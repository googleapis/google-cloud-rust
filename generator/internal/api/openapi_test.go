...
`
	...
	checkMessage(t, *test.Messages[0], Message{
		Name:          "Fake",
		ID:            "..Fake",
		Documentation: "A test message.",
		Fields: []*Field{
...
`
	...
	checkMessage(t, *test.Messages[0], Message{
		...
		Documentation: "A test message.",
		Fields: []*Field{
			{Name: "fMap", JSONName: "fMap", Typez: MESSAGE_TYPE, TypezID: ".google.protobuf.Any", Optional: true},
		},
	})
}
...
func TestOpenAPI_MakeAPI(t *testing.T) {
	...
	checkMessage(t, *location, Message{
	...
	checkMessage(t, *listLocationsResponse, Message{
	...
	checkMessage(t, *listLocationsRequest, Message{
	...
	checkMessage(t, *secretPayload, Message{
		Name:          "SecretPayload",
		ID:            "..SecretPayload",
	...
	if diff := cmp.Diff(wantService, service, cmpopts.IgnoreFields(Service{}, "Methods")); diff != "" {
		t.Errorf("mismatched service attributes (-want, +got):\n%s", diff)
	}

	checkMethod(t, service, "ListLocations", &Method{
		Name:          "ListLocations",
		...
		PathInfo: &PathInfo{
			...
			PathTemplate: []PathSegment{
				...
				NewLiteralPathSegment("projects"),
				NewFieldPathPathSegment("project"),
				NewLiteralPathSegment("locations"),
			},
	...
	checkMethod(t, service, "CreateSecret", &Method{
		Name:          "CreateSecret",
	...
	checkMethod(t, service, "AddSecretVersion", &Method{
		...
		PathInfo: &PathInfo{
			...
			PathTemplate: []PathSegment{
				...
				NewFieldPathPathSegment("project"),
				NewLiteralPathSegment("secrets"),
				NewFieldPathPathSegment("secret"),
				NewVerbPathSegment("addVersion"),
			},
			QueryParameters: map[string]bool{},
		},
	})
...
func TestOpenAPI_SyntheticMessageWithExistingRequest(t *testing.T) {
	...
	checkMessage(t, *setIamPolicyRequest, Message{
