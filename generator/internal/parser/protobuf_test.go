...
func TestProtobuf_Scalar(t *testing.T) {
	...
	checkProtobufMessage(t, *message, api.Message{
		Name:          "Fake",
		Package:       "test",
		ID:            ".test.Fake",
...
func TestProtobuf_SkipExternaEnums(t *testing.T) {
	...
	checkProtobufEnum(t, *enum, api.Enum{
		Name:          "LocalEnum",
		Package:       "test",
...
func TestProtobuf_Comments(t *testing.T) {
	...
	checkProtobufEnum(t, *e, api.Enum{
		Name:          "Status",
		Package:       "test",
	...
	checkProtobufService(t, *service, api.Service{
		Name:          "Service",
		ID:            ".test.Service",
		Package:       "test",
...
func checkProtobufMessage(t *testing.T, got api.Message, want api.Message) {
	t.Helper()
...
func checkProtobufEnum(t *testing.T, got api.Enum, want api.Enum) {
	t.Helper()
...
func checkProtobufService(t *testing.T, got api.Service, want api.Service) {
	t.Helper()
