...
`
	...
	checkOpenAPIMessage(t, *message, api.Message{
		Name:          "Automatic",
		ID:            "..Automatic",
...
`
	...
	checkOpenAPIMessage(t, *test.Messages[0], api.Message{
		Name:          "Fake",
		ID:            "..Fake",
		Documentation: "A test message.",
		Fields: []*api.Field{
...
func TestOpenAPI_MakeAPI(t *testing.T) {
	...
	checkOpenAPIMessage(t, *location, api.Message{
	...
	checkOpenAPIMessage(t, *listLocationsResponse, api.Message{
	...
	checkOpenAPIMessage(t, *listLocationsRequest, api.Message{
	...
	checkOpenAPIMessage(t, *secretPayload, api.Message{
		Name:          "SecretPayload",
		ID:            "..SecretPayload",
	...
	checkOpenAPIMethod(t, service, "ListLocations", &api.Method{
		Name:          "ListLocations",
	...
	checkOpenAPIMethod(t, service, "CreateSecret", &api.Method{
		Name:          "CreateSecret",
	...
	checkOpenAPIMethod(t, service, "AddSecretVersion", &api.Method{
...
func TestOpenAPI_SyntheticMessageWithExistingRequest(t *testing.T) {
	...
	checkOpenAPIMessage(t, *setIamPolicyRequest, api.Message{
...
func checkOpenAPIMethod(t *testing.T, service *api.Service, name string, want *api.Method) {
	t.Helper()
...
func checkOpenAPIMessage(t *testing.T, got api.Message, want api.Message) {
	t.Helper()
	if diff := cmp.Diff(want, got, cmpopts.IgnoreFields(api.Message{}, "Fields")); diff != "" {
