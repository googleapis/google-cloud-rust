...
impl IAMPolicy {
    ...
    async fn build_inner<T>(conf: gax::options::ClientConfig<T>) -> Result<Arc<dyn super::stubs::dynamic::IAMPolicy>>
    where T: gaxi::http::ValidCredential + 'static
    {
    ...
    async fn build_transport<T>(conf: gax::options::ClientConfig<T>) -> Result<impl super::stubs::IAMPolicy>
    where T: gaxi::http::ValidCredential + 'static
    {
        super::transport::IAMPolicy::new(conf).await
    }

    async fn build_with_tracing<T>(conf: gax::options::ClientConfig<T>) -> Result<impl super::stubs::IAMPolicy>
    where T: gaxi::http::ValidCredential + 'static
    {
