...
pub trait SecretManagerService: std::fmt::Debug + Send + Sync {
    ...
    fn list_secrets(
        ...
        std::future::ready::<crate::Result<gax::response::Response<crate::model::ListSecretsResponse>>>(Err(Error::other("unimplemented")))
    }
    ...
    fn create_secret(
        ...
        std::future::ready::<crate::Result<gax::response::Response<crate::model::Secret>>>(Err(Error::other("unimplemented")))
    }
    ...
    fn add_secret_version(
        ...
        std::future::ready::<crate::Result<gax::response::Response<crate::model::SecretVersion>>>(Err(Error::other("unimplemented")))
    }
    ...
    fn list_secret_versions(
        ...
        std::future::ready::<crate::Result<gax::response::Response<crate::model::ListSecretVersionsResponse>>>(Err(Error::other("unimplemented")))
    }
    ...
    fn access_secret_version(
        ...
        std::future::ready::<crate::Result<gax::response::Response<crate::model::AccessSecretVersionResponse>>>(Err(Error::other("unimplemented")))
    }
    ...
    fn set_iam_policy(
        ...
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<gax::response::Response<iam::model::Policy>>> + Send {
        std::future::ready::<crate::Result<gax::response::Response<iam::model::Policy>>>(Err(Error::other("unimplemented")))
    }
    ...
    fn test_iam_permissions(
        ...
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<gax::response::Response<iam::model::TestIamPermissionsResponse>>> + Send {
        std::future::ready::<crate::Result<gax::response::Response<iam::model::TestIamPermissionsResponse>>>(Err(Error::other("unimplemented")))
    }
    ...
    fn list_locations(
        ...
        std::future::ready::<crate::Result<gax::response::Response<location::model::ListLocationsResponse>>>(Err(Error::other("unimplemented")))
    }
    ...
    fn get_location(
        ...
        std::future::ready::<crate::Result<gax::response::Response<location::model::Location>>>(Err(Error::other("unimplemented")))
    }
}
