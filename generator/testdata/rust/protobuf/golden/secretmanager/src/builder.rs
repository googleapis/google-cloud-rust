...
pub mod secret_manager_service {
    ...
    impl SetIamPolicy {
        ...
        ///
        /// This is a **required** field for requests.
        pub fn set_policy<T: Into<std::option::Option<iam_v1::model::Policy>>>(mut self, v: T) -> Self {
    ...
    impl GetIamPolicy {
        ...
        pub fn set_options<T: Into<std::option::Option<iam_v1::model::GetPolicyOptions>>>(mut self, v: T) -> Self {
