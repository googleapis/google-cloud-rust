...
impl SecretManagerService {
    ...
    async fn build_inner<T>(conf: gax::options::ClientConfig<T>) -> Result<Arc<dyn super::stubs::dynamic::SecretManagerService>>
    where T: gaxi::http::ValidCredential + 'static
    {
    ...
    async fn build_transport<T>(conf: gax::options::ClientConfig<T>) -> Result<impl super::stubs::SecretManagerService>
    where T: gaxi::http::ValidCredential + 'static
    {
        super::transport::SecretManagerService::new(conf).await
    }

    async fn build_with_tracing<T>(conf: gax::options::ClientConfig<T>) -> Result<impl super::stubs::SecretManagerService>
    where T: gaxi::http::ValidCredential + 'static
    {
