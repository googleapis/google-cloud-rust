...
/// Implements a [SecretManagerService](crate::stubs::SecretManagerService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SecretManagerService<T>
where T: crate::stubs::SecretManagerService + std::fmt::Debug + Send + Sync {
    inner: T,
}
...
impl<T> crate::stubs::SecretManagerService for SecretManagerService<T>
where T: crate::stubs::SecretManagerService + std::fmt::Debug + Send + Sync {
