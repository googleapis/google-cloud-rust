...
/// recognition.
class LanguageService extends CloudService {
  static const String host = 'language.googleapis.com';

  LanguageService({required super.client});

  /// Analyzes the sentiment of the provided text.
  Future<AnalyzeSentimentResponse> analyzeSentiment(AnalyzeSentimentRequest request) async {
    final url = Uri.https(host, '/v2/documents:analyzeSentiment');
  ...
  Future<AnalyzeEntitiesResponse> analyzeEntities(AnalyzeEntitiesRequest request) async {
    final url = Uri.https(host, '/v2/documents:analyzeEntities');
    final response = await $post(url, body: request);
  ...
  Future<ClassifyTextResponse> classifyText(ClassifyTextRequest request) async {
    final url = Uri.https(host, '/v2/documents:classifyText');
    final response = await $post(url, body: request);
  ...
  Future<ModerateTextResponse> moderateText(ModerateTextRequest request) async {
    final url = Uri.https(host, '/v2/documents:moderateText');
    final response = await $post(url, body: request);
  ...
  Future<AnnotateTextResponse> annotateText(AnnotateTextRequest request) async {
    final url = Uri.https(host, '/v2/documents:annotateText');
    final response = await $post(url, body: request);
