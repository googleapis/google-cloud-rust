...
use google_cloud_gax_internal::http::{ReqwestClient, NoBody};
...
impl Client {
    ...
    pub fn list_stream_items(
        &self,
        req: ListFoosRequest,
    ) -> ItemPaginator<ListFoosResponse, gax::error::Error> {
    ...
    async fn list_impl(
        self,
        req: ListFoosRequest,
    ) -> std::result::Result<ListFoosResponse, gax::error::Error> {
