...
//! Re-exports symbols from [tonic] and provides the Tonic-backed gRPC client.
//!
//! [tonic]: https://docs.rs/tonic

pub use ::tonic::Code;
pub use ::tonic::Extensions;
pub use ::tonic::GrpcMethod;
pub use ::tonic::Response;
pub use ::tonic::Result;
...
use super::grpc_helpers::{add_auth_headers, make_credentials, make_headers};
use super::streaming;
use super::tracing_attributes::TracingAttributes;
...
impl Client {
    ...
    pub async fn execute<Request, Response>(
        ...
        request_params: &str,
    ) -> GaxResult<tonic::Response<Response>>
    where
    ...
    pub async fn bidi_stream<Request, Response>(
        ...
        api_client_header: &'static str,
        request_params: &str,
    ) -> GaxResult<tonic::Response<tonic::Streaming<Response>>>
    where
    ...
    pub async fn bidi_stream_with_status<Request, Response>(
        ...
        api_client_header: &'static str,
        request_params: &str,
    ) -> GaxResult<tonic::Result<tonic::Response<tonic::Streaming<Response>>>>
    where
        Request: prost::Message + 'static,
        Response: prost::Message + Default + 'static,
    {
    ...
    fn spawn_bidi_stream<ProstReq, ProstResp>(
        ...
        api_client_header: &'static str,
        request_params: &str,
    ) -> tokio::sync::oneshot::Receiver<GaxResult<tonic::Response<tonic::Streaming<ProstResp>>>>
    where
        ProstReq: prost::Message + Send + 'static,
    ...
    pub async fn execute_server_streaming<DomainReq, DomainResp, ProstReq, ProstResp>(
        ...
        api_client_header: &'static str,
        request_params: &str,
    ) -> GaxResult<google_cloud_gax::streaming::ResponseStream<DomainResp>>
    where
    ...
    where
        ...
        Response: prost::Message + Default + 'static,
    {
        let span = super::grpc_helpers::unary_make_request_span(
        ...
        let result = async {
            ...
            super::grpc_helpers::unary_wrap_and_record_request(
                self.metric.clone(),
                span,
                prior_attempt_count,
                pending,
    ...
    fn on_attempt_complete<Response>(
        ...
        result: GaxResult<TonicResponse<Response>>,
        options: &RequestOptions,
