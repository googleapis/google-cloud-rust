...
use spanner_grpc_mock::google::spanner::v1::{
    CommitResponse, ExecuteBatchDmlResponse, PartialResultSet, Partition, PartitionResponse,
    ResultSet, ResultSetMetadata, ResultSetStats, Session, StructType, Transaction,
    Type as SpannerType, TypeCode, result_set_stats::RowCount, struct_type::Field,
};
