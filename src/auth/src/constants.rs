...
pub(crate) const RETRY_EXHAUSTED_ERROR: &str = "Request to fetch the token failed after multiple retries with transient errors. Subsequent calls with this credential might succeed.";
