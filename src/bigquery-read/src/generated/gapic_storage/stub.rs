...
pub trait Read: std::fmt::Debug + Send + Sync {
    ...
    fn create_read_session(
        &self,
        _req: crate::model::CreateReadSessionRequest,
        _options: crate::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::Response<crate::model::ReadSession>>>
    + Send {
    ...
    fn split_read_stream(
        &self,
        _req: crate::model::SplitReadStreamRequest,
        _options: crate::RequestOptions,
    ) -> impl std::future::Future<
        Output = crate::Result<crate::Response<crate::model::SplitReadStreamResponse>>,
    > + Send {
        gaxi::unimplemented::unimplemented_stub()
    }
}
