...
/// Implements [CloudFunctionsService](crate::traits::CloudFunctionsService) using a [gax::http_client::ReqwestClient].
#[derive(Clone)]
pub struct CloudFunctionsService {
    inner: gax::http_client::ReqwestClient,
}

impl std::fmt::Debug for CloudFunctionsService {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::result::Result<(), std::fmt::Error> {
        f.debug_struct("CloudFunctionsService")
...
impl crate::traits::CloudFunctionsService for CloudFunctionsService {
    async fn list_functions(
        ...
        let builder = self
            ...
            .builder(
                reqwest::Method::GET,
                format!("/v1/{}/functions", req.parent),
            )
            .query(&[("alt", "json")])
            .header(
                "x-goog-api-client",
    ...
    async fn create_function(
        ...
        let builder = self
            ...
            .builder(
                reqwest::Method::POST,
                format!("/v1/{}/functions", req.location),
            )
            .query(&[("alt", "json")])
            .header(
                "x-goog-api-client",
        ...
        let builder = self
            ...
            .builder(
                ...
                format!(
                    ...
                    req.function
                        .as_ref()
                        .ok_or_else(|| gax::path_parameter::missing("function"))?
                        .name
                ),
            )
            .query(&[("alt", "json")])
    ...
    async fn call_function(
        ...
        let builder = self
            .inner
            .builder(reqwest::Method::POST, format!("/v1/{}:call", req.name))
            .query(&[("alt", "json")])
            .header(
                "x-goog-api-client",
                reqwest::header::HeaderValue::from_static(&crate::info::X_GOOG_API_CLIENT_HEADER),
    ...
    async fn generate_upload_url(
        ...
        let builder = self
            ...
            .builder(
                reqwest::Method::POST,
                format!("/v1/{}/functions:generateUploadUrl", req.parent),
            )
            .query(&[("alt", "json")])
            .header(
                "x-goog-api-client",
    ...
    async fn generate_download_url(
        ...
        let builder = self
            ...
            .builder(
                reqwest::Method::POST,
                format!("/v1/{}:generateDownloadUrl", req.name),
            )
            .query(&[("alt", "json")])
            .header(
                "x-goog-api-client",
