...
pub mod cloud_functions_service {
    use crate::Result;
    use std::sync::Arc;

    /// Common implementation for [crate::client::CloudFunctionsService] request builders.
    #[derive(Clone, Debug)]
    pub struct RequestBuilder<R: std::default::Default> {
        stub: Arc<dyn crate::traits::dyntraits::CloudFunctionsService>,
        request: R,
    ...
    {
        pub(crate) fn new(stub: Arc<dyn crate::traits::dyntraits::CloudFunctionsService>) -> Self {
            Self {
                stub,
                request: R::default(),
    ...
    /// The request builder for a CloudFunctionsService::list_functions call.
    #[derive(Clone, Debug)]
    ...
    /// The request builder for a CloudFunctionsService::get_function call.
    #[derive(Clone, Debug)]
    ...
    impl GetFunction {
        ...
        /// Sends the request.
        pub async fn send(self) -> Result<crate::model::CloudFunction> {
            (*self.0.stub)
        ...
        pub fn set_version_id<T: Into<i64>>(mut self, v: T) -> Self {
    ...
    /// The request builder for a CloudFunctionsService::create_function call.
    #[derive(Clone, Debug)]
    ...
    impl CreateFunction {
        ...
        /// on [create_function][crate::client::CloudFunctionsService::create_function].
        ...
        pub fn poller(
            self,
        ) -> impl lro::Poller<crate::model::CloudFunction, crate::model::OperationMetadataV1>
        {
            type Operation =
                lro::Operation<crate::model::CloudFunction, crate::model::OperationMetadataV1>;
        ...
        pub fn set_function<T: Into<std::option::Option<crate::model::CloudFunction>>>(
            mut self,
            v: T,
        ) -> Self {
    ...
    /// The request builder for a CloudFunctionsService::update_function call.
    #[derive(Clone, Debug)]
    ...
    impl UpdateFunction {
        ...
        ///
        /// This starts, but does not poll, a longrunning operation. More information
        /// on [update_function][crate::client::CloudFunctionsService::update_function].
        pub async fn send(self) -> Result<longrunning::model::Operation> {
            (*self.0.stub)
    ...
    /// The request builder for a CloudFunctionsService::delete_function call.
    #[derive(Clone, Debug)]
    ...
    impl DeleteFunction {
        ...
        ///
        /// This starts, but does not poll, a longrunning operation. More information
        /// on [delete_function][crate::client::CloudFunctionsService::delete_function].
        pub async fn send(self) -> Result<longrunning::model::Operation> {
            (*self.0.stub)
    ...
    /// The request builder for a CloudFunctionsService::call_function call.
    #[derive(Clone, Debug)]
    pub struct CallFunction(RequestBuilder<crate::model::CallFunctionRequest>);
    ...
    impl CallFunction {
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::CallFunctionRequest>>(mut self, v: V) -> Self {
            self.0.request = v.into();
            self
        }
        ...
        /// Sends the request.
        pub async fn send(self) -> Result<crate::model::CallFunctionResponse> {
            (*self.0.stub)
                .call_function(self.0.request, self.0.options)
                .await
        }
        ...
        pub fn set_data<T: Into<std::string::String>>(mut self, v: T) -> Self {
            self.0.request.data = v.into();
            self
        }
    }

    impl gax::options::RequestBuilder for CallFunction {
        fn request_options(&mut self) -> &mut gax::options::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for a CloudFunctionsService::generate_upload_url call.
    #[derive(Clone, Debug)]
    ...
    /// The request builder for a CloudFunctionsService::generate_download_url call.
    #[derive(Clone, Debug)]
    ...
    impl GenerateDownloadUrl {
        ...
        /// Sets the value of `version_id`.
        pub fn set_version_id<T: Into<u64>>(mut self, v: T) -> Self {
            self.0.request.version_id = v.into();
            self
        }
    }
    ...
    /// The request builder for a CloudFunctionsService::set_iam_policy call.
    #[derive(Clone, Debug)]
    ...
    /// The request builder for a CloudFunctionsService::get_iam_policy call.
    #[derive(Clone, Debug)]
    ...
    /// The request builder for a CloudFunctionsService::test_iam_permissions call.
    #[derive(Clone, Debug)]
    ...
    /// The request builder for a CloudFunctionsService::list_locations call.
    #[derive(Clone, Debug)]
    ...
    /// The request builder for a CloudFunctionsService::list_operations call.
    #[derive(Clone, Debug)]
    ...
    /// The request builder for a CloudFunctionsService::get_operation call.
    #[derive(Clone, Debug)]
