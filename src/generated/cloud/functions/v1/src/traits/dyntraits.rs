...
/// A dyn-compatible, crate-private version of `CloudFunctionsService`.
...
pub trait CloudFunctionsService: std::fmt::Debug + Send + Sync {
    ...
    async fn get_function(
        ...
        options: gax::options::RequestOptions,
    ) -> crate::Result<crate::model::CloudFunction>;
    ...
    async fn call_function(
        ...
        options: gax::options::RequestOptions,
    ) -> crate::Result<crate::model::CallFunctionResponse>;
...
/// All implementations of [crate::traits::CloudFunctionsService] also implement [CloudFunctionsService].
#[async_trait::async_trait]
impl<T: crate::traits::CloudFunctionsService> CloudFunctionsService for T {
    ...
    async fn call_function(
        ...
        T::call_function(self, req, options).await
    }
