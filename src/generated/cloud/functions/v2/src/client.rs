...
/// [with_credentials()]: super::builder::function_service::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `FunctionService` in
...
impl FunctionService {
    ...
    pub fn builder() -> super::builder::function_service::ClientBuilder {
        crate::new_client_builder(super::builder::function_service::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::FunctionService>> {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::FunctionService> {
    ...
    /// async fn sample(
    ///    client: &FunctionService, project_id: &str, location_id: &str, function_id: &str
    /// ) -> Result<()> {
    ///     let response = client.get_function()
    ///         .set_name(format!("projects/{project_id}/locations/{location_id}/functions/{function_id}"))
    ///         .send().await?;
    ...
    /// use google_cloud_functions_v2::Result;
    /// async fn sample(
    ///    client: &FunctionService, project_id: &str, location_id: &str
    /// ) -> Result<()> {
    ///     let mut list = client.list_functions()
    ///         .set_parent(format!("projects/{project_id}/locations/{location_id}"))
    ///         .by_item();
    ...
    ///         .set_function(
    ///             Function::new().set_name(format!("projects/{project_id}/locations/{location_id}/functions/{function_id}"))/* set fields */
    ///         )
