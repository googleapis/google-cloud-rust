    ...
    async fn get_function(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//cloudfunctions.googleapis.com/v2/{}", var_name,);
    ...
    async fn list_runtimes(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//cloudfunctions.googleapis.com/v2/{}/runtimes", var_parent,);
    ...
    async fn set_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//cloudfunctions.googleapis.com/v2/{}", var_resource,);
