    ...
    async fn list_functions(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/functions";
    ...
    async fn update_function(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{function.name}";

                let resource_name =
                    format!("//cloudfunctions.googleapis.com/{}", var_function_name,);
    ...
    async fn generate_upload_url(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/functions:generateUploadUrl";
    ...
    async fn generate_download_url(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{name}:generateDownloadUrl";
    ...
    async fn list_runtimes(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/runtimes";
