...
impl super::stub::FunctionService for FunctionService {
    async fn get_function(
        ...
        let response: crate::model::Function = self
            .inner
    ...
    async fn list_functions(
        ...
        let response: crate::model::ListFunctionsResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn generate_upload_url(
        ...
        let response: crate::model::GenerateUploadUrlResponse =
    ...
    async fn generate_download_url(
        ...
        let response: crate::model::GenerateDownloadUrlResponse =
            self.inner.execute(builder, Some(req), options).await?;
        Ok(gax::response::Response::from(response))
    }
    ...
    async fn list_runtimes(
        ...
        let builder = builder.query(&[("filter", &req.filter)]);
        let response: crate::model::ListRuntimesResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
