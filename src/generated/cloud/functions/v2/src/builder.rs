...
/// Request and client builders for [FunctionService][crate::client::FunctionService].
pub mod function_service {
    ...
    /// # async fn sample() -> google_cloud_functions_v2::Result<()> {
    ///
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetFunction {
    ...
    impl ListFunctions {
        ...
        pub fn by_page(
            self,
        ) -> impl google_cloud_gax::paginator::Paginator<crate::model::ListFunctionsResponse, crate::Error>
        {
            use std::clone::Clone;
        ...
        pub fn by_item(
            ...
            crate::model::ListFunctionsResponse,
            crate::Error,
        > {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListFunctions {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateFunction {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `create_function`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::Function, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_functions_v2::client::FunctionService::create_function::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateFunction {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UpdateFunction {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `update_function`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::Function, crate::model::OperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_functions_v2::client::FunctionService::update_function::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateFunction {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteFunction {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `delete_function`.
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_functions_v2::client::FunctionService::delete_function::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteFunction {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GenerateUploadUrl {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GenerateDownloadUrl {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListRuntimes {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
