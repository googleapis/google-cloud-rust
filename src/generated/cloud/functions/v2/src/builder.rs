...
pub mod function_service {
    ...
    where R: std::default::Default {
        pub(crate) fn new(stub: std::sync::Arc<dyn super::super::stub::dynamic::FunctionService>) -> Self {
            Self {
                stub,
                request: R::default(),
    ...
    impl GetFunction {
        ...
        pub async fn send(self) -> Result<crate::model::Function> {
            (*self.0.stub).get_function(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }
    ...
    impl ListFunctions {
        ...
        pub async fn send(self) -> Result<crate::model::ListFunctionsResponse> {
            (*self.0.stub).list_functions(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }

        /// Streams each page in the collection.
        pub fn by_page(self) -> impl gax::paginator::Paginator<crate::model::ListFunctionsResponse, gax::error::Error> {
            use std::clone::Clone;
        ...
        pub fn by_item(self) -> impl gax::paginator::ItemPaginator<crate::model::ListFunctionsResponse, gax::error::Error> {
    ...
    impl CreateFunction {
        ...
        pub async fn send(self) -> Result<longrunning::model::Operation> {
            (*self.0.stub).create_function(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }
        ...
        {
            type Operation = lro::internal::Operation<crate::model::Function, crate::model::OperationMetadata>;
    ...
    impl UpdateFunction {
        ...
        pub async fn send(self) -> Result<longrunning::model::Operation> {
            (*self.0.stub).update_function(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }
    ...
    impl DeleteFunction {
        ...
        pub async fn send(self) -> Result<longrunning::model::Operation> {
            (*self.0.stub).delete_function(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }
    ...
    impl GenerateUploadUrl {
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::GenerateUploadUrlRequest>>(mut self, v: V) -> Self {
            self.0.request = v.into();
            self
        }
        ...
        pub async fn send(self) -> Result<crate::model::GenerateUploadUrlResponse> {
            (*self.0.stub).generate_upload_url(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }
    ...
    impl GenerateDownloadUrl {
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::GenerateDownloadUrlRequest>>(mut self, v: V) -> Self {
            self.0.request = v.into();
            self
        }
        ...
        pub async fn send(self) -> Result<crate::model::GenerateDownloadUrlResponse> {
            (*self.0.stub).generate_download_url(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }
    ...
    impl ListRuntimes {
        ...
        pub async fn send(self) -> Result<crate::model::ListRuntimesResponse> {
            (*self.0.stub).list_runtimes(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }
