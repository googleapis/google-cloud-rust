...
/// Implements a [FunctionService](crate::stubs::FunctionService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct FunctionService<T>
where
    T: crate::stubs::FunctionService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::FunctionService for FunctionService<T>
where
    T: crate::stubs::FunctionService + std::fmt::Debug + Send + Sync,
{
