...
/// Implements a [FunctionService](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct FunctionService<T>
where
    T: crate::traits::FunctionService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::FunctionService for FunctionService<T>
where
    T: crate::traits::FunctionService + std::fmt::Debug + Send + Sync,
{
