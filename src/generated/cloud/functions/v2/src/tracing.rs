...
/// Implements a [FunctionService](super::stubs::FunctionService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct FunctionService<T>
where
    T: super::stubs::FunctionService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::FunctionService for FunctionService<T>
where
    T: super::stubs::FunctionService + std::fmt::Debug + Send + Sync,
{
