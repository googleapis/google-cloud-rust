...
/// Defines the trait used to implement [super::client::RegionHealthAggregationPolicies].
///
/// Application developers may need to implement this trait to mock
/// `client::RegionHealthAggregationPolicies`.  In other use-cases, application developers only
/// use `client::RegionHealthAggregationPolicies` and need not be concerned with this trait or
/// its implementations.
///
/// Services gain new RPCs routinely. Consequently, this trait gains new methods
/// too. To avoid breaking applications the trait provides a default
...
pub trait RegionHealthAggregationPolicies: std::fmt::Debug + Send + Sync {
    /// Implements [super::client::RegionHealthAggregationPolicies::aggregated_list].
    fn aggregated_list(
        &self,
    ...
    /// Implements [super::client::RegionHealthAggregationPolicies::delete].
    fn delete(
        &self,
    ...
    /// Implements [super::client::RegionHealthAggregationPolicies::get].
    fn get(
        &self,
    ...
    /// Implements [super::client::RegionHealthAggregationPolicies::insert].
    fn insert(
        &self,
    ...
    /// Implements [super::client::RegionHealthAggregationPolicies::list].
    fn list(
        &self,
    ...
    /// Implements [super::client::RegionHealthAggregationPolicies::patch].
    fn patch(
        &self,
    ...
    /// Implements [super::client::RegionHealthAggregationPolicies::test_iam_permissions].
    fn test_iam_permissions(
        &self,
    ...
    /// Implements [super::client::RegionHealthAggregationPolicies::get_operation].
    fn get_operation(
        &self,
        _req: crate::model::region_operations::GetRequest,
        _options: crate::RequestOptions,
...
/// Defines the trait used to implement [super::client::RegionInstanceGroupManagerResizeRequests].
///
/// Application developers may need to implement this trait to mock
/// `client::RegionInstanceGroupManagerResizeRequests`.  In other use-cases, application developers only
/// use `client::RegionInstanceGroupManagerResizeRequests` and need not be concerned with this trait or
/// its implementations.
///
/// Services gain new RPCs routinely. Consequently, this trait gains new methods
/// too. To avoid breaking applications the trait provides a default
...
pub trait RegionInstanceGroupManagerResizeRequests: std::fmt::Debug + Send + Sync {
    /// Implements [super::client::RegionInstanceGroupManagerResizeRequests::cancel].
    fn cancel(
        &self,
    ...
    /// Implements [super::client::RegionInstanceGroupManagerResizeRequests::delete].
    fn delete(
        &self,
    ...
    /// Implements [super::client::RegionInstanceGroupManagerResizeRequests::get].
    fn get(
        &self,
    ...
    /// Implements [super::client::RegionInstanceGroupManagerResizeRequests::insert].
    fn insert(
        &self,
    ...
    /// Implements [super::client::RegionInstanceGroupManagerResizeRequests::list].
    fn list(
        &self,
    ...
    /// Implements [super::client::RegionInstanceGroupManagerResizeRequests::get_operation].
    fn get_operation(
        &self,
        _req: crate::model::region_operations::GetRequest,
        _options: crate::RequestOptions,
...
/// Defines the trait used to implement [super::client::ReservationSlots].
///
/// Application developers may need to implement this trait to mock
/// `client::ReservationSlots`.  In other use-cases, application developers only
/// use `client::ReservationSlots` and need not be concerned with this trait or
/// its implementations.
///
/// Services gain new RPCs routinely. Consequently, this trait gains new methods
/// too. To avoid breaking applications the trait provides a default
...
pub trait ReservationSlots: std::fmt::Debug + Send + Sync {
    /// Implements [super::client::ReservationSlots::get].
    fn get(
        &self,
    ...
    /// Implements [super::client::ReservationSlots::update].
    fn update(
        &self,
    ...
    /// Implements [super::client::ReservationSlots::get_operation].
    fn get_operation(
        &self,
        _req: crate::model::zone_operations::GetRequest,
        _options: crate::RequestOptions,
...
/// Defines the trait used to implement [super::client::ZoneVmExtensionPolicies].
///
/// Application developers may need to implement this trait to mock
/// `client::ZoneVmExtensionPolicies`.  In other use-cases, application developers only
/// use `client::ZoneVmExtensionPolicies` and need not be concerned with this trait or
/// its implementations.
///
/// Services gain new RPCs routinely. Consequently, this trait gains new methods
/// too. To avoid breaking applications the trait provides a default
...
pub trait ZoneVmExtensionPolicies: std::fmt::Debug + Send + Sync {
    /// Implements [super::client::ZoneVmExtensionPolicies::delete].
    fn delete(
        &self,
    ...
    /// Implements [super::client::ZoneVmExtensionPolicies::get].
    fn get(
        &self,
    ...
    /// Implements [super::client::ZoneVmExtensionPolicies::insert].
    fn insert(
        &self,
    ...
    /// Implements [super::client::ZoneVmExtensionPolicies::list].
    fn list(
        &self,
    ...
    /// Implements [super::client::ZoneVmExtensionPolicies::update].
    fn update(
        &self,
    ...
    /// Implements [super::client::ZoneVmExtensionPolicies::get_operation].
    fn get_operation(
        &self,
        _req: crate::model::zone_operations::GetRequest,
        _options: crate::RequestOptions,
