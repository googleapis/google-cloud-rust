...
/// Implements a [FeedsService](super::stub::FeedsService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct FeedsService<T>
where
    T: super::stub::FeedsService + std::fmt::Debug + Send + Sync,
{
    inner: T,
    duration: gaxi::observability::DurationMetric,
}

impl<T> FeedsService<T>
where
    T: super::stub::FeedsService + std::fmt::Debug + Send + Sync,
{
    pub fn new(inner: T) -> Self {
...
impl<T> super::stub::FeedsService for FeedsService<T>
where
    T: super::stub::FeedsService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(level = tracing::Level::DEBUG, ret)]
    async fn fetch_service_account_for_customer(
        &self,
        req: crate::model::FetchServiceAccountForCustomerRequest,
        options: crate::RequestOptions,
    ) -> Result<crate::Response<crate::model::FeedServiceAccount>> {
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::FeedsService::fetch_service_account_for_customer",
            self.inner.fetch_service_account_for_customer(req, options));
        pending.await
    }
    ...
    async fn create_feed(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::FeedsService::create_feed",
    ...
    async fn get_feed(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::FeedsService::get_feed",
    ...
    async fn delete_feed(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::FeedsService::delete_feed",
    ...
    async fn enable_feed(
        &self,
        req: crate::model::EnableFeedRequest,
        options: crate::RequestOptions,
    ) -> Result<crate::Response<crate::model::Feed>> {
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::FeedsService::enable_feed",
            self.inner.enable_feed(req, options));
        pending.await
    }
    ...
    async fn disable_feed(
        &self,
        req: crate::model::DisableFeedRequest,
        options: crate::RequestOptions,
    ) -> Result<crate::Response<crate::model::Feed>> {
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::FeedsService::disable_feed",
            self.inner.disable_feed(req, options));
        pending.await
    }
    ...
    async fn list_feeds(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::FeedsService::list_feeds",
            self.inner.list_feeds(req, options));
        pending.await
    }

    #[tracing::instrument(level = tracing::Level::DEBUG, ret)]
    async fn list_feed_packs(
        &self,
        req: crate::model::ListFeedPacksRequest,
        options: crate::RequestOptions,
    ) -> Result<crate::Response<crate::model::ListFeedPacksResponse>> {
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::FeedsService::list_feed_packs",
            self.inner.list_feed_packs(req, options));
        pending.await
    }

    #[tracing::instrument(level = tracing::Level::DEBUG, ret)]
    async fn get_feed_pack(
        &self,
        req: crate::model::GetFeedPackRequest,
        options: crate::RequestOptions,
    ) -> Result<crate::Response<crate::model::FeedPack>> {
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::FeedsService::get_feed_pack",
            self.inner.get_feed_pack(req, options));
        pending.await
    }
    ...
    async fn update_feed(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::FeedsService::update_feed",
            self.inner.update_feed(req, options));
        pending.await
    }

    #[tracing::instrument(level = tracing::Level::DEBUG, ret)]
    async fn list_feed_source_type_schemas(
        &self,
        req: crate::model::ListFeedSourceTypeSchemasRequest,
        options: crate::RequestOptions,
    ) -> Result<crate::Response<crate::model::ListFeedSourceTypeSchemasResponse>> {
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::FeedsService::list_feed_source_type_schemas",
            self.inner.list_feed_source_type_schemas(req, options));
        pending.await
    }

    #[tracing::instrument(level = tracing::Level::DEBUG, ret)]
    async fn list_log_type_schemas(
        &self,
        req: crate::model::ListLogTypeSchemasRequest,
        options: crate::RequestOptions,
    ) -> Result<crate::Response<crate::model::ListLogTypeSchemasResponse>> {
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::FeedsService::list_log_type_schemas",
            self.inner.list_log_type_schemas(req, options));
        pending.await
    }

    #[tracing::instrument(level = tracing::Level::DEBUG, ret)]
    async fn import_push_logs(
        &self,
        req: crate::model::ImportPushLogsRequest,
        options: crate::RequestOptions,
    ) -> Result<crate::Response<google_cloud_api::model::HttpBody>> {
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::FeedsService::import_push_logs",
            self.inner.import_push_logs(req, options));
        pending.await
    }
    ...
    async fn generate_secret(
        &self,
        req: crate::model::GenerateSecretRequest,
        options: crate::RequestOptions,
    ) -> Result<crate::Response<crate::model::GenerateSecretResponse>> {
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::FeedsService::generate_secret",
            self.inner.generate_secret(req, options));
        pending.await
    }
    ...
    async fn list_operations(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::FeedsService::list_operations",
            self.inner.list_operations(req, options));
        pending.await
    }
    ...
    async fn get_operation(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::FeedsService::get_operation",
            self.inner.get_operation(req, options));
        google_cloud_lro::record_polling_attributes!(&_span);
        let result = pending.await;
        {
    ...
    async fn delete_operation(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::FeedsService::delete_operation",
            self.inner.delete_operation(req, options));
        pending.await
    }
    ...
    async fn cancel_operation(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::FeedsService::cancel_operation",
            self.inner.cancel_operation(req, options));
        pending.await
    }
}
