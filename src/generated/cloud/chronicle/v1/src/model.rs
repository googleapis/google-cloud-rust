...
impl DataAccessLabel {
    ...
    /// ```
    /// # use google_cloud_chronicle_v1::model::DataAccessLabel;
    /// use google_cloud_chronicle_v1::model::data_access_label;
    /// let x = DataAccessLabel::new().set_definition(Some(data_access_label::Definition::UdmQuery("example".to_string())));
    /// ```
...
impl DataAccessLabelReference {
    ...
    /// ```
    /// # use google_cloud_chronicle_v1::model::DataAccessLabelReference;
    /// use google_cloud_chronicle_v1::model::data_access_label_reference;
    /// let x = DataAccessLabelReference::new().set_label(Some(data_access_label_reference::Label::DataAccessLabel("example".to_string())));
    /// ```
    pub fn set_label<
...
pub mod watchlist {
    ...
    impl EntityPopulationMechanism {
        ...
        /// ```
        /// # use google_cloud_chronicle_v1::model::watchlist::EntityPopulationMechanism;
        /// use google_cloud_chronicle_v1::model::watchlist::entity_population_mechanism;
        /// use google_cloud_chronicle_v1::model::watchlist::entity_population_mechanism::Manual;
        /// let x = EntityPopulationMechanism::new().set_mechanism(Some(watchlist::entity_population_mechanism::Mechanism::Manual(Manual::default().into())));
        /// ```
