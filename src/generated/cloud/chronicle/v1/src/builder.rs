...
/// Request and client builders for [FeedsService][crate::client::FeedsService].
pub mod feeds_service {
    use crate::Result;

    /// A builder for [FeedsService][crate::client::FeedsService].
    ///
    /// ```
    /// # async fn sample() -> google_cloud_gax::client_builder::Result<()> {
    /// # use google_cloud_chronicle_v1::*;
    /// # use builder::feeds_service::ClientBuilder;
    /// # use client::FeedsService;
    /// let builder : ClientBuilder = FeedsService::builder();
    /// let client = builder
    ///     .with_endpoint("https://chronicle.googleapis.com")
    ///     .build().await?;
    /// # Ok(()) }
    ...
    pub(crate) mod client {
        use super::super::super::client::FeedsService;
        pub struct Factory;
        impl crate::ClientFactory for Factory {
            type Client = FeedsService;
            type Credentials = gaxi::options::Credentials;
            async fn build(
                self,
                config: gaxi::options::ClientConfig,
    ...
    /// Common implementation for [crate::client::FeedsService] request builders.
    #[derive(Clone, Debug)]
    pub(crate) struct RequestBuilder<R: std::default::Default> {
        stub: std::sync::Arc<dyn super::super::stub::dynamic::FeedsService>,
        request: R,
        options: crate::RequestOptions,
    }
    ...
    /// The request builder for [FeedsService::fetch_service_account_for_customer][crate::client::FeedsService::fetch_service_account_for_customer] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_chronicle_v1::builder::feeds_service::FetchServiceAccountForCustomer;
    /// # async fn sample() -> google_cloud_chronicle_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    /// # Ok(()) }
    ///
    /// fn prepare_request_builder() -> FetchServiceAccountForCustomer {
    ///   # panic!();
    ///   // ... details omitted ...
    /// }
    /// ```
    #[derive(Clone, Debug)]
    pub struct FetchServiceAccountForCustomer(
        RequestBuilder<crate::model::FetchServiceAccountForCustomerRequest>,
    );

    impl FetchServiceAccountForCustomer {
        pub(crate) fn new(
            stub: std::sync::Arc<dyn super::super::stub::dynamic::FeedsService>,
        ) -> Self {
            Self(RequestBuilder::new(stub))
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::FetchServiceAccountForCustomerRequest>>(
            mut self,
            v: V,
        ) -> Self {
            self.0.request = v.into();
        ...
        /// Sends the request.
        pub async fn send(self) -> Result<crate::model::FeedServiceAccount> {
            (*self.0.stub)
                .fetch_service_account_for_customer(self.0.request, self.0.options)
                .await
                .map(crate::Response::into_body)
        }

        /// Sets the value of [parent][crate::model::FetchServiceAccountForCustomerRequest::parent].
        ///
        /// This is a **required** field for requests.
        pub fn set_parent<T: Into<std::string::String>>(mut self, v: T) -> Self {
            self.0.request.parent = v.into();
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for FetchServiceAccountForCustomer {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [FeedsService::create_feed][crate::client::FeedsService::create_feed] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_chronicle_v1::builder::feeds_service::CreateFeed;
    /// # async fn sample() -> google_cloud_chronicle_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateFeed {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [FeedsService::get_feed][crate::client::FeedsService::get_feed] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_chronicle_v1::builder::feeds_service::GetFeed;
    /// # async fn sample() -> google_cloud_chronicle_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetFeed {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [FeedsService::delete_feed][crate::client::FeedsService::delete_feed] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_chronicle_v1::builder::feeds_service::DeleteFeed;
    /// # async fn sample() -> google_cloud_chronicle_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    ...
    impl DeleteFeed {
        ...
        /// Sets the value of [delete_backlog][crate::model::DeleteFeedRequest::delete_backlog].
        pub fn set_delete_backlog<T: Into<bool>>(mut self, v: T) -> Self {
            self.0.request.delete_backlog = v.into();
            self
        }
    }

    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteFeed {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [FeedsService::enable_feed][crate::client::FeedsService::enable_feed] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_chronicle_v1::builder::feeds_service::EnableFeed;
    /// # async fn sample() -> google_cloud_chronicle_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    /// # Ok(()) }
    ///
    /// fn prepare_request_builder() -> EnableFeed {
    ///   # panic!();
    ///   // ... details omitted ...
    /// }
    /// ```
    #[derive(Clone, Debug)]
    pub struct EnableFeed(RequestBuilder<crate::model::EnableFeedRequest>);
    ...
    impl EnableFeed {
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::EnableFeedRequest>>(mut self, v: V) -> Self {
            self.0.request = v.into();
            self
        }
        ...
        pub async fn send(self) -> Result<crate::model::Feed> {
            (*self.0.stub)
                .enable_feed(self.0.request, self.0.options)
                .await
                .map(crate::Response::into_body)
        }

        /// Sets the value of [name][crate::model::EnableFeedRequest::name].
        ///
        /// This is a **required** field for requests.
        pub fn set_name<T: Into<std::string::String>>(mut self, v: T) -> Self {
            self.0.request.name = v.into();
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for EnableFeed {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [FeedsService::disable_feed][crate::client::FeedsService::disable_feed] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_chronicle_v1::builder::feeds_service::DisableFeed;
    /// # async fn sample() -> google_cloud_chronicle_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    /// # Ok(()) }
    ///
    /// fn prepare_request_builder() -> DisableFeed {
    ///   # panic!();
    ///   // ... details omitted ...
    /// }
    /// ```
    #[derive(Clone, Debug)]
    pub struct DisableFeed(RequestBuilder<crate::model::DisableFeedRequest>);
    ...
    impl DisableFeed {
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::DisableFeedRequest>>(mut self, v: V) -> Self {
            self.0.request = v.into();
            self
        }
        ...
        pub async fn send(self) -> Result<crate::model::Feed> {
            (*self.0.stub)
                .disable_feed(self.0.request, self.0.options)
                .await
                .map(crate::Response::into_body)
        }

        /// Sets the value of [name][crate::model::DisableFeedRequest::name].
        ///
        /// This is a **required** field for requests.
        pub fn set_name<T: Into<std::string::String>>(mut self, v: T) -> Self {
            self.0.request.name = v.into();
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DisableFeed {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [FeedsService::list_feeds][crate::client::FeedsService::list_feeds] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_chronicle_v1::builder::feeds_service::ListFeeds;
    /// # async fn sample() -> google_cloud_chronicle_v1::Result<()> {
    /// use google_cloud_gax::paginator::ItemPaginator;
    ///
    /// let builder = prepare_request_builder();
    ...
    impl ListFeeds {
        ...
        pub fn by_page(
            self,
        ) -> impl google_cloud_gax::paginator::Paginator<crate::model::ListFeedsResponse, crate::Error>
        {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
            let execute = move |token: String| {
        ...
        pub fn by_item(
            self,
        ) -> impl google_cloud_gax::paginator::ItemPaginator<crate::model::ListFeedsResponse, crate::Error>
        {
            use google_cloud_gax::paginator::Paginator;
            self.by_page().items()
        }
        ...
        /// Sets the value of [page_size][crate::model::ListFeedsRequest::page_size].
        pub fn set_page_size<T: Into<i32>>(mut self, v: T) -> Self {
            self.0.request.page_size = v.into();
            self
        }

        /// Sets the value of [page_token][crate::model::ListFeedsRequest::page_token].
        pub fn set_page_token<T: Into<std::string::String>>(mut self, v: T) -> Self {
            self.0.request.page_token = v.into();
            self
        }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListFeeds {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [FeedsService::list_feed_packs][crate::client::FeedsService::list_feed_packs] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_chronicle_v1::builder::feeds_service::ListFeedPacks;
    /// # async fn sample() -> google_cloud_chronicle_v1::Result<()> {
    /// use google_cloud_gax::paginator::ItemPaginator;
    ///
    /// let builder = prepare_request_builder();
    ...
    /// # Ok(()) }
    ///
    /// fn prepare_request_builder() -> ListFeedPacks {
    ///   # panic!();
    ///   // ... details omitted ...
    /// }
    /// ```
    #[derive(Clone, Debug)]
    pub struct ListFeedPacks(RequestBuilder<crate::model::ListFeedPacksRequest>);
    ...
    impl ListFeedPacks {
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::ListFeedPacksRequest>>(mut self, v: V) -> Self {
            self.0.request = v.into();
            self
        }
        ...
        /// Sends the request.
        pub async fn send(self) -> Result<crate::model::ListFeedPacksResponse> {
            (*self.0.stub)
                .list_feed_packs(self.0.request, self.0.options)
                .await
                .map(crate::Response::into_body)
        }
        ...
        pub fn by_page(
            self,
        ) -> impl google_cloud_gax::paginator::Paginator<crate::model::ListFeedPacksResponse, crate::Error>
        {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
            let execute = move |token: String| {
        ...
        pub fn by_item(
            ...
            crate::model::ListFeedPacksResponse,
            crate::Error,
        > {
            use google_cloud_gax::paginator::Paginator;
            self.by_page().items()
        ...
        /// Sets the value of [parent][crate::model::ListFeedPacksRequest::parent].
        ///
        /// This is a **required** field for requests.
        pub fn set_parent<T: Into<std::string::String>>(mut self, v: T) -> Self {
            self.0.request.parent = v.into();
        ...
        /// Sets the value of [page_size][crate::model::ListFeedPacksRequest::page_size].
        pub fn set_page_size<T: Into<i32>>(mut self, v: T) -> Self {
            self.0.request.page_size = v.into();
            self
        }

        /// Sets the value of [page_token][crate::model::ListFeedPacksRequest::page_token].
        pub fn set_page_token<T: Into<std::string::String>>(mut self, v: T) -> Self {
            self.0.request.page_token = v.into();
            self
        }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListFeedPacks {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [FeedsService::get_feed_pack][crate::client::FeedsService::get_feed_pack] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_chronicle_v1::builder::feeds_service::GetFeedPack;
    /// # async fn sample() -> google_cloud_chronicle_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    /// # Ok(()) }
    ///
    /// fn prepare_request_builder() -> GetFeedPack {
    ///   # panic!();
    ///   // ... details omitted ...
    /// }
    /// ```
    #[derive(Clone, Debug)]
    pub struct GetFeedPack(RequestBuilder<crate::model::GetFeedPackRequest>);
    ...
    impl GetFeedPack {
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::GetFeedPackRequest>>(mut self, v: V) -> Self {
            self.0.request = v.into();
            self
        }
        ...
        /// Sends the request.
        pub async fn send(self) -> Result<crate::model::FeedPack> {
            (*self.0.stub)
                .get_feed_pack(self.0.request, self.0.options)
                .await
                .map(crate::Response::into_body)
        }

        /// Sets the value of [name][crate::model::GetFeedPackRequest::name].
        ///
        /// This is a **required** field for requests.
        pub fn set_name<T: Into<std::string::String>>(mut self, v: T) -> Self {
            self.0.request.name = v.into();
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetFeedPack {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [FeedsService::update_feed][crate::client::FeedsService::update_feed] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_chronicle_v1::builder::feeds_service::UpdateFeed;
    /// # async fn sample() -> google_cloud_chronicle_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateFeed {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [FeedsService::list_feed_source_type_schemas][crate::client::FeedsService::list_feed_source_type_schemas] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_chronicle_v1::builder::feeds_service::ListFeedSourceTypeSchemas;
    /// # async fn sample() -> google_cloud_chronicle_v1::Result<()> {
    /// use google_cloud_gax::paginator::ItemPaginator;
    ///
    /// let builder = prepare_request_builder();
    ...
    /// # Ok(()) }
    ///
    /// fn prepare_request_builder() -> ListFeedSourceTypeSchemas {
    ///   # panic!();
    ///   // ... details omitted ...
    /// }
    /// ```
    #[derive(Clone, Debug)]
    pub struct ListFeedSourceTypeSchemas(
        RequestBuilder<crate::model::ListFeedSourceTypeSchemasRequest>,
    );

    impl ListFeedSourceTypeSchemas {
        pub(crate) fn new(
            stub: std::sync::Arc<dyn super::super::stub::dynamic::FeedsService>,
        ) -> Self {
            Self(RequestBuilder::new(stub))
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::ListFeedSourceTypeSchemasRequest>>(
            mut self,
            v: V,
        ) -> Self {
            self.0.request = v.into();
        ...
        /// Sends the request.
        pub async fn send(self) -> Result<crate::model::ListFeedSourceTypeSchemasResponse> {
            (*self.0.stub)
                .list_feed_source_type_schemas(self.0.request, self.0.options)
                .await
                .map(crate::Response::into_body)
        }
        ...
        pub fn by_page(
            ...
            crate::model::ListFeedSourceTypeSchemasResponse,
            crate::Error,
        > {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
        ...
        /// Sets the value of [parent][crate::model::ListFeedSourceTypeSchemasRequest::parent].
        ///
        /// This is a **required** field for requests.
        pub fn set_parent<T: Into<std::string::String>>(mut self, v: T) -> Self {
            self.0.request.parent = v.into();
        ...
        /// Sets the value of [page_size][crate::model::ListFeedSourceTypeSchemasRequest::page_size].
        pub fn set_page_size<T: Into<i32>>(mut self, v: T) -> Self {
            self.0.request.page_size = v.into();
            self
        }

        /// Sets the value of [page_token][crate::model::ListFeedSourceTypeSchemasRequest::page_token].
        pub fn set_page_token<T: Into<std::string::String>>(mut self, v: T) -> Self {
            self.0.request.page_token = v.into();
            self
        }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListFeedSourceTypeSchemas {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [FeedsService::list_log_type_schemas][crate::client::FeedsService::list_log_type_schemas] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_chronicle_v1::builder::feeds_service::ListLogTypeSchemas;
    /// # async fn sample() -> google_cloud_chronicle_v1::Result<()> {
    /// use google_cloud_gax::paginator::ItemPaginator;
    ///
    /// let builder = prepare_request_builder();
    ...
    /// # Ok(()) }
    ///
    /// fn prepare_request_builder() -> ListLogTypeSchemas {
    ///   # panic!();
    ///   // ... details omitted ...
    /// }
    /// ```
    #[derive(Clone, Debug)]
    pub struct ListLogTypeSchemas(RequestBuilder<crate::model::ListLogTypeSchemasRequest>);

    impl ListLogTypeSchemas {
        pub(crate) fn new(
            stub: std::sync::Arc<dyn super::super::stub::dynamic::FeedsService>,
        ) -> Self {
            Self(RequestBuilder::new(stub))
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::ListLogTypeSchemasRequest>>(
            mut self,
            v: V,
        ) -> Self {
            self.0.request = v.into();
        ...
        /// Sends the request.
        pub async fn send(self) -> Result<crate::model::ListLogTypeSchemasResponse> {
            (*self.0.stub)
                .list_log_type_schemas(self.0.request, self.0.options)
                .await
                .map(crate::Response::into_body)
        }
        ...
        pub fn by_page(
            ...
            crate::model::ListLogTypeSchemasResponse,
            crate::Error,
        > {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
        ...
        /// Sets the value of [parent][crate::model::ListLogTypeSchemasRequest::parent].
        ///
        /// This is a **required** field for requests.
        pub fn set_parent<T: Into<std::string::String>>(mut self, v: T) -> Self {
            self.0.request.parent = v.into();
        ...
        /// Sets the value of [page_size][crate::model::ListLogTypeSchemasRequest::page_size].
        pub fn set_page_size<T: Into<i32>>(mut self, v: T) -> Self {
            self.0.request.page_size = v.into();
            self
        }

        /// Sets the value of [page_token][crate::model::ListLogTypeSchemasRequest::page_token].
        pub fn set_page_token<T: Into<std::string::String>>(mut self, v: T) -> Self {
            self.0.request.page_token = v.into();
            self
        }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListLogTypeSchemas {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [FeedsService::import_push_logs][crate::client::FeedsService::import_push_logs] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_chronicle_v1::builder::feeds_service::ImportPushLogs;
    /// # async fn sample() -> google_cloud_chronicle_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    /// # Ok(()) }
    ///
    /// fn prepare_request_builder() -> ImportPushLogs {
    ///   # panic!();
    ///   // ... details omitted ...
    /// }
    /// ```
    #[derive(Clone, Debug)]
    pub struct ImportPushLogs(RequestBuilder<crate::model::ImportPushLogsRequest>);
    ...
    impl ImportPushLogs {
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::ImportPushLogsRequest>>(mut self, v: V) -> Self {
            self.0.request = v.into();
            self
        }
        ...
        pub async fn send(self) -> Result<google_cloud_api::model::HttpBody> {
            (*self.0.stub)
                .import_push_logs(self.0.request, self.0.options)
                .await
                .map(crate::Response::into_body)
        }

        /// Sets the value of [parent][crate::model::ImportPushLogsRequest::parent].
        ///
        /// This is a **required** field for requests.
        pub fn set_parent<T: Into<std::string::String>>(mut self, v: T) -> Self {
            self.0.request.parent = v.into();
        ...
        /// Sets the value of [http_body][crate::model::ImportPushLogsRequest::http_body].
        ///
        /// This is a **required** field for requests.
        ...
        /// Sets or clears the value of [http_body][crate::model::ImportPushLogsRequest::http_body].
        ///
        /// This is a **required** field for requests.
        ...
        /// Sets the value of [secret][crate::model::ImportPushLogsRequest::secret].
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ImportPushLogs {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [FeedsService::generate_secret][crate::client::FeedsService::generate_secret] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_chronicle_v1::builder::feeds_service::GenerateSecret;
    /// # async fn sample() -> google_cloud_chronicle_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    /// # Ok(()) }
    ///
    /// fn prepare_request_builder() -> GenerateSecret {
    ///   # panic!();
    ///   // ... details omitted ...
    /// }
    /// ```
    #[derive(Clone, Debug)]
    pub struct GenerateSecret(RequestBuilder<crate::model::GenerateSecretRequest>);
    ...
    impl GenerateSecret {
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::GenerateSecretRequest>>(mut self, v: V) -> Self {
            self.0.request = v.into();
            self
        }
        ...
        /// Sends the request.
        pub async fn send(self) -> Result<crate::model::GenerateSecretResponse> {
            (*self.0.stub)
                .generate_secret(self.0.request, self.0.options)
                .await
                .map(crate::Response::into_body)
        }

        /// Sets the value of [name][crate::model::GenerateSecretRequest::name].
        ///
        /// This is a **required** field for requests.
        pub fn set_name<T: Into<std::string::String>>(mut self, v: T) -> Self {
            self.0.request.name = v.into();
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GenerateSecret {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [FeedsService::list_operations][crate::client::FeedsService::list_operations] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_chronicle_v1::builder::feeds_service::ListOperations;
    /// # async fn sample() -> google_cloud_chronicle_v1::Result<()> {
    /// use google_cloud_gax::paginator::ItemPaginator;
    ///
    /// let builder = prepare_request_builder();
    ...
    /// The request builder for [FeedsService::get_operation][crate::client::FeedsService::get_operation] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_chronicle_v1::builder::feeds_service::GetOperation;
    /// # async fn sample() -> google_cloud_chronicle_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    ...
    /// The request builder for [FeedsService::delete_operation][crate::client::FeedsService::delete_operation] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_chronicle_v1::builder::feeds_service::DeleteOperation;
    /// # async fn sample() -> google_cloud_chronicle_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    ...
    /// The request builder for [FeedsService::cancel_operation][crate::client::FeedsService::cancel_operation] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_chronicle_v1::builder::feeds_service::CancelOperation;
    /// # async fn sample() -> google_cloud_chronicle_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
