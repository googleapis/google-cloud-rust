        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//chronicle.googleapis.com/v1/{}/dataAccessLabels",
                    var_parent,
                );
    ...
    async fn get_data_access_label(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//chronicle.googleapis.com/v1/{}", var_name,);
    ...
    async fn update_data_access_label(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//chronicle.googleapis.com/v1/{}",
                    var_data_access_label_name,
                );
    ...
    async fn create_data_access_scope(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//chronicle.googleapis.com/v1/{}/dataAccessScopes",
                    var_parent,
                );
    ...
    async fn list_watchlists(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//chronicle.googleapis.com/v1/{}/watchlists", var_parent,);
    ...
    async fn list_reference_lists(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//chronicle.googleapis.com/v1/{}/referenceLists",
                    var_parent,
                );
    ...
    async fn create_rule(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//chronicle.googleapis.com/v1/{}/rules", var_parent,);
    ...
    async fn create_retrohunt(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//chronicle.googleapis.com/v1/{}/retrohunts", var_parent,);
    ...
    async fn list_rule_deployments(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//chronicle.googleapis.com/v1/{}/deployments", var_parent,);
