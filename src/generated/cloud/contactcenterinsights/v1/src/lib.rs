...
//! 
//!
//! This crate contains traits, types, and functions to interact with Contact Center AI Insights API
...
const DEFAULT_HOST: &str = "https://contactcenterinsights.googleapis.com/";
