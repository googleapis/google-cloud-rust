...
/// Implements a [ContactCenterInsights](crate::stubs::ContactCenterInsights) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ContactCenterInsights<T>
where
    T: crate::stubs::ContactCenterInsights + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ContactCenterInsights for ContactCenterInsights<T>
where
    T: crate::stubs::ContactCenterInsights + std::fmt::Debug + Send + Sync,
{
