...
/// Implements a [ContactCenterInsights](super::stubs::ContactCenterInsights) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ContactCenterInsights<T>
where
    T: super::stubs::ContactCenterInsights + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ContactCenterInsights for ContactCenterInsights<T>
where
    T: super::stubs::ContactCenterInsights + std::fmt::Debug + Send + Sync,
{
