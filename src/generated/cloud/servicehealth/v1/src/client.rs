...
/// [with_credentials()]: super::builder::service_health::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `ServiceHealth` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
#[derive(Clone, Debug)]
pub struct ServiceHealth {
    inner: std::sync::Arc<dyn super::stub::dynamic::ServiceHealth>,
}
...
impl ServiceHealth {
    ...
    pub fn builder() -> super::builder::service_health::ClientBuilder {
        crate::new_client_builder(super::builder::service_health::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::ServiceHealth>> {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::ServiceHealth> {
