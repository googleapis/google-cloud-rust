...
/// Implements a [ServiceHealth](super::stubs::ServiceHealth) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ServiceHealth<T>
where
    T: super::stubs::ServiceHealth + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ServiceHealth for ServiceHealth<T>
where
    T: super::stubs::ServiceHealth + std::fmt::Debug + Send + Sync,
{
