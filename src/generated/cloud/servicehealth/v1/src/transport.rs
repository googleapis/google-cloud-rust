    ...
    async fn list_events(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//servicehealth.googleapis.com/v1/{}/events", var_parent,);
    ...
    async fn get_event(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//servicehealth.googleapis.com/v1/{}", var_name,);
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//servicehealth.googleapis.com/v1/{}/organizationEvents",
                    var_parent,
                );
    ...
    async fn list_organization_impacts(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//servicehealth.googleapis.com/v1/{}/organizationImpacts",
                    var_parent,
                );
