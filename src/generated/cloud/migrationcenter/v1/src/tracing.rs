...
/// Implements a [MigrationCenter](super::stubs::MigrationCenter) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct MigrationCenter<T>
where
    T: super::stubs::MigrationCenter + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::MigrationCenter for MigrationCenter<T>
where
    T: super::stubs::MigrationCenter + std::fmt::Debug + Send + Sync,
{
