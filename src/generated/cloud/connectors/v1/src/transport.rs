    ...
    async fn update_connection(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//connectors.googleapis.com/{}", var_connection_name,);
    ...
    async fn list_runtime_entity_schemas(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/runtimeEntitySchemas";
    ...
    async fn list_runtime_action_schemas(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/runtimeActionSchemas";
