...
impl Destination {
    ...
    /// ```
    /// # use google_cloud_connectors_v1::model::Destination;
    /// use google_cloud_connectors_v1::model::destination::Destination;
    /// let x = Destination::new().set_destination(Some(Destination::ServiceAttachment("example".to_string())));
    /// ```
