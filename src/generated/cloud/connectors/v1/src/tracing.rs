...
/// Implements a [Connectors](super::stubs::Connectors) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Connectors<T>
where
    T: super::stubs::Connectors + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Connectors for Connectors<T>
where
    T: super::stubs::Connectors + std::fmt::Debug + Send + Sync,
{
