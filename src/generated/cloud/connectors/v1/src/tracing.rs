...
/// Implements a [Connectors](crate::stubs::Connectors) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Connectors<T>
where
    T: crate::stubs::Connectors + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::Connectors for Connectors<T>
where
    T: crate::stubs::Connectors + std::fmt::Debug + Send + Sync,
{
