...
/// Request and client builders for [Connectors][crate::client::Connectors].
pub mod connectors {
    use crate::Result;
    ...
    impl CreateConnection {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Connection, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_connectors_v1::client::Connectors::create_connection::until_done";
            }
    ...
    impl UpdateConnection {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Connection, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_connectors_v1::client::Connectors::update_connection::until_done";
            }
    ...
    impl DeleteConnection {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_connectors_v1::client::Connectors::delete_connection::until_done";
            }
    ...
    impl RefreshConnectionSchemaMetadata {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_connectors_v1::client::Connectors::refresh_connection_schema_metadata::until_done";
            }
