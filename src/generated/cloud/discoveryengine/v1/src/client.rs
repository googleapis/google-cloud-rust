...
/// [with_credentials()]: super::builder::assistant_service::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `AssistantService` in
...
/// [with_credentials()]: super::builder::cmek_config_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `CmekConfigService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
...
impl CmekConfigService {
    ...
    /// ) -> Result<()> {
    ///     let response = client.list_cmek_configs()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
...
impl CompletionService {
    ...
    ///    client: &CompletionService
    /// ) -> Result<()> {
    ///     let response = client.import_suggestion_deny_list_entries()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &CompletionService
    /// ) -> Result<()> {
    ///     let response = client.purge_suggestion_deny_list_entries()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &CompletionService
    /// ) -> Result<()> {
    ///     let response = client.purge_completion_suggestions()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
...
impl ConversationalSearchService {
    ...
    /// ) -> Result<()> {
    ///     let response = client.converse_conversation()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
...
/// [with_credentials()]: super::builder::data_store_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `DataStoreService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
...
impl DataStoreService {
    ...
    /// use google_cloud_discoveryengine_v1::Result;
    /// async fn sample(
    ///    client: &DataStoreService, parent: &str
    /// ) -> Result<()> {
    ///     let response = client.create_data_store()
    ///         .set_parent(parent)
    ///         .set_data_store(
    ///             DataStore::new()/* set fields */
    ///         )
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
...
/// [with_credentials()]: super::builder::document_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// [with_credentials()]: super::builder::engine_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `EngineService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
...
/// [with_credentials()]: super::builder::grounded_generation_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `GroundedGenerationService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
...
impl GroundedGenerationService {
    ...
    ///    client: &GroundedGenerationService
    /// ) -> Result<()> {
    ///     let response = client.check_grounding()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
...
/// [with_credentials()]: super::builder::identity_mapping_store_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `IdentityMappingStoreService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
...
impl IdentityMappingStoreService {
    ...
    /// use google_cloud_discoveryengine_v1::Result;
    /// async fn sample(
    ///    client: &IdentityMappingStoreService, parent: &str
    /// ) -> Result<()> {
    ///     let response = client.create_identity_mapping_store()
    ///         .set_parent(parent)
    ///         .set_identity_mapping_store(
    ///             IdentityMappingStore::new()/* set fields */
    ///         )
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    /// ) -> Result<()> {
    ///     let response = client.import_identity_mappings()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &IdentityMappingStoreService
    /// ) -> Result<()> {
    ///     let mut list = client.list_identity_mappings()
    ///         /* set fields */
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
...
/// [with_credentials()]: super::builder::rank_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `RankService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
...
/// [with_credentials()]: super::builder::recommendation_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `RecommendationService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
...
impl SearchService {
    ...
    ///    client: &SearchService
    /// ) -> Result<()> {
    ///     let mut list = client.search_lite()
    ///         /* set fields */
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
...
/// [with_credentials()]: super::builder::search_tuning_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `SearchTuningService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
...
impl SearchTuningService {
    ...
    ///    client: &SearchTuningService
    /// ) -> Result<()> {
    ///     let response = client.list_custom_models()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
...
/// [with_credentials()]: super::builder::site_search_engine_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `SiteSearchEngineService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
...
impl SiteSearchEngineService {
    ...
    /// ) -> Result<()> {
    ///     let response = client.batch_create_target_sites()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &SiteSearchEngineService
    /// ) -> Result<()> {
    ///     let response = client.fetch_sitemaps()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &SiteSearchEngineService
    /// ) -> Result<()> {
    ///     let response = client.enable_advanced_site_search()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &SiteSearchEngineService
    /// ) -> Result<()> {
    ///     let response = client.disable_advanced_site_search()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &SiteSearchEngineService
    /// ) -> Result<()> {
    ///     let response = client.recrawl_uris()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &SiteSearchEngineService
    /// ) -> Result<()> {
    ///     let response = client.batch_verify_target_sites()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &SiteSearchEngineService
    /// ) -> Result<()> {
    ///     let mut list = client.fetch_domain_verification_status()
    ///         /* set fields */
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
...
/// [with_credentials()]: super::builder::user_license_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `UserLicenseService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
...
impl UserLicenseService {
    ...
    ///    client: &UserLicenseService
    /// ) -> Result<()> {
    ///     let response = client.batch_update_user_licenses()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
