...
/// Implements a [ConversationalSearchService](super::stubs::ConversationalSearchService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ConversationalSearchService<T>
where
    T: super::stubs::ConversationalSearchService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ConversationalSearchService for ConversationalSearchService<T>
where
    T: super::stubs::ConversationalSearchService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [DataStoreService](super::stubs::DataStoreService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DataStoreService<T>
where
    T: super::stubs::DataStoreService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::DataStoreService for DataStoreService<T>
where
    T: super::stubs::DataStoreService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [DocumentService](super::stubs::DocumentService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DocumentService<T>
where
    T: super::stubs::DocumentService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::DocumentService for DocumentService<T>
where
    T: super::stubs::DocumentService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [EngineService](super::stubs::EngineService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct EngineService<T>
where
    T: super::stubs::EngineService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::EngineService for EngineService<T>
where
    T: super::stubs::EngineService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [GroundedGenerationService](super::stubs::GroundedGenerationService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct GroundedGenerationService<T>
where
    T: super::stubs::GroundedGenerationService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::GroundedGenerationService for GroundedGenerationService<T>
where
    T: super::stubs::GroundedGenerationService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [RankService](super::stubs::RankService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct RankService<T>
where
    T: super::stubs::RankService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::RankService for RankService<T>
where
    T: super::stubs::RankService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [RecommendationService](super::stubs::RecommendationService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct RecommendationService<T>
where
    T: super::stubs::RecommendationService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::RecommendationService for RecommendationService<T>
where
    T: super::stubs::RecommendationService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [SchemaService](super::stubs::SchemaService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SchemaService<T>
where
    T: super::stubs::SchemaService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::SchemaService for SchemaService<T>
where
    T: super::stubs::SchemaService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [SearchTuningService](super::stubs::SearchTuningService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SearchTuningService<T>
where
    T: super::stubs::SearchTuningService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::SearchTuningService for SearchTuningService<T>
where
    T: super::stubs::SearchTuningService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [SiteSearchEngineService](super::stubs::SiteSearchEngineService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SiteSearchEngineService<T>
where
    T: super::stubs::SiteSearchEngineService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::SiteSearchEngineService for SiteSearchEngineService<T>
where
    T: super::stubs::SiteSearchEngineService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
