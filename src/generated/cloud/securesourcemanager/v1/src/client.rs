...
/// [with_credentials()]: super::builder::secure_source_manager::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `SecureSourceManager` in
