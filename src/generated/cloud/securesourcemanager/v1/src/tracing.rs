...
/// Implements a [SecureSourceManager](crate::stubs::SecureSourceManager) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SecureSourceManager<T>
where
    T: crate::stubs::SecureSourceManager + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::SecureSourceManager for SecureSourceManager<T>
where
    T: crate::stubs::SecureSourceManager + std::fmt::Debug + Send + Sync,
{
