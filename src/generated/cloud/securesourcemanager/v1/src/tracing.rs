...
/// Implements a [SecureSourceManager](super::stubs::SecureSourceManager) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SecureSourceManager<T>
where
    T: super::stubs::SecureSourceManager + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::SecureSourceManager for SecureSourceManager<T>
where
    T: super::stubs::SecureSourceManager + std::fmt::Debug + Send + Sync,
{
