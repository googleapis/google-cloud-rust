...
impl PullRequestComment {
    ...
    /// ```
    /// # use google_cloud_securesourcemanager_v1::model::PullRequestComment;
    /// use google_cloud_securesourcemanager_v1::model::pull_request_comment;
    /// use google_cloud_securesourcemanager_v1::model::pull_request_comment::Review;
    /// let x = PullRequestComment::new().set_comment_detail(Some(pull_request_comment::CommentDetail::Review(Review::default().into())));
    /// ```
