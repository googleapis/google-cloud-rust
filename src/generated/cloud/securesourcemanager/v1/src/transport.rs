...
impl super::stub::SecureSourceManager for SecureSourceManager {
    ...
    async fn create_instance(
        ...
        let options = {
            let resource_name = Option::<&String>::None
                ...
                .or_else(|| req.instance.as_ref().and_then(|s| Some(&s.kms_key)));
            if let Some(rn) = resource_name {
                let full_resource_name = format!("//securesourcemanager.googleapis.com/{}", rn);
                gax::options::internal::set_resource_name(options, full_resource_name)
            } else {
    ...
    async fn create_repository(
        ...
        let options = {
            let resource_name = Option::<&String>::None
                .or_else(|| Some(&req.parent))
                .or_else(|| req.repository.as_ref().and_then(|s| Some(&s.instance)));
            if let Some(rn) = resource_name {
                let full_resource_name = format!("//securesourcemanager.googleapis.com/{}", rn);
                gax::options::internal::set_resource_name(options, full_resource_name)
            } else {
    ...
    async fn fetch_tree(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        let options = {
            let resource_name = Option::<&String>::None.or_else(|| Some(&req.repository));
            if let Some(rn) = resource_name {
                let full_resource_name = format!("//securesourcemanager.googleapis.com/{}", rn);
                gax::options::internal::set_resource_name(options, full_resource_name)
            } else {
