...
impl CycleStep {
    ...
    /// ```
    /// # use google_cloud_vmmigration_v1::model::CycleStep;
    /// use google_cloud_vmmigration_v1::model::cycle_step;
    /// use google_cloud_vmmigration_v1::model::InitializingReplicationStep;
    /// let x = CycleStep::new().set_step(Some(cycle_step::Step::InitializingReplication(InitializingReplicationStep::default().into())));
    /// ```
...
impl MigratingVm {
    ...
    /// ```
    /// # use google_cloud_vmmigration_v1::model::MigratingVm;
    /// use google_cloud_vmmigration_v1::model::migrating_vm;
    /// use google_cloud_vmmigration_v1::model::ComputeEngineTargetDefaults;
    /// let x = MigratingVm::new().set_target_vm_defaults(Some(migrating_vm::TargetVmDefaults::ComputeEngineTargetDefaults(ComputeEngineTargetDefaults::default().into())));
    /// ```
    ...
    /// let x = MigratingVm::new().set_source_vm_details(Some(migrating_vm::SourceVmDetails::VmwareSourceVmDetails(VmwareSourceVmDetails::default().into())));
    /// ```
...
impl CloneJob {
    ...
    /// ```
    /// # use google_cloud_vmmigration_v1::model::CloneJob;
    /// use google_cloud_vmmigration_v1::model::clone_job;
    /// use google_cloud_vmmigration_v1::model::ComputeEngineTargetDetails;
    /// let x = CloneJob::new().set_target_vm_details(Some(clone_job::TargetVmDetails::ComputeEngineTargetDetails(ComputeEngineTargetDetails::default().into())));
    /// ```
...
impl CloneStep {
    ...
    /// ```
    /// # use google_cloud_vmmigration_v1::model::CloneStep;
    /// use google_cloud_vmmigration_v1::model::clone_step;
    /// use google_cloud_vmmigration_v1::model::AdaptingOSStep;
    /// let x = CloneStep::new().set_step(Some(clone_step::Step::AdaptingOs(AdaptingOSStep::default().into())));
    /// ```
...
impl CutoverJob {
    ...
    /// ```
    /// # use google_cloud_vmmigration_v1::model::CutoverJob;
    /// use google_cloud_vmmigration_v1::model::cutover_job;
    /// use google_cloud_vmmigration_v1::model::ComputeEngineTargetDetails;
    /// let x = CutoverJob::new().set_target_vm_details(Some(cutover_job::TargetVmDetails::ComputeEngineTargetDetails(ComputeEngineTargetDetails::default().into())));
    /// ```
    pub fn set_target_vm_details<
...
impl CutoverStep {
    ...
    /// ```
    /// # use google_cloud_vmmigration_v1::model::CutoverStep;
    /// use google_cloud_vmmigration_v1::model::cutover_step;
    /// use google_cloud_vmmigration_v1::model::ReplicationCycle;
    /// let x = CutoverStep::new().set_step(Some(cutover_step::Step::PreviousReplicationCycle(ReplicationCycle::default().into())));
    /// ```
    pub fn set_step<
...
impl Source {
    ...
    /// let x = Source::new().set_source_details(Some(source::SourceDetails::Vmware(VmwareSourceDetails::default().into())));
    /// ```
...
impl AwsSourceDetails {
    ...
    /// ```
    /// # use google_cloud_vmmigration_v1::model::AwsSourceDetails;
    /// use google_cloud_vmmigration_v1::model::aws_source_details;
    /// use google_cloud_vmmigration_v1::model::aws_source_details::AccessKeyCredentials;
    /// let x = AwsSourceDetails::new().set_credentials_type(Some(aws_source_details::CredentialsType::AccessKeyCreds(AccessKeyCredentials::default().into())));
    /// ```
...
impl AzureSourceDetails {
    ...
    /// ```
    /// # use google_cloud_vmmigration_v1::model::AzureSourceDetails;
    /// use google_cloud_vmmigration_v1::model::azure_source_details;
    /// use google_cloud_vmmigration_v1::model::azure_source_details::ClientSecretCredentials;
    /// let x = AzureSourceDetails::new().set_credentials_type(Some(azure_source_details::CredentialsType::ClientSecretCreds(ClientSecretCredentials::default().into())));
    /// ```
    pub fn set_credentials_type<
        T: std::convert::Into<
...
impl FetchInventoryResponse {
    ...
    /// ```
    /// # use google_cloud_vmmigration_v1::model::FetchInventoryResponse;
    /// use google_cloud_vmmigration_v1::model::fetch_inventory_response;
    /// use google_cloud_vmmigration_v1::model::VmwareVmsDetails;
    /// let x = FetchInventoryResponse::new().set_source_vms(Some(fetch_inventory_response::SourceVms::VmwareVms(VmwareVmsDetails::default().into())));
    /// ```
...
impl SourceStorageResource {
    ...
    /// ```
    /// # use google_cloud_vmmigration_v1::model::SourceStorageResource;
    /// use google_cloud_vmmigration_v1::model::source_storage_resource;
    /// use google_cloud_vmmigration_v1::model::AwsSourceDiskDetails;
    /// let x = SourceStorageResource::new().set_storage_resource(Some(source_storage_resource::StorageResource::AwsDiskDetails(AwsSourceDiskDetails::default().into())));
    /// ```
...
impl VmUtilizationInfo {
    ...
    /// ```
    /// # use google_cloud_vmmigration_v1::model::VmUtilizationInfo;
    /// use google_cloud_vmmigration_v1::model::vm_utilization_info;
    /// use google_cloud_vmmigration_v1::model::VmwareVmDetails;
    /// let x = VmUtilizationInfo::new().set_vm_details(Some(vm_utilization_info::VmDetails::VmwareVmDetails(VmwareVmDetails::default().into())));
    /// ```
...
impl ComputeEngineDisksTargetDefaults {
    ...
    /// ```
    /// # use google_cloud_vmmigration_v1::model::ComputeEngineDisksTargetDefaults;
    /// use google_cloud_vmmigration_v1::model::compute_engine_disks_target_defaults;
    /// let x = ComputeEngineDisksTargetDefaults::new().set_location(Some(compute_engine_disks_target_defaults::Location::Zone("example".to_string())));
    /// ```
    pub fn set_location<
        T: std::convert::Into<
    ...
    /// let x = ComputeEngineDisksTargetDefaults::new().set_vm_target(Some(compute_engine_disks_target_defaults::VmTarget::DisksTargetDefaults(DisksMigrationDisksTargetDefaults::default().into())));
    /// ```
...
impl BootDiskDefaults {
    ...
    /// ```
    /// # use google_cloud_vmmigration_v1::model::BootDiskDefaults;
    /// use google_cloud_vmmigration_v1::model::boot_disk_defaults;
    /// use google_cloud_vmmigration_v1::model::boot_disk_defaults::DiskImageDefaults;
    /// let x = BootDiskDefaults::new().set_source(Some(boot_disk_defaults::Source::Image(DiskImageDefaults::default().into())));
    /// ```
    pub fn set_source<
...
impl ComputeEngineDisksTargetDetails {
    ...
    /// ```
    /// # use google_cloud_vmmigration_v1::model::ComputeEngineDisksTargetDetails;
    /// use google_cloud_vmmigration_v1::model::compute_engine_disks_target_details;
    /// use google_cloud_vmmigration_v1::model::DisksMigrationDisksTargetDetails;
    /// let x = ComputeEngineDisksTargetDetails::new().set_vm_target(Some(compute_engine_disks_target_details::VmTarget::DisksTargetDetails(DisksMigrationDisksTargetDetails::default().into())));
    /// ```
    pub fn set_vm_target<
        T: std::convert::Into<
...
impl ImageImport {
    ...
    /// ```
    /// # use google_cloud_vmmigration_v1::model::ImageImport;
    /// use google_cloud_vmmigration_v1::model::image_import;
    /// let x = ImageImport::new().set_source(Some(image_import::Source::CloudStorageUri("example".to_string())));
    /// ```
    pub fn set_source<
    ...
    /// let x = ImageImport::new().set_target_defaults(Some(image_import::TargetDefaults::DiskImageTargetDefaults(DiskImageTargetDetails::default().into())));
    /// ```
...
impl ImageImportJob {
    ...
    /// ```
    /// # use google_cloud_vmmigration_v1::model::ImageImportJob;
    /// use google_cloud_vmmigration_v1::model::image_import_job;
    /// let x = ImageImportJob::new().set_source(Some(image_import_job::Source::CloudStorageUri("example".to_string())));
    /// ```
    pub fn set_source<
    ...
    /// use google_cloud_vmmigration_v1::model::image_import_job;
    /// use google_cloud_vmmigration_v1::model::DiskImageTargetDetails;
    /// let x = ImageImportJob::new().set_target_details(Some(image_import_job::TargetDetails::DiskImageTargetDetails(DiskImageTargetDetails::default().into())));
    /// ```
...
impl ImageImportStep {
    ...
    /// ```
    /// # use google_cloud_vmmigration_v1::model::ImageImportStep;
    /// use google_cloud_vmmigration_v1::model::image_import_step;
    /// use google_cloud_vmmigration_v1::model::InitializingImageImportStep;
    /// let x = ImageImportStep::new().set_step(Some(image_import_step::Step::Initializing(InitializingImageImportStep::default().into())));
    /// ```
    pub fn set_step<
...
impl DiskImageTargetDetails {
    ...
    /// ```
    /// # use google_cloud_vmmigration_v1::model::DiskImageTargetDetails;
    /// use google_cloud_vmmigration_v1::model::disk_image_target_details;
    /// use google_cloud_vmmigration_v1::model::ImageImportOsAdaptationParameters;
    /// let x = DiskImageTargetDetails::new().set_os_adaptation_config(Some(disk_image_target_details::OsAdaptationConfig::OsAdaptationParameters(ImageImportOsAdaptationParameters::default().into())));
    /// ```
...
impl MachineImageTargetDetails {
    ...
    /// ```
    /// # use google_cloud_vmmigration_v1::model::MachineImageTargetDetails;
    /// use google_cloud_vmmigration_v1::model::machine_image_target_details;
    /// use google_cloud_vmmigration_v1::model::ImageImportOsAdaptationParameters;
    /// let x = MachineImageTargetDetails::new().set_os_adaptation_config(Some(machine_image_target_details::OsAdaptationConfig::OsAdaptationParameters(ImageImportOsAdaptationParameters::default().into())));
    /// ```
    pub fn set_os_adaptation_config<
        T: std::convert::Into<
                std::option::Option<crate::model::machine_image_target_details::OsAdaptationConfig>,
...
impl DiskMigrationJob {
    ...
    /// ```
    /// # use google_cloud_vmmigration_v1::model::DiskMigrationJob;
    /// use google_cloud_vmmigration_v1::model::disk_migration_job;
    /// use google_cloud_vmmigration_v1::model::AwsSourceDiskDetails;
    /// let x = DiskMigrationJob::new().set_source_disk_details(Some(disk_migration_job::SourceDiskDetails::AwsSourceDiskDetails(AwsSourceDiskDetails::default().into())));
    /// ```
...
impl DiskMigrationJobTargetDetails {
    ...
    /// ```
    /// # use google_cloud_vmmigration_v1::model::DiskMigrationJobTargetDetails;
    /// use google_cloud_vmmigration_v1::model::disk_migration_job_target_details;
    /// use google_cloud_vmmigration_v1::model::ComputeEngineDisk;
    /// let x = DiskMigrationJobTargetDetails::new().set_target_storage(Some(disk_migration_job_target_details::TargetStorage::TargetDisk(ComputeEngineDisk::default().into())));
    /// ```
...
impl DiskMigrationStep {
    ...
    /// ```
    /// # use google_cloud_vmmigration_v1::model::DiskMigrationStep;
    /// use google_cloud_vmmigration_v1::model::disk_migration_step;
    /// use google_cloud_vmmigration_v1::model::CreatingSourceDiskSnapshotStep;
    /// let x = DiskMigrationStep::new().set_step(Some(disk_migration_step::Step::CreatingSourceDiskSnapshot(CreatingSourceDiskSnapshotStep::default().into())));
    /// ```
    pub fn set_step<
