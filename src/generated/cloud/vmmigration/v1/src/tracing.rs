...
/// Implements a [VmMigration](super::stubs::VmMigration) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct VmMigration<T>
where
    T: super::stubs::VmMigration + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::VmMigration for VmMigration<T>
where
    T: super::stubs::VmMigration + std::fmt::Debug + Send + Sync,
{
