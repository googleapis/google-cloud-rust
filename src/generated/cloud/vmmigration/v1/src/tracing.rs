...
/// Implements a [VmMigration](crate::stubs::VmMigration) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct VmMigration<T>
where
    T: crate::stubs::VmMigration + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::VmMigration for VmMigration<T>
where
    T: crate::stubs::VmMigration + std::fmt::Debug + Send + Sync,
{
