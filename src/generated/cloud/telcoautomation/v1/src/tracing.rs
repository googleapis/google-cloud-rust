...
/// Implements a [TelcoAutomation](crate::stubs::TelcoAutomation) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct TelcoAutomation<T>
where
    T: crate::stubs::TelcoAutomation + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::TelcoAutomation for TelcoAutomation<T>
where
    T: crate::stubs::TelcoAutomation + std::fmt::Debug + Send + Sync,
{
