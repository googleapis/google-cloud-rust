...
pub trait TelcoAutomation: std::fmt::Debug + Send + Sync {
    ...
    fn list_orchestration_clusters(
        ...
        Output = crate::Result<crate::model::ListOrchestrationClustersResponse>,
    > + Send {
        std::future::ready::<crate::Result<crate::model::ListOrchestrationClustersResponse>>(Err(
    ...
    fn get_orchestration_cluster(
        ...
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::OrchestrationCluster>> + Send
    {
        std::future::ready::<crate::Result<crate::model::OrchestrationCluster>>(Err(Error::other(
            "unimplemented",
        )))
    }
    ...
    fn list_edge_slms(
        ...
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::ListEdgeSlmsResponse>> + Send
    {
        std::future::ready::<crate::Result<crate::model::ListEdgeSlmsResponse>>(Err(Error::other(
            "unimplemented",
        )))
    }
    ...
    fn get_edge_slm(
        ...
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::EdgeSlm>> + Send {
        std::future::ready::<crate::Result<crate::model::EdgeSlm>>(Err(Error::other(
            "unimplemented",
        )))
    }
    ...
    fn create_blueprint(
        ...
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::Blueprint>> + Send {
        std::future::ready::<crate::Result<crate::model::Blueprint>>(Err(Error::other(
            "unimplemented",
        )))
    }
    ...
    fn list_blueprints(
        ...
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::ListBlueprintsResponse>> + Send
    {
        std::future::ready::<crate::Result<crate::model::ListBlueprintsResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }
    ...
    fn list_blueprint_revisions(
        ...
        Output = crate::Result<crate::model::ListBlueprintRevisionsResponse>,
    > + Send {
        std::future::ready::<crate::Result<crate::model::ListBlueprintRevisionsResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }
    ...
    fn search_blueprint_revisions(
        ...
        Output = crate::Result<crate::model::SearchBlueprintRevisionsResponse>,
    > + Send {
        std::future::ready::<crate::Result<crate::model::SearchBlueprintRevisionsResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }
    ...
    fn search_deployment_revisions(
        ...
        Output = crate::Result<crate::model::SearchDeploymentRevisionsResponse>,
    > + Send {
        std::future::ready::<crate::Result<crate::model::SearchDeploymentRevisionsResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }
    ...
    fn discard_blueprint_changes(
        ...
        Output = crate::Result<crate::model::DiscardBlueprintChangesResponse>,
    > + Send {
        std::future::ready::<crate::Result<crate::model::DiscardBlueprintChangesResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }
    ...
    fn list_public_blueprints(
        ...
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::ListPublicBlueprintsResponse>>
    + Send {
        std::future::ready::<crate::Result<crate::model::ListPublicBlueprintsResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }
    ...
    fn get_public_blueprint(
        ...
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::PublicBlueprint>> + Send
    {
        std::future::ready::<crate::Result<crate::model::PublicBlueprint>>(Err(Error::other(
            "unimplemented",
        )))
    }
    ...
    fn list_deployment_revisions(
        ...
        Output = crate::Result<crate::model::ListDeploymentRevisionsResponse>,
    > + Send {
        std::future::ready::<crate::Result<crate::model::ListDeploymentRevisionsResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }
    ...
    fn discard_deployment_changes(
        ...
        Output = crate::Result<crate::model::DiscardDeploymentChangesResponse>,
    > + Send {
        std::future::ready::<crate::Result<crate::model::DiscardDeploymentChangesResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }
    ...
    fn compute_deployment_status(
        ...
        Output = crate::Result<crate::model::ComputeDeploymentStatusResponse>,
    > + Send {
        std::future::ready::<crate::Result<crate::model::ComputeDeploymentStatusResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }
    ...
    fn get_hydrated_deployment(
        ...
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::HydratedDeployment>> + Send
    {
        std::future::ready::<crate::Result<crate::model::HydratedDeployment>>(Err(Error::other(
            "unimplemented",
        )))
    }
    ...
    fn list_hydrated_deployments(
        ...
        Output = crate::Result<crate::model::ListHydratedDeploymentsResponse>,
    > + Send {
        std::future::ready::<crate::Result<crate::model::ListHydratedDeploymentsResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }
