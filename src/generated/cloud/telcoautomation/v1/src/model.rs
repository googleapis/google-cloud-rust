...
impl ManagementConfig {
    ...
    /// ```
    /// # use google_cloud_telcoautomation_v1::model::ManagementConfig;
    /// use google_cloud_telcoautomation_v1::model::management_config;
    /// use google_cloud_telcoautomation_v1::model::StandardManagementConfig;
    /// let x = ManagementConfig::new().set_oneof_config(Some(management_config::OneofConfig::StandardManagementConfig(StandardManagementConfig::default().into())));
    /// ```
