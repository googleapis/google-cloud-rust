...
/// Implements [IdentityAwareProxyAdminService](super::stubs::IdentityAwareProxyAdminService) using a [gaxi::ReqwestClient].
#[derive(Clone)]
...
/// Implements [IdentityAwareProxyOAuthService](super::stubs::IdentityAwareProxyOAuthService) using a [gaxi::ReqwestClient].
#[derive(Clone)]
