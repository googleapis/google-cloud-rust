    ...
    async fn get_iap_settings(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:iapSettings";
    ...
    async fn update_iap_settings(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{iap_settings.name}:iapSettings";

                let resource_name = format!("//iap.googleapis.com/{}", var_iap_settings_name,);
    ...
    async fn validate_iap_attribute_expression(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:validateAttributeExpression";
    ...
    async fn list_tunnel_dest_groups(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/destGroups";
    ...
    async fn update_tunnel_dest_group(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{tunnel_dest_group.name}";

                let resource_name = format!("//iap.googleapis.com/{}", var_tunnel_dest_group_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn list_brands(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/brands";
    ...
    async fn create_identity_aware_proxy_client(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/identityAwareProxyClients";
    ...
    async fn reset_identity_aware_proxy_client_secret(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:resetSecret";
