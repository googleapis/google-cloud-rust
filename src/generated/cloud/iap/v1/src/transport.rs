    ...
    async fn set_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//iap.googleapis.com/v1/{}", var_resource,);
    ...
    async fn list_tunnel_dest_groups(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//iap.googleapis.com/v1/{}/destGroups", var_parent,);
    ...
    async fn get_tunnel_dest_group(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//iap.googleapis.com/v1/{}", var_name,);
