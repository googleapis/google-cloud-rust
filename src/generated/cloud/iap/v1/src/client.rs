...
/// [with_credentials()]: super::builder::identity_aware_proxy_admin_service::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `IdentityAwareProxyAdminService` in
...
impl IdentityAwareProxyAdminService {
    ...
    ///    client: &IdentityAwareProxyAdminService
    /// ) -> Result<()> {
    ///     let response = client.get_iap_settings()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &IdentityAwareProxyAdminService
    /// ) -> Result<()> {
    ///     let response = client.update_iap_settings()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &IdentityAwareProxyAdminService
    /// ) -> Result<()> {
    ///     let response = client.validate_iap_attribute_expression()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
...
/// [with_credentials()]: super::builder::identity_aware_proxy_o_auth_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `IdentityAwareProxyOAuthService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
#[derive(Clone, Debug)]
...
impl IdentityAwareProxyOAuthService {
    ...
    ///    client: &IdentityAwareProxyOAuthService
    /// ) -> Result<()> {
    ///     let response = client.create_brand()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &IdentityAwareProxyOAuthService
    /// ) -> Result<()> {
    ///     let response = client.create_identity_aware_proxy_client()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &IdentityAwareProxyOAuthService
    /// ) -> Result<()> {
    ///     let mut list = client.list_identity_aware_proxy_clients()
    ///         /* set fields */
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &IdentityAwareProxyOAuthService
    /// ) -> Result<()> {
    ///     let response = client.get_identity_aware_proxy_client()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &IdentityAwareProxyOAuthService
    /// ) -> Result<()> {
    ///     let response = client.reset_identity_aware_proxy_client_secret()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
