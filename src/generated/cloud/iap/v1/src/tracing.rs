...
/// Implements a [IdentityAwareProxyAdminService](crate::stubs::IdentityAwareProxyAdminService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct IdentityAwareProxyAdminService<T>
where
    T: crate::stubs::IdentityAwareProxyAdminService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::IdentityAwareProxyAdminService for IdentityAwareProxyAdminService<T>
where
    T: crate::stubs::IdentityAwareProxyAdminService + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [IdentityAwareProxyOAuthService](crate::stubs::IdentityAwareProxyOAuthService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct IdentityAwareProxyOAuthService<T>
where
    T: crate::stubs::IdentityAwareProxyOAuthService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::IdentityAwareProxyOAuthService for IdentityAwareProxyOAuthService<T>
where
    T: crate::stubs::IdentityAwareProxyOAuthService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
