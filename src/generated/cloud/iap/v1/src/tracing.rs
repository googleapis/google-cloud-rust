...
/// Implements a [IdentityAwareProxyAdminService](super::stubs::IdentityAwareProxyAdminService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct IdentityAwareProxyAdminService<T>
where
    T: super::stubs::IdentityAwareProxyAdminService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::IdentityAwareProxyAdminService for IdentityAwareProxyAdminService<T>
where
    T: super::stubs::IdentityAwareProxyAdminService + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [IdentityAwareProxyOAuthService](super::stubs::IdentityAwareProxyOAuthService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct IdentityAwareProxyOAuthService<T>
where
    T: super::stubs::IdentityAwareProxyOAuthService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::IdentityAwareProxyOAuthService for IdentityAwareProxyOAuthService<T>
where
    T: super::stubs::IdentityAwareProxyOAuthService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
