...
/// Implements a [ImageVersions](super::stubs::ImageVersions) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ImageVersions<T>
where
    T: super::stubs::ImageVersions + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ImageVersions for ImageVersions<T>
where
    T: super::stubs::ImageVersions + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
