...
/// Implements a [ImageVersions](crate::stubs::ImageVersions) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ImageVersions<T>
where
    T: crate::stubs::ImageVersions + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ImageVersions for ImageVersions<T>
where
    T: crate::stubs::ImageVersions + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
