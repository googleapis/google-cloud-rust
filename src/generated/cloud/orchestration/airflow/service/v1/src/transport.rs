    ...
    async fn create_environment(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/environments";
    ...
    async fn execute_airflow_command(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{environment}:executeAirflowCommand";
    ...
    async fn stop_airflow_command(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{environment}:stopAirflowCommand";
    ...
    async fn poll_airflow_command(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{environment}:pollAirflowCommand";
    ...
    async fn check_upgrade(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{environment}:checkUpgrade";
    ...
    async fn create_user_workloads_secret(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/userWorkloadsSecrets";
    ...
    async fn update_user_workloads_secret(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{user_workloads_secret.name}";

                let resource_name = format!(
                    "//composer.googleapis.com/{}",
                    var_user_workloads_secret_name,
                );
    ...
    async fn create_user_workloads_config_map(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/userWorkloadsConfigMaps";
    ...
    async fn update_user_workloads_config_map(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{user_workloads_config_map.name}";

                let resource_name = format!(
                    "//composer.googleapis.com/{}",
                    var_user_workloads_config_map_name,
                );
                let builder = self.inner.builder(Method::PUT, path);
                let builder = Ok(builder);
                Some(builder.map(|b| (b, Method::PUT, _path_template, resource_name)))
    ...
    async fn save_snapshot(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{environment}:saveSnapshot";
    ...
    async fn load_snapshot(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{environment}:loadSnapshot";
    ...
    async fn database_failover(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{environment}:databaseFailover";
    ...
    async fn fetch_database_properties(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{environment}:fetchDatabaseProperties";
    ...
    async fn list_image_versions(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/imageVersions";
