    ...
    async fn list_workloads(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//composer.googleapis.com/v1/{}/workloads", var_parent,);
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//composer.googleapis.com/v1/{}/userWorkloadsSecrets",
                    var_parent,
                );
    ...
    async fn get_user_workloads_secret(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//composer.googleapis.com/v1/{}", var_name,);
    ...
    async fn create_user_workloads_config_map(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//composer.googleapis.com/v1/{}/userWorkloadsConfigMaps",
                    var_parent,
                );
    ...
    async fn fetch_database_properties(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//composer.googleapis.com/v1/{}", var_environment,);
