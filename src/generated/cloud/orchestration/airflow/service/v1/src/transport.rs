...
impl super::stub::Environments for Environments {
    ...
    async fn execute_airflow_command(
        ...
        let response: crate::model::ExecuteAirflowCommandResponse =
    ...
    async fn stop_airflow_command(
        ...
        let response: crate::model::StopAirflowCommandResponse =
            self.inner.execute(builder, Some(req), options).await?;
        Ok(gax::response::Response::from(response))
    }
    ...
    async fn poll_airflow_command(
        ...
        let response: crate::model::PollAirflowCommandResponse =
            self.inner.execute(builder, Some(req), options).await?;
        Ok(gax::response::Response::from(response))
    }
    ...
    async fn create_user_workloads_secret(
        ...
        let response: crate::model::UserWorkloadsSecret = self
            .inner
    ...
    async fn list_user_workloads_secrets(
        ...
        let builder = builder.query(&[("pageSize", &req.page_size)]);
        let builder = builder.query(&[("pageToken", &req.page_token)]);
        let response: crate::model::ListUserWorkloadsSecretsResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn create_user_workloads_config_map(
        ...
        let response: crate::model::UserWorkloadsConfigMap = self
            .inner
    ...
    async fn list_user_workloads_config_maps(
        ...
        let builder = builder.query(&[("pageSize", &req.page_size)]);
        let builder = builder.query(&[("pageToken", &req.page_token)]);
        let response: crate::model::ListUserWorkloadsConfigMapsResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn fetch_database_properties(
        ...
        let response: crate::model::FetchDatabasePropertiesResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
...
impl super::stub::ImageVersions for ImageVersions {
    async fn list_image_versions(
        ...
        let response: crate::model::ListImageVersionsResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
