...
/// Implements a [DataFusion](crate::stubs::DataFusion) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DataFusion<T>
where
    T: crate::stubs::DataFusion + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::DataFusion for DataFusion<T>
where
    T: crate::stubs::DataFusion + std::fmt::Debug + Send + Sync,
{
