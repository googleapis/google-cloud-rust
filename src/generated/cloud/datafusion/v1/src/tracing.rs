    ...
    async fn list_available_versions(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                Some("google.cloud.datafusion.v1.DataFusion/ListAvailableVersions")
            );
            self.inner
                .list_available_versions(req, options)
    ...
    async fn list_instances(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::DataFusion",
                "list_instances",
                Some("google.cloud.datafusion.v1.DataFusion/ListInstances")
            );
            self.inner
    ...
    async fn get_instance(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::DataFusion",
                "get_instance",
                Some("google.cloud.datafusion.v1.DataFusion/GetInstance")
            );
            self.inner
    ...
    async fn create_instance(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::DataFusion",
                "create_instance",
                Some("google.cloud.datafusion.v1.DataFusion/CreateInstance")
            );
            self.inner
    ...
    async fn delete_instance(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::DataFusion",
                "delete_instance",
                Some("google.cloud.datafusion.v1.DataFusion/DeleteInstance")
            );
            self.inner
    ...
    async fn update_instance(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::DataFusion",
                "update_instance",
                Some("google.cloud.datafusion.v1.DataFusion/UpdateInstance")
            );
            self.inner
    ...
    async fn restart_instance(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::DataFusion",
                "restart_instance",
                Some("google.cloud.datafusion.v1.DataFusion/RestartInstance")
            );
            self.inner
