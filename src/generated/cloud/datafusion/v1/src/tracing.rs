...
/// Implements a [DataFusion](super::stubs::DataFusion) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DataFusion<T>
where
    T: super::stubs::DataFusion + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::DataFusion for DataFusion<T>
where
    T: super::stubs::DataFusion + std::fmt::Debug + Send + Sync,
{
    ...
    ) -> Result<crate::model::ListAvailableVersionsResponse> {
