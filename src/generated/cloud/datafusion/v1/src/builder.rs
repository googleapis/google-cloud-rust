...
/// Request and client builders for [DataFusion][crate::client::DataFusion].
pub mod data_fusion {
    use crate::Result;
    ...
    impl ListAvailableVersions {
        ...
        pub fn by_page(
            ...
            crate::model::ListAvailableVersionsResponse,
            crate::Error,
        > {
            use std::clone::Clone;
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListAvailableVersions {
    ...
    impl CreateInstance {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Instance, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_datafusion_v1::client::DataFusion::create_instance::until_done";
            }
    ...
    impl DeleteInstance {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_datafusion_v1::client::DataFusion::delete_instance::until_done";
            }
    ...
    impl UpdateInstance {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Instance, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_datafusion_v1::client::DataFusion::update_instance::until_done";
            }
    ...
    impl RestartInstance {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Instance, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_datafusion_v1::client::DataFusion::restart_instance::until_done";
            }
