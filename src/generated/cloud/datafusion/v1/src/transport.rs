    ...
    async fn list_available_versions(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//datafusion.googleapis.com/v1/{}/versions", var_parent,);
    ...
    async fn list_instances(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//datafusion.googleapis.com/v1/{}/instances", var_parent,);
    ...
    async fn get_instance(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//datafusion.googleapis.com/v1/{}", var_name,);
    ...
    async fn update_instance(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//datafusion.googleapis.com/v1/{}", var_instance_name,);
