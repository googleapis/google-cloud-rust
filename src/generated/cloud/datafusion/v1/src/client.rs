...
/// [with_credentials()]: super::builder::data_fusion::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `DataFusion` in
...
impl DataFusion {
    ...
    pub fn builder() -> super::builder::data_fusion::ClientBuilder {
        crate::new_client_builder(super::builder::data_fusion::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::DataFusion>> {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::DataFusion> {
    ...
    /// use google_cloud_datafusion_v1::Result;
    /// async fn sample(
    ///    client: &DataFusion, project_id: &str, location_id: &str, instance_id: &str
    /// ) -> Result<()> {
