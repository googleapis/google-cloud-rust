...
/// Implements a [KeyDashboardService](crate::stubs::KeyDashboardService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct KeyDashboardService<T>
where
    T: crate::stubs::KeyDashboardService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::KeyDashboardService for KeyDashboardService<T>
where
    T: crate::stubs::KeyDashboardService + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [KeyTrackingService](crate::stubs::KeyTrackingService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct KeyTrackingService<T>
where
    T: crate::stubs::KeyTrackingService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::KeyTrackingService for KeyTrackingService<T>
where
    T: crate::stubs::KeyTrackingService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
