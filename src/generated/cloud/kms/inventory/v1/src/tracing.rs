...
/// Implements a [KeyDashboardService](super::stubs::KeyDashboardService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct KeyDashboardService<T>
where
    T: super::stubs::KeyDashboardService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::KeyDashboardService for KeyDashboardService<T>
where
    T: super::stubs::KeyDashboardService + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [KeyTrackingService](super::stubs::KeyTrackingService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct KeyTrackingService<T>
where
    T: super::stubs::KeyTrackingService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::KeyTrackingService for KeyTrackingService<T>
where
    T: super::stubs::KeyTrackingService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
