...
/// Request and client builders for [KeyDashboardService][crate::client::KeyDashboardService].
pub mod key_dashboard_service {
    ...
    impl ListCryptoKeys {
        ...
        pub fn by_page(
            ...
            crate::model::ListCryptoKeysResponse,
            crate::Error,
        > {
            use std::clone::Clone;
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListCryptoKeys {
...
/// Request and client builders for [KeyTrackingService][crate::client::KeyTrackingService].
pub mod key_tracking_service {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetProtectedResourcesSummary {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for SearchProtectedResources {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
