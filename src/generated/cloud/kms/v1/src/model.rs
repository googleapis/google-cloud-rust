...
impl CryptoKey {
    ...
    /// ```
    /// # use google_cloud_kms_v1::model::CryptoKey;
    /// use google_cloud_kms_v1::model::crypto_key;
    /// use wkt::Duration;
    /// let x = CryptoKey::new().set_rotation_schedule(Some(crypto_key::RotationSchedule::RotationPeriod(Duration::default().into())));
    /// ```
...
impl ImportCryptoKeyVersionRequest {
    ...
    /// ```
    /// # use google_cloud_kms_v1::model::ImportCryptoKeyVersionRequest;
    /// use google_cloud_kms_v1::model::import_crypto_key_version_request;
    /// let x = ImportCryptoKeyVersionRequest::new().set_wrapped_key_material(Some(import_crypto_key_version_request::WrappedKeyMaterial::RsaAesWrappedKey(bytes::Bytes::from_static(b"example"))));
    /// ```
...
impl Digest {
    ...
    /// # use google_cloud_kms_v1::model::Digest;
    /// use google_cloud_kms_v1::model::digest;
    /// let x = Digest::new().set_digest(Some(digest::Digest::Sha256(bytes::Bytes::from_static(b"example"))));
    /// ```
