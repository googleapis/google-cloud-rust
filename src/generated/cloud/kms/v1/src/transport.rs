    ...
    async fn create_key_handle(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//cloudkms.googleapis.com/v1/{}/keyHandles", var_parent,);
    ...
    async fn get_key_handle(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//cloudkms.googleapis.com/v1/{}", var_name,);
    ...
    async fn set_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//cloudkms.googleapis.com/v1/{}", var_resource,);
    ...
    async fn show_effective_autokey_config(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//cloudkms.googleapis.com/v1/{}", var_parent,);
    ...
    async fn list_ekm_connections(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//cloudkms.googleapis.com/v1/{}/ekmConnections", var_parent,);
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//cloudkms.googleapis.com/v1/{}/singleTenantHsmInstances",
                    var_parent,
                );
    ...
    async fn create_single_tenant_hsm_instance_proposal(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//cloudkms.googleapis.com/v1/{}/proposals", var_parent,);
    ...
    async fn list_key_rings(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//cloudkms.googleapis.com/v1/{}/keyRings", var_parent,);
    ...
    async fn list_crypto_keys(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//cloudkms.googleapis.com/v1/{}/cryptoKeys", var_parent,);
    ...
    async fn list_crypto_key_versions(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//cloudkms.googleapis.com/v1/{}/cryptoKeyVersions",
                    var_parent,
                );
    ...
    async fn list_import_jobs(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//cloudkms.googleapis.com/v1/{}/importJobs", var_parent,);
    ...
    async fn list_retired_resources(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//cloudkms.googleapis.com/v1/{}/retiredResources",
                    var_parent,
                );
    ...
    async fn get_public_key(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//cloudkms.googleapis.com/v1/{}/publicKey", var_name,);
