...
/// Implements a [Autokey](crate::stubs::Autokey) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Autokey<T>
where
    T: crate::stubs::Autokey + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::Autokey for Autokey<T>
where
    T: crate::stubs::Autokey + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [AutokeyAdmin](crate::stubs::AutokeyAdmin) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AutokeyAdmin<T>
where
    T: crate::stubs::AutokeyAdmin + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::AutokeyAdmin for AutokeyAdmin<T>
where
    T: crate::stubs::AutokeyAdmin + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [EkmService](crate::stubs::EkmService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct EkmService<T>
where
    T: crate::stubs::EkmService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::EkmService for EkmService<T>
where
    T: crate::stubs::EkmService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [KeyManagementService](crate::stubs::KeyManagementService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct KeyManagementService<T>
where
    T: crate::stubs::KeyManagementService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::KeyManagementService for KeyManagementService<T>
where
    T: crate::stubs::KeyManagementService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
