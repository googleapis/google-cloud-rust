...
/// Implements a [Autokey](super::stubs::Autokey) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Autokey<T>
where
    T: super::stubs::Autokey + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Autokey for Autokey<T>
where
    T: super::stubs::Autokey + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [AutokeyAdmin](super::stubs::AutokeyAdmin) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AutokeyAdmin<T>
where
    T: super::stubs::AutokeyAdmin + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::AutokeyAdmin for AutokeyAdmin<T>
where
    T: super::stubs::AutokeyAdmin + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [EkmService](super::stubs::EkmService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct EkmService<T>
where
    T: super::stubs::EkmService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::EkmService for EkmService<T>
where
    T: super::stubs::EkmService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [KeyManagementService](super::stubs::KeyManagementService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct KeyManagementService<T>
where
    T: super::stubs::KeyManagementService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::KeyManagementService for KeyManagementService<T>
where
    T: super::stubs::KeyManagementService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
