...
/// [with_credentials()]: super::builder::datastream::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `Datastream` in
...
impl Datastream {
    ...
    pub fn builder() -> super::builder::datastream::ClientBuilder {
        crate::new_client_builder(super::builder::datastream::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::Datastream>> {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::Datastream> {
    ...
    ///    client: &Datastream
    /// ) -> Result<()> {
    ///     let response = client.discover_connection_profile()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &Datastream
    /// ) -> Result<()> {
    ///     let response = client.run_stream()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &Datastream
    /// ) -> Result<()> {
    ///     let response = client.lookup_stream_object()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &Datastream
    /// ) -> Result<()> {
    ///     let response = client.start_backfill_job()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &Datastream
    /// ) -> Result<()> {
    ///     let response = client.stop_backfill_job()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
