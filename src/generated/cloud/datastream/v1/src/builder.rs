...
/// Request and client builders for [Datastream][crate::client::Datastream].
pub mod datastream {
    use crate::Result;
    ...
    impl CreateConnectionProfile {
        ...
        > {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_datastream_v1::client::Datastream::create_connection_profile::until_done";
            }
    ...
    impl UpdateConnectionProfile {
        ...
        > {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_datastream_v1::client::Datastream::update_connection_profile::until_done";
            }
    ...
    impl DeleteConnectionProfile {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_datastream_v1::client::Datastream::delete_connection_profile::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DiscoverConnectionProfile {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateStream {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Stream, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_datastream_v1::client::Datastream::create_stream::until_done";
            }
    ...
    impl UpdateStream {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Stream, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_datastream_v1::client::Datastream::update_stream::until_done";
            }
    ...
    impl DeleteStream {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_datastream_v1::client::Datastream::delete_stream::until_done";
            }
    ...
    impl RunStream {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `run_stream`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::Stream, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_datastream_v1::client::Datastream::run_stream::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for RunStream {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetStreamObject {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for LookupStreamObject {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ListStreamObjects {
        ...
        pub fn by_page(
            ...
            crate::model::ListStreamObjectsResponse,
            crate::Error,
        > {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListStreamObjects {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for StartBackfillJob {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for StopBackfillJob {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreatePrivateConnection {
        ...
        > {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_datastream_v1::client::Datastream::create_private_connection::until_done";
            }
    ...
    impl DeletePrivateConnection {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_datastream_v1::client::Datastream::delete_private_connection::until_done";
            }
    ...
    impl CreateRoute {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `create_route`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::Route, crate::model::OperationMetadata>
        {
            type Operation = google_cloud_lro::internal::Operation<
                crate::model::Route,
                crate::model::OperationMetadata,
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_datastream_v1::client::Datastream::create_route::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateRoute {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteRoute {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `delete_route`.
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            type Operation =
                google_cloud_lro::internal::Operation<wkt::Empty, crate::model::OperationMetadata>;
            let polling_error_policy = self.0.stub.get_polling_error_policy(&self.0.options);
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_datastream_v1::client::Datastream::delete_route::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteRoute {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
