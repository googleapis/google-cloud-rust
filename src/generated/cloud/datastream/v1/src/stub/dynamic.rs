...
pub trait Datastream: std::fmt::Debug + Send + Sync {
    ...
    async fn discover_connection_profile(
        ...
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::DiscoverConnectionProfileResponse>>;
    ...
    async fn get_stream_object(
        ...
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::StreamObject>>;
    ...
    async fn list_stream_objects(
        ...
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::ListStreamObjectsResponse>>;

    async fn start_backfill_job(
        &self,
        req: crate::model::StartBackfillJobRequest,
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::StartBackfillJobResponse>>;

    async fn stop_backfill_job(
        &self,
        req: crate::model::StopBackfillJobRequest,
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::StopBackfillJobResponse>>;
