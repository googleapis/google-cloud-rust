...
/// Request and client builders for [CloudShellService][crate::client::CloudShellService].
pub mod cloud_shell_service {
    ...
    impl StartEnvironment {
        ...
        > {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_shell_v1::client::CloudShellService::start_environment::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for StartEnvironment {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl AuthorizeEnvironment {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_shell_v1::client::CloudShellService::authorize_environment::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for AuthorizeEnvironment {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl AddPublicKey {
        ...
        > {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_shell_v1::client::CloudShellService::add_public_key::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for AddPublicKey {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl RemovePublicKey {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_shell_v1::client::CloudShellService::remove_public_key::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for RemovePublicKey {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
