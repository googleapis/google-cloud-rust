    ...
    async fn authorize_environment(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:authorize";
    ...
    async fn add_public_key(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{environment}:addPublicKey";

                let resource_name = format!("//cloudshell.googleapis.com/{}", var_environment,);
                let builder = self.inner.builder(Method::POST, path);
                let builder = Ok(builder);
                Some(builder.map(|b| (b, Method::POST, _path_template, resource_name)))
            })
    ...
    async fn remove_public_key(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{environment}:removePublicKey";
