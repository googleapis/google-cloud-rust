...
/// Implements a [CloudShellService](crate::stubs::CloudShellService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudShellService<T>
where
    T: crate::stubs::CloudShellService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::CloudShellService for CloudShellService<T>
where
    T: crate::stubs::CloudShellService + std::fmt::Debug + Send + Sync,
{
