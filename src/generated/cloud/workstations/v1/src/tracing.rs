...
/// Implements a [Workstations](super::stubs::Workstations) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Workstations<T>
where
    T: super::stubs::Workstations + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Workstations for Workstations<T>
where
    T: super::stubs::Workstations + std::fmt::Debug + Send + Sync,
{
