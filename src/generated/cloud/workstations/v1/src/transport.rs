...
impl super::stub::Workstations for Workstations {
    ...
    async fn list_workstation_clusters(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/workstationClusters";
    ...
    async fn update_workstation_cluster(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{workstation_cluster.name}";

                let resource_name = format!(
                    "//workstations.googleapis.com/{}",
                    var_workstation_cluster_name,
                );
    ...
    async fn list_workstation_configs(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/workstationConfigs";
    ...
    async fn list_usable_workstation_configs(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/workstationConfigs:listUsable";
    ...
    async fn update_workstation_config(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{workstation_config.name}";

                let resource_name = format!(
                    "//workstations.googleapis.com/{}",
                    var_workstation_config_name,
                );
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
    ...
    async fn list_workstations(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/workstations";
    ...
    async fn list_usable_workstations(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/workstations:listUsable";
    ...
    async fn update_workstation(
        ...
        .or_else(|| {
            ...
            let _path_template = "/v1/{workstation.name}";
    ...
    async fn generate_access_token(
        ...
        .or_else(|| {
            ...
            let _path_template = "/v1/{workstation}:generateAccessToken";
