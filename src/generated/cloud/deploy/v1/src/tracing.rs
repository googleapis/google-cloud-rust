...
/// Implements a [CloudDeploy](crate::stubs::CloudDeploy) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudDeploy<T>
where
    T: crate::stubs::CloudDeploy + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::CloudDeploy for CloudDeploy<T>
where
    T: crate::stubs::CloudDeploy + std::fmt::Debug + Send + Sync,
{
