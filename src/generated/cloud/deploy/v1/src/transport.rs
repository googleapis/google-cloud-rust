        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//clouddeploy.googleapis.com/v1/{}/deliveryPipelines",
                    var_parent,
                );
    ...
    async fn get_delivery_pipeline(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//clouddeploy.googleapis.com/v1/{}", var_name,);
    ...
    async fn list_targets(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//clouddeploy.googleapis.com/v1/{}/targets", var_parent,);
    ...
    async fn list_custom_target_types(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//clouddeploy.googleapis.com/v1/{}/customTargetTypes",
                    var_parent,
                );
    ...
    async fn list_releases(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//clouddeploy.googleapis.com/v1/{}/releases", var_parent,);
    ...
    async fn create_deploy_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//clouddeploy.googleapis.com/v1/{}/deployPolicies",
                    var_parent,
                );
    ...
    async fn list_rollouts(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//clouddeploy.googleapis.com/v1/{}/rollouts", var_parent,);
    ...
    async fn ignore_job(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//clouddeploy.googleapis.com/v1/{}", var_rollout,);
    ...
    async fn list_job_runs(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//clouddeploy.googleapis.com/v1/{}/jobRuns", var_parent,);
    ...
    async fn create_automation(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//clouddeploy.googleapis.com/v1/{}/automations", var_parent,);
    ...
    async fn list_automation_runs(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//clouddeploy.googleapis.com/v1/{}/automationRuns",
                    var_parent,
                );
    ...
    async fn set_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//clouddeploy.googleapis.com/v1/{}", var_resource,);
