...
impl super::stub::CloudDeploy for CloudDeploy {
    async fn list_delivery_pipelines(
        ...
        .or_else(|| {
            ...
            let path_template = "/v1/{parent}/deliveryPipelines";
        ...
        let options = {
            ...
            if let Some(rn) = resource_name {
                let full_resource_name = format!("//clouddeploy.googleapis.com/{}", rn);
    ...
    async fn get_delivery_pipeline(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/deliveryPipelines/"), Segment::SingleWildcard])?,
            );
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                ...
                let builder = builder.maybe_add(
                    ...
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/deliveryPipelines/"), Segment::SingleWildcard],
                    "name",
    ...
    async fn update_delivery_pipeline(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).and_then(|m| m.delivery_pipeline.as_ref()).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/deliveryPipelines/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{delivery_pipeline.name}";
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                let builder = PathMismatchBuilder::default();
                let builder = builder.maybe_add(
                    Some(&req).and_then(|m| m.delivery_pipeline.as_ref()).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/deliveryPipelines/"), Segment::SingleWildcard],
    ...
    async fn list_targets(
        ...
        .or_else(|| {
            ...
            let path_template = "/v1/{parent}/targets";
    ...
    async fn get_target(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/targets/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{name}";
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                ...
                let builder = builder.maybe_add(
                    Some(&req).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/targets/"), Segment::SingleWildcard],
                    "name",
    ...
    async fn update_target(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).and_then(|m| m.target.as_ref()).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/targets/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{target.name}";
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                let builder = PathMismatchBuilder::default();
                let builder = builder.maybe_add(
                    Some(&req).and_then(|m| m.target.as_ref()).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/targets/"), Segment::SingleWildcard],
                    "target.name",
                    "projects/*/locations/*/targets/*");
                paths.push(builder.build());
    ...
    async fn list_custom_target_types(
        ...
        .or_else(|| {
            ...
            let path_template = "/v1/{parent}/customTargetTypes";
    ...
    async fn get_custom_target_type(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/customTargetTypes/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{name}";
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                ...
                let builder = builder.maybe_add(
                    Some(&req).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/customTargetTypes/"), Segment::SingleWildcard],
                    "name",
    ...
    async fn update_custom_target_type(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).and_then(|m| m.custom_target_type.as_ref()).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/customTargetTypes/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{custom_target_type.name}";
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                let builder = PathMismatchBuilder::default();
                let builder = builder.maybe_add(
                    Some(&req).and_then(|m| m.custom_target_type.as_ref()).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/customTargetTypes/"), Segment::SingleWildcard],
    ...
    async fn list_releases(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}/releases",
                try_match(Some(&req).map(|m| &m.parent).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/deliveryPipelines/"), Segment::SingleWildcard])?,
            );
    ...
    async fn get_release(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/deliveryPipelines/"), Segment::SingleWildcard, Segment::Literal("/releases/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{name}";
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                ...
                let builder = builder.maybe_add(
                    Some(&req).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/deliveryPipelines/"), Segment::SingleWildcard, Segment::Literal("/releases/"), Segment::SingleWildcard],
                    "name",
    ...
    async fn create_release(
        ...
        .or_else(|| {
            ...
            let builder = builder.query(&[("requestId", &req.request_id)]);
            let builder = builder.query(&[("validateOnly", &req.validate_only)]);
            let builder = req.override_deploy_policy.iter().fold(builder, |builder, p| builder.query(&[("overrideDeployPolicy", p)]));
            let builder = Ok(builder);
            Some(builder.map(|b| (b, reqwest::Method::POST, path_template)))
        })
        .ok_or_else(|| {
    ...
    async fn create_deploy_policy(
        ...
        .or_else(|| {
            ...
            let path_template = "/v1/{parent}/deployPolicies";
    ...
    async fn update_deploy_policy(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).and_then(|m| m.deploy_policy.as_ref()).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/deployPolicies/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{deploy_policy.name}";
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                let builder = PathMismatchBuilder::default();
                let builder = builder.maybe_add(
                    Some(&req).and_then(|m| m.deploy_policy.as_ref()).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/deployPolicies/"), Segment::SingleWildcard],
                    "deploy_policy.name",
    ...
    async fn delete_deploy_policy(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/deployPolicies/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{name}";
    ...
    async fn approve_rollout(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}:approve",
                try_match(Some(&req).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/deliveryPipelines/"), Segment::SingleWildcard, Segment::Literal("/releases/"), Segment::SingleWildcard, Segment::Literal("/rollouts/"), Segment::SingleWildcard])?,
            );
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                ...
                let builder = builder.maybe_add(
                    Some(&req).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/deliveryPipelines/"), Segment::SingleWildcard, Segment::Literal("/releases/"), Segment::SingleWildcard, Segment::Literal("/rollouts/"), Segment::SingleWildcard],
                    "name",
    ...
    async fn list_rollouts(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}/rollouts",
                try_match(Some(&req).map(|m| &m.parent).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/deliveryPipelines/"), Segment::SingleWildcard, Segment::Literal("/releases/"), Segment::SingleWildcard])?,
            );
    ...
    async fn create_rollout(
        ...
        let options = {
            let resource_name = Option::<&String>::None
                .or(Some(&req.parent))
                                .or(req.rollout.as_ref().map(|s| &s.deploying_build))
                ;
            if let Some(rn) = resource_name {
                let full_resource_name = format!("//clouddeploy.googleapis.com/{}", rn);
                gax::options::internal::set_resource_name(options, full_resource_name)
    ...
    async fn ignore_job(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}:ignoreJob",
                try_match(Some(&req).map(|m| &m.rollout).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/deliveryPipelines/"), Segment::SingleWildcard, Segment::Literal("/releases/"), Segment::SingleWildcard, Segment::Literal("/rollouts/"), Segment::SingleWildcard])?,
            );
    ...
    async fn list_job_runs(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}/jobRuns",
                try_match(Some(&req).map(|m| &m.parent).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/deliveryPipelines/"), Segment::SingleWildcard, Segment::Literal("/releases/"), Segment::SingleWildcard, Segment::Literal("/rollouts/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{parent}/jobRuns";
    ...
    async fn create_automation(
        ...
        .or_else(|| {
            ...
            let path_template = "/v1/{parent}/automations";
    ...
    async fn update_automation(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).and_then(|m| m.automation.as_ref()).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/deliveryPipelines/"), Segment::SingleWildcard, Segment::Literal("/automations/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{automation.name}";
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                let builder = PathMismatchBuilder::default();
                let builder = builder.maybe_add(
                    Some(&req).and_then(|m| m.automation.as_ref()).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/deliveryPipelines/"), Segment::SingleWildcard, Segment::Literal("/automations/"), Segment::SingleWildcard],
                    "automation.name",
    ...
    async fn delete_automation(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/deliveryPipelines/"), Segment::SingleWildcard, Segment::Literal("/automations/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{name}";
    ...
    async fn get_automation_run(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/deliveryPipelines/"), Segment::SingleWildcard, Segment::Literal("/automationRuns/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{name}";
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                ...
                let builder = builder.maybe_add(
                    Some(&req).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/deliveryPipelines/"), Segment::SingleWildcard, Segment::Literal("/automationRuns/"), Segment::SingleWildcard],
                    "name",
    ...
    async fn list_automation_runs(
        ...
        .or_else(|| {
            ...
            let path_template = "/v1/{parent}/automationRuns";
    ...
    async fn set_iam_policy(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}:setIamPolicy",
                try_match(Some(&req).map(|m| &m.resource).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/deliveryPipelines/"), Segment::SingleWildcard])?,
            );
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}:setIamPolicy",
                try_match(Some(&req).map(|m| &m.resource).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/targets/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{resource}:setIamPolicy";
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}:setIamPolicy",
                try_match(Some(&req).map(|m| &m.resource).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/customTargetTypes/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{resource}:setIamPolicy";
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}:setIamPolicy",
                try_match(Some(&req).map(|m| &m.resource).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/deployPolicies/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{resource}:setIamPolicy";
