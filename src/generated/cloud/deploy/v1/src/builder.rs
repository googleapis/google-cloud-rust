...
/// Request and client builders for [CloudDeploy][crate::client::CloudDeploy].
pub mod cloud_deploy {
    ...
    impl CreateDeliveryPipeline {
        ...
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::DeliveryPipeline, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_deploy_v1::client::CloudDeploy::create_delivery_pipeline::until_done";
            }
    ...
    impl UpdateDeliveryPipeline {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::DeliveryPipeline, crate::model::OperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_deploy_v1::client::CloudDeploy::update_delivery_pipeline::until_done";
            }
    ...
    impl DeleteDeliveryPipeline {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_deploy_v1::client::CloudDeploy::delete_delivery_pipeline::until_done";
            }
    ...
    impl CreateTarget {
        ...
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::Target, crate::model::OperationMetadata>
        {
            type Operation = google_cloud_lro::internal::Operation<
                crate::model::Target,
                crate::model::OperationMetadata,
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_deploy_v1::client::CloudDeploy::create_target::until_done";
            }
    ...
    impl UpdateTarget {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Target, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_deploy_v1::client::CloudDeploy::update_target::until_done";
            }
    ...
    impl DeleteTarget {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_deploy_v1::client::CloudDeploy::delete_target::until_done";
            }
    ...
    impl CreateCustomTargetType {
        ...
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::CustomTargetType, crate::model::OperationMetadata>
        {
            type Operation = google_cloud_lro::internal::Operation<
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_deploy_v1::client::CloudDeploy::create_custom_target_type::until_done";
            }
    ...
    impl UpdateCustomTargetType {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::CustomTargetType, crate::model::OperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_deploy_v1::client::CloudDeploy::update_custom_target_type::until_done";
            }
    ...
    impl DeleteCustomTargetType {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_deploy_v1::client::CloudDeploy::delete_custom_target_type::until_done";
            }
    ...
    impl CreateRelease {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Release, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_deploy_v1::client::CloudDeploy::create_release::until_done";
            }
    ...
    impl CreateDeployPolicy {
        ...
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::DeployPolicy, crate::model::OperationMetadata>
        {
            type Operation = google_cloud_lro::internal::Operation<
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_deploy_v1::client::CloudDeploy::create_deploy_policy::until_done";
            }
    ...
    impl UpdateDeployPolicy {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::DeployPolicy, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_deploy_v1::client::CloudDeploy::update_deploy_policy::until_done";
            }
    ...
    impl DeleteDeployPolicy {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_deploy_v1::client::CloudDeploy::delete_deploy_policy::until_done";
            }
    ...
    impl CreateRollout {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Rollout, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_deploy_v1::client::CloudDeploy::create_rollout::until_done";
            }
    ...
    impl CreateAutomation {
        ...
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::Automation, crate::model::OperationMetadata>
        {
            type Operation = google_cloud_lro::internal::Operation<
                crate::model::Automation,
                crate::model::OperationMetadata,
            >;
            let polling_error_policy = self.0.stub.get_polling_error_policy(&self.0.options);
            let polling_backoff_policy = self.0.stub.get_polling_backoff_policy(&self.0.options);
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_deploy_v1::client::CloudDeploy::create_automation::until_done";
            }
    ...
    impl UpdateAutomation {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Automation, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_deploy_v1::client::CloudDeploy::update_automation::until_done";
            }
    ...
    impl DeleteAutomation {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_deploy_v1::client::CloudDeploy::delete_automation::until_done";
            }
