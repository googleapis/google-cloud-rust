...
/// [with_credentials()]: super::builder::business_glossary_service::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `BusinessGlossaryService` in
...
impl CatalogService {
    ...
    ///    client: &CatalogService
    /// ) -> Result<()> {
    ///     let response = client.modify_entry()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    /// }
    /// ```
    pub fn modify_entry(&self) -> super::builder::catalog_service::ModifyEntry {
        super::builder::catalog_service::ModifyEntry::new(self.inner.clone())
    }
...
/// [with_credentials()]: super::builder::cmek_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `CmekService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
#[derive(Clone, Debug)]
...
/// [with_credentials()]: super::builder::content_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `ContentService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
#[derive(Clone, Debug)]
...
/// # Configuration
///
/// To configure `DataProductService` use the `with_*` methods in the type returned
/// by [builder()][DataProductService::builder]. The default configuration should
/// work for most applications. Common configuration changes include
///
/// * [with_endpoint()]: by default this client uses the global default endpoint
///   (`https://dataplex.googleapis.com`). Applications using regional
...
///   authentication may need to override this default.
///
/// [with_endpoint()]: super::builder::data_product_service::ClientBuilder::with_endpoint
/// [with_credentials()]: super::builder::data_product_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
///
/// `DataProductService` holds a connection pool internally, it is advised to
/// create one and reuse it. You do not need to wrap `DataProductService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
#[derive(Clone, Debug)]
...
impl DataProductService {
    /// Returns a builder for [DataProductService].
    ///
    /// ```
    /// # async fn sample() -> google_cloud_gax::client_builder::Result<()> {
    /// # use google_cloud_dataplex_v1::client::DataProductService;
    ...
    /// ) -> Result<()> {
    ///     let response = client.create_data_product()
    ///         .set_parent(parent)
    ///         .set_data_product(
    ///             DataProduct::new()/* set fields */
    ///         )
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    /// use google_cloud_dataplex_v1::Result;
    /// async fn sample(
    ///    client: &DataProductService
    /// ) -> Result<()> {
    ///     let response = client.request_data_product_access()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    /// }
    /// ```
    pub fn request_data_product_access(
        &self,
    ) -> super::builder::data_product_service::RequestDataProductAccess {
        super::builder::data_product_service::RequestDataProductAccess::new(self.inner.clone())
    }
...
/// [with_credentials()]: super::builder::data_taxonomy_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// [with_credentials()]: super::builder::data_scan_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `DataScanService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
#[derive(Clone, Debug)]
...
impl DataScanService {
    ...
    ///    client: &DataScanService
    /// ) -> Result<()> {
    ///     let response = client.cancel_data_scan_job()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    /// }
    /// ```
    pub fn cancel_data_scan_job(&self) -> super::builder::data_scan_service::CancelDataScanJob {
        super::builder::data_scan_service::CancelDataScanJob::new(self.inner.clone())
    }
...
/// [with_credentials()]: super::builder::dataplex_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
