...
/// Implements a [DatasetService](crate::stubs::DatasetService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DatasetService<T>
where
    T: crate::stubs::DatasetService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::DatasetService for DatasetService<T>
where
    T: crate::stubs::DatasetService + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [DeploymentResourcePoolService](crate::stubs::DeploymentResourcePoolService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DeploymentResourcePoolService<T>
where
    T: crate::stubs::DeploymentResourcePoolService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::DeploymentResourcePoolService for DeploymentResourcePoolService<T>
where
    T: crate::stubs::DeploymentResourcePoolService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [EndpointService](crate::stubs::EndpointService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct EndpointService<T>
where
    T: crate::stubs::EndpointService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::EndpointService for EndpointService<T>
where
    T: crate::stubs::EndpointService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [EvaluationService](crate::stubs::EvaluationService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct EvaluationService<T>
where
    T: crate::stubs::EvaluationService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::EvaluationService for EvaluationService<T>
where
    T: crate::stubs::EvaluationService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [FeatureOnlineStoreAdminService](crate::stubs::FeatureOnlineStoreAdminService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct FeatureOnlineStoreAdminService<T>
where
    T: crate::stubs::FeatureOnlineStoreAdminService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::FeatureOnlineStoreAdminService for FeatureOnlineStoreAdminService<T>
where
    T: crate::stubs::FeatureOnlineStoreAdminService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [FeatureOnlineStoreService](crate::stubs::FeatureOnlineStoreService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct FeatureOnlineStoreService<T>
where
    T: crate::stubs::FeatureOnlineStoreService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::FeatureOnlineStoreService for FeatureOnlineStoreService<T>
where
    T: crate::stubs::FeatureOnlineStoreService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [FeatureRegistryService](crate::stubs::FeatureRegistryService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct FeatureRegistryService<T>
where
    T: crate::stubs::FeatureRegistryService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::FeatureRegistryService for FeatureRegistryService<T>
where
    T: crate::stubs::FeatureRegistryService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [FeaturestoreOnlineServingService](crate::stubs::FeaturestoreOnlineServingService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct FeaturestoreOnlineServingService<T>
where
    T: crate::stubs::FeaturestoreOnlineServingService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::FeaturestoreOnlineServingService for FeaturestoreOnlineServingService<T>
where
    T: crate::stubs::FeaturestoreOnlineServingService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [FeaturestoreService](crate::stubs::FeaturestoreService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct FeaturestoreService<T>
where
    T: crate::stubs::FeaturestoreService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::FeaturestoreService for FeaturestoreService<T>
where
    T: crate::stubs::FeaturestoreService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [GenAiCacheService](crate::stubs::GenAiCacheService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct GenAiCacheService<T>
where
    T: crate::stubs::GenAiCacheService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::GenAiCacheService for GenAiCacheService<T>
where
    T: crate::stubs::GenAiCacheService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [GenAiTuningService](crate::stubs::GenAiTuningService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct GenAiTuningService<T>
where
    T: crate::stubs::GenAiTuningService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::GenAiTuningService for GenAiTuningService<T>
where
    T: crate::stubs::GenAiTuningService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [IndexEndpointService](crate::stubs::IndexEndpointService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct IndexEndpointService<T>
where
    T: crate::stubs::IndexEndpointService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::IndexEndpointService for IndexEndpointService<T>
where
    T: crate::stubs::IndexEndpointService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [IndexService](crate::stubs::IndexService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct IndexService<T>
where
    T: crate::stubs::IndexService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::IndexService for IndexService<T>
where
    T: crate::stubs::IndexService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [LlmUtilityService](crate::stubs::LlmUtilityService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct LlmUtilityService<T>
where
    T: crate::stubs::LlmUtilityService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::LlmUtilityService for LlmUtilityService<T>
where
    T: crate::stubs::LlmUtilityService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [MatchService](crate::stubs::MatchService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct MatchService<T>
where
    T: crate::stubs::MatchService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::MatchService for MatchService<T>
where
    T: crate::stubs::MatchService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [MetadataService](crate::stubs::MetadataService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct MetadataService<T>
where
    T: crate::stubs::MetadataService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::MetadataService for MetadataService<T>
where
    T: crate::stubs::MetadataService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [MigrationService](crate::stubs::MigrationService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct MigrationService<T>
where
    T: crate::stubs::MigrationService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::MigrationService for MigrationService<T>
where
    T: crate::stubs::MigrationService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [ModelGardenService](crate::stubs::ModelGardenService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ModelGardenService<T>
where
    T: crate::stubs::ModelGardenService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ModelGardenService for ModelGardenService<T>
where
    T: crate::stubs::ModelGardenService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [ModelService](crate::stubs::ModelService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ModelService<T>
where
    T: crate::stubs::ModelService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ModelService for ModelService<T>
where
    T: crate::stubs::ModelService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [NotebookService](crate::stubs::NotebookService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct NotebookService<T>
where
    T: crate::stubs::NotebookService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::NotebookService for NotebookService<T>
where
    T: crate::stubs::NotebookService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [PersistentResourceService](crate::stubs::PersistentResourceService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct PersistentResourceService<T>
where
    T: crate::stubs::PersistentResourceService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::PersistentResourceService for PersistentResourceService<T>
where
    T: crate::stubs::PersistentResourceService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [PipelineService](crate::stubs::PipelineService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct PipelineService<T>
where
    T: crate::stubs::PipelineService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::PipelineService for PipelineService<T>
where
    T: crate::stubs::PipelineService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [PredictionService](crate::stubs::PredictionService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct PredictionService<T>
where
    T: crate::stubs::PredictionService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::PredictionService for PredictionService<T>
where
    T: crate::stubs::PredictionService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [ReasoningEngineExecutionService](crate::stubs::ReasoningEngineExecutionService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ReasoningEngineExecutionService<T>
where
    T: crate::stubs::ReasoningEngineExecutionService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ReasoningEngineExecutionService for ReasoningEngineExecutionService<T>
where
    T: crate::stubs::ReasoningEngineExecutionService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [ReasoningEngineService](crate::stubs::ReasoningEngineService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ReasoningEngineService<T>
where
    T: crate::stubs::ReasoningEngineService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ReasoningEngineService for ReasoningEngineService<T>
where
    T: crate::stubs::ReasoningEngineService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [ScheduleService](crate::stubs::ScheduleService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ScheduleService<T>
where
    T: crate::stubs::ScheduleService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ScheduleService for ScheduleService<T>
where
    T: crate::stubs::ScheduleService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [SpecialistPoolService](crate::stubs::SpecialistPoolService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SpecialistPoolService<T>
where
    T: crate::stubs::SpecialistPoolService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::SpecialistPoolService for SpecialistPoolService<T>
where
    T: crate::stubs::SpecialistPoolService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [TensorboardService](crate::stubs::TensorboardService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct TensorboardService<T>
where
    T: crate::stubs::TensorboardService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::TensorboardService for TensorboardService<T>
where
    T: crate::stubs::TensorboardService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [VertexRagDataService](crate::stubs::VertexRagDataService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct VertexRagDataService<T>
where
    T: crate::stubs::VertexRagDataService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::VertexRagDataService for VertexRagDataService<T>
where
    T: crate::stubs::VertexRagDataService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [VertexRagService](crate::stubs::VertexRagService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct VertexRagService<T>
where
    T: crate::stubs::VertexRagService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::VertexRagService for VertexRagService<T>
where
    T: crate::stubs::VertexRagService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [VizierService](crate::stubs::VizierService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct VizierService<T>
where
    T: crate::stubs::VizierService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::VizierService for VizierService<T>
where
    T: crate::stubs::VizierService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
