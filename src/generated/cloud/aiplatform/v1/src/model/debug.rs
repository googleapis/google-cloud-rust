...
impl std::fmt::Debug for super::ReasoningEngineSpec {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        debug_struct.field("build_spec", &self.build_spec);
...
#[cfg(feature = "reasoning-engine-service")]
impl std::fmt::Debug for super::reasoning_engine_spec::BuildSpec {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut debug_struct = f.debug_struct("BuildSpec");
...
impl std::fmt::Debug for super::Tool {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        debug_struct.field("exa_ai_search", &self.exa_ai_search);
...
impl std::fmt::Debug for super::tool::ExaAiSearch {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut debug_struct = f.debug_struct("ExaAiSearch");
        debug_struct.field("api_key", &self.api_key);
        debug_struct.field("custom_configs", &self.custom_configs);
        if !self._unknown_fields.is_empty() {
            debug_struct.field("_unknown_fields", &self._unknown_fields);
