...
pub mod scan_config {
    ...
    impl Authentication {
        ...
        /// let x = Authentication::new().set_authentication(Some(scan_config::authentication::Authentication::CustomAccount(CustomAccount::default().into())));
        /// ```
    ...
    pub mod authentication {
        ...
        impl IapCredential {
            ...
            /// ```
            /// # use google_cloud_websecurityscanner_v1::model::scan_config::authentication::IapCredential;
            /// use google_cloud_websecurityscanner_v1::model::scan_config::authentication::iap_credential;
            /// use google_cloud_websecurityscanner_v1::model::scan_config::authentication::iap_credential::IapTestServiceAccountInfo;
            /// let x = IapCredential::new().set_iap_credentials(Some(scan_config::authentication::iap_credential::IapCredentials::IapTestServiceAccountInfo(IapTestServiceAccountInfo::default().into())));
            /// ```
