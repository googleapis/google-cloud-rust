...
/// [with_credentials()]: super::builder::web_security_scanner::ClientBuilder::with_credentials
...
impl WebSecurityScanner {
    ...
    pub fn builder() -> super::builder::web_security_scanner::ClientBuilder {
        crate::new_client_builder(super::builder::web_security_scanner::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::WebSecurityScanner>>
    {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::WebSecurityScanner> {
