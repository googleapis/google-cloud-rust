...
/// Implements a [WebSecurityScanner](crate::stubs::WebSecurityScanner) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct WebSecurityScanner<T>
where
    T: crate::stubs::WebSecurityScanner + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::WebSecurityScanner for WebSecurityScanner<T>
where
    T: crate::stubs::WebSecurityScanner + std::fmt::Debug + Send + Sync,
{
