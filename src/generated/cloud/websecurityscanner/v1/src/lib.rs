...
//!
//!
//! This crate contains traits, types, and functions to interact with Web Security Scanner API
...
const DEFAULT_HOST: &str = "https://websecurityscanner.googleapis.com/";
