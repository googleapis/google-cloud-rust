        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//developerconnect.googleapis.com/v1/{}/connections",
                    var_parent,
                );
    ...
    async fn get_connection(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//developerconnect.googleapis.com/v1/{}", var_name,);
    ...
    async fn create_git_repository_link(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//developerconnect.googleapis.com/v1/{}/gitRepositoryLinks",
                    var_parent,
                );
    ...
    async fn fetch_read_write_token(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//developerconnect.googleapis.com/v1/{}",
    ...
    async fn fetch_linkable_git_repositories(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//developerconnect.googleapis.com/v1/{}", var_connection,);
    ...
    async fn list_account_connectors(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//developerconnect.googleapis.com/v1/{}/accountConnectors",
                    var_parent,
                );
    ...
    async fn fetch_access_token(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//developerconnect.googleapis.com/v1/{}/users",
    ...
    async fn list_users(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//developerconnect.googleapis.com/v1/{}/users", var_parent,);
    ...
    async fn fetch_self(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//developerconnect.googleapis.com/v1/{}/users", var_name,);
    ...
    async fn list_insights_configs(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//developerconnect.googleapis.com/v1/{}/insightsConfigs",
                    var_parent,
                );
    ...
    async fn list_deployment_events(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//developerconnect.googleapis.com/v1/{}/deploymentEvents",
                    var_parent,
                );
