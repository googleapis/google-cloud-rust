...
/// Implements a [DeveloperConnect](super::stubs::DeveloperConnect) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DeveloperConnect<T>
where
    T: super::stubs::DeveloperConnect + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::DeveloperConnect for DeveloperConnect<T>
where
    T: super::stubs::DeveloperConnect + std::fmt::Debug + Send + Sync,
{
