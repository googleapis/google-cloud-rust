...
pub mod git_hub_config {
    ...
    #[derive(Clone, Debug, PartialEq)]
    pub struct GitHubApp(wkt::enumerations::Enumeration);
    ...
    pub mod git_hub_app {
        ...
        pub const GIT_HUB_APP_UNSPECIFIED: GitHubApp =
            GitHubApp::known("GIT_HUB_APP_UNSPECIFIED", 0);

        /// The Developer Connect GitHub Application.
        pub const DEVELOPER_CONNECT: GitHubApp = GitHubApp::known("DEVELOPER_CONNECT", 1);

        /// The Firebase GitHub Application.
        pub const FIREBASE: GitHubApp = GitHubApp::known("FIREBASE", 2);
    }
    ...
    impl<'de> serde::de::Deserialize<'de> for GitHubApp {
            ...
            D: serde::Deserializer<'de>,
        {
            ...
            use wkt::enumerations::Enumeration;
            match Enumeration::deserialize(deserializer)? {
                Enumeration::Known { str: _, val } => Ok(GitHubApp::from(val)),
                Enumeration::UnknownStr { val, str: _ } => Ok(GitHubApp::from(val)),
                Enumeration::UnknownNum { str } => Ok(GitHubApp::from(str)),
            }
        }
    }
    ...
    impl std::convert::From<std::string::String> for GitHubApp {
        fn from(value: std::string::String) -> Self {
            match value.as_str() {
                "GIT_HUB_APP_UNSPECIFIED" => git_hub_app::GIT_HUB_APP_UNSPECIFIED,
                "DEVELOPER_CONNECT" => git_hub_app::DEVELOPER_CONNECT,
                "FIREBASE" => git_hub_app::FIREBASE,
                _ => Self(wkt::enumerations::Enumeration::known_str(value)),
            }
        }
    }
    ...
    impl std::convert::From<i32> for GitHubApp {
        fn from(value: i32) -> Self {
            match value {
                0 => git_hub_app::GIT_HUB_APP_UNSPECIFIED,
                1 => git_hub_app::DEVELOPER_CONNECT,
                2 => git_hub_app::FIREBASE,
                _ => Self(wkt::enumerations::Enumeration::known_num(value)),
            }
        }
    }
