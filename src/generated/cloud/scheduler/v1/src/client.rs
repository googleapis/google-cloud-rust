...
/// [with_credentials()]: super::builder::cloud_scheduler::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `CloudScheduler` in
...
impl CloudScheduler {
    ...
    pub fn builder() -> super::builder::cloud_scheduler::ClientBuilder {
        crate::new_client_builder(super::builder::cloud_scheduler::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::CloudScheduler>> {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::CloudScheduler> {
    ...
    ///    client: &CloudScheduler
    /// ) -> Result<()> {
    ///     let response = client.resume_job()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
