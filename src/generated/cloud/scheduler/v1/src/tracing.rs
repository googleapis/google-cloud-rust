...
/// Implements a [CloudScheduler](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudScheduler<T>
where
    T: crate::traits::CloudScheduler + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::CloudScheduler for CloudScheduler<T>
where
    T: crate::traits::CloudScheduler + std::fmt::Debug + Send + Sync,
{
