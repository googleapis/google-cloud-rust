...
/// Implements a [CloudScheduler](crate::stubs::CloudScheduler) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudScheduler<T>
where
    T: crate::stubs::CloudScheduler + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::CloudScheduler for CloudScheduler<T>
where
    T: crate::stubs::CloudScheduler + std::fmt::Debug + Send + Sync,
{
