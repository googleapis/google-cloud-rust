...
/// Implements a [CloudScheduler](super::stubs::CloudScheduler) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudScheduler<T>
where
    T: super::stubs::CloudScheduler + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::CloudScheduler for CloudScheduler<T>
where
    T: super::stubs::CloudScheduler + std::fmt::Debug + Send + Sync,
{
