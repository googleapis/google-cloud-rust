...
/// A dyn-compatible, crate-private version of `CloudScheduler`.
...
/// All implementations of [crate::traits::CloudScheduler] also implement [CloudScheduler].
#[async_trait::async_trait]
impl<T: crate::traits::CloudScheduler> CloudScheduler for T {
