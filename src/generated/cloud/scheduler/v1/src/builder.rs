...
/// Request and client builders for [CloudScheduler][crate::client::CloudScheduler].
pub mod cloud_scheduler {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for PauseJob {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ResumeJob {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for RunJob {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
