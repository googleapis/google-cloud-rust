...
/// Request and client builders for [AppConnectionsService][crate::client::AppConnectionsService].
pub mod app_connections_service {
    ...
    /// # Example
    /// ```
    /// # use google_cloud_beyondcorp_appconnections_v1::builder::app_connections_service::ListAppConnections;
    /// # async fn sample() -> google_cloud_beyondcorp_appconnections_v1::Result<()> {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListAppConnections {
    ...
    /// # Example
    /// ```
    /// # use google_cloud_beyondcorp_appconnections_v1::builder::app_connections_service::GetAppConnection;
    /// # async fn sample() -> google_cloud_beyondcorp_appconnections_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetAppConnection {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    /// # Example
    /// ```
    /// # use google_cloud_beyondcorp_appconnections_v1::builder::app_connections_service::CreateAppConnection;
    /// # async fn sample() -> google_cloud_beyondcorp_appconnections_v1::Result<()> {
    ...
    impl CreateAppConnection {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `create_app_connection`.
        pub fn poller(
            self,
        ...
        > {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_beyondcorp_appconnections_v1::client::AppConnectionsService::create_app_connection::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateAppConnection {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    /// # Example
    /// ```
    /// # use google_cloud_beyondcorp_appconnections_v1::builder::app_connections_service::UpdateAppConnection;
    /// # async fn sample() -> google_cloud_beyondcorp_appconnections_v1::Result<()> {
    /// use google_cloud_lro::Poller;
    ///
    /// let builder = prepare_request_builder();
    ...
    impl UpdateAppConnection {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `update_app_connection`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<
            crate::model::AppConnection,
        ...
        > {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_beyondcorp_appconnections_v1::client::AppConnectionsService::update_app_connection::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateAppConnection {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    /// # Example
    /// ```
    /// # use google_cloud_beyondcorp_appconnections_v1::builder::app_connections_service::DeleteAppConnection;
    /// # async fn sample() -> google_cloud_beyondcorp_appconnections_v1::Result<()> {
    /// use google_cloud_lro::Poller;
    ///
    /// let builder = prepare_request_builder();
    ...
    impl DeleteAppConnection {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `delete_app_connection`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<(), crate::model::AppConnectionOperationMetadata>
        {
            type Operation = google_cloud_lro::internal::Operation<
                wkt::Empty,
                crate::model::AppConnectionOperationMetadata,
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_beyondcorp_appconnections_v1::client::AppConnectionsService::delete_app_connection::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteAppConnection {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    /// # Example
    /// ```
    /// # use google_cloud_beyondcorp_appconnections_v1::builder::app_connections_service::ResolveAppConnections;
    /// # async fn sample() -> google_cloud_beyondcorp_appconnections_v1::Result<()> {
    /// use google_cloud_gax::paginator::ItemPaginator;
    ///
    /// let builder = prepare_request_builder();
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ResolveAppConnections {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    /// # Example
    /// ```
    /// # use google_cloud_beyondcorp_appconnections_v1::builder::app_connections_service::ListLocations;
    /// # async fn sample() -> google_cloud_beyondcorp_appconnections_v1::Result<()> {
    /// use google_cloud_gax::paginator::ItemPaginator;
    ///
    /// let builder = prepare_request_builder();
    ...
    /// # Example
    /// ```
    /// # use google_cloud_beyondcorp_appconnections_v1::builder::app_connections_service::GetLocation;
    /// # async fn sample() -> google_cloud_beyondcorp_appconnections_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    ...
    /// # Example
    /// ```
    /// # use google_cloud_beyondcorp_appconnections_v1::builder::app_connections_service::SetIamPolicy;
    /// # async fn sample() -> google_cloud_beyondcorp_appconnections_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    ...
    /// # Example
    /// ```
    /// # use google_cloud_beyondcorp_appconnections_v1::builder::app_connections_service::GetIamPolicy;
    /// # async fn sample() -> google_cloud_beyondcorp_appconnections_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    ...
    /// # Example
    /// ```
    /// # use google_cloud_beyondcorp_appconnections_v1::builder::app_connections_service::TestIamPermissions;
    /// # async fn sample() -> google_cloud_beyondcorp_appconnections_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    ...
    /// # Example
    /// ```
    /// # use google_cloud_beyondcorp_appconnections_v1::builder::app_connections_service::ListOperations;
    /// # async fn sample() -> google_cloud_beyondcorp_appconnections_v1::Result<()> {
    /// use google_cloud_gax::paginator::ItemPaginator;
    ///
    /// let builder = prepare_request_builder();
    ...
    /// # Example
    /// ```
    /// # use google_cloud_beyondcorp_appconnections_v1::builder::app_connections_service::GetOperation;
    /// # async fn sample() -> google_cloud_beyondcorp_appconnections_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    ...
    /// # Example
    /// ```
    /// # use google_cloud_beyondcorp_appconnections_v1::builder::app_connections_service::DeleteOperation;
    /// # async fn sample() -> google_cloud_beyondcorp_appconnections_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    ...
    /// # Example
    /// ```
    /// # use google_cloud_beyondcorp_appconnections_v1::builder::app_connections_service::CancelOperation;
    /// # async fn sample() -> google_cloud_beyondcorp_appconnections_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
