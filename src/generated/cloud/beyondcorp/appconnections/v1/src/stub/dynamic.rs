...
pub trait AppConnectionsService: std::fmt::Debug + Send + Sync {
    ...
    ) -> crate::Result<crate::Response<crate::model::ListAppConnectionsResponse>>;

    async fn get_app_connection(
        &self,
        req: crate::model::GetAppConnectionRequest,
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::AppConnection>>;
    ...
    async fn resolve_app_connections(
        ...
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::ResolveAppConnectionsResponse>>;
