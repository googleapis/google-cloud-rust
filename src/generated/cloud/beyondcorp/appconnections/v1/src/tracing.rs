...
/// Implements a [AppConnectionsService](crate::stubs::AppConnectionsService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AppConnectionsService<T>
where
    T: crate::stubs::AppConnectionsService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::AppConnectionsService for AppConnectionsService<T>
where
    T: crate::stubs::AppConnectionsService + std::fmt::Debug + Send + Sync,
{
