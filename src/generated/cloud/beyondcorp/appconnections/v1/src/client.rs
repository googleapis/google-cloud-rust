...
/// Implements a client for the BeyondCorp AppConnections API.
///
/// # Example
/// ```
...
/// [with_credentials()]: super::builder::app_connections_service::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `AppConnectionsService` in
