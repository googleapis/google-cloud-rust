...
impl super::stub::AppConnectionsService for AppConnectionsService {
    async fn list_app_connections(
        ...
        let response: crate::model::ListAppConnectionsResponse = self
            .inner
    ...
    async fn get_app_connection(
        ...
        let response: crate::model::AppConnection = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn resolve_app_connections(
        ...
        let builder = builder.query(&[("pageSize", &req.page_size)]);
        let builder = builder.query(&[("pageToken", &req.page_token)]);
        let response: crate::model::ResolveAppConnectionsResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
