    ...
    async fn list_app_connections(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/appConnections";
    ...
    async fn update_app_connection(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{app_connection.name}";

                let resource_name =
                    format!("//beyondcorp.googleapis.com/{}", var_app_connection_name,);
    ...
    async fn resolve_app_connections(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/appConnections:resolve";
