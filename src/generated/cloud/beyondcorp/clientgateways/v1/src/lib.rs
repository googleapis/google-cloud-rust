...
//!
//! This crate contains traits, types, and functions to interact with BeyondCorp ClientGateways API
...
//! # Available Clients
//!
//! * [ClientGatewaysService](client/struct.ClientGatewaysService.html)
//!
//! # Features
//!
