...
pub trait ClientGatewaysService: std::fmt::Debug + Send + Sync {
    ...
    fn list_client_gateways(
        ...
        Output = crate::Result<gax::response::Response<crate::model::ListClientGatewaysResponse>>,
    > + Send {
        std::future::ready::<
    ...
    fn get_client_gateway(
        ...
        Output = crate::Result<gax::response::Response<crate::model::ClientGateway>>,
    > + Send {
        std::future::ready::<crate::Result<gax::response::Response<crate::model::ClientGateway>>>(
            Err(Error::other("unimplemented")),
        )
    }
