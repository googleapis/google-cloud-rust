...
/// Request and client builders for [ClientGatewaysService][crate::client::ClientGatewaysService].
pub mod client_gateways_service {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListClientGateways {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetClientGateway {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateClientGateway {
        ...
        > {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_beyondcorp_clientgateways_v1::client::ClientGatewaysService::create_client_gateway::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateClientGateway {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteClientGateway {
        ...
        ) -> impl google_cloud_lro::Poller<(), crate::model::ClientGatewayOperationMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_beyondcorp_clientgateways_v1::client::ClientGatewaysService::delete_client_gateway::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteClientGateway {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
