...
/// Implements [ClientGatewaysService](crate::stubs::ClientGatewaysService) using a [gax::http_client::ReqwestClient].
#[derive(Clone)]
...
impl crate::stubs::ClientGatewaysService for ClientGatewaysService {
