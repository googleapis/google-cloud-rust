...
pub trait ClientGatewaysService: std::fmt::Debug + Send + Sync {
    ...
    ) -> crate::Result<gax::response::Response<crate::model::ListClientGatewaysResponse>>;

    async fn get_client_gateway(
        &self,
        req: crate::model::GetClientGatewayRequest,
        options: gax::options::RequestOptions,
    ) -> crate::Result<gax::response::Response<crate::model::ClientGateway>>;
...
/// All implementations of [super::ClientGatewaysService] also implement [ClientGatewaysService].
#[async_trait::async_trait]
impl<T: super::ClientGatewaysService> ClientGatewaysService for T {
