...
pub trait ClientGatewaysService: std::fmt::Debug + Send + Sync {
    ...
    ) -> impl std::future::Future<Output = crate::Result<crate::model::ListClientGatewaysResponse>> + Send
    {
        std::future::ready::<crate::Result<crate::model::ListClientGatewaysResponse>>(Err(
    ...
    fn get_client_gateway(
        ...
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::ClientGateway>> + Send {
        std::future::ready::<crate::Result<crate::model::ClientGateway>>(Err(Error::other(
            "unimplemented",
        )))
    }
