...
/// Implements a client for the BeyondCorp ClientGateways API.
///
/// # Example
/// ```
...
/// [with_credentials()]: super::builder::client_gateways_service::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `ClientGatewaysService` in
...
impl ClientGatewaysService {
    ...
    pub fn builder() -> super::builder::client_gateways_service::ClientBuilder {
        crate::new_client_builder(super::builder::client_gateways_service::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::ClientGatewaysService>>
    {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::ClientGatewaysService> {
