...
pub mod app_gateway {
    ...
    /// Connection.
    #[derive(Clone, Debug, PartialEq)]
    pub struct HostType(wkt::enumerations::Enumeration);
    ...
    pub mod host_type {
        ...
        /// Default value. This value is unused.
        pub const HOST_TYPE_UNSPECIFIED: HostType = HostType::known("HOST_TYPE_UNSPECIFIED", 0);

        /// AppGateway hosted in a GCP regional managed instance group.
        pub const GCP_REGIONAL_MIG: HostType = HostType::known("GCP_REGIONAL_MIG", 1);
    }
    ...
    impl<'de> serde::de::Deserialize<'de> for HostType {
            ...
            D: serde::Deserializer<'de>,
        {
            ...
            use wkt::enumerations::Enumeration;
            match Enumeration::deserialize(deserializer)? {
                Enumeration::Known { str: _, val } => Ok(HostType::from(val)),
                Enumeration::UnknownStr { val, str: _ } => Ok(HostType::from(val)),
                Enumeration::UnknownNum { str } => Ok(HostType::from(str)),
            }
        }
    }
    ...
    impl std::convert::From<std::string::String> for HostType {
        fn from(value: std::string::String) -> Self {
            match value.as_str() {
                "HOST_TYPE_UNSPECIFIED" => host_type::HOST_TYPE_UNSPECIFIED,
                "GCP_REGIONAL_MIG" => host_type::GCP_REGIONAL_MIG,
                _ => Self(wkt::enumerations::Enumeration::known_str(value)),
            }
        }
    }
    ...
    impl std::convert::From<i32> for HostType {
        fn from(value: i32) -> Self {
            match value {
                0 => host_type::HOST_TYPE_UNSPECIFIED,
                1 => host_type::GCP_REGIONAL_MIG,
                _ => Self(wkt::enumerations::Enumeration::known_num(value)),
            }
        }
    }
