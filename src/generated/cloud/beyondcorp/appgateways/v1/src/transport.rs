...
/// Implements [AppGatewaysService](crate::stubs::AppGatewaysService) using a [gax::http_client::ReqwestClient].
#[derive(Clone)]
...
impl crate::stubs::AppGatewaysService for AppGatewaysService {
