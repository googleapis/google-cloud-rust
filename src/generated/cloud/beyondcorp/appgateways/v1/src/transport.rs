...
impl super::stub::AppGatewaysService for AppGatewaysService {
    async fn list_app_gateways(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}/appGateways", var_parent,);
    ...
    async fn create_app_gateway(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.beyondcorp.appgateways.v1.AppGatewaysService/CreateAppGateway")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name)
            );
        }
    ...
    async fn delete_app_gateway(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.beyondcorp.appgateways.v1.AppGatewaysService/DeleteAppGateway")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name)
            );
        }
