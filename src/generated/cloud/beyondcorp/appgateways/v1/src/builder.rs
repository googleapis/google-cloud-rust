...
/// Request and client builders for [AppGatewaysService][crate::client::AppGatewaysService].
pub mod app_gateways_service {
    ...
    /// # async fn sample() -> google_cloud_beyondcorp_appgateways_v1::Result<()> {
    ...
    impl ListAppGateways {
        ...
        pub fn by_page(
            ...
            crate::model::ListAppGatewaysResponse,
            crate::Error,
        > {
            use std::clone::Clone;
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListAppGateways {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetAppGateway {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateAppGateway {
        ...
        > {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_beyondcorp_appgateways_v1::client::AppGatewaysService::create_app_gateway::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateAppGateway {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteAppGateway {
        ...
        pub fn poller(
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_beyondcorp_appgateways_v1::client::AppGatewaysService::delete_app_gateway::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteAppGateway {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
