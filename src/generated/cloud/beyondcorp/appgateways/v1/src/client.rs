...
impl AppGatewaysService {
    ...
    /// ```
    /// # use gax::Result;
    /// # use google_cloud_beyondcorp_appgateways_v1::model;
    /// async fn wait(
    ///     mut poller: impl lro::Poller<model::AppGateway, model::AppGatewayOperationMetadata>
    /// ) -> Result<model::AppGateway> {
    ...
    /// field contains the final response, this will be a [crate::model::AppGateway] (as
    /// an [Any]), or the error (as a `Status`).
    ///
    /// If the `done` field is `false`, the operation has not completed.  The
    /// operation may also include a [crate::model::AppGatewayOperationMetadata] value in the `metadata`
    ...
    ///
    /// [send()]: crate::builders::app_gateways_service::CreateAppGateway::send
    /// [poller()]: crate::builders::app_gateways_service::CreateAppGateway::poller
    ...
    /// # use google_cloud_beyondcorp_appgateways_v1::model;
    /// async fn wait(
    ///     mut poller: impl lro::Poller<wkt::Empty, model::AppGatewayOperationMetadata>
    /// ) -> Result<wkt::Empty> {
    ///     poller.until_done().await
    /// }
    /// ```
    ...
    /// the error status in the [result] field.
    ///
    /// [send()]: crate::builders::app_gateways_service::DeleteAppGateway::send
    /// [poller()]: crate::builders::app_gateways_service::DeleteAppGateway::poller
    /// [until_done()]: lro::Poller::until_done
    /// [PollingPolicy]: gax::polling_policy::PollingPolicy
    /// [PollingBackoffPolicy]: gax::polling_backoff_policy::PollingBackoffPolicy
    /// [get_operation]: Self::get_operation
