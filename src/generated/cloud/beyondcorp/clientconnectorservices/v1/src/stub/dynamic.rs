...
/// A dyn-compatible, crate-private version of [super::ClientConnectorServicesService].
...
pub trait ClientConnectorServicesService: std::fmt::Debug + Send + Sync {
    ...
    ) -> crate::Result<crate::Response<crate::model::ListClientConnectorServicesResponse>>;

    async fn get_client_connector_service(
        &self,
        req: crate::model::GetClientConnectorServiceRequest,
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::ClientConnectorService>>;
...
impl<T: super::ClientConnectorServicesService> ClientConnectorServicesService for T {
    ...
    async fn get_client_connector_service(
        ...
        T::get_client_connector_service(self, req, options).await
    }
    ...
    async fn create_client_connector_service(
        ...
        T::create_client_connector_service(self, req, options).await
    }
    ...
    async fn update_client_connector_service(
        ...
        T::update_client_connector_service(self, req, options).await
    }
    ...
    async fn delete_client_connector_service(
        ...
        T::delete_client_connector_service(self, req, options).await
    }
