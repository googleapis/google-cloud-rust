...
/// Implements a [ClientConnectorServicesService](super::stubs::ClientConnectorServicesService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ClientConnectorServicesService<T>
where
    T: super::stubs::ClientConnectorServicesService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ClientConnectorServicesService for ClientConnectorServicesService<T>
where
    T: super::stubs::ClientConnectorServicesService + std::fmt::Debug + Send + Sync,
{
