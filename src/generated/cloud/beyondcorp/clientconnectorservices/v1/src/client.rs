...
/// Implements a client for the BeyondCorp ClientConnectorServices API.
///
/// # Example
/// ```
...
/// [with_credentials()]: super::builder::client_connector_services_service::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `ClientConnectorServicesService` in
...
impl ClientConnectorServicesService {
    ...
    async fn build_inner(
        ...
        std::sync::Arc<dyn super::stub::dynamic::ClientConnectorServicesService>,
    > {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::ClientConnectorServicesService> {
