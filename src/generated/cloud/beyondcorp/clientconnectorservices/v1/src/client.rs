...
impl ClientConnectorServicesService {
    ...
    /// ```
    /// # use gax::Result;
    /// # use google_cloud_beyondcorp_clientconnectorservices_v1::model;
    /// async fn wait(
    ///     mut poller: impl lro::Poller<model::ClientConnectorService, model::ClientConnectorServiceOperationMetadata>
    /// ) -> Result<model::ClientConnectorService> {
    ...
    /// field contains the final response, this will be a [crate::model::ClientConnectorService] (as
    /// an [Any]), or the error (as a `Status`).
    ///
    /// If the `done` field is `false`, the operation has not completed.  The
    /// operation may also include a [crate::model::ClientConnectorServiceOperationMetadata] value in the `metadata`
    ...
    ///
    /// [send()]: crate::builders::client_connector_services_service::CreateClientConnectorService::send
    /// [poller()]: crate::builders::client_connector_services_service::CreateClientConnectorService::poller
    ...
    /// the error status in the [result] field.
    ///
    /// [send()]: crate::builders::client_connector_services_service::UpdateClientConnectorService::send
    /// [poller()]: crate::builders::client_connector_services_service::UpdateClientConnectorService::poller
    /// [until_done()]: lro::Poller::until_done
    /// [PollingPolicy]: gax::polling_policy::PollingPolicy
    /// [PollingBackoffPolicy]: gax::polling_backoff_policy::PollingBackoffPolicy
    /// [get_operation]: Self::get_operation
    ...
    /// # use google_cloud_beyondcorp_clientconnectorservices_v1::model;
    /// async fn wait(
    ///     mut poller: impl lro::Poller<wkt::Empty, model::ClientConnectorServiceOperationMetadata>
    /// ) -> Result<wkt::Empty> {
    ///     poller.until_done().await
    /// }
    /// ```
    ...
    /// the error status in the [result] field.
    ///
    /// [send()]: crate::builders::client_connector_services_service::DeleteClientConnectorService::send
    /// [poller()]: crate::builders::client_connector_services_service::DeleteClientConnectorService::poller
    /// [until_done()]: lro::Poller::until_done
    /// [PollingPolicy]: gax::polling_policy::PollingPolicy
    /// [PollingBackoffPolicy]: gax::polling_backoff_policy::PollingBackoffPolicy
    /// [get_operation]: Self::get_operation
