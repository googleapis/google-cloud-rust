    ...
    async fn list_app_connectors(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/appConnectors";
    ...
    async fn update_app_connector(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{app_connector.name}";

                let resource_name =
                    format!("//beyondcorp.googleapis.com/{}", var_app_connector_name,);
    ...
    async fn report_status(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{app_connector}:reportStatus";
