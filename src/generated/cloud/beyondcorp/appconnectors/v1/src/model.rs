...
impl NotificationConfig {
    ...
    /// ```
    /// # use google_cloud_beyondcorp_appconnectors_v1::model::NotificationConfig;
    /// use google_cloud_beyondcorp_appconnectors_v1::model::notification_config;
    /// use google_cloud_beyondcorp_appconnectors_v1::model::notification_config::CloudPubSubNotificationConfig;
    /// let x = NotificationConfig::new().set_config(Some(notification_config::Config::PubsubNotification(CloudPubSubNotificationConfig::default().into())));
    /// ```
    pub fn set_config<
...
pub mod app_connector {
    ...
    impl PrincipalInfo {
        ...
        /// ```
        /// # use google_cloud_beyondcorp_appconnectors_v1::model::app_connector::PrincipalInfo;
        /// use google_cloud_beyondcorp_appconnectors_v1::model::app_connector::principal_info;
        /// use google_cloud_beyondcorp_appconnectors_v1::model::app_connector::principal_info::ServiceAccount;
        /// let x = PrincipalInfo::new().set_type(Some(app_connector::principal_info::Type::ServiceAccount(ServiceAccount::default().into())));
        /// ```
        pub fn set_type<
            T: std::convert::Into<
