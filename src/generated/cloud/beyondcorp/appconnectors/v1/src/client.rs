...
/// Implements a client for the BeyondCorp AppConnectors API.
///
/// # Example
/// ```
...
/// [with_credentials()]: super::builder::app_connectors_service::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `AppConnectorsService` in
...
impl AppConnectorsService {
    ...
    pub fn builder() -> super::builder::app_connectors_service::ClientBuilder {
        crate::new_client_builder(super::builder::app_connectors_service::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::AppConnectorsService>>
    {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::AppConnectorsService> {
    ...
    /// ) -> Result<()> {
    ///     let response = client.report_status()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
