    ...
    async fn list_address_groups(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/addressGroups";
    ...
    async fn update_address_group(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{address_group.name}";

                let resource_name = format!(
                    "//networksecurity.googleapis.com/{}",
                    var_address_group_name,
                );
    ...
    async fn add_address_group_items(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{address_group}:addItems";
    ...
    async fn remove_address_group_items(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{address_group}:removeItems";
    ...
    async fn clone_address_group_items(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{address_group}:cloneItems";
    ...
    async fn list_address_group_references(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{address_group}:listReferences";
    ...
    async fn list_authorization_policies(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/authorizationPolicies";
    ...
    async fn update_authorization_policy(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{authorization_policy.name}";

                let resource_name = format!(
                    "//networksecurity.googleapis.com/{}",
                    var_authorization_policy_name,
                );
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
    ...
    async fn list_server_tls_policies(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/serverTlsPolicies";
    ...
    async fn update_server_tls_policy(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{server_tls_policy.name}";

                let resource_name = format!(
                    "//networksecurity.googleapis.com/{}",
                    var_server_tls_policy_name,
                );
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
    ...
    async fn list_client_tls_policies(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/clientTlsPolicies";
    ...
    async fn update_client_tls_policy(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{client_tls_policy.name}";

                let resource_name = format!(
                    "//networksecurity.googleapis.com/{}",
                    var_client_tls_policy_name,
                );
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
