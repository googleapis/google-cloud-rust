...
/// Implements a [NetworkSecurity](crate::stubs::NetworkSecurity) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct NetworkSecurity<T>
where
    T: crate::stubs::NetworkSecurity + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::NetworkSecurity for NetworkSecurity<T>
where
    T: crate::stubs::NetworkSecurity + std::fmt::Debug + Send + Sync,
{
