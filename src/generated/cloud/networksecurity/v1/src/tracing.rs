...
/// Implements a [NetworkSecurity](super::stubs::NetworkSecurity) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct NetworkSecurity<T>
where
    T: super::stubs::NetworkSecurity + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::NetworkSecurity for NetworkSecurity<T>
where
    T: super::stubs::NetworkSecurity + std::fmt::Debug + Send + Sync,
{
