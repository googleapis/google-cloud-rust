...
//!
//!
//! This crate contains traits, types, and functions to interact with Policy Troubleshooter API
...
const DEFAULT_HOST: &str = "https://policytroubleshooter.googleapis.com/";
