...
/// Implements a [IamChecker](crate::stubs::IamChecker) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct IamChecker<T>
where
    T: crate::stubs::IamChecker + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::IamChecker for IamChecker<T>
where
    T: crate::stubs::IamChecker + std::fmt::Debug + Send + Sync,
{
