...
/// Implements a [IamChecker](super::stubs::IamChecker) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct IamChecker<T>
where
    T: super::stubs::IamChecker + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::IamChecker for IamChecker<T>
where
    T: super::stubs::IamChecker + std::fmt::Debug + Send + Sync,
{
