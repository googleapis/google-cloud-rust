...
/// [with_credentials()]: super::builder::iam_checker::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `IamChecker` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
#[derive(Clone, Debug)]
pub struct IamChecker {
    inner: std::sync::Arc<dyn super::stub::dynamic::IamChecker>,
}
...
impl IamChecker {
    ...
    pub fn builder() -> super::builder::iam_checker::ClientBuilder {
        crate::new_client_builder(super::builder::iam_checker::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::IamChecker>> {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::IamChecker> {
    ...
    /// ```
    /// # use google_cloud_policytroubleshooter_v1::client::IamChecker;
    /// use google_cloud_policytroubleshooter_v1::Result;
    /// async fn sample(
    ///    client: &IamChecker
    /// ) -> Result<()> {
    ///     let response = client.troubleshoot_iam_policy()
