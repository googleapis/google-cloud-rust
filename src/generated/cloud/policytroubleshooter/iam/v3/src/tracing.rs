...
/// Implements a [PolicyTroubleshooter](crate::stubs::PolicyTroubleshooter) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct PolicyTroubleshooter<T>
where
    T: crate::stubs::PolicyTroubleshooter + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::PolicyTroubleshooter for PolicyTroubleshooter<T>
where
    T: crate::stubs::PolicyTroubleshooter + std::fmt::Debug + Send + Sync,
{
