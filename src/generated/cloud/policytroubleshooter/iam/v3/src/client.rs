...
/// [with_credentials()]: super::builder::policy_troubleshooter::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `PolicyTroubleshooter` in
...
impl PolicyTroubleshooter {
    ...
    /// ```
    /// # use google_cloud_policytroubleshooter_iam_v3::client::PolicyTroubleshooter;
    /// use google_cloud_policytroubleshooter_iam_v3::Result;
    /// async fn sample(
