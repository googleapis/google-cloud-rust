        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//backupdr.googleapis.com/v1/{}/managementServers",
                    var_parent,
                );
    ...
    async fn get_management_server(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//backupdr.googleapis.com/v1/{}", var_name,);
    ...
    async fn create_backup_vault(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//backupdr.googleapis.com/v1/{}/backupVaults", var_parent,);
    ...
    async fn list_data_sources(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//backupdr.googleapis.com/v1/{}/dataSources", var_parent,);
    ...
    async fn list_backups(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//backupdr.googleapis.com/v1/{}/backups", var_parent,);
    ...
    async fn create_backup_plan(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//backupdr.googleapis.com/v1/{}/backupPlans", var_parent,);
    ...
    async fn list_backup_plan_revisions(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//backupdr.googleapis.com/v1/{}/revisions", var_parent,);
    ...
    async fn create_backup_plan_association(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//backupdr.googleapis.com/v1/{}/backupPlanAssociations",
                    var_parent,
                );
    ...
    async fn list_data_source_references(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//backupdr.googleapis.com/v1/{}/dataSourceReferences",
                    var_parent,
                );
    ...
    async fn set_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//backupdr.googleapis.com/v1/{}", var_resource,);
    ...
    async fn list_resource_backup_configs(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//backupdr.googleapis.com/v1/{}/resourceBackupConfigs",
                    var_parent,
                );
