    ...
    async fn list_management_servers(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/managementServers";
    ...
    async fn fetch_usable_backup_vaults(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/backupVaults:fetchUsable";
    ...
    async fn update_backup_vault(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//backupdr.googleapis.com/{}", var_backup_vault_name,);
    ...
    async fn list_data_sources(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/dataSources";
    ...
    async fn update_data_source(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{data_source.name}";

                let resource_name = format!("//backupdr.googleapis.com/{}", var_data_source_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn fetch_backups_for_resource_type(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/backups:fetchForResourceType";
    ...
    async fn update_backup(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//backupdr.googleapis.com/{}", var_backup_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn create_backup_plan(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/backupPlans";
    ...
    async fn update_backup_plan(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{backup_plan.name}";

                let resource_name = format!("//backupdr.googleapis.com/{}", var_backup_plan_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn list_backup_plan_revisions(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/revisions";
    ...
    async fn create_backup_plan_association(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/backupPlanAssociations";
    ...
    async fn update_backup_plan_association(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{backup_plan_association.name}";

                let resource_name = format!(
                    "//backupdr.googleapis.com/{}",
                    var_backup_plan_association_name,
                );
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
    ...
    ) -> Result<crate::Response<crate::model::FetchBackupPlanAssociationsForResourceTypeResponse>>
    {
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/backupPlanAssociations:fetchForResourceType";
    ...
    async fn trigger_backup(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:triggerBackup";
    ...
    async fn list_data_source_references(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/dataSourceReferences";
    ...
    ) -> Result<crate::Response<crate::model::FetchDataSourceReferencesForResourceTypeResponse>>
    {
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/dataSourceReferences:fetchForResourceType";
    ...
    async fn initialize_service(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:initialize";
    ...
    async fn list_resource_backup_configs(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/resourceBackupConfigs";
