...
/// Implements a [BackupDR](crate::stubs::BackupDR) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct BackupDR<T>
where
    T: crate::stubs::BackupDR + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::BackupDR for BackupDR<T>
where
    T: crate::stubs::BackupDR + std::fmt::Debug + Send + Sync,
{
