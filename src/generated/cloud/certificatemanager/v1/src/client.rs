...
/// [with_credentials()]: super::builder::certificate_manager::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `CertificateManager` in
