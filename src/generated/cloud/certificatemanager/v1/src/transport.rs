        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//certificatemanager.googleapis.com/v1/{}/certificates",
                    var_parent,
                );
    ...
    async fn get_certificate(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//certificatemanager.googleapis.com/v1/{}", var_name,);
    ...
    async fn list_certificate_maps(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//certificatemanager.googleapis.com/v1/{}/certificateMaps",
                    var_parent,
                );
    ...
    async fn list_certificate_map_entries(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//certificatemanager.googleapis.com/v1/{}/certificateMapEntries",
                    var_parent,
                );
    ...
    async fn list_dns_authorizations(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//certificatemanager.googleapis.com/v1/{}/dnsAuthorizations",
                    var_parent,
                );
    ...
    async fn list_certificate_issuance_configs(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//certificatemanager.googleapis.com/v1/{}/certificateIssuanceConfigs",
                    var_parent,
                );
    ...
    async fn list_trust_configs(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//certificatemanager.googleapis.com/v1/{}/trustConfigs",
                    var_parent,
                );
