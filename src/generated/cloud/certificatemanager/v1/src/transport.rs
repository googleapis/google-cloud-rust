...
impl super::stub::CertificateManager for CertificateManager {
    async fn list_certificates(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//certificatemanager.googleapis.com/{}", var_parent,);
    ...
    async fn get_certificate(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//certificatemanager.googleapis.com/{}", var_name,);
                let builder = self.inner.builder(Method::GET, path);
                let builder = Ok(builder);
                Some(builder.map(|b| (b, Method::GET, path_template, resource_name)))
            })
    ...
    async fn list_certificate_maps(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}/certificateMaps", var_parent,);
            ...
            .or_else(|| {
                let var_name = try_match(
                    ...
                    &[
                        ...
                        Segment::Literal("/locations/"),
                        Segment::SingleWildcard,
                        Segment::Literal("/certificateMaps/"),
                        Segment::SingleWildcard,
                    ],
                )?;
                let path = format!("/v1/{}", var_name,);
    ...
    async fn create_certificate_map(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.certificatemanager.v1.CertificateManager/CreateCertificateMap")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name)
            );
        }
    ...
    async fn update_certificate_map(
        ...
        let (builder, method, _path_template) = None
            .or_else(|| {
                let var_certificate_map_name = try_match(
                    Some(&req)
                        .and_then(|m| m.certificate_map.as_ref())
                        .map(|m| &m.name)
                        .map(|s| s.as_str()),
                    &[
                        Segment::Literal("projects/"),
                ...
                let path = format!("/v1/{}", var_certificate_map_name,);
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.certificatemanager.v1.CertificateManager/UpdateCertificateMap")
                    .set_url_template(_path_template)
            );
        }
        let options = google_cloud_gax::options::internal::set_default_idempotency(
    ...
    async fn delete_certificate_map(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.certificatemanager.v1.CertificateManager/DeleteCertificateMap")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name)
            );
        }
    ...
    async fn list_certificate_map_entries(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}/certificateMapEntries", var_parent,);
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.certificatemanager.v1.CertificateManager/ListCertificateMapEntries")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name)
            );
        }
    ...
    async fn get_certificate_map_entry(
            ...
            .or_else(|| {
                let var_name = try_match(
                    ...
                    &[
                        ...
                        Segment::Literal("/certificateMaps/"),
                        Segment::SingleWildcard,
                        Segment::Literal("/certificateMapEntries/"),
                        Segment::SingleWildcard,
                    ],
                )?;
                let path = format!("/v1/{}", var_name,);
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.certificatemanager.v1.CertificateManager/GetCertificateMapEntry")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name)
            );
        }
    ...
    async fn create_certificate_map_entry(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.certificatemanager.v1.CertificateManager/CreateCertificateMapEntry")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name)
            );
        }
    ...
    async fn update_certificate_map_entry(
        ...
        let (builder, method, _path_template) = None
            .or_else(|| {
                let var_certificate_map_entry_name = try_match(
                    Some(&req)
                        .and_then(|m| m.certificate_map_entry.as_ref())
                        .map(|m| &m.name)
                        .map(|s| s.as_str()),
                    &[
                        Segment::Literal("projects/"),
                ...
                let path = format!("/v1/{}", var_certificate_map_entry_name,);
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.certificatemanager.v1.CertificateManager/UpdateCertificateMapEntry")
                    .set_url_template(_path_template)
            );
        }
        let options = google_cloud_gax::options::internal::set_default_idempotency(
    ...
    async fn delete_certificate_map_entry(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.certificatemanager.v1.CertificateManager/DeleteCertificateMapEntry")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name)
            );
        }
    ...
    async fn list_dns_authorizations(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}/dnsAuthorizations", var_parent,);
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.certificatemanager.v1.CertificateManager/ListDnsAuthorizations")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name)
            );
        }
            ...
            .or_else(|| {
                let var_name = try_match(
                    ...
                    &[
                        ...
                        Segment::Literal("/locations/"),
                        Segment::SingleWildcard,
                        Segment::Literal("/dnsAuthorizations/"),
                        Segment::SingleWildcard,
                    ],
                )?;
                let path = format!("/v1/{}", var_name,);
    ...
    async fn create_dns_authorization(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.certificatemanager.v1.CertificateManager/CreateDnsAuthorization")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name)
            );
        }
    ...
    async fn update_dns_authorization(
        ...
        let (builder, method, _path_template) = None
            .or_else(|| {
                let var_dns_authorization_name = try_match(
                    Some(&req)
                        .and_then(|m| m.dns_authorization.as_ref())
                        .map(|m| &m.name)
                        .map(|s| s.as_str()),
                    &[
                        Segment::Literal("projects/"),
                ...
                let path = format!("/v1/{}", var_dns_authorization_name,);
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.certificatemanager.v1.CertificateManager/UpdateDnsAuthorization")
                    .set_url_template(_path_template)
            );
        }
        let options = google_cloud_gax::options::internal::set_default_idempotency(
    ...
    async fn delete_dns_authorization(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.certificatemanager.v1.CertificateManager/DeleteDnsAuthorization")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name)
            );
        }
    ...
    async fn list_certificate_issuance_configs(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}/certificateIssuanceConfigs", var_parent,);
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.certificatemanager.v1.CertificateManager/ListCertificateIssuanceConfigs")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name)
            );
        }
    ...
    async fn get_certificate_issuance_config(
            ...
            .or_else(|| {
                let var_name = try_match(
                    ...
                    &[
                        ...
                        Segment::Literal("/locations/"),
                        Segment::SingleWildcard,
                        Segment::Literal("/certificateIssuanceConfigs/"),
                        Segment::SingleWildcard,
                    ],
                )?;
                let path = format!("/v1/{}", var_name,);
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.certificatemanager.v1.CertificateManager/GetCertificateIssuanceConfig")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name)
            );
        }
    ...
    async fn create_certificate_issuance_config(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.certificatemanager.v1.CertificateManager/CreateCertificateIssuanceConfig")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name)
            );
        }
    ...
    async fn delete_certificate_issuance_config(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.certificatemanager.v1.CertificateManager/DeleteCertificateIssuanceConfig")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name)
            );
        }
    ...
    async fn list_trust_configs(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}/trustConfigs", var_parent,);
    ...
    async fn update_trust_config(
        ...
        let (builder, method, _path_template) = None
            .or_else(|| {
                let var_trust_config_name = try_match(
                    Some(&req)
                        .and_then(|m| m.trust_config.as_ref())
                        .map(|m| &m.name)
                        .map(|s| s.as_str()),
                    &[
                        Segment::Literal("projects/"),
                ...
                let path = format!("/v1/{}", var_trust_config_name,);
