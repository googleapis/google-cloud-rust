...
/// Implements a [CertificateManager](crate::stubs::CertificateManager) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CertificateManager<T>
where
    T: crate::stubs::CertificateManager + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::CertificateManager for CertificateManager<T>
where
    T: crate::stubs::CertificateManager + std::fmt::Debug + Send + Sync,
{
