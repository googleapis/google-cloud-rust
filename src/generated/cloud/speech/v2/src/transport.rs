...
impl super::stub::Speech for Speech {
    ...
    async fn list_recognizers(
        ...
        let response: crate::model::ListRecognizersResponse = self
            .inner
    ...
    async fn get_recognizer(
        ...
        let response: crate::model::Recognizer = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn recognize(
        ...
        let response: crate::model::RecognizeResponse =
            self.inner.execute(builder, Some(req), options).await?;
        Ok(gax::response::Response::from(response))
    }
    ...
    async fn list_custom_classes(
        ...
        let builder = builder.query(&[("pageToken", &req.page_token)]);
        let builder = builder.query(&[("showDeleted", &req.show_deleted)]);
        let response: crate::model::ListCustomClassesResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn get_custom_class(
        ...
        let response: crate::model::CustomClass = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn list_phrase_sets(
        ...
        let builder = builder.query(&[("pageToken", &req.page_token)]);
        let builder = builder.query(&[("showDeleted", &req.show_deleted)]);
        let response: crate::model::ListPhraseSetsResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn get_phrase_set(
        ...
        let response: crate::model::PhraseSet = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
