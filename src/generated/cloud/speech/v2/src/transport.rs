    ...
    async fn create_recognizer(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//speech.googleapis.com/v2/{}/recognizers", var_parent,);
    ...
    async fn get_recognizer(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//speech.googleapis.com/v2/{}", var_name,);
    ...
    async fn recognize(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//speech.googleapis.com/v2/{}", var_recognizer,);
    ...
    async fn create_custom_class(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//speech.googleapis.com/v2/{}/customClasses", var_parent,);
    ...
    async fn create_phrase_set(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//speech.googleapis.com/v2/{}/phraseSets", var_parent,);
