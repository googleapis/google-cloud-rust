...
/// Implements a [Speech](crate::stubs::Speech) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Speech<T>
where
    T: crate::stubs::Speech + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::Speech for Speech<T>
where
    T: crate::stubs::Speech + std::fmt::Debug + Send + Sync,
{
