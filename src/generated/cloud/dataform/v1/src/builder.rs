...
/// Request and client builders for [Dataform][crate::client::Dataform].
pub mod dataform {
    use crate::Result;
    ...
    impl DeleteTeamFolderTree {
        ...
        pub fn poller(
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_dataform_v1::client::Dataform::delete_team_folder_tree::until_done";
            }
    ...
    impl DeleteFolderTree {
        ...
        pub fn poller(
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_dataform_v1::client::Dataform::delete_folder_tree::until_done";
            }
    ...
    impl MoveFolder {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::MoveFolderMetadata> {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_dataform_v1::client::Dataform::move_folder::until_done";
            }
    ...
    impl MoveRepository {
        ...
        pub fn poller(
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_dataform_v1::client::Dataform::move_repository::until_done";
            }
