...
pub trait ReachabilityService: std::fmt::Debug + Send + Sync {
    ...
    ) -> crate::Result<crate::Response<crate::model::ListConnectivityTestsResponse>>;

    async fn get_connectivity_test(
        &self,
        req: crate::model::GetConnectivityTestRequest,
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::ConnectivityTest>>;
...
pub trait VpcFlowLogsService: std::fmt::Debug + Send + Sync {
    async fn list_vpc_flow_logs_configs(
        ...
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::ListVpcFlowLogsConfigsResponse>>;

    async fn get_vpc_flow_logs_config(
        &self,
        req: crate::model::GetVpcFlowLogsConfigRequest,
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::VpcFlowLogsConfig>>;
    ...
    async fn query_org_vpc_flow_logs_configs(
        ...
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::QueryOrgVpcFlowLogsConfigsResponse>>;

    async fn show_effective_flow_logs_configs(
        &self,
        req: crate::model::ShowEffectiveFlowLogsConfigsRequest,
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::ShowEffectiveFlowLogsConfigsResponse>>;
...
/// All implementations of [super::OrganizationVpcFlowLogsService] also implement [OrganizationVpcFlowLogsService].
#[async_trait::async_trait]
impl<T: super::OrganizationVpcFlowLogsService> OrganizationVpcFlowLogsService for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn list_vpc_flow_logs_configs(
        &self,
        req: crate::model::ListVpcFlowLogsConfigsRequest,
