...
/// Request and client builders for [ReachabilityService][crate::client::ReachabilityService].
pub mod reachability_service {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListConnectivityTests {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetConnectivityTest {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateConnectivityTest {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::ConnectivityTest, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_networkmanagement_v1::client::ReachabilityService::create_connectivity_test::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateConnectivityTest {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UpdateConnectivityTest {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::ConnectivityTest, crate::model::OperationMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_networkmanagement_v1::client::ReachabilityService::update_connectivity_test::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateConnectivityTest {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl RerunConnectivityTest {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::ConnectivityTest, crate::model::OperationMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_networkmanagement_v1::client::ReachabilityService::rerun_connectivity_test::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for RerunConnectivityTest {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteConnectivityTest {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_networkmanagement_v1::client::ReachabilityService::delete_connectivity_test::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteConnectivityTest {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
...
/// Request and client builders for [VpcFlowLogsService][crate::client::VpcFlowLogsService].
pub mod vpc_flow_logs_service {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListVpcFlowLogsConfigs {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetVpcFlowLogsConfig {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateVpcFlowLogsConfig {
        ...
        > {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_networkmanagement_v1::client::VpcFlowLogsService::create_vpc_flow_logs_config::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateVpcFlowLogsConfig {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UpdateVpcFlowLogsConfig {
        ...
        > {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_networkmanagement_v1::client::VpcFlowLogsService::update_vpc_flow_logs_config::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateVpcFlowLogsConfig {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteVpcFlowLogsConfig {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_networkmanagement_v1::client::VpcFlowLogsService::delete_vpc_flow_logs_config::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteVpcFlowLogsConfig {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for QueryOrgVpcFlowLogsConfigs {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ShowEffectiveFlowLogsConfigs {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
...
/// Request and client builders for [OrganizationVpcFlowLogsService][crate::client::OrganizationVpcFlowLogsService].
pub mod organization_vpc_flow_logs_service {
    ...
    impl CreateVpcFlowLogsConfig {
        ...
        > {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_networkmanagement_v1::client::OrganizationVpcFlowLogsService::create_vpc_flow_logs_config::until_done";
            }
    ...
    impl UpdateVpcFlowLogsConfig {
        ...
        > {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_networkmanagement_v1::client::OrganizationVpcFlowLogsService::update_vpc_flow_logs_config::until_done";
            }
    ...
    impl DeleteVpcFlowLogsConfig {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_networkmanagement_v1::client::OrganizationVpcFlowLogsService::delete_vpc_flow_logs_config::until_done";
            }
