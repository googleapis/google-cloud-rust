...
impl super::stub::ReachabilityService for ReachabilityService {
    async fn list_connectivity_tests(
        ...
        let response: crate::model::ListConnectivityTestsResponse = self
            .inner
    ...
    async fn get_connectivity_test(
        ...
        let response: crate::model::ConnectivityTest = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
...
impl super::stub::VpcFlowLogsService for VpcFlowLogsService {
    async fn list_vpc_flow_logs_configs(
        ...
        let builder = builder.query(&[("filter", &req.filter)]);
        let builder = builder.query(&[("orderBy", &req.order_by)]);
        let response: crate::model::ListVpcFlowLogsConfigsResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn get_vpc_flow_logs_config(
        ...
        let response: crate::model::VpcFlowLogsConfig = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
