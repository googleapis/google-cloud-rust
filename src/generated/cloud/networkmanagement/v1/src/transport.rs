    ...
    async fn list_connectivity_tests(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/connectivityTests";
    ...
    async fn update_connectivity_test(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{resource.name}";

                let resource_name =
                    format!("//networkmanagement.googleapis.com/{}", var_resource_name,);
    ...
    async fn rerun_connectivity_test(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:rerun";
    ...
    async fn list_vpc_flow_logs_configs(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/vpcFlowLogsConfigs";
    ...
    async fn update_vpc_flow_logs_config(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{vpc_flow_logs_config.name}";

                let resource_name = format!(
                    "//networkmanagement.googleapis.com/{}",
                    var_vpc_flow_logs_config_name,
                );
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
    ...
    async fn query_org_vpc_flow_logs_configs(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/vpcFlowLogsConfigs:queryOrgVpcFlowLogsConfigs";
    ...
    async fn show_effective_flow_logs_configs(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/vpcFlowLogsConfigs:showEffectiveFlowLogsConfigs";
