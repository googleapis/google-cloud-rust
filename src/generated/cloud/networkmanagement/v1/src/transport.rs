...
/// Implements [ReachabilityService](crate::stubs::ReachabilityService) using a [gax::http_client::ReqwestClient].
#[derive(Clone)]
...
/// Implements [VpcFlowLogsService](crate::stubs::VpcFlowLogsService) using a [gax::http_client::ReqwestClient].
#[derive(Clone)]
