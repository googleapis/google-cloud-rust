...
/// Implements a [ReachabilityService](crate::stubs::ReachabilityService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ReachabilityService<T>
where
    T: crate::stubs::ReachabilityService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ReachabilityService for ReachabilityService<T>
where
    T: crate::stubs::ReachabilityService + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [VpcFlowLogsService](crate::stubs::VpcFlowLogsService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct VpcFlowLogsService<T>
where
    T: crate::stubs::VpcFlowLogsService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::VpcFlowLogsService for VpcFlowLogsService<T>
where
    T: crate::stubs::VpcFlowLogsService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
