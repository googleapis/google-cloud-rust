...
/// Implements a [ReachabilityService](super::stubs::ReachabilityService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ReachabilityService<T>
where
    T: super::stubs::ReachabilityService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ReachabilityService for ReachabilityService<T>
where
    T: super::stubs::ReachabilityService + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [VpcFlowLogsService](super::stubs::VpcFlowLogsService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct VpcFlowLogsService<T>
where
    T: super::stubs::VpcFlowLogsService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::VpcFlowLogsService for VpcFlowLogsService<T>
where
    T: super::stubs::VpcFlowLogsService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
