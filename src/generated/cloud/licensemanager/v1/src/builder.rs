...
/// Request and client builders for [LicenseManager][crate::client::LicenseManager].
pub mod license_manager {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListConfigurations {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetConfiguration {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateConfiguration {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Configuration, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_licensemanager_v1::client::LicenseManager::create_configuration::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateConfiguration {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UpdateConfiguration {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Configuration, crate::model::OperationMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_licensemanager_v1::client::LicenseManager::update_configuration::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateConfiguration {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteConfiguration {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_licensemanager_v1::client::LicenseManager::delete_configuration::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteConfiguration {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeactivateConfiguration {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Configuration, crate::model::OperationMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_licensemanager_v1::client::LicenseManager::deactivate_configuration::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeactivateConfiguration {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ReactivateConfiguration {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Configuration, crate::model::OperationMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_licensemanager_v1::client::LicenseManager::reactivate_configuration::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ReactivateConfiguration {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for QueryConfigurationLicenseUsage {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl AggregateUsage {
        ...
        pub fn by_page(
            ...
            crate::model::AggregateUsageResponse,
            crate::Error,
        > {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for AggregateUsage {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
