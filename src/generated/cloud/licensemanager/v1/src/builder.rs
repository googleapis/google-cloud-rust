...
pub mod license_manager {
    ...
    impl ListConfigurations {
        ...
        pub async fn paginator(
            self,
        ) -> gax::paginator::Paginator<crate::model::ListConfigurationsResponse, gax::error::Error>
        {
            use std::clone::Clone;
    ...
    impl AggregateUsage {
        ...
        pub async fn paginator(
            self,
        ) -> gax::paginator::Paginator<crate::model::AggregateUsageResponse, gax::error::Error>
        {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
            let execute = move |token: String| {
