...
pub trait LicenseManager: std::fmt::Debug + Send + Sync {
    ...
    ) -> impl std::future::Future<Output = crate::Result<crate::model::ListConfigurationsResponse>> + Send
    {
        std::future::ready::<crate::Result<crate::model::ListConfigurationsResponse>>(Err(
    ...
    fn get_configuration(
        ...
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::Configuration>> + Send {
        std::future::ready::<crate::Result<crate::model::Configuration>>(Err(Error::other(
            "unimplemented",
        )))
    }
    ...
    fn query_configuration_license_usage(
        ...
        Output = crate::Result<crate::model::QueryConfigurationLicenseUsageResponse>,
    > + Send {
        std::future::ready::<crate::Result<crate::model::QueryConfigurationLicenseUsageResponse>>(
    ...
    fn aggregate_usage(
        ...
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::AggregateUsageResponse>> + Send
    {
        std::future::ready::<crate::Result<crate::model::AggregateUsageResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }
