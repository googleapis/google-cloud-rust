        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//licensemanager.googleapis.com/v1/{}/configurations",
                    var_parent,
                );
    ...
    async fn get_configuration(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//licensemanager.googleapis.com/v1/{}", var_name,);
    ...
    async fn list_instances(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//licensemanager.googleapis.com/v1/{}/instances",
                    var_parent,
                );
    ...
    async fn list_products(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//licensemanager.googleapis.com/v1/{}/products", var_parent,);
