    ...
    async fn list_configurations(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/configurations";
    ...
    async fn update_configuration(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{configuration.name}";

                let resource_name =
                    format!("//licensemanager.googleapis.com/{}", var_configuration_name,);
    ...
    async fn deactivate_configuration(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:deactivate";
    ...
    async fn reactivate_configuration(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:reactivate";
    ...
    async fn query_configuration_license_usage(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:queryLicenseUsage";
    ...
    async fn aggregate_usage(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:aggregateUsage";
    ...
    async fn list_products(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/products";
