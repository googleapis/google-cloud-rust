    ...
    async fn create_process(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//datalineage.googleapis.com/v1/{}/processes", var_parent,);
    ...
    async fn get_process(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//datalineage.googleapis.com/v1/{}", var_name,);
    ...
    async fn create_run(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//datalineage.googleapis.com/v1/{}/runs", var_parent,);
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//datalineage.googleapis.com/v1/{}/lineageEvents",
                    var_parent,
                );
    ...
    async fn search_links(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//datalineage.googleapis.com/v1/{}", var_parent,);
