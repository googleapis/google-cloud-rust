...
/// Implements a [Lineage](super::stubs::Lineage) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Lineage<T>
where
    T: super::stubs::Lineage + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Lineage for Lineage<T>
where
    T: super::stubs::Lineage + std::fmt::Debug + Send + Sync,
{
