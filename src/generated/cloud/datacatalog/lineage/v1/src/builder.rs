...
/// Request and client builders for [Lineage][crate::client::Lineage].
pub mod lineage {
    use crate::Result;
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ProcessOpenLineageRunEvent {
    ...
    impl DeleteProcess {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_datacatalog_lineage_v1::client::Lineage::delete_process::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateRun {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateRun {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetRun {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ListRuns {
        ...
        pub fn by_page(
            self,
        ) -> impl google_cloud_gax::paginator::Paginator<crate::model::ListRunsResponse, crate::Error>
        {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
            let execute = move |token: String| {
        ...
        pub fn by_item(
            self,
        ) -> impl google_cloud_gax::paginator::ItemPaginator<crate::model::ListRunsResponse, crate::Error>
        {
            use google_cloud_gax::paginator::Paginator;
            self.by_page().items()
        }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListRuns {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteRun {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `delete_run`.
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            type Operation =
                google_cloud_lro::internal::Operation<wkt::Empty, crate::model::OperationMetadata>;
            let polling_error_policy = self.0.stub.get_polling_error_policy(&self.0.options);
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_datacatalog_lineage_v1::client::Lineage::delete_run::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteRun {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateLineageEvent {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetLineageEvent {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ListLineageEvents {
        ...
        pub fn by_page(
            ...
            crate::model::ListLineageEventsResponse,
            crate::Error,
        > {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListLineageEvents {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteLineageEvent {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl SearchLinks {
        ...
        pub fn by_page(
            self,
        ) -> impl google_cloud_gax::paginator::Paginator<crate::model::SearchLinksResponse, crate::Error>
        {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
            let execute = move |token: String| {
        ...
        pub fn by_item(
            ...
            crate::model::SearchLinksResponse,
            crate::Error,
        > {
            use google_cloud_gax::paginator::Paginator;
            self.by_page().items()
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for SearchLinks {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for BatchSearchLinkProcesses {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
