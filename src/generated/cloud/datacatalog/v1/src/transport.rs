...
/// Implements [DataCatalog](super::stubs::DataCatalog) using a [gaxi::ReqwestClient].
#[derive(Clone)]
...
/// Implements [PolicyTagManager](super::stubs::PolicyTagManager) using a [gaxi::ReqwestClient].
#[derive(Clone)]
...
/// Implements [PolicyTagManagerSerialization](super::stubs::PolicyTagManagerSerialization) using a [gaxi::ReqwestClient].
#[derive(Clone)]
