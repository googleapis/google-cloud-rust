...
impl BigQueryConnectionSpec {
    ...
    /// ```
    /// # use google_cloud_datacatalog_v1::model::BigQueryConnectionSpec;
    /// use google_cloud_datacatalog_v1::model::big_query_connection_spec;
    /// use google_cloud_datacatalog_v1::model::CloudSqlBigQueryConnectionSpec;
    /// let x = BigQueryConnectionSpec::new().set_connection_spec(Some(big_query_connection_spec::ConnectionSpec::CloudSql(CloudSqlBigQueryConnectionSpec::default().into())));
    /// ```
...
impl DataSource {
    ...
    /// ```
    /// # use google_cloud_datacatalog_v1::model::DataSource;
    /// use google_cloud_datacatalog_v1::model::data_source;
    /// use google_cloud_datacatalog_v1::model::StorageProperties;
    /// let x = DataSource::new().set_properties(Some(data_source::Properties::StorageProperties(StorageProperties::default().into())));
    /// ```
...
impl LookupEntryRequest {
    ...
    /// ```
    /// # use google_cloud_datacatalog_v1::model::LookupEntryRequest;
    /// use google_cloud_datacatalog_v1::model::lookup_entry_request;
    /// let x = LookupEntryRequest::new().set_target_name(Some(lookup_entry_request::TargetName::LinkedResource("example".to_string())));
    /// ```
...
impl Entry {
    ...
    /// let x0 = Entry::new().set_entry_type(Some(entry::EntryType::Type(EntryType::Table)));
    /// let x1 = Entry::new().set_entry_type(Some(entry::EntryType::Type(EntryType::Model)));
    /// let x2 = Entry::new().set_entry_type(Some(entry::EntryType::Type(EntryType::DataStream)));
    /// ```
    ...
    /// assert!(x.user_specified_type().is_none());
    /// ```
    ...
    /// let x0 = Entry::new().set_system(Some(entry::System::IntegratedSystem(IntegratedSystem::Bigquery)));
    /// let x1 = Entry::new().set_system(Some(entry::System::IntegratedSystem(IntegratedSystem::CloudPubsub)));
    /// let x2 = Entry::new().set_system(Some(entry::System::IntegratedSystem(IntegratedSystem::DataprocMetastore)));
    /// ```
    ...
    /// assert!(x.integrated_system().is_some());
    /// assert!(x.user_specified_system().is_none());
    /// ```
    ...
    /// let x = Entry::new().set_system_spec(Some(entry::SystemSpec::SqlDatabaseSystemSpec(SqlDatabaseSystemSpec::default().into())));
    /// ```
    ...
    /// let x = Entry::new().set_type_spec(Some(entry::TypeSpec::GcsFilesetSpec(GcsFilesetSpec::default().into())));
    /// ```
    ...
    /// let x = Entry::new().set_spec(Some(entry::Spec::DatabaseTableSpec(DatabaseTableSpec::default().into())));
    /// ```
...
pub mod database_table_spec {
    ...
    impl DatabaseViewSpec {
        ...
        /// ```
        /// # use google_cloud_datacatalog_v1::model::database_table_spec::DatabaseViewSpec;
        /// use google_cloud_datacatalog_v1::model::database_table_spec::database_view_spec;
        /// let x = DatabaseViewSpec::new().set_source_definition(Some(database_table_spec::database_view_spec::SourceDefinition::BaseTable("example".to_string())));
        /// ```
...
impl RoutineSpec {
    ...
    /// ```
    /// # use google_cloud_datacatalog_v1::model::RoutineSpec;
    /// use google_cloud_datacatalog_v1::model::routine_spec;
    /// use google_cloud_datacatalog_v1::model::BigQueryRoutineSpec;
    /// let x = RoutineSpec::new().set_system_spec(Some(routine_spec::SystemSpec::BigqueryRoutineSpec(BigQueryRoutineSpec::default().into())));
    /// ```
    pub fn set_system_spec<
...
impl DatasetSpec {
    ...
    /// ```
    /// # use google_cloud_datacatalog_v1::model::DatasetSpec;
    /// use google_cloud_datacatalog_v1::model::dataset_spec;
    /// use google_cloud_datacatalog_v1::model::VertexDatasetSpec;
    /// let x = DatasetSpec::new().set_system_spec(Some(dataset_spec::SystemSpec::VertexDatasetSpec(VertexDatasetSpec::default().into())));
    /// ```
    pub fn set_system_spec<
...
impl ServiceSpec {
    ...
    /// ```
    /// # use google_cloud_datacatalog_v1::model::ServiceSpec;
    /// use google_cloud_datacatalog_v1::model::service_spec;
    /// use google_cloud_datacatalog_v1::model::CloudBigtableInstanceSpec;
    /// let x = ServiceSpec::new().set_system_spec(Some(service_spec::SystemSpec::CloudBigtableInstanceSpec(CloudBigtableInstanceSpec::default().into())));
    /// ```
    pub fn set_system_spec<
...
impl ModelSpec {
    ...
    /// ```
    /// # use google_cloud_datacatalog_v1::model::ModelSpec;
    /// use google_cloud_datacatalog_v1::model::model_spec;
    /// use google_cloud_datacatalog_v1::model::VertexModelSpec;
    /// let x = ModelSpec::new().set_system_spec(Some(model_spec::SystemSpec::VertexModelSpec(VertexModelSpec::default().into())));
    /// ```
    pub fn set_system_spec<
...
impl ImportEntriesRequest {
    ...
    /// ```
    /// # use google_cloud_datacatalog_v1::model::ImportEntriesRequest;
    /// use google_cloud_datacatalog_v1::model::import_entries_request;
    /// let x = ImportEntriesRequest::new().set_source(Some(import_entries_request::Source::GcsBucketPath("example".to_string())));
    /// ```
    pub fn set_source<
...
impl SetConfigRequest {
    ...
    /// ```
    /// # use google_cloud_datacatalog_v1::model::SetConfigRequest;
    /// use google_cloud_datacatalog_v1::model::set_config_request;
    /// use google_cloud_datacatalog_v1::model::TagTemplateMigration;
    /// let x0 = SetConfigRequest::new().set_configuration(Some(set_config_request::Configuration::TagTemplateMigration(TagTemplateMigration::Enabled)));
    /// let x1 = SetConfigRequest::new().set_configuration(Some(set_config_request::Configuration::TagTemplateMigration(TagTemplateMigration::Disabled)));
    /// ```
    ...
    /// assert!(x.tag_template_migration().is_some());
    /// assert!(x.catalog_ui_experience().is_none());
    /// ```
    ...
    /// assert!(x.catalog_ui_experience().is_some());
    /// assert!(x.tag_template_migration().is_none());
    /// ```
...
impl TaggedEntry {
    ...
    /// ```
    /// # use google_cloud_datacatalog_v1::model::TaggedEntry;
    /// use google_cloud_datacatalog_v1::model::tagged_entry;
    /// use google_cloud_datacatalog_v1::model::Entry;
    /// let x = TaggedEntry::new().set_entry(Some(tagged_entry::Entry::V1Entry(Entry::default().into())));
    /// ```
    pub fn set_entry<
...
impl DumpItem {
    ...
    /// use google_cloud_datacatalog_v1::model::dump_item;
    /// use google_cloud_datacatalog_v1::model::TaggedEntry;
    /// let x = DumpItem::new().set_item(Some(dump_item::Item::TaggedEntry(TaggedEntry::default().into())));
    /// ```
...
impl PhysicalSchema {
    ...
    /// ```
    /// # use google_cloud_datacatalog_v1::model::PhysicalSchema;
    /// use google_cloud_datacatalog_v1::model::physical_schema;
    /// use google_cloud_datacatalog_v1::model::physical_schema::AvroSchema;
    /// let x = PhysicalSchema::new().set_schema(Some(physical_schema::Schema::Avro(AvroSchema::default().into())));
    /// ```
    pub fn set_schema<
...
impl ImportTaxonomiesRequest {
    ...
    /// ```
    /// # use google_cloud_datacatalog_v1::model::ImportTaxonomiesRequest;
    /// use google_cloud_datacatalog_v1::model::import_taxonomies_request;
    /// use google_cloud_datacatalog_v1::model::InlineSource;
    /// let x = ImportTaxonomiesRequest::new().set_source(Some(import_taxonomies_request::Source::InlineSource(InlineSource::default().into())));
    /// ```
    pub fn set_source<
...
impl ExportTaxonomiesRequest {
    ...
    /// ```
    /// # use google_cloud_datacatalog_v1::model::ExportTaxonomiesRequest;
    /// use google_cloud_datacatalog_v1::model::export_taxonomies_request;
    /// let x = ExportTaxonomiesRequest::new().set_destination(Some(export_taxonomies_request::Destination::SerializedTaxonomies(true)));
    /// ```
...
impl ColumnSchema {
    ...
    /// ```
    /// # use google_cloud_datacatalog_v1::model::ColumnSchema;
    /// use google_cloud_datacatalog_v1::model::column_schema;
    /// use google_cloud_datacatalog_v1::model::column_schema::LookerColumnSpec;
    /// let x = ColumnSchema::new().set_system_spec(Some(column_schema::SystemSpec::LookerColumnSpec(LookerColumnSpec::default().into())));
    /// ```
    pub fn set_system_spec<
...
impl SearchCatalogResult {
    ...
    /// ```
    /// # use google_cloud_datacatalog_v1::model::SearchCatalogResult;
    /// use google_cloud_datacatalog_v1::model::search_catalog_result;
    /// use google_cloud_datacatalog_v1::model::IntegratedSystem;
    /// let x0 = SearchCatalogResult::new().set_system(Some(search_catalog_result::System::IntegratedSystem(IntegratedSystem::Bigquery)));
    /// let x1 = SearchCatalogResult::new().set_system(Some(search_catalog_result::System::IntegratedSystem(IntegratedSystem::CloudPubsub)));
    /// let x2 = SearchCatalogResult::new().set_system(Some(search_catalog_result::System::IntegratedSystem(IntegratedSystem::DataprocMetastore)));
    /// ```
    pub fn set_system<
...
impl BigQueryTableSpec {
    ...
    /// ```
    /// # use google_cloud_datacatalog_v1::model::BigQueryTableSpec;
    /// use google_cloud_datacatalog_v1::model::big_query_table_spec;
    /// use google_cloud_datacatalog_v1::model::ViewSpec;
    /// let x = BigQueryTableSpec::new().set_type_spec(Some(big_query_table_spec::TypeSpec::ViewSpec(ViewSpec::default().into())));
    /// ```
    pub fn set_type_spec<
...
impl Tag {
    ...
    /// # use google_cloud_datacatalog_v1::model::Tag;
    /// use google_cloud_datacatalog_v1::model::tag;
    /// let x = Tag::new().set_scope(Some(tag::Scope::Column("example".to_string())));
    /// ```
...
impl TagField {
    ...
    /// ```
    /// # use google_cloud_datacatalog_v1::model::TagField;
    /// use google_cloud_datacatalog_v1::model::tag_field;
    /// let x = TagField::new().set_kind(Some(tag_field::Kind::DoubleValue(42.0)));
    /// ```
...
impl FieldType {
    ...
    /// ```
    /// # use google_cloud_datacatalog_v1::model::FieldType;
    /// use google_cloud_datacatalog_v1::model::field_type;
    /// use google_cloud_datacatalog_v1::model::field_type::PrimitiveType;
    /// let x0 = FieldType::new().set_type_decl(Some(field_type::TypeDecl::PrimitiveType(PrimitiveType::Double)));
    /// let x1 = FieldType::new().set_type_decl(Some(field_type::TypeDecl::PrimitiveType(PrimitiveType::String)));
    /// let x2 = FieldType::new().set_type_decl(Some(field_type::TypeDecl::PrimitiveType(PrimitiveType::Bool)));
    /// ```
    ...
    /// assert!(x.primitive_type().is_some());
