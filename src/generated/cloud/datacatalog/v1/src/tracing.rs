...
/// Implements a [DataCatalog](super::stubs::DataCatalog) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DataCatalog<T>
where
    T: super::stubs::DataCatalog + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::DataCatalog for DataCatalog<T>
where
    T: super::stubs::DataCatalog + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [PolicyTagManager](super::stubs::PolicyTagManager) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct PolicyTagManager<T>
where
    T: super::stubs::PolicyTagManager + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::PolicyTagManager for PolicyTagManager<T>
where
    T: super::stubs::PolicyTagManager + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [PolicyTagManagerSerialization](super::stubs::PolicyTagManagerSerialization) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct PolicyTagManagerSerialization<T>
where
    T: super::stubs::PolicyTagManagerSerialization + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::PolicyTagManagerSerialization for PolicyTagManagerSerialization<T>
where
    T: super::stubs::PolicyTagManagerSerialization + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
