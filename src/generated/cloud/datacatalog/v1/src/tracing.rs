...
/// Implements a [DataCatalog](crate::stubs::DataCatalog) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DataCatalog<T>
where
    T: crate::stubs::DataCatalog + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::DataCatalog for DataCatalog<T>
where
    T: crate::stubs::DataCatalog + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [PolicyTagManager](crate::stubs::PolicyTagManager) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct PolicyTagManager<T>
where
    T: crate::stubs::PolicyTagManager + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::PolicyTagManager for PolicyTagManager<T>
where
    T: crate::stubs::PolicyTagManager + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [PolicyTagManagerSerialization](crate::stubs::PolicyTagManagerSerialization) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct PolicyTagManagerSerialization<T>
where
    T: crate::stubs::PolicyTagManagerSerialization + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::PolicyTagManagerSerialization for PolicyTagManagerSerialization<T>
where
    T: crate::stubs::PolicyTagManagerSerialization + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
