...
/// Request and client builders for [DataCatalog][crate::client::DataCatalog].
pub mod data_catalog {
    ...
    impl ReconcileTags {
        ...
        > {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_datacatalog_v1::client::DataCatalog::reconcile_tags::until_done";
            }
    ...
    impl ImportEntries {
        ...
        > {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_datacatalog_v1::client::DataCatalog::import_entries::until_done";
            }
...
/// Request and client builders for [PolicyTagManager][crate::client::PolicyTagManager].
...
/// Request and client builders for [PolicyTagManagerSerialization][crate::client::PolicyTagManagerSerialization].
