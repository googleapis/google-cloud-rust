...
/// Implements a [ApiGatewayService](super::stubs::ApiGatewayService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ApiGatewayService<T>
where
    T: super::stubs::ApiGatewayService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ApiGatewayService for ApiGatewayService<T>
where
    T: super::stubs::ApiGatewayService + std::fmt::Debug + Send + Sync,
{
