...
/// Implements a [ApiGatewayService](crate::stubs::ApiGatewayService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ApiGatewayService<T>
where
    T: crate::stubs::ApiGatewayService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ApiGatewayService for ApiGatewayService<T>
where
    T: crate::stubs::ApiGatewayService + std::fmt::Debug + Send + Sync,
{
