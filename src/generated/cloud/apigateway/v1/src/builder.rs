...
/// Request and client builders for [ApiGatewayService][crate::client::ApiGatewayService].
pub mod api_gateway_service {
    ...
    impl CreateGateway {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Gateway, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_apigateway_v1::client::ApiGatewayService::create_gateway::until_done";
            }
    ...
    impl UpdateGateway {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Gateway, crate::model::OperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_apigateway_v1::client::ApiGatewayService::update_gateway::until_done";
            }
    ...
    impl DeleteGateway {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_apigateway_v1::client::ApiGatewayService::delete_gateway::until_done";
            }
    ...
    impl CreateApi {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Api, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_apigateway_v1::client::ApiGatewayService::create_api::until_done";
            }
    ...
    impl UpdateApi {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Api, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_apigateway_v1::client::ApiGatewayService::update_api::until_done";
            }
    ...
    impl DeleteApi {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_apigateway_v1::client::ApiGatewayService::delete_api::until_done";
            }
    ...
    impl ListApiConfigs {
        ...
        pub fn by_page(
            ...
            crate::model::ListApiConfigsResponse,
            crate::Error,
        > {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListApiConfigs {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetApiConfig {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateApiConfig {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::ApiConfig, crate::model::OperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_apigateway_v1::client::ApiGatewayService::create_api_config::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateApiConfig {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UpdateApiConfig {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::ApiConfig, crate::model::OperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_apigateway_v1::client::ApiGatewayService::update_api_config::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateApiConfig {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteApiConfig {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_apigateway_v1::client::ApiGatewayService::delete_api_config::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteApiConfig {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
