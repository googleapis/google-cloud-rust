...
impl super::stub::ApiGatewayService for ApiGatewayService {
    async fn list_gateways(
        ...
        let response: crate::model::ListGatewaysResponse = self
            .inner
    ...
    async fn get_gateway(
        ...
        let response: crate::model::Gateway = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn list_api_configs(
        ...
        let builder = builder.query(&[("filter", &req.filter)]);
        let builder = builder.query(&[("orderBy", &req.order_by)]);
        let response: crate::model::ListApiConfigsResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn get_api_config(
        ...
        let response: crate::model::ApiConfig = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
