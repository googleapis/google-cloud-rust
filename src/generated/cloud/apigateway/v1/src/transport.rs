    ...
    async fn list_gateways(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//apigateway.googleapis.com/v1/{}/gateways", var_parent,);
    ...
    async fn get_gateway(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//apigateway.googleapis.com/v1/{}", var_name,);
    ...
    async fn list_apis(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//apigateway.googleapis.com/v1/{}/apis", var_parent,);
    ...
    async fn list_api_configs(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//apigateway.googleapis.com/v1/{}/configs", var_parent,);
