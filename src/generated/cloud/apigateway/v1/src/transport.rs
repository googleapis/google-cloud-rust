...
/// Implements [ApiGatewayService](crate::stubs::ApiGatewayService) using a [gax::http_client::ReqwestClient].
#[derive(Clone)]
...
impl crate::stubs::ApiGatewayService for ApiGatewayService {
