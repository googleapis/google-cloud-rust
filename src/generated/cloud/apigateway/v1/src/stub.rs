...
pub trait ApiGatewayService: std::fmt::Debug + Send + Sync {
    ...
    fn list_api_configs(
        ...
        Output = crate::Result<crate::Response<crate::model::ListApiConfigsResponse>>,
    > + Send {
        gaxi::unimplemented::unimplemented_stub()
    }
    ...
    fn get_api_config(
        ...
        _options: crate::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::Response<crate::model::ApiConfig>>> + Send
    {
        gaxi::unimplemented::unimplemented_stub()
    }
