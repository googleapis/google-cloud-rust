    ...
    async fn execute_patch_job(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//osconfig.googleapis.com/v1/{}/patchJobs", var_parent,);
    ...
    async fn get_patch_job(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//osconfig.googleapis.com/v1/{}", var_name,);
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//osconfig.googleapis.com/v1/{}/instanceDetails",
                    var_parent,
                );
    ...
    async fn create_patch_deployment(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//osconfig.googleapis.com/v1/{}/patchDeployments",
                    var_parent,
                );
    ...
    async fn create_os_policy_assignment(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//osconfig.googleapis.com/v1/{}/osPolicyAssignments",
                    var_parent,
                );
    ...
    async fn list_os_policy_assignment_reports(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//osconfig.googleapis.com/v1/{}/reports", var_parent,);
    ...
    async fn list_inventories(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//osconfig.googleapis.com/v1/{}/inventories", var_parent,);
    ...
    async fn list_vulnerability_reports(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//osconfig.googleapis.com/v1/{}/vulnerabilityReports",
                    var_parent,
                );
