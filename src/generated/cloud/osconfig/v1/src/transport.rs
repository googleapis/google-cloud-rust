...
/// Implements [OsConfigService](super::stubs::OsConfigService) using a [gaxi::ReqwestClient].
#[derive(Clone)]
...
/// Implements [OsConfigZonalService](super::stubs::OsConfigZonalService) using a [gaxi::ReqwestClient].
#[derive(Clone)]
