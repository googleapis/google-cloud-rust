...
/// Implements a [OsConfigService](super::stubs::OsConfigService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct OsConfigService<T>
where
    T: super::stubs::OsConfigService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::OsConfigService for OsConfigService<T>
where
    T: super::stubs::OsConfigService + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [OsConfigZonalService](super::stubs::OsConfigZonalService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct OsConfigZonalService<T>
where
    T: super::stubs::OsConfigZonalService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::OsConfigZonalService for OsConfigZonalService<T>
where
    T: super::stubs::OsConfigZonalService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
