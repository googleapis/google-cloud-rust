...
/// Implements a [BackupForGKE](crate::stubs::BackupForGKE) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct BackupForGKE<T>
where
    T: crate::stubs::BackupForGKE + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::BackupForGKE for BackupForGKE<T>
where
    T: crate::stubs::BackupForGKE + std::fmt::Debug + Send + Sync,
{
