    ...
    async fn create_backup_plan(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//gkebackup.googleapis.com/v1/{}/backupPlans", var_parent,);
    ...
    async fn get_backup_plan(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//gkebackup.googleapis.com/v1/{}", var_name,);
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//gkebackup.googleapis.com/v1/{}/backupChannels",
                    var_parent,
                );
    ...
    async fn list_backup_plan_bindings(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//gkebackup.googleapis.com/v1/{}/backupPlanBindings",
                    var_parent,
                );
    ...
    async fn create_backup(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//gkebackup.googleapis.com/v1/{}/backups", var_parent,);
    ...
    async fn list_volume_backups(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//gkebackup.googleapis.com/v1/{}/volumeBackups", var_parent,);
    ...
    async fn create_restore_plan(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//gkebackup.googleapis.com/v1/{}/restorePlans", var_parent,);
    ...
    async fn create_restore_channel(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//gkebackup.googleapis.com/v1/{}/restoreChannels",
                    var_parent,
                );
    ...
    async fn list_restore_plan_bindings(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//gkebackup.googleapis.com/v1/{}/restorePlanBindings",
                    var_parent,
                );
    ...
    async fn create_restore(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//gkebackup.googleapis.com/v1/{}/restores", var_parent,);
    ...
    async fn list_volume_restores(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//gkebackup.googleapis.com/v1/{}/volumeRestores",
                    var_parent,
                );
    ...
    async fn get_backup_index_download_url(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//gkebackup.googleapis.com/v1/{}", var_backup,);
    ...
    async fn set_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//gkebackup.googleapis.com/v1/{}", var_resource,);
