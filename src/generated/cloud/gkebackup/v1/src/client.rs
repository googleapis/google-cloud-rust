...
/// [with_credentials()]: super::builder::backup_for_gke::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `BackupForGKE` in
...
impl BackupForGKE {
    ...
    pub fn builder() -> super::builder::backup_for_gke::ClientBuilder {
        crate::new_client_builder(super::builder::backup_for_gke::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::BackupForGKE>> {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::BackupForGKE> {
    ...
    ///    client: &BackupForGKE, parent: &str
    /// ) -> Result<()> {
    ///     let response = client.create_backup_channel()
    ///         .set_parent(parent)
    ///         .set_backup_channel(
    ///             BackupChannel::new()/* set fields */
    ///         )
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &BackupForGKE, parent: &str
    /// ) -> Result<()> {
    ///     let mut list = client.list_backup_channels()
    ///         .set_parent(parent)
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &BackupForGKE, parent: &str
    /// ) -> Result<()> {
    ///     let response = client.create_restore_plan()
    ///         .set_parent(parent)
    ///         .set_restore_plan(
    ///             RestorePlan::new()/* set fields */
    ///         )
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &BackupForGKE, parent: &str
    /// ) -> Result<()> {
    ///     let mut list = client.list_restore_plans()
    ///         .set_parent(parent)
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &BackupForGKE, parent: &str
    /// ) -> Result<()> {
    ///     let response = client.create_restore_channel()
    ///         .set_parent(parent)
    ///         .set_restore_channel(
    ///             RestoreChannel::new()/* set fields */
    ///         )
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &BackupForGKE, parent: &str
    /// ) -> Result<()> {
    ///     let mut list = client.list_restore_channels()
    ///         .set_parent(parent)
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &BackupForGKE
    /// ) -> Result<()> {
    ///     let response = client.get_backup_index_download_url()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
