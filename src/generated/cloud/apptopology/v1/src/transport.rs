...
/// Implements [AppTopology](super::stub::AppTopology) using a [gaxi::http::ReqwestClient].
#[derive(Clone)]
pub struct AppTopology {
    inner: gaxi::http::ReqwestClient,
}

impl std::fmt::Debug for AppTopology {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::result::Result<(), std::fmt::Error> {
        f.debug_struct("AppTopology")
...
impl super::stub::AppTopology for AppTopology {
            ...
            .or_else(|| {
                let var_name = try_match(
                    ...
                    &[
                        ...
                        Segment::SingleWildcard,
                        Segment::Literal("/discoveredResourcesTopology"),
                    ],
                )?;
                let path = format!("/v1/{}:generate", var_name,);
                let path_template = "/v1/{name}:generate";

                let resource_name = format!("//apptopology.googleapis.com/{}", var_name,);
            ...
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    ...
                    let builder = builder.maybe_add(
                        ...
                        "name",
                        "projects/*/locations/*/discoveredResourcesTopology",
                    );
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.apptopology.v1.AppTopology/GenerateDiscoveredResourcesTopology")
    ...
    async fn get_schema(
            ...
            .or_else(|| {
                let var_name = try_match(
                    ...
                    &[
                        ...
                        Segment::Literal("/locations/"),
                        Segment::SingleWildcard,
                        Segment::Literal("/domains/"),
                        Segment::SingleWildcard,
                        Segment::Literal("/schema"),
                    ],
                )?;
            ...
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    ...
                    let builder = builder.maybe_add(
                        ...
                        "name",
                        "projects/*/locations/*/domains/*/schema",
                    );
                    paths.push(builder.build());
                }
                google_cloud_gax::error::Error::binding(BindingError { paths })
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.apptopology.v1.AppTopology/GetSchema")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn get_domain(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.apptopology.v1.AppTopology/GetDomain")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn list_domains(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//apptopology.googleapis.com/{}", var_parent,);
                let builder = self.inner.builder(Method::GET, path);
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.apptopology.v1.AppTopology/ListDomains")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
