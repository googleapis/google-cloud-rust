...
impl RemoveAclEntryResponse {
    ...
    /// use google_cloud_managedkafka_v1::model::remove_acl_entry_response;
    /// let x = RemoveAclEntryResponse::new().set_result(Some(remove_acl_entry_response::Result::AclDeleted(true)));
    /// ```
    pub fn set_result<
...
impl Cluster {
    ...
    /// let x = Cluster::new().set_platform_config(Some(cluster::PlatformConfig::GcpConfig(GcpConfig::default().into())));
    /// ```
...
impl ConnectCluster {
    ...
    /// ```
    /// # use google_cloud_managedkafka_v1::model::ConnectCluster;
    /// use google_cloud_managedkafka_v1::model::connect_cluster;
    /// use google_cloud_managedkafka_v1::model::ConnectGcpConfig;
    /// let x = ConnectCluster::new().set_platform_config(Some(connect_cluster::PlatformConfig::GcpConfig(ConnectGcpConfig::default().into())));
    /// ```
    pub fn set_platform_config<
...
impl Connector {
    ...
    /// let x = Connector::new().set_restart_policy(Some(connector::RestartPolicy::TaskRestartPolicy(TaskRetryPolicy::default().into())));
    /// ```
