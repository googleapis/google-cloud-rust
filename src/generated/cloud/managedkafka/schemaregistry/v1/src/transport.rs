...
impl super::stub::ManagedSchemaRegistry for ManagedSchemaRegistry {
    ...
    async fn list_schema_registries(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/schemaRegistries";
    ...
    async fn list_contexts(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/contexts";
    ...
    async fn get_raw_schema(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}/schema";
    ...
    async fn list_schema_types(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/schemas/types";
    ...
    async fn list_subjects(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/subjects";
    ...
    async fn list_referenced_schemas(
        ...
        .or_else(|| {
            ...
            let _path_template = "/v1/{parent}/referencedby";
