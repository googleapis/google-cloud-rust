        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkservices.googleapis.com/v1/{}/lbTrafficExtensions",
                    var_parent,
                );
    ...
    async fn get_lb_traffic_extension(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//networkservices.googleapis.com/v1/{}", var_name,);
    ...
    async fn list_lb_route_extensions(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkservices.googleapis.com/v1/{}/lbRouteExtensions",
                    var_parent,
                );
    ...
    async fn list_lb_edge_extensions(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkservices.googleapis.com/v1/{}/lbEdgeExtensions",
                    var_parent,
                );
    ...
    async fn list_authz_extensions(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkservices.googleapis.com/v1/{}/authzExtensions",
                    var_parent,
                );
    ...
    async fn set_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//networkservices.googleapis.com/v1/{}", var_resource,);
    ...
    async fn list_endpoint_policies(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkservices.googleapis.com/v1/{}/endpointPolicies",
                    var_parent,
                );
    ...
    async fn list_wasm_plugin_versions(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkservices.googleapis.com/v1/{}/versions",
                    var_parent,
                );
    ...
    async fn list_wasm_plugins(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkservices.googleapis.com/v1/{}/wasmPlugins",
                    var_parent,
                );
    ...
    async fn list_gateways(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkservices.googleapis.com/v1/{}/gateways",
                    var_parent,
                );
    ...
    async fn list_grpc_routes(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkservices.googleapis.com/v1/{}/grpcRoutes",
                    var_parent,
                );
    ...
    async fn list_http_routes(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkservices.googleapis.com/v1/{}/httpRoutes",
                    var_parent,
                );
    ...
    async fn list_tcp_routes(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkservices.googleapis.com/v1/{}/tcpRoutes",
                    var_parent,
                );
    ...
    async fn list_tls_routes(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkservices.googleapis.com/v1/{}/tlsRoutes",
                    var_parent,
                );
    ...
    async fn list_service_bindings(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkservices.googleapis.com/v1/{}/serviceBindings",
                    var_parent,
                );
    ...
    async fn list_meshes(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//networkservices.googleapis.com/v1/{}/meshes", var_parent,);
    ...
    async fn list_service_lb_policies(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkservices.googleapis.com/v1/{}/serviceLbPolicies",
                    var_parent,
                );
    ...
    async fn list_gateway_route_views(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkservices.googleapis.com/v1/{}/routeViews",
                    var_parent,
                );
