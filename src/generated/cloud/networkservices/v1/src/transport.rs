...
/// Implements [DepService](super::stubs::DepService) using a [gaxi::ReqwestClient].
#[derive(Clone)]
...
/// Implements [NetworkServices](super::stubs::NetworkServices) using a [gaxi::ReqwestClient].
#[derive(Clone)]
