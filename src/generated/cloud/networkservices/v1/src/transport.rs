...
/// Implements [DepService](crate::stubs::DepService) using a [gclient::ReqwestClient].
#[derive(Clone)]
...
/// Implements [NetworkServices](crate::stubs::NetworkServices) using a [gclient::ReqwestClient].
#[derive(Clone)]
