...
/// Implements a [Workflows](super::stubs::Workflows) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Workflows<T>
where
    T: super::stubs::Workflows + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Workflows for Workflows<T>
where
    T: super::stubs::Workflows + std::fmt::Debug + Send + Sync,
{
