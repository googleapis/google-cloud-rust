...
/// Request and client builders for [Workflows][crate::client::Workflows].
pub mod workflows {
    use crate::Result;
    ...
    impl ListWorkflows {
        ...
        pub fn by_page(
            self,
        ) -> impl google_cloud_gax::paginator::Paginator<crate::model::ListWorkflowsResponse, crate::Error>
        {
            use std::clone::Clone;
        ...
        pub fn by_item(
            ...
            crate::model::ListWorkflowsResponse,
            crate::Error,
        > {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListWorkflows {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetWorkflow {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateWorkflow {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Workflow, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_workflows_v1::client::Workflows::create_workflow::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateWorkflow {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteWorkflow {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_workflows_v1::client::Workflows::delete_workflow::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteWorkflow {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UpdateWorkflow {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Workflow, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_workflows_v1::client::Workflows::update_workflow::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateWorkflow {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListWorkflowRevisions {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
