...
pub trait Workflows: std::fmt::Debug + Send + Sync {
    ...
    ) -> crate::Result<crate::Response<crate::model::ListWorkflowsResponse>>;

    async fn get_workflow(
        &self,
        req: crate::model::GetWorkflowRequest,
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::Workflow>>;
    ...
    async fn list_workflow_revisions(
        ...
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::ListWorkflowRevisionsResponse>>;
