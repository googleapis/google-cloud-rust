...
/// [with_credentials()]: super::builder::publisher::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `Publisher` in
...
impl Publisher {
    ...
    pub fn builder() -> super::builder::publisher::ClientBuilder {
        crate::new_client_builder(super::builder::publisher::client::Factory)
    }
