    ...
    async fn list_triggers(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/triggers";
    ...
    async fn update_trigger(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{trigger.name}";

                let resource_name = format!("//eventarc.googleapis.com/{}", var_trigger_name,);
    ...
    async fn list_channels(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/channels";
    ...
    async fn update_channel(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{channel.name}";

                let resource_name = format!("//eventarc.googleapis.com/{}", var_channel_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn list_providers(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/providers";
    ...
    async fn list_channel_connections(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/channelConnections";
    ...
    async fn update_google_channel_config(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{google_channel_config.name}";

                let resource_name = format!(
                    "//eventarc.googleapis.com/{}",
                    var_google_channel_config_name,
                );
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
    ...
    async fn list_message_buses(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/messageBuses";
    ...
    async fn list_message_bus_enrollments(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}:listEnrollments";
    ...
    async fn update_message_bus(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{message_bus.name}";

                let resource_name = format!("//eventarc.googleapis.com/{}", var_message_bus_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn list_enrollments(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/enrollments";
    ...
    async fn update_enrollment(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{enrollment.name}";

                let resource_name = format!("//eventarc.googleapis.com/{}", var_enrollment_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn list_pipelines(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/pipelines";
    ...
    async fn update_pipeline(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{pipeline.name}";

                let resource_name = format!("//eventarc.googleapis.com/{}", var_pipeline_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn list_google_api_sources(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/googleApiSources";
    ...
    async fn update_google_api_source(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{google_api_source.name}";

                let resource_name =
                    format!("//eventarc.googleapis.com/{}", var_google_api_source_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
