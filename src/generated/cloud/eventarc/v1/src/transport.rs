    ...
    async fn get_trigger(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//eventarc.googleapis.com/v1/{}", var_name,);
    ...
    async fn list_triggers(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//eventarc.googleapis.com/v1/{}/triggers", var_parent,);
    ...
    async fn list_channels(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//eventarc.googleapis.com/v1/{}/channels", var_parent,);
    ...
    async fn list_providers(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//eventarc.googleapis.com/v1/{}/providers", var_parent,);
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//eventarc.googleapis.com/v1/{}/channelConnections",
                    var_parent,
                );
    ...
    async fn list_message_buses(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//eventarc.googleapis.com/v1/{}/messageBuses", var_parent,);
    ...
    async fn list_message_bus_enrollments(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//eventarc.googleapis.com/v1/{}", var_parent,);
    ...
    async fn list_enrollments(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//eventarc.googleapis.com/v1/{}/enrollments", var_parent,);
    ...
    async fn list_pipelines(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//eventarc.googleapis.com/v1/{}/pipelines", var_parent,);
    ...
    async fn list_google_api_sources(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//eventarc.googleapis.com/v1/{}/googleApiSources",
                    var_parent,
                );
    ...
    async fn set_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//eventarc.googleapis.com/v1/{}", var_resource,);
