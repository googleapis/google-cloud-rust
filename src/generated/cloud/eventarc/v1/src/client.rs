...
/// [with_credentials()]: super::builder::eventarc::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `Eventarc` in
...
impl Eventarc {
    ...
    pub fn builder() -> super::builder::eventarc::ClientBuilder {
        crate::new_client_builder(super::builder::eventarc::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::Eventarc>> {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::Eventarc> {
