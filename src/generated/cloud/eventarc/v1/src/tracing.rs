...
/// Implements a [Eventarc](crate::stubs::Eventarc) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Eventarc<T>
where
    T: crate::stubs::Eventarc + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::Eventarc for Eventarc<T>
where
    T: crate::stubs::Eventarc + std::fmt::Debug + Send + Sync,
{
