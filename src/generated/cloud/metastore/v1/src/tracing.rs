...
/// Implements a [DataprocMetastore](super::stubs::DataprocMetastore) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DataprocMetastore<T>
where
    T: super::stubs::DataprocMetastore + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::DataprocMetastore for DataprocMetastore<T>
where
    T: super::stubs::DataprocMetastore + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [DataprocMetastoreFederation](super::stubs::DataprocMetastoreFederation) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DataprocMetastoreFederation<T>
where
    T: super::stubs::DataprocMetastoreFederation + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::DataprocMetastoreFederation for DataprocMetastoreFederation<T>
where
    T: super::stubs::DataprocMetastoreFederation + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
