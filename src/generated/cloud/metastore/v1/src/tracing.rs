...
/// Implements a [DataprocMetastore](crate::stubs::DataprocMetastore) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DataprocMetastore<T>
where
    T: crate::stubs::DataprocMetastore + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::DataprocMetastore for DataprocMetastore<T>
where
    T: crate::stubs::DataprocMetastore + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [DataprocMetastoreFederation](crate::stubs::DataprocMetastoreFederation) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DataprocMetastoreFederation<T>
where
    T: crate::stubs::DataprocMetastoreFederation + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::DataprocMetastoreFederation for DataprocMetastoreFederation<T>
where
    T: crate::stubs::DataprocMetastoreFederation + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
