...
/// Implements [DataprocMetastore](super::stubs::DataprocMetastore) using a [gaxi::ReqwestClient].
#[derive(Clone)]
...
/// Implements [DataprocMetastoreFederation](super::stubs::DataprocMetastoreFederation) using a [gaxi::ReqwestClient].
#[derive(Clone)]
