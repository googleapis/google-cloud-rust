    ...
    async fn update_service(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{service.name}";

                let resource_name = format!("//metastore.googleapis.com/{}", var_service_name,);
    ...
    async fn list_metadata_imports(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/metadataImports";
    ...
    async fn update_metadata_import(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{metadata_import.name}";

                let resource_name =
                    format!("//metastore.googleapis.com/{}", var_metadata_import_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn export_metadata(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{service}:exportMetadata";
    ...
    async fn restore_service(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{service}:restore";
    ...
    async fn query_metadata(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{service}:queryMetadata";
    ...
    async fn move_table_to_database(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{service}:moveTableToDatabase";
    ...
    async fn alter_metadata_resource_location(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{service}:alterLocation";
    ...
    async fn list_federations(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/federations";
    ...
    async fn update_federation(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{federation.name}";

                let resource_name = format!("//metastore.googleapis.com/{}", var_federation_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
