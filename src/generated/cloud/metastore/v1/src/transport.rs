    ...
    async fn list_services(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//metastore.googleapis.com/v1/{}/services", var_parent,);
    ...
    async fn get_service(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//metastore.googleapis.com/v1/{}", var_name,);
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//metastore.googleapis.com/v1/{}/metadataImports",
                    var_parent,
                );
    ...
    async fn export_metadata(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//metastore.googleapis.com/v1/{}", var_service,);
    ...
    async fn list_backups(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//metastore.googleapis.com/v1/{}/backups", var_parent,);
    ...
    async fn set_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//metastore.googleapis.com/v1/{}", var_resource,);
    ...
    async fn list_federations(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//metastore.googleapis.com/v1/{}/federations", var_parent,);
