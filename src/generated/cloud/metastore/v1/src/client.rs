...
/// [with_credentials()]: super::builder::dataproc_metastore::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `DataprocMetastore` in
...
impl DataprocMetastore {
    ...
    /// ) -> Result<()> {
    ///     let response = client.export_metadata()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &DataprocMetastore
    /// ) -> Result<()> {
    ///     let response = client.restore_service()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &DataprocMetastore
    /// ) -> Result<()> {
    ///     let response = client.query_metadata()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &DataprocMetastore
    /// ) -> Result<()> {
    ///     let response = client.move_table_to_database()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &DataprocMetastore
    /// ) -> Result<()> {
    ///     let response = client.alter_metadata_resource_location()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
...
/// [with_credentials()]: super::builder::dataproc_metastore_federation::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `DataprocMetastoreFederation` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
#[derive(Clone, Debug)]
