...
/// Implements a [StorageInsights](super::stubs::StorageInsights) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct StorageInsights<T>
where
    T: super::stubs::StorageInsights + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::StorageInsights for StorageInsights<T>
where
    T: super::stubs::StorageInsights + std::fmt::Debug + Send + Sync,
{
