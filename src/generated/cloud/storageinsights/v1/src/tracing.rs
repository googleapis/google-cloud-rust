...
/// Implements a [StorageInsights](crate::stubs::StorageInsights) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct StorageInsights<T>
where
    T: crate::stubs::StorageInsights + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::StorageInsights for StorageInsights<T>
where
    T: crate::stubs::StorageInsights + std::fmt::Debug + Send + Sync,
{
