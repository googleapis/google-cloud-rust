    ...
    async fn update_report_config(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{report_config.name}";

                let resource_name = format!(
                    "//storageinsights.googleapis.com/{}",
                    var_report_config_name,
                );
    ...
    async fn list_report_details(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/reportDetails";
    ...
    async fn list_dataset_configs(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/datasetConfigs";
    ...
    async fn update_dataset_config(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{dataset_config.name}";

                let resource_name = format!(
                    "//storageinsights.googleapis.com/{}",
                    var_dataset_config_name,
                );
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
    ...
    async fn link_dataset(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:linkDataset";
    ...
    async fn unlink_dataset(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:unlinkDataset";
