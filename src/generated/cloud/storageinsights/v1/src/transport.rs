        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//storageinsights.googleapis.com/v1/{}/reportConfigs",
                    var_parent,
                );
    ...
    async fn get_report_config(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//storageinsights.googleapis.com/v1/{}", var_name,);
    ...
    async fn list_report_details(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//storageinsights.googleapis.com/v1/{}/reportDetails",
                    var_parent,
                );
    ...
    async fn list_dataset_configs(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//storageinsights.googleapis.com/v1/{}/datasetConfigs",
                    var_parent,
                );
