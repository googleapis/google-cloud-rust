...
pub mod dataset_config {
    ...
    pub mod cloud_storage_buckets {
        ...
        impl CloudStorageBucket {
            ...
            /// ```
            /// # use google_cloud_storageinsights_v1::model::dataset_config::cloud_storage_buckets::CloudStorageBucket;
            /// use google_cloud_storageinsights_v1::model::dataset_config::cloud_storage_buckets::cloud_storage_bucket::CloudStorageBucket;
            /// let x = CloudStorageBucket::new().set_cloud_storage_bucket(Some(CloudStorageBucket::BucketName("example".to_string())));
            /// ```
