...
/// Request and client builders for [StorageInsights][crate::client::StorageInsights].
pub mod storage_insights {
    ...
    impl ListReportConfigs {
        ...
        pub fn by_page(
            ...
            crate::model::ListReportConfigsResponse,
            crate::Error,
        > {
            use std::clone::Clone;
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListReportConfigs {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetReportConfig {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateReportConfig {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateReportConfig {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteReportConfig {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ListReportDetails {
        ...
        pub fn by_page(
            ...
            crate::model::ListReportDetailsResponse,
            crate::Error,
        > {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListReportDetails {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetReportDetail {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListDatasetConfigs {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetDatasetConfig {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateDatasetConfig {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::DatasetConfig, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_storageinsights_v1::client::StorageInsights::create_dataset_config::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateDatasetConfig {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UpdateDatasetConfig {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::DatasetConfig, crate::model::OperationMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_storageinsights_v1::client::StorageInsights::update_dataset_config::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateDatasetConfig {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteDatasetConfig {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_storageinsights_v1::client::StorageInsights::delete_dataset_config::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteDatasetConfig {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl LinkDataset {
        ...
        > {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_storageinsights_v1::client::StorageInsights::link_dataset::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for LinkDataset {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UnlinkDataset {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_storageinsights_v1::client::StorageInsights::unlink_dataset::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UnlinkDataset {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
