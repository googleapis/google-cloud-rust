...
pub trait DirectAccessService: std::fmt::Debug + Send + Sync {
    ...
    /// Implements [super::client::DirectAccessService::list_device_sessions].
    ...
    /// Implements [super::client::DirectAccessService::get_device_session].
    ...
    /// Implements [super::client::DirectAccessService::cancel_device_session].
    ...
    /// Implements [super::client::DirectAccessService::update_device_session].
    ...
    /// Implements [super::client::DirectAccessService::adb_connect].
    fn adb_connect(
        &self,
        _options: crate::RequestOptions,
    ) -> (
