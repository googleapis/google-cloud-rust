        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//configdelivery.googleapis.com/v1/{}/resourceBundles",
                    var_parent,
                );
    ...
    async fn get_resource_bundle(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//configdelivery.googleapis.com/v1/{}", var_name,);
    ...
    async fn list_fleet_packages(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//configdelivery.googleapis.com/v1/{}/fleetPackages",
                    var_parent,
                );
    ...
    async fn list_releases(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//configdelivery.googleapis.com/v1/{}/releases", var_parent,);
    ...
    async fn list_variants(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//configdelivery.googleapis.com/v1/{}/variants", var_parent,);
    ...
    async fn list_rollouts(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//configdelivery.googleapis.com/v1/{}/rollouts", var_parent,);
