...
/// [with_credentials()]: super::builder::config_delivery::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `ConfigDelivery` in
...
impl ConfigDelivery {
    ...
    pub fn builder() -> super::builder::config_delivery::ClientBuilder {
        crate::new_client_builder(super::builder::config_delivery::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::ConfigDelivery>> {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::ConfigDelivery> {
    ...
    /// ) -> Result<()> {
    ///     let response = client.suspend_rollout()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ConfigDelivery
    /// ) -> Result<()> {
    ///     let response = client.abort_rollout()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
