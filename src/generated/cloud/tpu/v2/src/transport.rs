    ...
    async fn list_nodes(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/nodes";
    ...
    async fn update_node(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{node.name}";

                let resource_name = format!("//tpu.googleapis.com/{}", var_node_name,);
    ...
    async fn list_queued_resources(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/queuedResources";
    ...
    async fn generate_service_identity(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}:generateServiceIdentity";
    ...
    async fn list_accelerator_types(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/acceleratorTypes";
    ...
    async fn list_runtime_versions(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/runtimeVersions";
    ...
    async fn get_guest_attributes(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{name}:getGuestAttributes";
