    ...
    async fn list_nodes(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//tpu.googleapis.com/v2/{}/nodes", var_parent,);
    ...
    async fn get_node(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//tpu.googleapis.com/v2/{}", var_name,);
    ...
    async fn list_queued_resources(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//tpu.googleapis.com/v2/{}/queuedResources", var_parent,);
    ...
    async fn generate_service_identity(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//tpu.googleapis.com/v2/{}", var_parent,);
    ...
    async fn list_accelerator_types(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//tpu.googleapis.com/v2/{}/acceleratorTypes", var_parent,);
    ...
    async fn list_runtime_versions(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//tpu.googleapis.com/v2/{}/runtimeVersions", var_parent,);
