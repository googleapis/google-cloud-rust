...
impl QueuedResource {
    ...
    /// ```
    /// # use google_cloud_tpu_v2::model::QueuedResource;
    /// use google_cloud_tpu_v2::model::queued_resource;
    /// use google_cloud_tpu_v2::model::queued_resource::Tpu;
    /// let x = QueuedResource::new().set_resource(Some(queued_resource::Resource::Tpu(Tpu::default().into())));
    /// ```
    pub fn set_resource<
    ...
    /// let x = QueuedResource::new().set_tier(Some(queued_resource::Tier::Spot(Spot::default().into())));
    /// ```
    pub fn set_tier<
...
pub mod queued_resource {
    ...
    pub mod tpu {
        ...
        impl NodeSpec {
            ...
            /// ```
            /// # use google_cloud_tpu_v2::model::queued_resource::tpu::NodeSpec;
            /// use google_cloud_tpu_v2::model::queued_resource::tpu::node_spec;
            /// let x = NodeSpec::new().set_name_strategy(Some(queued_resource::tpu::node_spec::NameStrategy::NodeId("example".to_string())));
            /// ```
    ...
    impl QueueingPolicy {
        ...
        /// ```
        /// # use google_cloud_tpu_v2::model::queued_resource::QueueingPolicy;
        /// use google_cloud_tpu_v2::model::queued_resource::queueing_policy;
        /// use wkt::Duration;
        /// let x = QueueingPolicy::new().set_start_timing_constraints(Some(queued_resource::queueing_policy::StartTimingConstraints::ValidUntilDuration(Duration::default().into())));
        /// ```
...
impl QueuedResourceState {
    ...
    /// ```
    /// # use google_cloud_tpu_v2::model::QueuedResourceState;
    /// use google_cloud_tpu_v2::model::queued_resource_state;
    /// use google_cloud_tpu_v2::model::queued_resource_state::CreatingData;
    /// let x = QueuedResourceState::new().set_state_data(Some(queued_resource_state::StateData::CreatingData(CreatingData::default().into())));
    /// ```
