...
/// Request and client builders for [Tpu][crate::client::Tpu].
pub mod tpu {
    use crate::Result;
    ...
    impl CreateNode {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Node, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_tpu_v2::client::Tpu::create_node::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateNode {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteNode {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_tpu_v2::client::Tpu::delete_node::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteNode {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl StopNode {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Node, crate::model::OperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_tpu_v2::client::Tpu::stop_node::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for StopNode {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl StartNode {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Node, crate::model::OperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_tpu_v2::client::Tpu::start_node::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for StartNode {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UpdateNode {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Node, crate::model::OperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_tpu_v2::client::Tpu::update_node::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateNode {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListQueuedResources {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetQueuedResource {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateQueuedResource {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::QueuedResource, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_tpu_v2::client::Tpu::create_queued_resource::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateQueuedResource {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteQueuedResource {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_tpu_v2::client::Tpu::delete_queued_resource::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteQueuedResource {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ResetQueuedResource {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::QueuedResource, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_tpu_v2::client::Tpu::reset_queued_resource::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ResetQueuedResource {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GenerateServiceIdentity {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListAcceleratorTypes {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetAcceleratorType {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListRuntimeVersions {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetRuntimeVersion {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetGuestAttributes {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
