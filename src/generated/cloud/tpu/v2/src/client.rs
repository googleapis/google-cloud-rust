...
/// [with_credentials()]: super::builder::tpu::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `Tpu` in
...
impl Tpu {
    ...
    pub fn builder() -> super::builder::tpu::ClientBuilder {
        crate::new_client_builder(super::builder::tpu::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::Tpu>> {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::Tpu> {
