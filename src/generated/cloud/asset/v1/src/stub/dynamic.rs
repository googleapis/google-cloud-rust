...
pub trait AssetService: std::fmt::Debug + Send + Sync {
    ...
    async fn batch_get_assets_history(
        ...
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::BatchGetAssetsHistoryResponse>>;
    ...
    async fn search_all_resources(
        ...
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::SearchAllResourcesResponse>>;

    async fn search_all_iam_policies(
        &self,
        req: crate::model::SearchAllIamPoliciesRequest,
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::SearchAllIamPoliciesResponse>>;

    async fn analyze_iam_policy(
        &self,
        req: crate::model::AnalyzeIamPolicyRequest,
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::AnalyzeIamPolicyResponse>>;
    ...
    async fn analyze_move(
        ...
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::AnalyzeMoveResponse>>;

    async fn query_assets(
        &self,
        req: crate::model::QueryAssetsRequest,
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::QueryAssetsResponse>>;

    async fn create_saved_query(
        &self,
        req: crate::model::CreateSavedQueryRequest,
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::SavedQuery>>;
    ...
    async fn batch_get_effective_iam_policies(
        ...
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::BatchGetEffectiveIamPoliciesResponse>>;

    async fn analyze_org_policies(
        &self,
        req: crate::model::AnalyzeOrgPoliciesRequest,
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::AnalyzeOrgPoliciesResponse>>;

    async fn analyze_org_policy_governed_containers(
        &self,
        req: crate::model::AnalyzeOrgPolicyGovernedContainersRequest,
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::AnalyzeOrgPolicyGovernedContainersResponse>>;

    async fn analyze_org_policy_governed_assets(
        &self,
        req: crate::model::AnalyzeOrgPolicyGovernedAssetsRequest,
        options: crate::RequestOptions,
    ) -> crate::Result<crate::Response<crate::model::AnalyzeOrgPolicyGovernedAssetsResponse>>;
