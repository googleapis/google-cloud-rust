...
/// Implements a [AssetService](crate::stubs::AssetService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AssetService<T>
where
    T: crate::stubs::AssetService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::AssetService for AssetService<T>
where
    T: crate::stubs::AssetService + std::fmt::Debug + Send + Sync,
{
