...
/// [with_credentials()]: super::builder::asset_service::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `AssetService` in
...
impl AssetService {
    ...
    ///    client: &AssetService
    /// ) -> Result<()> {
    ///     let response = client.export_assets()
    ///         /* set fields */
    ...
    ///    client: &AssetService
    /// ) -> Result<()> {
    ///     let response = client.batch_get_assets_history()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &AssetService
    /// ) -> Result<()> {
    ///     let response = client.list_feeds()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &AssetService
    /// ) -> Result<()> {
    ///     let mut list = client.search_all_resources()
    ///         /* set fields */
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &AssetService
    /// ) -> Result<()> {
    ///     let mut list = client.search_all_iam_policies()
    ///         /* set fields */
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &AssetService
    /// ) -> Result<()> {
    ///     let response = client.analyze_iam_policy()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &AssetService
    /// ) -> Result<()> {
    ///     let response = client.analyze_iam_policy_longrunning()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &AssetService
    /// ) -> Result<()> {
    ///     let response = client.analyze_move()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &AssetService
    /// ) -> Result<()> {
    ///     let response = client.query_assets()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &AssetService
    /// ) -> Result<()> {
    ///     let response = client.batch_get_effective_iam_policies()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &AssetService
    /// ) -> Result<()> {
    ///     let mut list = client.analyze_org_policies()
    ///         /* set fields */
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &AssetService
    /// ) -> Result<()> {
    ///     let mut list = client.analyze_org_policy_governed_containers()
    ///         /* set fields */
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &AssetService
    /// ) -> Result<()> {
    ///     let mut list = client.analyze_org_policy_governed_assets()
    ///         /* set fields */
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
