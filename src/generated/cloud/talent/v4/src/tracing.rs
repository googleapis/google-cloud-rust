...
/// Implements a [CompanyService](super::stubs::CompanyService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CompanyService<T>
where
    T: super::stubs::CompanyService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::CompanyService for CompanyService<T>
where
    T: super::stubs::CompanyService + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [Completion](super::stubs::Completion) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Completion<T>
where
    T: super::stubs::Completion + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Completion for Completion<T>
where
    T: super::stubs::Completion + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [EventService](super::stubs::EventService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct EventService<T>
where
    T: super::stubs::EventService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::EventService for EventService<T>
where
    T: super::stubs::EventService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [TenantService](super::stubs::TenantService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct TenantService<T>
where
    T: super::stubs::TenantService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::TenantService for TenantService<T>
where
    T: super::stubs::TenantService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
