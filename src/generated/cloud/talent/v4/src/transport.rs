    ...
    async fn create_company(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v4/{parent}/companies";
    ...
    async fn update_company(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v4/{company.name}";

                let resource_name = format!("//jobs.googleapis.com/{}", var_company_name,);
    ...
    async fn complete_query(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v4/{tenant}:completeQuery";
    ...
    async fn create_client_event(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v4/{parent}/clientEvents";
    ...
    async fn create_job(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v4/{parent}/jobs";
    ...
    async fn batch_create_jobs(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v4/{parent}/jobs:batchCreate";
    ...
    async fn update_job(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v4/{job.name}";

                let resource_name = format!("//jobs.googleapis.com/{}", var_job_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn batch_update_jobs(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v4/{parent}/jobs:batchUpdate";
    ...
    async fn batch_delete_jobs(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v4/{parent}/jobs:batchDelete";
    ...
    async fn search_jobs(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v4/{parent}/jobs:search";
    ...
    async fn search_jobs_for_alert(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v4/{parent}/jobs:searchForAlert";
    ...
    async fn create_tenant(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v4/{parent}/tenants";
    ...
    async fn update_tenant(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v4/{tenant.name}";

                let resource_name = format!("//jobs.googleapis.com/{}", var_tenant_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
