...
pub mod compensation_info {
    ...
    impl CompensationEntry {
        ...
        /// ```
        /// # use google_cloud_talent_v4::model::compensation_info::CompensationEntry;
        /// use google_cloud_talent_v4::model::compensation_info::compensation_entry;
        /// use gtype::model::Money;
        /// let x = CompensationEntry::new().set_compensation_amount(Some(compensation_info::compensation_entry::CompensationAmount::Amount(Money::default().into())));
        /// ```
...
impl ClientEvent {
    ...
    /// ```
    /// # use google_cloud_talent_v4::model::ClientEvent;
    /// use google_cloud_talent_v4::model::client_event;
    /// use google_cloud_talent_v4::model::JobEvent;
    /// let x = ClientEvent::new().set_event(Some(client_event::Event::JobEvent(JobEvent::default().into())));
    /// ```
    pub fn set_event<
...
impl CommuteFilter {
    ...
    /// ```
    /// # use google_cloud_talent_v4::model::CommuteFilter;
    /// use google_cloud_talent_v4::model::commute_filter;
    /// use google_cloud_talent_v4::model::commute_filter::RoadTraffic;
    /// let x0 = CommuteFilter::new().set_traffic_option(Some(commute_filter::TrafficOption::RoadTraffic(RoadTraffic::TrafficFree)));
    /// let x1 = CommuteFilter::new().set_traffic_option(Some(commute_filter::TrafficOption::RoadTraffic(RoadTraffic::BusyHour)));
    /// ```
    ...
    /// assert!(x.road_traffic().is_some());
    /// assert!(x.departure_time().is_none());
    /// ```
