    ...
    async fn list_insights(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/insights";
    ...
    async fn mark_insight_accepted(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:markAccepted";
    ...
    async fn list_recommendations(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/recommendations";
    ...
    async fn mark_recommendation_dismissed(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:markDismissed";
    ...
    async fn mark_recommendation_claimed(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:markClaimed";
    ...
    async fn mark_recommendation_succeeded(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:markSucceeded";
    ...
    async fn mark_recommendation_failed(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:markFailed";
    ...
    async fn update_recommender_config(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{recommender_config.name}";

                let resource_name = format!(
                    "//recommender.googleapis.com/{}",
                    var_recommender_config_name,
                );
    ...
    async fn update_insight_type_config(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{insight_type_config.name}";

                let resource_name = format!(
                    "//recommender.googleapis.com/{}",
                    var_insight_type_config_name,
                );
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
