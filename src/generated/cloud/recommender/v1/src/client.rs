...
/// [with_credentials()]: super::builder::recommender::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `Recommender` in
...
impl Recommender {
    ...
    ///    client: &Recommender
    /// ) -> Result<()> {
    ///     let response = client.mark_insight_accepted()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &Recommender, parent: &str
    /// ) -> Result<()> {
    ///     let mut list = client.list_recommendations()
    ///         .set_parent(parent)
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &Recommender
    /// ) -> Result<()> {
    ///     let response = client.mark_recommendation_dismissed()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &Recommender
    /// ) -> Result<()> {
    ///     let response = client.mark_recommendation_claimed()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &Recommender
    /// ) -> Result<()> {
    ///     let response = client.mark_recommendation_succeeded()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &Recommender
    /// ) -> Result<()> {
    ///     let response = client.mark_recommendation_failed()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
