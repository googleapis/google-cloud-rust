...
impl Operation {
    ...
    /// use google_cloud_recommender_v1::model::operation;
    /// use wkt::Value;
    /// let x = Operation::new().set_path_value(Some(operation::PathValue::Value(Value::default().into())));
    /// ```
...
impl ValueMatcher {
    ...
    /// ```
    /// # use google_cloud_recommender_v1::model::ValueMatcher;
    /// use google_cloud_recommender_v1::model::value_matcher;
    /// let x = ValueMatcher::new().set_match_variant(Some(value_matcher::MatchVariant::MatchesPattern("example".to_string())));
    /// ```
...
impl Impact {
    ...
    /// use google_cloud_recommender_v1::model::impact;
    /// use google_cloud_recommender_v1::model::CostProjection;
    /// let x = Impact::new().set_projection(Some(impact::Projection::CostProjection(CostProjection::default().into())));
    /// ```
