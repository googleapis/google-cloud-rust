...
/// Implements a [Recommender](crate::stubs::Recommender) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Recommender<T>
where
    T: crate::stubs::Recommender + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::Recommender for Recommender<T>
where
    T: crate::stubs::Recommender + std::fmt::Debug + Send + Sync,
{
