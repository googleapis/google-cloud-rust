...
/// Implements a [Recommender](super::stubs::Recommender) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Recommender<T>
where
    T: super::stubs::Recommender + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Recommender for Recommender<T>
where
    T: super::stubs::Recommender + std::fmt::Debug + Send + Sync,
{
