...
/// Implements a [ParameterManager](super::stubs::ParameterManager) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ParameterManager<T>
where
    T: super::stubs::ParameterManager + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ParameterManager for ParameterManager<T>
where
    T: super::stubs::ParameterManager + std::fmt::Debug + Send + Sync,
{
