...
/// Implements a [ParameterManager](crate::stubs::ParameterManager) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ParameterManager<T>
where
    T: crate::stubs::ParameterManager + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ParameterManager for ParameterManager<T>
where
    T: crate::stubs::ParameterManager + std::fmt::Debug + Send + Sync,
{
