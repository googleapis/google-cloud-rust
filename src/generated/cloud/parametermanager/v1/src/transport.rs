    ...
    async fn list_parameters(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/parameters";
    ...
    async fn update_parameter(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parameter.name}";

                let resource_name =
                    format!("//parametermanager.googleapis.com/{}", var_parameter_name,);
    ...
    async fn render_parameter_version(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:render";
    ...
    async fn update_parameter_version(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parameter_version.name}";

                let resource_name = format!(
                    "//parametermanager.googleapis.com/{}",
                    var_parameter_version_name,
                );
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
