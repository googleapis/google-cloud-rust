        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//parametermanager.googleapis.com/v1/{}/parameters",
                    var_parent,
                );
    ...
    async fn get_parameter(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//parametermanager.googleapis.com/v1/{}", var_name,);
    ...
    async fn list_parameter_versions(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//parametermanager.googleapis.com/v1/{}/versions",
                    var_parent,
                );
