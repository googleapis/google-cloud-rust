...
impl ProvisioningQuota {
    ...
    /// ```
    /// # use google_cloud_baremetalsolution_v2::model::ProvisioningQuota;
    /// use google_cloud_baremetalsolution_v2::model::provisioning_quota;
    /// use google_cloud_baremetalsolution_v2::model::InstanceQuota;
    /// let x = ProvisioningQuota::new().set_quota(Some(provisioning_quota::Quota::InstanceQuota(InstanceQuota::default().into())));
    /// ```
    pub fn set_quota<
    ...
    /// # use google_cloud_baremetalsolution_v2::model::ProvisioningQuota;
    /// use google_cloud_baremetalsolution_v2::model::provisioning_quota;
    /// let x = ProvisioningQuota::new().set_availability(Some(provisioning_quota::Availability::ServerCount(42)));
    /// ```
...
pub mod volume_config {
    ...
    impl NfsExport {
        ...
        /// ```
        /// # use google_cloud_baremetalsolution_v2::model::volume_config::NfsExport;
        /// use google_cloud_baremetalsolution_v2::model::volume_config::nfs_export;
        /// let x = NfsExport::new().set_client(Some(volume_config::nfs_export::Client::MachineId("example".to_string())));
        /// ```
        pub fn set_client<
            T: std::convert::Into<
