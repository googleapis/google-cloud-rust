...
/// Implements a [BareMetalSolution](super::stubs::BareMetalSolution) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct BareMetalSolution<T>
where
    T: super::stubs::BareMetalSolution + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::BareMetalSolution for BareMetalSolution<T>
where
    T: super::stubs::BareMetalSolution + std::fmt::Debug + Send + Sync,
{
