...
/// Implements a [BinauthzManagementServiceV1](super::stubs::BinauthzManagementServiceV1) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct BinauthzManagementServiceV1<T>
where
    T: super::stubs::BinauthzManagementServiceV1 + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::BinauthzManagementServiceV1 for BinauthzManagementServiceV1<T>
where
    T: super::stubs::BinauthzManagementServiceV1 + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [SystemPolicyV1](super::stubs::SystemPolicyV1) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SystemPolicyV1<T>
where
    T: super::stubs::SystemPolicyV1 + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::SystemPolicyV1 for SystemPolicyV1<T>
where
    T: super::stubs::SystemPolicyV1 + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [ValidationHelperV1](super::stubs::ValidationHelperV1) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ValidationHelperV1<T>
where
    T: super::stubs::ValidationHelperV1 + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ValidationHelperV1 for ValidationHelperV1<T>
where
    T: super::stubs::ValidationHelperV1 + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
