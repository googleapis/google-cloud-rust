    ...
    async fn update_policy(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//binaryauthorization.googleapis.com/{}", var_policy_name,);
    ...
    async fn create_attestor(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/attestors";
    ...
    async fn update_attestor(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{attestor.name}";

                let resource_name =
                    format!("//binaryauthorization.googleapis.com/{}", var_attestor_name,);
                let builder = self.inner.builder(Method::PUT, path);
                let builder = Ok(builder);
                Some(builder.map(|b| (b, Method::PUT, _path_template, resource_name)))
            })
    ...
    async fn validate_attestation_occurrence(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{attestor}:validateAttestationOccurrence";

                let resource_name =
                    format!("//binaryauthorization.googleapis.com/{}", var_attestor,);
                let builder = self.inner.builder(Method::POST, path);
                let builder = Ok(builder);
                Some(builder.map(|b| (b, Method::POST, _path_template, resource_name)))
            })
