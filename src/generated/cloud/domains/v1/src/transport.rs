    ...
    async fn search_domains(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{location}/registrations:searchDomains";
    ...
    async fn retrieve_register_parameters(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{location}/registrations:retrieveRegisterParameters";
    ...
    async fn register_domain(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/registrations:register";
    ...
    async fn retrieve_transfer_parameters(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{location}/registrations:retrieveTransferParameters";
    ...
    async fn transfer_domain(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/registrations:transfer";
    ...
    async fn list_registrations(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/registrations";
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                let var_registration_name = try_match(
                    Some(&req)
                        .and_then(|m| m.registration.as_ref())
                        .map(|m| &m.name)
                        .map(|s| s.as_str()),
                    &[
                        Segment::Literal("projects/"),
                ...
                let _path_template = "/v1/{registration.name}";

                let resource_name = format!("//domains.googleapis.com/{}", var_registration_name,);
    ...
    async fn configure_management_settings(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{registration}:configureManagementSettings";
    ...
    async fn configure_dns_settings(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{registration}:configureDnsSettings";
    ...
    async fn configure_contact_settings(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{registration}:configureContactSettings";
    ...
    async fn retrieve_authorization_code(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{registration}:retrieveAuthorizationCode";
    ...
    async fn reset_authorization_code(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{registration}:resetAuthorizationCode";
