...
impl super::stub::Domains for Domains {
    async fn search_domains(
        ...
        let response: crate::model::SearchDomainsResponse = self
            .inner
    ...
    async fn retrieve_register_parameters(
        ...
        let response: crate::model::RetrieveRegisterParametersResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn retrieve_transfer_parameters(
        ...
        let builder = builder.query(&[("domainName", &req.domain_name)]);
        let response: crate::model::RetrieveTransferParametersResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn list_registrations(
        ...
        let response: crate::model::ListRegistrationsResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn get_registration(
        ...
        let response: crate::model::Registration = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn retrieve_authorization_code(
        ...
        let response: crate::model::AuthorizationCode = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn reset_authorization_code(
        ...
        let response: crate::model::AuthorizationCode =
            self.inner.execute(builder, Some(req), options).await?;
        Ok(gax::response::Response::from(response))
    }
