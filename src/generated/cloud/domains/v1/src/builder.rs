...
/// Request and client builders for [Domains][crate::client::Domains].
pub mod domains {
    use crate::Result;
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for SearchDomains {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for RetrieveRegisterParameters {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl RegisterDomain {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Registration, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_domains_v1::client::Domains::register_domain::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for RegisterDomain {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for RetrieveTransferParameters {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl TransferDomain {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Registration, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_domains_v1::client::Domains::transfer_domain::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for TransferDomain {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ListRegistrations {
        ...
        pub fn by_page(
            ...
            crate::model::ListRegistrationsResponse,
            crate::Error,
        > {
            use std::clone::Clone;
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListRegistrations {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetRegistration {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UpdateRegistration {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Registration, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_domains_v1::client::Domains::update_registration::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateRegistration {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ConfigureManagementSettings {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Registration, crate::model::OperationMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_domains_v1::client::Domains::configure_management_settings::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ConfigureManagementSettings {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ConfigureDnsSettings {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Registration, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_domains_v1::client::Domains::configure_dns_settings::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ConfigureDnsSettings {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ConfigureContactSettings {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Registration, crate::model::OperationMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_domains_v1::client::Domains::configure_contact_settings::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ConfigureContactSettings {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ExportRegistration {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Registration, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_domains_v1::client::Domains::export_registration::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ExportRegistration {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteRegistration {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_domains_v1::client::Domains::delete_registration::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteRegistration {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for RetrieveAuthorizationCode {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ResetAuthorizationCode {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
