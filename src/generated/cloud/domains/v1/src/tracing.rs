...
/// Implements a [Domains](super::stubs::Domains) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Domains<T>
where
    T: super::stubs::Domains + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Domains for Domains<T>
where
    T: super::stubs::Domains + std::fmt::Debug + Send + Sync,
{
