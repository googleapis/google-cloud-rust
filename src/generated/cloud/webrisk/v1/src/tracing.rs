...
/// Implements a [WebRiskService](super::stubs::WebRiskService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct WebRiskService<T>
where
    T: super::stubs::WebRiskService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::WebRiskService for WebRiskService<T>
where
    T: super::stubs::WebRiskService + std::fmt::Debug + Send + Sync,
{
