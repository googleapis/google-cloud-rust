...
/// Implements a [WebRiskService](crate::stubs::WebRiskService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct WebRiskService<T>
where
    T: crate::stubs::WebRiskService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::WebRiskService for WebRiskService<T>
where
    T: crate::stubs::WebRiskService + std::fmt::Debug + Send + Sync,
{
