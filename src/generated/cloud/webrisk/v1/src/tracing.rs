...
/// Implements a [WebRiskService](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct WebRiskService<T>
where
    T: crate::traits::WebRiskService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::WebRiskService for WebRiskService<T>
where
    T: crate::traits::WebRiskService + std::fmt::Debug + Send + Sync,
{
