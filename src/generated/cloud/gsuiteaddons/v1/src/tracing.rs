...
/// Implements a [GSuiteAddOns](super::stubs::GSuiteAddOns) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct GSuiteAddOns<T>
where
    T: super::stubs::GSuiteAddOns + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::GSuiteAddOns for GSuiteAddOns<T>
where
    T: super::stubs::GSuiteAddOns + std::fmt::Debug + Send + Sync,
{
