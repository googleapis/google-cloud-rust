...
/// [with_credentials()]: super::builder::cloud_redis::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `CloudRedis` in
...
impl CloudRedis {
    ...
    ///    client: &CloudRedis
    /// ) -> Result<()> {
    ///     let response = client.get_instance_auth_string()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &CloudRedis
    /// ) -> Result<()> {
    ///     let response = client.import_instance()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &CloudRedis
    /// ) -> Result<()> {
    ///     let response = client.export_instance()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
