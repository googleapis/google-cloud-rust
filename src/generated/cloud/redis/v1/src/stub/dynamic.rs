...
/// A dyn-compatible, crate-private version of [super::CloudRedis].
...
pub trait CloudRedis: std::fmt::Debug + Send + Sync {
    ...
    async fn get_instance_auth_string(
        ...
        options: gax::options::RequestOptions,
    ) -> crate::Result<gax::response::Response<crate::model::InstanceAuthString>>;
...
impl<T: super::CloudRedis> CloudRedis for T {
    ...
    async fn get_instance_auth_string(
        ...
        T::get_instance_auth_string(self, req, options).await
    }
    ...
    async fn upgrade_instance(
        ...
        T::upgrade_instance(self, req, options).await
    }
    ...
    async fn import_instance(
        ...
        T::import_instance(self, req, options).await
    }
    ...
    async fn export_instance(
        ...
        T::export_instance(self, req, options).await
    }
