...
/// Implements a [CloudRedis](super::stubs::CloudRedis) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudRedis<T>
where
    T: super::stubs::CloudRedis + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::CloudRedis for CloudRedis<T>
where
    T: super::stubs::CloudRedis + std::fmt::Debug + Send + Sync,
{
    ...
    async fn get_instance_auth_string(
        ...
        options: gax::options::RequestOptions,
    ) -> Result<crate::model::InstanceAuthString> {
