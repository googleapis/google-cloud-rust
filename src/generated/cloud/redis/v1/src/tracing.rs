...
/// Implements a [CloudRedis](crate::stubs::CloudRedis) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudRedis<T>
where
    T: crate::stubs::CloudRedis + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::CloudRedis for CloudRedis<T>
where
    T: crate::stubs::CloudRedis + std::fmt::Debug + Send + Sync,
{
