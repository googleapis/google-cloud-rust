...
pub trait CloudRedis: std::fmt::Debug + Send + Sync {
    ...
    fn get_instance_auth_string(
        ...
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::InstanceAuthString>> + Send
    {
        std::future::ready::<crate::Result<crate::model::InstanceAuthString>>(Err(Error::other(
            "unimplemented",
        )))
    }
