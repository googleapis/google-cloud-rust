...
/// Request and client builders for [CloudRedis][crate::client::CloudRedis].
pub mod cloud_redis {
    use crate::Result;
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetInstanceAuthString {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ImportInstance {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `import_instance`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::Instance, crate::model::OperationMetadata>
        {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ImportInstance {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ExportInstance {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `export_instance`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::Instance, crate::model::OperationMetadata>
        {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ExportInstance {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
