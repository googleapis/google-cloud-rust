...
/// use `client::CloudRedis` and need not be concerned with this trait or
/// its implementations.
///
...
pub trait CloudRedis: std::fmt::Debug + Send + Sync {
    ...
    fn get_instance_auth_string(
        ...
        Output = crate::Result<gax::response::Response<crate::model::InstanceAuthString>>,
    > + Send {
        std::future::ready::<crate::Result<gax::response::Response<crate::model::InstanceAuthString>>>(
            Err(Error::other("unimplemented")),
        )
    }
