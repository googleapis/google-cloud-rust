    ...
    async fn list_clusters(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//redis.googleapis.com/v1/{}/clusters", var_parent,);
    ...
    async fn get_cluster(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//redis.googleapis.com/v1/{}", var_name,);
    ...
    async fn list_backup_collections(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//redis.googleapis.com/v1/{}/backupCollections", var_parent,);
    ...
    async fn list_backups(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//redis.googleapis.com/v1/{}/backups", var_parent,);
