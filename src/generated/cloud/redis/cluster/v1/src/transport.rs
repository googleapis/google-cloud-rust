...
impl super::stub::CloudRedisCluster for CloudRedisCluster {
    async fn list_clusters(
        ...
        let options = {
            ...
            if let Some(rn) = resource_name {
                let full_resource_name = format!("//redis.googleapis.com/{}", rn);
    ...
    async fn update_cluster(
        ...
        let options = {
            let resource_name = Option::<&String>::None
                .or(req.cluster.as_ref().and_then(|s| s.backup_collection.as_ref()))
                                .or(req.cluster.as_ref().and_then(|s| s.kms_key.as_ref()))
                ;
            if let Some(rn) = resource_name {
                let full_resource_name = format!("//redis.googleapis.com/{}", rn);
                gax::options::internal::set_resource_name(options, full_resource_name)
    ...
    async fn get_cluster_certificate_authority(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/clusters/"), Segment::SingleWildcard, Segment::Literal("/certificateAuthority")])?,
            );
            let path_template = "/v1/{name}";
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                ...
                let builder = builder.maybe_add(
                    Some(&req).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/clusters/"), Segment::SingleWildcard, Segment::Literal("/certificateAuthority")],
                    "name",
    ...
    async fn list_backup_collections(
        ...
        .or_else(|| {
            ...
            let path_template = "/v1/{parent}/backupCollections";
    ...
    async fn get_backup_collection(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/backupCollections/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{name}";
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                ...
                let builder = builder.maybe_add(
                    Some(&req).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/backupCollections/"), Segment::SingleWildcard],
                    "name",
    ...
    async fn list_backups(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}/backups",
                try_match(Some(&req).map(|m| &m.parent).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/backupCollections/"), Segment::SingleWildcard])?,
            );
    ...
    async fn get_backup(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/backupCollections/"), Segment::SingleWildcard, Segment::Literal("/backups/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{name}";
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                ...
                let builder = builder.maybe_add(
                    Some(&req).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/backupCollections/"), Segment::SingleWildcard, Segment::Literal("/backups/"), Segment::SingleWildcard],
                    "name",
