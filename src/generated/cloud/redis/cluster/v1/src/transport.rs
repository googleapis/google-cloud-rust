...
/// Implements [CloudRedisCluster](crate::stubs::CloudRedisCluster) using a [gax::http_client::ReqwestClient].
#[derive(Clone)]
...
impl crate::stubs::CloudRedisCluster for CloudRedisCluster {
