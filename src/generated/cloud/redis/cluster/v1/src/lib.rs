...
//! 
//!
//! This crate contains traits, types, and functions to interact with Google Cloud Memorystore for Redis API
...
const DEFAULT_HOST: &str = "https://redis.googleapis.com/";
