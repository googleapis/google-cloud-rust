...
/// Implements a [CloudRedisCluster](super::stubs::CloudRedisCluster) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudRedisCluster<T>
where
    T: super::stubs::CloudRedisCluster + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::CloudRedisCluster for CloudRedisCluster<T>
where
    T: super::stubs::CloudRedisCluster + std::fmt::Debug + Send + Sync,
{
    ...
    async fn list_backup_collections(
        ...
        options: gax::options::RequestOptions,
    ) -> Result<crate::model::ListBackupCollectionsResponse> {
    ...
    async fn get_backup_collection(
        ...
        options: gax::options::RequestOptions,
    ) -> Result<crate::model::BackupCollection> {
