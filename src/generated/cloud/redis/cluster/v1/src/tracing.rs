...
/// Implements a [CloudRedisCluster](crate::stubs::CloudRedisCluster) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudRedisCluster<T>
where
    T: crate::stubs::CloudRedisCluster + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::CloudRedisCluster for CloudRedisCluster<T>
where
    T: crate::stubs::CloudRedisCluster + std::fmt::Debug + Send + Sync,
{
