...
/// [with_credentials()]: super::builder::data_migration_service::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `DataMigrationService` in
...
impl DataMigrationService {
    ...
    pub fn builder() -> super::builder::data_migration_service::ClientBuilder {
        crate::new_client_builder(super::builder::data_migration_service::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::DataMigrationService>>
    {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::DataMigrationService> {
