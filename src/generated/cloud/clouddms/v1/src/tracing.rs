...
/// Implements a [DataMigrationService](super::stubs::DataMigrationService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DataMigrationService<T>
where
    T: super::stubs::DataMigrationService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::DataMigrationService for DataMigrationService<T>
where
    T: super::stubs::DataMigrationService + std::fmt::Debug + Send + Sync,
{
