...
/// Implements a [DataMigrationService](crate::stubs::DataMigrationService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DataMigrationService<T>
where
    T: crate::stubs::DataMigrationService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::DataMigrationService for DataMigrationService<T>
where
    T: crate::stubs::DataMigrationService + std::fmt::Debug + Send + Sync,
{
