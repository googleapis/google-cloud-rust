...
/// Request and client builders for [AdvisoryNotificationsService][crate::client::AdvisoryNotificationsService].
pub mod advisory_notifications_service {
    ...
    impl ListNotifications {
        ...
        pub fn by_page(
            ...
            crate::model::ListNotificationsResponse,
            crate::Error,
        > {
            use std::clone::Clone;
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListNotifications {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetNotification {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
