...
/// Implements a [AdvisoryNotificationsService](crate::stubs::AdvisoryNotificationsService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AdvisoryNotificationsService<T>
where
    T: crate::stubs::AdvisoryNotificationsService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::AdvisoryNotificationsService for AdvisoryNotificationsService<T>
where
    T: crate::stubs::AdvisoryNotificationsService + std::fmt::Debug + Send + Sync,
{
