...
/// [with_credentials()]: super::builder::video_intelligence_service::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `VideoIntelligenceService` in
