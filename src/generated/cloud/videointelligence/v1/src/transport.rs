    ...
    async fn annotate_video(
        ...
        let (builder, method, _path_template) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/videos:annotate";
    ...
    async fn list_operations(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//videointelligence.googleapis.com/{}", var_name,);
    ...
    async fn get_operation(
        ...
        let (builder, method, _path_template, resource_name) = None
            ...
            .or_else(|| {
                ...
                let _path_template = "/v1/operations/{name}";
    ...
    async fn cancel_operation(
        ...
        let (builder, method, _path_template, resource_name) = None
            ...
            .or_else(|| {
                ...
                let _path_template = "/v1/operations/{name}:cancel";
