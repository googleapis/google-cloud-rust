...
/// Request and client builders for [VideoIntelligenceService][crate::client::VideoIntelligenceService].
pub mod video_intelligence_service {
    ...
    impl AnnotateVideo {
        ...
        > {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_videointelligence_v1::client::VideoIntelligenceService::annotate_video::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for AnnotateVideo {
