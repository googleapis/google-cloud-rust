...
/// Defines the trait used to implement [super::client::AuditManager].
///
/// Application developers may need to implement this trait to mock
/// `client::AuditManager`.  In other use-cases, application developers only
/// use `client::AuditManager` and need not be concerned with this trait or
/// its implementations.
///
...
pub trait AuditManager: std::fmt::Debug + Send + Sync {
    ...
    /// Implements [super::client::AuditManager::generate_audit_scope_report].
    ...
    /// Implements [super::client::AuditManager::generate_audit_report].
    ...
    /// Implements [super::client::AuditManager::list_audit_reports].
    ...
    /// Implements [super::client::AuditManager::get_audit_report].
    fn get_audit_report(
        &self,
    ...
    /// Implements [super::client::AuditManager::get_resource_enrollment_status].
    ...
    /// Implements [super::client::AuditManager::list_resource_enrollment_statuses].
    ...
    /// Implements [super::client::AuditManager::list_controls].
    fn list_controls(
        &self,
    ...
    /// Implements [super::client::AuditManager::list_locations].
    fn list_locations(
        &self,
    ...
    /// Implements [super::client::AuditManager::get_location].
    fn get_location(
        &self,
    ...
    /// Implements [super::client::AuditManager::list_operations].
    fn list_operations(
        &self,
    ...
    /// Implements [super::client::AuditManager::get_operation].
    fn get_operation(
        &self,
    ...
    /// Implements [super::client::AuditManager::delete_operation].
    fn delete_operation(
        &self,
    ...
    /// Implements [super::client::AuditManager::cancel_operation].
    fn cancel_operation(
        &self,
