...
impl super::stub::AuditManager for AuditManager {
    async fn create_audit_schedule(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}/auditSchedules", var_parent,);
                let path_template = "/v1/{parent}/auditSchedules";

                let resource_name = format!("//auditmanager.googleapis.com/{}", var_parent,);
                let builder = self.inner.builder(Method::POST, path);
                let builder = builder.query(&[("auditScheduleId", &req.audit_schedule_id)]);
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.auditmanager.v1.AuditManager/CreateAuditSchedule")
        ...
        let body = gaxi::http::handle_empty(req.audit_schedule, &method);
    ...
    async fn update_audit_schedule(
        ...
        let (builder, method, _path_template) = None
            .or_else(|| {
                let var_audit_schedule_name = try_match(
                    Some(&req)
                        .and_then(|m| m.audit_schedule.as_ref())
                        .map(|m| &m.name)
                        .map(|s| s.as_str()),
                    &[
                        Segment::Literal("projects/"),
                        ...
                        Segment::Literal("/locations/"),
                        Segment::SingleWildcard,
                        Segment::Literal("/auditSchedules/"),
                        Segment::SingleWildcard,
                    ],
                )?;
                let path = format!("/v1/{}", var_audit_schedule_name,);
                let path_template = "/v1/{audit_schedule.name}";
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.auditmanager.v1.AuditManager/UpdateAuditSchedule")
                    .set_url_template(_path_template),
            );
        }
        let options = google_cloud_gax::options::internal::set_default_idempotency(
    ...
    async fn get_audit_schedule(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.auditmanager.v1.AuditManager/GetAuditSchedule")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn list_audit_schedules(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.auditmanager.v1.AuditManager/ListAuditSchedules")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
