    ...
    async fn enroll_resource(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{scope}:enrollResource";

                let resource_name = format!("//auditmanager.googleapis.com/{}", var_scope,);
    ...
    async fn generate_audit_scope_report(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{scope}/auditScopeReports:generate";
    ...
    async fn generate_audit_report(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{scope}/auditReports:generate";
    ...
    async fn list_audit_reports(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/auditReports";
    ...
    async fn list_resource_enrollment_statuses(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/resourceEnrollmentStatuses";
    ...
    async fn list_controls(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/controls";
