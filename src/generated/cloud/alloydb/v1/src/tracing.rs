...
/// Implements a [AlloyDBAdmin](crate::stubs::AlloyDBAdmin) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AlloyDBAdmin<T>
where
    T: crate::stubs::AlloyDBAdmin + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::AlloyDBAdmin for AlloyDBAdmin<T>
where
    T: crate::stubs::AlloyDBAdmin + std::fmt::Debug + Send + Sync,
{
