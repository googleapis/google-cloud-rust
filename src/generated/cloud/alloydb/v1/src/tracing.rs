...
/// Implements a [AlloyDBAdmin](super::stubs::AlloyDBAdmin) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AlloyDBAdmin<T>
where
    T: super::stubs::AlloyDBAdmin + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::AlloyDBAdmin for AlloyDBAdmin<T>
where
    T: super::stubs::AlloyDBAdmin + std::fmt::Debug + Send + Sync,
{
