...
/// [with_credentials()]: super::builder::public_certificate_authority_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
///
/// `PublicCertificateAuthorityService` holds a connection pool internally, it is advised to
/// create one and reuse it. You do not need to wrap `PublicCertificateAuthorityService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
#[derive(Clone, Debug)]
pub struct PublicCertificateAuthorityService {
    inner: std::sync::Arc<dyn super::stub::dynamic::PublicCertificateAuthorityService>,
}
