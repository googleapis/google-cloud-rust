...
/// [with_credentials()]: super::builder::certificate_authority_service::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `CertificateAuthorityService` in
...
impl CertificateAuthorityService {
    ...
    pub fn builder() -> super::builder::certificate_authority_service::ClientBuilder {
        crate::new_client_builder(super::builder::certificate_authority_service::client::Factory)
    }
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::CertificateAuthorityService> {
    ...
    /// ) -> Result<()> {
    ///     let response = client.revoke_certificate()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &CertificateAuthorityService
    /// ) -> Result<()> {
    ///     let response = client.activate_certificate_authority()
    ///         /* set fields */
    ...
    ///    client: &CertificateAuthorityService
    /// ) -> Result<()> {
    ///     let response = client.disable_certificate_authority()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &CertificateAuthorityService
    /// ) -> Result<()> {
    ///     let response = client.enable_certificate_authority()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &CertificateAuthorityService
    /// ) -> Result<()> {
    ///     let response = client.fetch_certificate_authority_csr()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    /// ) -> Result<()> {
    ///     let response = client.create_ca_pool()
    ///         .set_parent(parent)
    ///         .set_ca_pool(
    ///             CaPool::new()/* set fields */
    ///         )
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &CertificateAuthorityService, parent: &str
    /// ) -> Result<()> {
    ///     let mut list = client.list_ca_pools()
    ///         .set_parent(parent)
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &CertificateAuthorityService
    /// ) -> Result<()> {
    ///     let response = client.fetch_ca_certs()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &CertificateAuthorityService, parent: &str
    /// ) -> Result<()> {
    ///     let response = client.create_certificate_template()
    ///         .set_parent(parent)
    ///         .set_certificate_template(
    ///             CertificateTemplate::new()/* set fields */
    ///         )
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &CertificateAuthorityService, parent: &str
    /// ) -> Result<()> {
    ///     let mut list = client.list_certificate_templates()
    ///         .set_parent(parent)
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
