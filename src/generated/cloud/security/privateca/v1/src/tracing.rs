...
/// Implements a [CertificateAuthorityService](crate::stubs::CertificateAuthorityService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CertificateAuthorityService<T>
where
    T: crate::stubs::CertificateAuthorityService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::CertificateAuthorityService for CertificateAuthorityService<T>
where
    T: crate::stubs::CertificateAuthorityService + std::fmt::Debug + Send + Sync,
{
