...
impl SubordinateConfig {
    ...
    /// ```
    /// # use google_cloud_security_privateca_v1::model::SubordinateConfig;
    /// use google_cloud_security_privateca_v1::model::subordinate_config::SubordinateConfig;
    /// let x = SubordinateConfig::new().set_subordinate_config(Some(SubordinateConfig::CertificateAuthority("example".to_string())));
    /// ```
