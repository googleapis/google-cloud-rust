...
/// Defines the trait used to implement [super::client::Maintenance].
///
/// Application developers may need to implement this trait to mock
/// `client::Maintenance`.  In other use-cases, application developers only
/// use `client::Maintenance` and need not be concerned with this trait or
/// its implementations.
///
...
pub trait Maintenance: std::fmt::Debug + Send + Sync {
    ...
    /// Implements [super::client::Maintenance::list_resource_maintenances].
    ...
    /// Implements [super::client::Maintenance::get_resource_maintenance].
    ...
    /// Implements [super::client::Maintenance::list_locations].
    fn list_locations(
        &self,
    ...
    /// Implements [super::client::Maintenance::get_location].
    fn get_location(
        &self,
