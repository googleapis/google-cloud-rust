...
pub mod maintenance {
    ...
    where R: std::default::Default {
        pub(crate) fn new(stub: std::sync::Arc<dyn super::super::stub::dynamic::Maintenance>) -> Self {
            Self {
                stub,
                request: R::default(),
    ...
    impl SummarizeMaintenances {
        ...
        pub fn with_request<V: Into<crate::model::SummarizeMaintenancesRequest>>(mut self, v: V) -> Self {
        ...
        pub async fn send(self) -> Result<crate::model::SummarizeMaintenancesResponse> {
            (*self.0.stub).summarize_maintenances(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }

        /// Streams each page in the collection.
        pub fn by_page(self) -> impl gax::paginator::Paginator<crate::model::SummarizeMaintenancesResponse, gax::error::Error> {
            use std::clone::Clone;
        ...
        pub fn by_item(self) -> impl gax::paginator::ItemPaginator<crate::model::SummarizeMaintenancesResponse, gax::error::Error> {
    ...
    /// ```
    #[derive(Clone, Debug)]
    pub struct ListResourceMaintenances(RequestBuilder<crate::model::ListResourceMaintenancesRequest>);
    ...
    impl ListResourceMaintenances {
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::ListResourceMaintenancesRequest>>(mut self, v: V) -> Self {
            self.0.request = v.into();
            self
        }
        ...
        pub async fn send(self) -> Result<crate::model::ListResourceMaintenancesResponse> {
            (*self.0.stub).list_resource_maintenances(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }

        /// Streams each page in the collection.
        pub fn by_page(self) -> impl gax::paginator::Paginator<crate::model::ListResourceMaintenancesResponse, gax::error::Error> {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
            let execute = move |token: String| {
                let mut builder = self.clone();
        ...
        /// Streams each item in the collection.
        pub fn by_item(self) -> impl gax::paginator::ItemPaginator<crate::model::ListResourceMaintenancesResponse, gax::error::Error> {
            use gax::paginator::Paginator;
            self.by_page().items()
        }
    ...
    impl GetResourceMaintenance {
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::GetResourceMaintenanceRequest>>(mut self, v: V) -> Self {
            self.0.request = v.into();
            self
        }
        ...
        pub async fn send(self) -> Result<crate::model::ResourceMaintenance> {
            (*self.0.stub).get_resource_maintenance(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }
