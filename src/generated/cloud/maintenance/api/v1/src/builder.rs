...
/// Request and client builders for [Maintenance][crate::client::Maintenance].
pub mod maintenance {
    use crate::Result;
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for SummarizeMaintenances {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListResourceMaintenances {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetResourceMaintenance {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
