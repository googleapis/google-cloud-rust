    ...
    async fn summarize_maintenances(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}/resourceMaintenances:summarize", var_parent,);

                let _path_template = "/v1/{parent}/resourceMaintenances:summarize";

                let resource_name = format!("//maintenance.googleapis.com/{}", var_parent,);
    ...
    async fn list_resource_maintenances(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}/resourceMaintenances", var_parent,);

                let _path_template = "/v1/{parent}/resourceMaintenances";
    ...
    async fn get_resource_maintenance(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//maintenance.googleapis.com/{}", var_name,);
                let builder = self.inner.builder(Method::GET, path);
                let builder = Ok(builder);
                Some(builder.map(|b| (b, Method::GET, _path_template, resource_name)))
            })
