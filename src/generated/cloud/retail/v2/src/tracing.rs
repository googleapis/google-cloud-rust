...
/// Implements a [AnalyticsService](crate::stubs::AnalyticsService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AnalyticsService<T>
where
    T: crate::stubs::AnalyticsService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::AnalyticsService for AnalyticsService<T>
where
    T: crate::stubs::AnalyticsService + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [CatalogService](crate::stubs::CatalogService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CatalogService<T>
where
    T: crate::stubs::CatalogService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::CatalogService for CatalogService<T>
where
    T: crate::stubs::CatalogService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [GenerativeQuestionService](crate::stubs::GenerativeQuestionService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct GenerativeQuestionService<T>
where
    T: crate::stubs::GenerativeQuestionService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::GenerativeQuestionService for GenerativeQuestionService<T>
where
    T: crate::stubs::GenerativeQuestionService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [ProductService](crate::stubs::ProductService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ProductService<T>
where
    T: crate::stubs::ProductService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ProductService for ProductService<T>
where
    T: crate::stubs::ProductService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [ServingConfigService](crate::stubs::ServingConfigService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ServingConfigService<T>
where
    T: crate::stubs::ServingConfigService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ServingConfigService for ServingConfigService<T>
where
    T: crate::stubs::ServingConfigService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
