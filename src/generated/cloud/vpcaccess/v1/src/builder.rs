...
/// Request and client builders for [VpcAccessService][crate::client::VpcAccessService].
pub mod vpc_access_service {
    ...
    impl CreateConnector {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Connector, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_vpcaccess_v1::client::VpcAccessService::create_connector::until_done";
            }
    ...
    impl DeleteConnector {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_vpcaccess_v1::client::VpcAccessService::delete_connector::until_done";
            }
