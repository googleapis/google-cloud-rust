...
pub mod vpc_access_service {
    ...
    where R: std::default::Default {
        pub(crate) fn new(stub: std::sync::Arc<dyn super::super::stub::dynamic::VpcAccessService>) -> Self {
            Self {
                stub,
                request: R::default(),
    ...
    impl CreateConnector {
        ...
        {
            type Operation = lro::internal::Operation<crate::model::Connector, crate::model::OperationMetadata>;
