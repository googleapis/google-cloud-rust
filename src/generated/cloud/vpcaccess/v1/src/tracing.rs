...
/// Implements a [VpcAccessService](super::stubs::VpcAccessService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct VpcAccessService<T>
where
    T: super::stubs::VpcAccessService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::VpcAccessService for VpcAccessService<T>
where
    T: super::stubs::VpcAccessService + std::fmt::Debug + Send + Sync,
{
