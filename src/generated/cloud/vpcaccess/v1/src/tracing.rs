...
/// Implements a [VpcAccessService](crate::stubs::VpcAccessService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct VpcAccessService<T>
where
    T: crate::stubs::VpcAccessService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::VpcAccessService for VpcAccessService<T>
where
    T: crate::stubs::VpcAccessService + std::fmt::Debug + Send + Sync,
{
