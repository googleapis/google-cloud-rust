...
/// Implements a [WorkloadIdentity](super::stub::WorkloadIdentity) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct WorkloadIdentity<T>
where
    T: super::stub::WorkloadIdentity + std::fmt::Debug + Send + Sync,
{
    inner: T,
    duration: gaxi::observability::DurationMetric,
}

impl<T> WorkloadIdentity<T>
where
    T: super::stub::WorkloadIdentity + std::fmt::Debug + Send + Sync,
{
...
impl<T> super::stub::WorkloadIdentity for WorkloadIdentity<T>
where
    T: super::stub::WorkloadIdentity + std::fmt::Debug + Send + Sync,
{
    ...
    async fn generate_service_agents(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            ...
            method: "client::WorkloadIdentity::generate_service_agents",
            self.inner.generate_service_agents(req, options));
        pending.await
    }
    ...
    async fn list_locations(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::WorkloadIdentity::list_locations",
    ...
    async fn get_location(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::WorkloadIdentity::get_location",
    ...
    async fn list_operations(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::WorkloadIdentity::list_operations",
    ...
    async fn get_operation(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::WorkloadIdentity::get_operation",
    ...
    async fn delete_operation(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::WorkloadIdentity::delete_operation",
    ...
    async fn cancel_operation(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::WorkloadIdentity::cancel_operation",
...
pub(crate) mod info {
    ...
    > = std::sync::LazyLock::new(|| {
        ...
        info.service_name = "workloadidentity";
        info.client_version = VERSION;
        info.client_artifact = NAME;
        info.default_host = "workloadidentity";
        info
    });
}
