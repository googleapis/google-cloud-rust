...
/// Request and client builders for [WorkloadIdentity][crate::client::WorkloadIdentity].
pub mod workload_identity {
    use crate::Result;

    /// A builder for [WorkloadIdentity][crate::client::WorkloadIdentity].
    ///
    /// ```
    /// # async fn sample() -> google_cloud_gax::client_builder::Result<()> {
    /// # use google_cloud_workloadidentity_v1::*;
    /// # use builder::workload_identity::ClientBuilder;
    /// # use client::WorkloadIdentity;
    /// let builder : ClientBuilder = WorkloadIdentity::builder();
    /// let client = builder
    ///     .with_endpoint("https://workloadidentity.googleapis.com")
    ///     .build().await?;
    /// # Ok(()) }
    /// ```
    ...
    pub(crate) mod client {
        use super::super::super::client::WorkloadIdentity;
        pub struct Factory;
        impl crate::ClientFactory for Factory {
            type Client = WorkloadIdentity;
    ...
    /// Common implementation for [crate::client::WorkloadIdentity] request builders.
    #[derive(Clone, Debug)]
    pub(crate) struct RequestBuilder<R: std::default::Default> {
        stub: std::sync::Arc<dyn super::super::stub::dynamic::WorkloadIdentity>,
        request: R,
    ...
    /// The request builder for [WorkloadIdentity::generate_service_agents][crate::client::WorkloadIdentity::generate_service_agents] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_workloadidentity_v1::builder::workload_identity::GenerateServiceAgents;
    /// # async fn sample() -> google_cloud_workloadidentity_v1::Result<()> {
    ...
    /// # Ok(()) }
    ///
    /// fn prepare_request_builder() -> GenerateServiceAgents {
    ///   # panic!();
    ///   // ... details omitted ...
    /// }
    /// ```
    #[derive(Clone, Debug)]
    pub struct GenerateServiceAgents(RequestBuilder<crate::model::GenerateServiceAgentsRequest>);

    impl GenerateServiceAgents {
        pub(crate) fn new(
            stub: std::sync::Arc<dyn super::super::stub::dynamic::WorkloadIdentity>,
        ) -> Self {
        ...
        pub fn with_request<V: Into<crate::model::GenerateServiceAgentsRequest>>(
            mut self,
            v: V,
        ) -> Self {
        ...
        /// on [generate_service_agents][crate::client::WorkloadIdentity::generate_service_agents].
        pub async fn send(self) -> Result<google_cloud_longrunning::model::Operation> {
            (*self.0.stub)
                .generate_service_agents(self.0.request, self.0.options)
                .await
                .map(crate::Response::into_body)
        }

        /// Creates a [Poller][google_cloud_lro::Poller] to work with `generate_service_agents`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<
            crate::model::GenerateServiceAgentsResponse,
        ...
        > {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_workloadidentity_v1::client::WorkloadIdentity::generate_service_agents::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GenerateServiceAgents {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [WorkloadIdentity::list_locations][crate::client::WorkloadIdentity::list_locations] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_workloadidentity_v1::builder::workload_identity::ListLocations;
    /// # async fn sample() -> google_cloud_workloadidentity_v1::Result<()> {
    ...
    /// The request builder for [WorkloadIdentity::get_location][crate::client::WorkloadIdentity::get_location] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_workloadidentity_v1::builder::workload_identity::GetLocation;
    /// # async fn sample() -> google_cloud_workloadidentity_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    ...
    /// The request builder for [WorkloadIdentity::list_operations][crate::client::WorkloadIdentity::list_operations] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_workloadidentity_v1::builder::workload_identity::ListOperations;
    /// # async fn sample() -> google_cloud_workloadidentity_v1::Result<()> {
    /// use google_cloud_gax::paginator::ItemPaginator;
    ///
    /// let builder = prepare_request_builder();
    ...
    /// The request builder for [WorkloadIdentity::get_operation][crate::client::WorkloadIdentity::get_operation] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_workloadidentity_v1::builder::workload_identity::GetOperation;
    /// # async fn sample() -> google_cloud_workloadidentity_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    ...
    /// The request builder for [WorkloadIdentity::delete_operation][crate::client::WorkloadIdentity::delete_operation] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_workloadidentity_v1::builder::workload_identity::DeleteOperation;
    /// # async fn sample() -> google_cloud_workloadidentity_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    ...
    /// The request builder for [WorkloadIdentity::cancel_operation][crate::client::WorkloadIdentity::cancel_operation] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_workloadidentity_v1::builder::workload_identity::CancelOperation;
    /// # async fn sample() -> google_cloud_workloadidentity_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
