...
/// Implements [WorkloadIdentity](super::stub::WorkloadIdentity) using a [gaxi::http::ReqwestClient].
#[derive(Clone)]
...
impl super::stub::WorkloadIdentity for WorkloadIdentity {
    async fn generate_service_agents(
        &self,
        req: crate::model::GenerateServiceAgentsRequest,
            ...
            .or_else(|| {
                let var_parent = try_match(
                    ...
                    &[
                        ...
                        Segment::SingleWildcard,
                        Segment::Literal("/serviceProducers/"),
                        Segment::SingleWildcard,
                    ],
                )?;
                let path = format!("/v1/{}:generateServiceAgents", var_parent,);
