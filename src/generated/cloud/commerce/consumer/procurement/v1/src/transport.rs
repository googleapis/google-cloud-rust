...
impl super::stub::LicenseManagementService for LicenseManagementService {
    async fn get_license_pool(
        ...
        let response: crate::model::LicensePool = self
            .inner
    ...
    async fn assign(
        ...
        let response: crate::model::AssignResponse =
    ...
    async fn unassign(
        ...
        let response: crate::model::UnassignResponse =
            self.inner.execute(builder, Some(req), options).await?;
        Ok(gax::response::Response::from(response))
    }
    ...
    async fn enumerate_licensed_users(
        ...
        let response: crate::model::EnumerateLicensedUsersResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
...
impl super::stub::ConsumerProcurementService for ConsumerProcurementService {
    ...
    async fn get_order(
        ...
        let response: crate::model::Order = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn list_orders(
        ...
        let response: crate::model::ListOrdersResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
