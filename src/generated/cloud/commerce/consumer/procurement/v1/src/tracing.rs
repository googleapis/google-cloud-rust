...
/// Implements a [LicenseManagementService](super::stubs::LicenseManagementService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct LicenseManagementService<T>
where
    T: super::stubs::LicenseManagementService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::LicenseManagementService for LicenseManagementService<T>
where
    T: super::stubs::LicenseManagementService + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [ConsumerProcurementService](super::stubs::ConsumerProcurementService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ConsumerProcurementService<T>
where
    T: super::stubs::ConsumerProcurementService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ConsumerProcurementService for ConsumerProcurementService<T>
where
    T: super::stubs::ConsumerProcurementService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
