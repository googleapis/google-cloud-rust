...
/// Request and client builders for [LicenseManagementService][crate::client::LicenseManagementService].
pub mod license_management_service {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetLicensePool {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateLicensePool {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for Assign {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for Unassign {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for EnumerateLicensedUsers {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
...
/// Request and client builders for [ConsumerProcurementService][crate::client::ConsumerProcurementService].
pub mod consumer_procurement_service {
    ...
    impl PlaceOrder {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Order, crate::model::PlaceOrderMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_commerce_consumer_procurement_v1::client::ConsumerProcurementService::place_order::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for PlaceOrder {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetOrder {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ListOrders {
        ...
        pub fn by_page(
            self,
        ) -> impl google_cloud_gax::paginator::Paginator<crate::model::ListOrdersResponse, crate::Error>
        {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
            let execute = move |token: String| {
        ...
        pub fn by_item(
            ...
            crate::model::ListOrdersResponse,
            crate::Error,
        > {
            use google_cloud_gax::paginator::Paginator;
            self.by_page().items()
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListOrders {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ModifyOrder {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Order, crate::model::ModifyOrderMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_commerce_consumer_procurement_v1::client::ConsumerProcurementService::modify_order::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ModifyOrder {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CancelOrder {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Order, crate::model::CancelOrderMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_commerce_consumer_procurement_v1::client::ConsumerProcurementService::cancel_order::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CancelOrder {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
