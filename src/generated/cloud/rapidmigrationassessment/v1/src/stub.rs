...
pub trait RapidMigrationAssessment: std::fmt::Debug + Send + Sync {
    ...
    fn list_collectors(
        ...
        Output = crate::Result<crate::Response<crate::model::ListCollectorsResponse>>,
    > + Send {
        gaxi::unimplemented::unimplemented_stub()
    }
    ...
    fn get_collector(
        ...
        _options: crate::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::Response<crate::model::Collector>>> + Send
    {
        gaxi::unimplemented::unimplemented_stub()
    }
