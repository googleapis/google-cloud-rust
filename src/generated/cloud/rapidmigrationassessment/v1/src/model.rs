...
pub mod collector {
    ...
    pub mod state {
        ...
        pub const STATE_INITIALIZING: State = State::known("STATE_INITIALIZING", 1);

        /// Collector has been created, MC source creation and db object creation
        /// completed.
        pub const STATE_READY_TO_USE: State = State::known("STATE_READY_TO_USE", 2);

        /// Collector client has been registered with client.
        pub const STATE_REGISTERED: State = State::known("STATE_REGISTERED", 3);

        /// Collector client is actively scanning.
        pub const STATE_ACTIVE: State = State::known("STATE_ACTIVE", 4);

        /// Collector is not actively scanning.
        pub const STATE_PAUSED: State = State::known("STATE_PAUSED", 5);

        /// Collector is starting background job for deletion.
        pub const STATE_DELETING: State = State::known("STATE_DELETING", 6);

        /// Collector completed all tasks for deletion.
        pub const STATE_DECOMMISSIONED: State = State::known("STATE_DECOMMISSIONED", 7);

        /// Collector is in error state.
        pub const STATE_ERROR: State = State::known("STATE_ERROR", 8);
    }
    ...
    impl std::convert::From<std::string::String> for State {
        fn from(value: std::string::String) -> Self {
            match value.as_str() {
                ...
                "STATE_INITIALIZING" => state::STATE_INITIALIZING,
                "STATE_READY_TO_USE" => state::STATE_READY_TO_USE,
                "STATE_REGISTERED" => state::STATE_REGISTERED,
                "STATE_ACTIVE" => state::STATE_ACTIVE,
                "STATE_PAUSED" => state::STATE_PAUSED,
                "STATE_DELETING" => state::STATE_DELETING,
                "STATE_DECOMMISSIONED" => state::STATE_DECOMMISSIONED,
    ...
    impl std::convert::From<i32> for State {
        fn from(value: i32) -> Self {
            match value {
                ...
                1 => state::STATE_INITIALIZING,
                2 => state::STATE_READY_TO_USE,
                3 => state::STATE_REGISTERED,
                4 => state::STATE_ACTIVE,
                5 => state::STATE_PAUSED,
                6 => state::STATE_DELETING,
                7 => state::STATE_DECOMMISSIONED,
                8 => state::STATE_ERROR,
...
pub mod annotation {
    ...
    pub mod r#type {
        ...
        pub const TYPE_LEGACY_EXPORT_CONSENT: Type = Type::known("TYPE_LEGACY_EXPORT_CONSENT", 1);

        /// Indicates that this project is created by Qwiklab.
        pub const TYPE_QWIKLAB: Type = Type::known("TYPE_QWIKLAB", 2);
    }
    ...
    impl std::convert::From<std::string::String> for Type {
        fn from(value: std::string::String) -> Self {
            match value.as_str() {
                ...
                "TYPE_LEGACY_EXPORT_CONSENT" => r#type::TYPE_LEGACY_EXPORT_CONSENT,
                "TYPE_QWIKLAB" => r#type::TYPE_QWIKLAB,
                _ => Self(wkt::enumerations::Enumeration::known_str(value)),
            }
        }
    }
    ...
    impl std::convert::From<i32> for Type {
        fn from(value: i32) -> Self {
            match value {
                ...
                1 => r#type::TYPE_LEGACY_EXPORT_CONSENT,
                2 => r#type::TYPE_QWIKLAB,
                _ => Self(wkt::enumerations::Enumeration::known_num(value)),
            }
        }
    }
