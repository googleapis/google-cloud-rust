...
/// Implements a [RapidMigrationAssessment](super::stubs::RapidMigrationAssessment) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct RapidMigrationAssessment<T>
where
    T: super::stubs::RapidMigrationAssessment + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::RapidMigrationAssessment for RapidMigrationAssessment<T>
where
    T: super::stubs::RapidMigrationAssessment + std::fmt::Debug + Send + Sync,
{
