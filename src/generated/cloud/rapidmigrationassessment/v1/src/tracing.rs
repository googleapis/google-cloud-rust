...
/// Implements a [RapidMigrationAssessment](crate::stubs::RapidMigrationAssessment) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct RapidMigrationAssessment<T>
where
    T: crate::stubs::RapidMigrationAssessment + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::RapidMigrationAssessment for RapidMigrationAssessment<T>
where
    T: crate::stubs::RapidMigrationAssessment + std::fmt::Debug + Send + Sync,
{
