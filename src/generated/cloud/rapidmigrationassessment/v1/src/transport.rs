        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//rapidmigrationassessment.googleapis.com/v1/{}/collectors",
                    var_parent,
                );
    ...
    async fn create_annotation(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//rapidmigrationassessment.googleapis.com/v1/{}/annotations",
                    var_parent,
                );
    ...
    async fn get_annotation(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//rapidmigrationassessment.googleapis.com/v1/{}", var_name,);
