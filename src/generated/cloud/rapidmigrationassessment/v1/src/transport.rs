...
/// Implements [RapidMigrationAssessment](super::stubs::RapidMigrationAssessment) using a [gaxi::ReqwestClient].
#[derive(Clone)]
...
impl super::stubs::RapidMigrationAssessment for RapidMigrationAssessment {
    ...
    async fn list_collectors(
        ...
        options: gax::options::RequestOptions,
    ) -> Result<crate::model::ListCollectorsResponse> {
        let options = options.set_default_idempotency(reqwest::Method::GET.is_idempotent());
        let builder = self
            .inner
            .builder(
