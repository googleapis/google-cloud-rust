...
/// [with_credentials()]: super::builder::rapid_migration_assessment::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `RapidMigrationAssessment` in
