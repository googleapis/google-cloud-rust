...
impl GenerateFrameworkAuditScopeReportResponse {
    ...
    /// ```
    /// # use google_cloud_cloudsecuritycompliance_v1::model::GenerateFrameworkAuditScopeReportResponse;
    /// use google_cloud_cloudsecuritycompliance_v1::model::generate_framework_audit_scope_report_response;
    /// let x = GenerateFrameworkAuditScopeReportResponse::new().set_audit_report(Some(generate_framework_audit_scope_report_response::AuditReport::ScopeReportContents(bytes::Bytes::from_static(b"example"))));
    /// ```
...
impl FrameworkAuditDestination {
    ...
    /// use google_cloud_cloudsecuritycompliance_v1::model::framework_audit_destination;
    /// use google_cloud_cloudsecuritycompliance_v1::model::BucketDestination;
    /// let x = FrameworkAuditDestination::new().set_destination_type(Some(framework_audit_destination::DestinationType::Bucket(BucketDestination::default().into())));
    /// ```
...
pub mod audit_config {
    ...
    impl CmEligibleDestination {
        ...
        /// ```
        /// # use google_cloud_cloudsecuritycompliance_v1::model::audit_config::CmEligibleDestination;
        /// use google_cloud_cloudsecuritycompliance_v1::model::audit_config::cm_eligible_destination;
        /// let x = CmEligibleDestination::new().set_cm_eligible_destinations(Some(audit_config::cm_eligible_destination::CmEligibleDestinations::GcsBucket("example".to_string())));
        /// ```
...
impl Validation {
    ...
    /// let x = Validation::new().set_constraint(Some(validation::Constraint::AllowedValues(AllowedValues::default().into())));
    /// ```
...
impl ParamValue {
    ...
    /// ```
    /// # use google_cloud_cloudsecuritycompliance_v1::model::ParamValue;
    /// use google_cloud_cloudsecuritycompliance_v1::model::param_value;
    /// let x = ParamValue::new().set_kind(Some(param_value::Kind::StringValue("example".to_string())));
    /// ```
...
impl ParameterSubstitutionRule {
    ...
    /// ```
    /// # use google_cloud_cloudsecuritycompliance_v1::model::ParameterSubstitutionRule;
    /// use google_cloud_cloudsecuritycompliance_v1::model::parameter_substitution_rule;
    /// use google_cloud_cloudsecuritycompliance_v1::model::PlaceholderSubstitutionRule;
    /// let x = ParameterSubstitutionRule::new().set_substitution_type(Some(parameter_substitution_rule::SubstitutionType::PlaceholderSubstitutionRule(PlaceholderSubstitutionRule::default().into())));
    /// ```
...
impl Rule {
    ...
    /// let x = Rule::new().set_implementation(Some(rule::Implementation::CelExpression(CELExpression::default().into())));
    /// ```
...
impl CELExpression {
    ...
    /// ```
    /// # use google_cloud_cloudsecuritycompliance_v1::model::CELExpression;
    /// use google_cloud_cloudsecuritycompliance_v1::model::cel_expression;
    /// use google_cloud_cloudsecuritycompliance_v1::model::StringList;
    /// let x = CELExpression::new().set_criteria(Some(cel_expression::Criteria::ResourceTypesValues(StringList::default().into())));
    /// ```
    pub fn set_criteria<
...
impl TargetResourceConfig {
    ...
    /// ```
    /// # use google_cloud_cloudsecuritycompliance_v1::model::TargetResourceConfig;
    /// use google_cloud_cloudsecuritycompliance_v1::model::target_resource_config;
    /// let x = TargetResourceConfig::new().set_resource_config(Some(target_resource_config::ResourceConfig::ExistingTargetResource("example".to_string())));
    /// ```
...
impl TargetResourceCreationConfig {
    ...
    /// ```
    /// # use google_cloud_cloudsecuritycompliance_v1::model::TargetResourceCreationConfig;
    /// use google_cloud_cloudsecuritycompliance_v1::model::target_resource_creation_config;
    /// use google_cloud_cloudsecuritycompliance_v1::model::FolderCreationConfig;
    /// let x = TargetResourceCreationConfig::new().set_resource_creation_config(Some(target_resource_creation_config::ResourceCreationConfig::FolderCreationConfig(FolderCreationConfig::default().into())));
    /// ```
...
impl CloudControlReport {
    ...
    /// ```
    /// # use google_cloud_cloudsecuritycompliance_v1::model::CloudControlReport;
    /// use google_cloud_cloudsecuritycompliance_v1::model::cloud_control_report;
    /// use google_cloud_cloudsecuritycompliance_v1::model::ManualCloudControlAssessmentDetails;
    /// let x = CloudControlReport::new().set_assessment_details(Some(cloud_control_report::AssessmentDetails::ManualCloudControlAssessmentDetails(ManualCloudControlAssessmentDetails::default().into())));
    /// ```
