...
//!
//! This crate contains traits, types, and functions to interact with Cloud Security Compliance API
...
const DEFAULT_HOST: &str = "https://cloudsecuritycompliance.googleapis.com/";
