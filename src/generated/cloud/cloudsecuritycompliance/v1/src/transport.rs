    ...
    async fn generate_framework_audit_scope_report(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//cloudsecuritycompliance.googleapis.com/{}", var_scope,);
    ...
    async fn create_framework_audit(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/frameworkAudits";
    ...
    async fn update_cm_enrollment(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{cm_enrollment.name}";

                let resource_name = format!(
                    "//cloudsecuritycompliance.googleapis.com/{}",
                    var_cm_enrollment_name,
                );
    ...
    async fn calculate_effective_cm_enrollment(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:calculate";
    ...
    async fn list_frameworks(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/frameworks";
    ...
    async fn update_framework(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{framework.name}";
    ...
    async fn list_cloud_controls(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/cloudControls";
    ...
    async fn update_cloud_control(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{cloud_control.name}";

                let resource_name = format!(
                    "//cloudsecuritycompliance.googleapis.com/{}",
                    var_cloud_control_name,
                );
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
    ...
    async fn create_framework_deployment(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/frameworkDeployments";
    ...
    async fn list_cloud_control_deployments(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/cloudControlDeployments";
    ...
    async fn list_framework_compliance_summaries(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/frameworkComplianceSummaries";
    ...
    async fn list_finding_summaries(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/findingSummaries";
    ...
    async fn list_control_compliance_summaries(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/controlComplianceSummaries";
    ...
    async fn aggregate_framework_compliance_report(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:aggregate";
