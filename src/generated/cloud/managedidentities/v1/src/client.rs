...
impl ManagedIdentitiesService {
    ...
    /// ```
    /// # use gax::Result;
    /// # use google_cloud_managedidentities_v1::model;
    /// async fn wait(
    ///     mut poller: impl lro::Poller<model::Domain, model::OpMetadata>
    /// ) -> Result<model::Domain> {
    ...
    /// field contains the final response, this will be a [crate::model::Domain] (as
    /// an [Any]), or the error (as a `Status`).
    ///
    /// If the `done` field is `false`, the operation has not completed.  The
    /// operation may also include a [crate::model::OpMetadata] value in the `metadata`
    ...
    ///
    /// [send()]: crate::builders::managed_identities_service::CreateMicrosoftAdDomain::send
    /// [poller()]: crate::builders::managed_identities_service::CreateMicrosoftAdDomain::poller
    ...
    /// the error status in the [result] field.
    ///
    /// [send()]: crate::builders::managed_identities_service::UpdateDomain::send
    /// [poller()]: crate::builders::managed_identities_service::UpdateDomain::poller
    /// [until_done()]: lro::Poller::until_done
    /// [PollingPolicy]: gax::polling_policy::PollingPolicy
    /// [PollingBackoffPolicy]: gax::polling_backoff_policy::PollingBackoffPolicy
    /// [get_operation]: Self::get_operation
    ...
    /// # use google_cloud_managedidentities_v1::model;
    /// async fn wait(
    ///     mut poller: impl lro::Poller<wkt::Empty, model::OpMetadata>
    /// ) -> Result<wkt::Empty> {
    ///     poller.until_done().await
    /// }
    /// ```
    ...
    /// the error status in the [result] field.
    ///
    /// [send()]: crate::builders::managed_identities_service::DeleteDomain::send
    /// [poller()]: crate::builders::managed_identities_service::DeleteDomain::poller
    /// [until_done()]: lro::Poller::until_done
    /// [PollingPolicy]: gax::polling_policy::PollingPolicy
    /// [PollingBackoffPolicy]: gax::polling_backoff_policy::PollingBackoffPolicy
    /// [get_operation]: Self::get_operation
    ...
    /// the error status in the [result] field.
    ///
    /// [send()]: crate::builders::managed_identities_service::AttachTrust::send
    /// [poller()]: crate::builders::managed_identities_service::AttachTrust::poller
    /// [until_done()]: lro::Poller::until_done
    /// [PollingPolicy]: gax::polling_policy::PollingPolicy
    /// [PollingBackoffPolicy]: gax::polling_backoff_policy::PollingBackoffPolicy
    /// [get_operation]: Self::get_operation
    ...
    /// the error status in the [result] field.
    ///
    /// [send()]: crate::builders::managed_identities_service::ReconfigureTrust::send
    /// [poller()]: crate::builders::managed_identities_service::ReconfigureTrust::poller
    /// [until_done()]: lro::Poller::until_done
    /// [PollingPolicy]: gax::polling_policy::PollingPolicy
    /// [PollingBackoffPolicy]: gax::polling_backoff_policy::PollingBackoffPolicy
    /// [get_operation]: Self::get_operation
    ...
    /// the error status in the [result] field.
    ///
    /// [send()]: crate::builders::managed_identities_service::DetachTrust::send
    /// [poller()]: crate::builders::managed_identities_service::DetachTrust::poller
    /// [until_done()]: lro::Poller::until_done
    /// [PollingPolicy]: gax::polling_policy::PollingPolicy
    /// [PollingBackoffPolicy]: gax::polling_backoff_policy::PollingBackoffPolicy
    /// [get_operation]: Self::get_operation
    ...
    /// the error status in the [result] field.
    ///
    /// [send()]: crate::builders::managed_identities_service::ValidateTrust::send
    /// [poller()]: crate::builders::managed_identities_service::ValidateTrust::poller
    /// [until_done()]: lro::Poller::until_done
    /// [PollingPolicy]: gax::polling_policy::PollingPolicy
    /// [PollingBackoffPolicy]: gax::polling_backoff_policy::PollingBackoffPolicy
    /// [get_operation]: Self::get_operation
