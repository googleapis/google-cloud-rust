...
/// Request and client builders for [ManagedIdentitiesService][crate::client::ManagedIdentitiesService].
pub mod managed_identities_service {
    ...
    impl CreateMicrosoftAdDomain {
        ...
        pub fn poller(
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_managedidentities_v1::client::ManagedIdentitiesService::create_microsoft_ad_domain::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateMicrosoftAdDomain {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ResetAdminPassword {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UpdateDomain {
        ...
        pub fn poller(
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_managedidentities_v1::client::ManagedIdentitiesService::update_domain::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateDomain {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteDomain {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OpMetadata> {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_managedidentities_v1::client::ManagedIdentitiesService::delete_domain::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteDomain {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl AttachTrust {
        ...
        pub fn poller(
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_managedidentities_v1::client::ManagedIdentitiesService::attach_trust::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for AttachTrust {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ReconfigureTrust {
        ...
        pub fn poller(
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_managedidentities_v1::client::ManagedIdentitiesService::reconfigure_trust::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ReconfigureTrust {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DetachTrust {
        ...
        pub fn poller(
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_managedidentities_v1::client::ManagedIdentitiesService::detach_trust::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DetachTrust {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ValidateTrust {
        ...
        pub fn poller(
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_managedidentities_v1::client::ManagedIdentitiesService::validate_trust::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ValidateTrust {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
