...
/// Implements a [ManagedIdentitiesService](super::stubs::ManagedIdentitiesService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ManagedIdentitiesService<T>
where
    T: super::stubs::ManagedIdentitiesService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ManagedIdentitiesService for ManagedIdentitiesService<T>
where
    T: super::stubs::ManagedIdentitiesService + std::fmt::Debug + Send + Sync,
{
