...
/// Implements a [ManagedIdentitiesService](crate::stubs::ManagedIdentitiesService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ManagedIdentitiesService<T>
where
    T: crate::stubs::ManagedIdentitiesService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ManagedIdentitiesService for ManagedIdentitiesService<T>
where
    T: crate::stubs::ManagedIdentitiesService + std::fmt::Debug + Send + Sync,
{
