    ...
    async fn create_microsoft_ad_domain(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}/domains", var_parent,);
                let path_template = "/v1/{parent}/domains";

                let resource_name = format!("//managedidentities.googleapis.com/{}", var_parent,);
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.managedidentities.v1.ManagedIdentitiesService/CreateMicrosoftAdDomain")
    ...
    async fn reset_admin_password(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}:resetAdminPassword", var_name,);
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.managedidentities.v1.ManagedIdentitiesService/ResetAdminPassword")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name)
            );
        }
    ...
    async fn update_domain(
        ...
        let (builder, method, _path_template) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}", var_domain_name,);
    ...
    async fn attach_trust(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}:attachTrust", var_name,);
    ...
    async fn reconfigure_trust(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}:reconfigureTrust", var_name,);
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.managedidentities.v1.ManagedIdentitiesService/ReconfigureTrust")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name)
            );
        }
    ...
    async fn detach_trust(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}:detachTrust", var_name,);
    ...
    async fn validate_trust(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}:validateTrust", var_name,);
