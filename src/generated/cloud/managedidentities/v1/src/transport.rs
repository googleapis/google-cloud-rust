    ...
    async fn create_microsoft_ad_domain(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/domains";
    ...
    async fn reset_admin_password(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:resetAdminPassword";
    ...
    async fn update_domain(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{domain.name}";

                let resource_name =
                    format!("//managedidentities.googleapis.com/{}", var_domain_name,);
    ...
    async fn attach_trust(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:attachTrust";
    ...
    async fn reconfigure_trust(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:reconfigureTrust";
    ...
    async fn detach_trust(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:detachTrust";
    ...
    async fn validate_trust(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:validateTrust";
