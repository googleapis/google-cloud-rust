...
/// Implements [HypercomputeCluster](super::stub::HypercomputeCluster) using a [gaxi::http::ReqwestClient].
#[derive(Clone)]
pub struct HypercomputeCluster {
    inner: gaxi::http::ReqwestClient,
}

impl std::fmt::Debug for HypercomputeCluster {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::result::Result<(), std::fmt::Error> {
        f.debug_struct("HypercomputeCluster")
...
impl super::stub::HypercomputeCluster for HypercomputeCluster {
    async fn list_clusters(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//hypercomputecluster.googleapis.com/{}", var_parent,);
    ...
    async fn get_cluster(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//hypercomputecluster.googleapis.com/{}", var_name,);
                let builder = self.inner.builder(Method::GET, path);
                let builder = Ok(builder);
                Some(builder.map(|b| (b, Method::GET, _path_template, resource_name)))
            })
    ...
    async fn update_cluster(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//hypercomputecluster.googleapis.com/{}", var_cluster_name,);
