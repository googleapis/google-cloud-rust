    ...
    async fn list_clusters(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "list_clusters",
                Some("google.cloud.hypercomputecluster.v1.HypercomputeCluster/ListClusters")
            );
            self.inner
    ...
    async fn get_cluster(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::HypercomputeCluster",
                "get_cluster",
                Some("google.cloud.hypercomputecluster.v1.HypercomputeCluster/GetCluster")
            );
            self.inner
    ...
    async fn create_cluster(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::HypercomputeCluster",
                "create_cluster",
                Some("google.cloud.hypercomputecluster.v1.HypercomputeCluster/CreateCluster")
            );
            self.inner
    ...
    async fn update_cluster(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::HypercomputeCluster",
                "update_cluster",
                Some("google.cloud.hypercomputecluster.v1.HypercomputeCluster/UpdateCluster")
            );
            self.inner
    ...
    async fn delete_cluster(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::HypercomputeCluster",
                "delete_cluster",
                Some("google.cloud.hypercomputecluster.v1.HypercomputeCluster/DeleteCluster")
            );
            self.inner
