...
pub mod hypercompute_cluster {
    ...
    impl CreateCluster {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Cluster, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_hypercomputecluster_v1::client::HypercomputeCluster::create_cluster::until_done";
            }
    ...
    impl UpdateCluster {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Cluster, crate::model::OperationMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_hypercomputecluster_v1::client::HypercomputeCluster::update_cluster::until_done";
            }
    ...
    impl DeleteCluster {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_hypercomputecluster_v1::client::HypercomputeCluster::delete_cluster::until_done";
            }
