...
/// Implements a [AppHub](super::stubs::AppHub) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AppHub<T>
where
    T: super::stubs::AppHub + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::AppHub for AppHub<T>
where
    T: super::stubs::AppHub + std::fmt::Debug + Send + Sync,
{
