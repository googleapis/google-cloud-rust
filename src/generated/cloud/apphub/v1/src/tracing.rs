...
/// Implements a [AppHub](crate::stubs::AppHub) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AppHub<T>
where
    T: crate::stubs::AppHub + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::AppHub for AppHub<T>
where
    T: crate::stubs::AppHub + std::fmt::Debug + Send + Sync,
{
