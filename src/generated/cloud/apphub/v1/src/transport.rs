    ...
    async fn lookup_service_project_attachment(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//apphub.googleapis.com/v1/{}", var_name,);
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//apphub.googleapis.com/v1/{}/serviceProjectAttachments",
                    var_parent,
                );
    ...
    async fn list_discovered_services(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//apphub.googleapis.com/v1/{}/discoveredServices",
                    var_parent,
                );
    ...
    async fn list_services(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//apphub.googleapis.com/v1/{}/services", var_parent,);
    ...
    async fn list_discovered_workloads(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//apphub.googleapis.com/v1/{}/discoveredWorkloads",
                    var_parent,
                );
    ...
    async fn list_workloads(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//apphub.googleapis.com/v1/{}/workloads", var_parent,);
    ...
    async fn list_applications(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//apphub.googleapis.com/v1/{}/applications", var_parent,);
    ...
    async fn set_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//apphub.googleapis.com/v1/{}", var_resource,);
