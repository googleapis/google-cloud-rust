...
/// Request and client builders for [AppHub][crate::client::AppHub].
pub mod app_hub {
    use crate::Result;
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for LookupServiceProjectAttachment {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListServiceProjectAttachments {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateServiceProjectAttachment {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `create_service_project_attachment`.
        pub fn poller(
            self,
        ...
        > {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_apphub_v1::client::AppHub::create_service_project_attachment::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateServiceProjectAttachment {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetServiceProjectAttachment {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteServiceProjectAttachment {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `delete_service_project_attachment`.
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_apphub_v1::client::AppHub::delete_service_project_attachment::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteServiceProjectAttachment {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DetachServiceProjectAttachment {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListDiscoveredServices {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetDiscoveredService {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for LookupDiscoveredService {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateService {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Service, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_apphub_v1::client::AppHub::create_service::until_done";
            }
    ...
    impl UpdateService {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Service, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_apphub_v1::client::AppHub::update_service::until_done";
            }
    ...
    impl DeleteService {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_apphub_v1::client::AppHub::delete_service::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListDiscoveredWorkloads {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetDiscoveredWorkload {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for LookupDiscoveredWorkload {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateWorkload {
        ...
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::Workload, crate::model::OperationMetadata>
        {
            type Operation = google_cloud_lro::internal::Operation<
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_apphub_v1::client::AppHub::create_workload::until_done";
            }
    ...
    impl UpdateWorkload {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `update_workload`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::Workload, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_apphub_v1::client::AppHub::update_workload::until_done";
            }
    ...
    impl DeleteWorkload {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `delete_workload`.
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            type Operation =
                google_cloud_lro::internal::Operation<wkt::Empty, crate::model::OperationMetadata>;
            let polling_error_policy = self.0.stub.get_polling_error_policy(&self.0.options);
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_apphub_v1::client::AppHub::delete_workload::until_done";
            }
    ...
    impl CreateApplication {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Application, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_apphub_v1::client::AppHub::create_application::until_done";
            }
    ...
    impl UpdateApplication {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Application, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_apphub_v1::client::AppHub::update_application::until_done";
            }
    ...
    impl DeleteApplication {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_apphub_v1::client::AppHub::delete_application::until_done";
            }
