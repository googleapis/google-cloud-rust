...
/// Implements a [ModelArmor](crate::stubs::ModelArmor) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ModelArmor<T>
where
    T: crate::stubs::ModelArmor + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ModelArmor for ModelArmor<T>
where
    T: crate::stubs::ModelArmor + std::fmt::Debug + Send + Sync,
{
