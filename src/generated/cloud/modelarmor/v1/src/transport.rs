...
/// Implements [ModelArmor](super::stub::ModelArmor) using a [gaxi::http::ReqwestClient] and a [gaxi::grpc::Client].
#[derive(Clone)]
...
impl super::stub::ModelArmor for ModelArmor {
    async fn list_templates(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}/templates", var_parent,);
                let path_template = "/v1/{parent}/templates";

                let resource_name = format!("//modelarmor.googleapis.com/{}", var_parent,);
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.modelarmor.v1.ModelArmor/ListTemplates")
    ...
    async fn get_template(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.modelarmor.v1.ModelArmor/GetTemplate")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn create_template(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.modelarmor.v1.ModelArmor/CreateTemplate")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn update_template(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.modelarmor.v1.ModelArmor/UpdateTemplate")
                    .set_url_template(_path_template),
            );
        }
        let options = google_cloud_gax::options::internal::set_default_idempotency(
    ...
    async fn delete_template(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.modelarmor.v1.ModelArmor/DeleteTemplate")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn get_floor_setting(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.modelarmor.v1.ModelArmor/GetFloorSetting")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn update_floor_setting(
        ...
        let (builder, method, _path_template) = None
            .or_else(|| {
                let var_floor_setting_name = try_match(
                    Some(&req)
                ...
                let path = format!("/v1/{}", var_floor_setting_name,);
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.modelarmor.v1.ModelArmor/UpdateFloorSetting")
                    .set_url_template(_path_template),
            );
        }
        let options = google_cloud_gax::options::internal::set_default_idempotency(
    ...
    async fn sanitize_user_prompt(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}:sanitizeUserPrompt", var_name,);
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.modelarmor.v1.ModelArmor/SanitizeUserPrompt")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn sanitize_model_response(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}:sanitizeModelResponse", var_name,);
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.modelarmor.v1.ModelArmor/SanitizeModelResponse")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    fn stream_sanitize_user_prompt(
        ...
        self.grpc_inner
            .execute_bidi_streaming::<
                ...
                crate::prost::google::cloud::modelarmor::v1::SanitizeUserPromptResponse,
            >(
                extensions,
                path,
                options,
    ...
    fn stream_sanitize_model_response(
        ...
        self.grpc_inner
            .execute_bidi_streaming::<
                ...
                crate::prost::google::cloud::modelarmor::v1::SanitizeModelResponseResponse,
            >(
                extensions,
                path,
                options,
