    ...
    async fn list_templates(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/templates";
    ...
    async fn update_template(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//modelarmor.googleapis.com/{}", var_template_name,);
    ...
    async fn update_floor_setting(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{floor_setting.name}";

                let resource_name =
                    format!("//modelarmor.googleapis.com/{}", var_floor_setting_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn sanitize_user_prompt(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:sanitizeUserPrompt";
    ...
    async fn sanitize_model_response(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:sanitizeModelResponse";
