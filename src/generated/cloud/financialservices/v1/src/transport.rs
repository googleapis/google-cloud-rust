        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//financialservices.googleapis.com/v1/{}/instances",
                    var_parent,
                );
    ...
    async fn get_instance(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//financialservices.googleapis.com/v1/{}", var_name,);
    ...
    async fn list_datasets(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//financialservices.googleapis.com/v1/{}/datasets",
                    var_parent,
                );
    ...
    async fn list_models(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//financialservices.googleapis.com/v1/{}/models",
                    var_parent,
                );
    ...
    async fn export_model_metadata(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//financialservices.googleapis.com/v1/{}", var_model,);
    ...
    async fn list_engine_configs(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//financialservices.googleapis.com/v1/{}/engineConfigs",
                    var_parent,
                );
    ...
    async fn export_engine_config_metadata(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//financialservices.googleapis.com/v1/{}",
                    var_engine_config,
                );
    ...
    async fn list_engine_versions(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//financialservices.googleapis.com/v1/{}/engineVersions",
                    var_parent,
                );
    ...
    async fn list_prediction_results(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//financialservices.googleapis.com/v1/{}/predictionResults",
                    var_parent,
                );
    ...
    async fn list_backtest_results(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//financialservices.googleapis.com/v1/{}/backtestResults",
                    var_parent,
                );
