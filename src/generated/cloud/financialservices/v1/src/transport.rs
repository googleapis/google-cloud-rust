    ...
    async fn update_instance(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//financialservices.googleapis.com/{}", var_instance_name,);
    ...
    async fn import_registered_parties(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:importRegisteredParties";
    ...
    async fn export_registered_parties(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:exportRegisteredParties";
    ...
    async fn update_dataset(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{dataset.name}";

                let resource_name =
                    format!("//financialservices.googleapis.com/{}", var_dataset_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn list_models(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/models";
    ...
    async fn update_model(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{model.name}";

                let resource_name =
                    format!("//financialservices.googleapis.com/{}", var_model_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn export_model_metadata(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{model}:exportMetadata";
    ...
    async fn list_engine_configs(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/engineConfigs";
    ...
    async fn update_engine_config(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{engine_config.name}";

                let resource_name = format!(
                    "//financialservices.googleapis.com/{}",
                    var_engine_config_name,
                );
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
    ...
    async fn export_engine_config_metadata(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{engine_config}:exportMetadata";
    ...
    async fn list_engine_versions(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/engineVersions";
    ...
    async fn list_prediction_results(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/predictionResults";
    ...
    async fn update_prediction_result(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{prediction_result.name}";

                let resource_name = format!(
                    "//financialservices.googleapis.com/{}",
                    var_prediction_result_name,
                );
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
    ...
    async fn export_prediction_result_metadata(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{prediction_result}:exportMetadata";
    ...
    async fn list_backtest_results(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/backtestResults";
    ...
    async fn update_backtest_result(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{backtest_result.name}";

                let resource_name = format!(
                    "//financialservices.googleapis.com/{}",
                    var_backtest_result_name,
                );
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
    ...
    async fn export_backtest_result_metadata(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{backtest_result}:exportMetadata";
