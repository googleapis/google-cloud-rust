...
/// [with_credentials()]: super::builder::aml::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `Aml` in
...
impl Aml {
    ...
    pub fn builder() -> super::builder::aml::ClientBuilder {
        crate::new_client_builder(super::builder::aml::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::Aml>> {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::Aml> {
