    ...
    async fn get_mcp_server(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//cloudapiregistry.googleapis.com/v1/{}", var_name,);
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//cloudapiregistry.googleapis.com/v1/{}/mcpServers",
                    var_parent,
                );
    ...
    async fn list_mcp_tools(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//cloudapiregistry.googleapis.com/v1/{}/mcpTools",
                    var_parent,
                );
