...
impl CloudApiRegistry {
    ...
    pub fn builder() -> super::builder::cloud_api_registry::ClientBuilder {
        gax::client_builder::internal::new_builder(
            super::builder::cloud_api_registry::client::Factory,
        )
    }
    ...
    ) -> gax::client_builder::Result<std::sync::Arc<dyn super::stub::dynamic::CloudApiRegistry>>
    {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> gax::client_builder::Result<impl super::stub::CloudApiRegistry> {
