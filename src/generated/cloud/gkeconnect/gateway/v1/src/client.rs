...
/// [with_credentials()]: super::builder::gateway_control::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `GatewayControl` in
...
impl GatewayControl {
    ...
    pub fn builder() -> super::builder::gateway_control::ClientBuilder {
        crate::new_client_builder(super::builder::gateway_control::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::GatewayControl>> {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::GatewayControl> {
    ...
    /// ```
    /// # use google_cloud_gkeconnect_gateway_v1::client::GatewayControl;
    /// use google_cloud_gkeconnect_gateway_v1::Result;
    /// async fn sample(
