...
/// Implements a [AccountManagementService](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AccountManagementService<T>
where
    T: crate::traits::AccountManagementService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::AccountManagementService for AccountManagementService<T>
where
    T: crate::traits::AccountManagementService + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [AuthenticationService](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AuthenticationService<T>
where
    T: crate::traits::AuthenticationService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::AuthenticationService for AuthenticationService<T>
where
    T: crate::traits::AuthenticationService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
