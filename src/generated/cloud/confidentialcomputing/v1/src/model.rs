...
impl VerifyAttestationRequest {
    ...
    /// ```
    /// # use google_cloud_confidentialcomputing_v1::model::VerifyAttestationRequest;
    /// use google_cloud_confidentialcomputing_v1::model::verify_attestation_request;
    /// use google_cloud_confidentialcomputing_v1::model::TdxCcelAttestation;
    /// let x = VerifyAttestationRequest::new().set_tee_attestation(Some(verify_attestation_request::TeeAttestation::TdCcel(TdxCcelAttestation::default().into())));
    /// ```
...
impl TokenOptions {
    ...
    /// ```
    /// # use google_cloud_confidentialcomputing_v1::model::TokenOptions;
    /// use google_cloud_confidentialcomputing_v1::model::token_options;
    /// use google_cloud_confidentialcomputing_v1::model::AwsPrincipalTagsOptions;
    /// let x = TokenOptions::new().set_token_type_options(Some(token_options::TokenTypeOptions::AwsPrincipalTagsOptions(AwsPrincipalTagsOptions::default().into())));
    /// ```
...
impl VerifyConfidentialSpaceRequest {
    ...
    /// ```
    /// # use google_cloud_confidentialcomputing_v1::model::VerifyConfidentialSpaceRequest;
    /// use google_cloud_confidentialcomputing_v1::model::verify_confidential_space_request;
    /// use google_cloud_confidentialcomputing_v1::model::TdxCcelAttestation;
    /// let x = VerifyConfidentialSpaceRequest::new().set_tee_attestation(Some(verify_confidential_space_request::TeeAttestation::TdCcel(TdxCcelAttestation::default().into())));
    /// ```
    pub fn set_tee_attestation<
        T: std::convert::Into<
                std::option::Option<
...
pub mod verify_confidential_space_request {
    ...
    impl ConfidentialSpaceOptions {
        ...
        /// ```
        /// # use google_cloud_confidentialcomputing_v1::model::verify_confidential_space_request::ConfidentialSpaceOptions;
        /// use google_cloud_confidentialcomputing_v1::model::verify_confidential_space_request::confidential_space_options;
        /// use google_cloud_confidentialcomputing_v1::model::AwsPrincipalTagsOptions;
        /// let x = ConfidentialSpaceOptions::new().set_token_profile_options(Some(verify_confidential_space_request::confidential_space_options::TokenProfileOptions::AwsPrincipalTagsOptions(AwsPrincipalTagsOptions::default().into())));
        /// ```
...
impl VerifyConfidentialGkeRequest {
    ...
    /// ```
    /// # use google_cloud_confidentialcomputing_v1::model::VerifyConfidentialGkeRequest;
    /// use google_cloud_confidentialcomputing_v1::model::verify_confidential_gke_request;
    /// use google_cloud_confidentialcomputing_v1::model::TpmAttestation;
    /// let x = VerifyConfidentialGkeRequest::new().set_tee_attestation(Some(verify_confidential_gke_request::TeeAttestation::TpmAttestation(TpmAttestation::default().into())));
    /// ```
    pub fn set_tee_attestation<
        T: std::convert::Into<
                std::option::Option<crate::model::verify_confidential_gke_request::TeeAttestation>,
