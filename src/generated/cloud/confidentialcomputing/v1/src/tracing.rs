...
/// Implements a [ConfidentialComputing](crate::stubs::ConfidentialComputing) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ConfidentialComputing<T>
where
    T: crate::stubs::ConfidentialComputing + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ConfidentialComputing for ConfidentialComputing<T>
where
    T: crate::stubs::ConfidentialComputing + std::fmt::Debug + Send + Sync,
{
