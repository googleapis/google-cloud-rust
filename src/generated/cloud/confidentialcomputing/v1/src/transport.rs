    ...
    async fn create_challenge(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/challenges";
    ...
    async fn verify_attestation(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{challenge}:verifyAttestation";
    ...
    async fn verify_confidential_space(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{challenge}:verifyConfidentialSpace";
    ...
    async fn verify_confidential_gke(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{challenge}:verifyConfidentialGke";
    ...
    async fn list_locations(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//confidentialcomputing.googleapis.com/{}", var_name,);
