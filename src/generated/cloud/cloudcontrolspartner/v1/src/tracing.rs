...
/// Implements a [CloudControlsPartnerCore](crate::stubs::CloudControlsPartnerCore) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudControlsPartnerCore<T>
where
    T: crate::stubs::CloudControlsPartnerCore + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::CloudControlsPartnerCore for CloudControlsPartnerCore<T>
where
    T: crate::stubs::CloudControlsPartnerCore + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [CloudControlsPartnerMonitoring](crate::stubs::CloudControlsPartnerMonitoring) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudControlsPartnerMonitoring<T>
where
    T: crate::stubs::CloudControlsPartnerMonitoring + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::CloudControlsPartnerMonitoring for CloudControlsPartnerMonitoring<T>
where
    T: crate::stubs::CloudControlsPartnerMonitoring + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
