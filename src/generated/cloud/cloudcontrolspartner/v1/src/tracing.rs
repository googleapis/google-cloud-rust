...
/// Implements a [CloudControlsPartnerCore](super::stubs::CloudControlsPartnerCore) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudControlsPartnerCore<T>
where
    T: super::stubs::CloudControlsPartnerCore + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::CloudControlsPartnerCore for CloudControlsPartnerCore<T>
where
    T: super::stubs::CloudControlsPartnerCore + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [CloudControlsPartnerMonitoring](super::stubs::CloudControlsPartnerMonitoring) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudControlsPartnerMonitoring<T>
where
    T: super::stubs::CloudControlsPartnerMonitoring + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::CloudControlsPartnerMonitoring for CloudControlsPartnerMonitoring<T>
where
    T: super::stubs::CloudControlsPartnerMonitoring + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
