    ...
    async fn get_workload(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//cloudcontrolspartner.googleapis.com/v1/{}", var_name,);
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//cloudcontrolspartner.googleapis.com/v1/{}/workloads",
                    var_parent,
                );
    ...
    async fn list_customers(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//cloudcontrolspartner.googleapis.com/v1/{}/customers",
                    var_parent,
                );
    ...
    async fn list_access_approval_requests(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//cloudcontrolspartner.googleapis.com/v1/{}/accessApprovalRequests",
                    var_parent,
                );
    ...
    async fn list_violations(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//cloudcontrolspartner.googleapis.com/v1/{}/violations",
                    var_parent,
                );
