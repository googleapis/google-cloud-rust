...
//! 
//!
//! This crate contains traits, types, and functions to interact with Cloud Controls Partner API
...
const DEFAULT_HOST: &str = "https://cloudcontrolspartner.googleapis.com/";
