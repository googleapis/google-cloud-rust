...
/// Implements a [NetApp](crate::stubs::NetApp) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct NetApp<T>
where
    T: crate::stubs::NetApp + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::NetApp for NetApp<T>
where
    T: crate::stubs::NetApp + std::fmt::Debug + Send + Sync,
{
