    ...
    async fn list_storage_pools(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//netapp.googleapis.com/v1/{}/storagePools", var_parent,);
    ...
    async fn get_storage_pool(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//netapp.googleapis.com/v1/{}", var_name,);
    ...
    async fn list_volumes(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//netapp.googleapis.com/v1/{}/volumes", var_parent,);
    ...
    async fn list_snapshots(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//netapp.googleapis.com/v1/{}/snapshots", var_parent,);
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//netapp.googleapis.com/v1/{}/activeDirectories",
                    var_parent,
                );
    ...
    async fn list_kms_configs(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//netapp.googleapis.com/v1/{}/kmsConfigs", var_parent,);
    ...
    async fn list_replications(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//netapp.googleapis.com/v1/{}/replications", var_parent,);
    ...
    async fn create_backup_vault(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//netapp.googleapis.com/v1/{}/backupVaults", var_parent,);
    ...
    async fn create_backup(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//netapp.googleapis.com/v1/{}/backups", var_parent,);
    ...
    async fn create_backup_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//netapp.googleapis.com/v1/{}/backupPolicies", var_parent,);
    ...
    async fn list_quota_rules(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//netapp.googleapis.com/v1/{}/quotaRules", var_parent,);
    ...
    async fn list_host_groups(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//netapp.googleapis.com/v1/{}/hostGroups", var_parent,);
