    ...
    async fn list_storage_pools(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/storagePools";
    ...
    async fn update_storage_pool(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{storage_pool.name}";

                let resource_name = format!("//netapp.googleapis.com/{}", var_storage_pool_name,);
    ...
    async fn validate_directory_service(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:validateDirectoryService";
    ...
    async fn switch_active_replica_zone(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:switch";
    ...
    async fn list_volumes(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/volumes";
    ...
    async fn update_volume(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{volume.name}";

                let resource_name = format!("//netapp.googleapis.com/{}", var_volume_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn update_snapshot(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//netapp.googleapis.com/{}", var_snapshot_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn list_active_directories(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/activeDirectories";
    ...
    async fn update_active_directory(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{active_directory.name}";

                let resource_name =
                    format!("//netapp.googleapis.com/{}", var_active_directory_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn list_kms_configs(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/kmsConfigs";
    ...
    async fn update_kms_config(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{kms_config.name}";

                let resource_name = format!("//netapp.googleapis.com/{}", var_kms_config_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn encrypt_volumes(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:encrypt";
    ...
    async fn verify_kms_config(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:verify";
    ...
    async fn list_replications(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/replications";
    ...
    async fn update_replication(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{replication.name}";

                let resource_name = format!("//netapp.googleapis.com/{}", var_replication_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn resume_replication(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:resume";
    ...
    async fn reverse_replication_direction(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:reverseDirection";
    ...
    async fn establish_peering(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:establishPeering";
    ...
    async fn sync_replication(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:sync";
    ...
    async fn create_backup_vault(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/backupVaults";
    ...
    async fn update_backup_vault(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{backup_vault.name}";

                let resource_name = format!("//netapp.googleapis.com/{}", var_backup_vault_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn update_backup(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//netapp.googleapis.com/{}", var_backup_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn create_backup_policy(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/backupPolicies";
    ...
    async fn update_backup_policy(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{backup_policy.name}";

                let resource_name = format!("//netapp.googleapis.com/{}", var_backup_policy_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn list_quota_rules(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/quotaRules";
    ...
    async fn update_quota_rule(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{quota_rule.name}";

                let resource_name = format!("//netapp.googleapis.com/{}", var_quota_rule_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn list_host_groups(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/hostGroups";
    ...
    async fn update_host_group(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{host_group.name}";

                let resource_name = format!("//netapp.googleapis.com/{}", var_host_group_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
