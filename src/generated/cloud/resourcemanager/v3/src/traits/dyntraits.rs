...
/// All implementations of [crate::traits::Folders] also implement [Folders].
#[async_trait::async_trait]
impl<T: crate::traits::Folders> Folders for T {
...
/// All implementations of [crate::traits::Organizations] also implement [Organizations].
#[async_trait::async_trait]
impl<T: crate::traits::Organizations> Organizations for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn get_organization(
        &self,
        req: crate::model::GetOrganizationRequest,
...
/// All implementations of [crate::traits::Projects] also implement [Projects].
#[async_trait::async_trait]
impl<T: crate::traits::Projects> Projects for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn get_project(
        &self,
        req: crate::model::GetProjectRequest,
...
/// All implementations of [crate::traits::TagBindings] also implement [TagBindings].
#[async_trait::async_trait]
impl<T: crate::traits::TagBindings> TagBindings for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn list_tag_bindings(
        &self,
        req: crate::model::ListTagBindingsRequest,
...
/// All implementations of [crate::traits::TagHolds] also implement [TagHolds].
#[async_trait::async_trait]
impl<T: crate::traits::TagHolds> TagHolds for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn create_tag_hold(
        &self,
        req: crate::model::CreateTagHoldRequest,
...
/// All implementations of [crate::traits::TagKeys] also implement [TagKeys].
#[async_trait::async_trait]
impl<T: crate::traits::TagKeys> TagKeys for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn list_tag_keys(
        &self,
        req: crate::model::ListTagKeysRequest,
...
/// All implementations of [crate::traits::TagValues] also implement [TagValues].
#[async_trait::async_trait]
impl<T: crate::traits::TagValues> TagValues for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn list_tag_values(
        &self,
        req: crate::model::ListTagValuesRequest,
