...
/// Implements a [Folders](super::stubs::Folders) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Folders<T>
where
    T: super::stubs::Folders + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Folders for Folders<T>
where
    T: super::stubs::Folders + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [Organizations](super::stubs::Organizations) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Organizations<T>
where
    T: super::stubs::Organizations + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Organizations for Organizations<T>
where
    T: super::stubs::Organizations + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Projects](super::stubs::Projects) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Projects<T>
where
    T: super::stubs::Projects + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Projects for Projects<T>
where
    T: super::stubs::Projects + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [TagBindings](super::stubs::TagBindings) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct TagBindings<T>
where
    T: super::stubs::TagBindings + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::TagBindings for TagBindings<T>
where
    T: super::stubs::TagBindings + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [TagHolds](super::stubs::TagHolds) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct TagHolds<T>
where
    T: super::stubs::TagHolds + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::TagHolds for TagHolds<T>
where
    T: super::stubs::TagHolds + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [TagKeys](super::stubs::TagKeys) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct TagKeys<T>
where
    T: super::stubs::TagKeys + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::TagKeys for TagKeys<T>
where
    T: super::stubs::TagKeys + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [TagValues](super::stubs::TagValues) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct TagValues<T>
where
    T: super::stubs::TagValues + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::TagValues for TagValues<T>
where
    T: super::stubs::TagValues + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
