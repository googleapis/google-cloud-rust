...
//!
//! This crate contains traits, types, and functions to interact with Cloud FTP API
...
//! # Available Clients
//!
//! * [CloudFtp](client/struct.CloudFtp.html)
//!
//! # Features
//!
...
const DEFAULT_HOST: &str = "https://ftp.googleapis.com/";
