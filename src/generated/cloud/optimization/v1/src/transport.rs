    ...
    async fn optimize_tours(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}:optimizeTours";

                let resource_name = format!("//cloudoptimization.googleapis.com/{}", var_parent,);
    ...
    async fn batch_optimize_tours(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}:batchOptimizeTours";
    ...
    async fn get_operation(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//cloudoptimization.googleapis.com/{}", var_name,);
