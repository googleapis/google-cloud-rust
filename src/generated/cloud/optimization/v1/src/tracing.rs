...
/// Implements a [FleetRouting](super::stubs::FleetRouting) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct FleetRouting<T>
where
    T: super::stubs::FleetRouting + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::FleetRouting for FleetRouting<T>
where
    T: super::stubs::FleetRouting + std::fmt::Debug + Send + Sync,
{
