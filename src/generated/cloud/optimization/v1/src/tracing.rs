...
/// Implements a [FleetRouting](crate::stubs::FleetRouting) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct FleetRouting<T>
where
    T: crate::stubs::FleetRouting + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::FleetRouting for FleetRouting<T>
where
    T: crate::stubs::FleetRouting + std::fmt::Debug + Send + Sync,
{
