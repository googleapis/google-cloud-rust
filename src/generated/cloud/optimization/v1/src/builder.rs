...
/// Request and client builders for [FleetRouting][crate::client::FleetRouting].
    ...
    impl BatchOptimizeTours {
        ...
        > {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_optimization_v1::client::FleetRouting::batch_optimize_tours::until_done";
            }
