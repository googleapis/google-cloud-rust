...
/// Implements a [DocumentProcessorService](crate::stubs::DocumentProcessorService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DocumentProcessorService<T>
where
    T: crate::stubs::DocumentProcessorService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::DocumentProcessorService for DocumentProcessorService<T>
where
    T: crate::stubs::DocumentProcessorService + std::fmt::Debug + Send + Sync,
{
