...
/// Request and client builders for [DocumentProcessorService][crate::client::DocumentProcessorService].
pub mod document_processor_service {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ProcessDocument {
    ...
    impl BatchProcessDocuments {
        ...
        > {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_documentai_v1::client::DocumentProcessorService::batch_process_documents::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for BatchProcessDocuments {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for FetchProcessorTypes {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListProcessorTypes {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetProcessorType {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl TrainProcessorVersion {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_documentai_v1::client::DocumentProcessorService::train_processor_version::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for TrainProcessorVersion {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetProcessorVersion {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListProcessorVersions {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteProcessorVersion {
        ...
        ) -> impl google_cloud_lro::Poller<(), crate::model::DeleteProcessorVersionMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_documentai_v1::client::DocumentProcessorService::delete_processor_version::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteProcessorVersion {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeployProcessorVersion {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_documentai_v1::client::DocumentProcessorService::deploy_processor_version::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeployProcessorVersion {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UndeployProcessorVersion {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_documentai_v1::client::DocumentProcessorService::undeploy_processor_version::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UndeployProcessorVersion {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteProcessor {
        ...
        pub fn poller(
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_documentai_v1::client::DocumentProcessorService::delete_processor::until_done";
            }
    ...
    impl EnableProcessor {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_documentai_v1::client::DocumentProcessorService::enable_processor::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for EnableProcessor {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DisableProcessor {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_documentai_v1::client::DocumentProcessorService::disable_processor::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DisableProcessor {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl SetDefaultProcessorVersion {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_documentai_v1::client::DocumentProcessorService::set_default_processor_version::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for SetDefaultProcessorVersion {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ReviewDocument {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_documentai_v1::client::DocumentProcessorService::review_document::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ReviewDocument {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl EvaluateProcessorVersion {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_documentai_v1::client::DocumentProcessorService::evaluate_processor_version::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for EvaluateProcessorVersion {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetEvaluation {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ListEvaluations {
        ...
        pub fn by_page(
            ...
            crate::model::ListEvaluationsResponse,
            crate::Error,
        > {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListEvaluations {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
