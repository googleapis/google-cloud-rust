...
/// Implements [DocumentProcessorService](crate::stubs::DocumentProcessorService) using a [gax::http_client::ReqwestClient].
#[derive(Clone)]
...
impl crate::stubs::DocumentProcessorService for DocumentProcessorService {
