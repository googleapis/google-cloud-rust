...
//! Google Cloud Client Libraries for Rust - Cloud Product Registry API
//!
//! This crate contains traits, types, and functions to interact with Cloud Product Registry API
...
//! # Available Clients
//!
//! * [CloudProductRegistryReadService](client/struct.CloudProductRegistryReadService.html)
//!
//! # Features
//!
...
const DEFAULT_HOST: &str = "https://cloudproductregistry.googleapis.com/";
