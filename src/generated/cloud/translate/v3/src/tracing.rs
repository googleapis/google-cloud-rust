...
/// Implements a [TranslationService](super::stubs::TranslationService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct TranslationService<T>
where
    T: super::stubs::TranslationService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::TranslationService for TranslationService<T>
where
    T: super::stubs::TranslationService + std::fmt::Debug + Send + Sync,
{
