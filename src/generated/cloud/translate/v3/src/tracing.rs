...
/// Implements a [TranslationService](crate::stubs::TranslationService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct TranslationService<T>
where
    T: crate::stubs::TranslationService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::TranslationService for TranslationService<T>
where
    T: crate::stubs::TranslationService + std::fmt::Debug + Send + Sync,
{
