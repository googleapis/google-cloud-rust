...
/// Implements a [TranslationService](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct TranslationService<T>
where
    T: crate::traits::TranslationService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::TranslationService for TranslationService<T>
where
    T: crate::traits::TranslationService + std::fmt::Debug + Send + Sync,
{
