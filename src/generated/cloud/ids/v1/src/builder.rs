...
/// Request and client builders for [Ids][crate::client::Ids].
pub mod ids {
    use crate::Result;
    ...
    impl CreateEndpoint {
        ...
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::Endpoint, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_ids_v1::client::Ids::create_endpoint::until_done";
            }
    ...
    impl DeleteEndpoint {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_ids_v1::client::Ids::delete_endpoint::until_done";
            }
