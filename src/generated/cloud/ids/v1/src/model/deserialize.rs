                ...
                impl<'de> serde::de::Visitor<'de> for Visitor {
                        ...
                        E: serde::de::Error,
                    {
                        ...
                        match value {
                            ...
                            "endpoint_forwarding_rule" => Ok(__FieldTag::__endpoint_forwarding_rule),
                    ...
                    match tag {
                        ...
                        __FieldTag::__endpoint_forwarding_rule => {
                            if !fields.insert(__FieldTag::__endpoint_forwarding_rule) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for endpoint_forwarding_rule"));
                            }
                            result.endpoint_forwarding_rule = map.next_value::<std::option::Option<std::string::String>>()?.unwrap_or_default();
                        },
                        __FieldTag::__endpoint_ip => {
                            if !fields.insert(__FieldTag::__endpoint_ip) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for endpoint_ip"));
                            }
                            result.endpoint_ip = map.next_value::<std::option::Option<std::string::String>>()?.unwrap_or_default();
                        },
                        ...
                        __FieldTag::__state => {
                            ...
                            result.state = map.next_value::<std::option::Option<crate::model::endpoint::State>>()?.unwrap_or_default();
                        },
                        __FieldTag::__traffic_logs => {
                            if !fields.insert(__FieldTag::__traffic_logs) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for traffic_logs"));
                            }
                            result.traffic_logs = map.next_value::<std::option::Option<bool>>()?.unwrap_or_default();
                        },
