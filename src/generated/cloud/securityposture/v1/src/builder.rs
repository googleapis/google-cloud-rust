...
/// Request and client builders for [SecurityPosture][crate::client::SecurityPosture].
pub mod security_posture {
    ...
    impl ListPostures {
        ...
        pub fn by_page(
            self,
        ) -> impl google_cloud_gax::paginator::Paginator<crate::model::ListPosturesResponse, crate::Error>
        {
            use std::clone::Clone;
        ...
        pub fn by_item(
            ...
            crate::model::ListPosturesResponse,
            crate::Error,
        > {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListPostures {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListPostureRevisions {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetPosture {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreatePosture {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Posture, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_securityposture_v1::client::SecurityPosture::create_posture::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreatePosture {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UpdatePosture {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Posture, crate::model::OperationMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_securityposture_v1::client::SecurityPosture::update_posture::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdatePosture {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeletePosture {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_securityposture_v1::client::SecurityPosture::delete_posture::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeletePosture {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ExtractPosture {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Posture, crate::model::OperationMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_securityposture_v1::client::SecurityPosture::extract_posture::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ExtractPosture {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListPostureDeployments {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetPostureDeployment {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreatePostureDeployment {
        ...
        > {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_securityposture_v1::client::SecurityPosture::create_posture_deployment::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreatePostureDeployment {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UpdatePostureDeployment {
        ...
        > {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_securityposture_v1::client::SecurityPosture::update_posture_deployment::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdatePostureDeployment {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeletePostureDeployment {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_securityposture_v1::client::SecurityPosture::delete_posture_deployment::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeletePostureDeployment {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListPostureTemplates {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetPostureTemplate {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
