        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//securityposture.googleapis.com/v1/{}/postures",
                    var_parent,
                );
    ...
    async fn list_posture_revisions(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//securityposture.googleapis.com/v1/{}", var_name,);
    ...
    async fn list_posture_deployments(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//securityposture.googleapis.com/v1/{}/postureDeployments",
                    var_parent,
                );
    ...
    async fn list_posture_templates(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//securityposture.googleapis.com/v1/{}/postureTemplates",
                    var_parent,
                );
