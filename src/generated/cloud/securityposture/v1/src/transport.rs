    ...
    async fn list_postures(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/postures";
    ...
    async fn update_posture(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{posture.name}";

                let resource_name =
                    format!("//securityposture.googleapis.com/{}", var_posture_name,);
    ...
    async fn extract_posture(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/postures:extract";
    ...
    async fn list_posture_deployments(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/postureDeployments";
    ...
    async fn update_posture_deployment(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{posture_deployment.name}";

                let resource_name = format!(
                    "//securityposture.googleapis.com/{}",
                    var_posture_deployment_name,
                );
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
    ...
    async fn list_posture_templates(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/postureTemplates";
