...
/// Implements a [SecurityPosture](super::stubs::SecurityPosture) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SecurityPosture<T>
where
    T: super::stubs::SecurityPosture + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::SecurityPosture for SecurityPosture<T>
where
    T: super::stubs::SecurityPosture + std::fmt::Debug + Send + Sync,
{
