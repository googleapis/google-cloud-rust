...
/// Implements a [Config](crate::stubs::Config) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Config<T>
where
    T: crate::stubs::Config + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::Config for Config<T>
where
    T: crate::stubs::Config + std::fmt::Debug + Send + Sync,
{
