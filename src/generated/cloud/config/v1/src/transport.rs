    ...
    async fn list_deployments(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//config.googleapis.com/v1/{}/deployments", var_parent,);
    ...
    async fn get_deployment(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//config.googleapis.com/v1/{}", var_name,);
    ...
    async fn list_revisions(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//config.googleapis.com/v1/{}/revisions", var_parent,);
    ...
    async fn list_resources(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//config.googleapis.com/v1/{}/resources", var_parent,);
    ...
    async fn export_deployment_statefile(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//config.googleapis.com/v1/{}", var_parent,);
    ...
    async fn create_preview(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//config.googleapis.com/v1/{}/previews", var_parent,);
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//config.googleapis.com/v1/{}/terraformVersions",
                    var_parent,
                );
    ...
    async fn list_resource_changes(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//config.googleapis.com/v1/{}/resourceChanges", var_parent,);
    ...
    async fn list_resource_drifts(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//config.googleapis.com/v1/{}/resourceDrifts", var_parent,);
    ...
    async fn set_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//config.googleapis.com/v1/{}", var_resource,);
