...
- Read the [crate's documentation](https://docs.rs/google-cloud-config-v1/1.4.0)

[Config]: https://docs.rs/google-cloud-config-v1/1.4.0/google_cloud_config_v1/client/struct.Config.html
