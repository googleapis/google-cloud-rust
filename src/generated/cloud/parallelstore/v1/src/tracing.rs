...
/// Implements a [Parallelstore](super::stubs::Parallelstore) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Parallelstore<T>
where
    T: super::stubs::Parallelstore + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Parallelstore for Parallelstore<T>
where
    T: super::stubs::Parallelstore + std::fmt::Debug + Send + Sync,
{
