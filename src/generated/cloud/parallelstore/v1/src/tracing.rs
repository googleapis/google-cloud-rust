...
/// Implements a [Parallelstore](crate::stubs::Parallelstore) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Parallelstore<T>
where
    T: crate::stubs::Parallelstore + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::Parallelstore for Parallelstore<T>
where
    T: crate::stubs::Parallelstore + std::fmt::Debug + Send + Sync,
{
