...
/// Implements a [Memorystore](crate::stubs::Memorystore) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Memorystore<T>
where
    T: crate::stubs::Memorystore + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::Memorystore for Memorystore<T>
where
    T: crate::stubs::Memorystore + std::fmt::Debug + Send + Sync,
{
