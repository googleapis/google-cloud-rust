...
/// Implements a [Memorystore](super::stubs::Memorystore) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Memorystore<T>
where
    T: super::stubs::Memorystore + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Memorystore for Memorystore<T>
where
    T: super::stubs::Memorystore + std::fmt::Debug + Send + Sync,
{
