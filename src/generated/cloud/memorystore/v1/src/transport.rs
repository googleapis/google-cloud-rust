    ...
    async fn list_instances(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//memorystore.googleapis.com/v1/{}/instances", var_parent,);
    ...
    async fn get_instance(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//memorystore.googleapis.com/v1/{}", var_name,);
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//memorystore.googleapis.com/v1/{}/certificateAuthority",
                    var_name,
                );
    ...
    async fn list_backup_collections(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//memorystore.googleapis.com/v1/{}/backupCollections",
                    var_parent,
                );
    ...
    async fn list_backups(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//memorystore.googleapis.com/v1/{}/backups", var_parent,);
