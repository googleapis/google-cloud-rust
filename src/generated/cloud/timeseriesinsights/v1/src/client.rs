...
/// [with_credentials()]: super::builder::timeseries_insights_controller::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `TimeseriesInsightsController` in
...
impl TimeseriesInsightsController {
    ...
    pub fn builder() -> super::builder::timeseries_insights_controller::ClientBuilder {
        crate::new_client_builder(super::builder::timeseries_insights_controller::client::Factory)
    }
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::TimeseriesInsightsController> {
