...
/// Implements a [TimeseriesInsightsController](super::stubs::TimeseriesInsightsController) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct TimeseriesInsightsController<T>
where
    T: super::stubs::TimeseriesInsightsController + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::TimeseriesInsightsController for TimeseriesInsightsController<T>
where
    T: super::stubs::TimeseriesInsightsController + std::fmt::Debug + Send + Sync,
{
