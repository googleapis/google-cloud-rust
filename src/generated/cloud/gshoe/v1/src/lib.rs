...
//! Google Cloud Client Libraries for Rust - GShoe API
//!
//! This crate contains traits, types, and functions to interact with GShoe API
...
//! # Available Clients
//!
//! * [ShoeService](client/struct.ShoeService.html)
//!
//! # Features
//!
...
const DEFAULT_HOST: &str = "https://gshoe.googleapis.com/";
