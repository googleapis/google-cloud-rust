...
/// Implements [HubService](super::stubs::HubService) using a [gaxi::ReqwestClient].
#[derive(Clone)]
...
/// Implements [PolicyBasedRoutingService](super::stubs::PolicyBasedRoutingService) using a [gaxi::ReqwestClient].
#[derive(Clone)]
