        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkconnectivity.googleapis.com/v1/{}/serviceConnectionMaps",
                    var_parent,
                );
    ...
    async fn get_service_connection_map(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//networkconnectivity.googleapis.com/v1/{}", var_name,);
    ...
    async fn list_service_connection_policies(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkconnectivity.googleapis.com/v1/{}/serviceConnectionPolicies",
                    var_parent,
                );
    ...
    async fn list_service_classes(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkconnectivity.googleapis.com/v1/{}/serviceClasses",
                    var_parent,
                );
    ...
    async fn list_service_connection_tokens(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkconnectivity.googleapis.com/v1/{}/serviceConnectionTokens",
                    var_parent,
                );
    ...
    async fn set_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//networkconnectivity.googleapis.com/v1/{}", var_resource,);
...
impl super::stub::DataTransferService for DataTransferService {
    async fn list_multicloud_data_transfer_configs(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkconnectivity.googleapis.com/v1/{}/multicloudDataTransferConfigs",
                    var_parent,
                );
    ...
    async fn list_destinations(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkconnectivity.googleapis.com/v1/{}/destinations",
                    var_parent,
                );
    ...
    ) -> Result<crate::Response<crate::model::ListMulticloudDataTransferSupportedServicesResponse>>
    {
        ...
        let (builder, method, resource_name) = None
        .or_else(|| {
            let var_parent = try_match(Some(&req).map(|m| &m.parent).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard])?;
            let path = format!(
            ...
            let resource_name = format!(
                "//networkconnectivity.googleapis.com/v1/{}/multicloudDataTransferSupportedServices",
                var_parent,
            );
    ...
    async fn list_hubs(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkconnectivity.googleapis.com/v1/{}/hubs",
                    var_parent,
                );
    ...
    async fn list_spokes(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkconnectivity.googleapis.com/v1/{}/spokes",
                    var_parent,
                );
    ...
    async fn list_routes(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkconnectivity.googleapis.com/v1/{}/routes",
                    var_parent,
                );
    ...
    async fn list_route_tables(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkconnectivity.googleapis.com/v1/{}/routeTables",
                    var_parent,
                );
    ...
    async fn list_groups(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkconnectivity.googleapis.com/v1/{}/groups",
                    var_parent,
                );
    ...
    async fn list_internal_ranges(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkconnectivity.googleapis.com/v1/{}/internalRanges",
                    var_parent,
                );
    ...
    async fn list_policy_based_routes(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//networkconnectivity.googleapis.com/v1/{}/policyBasedRoutes",
                    var_parent,
                );
