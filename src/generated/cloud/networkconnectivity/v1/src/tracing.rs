...
/// Implements a [HubService](crate::stubs::HubService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct HubService<T>
where
    T: crate::stubs::HubService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::HubService for HubService<T>
where
    T: crate::stubs::HubService + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [PolicyBasedRoutingService](crate::stubs::PolicyBasedRoutingService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct PolicyBasedRoutingService<T>
where
    T: crate::stubs::PolicyBasedRoutingService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::PolicyBasedRoutingService for PolicyBasedRoutingService<T>
where
    T: crate::stubs::PolicyBasedRoutingService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
