...
/// Implements a [EssentialContactsService](crate::stubs::EssentialContactsService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct EssentialContactsService<T>
where
    T: crate::stubs::EssentialContactsService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::EssentialContactsService for EssentialContactsService<T>
where
    T: crate::stubs::EssentialContactsService + std::fmt::Debug + Send + Sync,
{
