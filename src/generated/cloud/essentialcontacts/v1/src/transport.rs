...
impl super::stub::EssentialContactsService for EssentialContactsService {
    ...
    async fn compute_contacts(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.essentialcontacts.v1.EssentialContactsService/ComputeContacts")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name)
            );
        }
    ...
    async fn send_test_message(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.essentialcontacts.v1.EssentialContactsService/SendTestMessage")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name)
            );
        }
