...
/// Implements a [OrgPolicy](crate::stubs::OrgPolicy) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct OrgPolicy<T>
where
    T: crate::stubs::OrgPolicy + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::OrgPolicy for OrgPolicy<T>
where
    T: crate::stubs::OrgPolicy + std::fmt::Debug + Send + Sync,
{
