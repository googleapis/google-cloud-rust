    ...
    async fn create_channel(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//livestream.googleapis.com/v1/{}/channels", var_parent,);
    ...
    async fn get_channel(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//livestream.googleapis.com/v1/{}", var_name,);
    ...
    async fn create_input(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//livestream.googleapis.com/v1/{}/inputs", var_parent,);
    ...
    async fn create_event(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//livestream.googleapis.com/v1/{}/events", var_parent,);
    ...
    async fn list_clips(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//livestream.googleapis.com/v1/{}/clips", var_parent,);
    ...
    async fn create_dvr_session(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//livestream.googleapis.com/v1/{}/dvrSessions", var_parent,);
    ...
    async fn create_asset(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//livestream.googleapis.com/v1/{}/assets", var_parent,);
