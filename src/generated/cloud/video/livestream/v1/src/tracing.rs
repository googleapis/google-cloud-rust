...
/// Implements a [LivestreamService](super::stubs::LivestreamService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct LivestreamService<T>
where
    T: super::stubs::LivestreamService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::LivestreamService for LivestreamService<T>
where
    T: super::stubs::LivestreamService + std::fmt::Debug + Send + Sync,
{
