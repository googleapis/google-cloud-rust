...
impl Manifest {
    ...
    pub fn maybe_segment_keep_duration<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<wkt::Duration>,
    {
...
impl Input {
    ...
    pub fn maybe_security_rules<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<crate::model::input::SecurityRule>,
    {
    ...
    pub fn maybe_input_stream_property<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<crate::model::InputStreamProperty>,
    {
...
impl Channel {
    ...
    pub fn maybe_streaming_error<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<rpc::model::Status>,
    {
    ...
    pub fn maybe_log_config<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<crate::model::LogConfig>,
    {
    ...
    pub fn maybe_timecode_config<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<crate::model::TimecodeConfig>,
    {
    ...
    pub fn maybe_retention_config<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<crate::model::RetentionConfig>,
    {
...
impl RetentionConfig {
    ...
    pub fn maybe_retention_window_duration<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<wkt::Duration>,
    {
...
impl InputStreamProperty {
    ...
    pub fn maybe_last_establish_time<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<wkt::Timestamp>,
    {
...
impl VideoStreamProperty {
    ...
    pub fn maybe_video_format<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<crate::model::VideoFormat>,
    {
...
impl AudioStreamProperty {
    ...
    pub fn maybe_audio_format<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<crate::model::AudioFormat>,
    {
...
impl InputAttachment {
    ...
    pub fn maybe_automatic_failover<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<crate::model::input_attachment::AutomaticFailover>,
    {
...
pub mod clip {
    ...
    impl TimeSlice {
        ...
        pub fn maybe_markin_time<T>(mut self, v: std::option::Option<T>) -> Self
        where
            T: std::convert::Into<wkt::Timestamp>,
        {
        ...
        pub fn maybe_markout_time<T>(mut self, v: std::option::Option<T>) -> Self
        where
            T: std::convert::Into<wkt::Timestamp>,
        {
