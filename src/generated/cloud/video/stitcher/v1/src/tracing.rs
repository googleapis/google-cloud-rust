...
/// Implements a [VideoStitcherService](crate::stubs::VideoStitcherService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct VideoStitcherService<T>
where
    T: crate::stubs::VideoStitcherService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::VideoStitcherService for VideoStitcherService<T>
where
    T: crate::stubs::VideoStitcherService + std::fmt::Debug + Send + Sync,
{
