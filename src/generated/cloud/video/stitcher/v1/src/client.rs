...
/// [with_credentials()]: super::builder::video_stitcher_service::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `VideoStitcherService` in
...
impl VideoStitcherService {
    ...
    pub fn builder() -> super::builder::video_stitcher_service::ClientBuilder {
        crate::new_client_builder(super::builder::video_stitcher_service::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::VideoStitcherService>>
    {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::VideoStitcherService> {
