    ...
    async fn create_cdn_key(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//videostitcher.googleapis.com/v1/{}/cdnKeys", var_parent,);
    ...
    async fn get_cdn_key(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//videostitcher.googleapis.com/v1/{}", var_name,);
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//videostitcher.googleapis.com/v1/{}/vodSessions",
                    var_parent,
                );
    ...
    async fn list_vod_stitch_details(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//videostitcher.googleapis.com/v1/{}/vodStitchDetails",
                    var_parent,
                );
    ...
    async fn list_vod_ad_tag_details(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//videostitcher.googleapis.com/v1/{}/vodAdTagDetails",
                    var_parent,
                );
    ...
    async fn list_live_ad_tag_details(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//videostitcher.googleapis.com/v1/{}/liveAdTagDetails",
                    var_parent,
                );
    ...
    async fn create_slate(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//videostitcher.googleapis.com/v1/{}/slates", var_parent,);
    ...
    async fn create_live_session(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//videostitcher.googleapis.com/v1/{}/liveSessions",
                    var_parent,
                );
    ...
    async fn create_live_config(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//videostitcher.googleapis.com/v1/{}/liveConfigs",
                    var_parent,
                );
    ...
    async fn create_vod_config(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//videostitcher.googleapis.com/v1/{}/vodConfigs",
                    var_parent,
                );
