...
/// Implements a [TranscoderService](crate::stubs::TranscoderService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct TranscoderService<T>
where
    T: crate::stubs::TranscoderService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::TranscoderService for TranscoderService<T>
where
    T: crate::stubs::TranscoderService + std::fmt::Debug + Send + Sync,
{
