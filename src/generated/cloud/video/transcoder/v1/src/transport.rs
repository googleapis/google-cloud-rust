    ...
    async fn create_job(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//transcoder.googleapis.com/v1/{}/jobs", var_parent,);
    ...
    async fn get_job(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//transcoder.googleapis.com/v1/{}", var_name,);
    ...
    async fn create_job_template(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//transcoder.googleapis.com/v1/{}/jobTemplates", var_parent,);
