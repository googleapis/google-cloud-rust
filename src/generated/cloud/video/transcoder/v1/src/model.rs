...
impl Job {
    ...
    /// # use google_cloud_video_transcoder_v1::model::Job;
    /// use google_cloud_video_transcoder_v1::model::job;
    /// let x = Job::new().set_job_config(Some(job::JobConfig::TemplateId("example".to_string())));
    /// ```
...
impl ElementaryStream {
    ...
    /// ```
    /// # use google_cloud_video_transcoder_v1::model::ElementaryStream;
    /// use google_cloud_video_transcoder_v1::model::elementary_stream;
    /// use google_cloud_video_transcoder_v1::model::VideoStream;
    /// let x = ElementaryStream::new().set_elementary_stream(Some(elementary_stream::ElementaryStream::VideoStream(VideoStream::default().into())));
    /// ```
...
impl MuxStream {
    ...
    /// ```
    /// # use google_cloud_video_transcoder_v1::model::MuxStream;
    /// use google_cloud_video_transcoder_v1::model::mux_stream;
    /// use google_cloud_video_transcoder_v1::model::mux_stream::Fmp4Config;
    /// let x = MuxStream::new().set_container_config(Some(mux_stream::ContainerConfig::Fmp4(Fmp4Config::default().into())));
    /// ```
...
impl Manifest {
    ...
    /// let x = Manifest::new().set_manifest_config(Some(manifest::ManifestConfig::Dash(DashConfig::default().into())));
    /// ```
...
impl SpriteSheet {
    ...
    /// ```
    /// # use google_cloud_video_transcoder_v1::model::SpriteSheet;
    /// use google_cloud_video_transcoder_v1::model::sprite_sheet;
    /// let x = SpriteSheet::new().set_extraction_strategy(Some(sprite_sheet::ExtractionStrategy::TotalCount(42)));
    /// ```
...
pub mod overlay {
    ...
    impl Animation {
        ...
        /// use google_cloud_video_transcoder_v1::model::overlay::animation;
        /// use google_cloud_video_transcoder_v1::model::overlay::AnimationStatic;
        /// let x = Animation::new().set_animation_type(Some(overlay::animation::AnimationType::AnimationStatic(AnimationStatic::default().into())));
        /// ```
...
pub mod preprocessing_config {
    ...
    impl Deinterlace {
        ...
        /// let x = Deinterlace::new().set_deinterlacing_filter(Some(preprocessing_config::deinterlace::DeinterlacingFilter::Yadif(YadifConfig::default().into())));
        /// ```
...
impl VideoStream {
    ...
    /// ```
    /// # use google_cloud_video_transcoder_v1::model::VideoStream;
    /// use google_cloud_video_transcoder_v1::model::video_stream;
    /// use google_cloud_video_transcoder_v1::model::video_stream::H264CodecSettings;
    /// let x = VideoStream::new().set_codec_settings(Some(video_stream::CodecSettings::H264(H264CodecSettings::default().into())));
    /// ```
...
pub mod video_stream {
    ...
    impl H264CodecSettings {
        ...
        /// ```
        /// # use google_cloud_video_transcoder_v1::model::video_stream::H264CodecSettings;
        /// use google_cloud_video_transcoder_v1::model::video_stream::h_264_codec_settings;
        /// let x = H264CodecSettings::new().set_gop_mode(Some(video_stream::h_264_codec_settings::GopMode::GopFrameCount(42)));
        /// ```
        pub fn set_gop_mode<
            T: std::convert::Into<
                    std::option::Option<crate::model::video_stream::h_264_codec_settings::GopMode>,
        ...
        /// let x = H264CodecSettings::new().set_color_format(Some(video_stream::h_264_codec_settings::ColorFormat::Sdr(H264ColorFormatSDR::default().into())));
        /// ```
    ...
    impl H265CodecSettings {
        ...
        /// ```
        /// # use google_cloud_video_transcoder_v1::model::video_stream::H265CodecSettings;
        /// use google_cloud_video_transcoder_v1::model::video_stream::h_265_codec_settings;
        /// let x = H265CodecSettings::new().set_gop_mode(Some(video_stream::h_265_codec_settings::GopMode::GopFrameCount(42)));
        /// ```
        pub fn set_gop_mode<
            T: std::convert::Into<
                    std::option::Option<crate::model::video_stream::h_265_codec_settings::GopMode>,
        ...
        /// let x = H265CodecSettings::new().set_color_format(Some(video_stream::h_265_codec_settings::ColorFormat::Sdr(H265ColorFormatSDR::default().into())));
        /// ```
        pub fn set_color_format<
            T: std::convert::Into<
                    std::option::Option<
    ...
    impl Vp9CodecSettings {
        ...
        /// ```
        /// # use google_cloud_video_transcoder_v1::model::video_stream::Vp9CodecSettings;
        /// use google_cloud_video_transcoder_v1::model::video_stream::vp_9_codec_settings;
        /// let x = Vp9CodecSettings::new().set_gop_mode(Some(video_stream::vp_9_codec_settings::GopMode::GopFrameCount(42)));
        /// ```
        pub fn set_gop_mode<
            T: std::convert::Into<
        ...
        /// let x = Vp9CodecSettings::new().set_color_format(Some(video_stream::vp_9_codec_settings::ColorFormat::Sdr(Vp9ColorFormatSDR::default().into())));
        /// ```
        pub fn set_color_format<
            T: std::convert::Into<
                    std::option::Option<
...
impl Encryption {
    ...
    /// let x = Encryption::new().set_encryption_mode(Some(encryption::EncryptionMode::Aes128(Aes128Encryption::default().into())));
    /// ```
    ...
    /// let x = Encryption::new().set_secret_source(Some(encryption::SecretSource::SecretManagerKeySource(SecretManagerSource::default().into())));
    /// ```
