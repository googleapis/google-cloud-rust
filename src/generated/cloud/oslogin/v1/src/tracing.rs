...
/// Implements a [OsLoginService](crate::stubs::OsLoginService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct OsLoginService<T>
where
    T: crate::stubs::OsLoginService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::OsLoginService for OsLoginService<T>
where
    T: crate::stubs::OsLoginService + std::fmt::Debug + Send + Sync,
{
