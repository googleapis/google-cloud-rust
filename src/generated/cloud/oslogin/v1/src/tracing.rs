...
/// Implements a [OsLoginService](super::stubs::OsLoginService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct OsLoginService<T>
where
    T: super::stubs::OsLoginService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::OsLoginService for OsLoginService<T>
where
    T: super::stubs::OsLoginService + std::fmt::Debug + Send + Sync,
{
