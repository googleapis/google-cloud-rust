    ...
    async fn create_ssh_public_key(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//oslogin.googleapis.com/v1/{}/sshPublicKeys", var_parent,);
    ...
    async fn delete_posix_account(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//oslogin.googleapis.com/v1/{}", var_name,);
    ...
    async fn get_login_profile(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//oslogin.googleapis.com/v1/{}/loginProfile", var_name,);
    ...
    async fn import_ssh_public_key(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//oslogin.googleapis.com/v1/{}", var_parent,);
