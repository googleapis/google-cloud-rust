...
/// [with_credentials()]: super::builder::cloud_tasks::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `CloudTasks` in
...
impl CloudTasks {
    ...
    pub fn builder() -> super::builder::cloud_tasks::ClientBuilder {
        crate::new_client_builder(super::builder::cloud_tasks::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::CloudTasks>> {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::CloudTasks> {
    ...
    ///    client: &CloudTasks
    /// ) -> Result<()> {
    ///     let response = client.purge_queue()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &CloudTasks
    /// ) -> Result<()> {
    ///     let response = client.pause_queue()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &CloudTasks
    /// ) -> Result<()> {
    ///     let response = client.resume_queue()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
