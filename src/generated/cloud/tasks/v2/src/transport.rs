    ...
    async fn list_queues(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//cloudtasks.googleapis.com/v2/{}/queues", var_parent,);
    ...
    async fn get_queue(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//cloudtasks.googleapis.com/v2/{}", var_name,);
    ...
    async fn get_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//cloudtasks.googleapis.com/v2/{}", var_resource,);
    ...
    async fn list_tasks(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//cloudtasks.googleapis.com/v2/{}/tasks", var_parent,);
