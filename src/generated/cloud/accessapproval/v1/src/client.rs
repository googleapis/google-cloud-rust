...
/// [with_credentials()]: super::builder::access_approval::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `AccessApproval` in
...
impl AccessApproval {
    ...
    pub fn builder() -> super::builder::access_approval::ClientBuilder {
        crate::new_client_builder(super::builder::access_approval::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::AccessApproval>> {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::AccessApproval> {
