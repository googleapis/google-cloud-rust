...
/// Implements a [AccessApproval](super::stubs::AccessApproval) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AccessApproval<T>
where
    T: super::stubs::AccessApproval + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::AccessApproval for AccessApproval<T>
where
    T: super::stubs::AccessApproval + std::fmt::Debug + Send + Sync,
{
