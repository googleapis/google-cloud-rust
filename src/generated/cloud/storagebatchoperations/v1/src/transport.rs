        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//storagebatchoperations.googleapis.com/v1/{}/jobs",
                    var_parent,
                );
    ...
    async fn get_job(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//storagebatchoperations.googleapis.com/v1/{}", var_name,);
    ...
    async fn list_bucket_operations(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//storagebatchoperations.googleapis.com/v1/{}/bucketOperations",
                    var_parent,
                );
