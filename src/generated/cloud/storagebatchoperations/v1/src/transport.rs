...
impl super::stub::StorageBatchOperations for StorageBatchOperations {
    async fn list_jobs(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//storagebatchoperations.googleapis.com/{}", var_parent,);
    ...
    async fn list_bucket_operations(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}/bucketOperations", var_parent,);
                let path_template = "/v1/{parent}/bucketOperations";
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.storagebatchoperations.v1.StorageBatchOperations/ListBucketOperations")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name)
            );
        }
    ...
    async fn get_bucket_operation(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.storagebatchoperations.v1.StorageBatchOperations/GetBucketOperation")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name)
            );
        }
