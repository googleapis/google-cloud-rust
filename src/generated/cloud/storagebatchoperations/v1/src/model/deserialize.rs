                ...
                while let Some(tag) = map.next_key::<__FieldTag>()? {
                    ...
                    match tag {
                        __FieldTag::__retain_until_time => {
                            ...
                            result.retain_until_time = map.next_value::<std::option::Option<std::string::String>>()?
                                ;
                        },
                        __FieldTag::__retention_mode => {
                            ...
                            result.retention_mode = map.next_value::<std::option::Option<crate::model::object_retention::RetentionMode>>()?
                                ;
                        },
                        __FieldTag::Unknown(key) => {
                            let value = map.next_value::<serde_json::Value>()?;
                ...
                while let Some(tag) = map.next_key::<__FieldTag>()? {
                    ...
                    match tag {
                        ...
                        __FieldTag::__object_retention => {
                            ...
                            result.object_retention = map.next_value::<std::option::Option<crate::model::ObjectRetention>>()?
                                ;
                        },
                        __FieldTag::Unknown(key) => {
                            let value = map.next_value::<serde_json::Value>()?;
                    ...
                    match tag {
                        ...
                        __FieldTag::__total_bytes_found => {
                            if !fields.insert(__FieldTag::__total_bytes_found) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for total_bytes_found"));
                            }
                            struct __With( std::option::Option<i64> );
                            impl<'de> serde::de::Deserialize<'de> for __With {
                                fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
