...
/// Request and client builders for [CloudLocationFinder][crate::client::CloudLocationFinder].
pub mod cloud_location_finder {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListCloudLocations {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetCloudLocation {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for SearchCloudLocations {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
