...
impl Justification {
    ...
    /// ```
    /// # use google_cloud_privilegedaccessmanager_v1::model::Justification;
    /// use google_cloud_privilegedaccessmanager_v1::model::justification::Justification;
    /// let x = Justification::new().set_justification(Some(Justification::UnstructuredJustification("example".to_string())));
    /// ```
