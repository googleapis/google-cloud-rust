...
/// Request and client builders for [PrivilegedAccessManager][crate::client::PrivilegedAccessManager].
pub mod privileged_access_manager {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CheckOnboardingStatus {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for SearchEntitlements {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetEntitlement {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateEntitlement {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Entitlement, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_privilegedaccessmanager_v1::client::PrivilegedAccessManager::create_entitlement::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateEntitlement {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteEntitlement {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Entitlement, crate::model::OperationMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_privilegedaccessmanager_v1::client::PrivilegedAccessManager::delete_entitlement::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteEntitlement {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UpdateEntitlement {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Entitlement, crate::model::OperationMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_privilegedaccessmanager_v1::client::PrivilegedAccessManager::update_entitlement::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateEntitlement {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ListGrants {
        ...
        pub fn by_page(
            self,
        ) -> impl google_cloud_gax::paginator::Paginator<crate::model::ListGrantsResponse, crate::Error>
        {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
            let execute = move |token: String| {
        ...
        pub fn by_item(
            ...
            crate::model::ListGrantsResponse,
            crate::Error,
        > {
            use google_cloud_gax::paginator::Paginator;
            self.by_page().items()
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListGrants {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl SearchGrants {
        ...
        pub fn by_page(
            self,
        ) -> impl google_cloud_gax::paginator::Paginator<crate::model::SearchGrantsResponse, crate::Error>
        {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
            let execute = move |token: String| {
        ...
        pub fn by_item(
            ...
            crate::model::SearchGrantsResponse,
            crate::Error,
        > {
            use google_cloud_gax::paginator::Paginator;
            self.by_page().items()
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for SearchGrants {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetGrant {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateGrant {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ApproveGrant {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DenyGrant {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl RevokeGrant {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Grant, crate::model::OperationMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_privilegedaccessmanager_v1::client::PrivilegedAccessManager::revoke_grant::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for RevokeGrant {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
