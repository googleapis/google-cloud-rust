...
/// [with_credentials()]: super::builder::privileged_access_manager::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `PrivilegedAccessManager` in
...
impl PrivilegedAccessManager {
    ...
    pub fn builder() -> super::builder::privileged_access_manager::ClientBuilder {
        crate::new_client_builder(super::builder::privileged_access_manager::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::PrivilegedAccessManager>>
    {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::PrivilegedAccessManager> {
    ...
    /// ) -> Result<()> {
    ///     let response = client.check_onboarding_status()
    ///         /* set fields */
    ///         .send().await?;
    ...
    ///    client: &PrivilegedAccessManager
    /// ) -> Result<()> {
    ///     let mut list = client.search_entitlements()
    ///         /* set fields */
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &PrivilegedAccessManager
    /// ) -> Result<()> {
    ///     let mut list = client.search_grants()
    ///         /* set fields */
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &PrivilegedAccessManager
    /// ) -> Result<()> {
    ///     let response = client.approve_grant()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &PrivilegedAccessManager
    /// ) -> Result<()> {
    ///     let response = client.deny_grant()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &PrivilegedAccessManager
    /// ) -> Result<()> {
    ///     let response = client.revoke_grant()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
