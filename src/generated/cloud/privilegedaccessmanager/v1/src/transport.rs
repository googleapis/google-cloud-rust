    ...
    async fn check_onboarding_status(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}:checkOnboardingStatus";
    ...
    async fn search_entitlements(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/entitlements:search";
    ...
    async fn update_entitlement(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{entitlement.name}";

                let resource_name = format!(
                    "//privilegedaccessmanager.googleapis.com/{}",
                    var_entitlement_name,
                );
    ...
    async fn list_grants(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/grants";
    ...
    async fn search_grants(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/grants:search";
    ...
    async fn deny_grant(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:deny";
