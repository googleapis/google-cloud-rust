...
/// Implements a [PrivilegedAccessManager](super::stubs::PrivilegedAccessManager) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct PrivilegedAccessManager<T>
where
    T: super::stubs::PrivilegedAccessManager + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::PrivilegedAccessManager for PrivilegedAccessManager<T>
where
    T: super::stubs::PrivilegedAccessManager + std::fmt::Debug + Send + Sync,
{
