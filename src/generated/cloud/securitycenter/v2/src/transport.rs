    ...
    async fn batch_create_resource_value_configs(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/resourceValueConfigs:batchCreate";
    ...
    async fn bulk_mute_findings(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/findings:bulkMute";
    ...
    async fn create_big_query_export(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/bigQueryExports";
    ...
    async fn create_finding(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/findings";
    ...
    async fn create_mute_config(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/muteConfigs";
    ...
    async fn create_notification_config(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/notificationConfigs";
    ...
    async fn create_source(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/sources";
    ...
    async fn group_findings(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/findings:group";
    ...
    async fn list_attack_paths(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/attackPaths";
    ...
    async fn list_resource_value_configs(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/resourceValueConfigs";
    ...
    async fn list_valued_resources(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/valuedResources";
    ...
    async fn set_finding_state(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{name}:setState";
    ...
    async fn set_mute(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{name}:setMute";
    ...
    async fn update_big_query_export(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{big_query_export.name}";

                let resource_name = format!(
                    "//securitycenter.googleapis.com/{}",
                    var_big_query_export_name,
                );
    ...
    async fn update_external_system(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{external_system.name}";

                let resource_name = format!(
                    "//securitycenter.googleapis.com/{}",
                    var_external_system_name,
                );
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
    ...
    async fn update_finding(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{finding.name}";

                let resource_name =
                    format!("//securitycenter.googleapis.com/{}", var_finding_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn update_mute_config(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{mute_config.name}";

                let resource_name =
                    format!("//securitycenter.googleapis.com/{}", var_mute_config_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn update_notification_config(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{notification_config.name}";

                let resource_name = format!(
                    "//securitycenter.googleapis.com/{}",
                    var_notification_config_name,
                );
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
    ...
    async fn update_resource_value_config(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{resource_value_config.name}";

                let resource_name = format!(
                    "//securitycenter.googleapis.com/{}",
                    var_resource_value_config_name,
                );
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
    ...
    async fn update_security_marks(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{security_marks.name}";

                let resource_name = format!(
                    "//securitycenter.googleapis.com/{}",
                    var_security_marks_name,
                );
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
    ...
    async fn update_source(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{source.name}";

                let resource_name = format!("//securitycenter.googleapis.com/{}", var_source_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn cancel_operation(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{name}:cancel";
