        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//securitycenter.googleapis.com/v2/{}/resourceValueConfigs",
                    var_parent,
                );
    ...
    async fn bulk_mute_findings(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//securitycenter.googleapis.com/v2/{}/findings", var_parent,);
    ...
    async fn create_big_query_export(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//securitycenter.googleapis.com/v2/{}/bigQueryExports",
                    var_parent,
                );
    ...
    async fn create_mute_config(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//securitycenter.googleapis.com/v2/{}/muteConfigs",
                    var_parent,
                );
    ...
    async fn create_notification_config(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//securitycenter.googleapis.com/v2/{}/notificationConfigs",
                    var_parent,
                );
    ...
    async fn create_source(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//securitycenter.googleapis.com/v2/{}/sources", var_parent,);
    ...
    async fn delete_big_query_export(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//securitycenter.googleapis.com/v2/{}", var_name,);
    ...
    async fn get_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//securitycenter.googleapis.com/v2/{}", var_resource,);
    ...
    async fn list_attack_paths(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//securitycenter.googleapis.com/v2/{}/attackPaths",
                    var_parent,
                );
    ...
    async fn list_valued_resources(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//securitycenter.googleapis.com/v2/{}/valuedResources",
                    var_parent,
                );
