...
/// Implements a [SecurityCenter](crate::stubs::SecurityCenter) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SecurityCenter<T>
where
    T: crate::stubs::SecurityCenter + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::SecurityCenter for SecurityCenter<T>
where
    T: crate::stubs::SecurityCenter + std::fmt::Debug + Send + Sync,
{
