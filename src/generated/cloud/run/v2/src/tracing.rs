...
/// Implements a [Builds](crate::stubs::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Builds<T>
where
    T: crate::stubs::Builds + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::Builds for Builds<T>
where
    T: crate::stubs::Builds + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [Executions](crate::stubs::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Executions<T>
where
    T: crate::stubs::Executions + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::Executions for Executions<T>
where
    T: crate::stubs::Executions + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Jobs](crate::stubs::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Jobs<T>
where
    T: crate::stubs::Jobs + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::Jobs for Jobs<T>
where
    T: crate::stubs::Jobs + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Revisions](crate::stubs::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Revisions<T>
where
    T: crate::stubs::Revisions + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::Revisions for Revisions<T>
where
    T: crate::stubs::Revisions + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Services](crate::stubs::) decorator for logging and tracing.
#[derive(Clone, Debug)]
...
/// Implements a [Tasks](crate::stubs::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Tasks<T>
where
    T: crate::stubs::Tasks + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::Tasks for Tasks<T>
where
    T: crate::stubs::Tasks + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
