...
/// Implements a [Builds](crate::stubs::Builds) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Builds<T>
where
...
/// Implements a [Executions](crate::stubs::Executions) decorator for logging and tracing.
#[derive(Clone, Debug)]
...
/// Implements a [Jobs](crate::stubs::Jobs) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Jobs<T>
where
...
/// Implements a [Revisions](crate::stubs::Revisions) decorator for logging and tracing.
#[derive(Clone, Debug)]
...
/// Implements a [Tasks](crate::stubs::Tasks) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Tasks<T>
where
