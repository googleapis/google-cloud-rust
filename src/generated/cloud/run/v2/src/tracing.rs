...
/// Implements a [Builds](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Builds<T>
where
    T: crate::traits::Builds + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::Builds for Builds<T>
where
    T: crate::traits::Builds + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [Executions](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Executions<T>
where
    T: crate::traits::Executions + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::Executions for Executions<T>
where
    T: crate::traits::Executions + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Jobs](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Jobs<T>
where
    T: crate::traits::Jobs + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::Jobs for Jobs<T>
where
    T: crate::traits::Jobs + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Revisions](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Revisions<T>
where
    T: crate::traits::Revisions + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::Revisions for Revisions<T>
where
    T: crate::traits::Revisions + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Services](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Services<T>
where
    T: crate::traits::Services + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::Services for Services<T>
where
    T: crate::traits::Services + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Tasks](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Tasks<T>
where
    T: crate::traits::Tasks + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::Tasks for Tasks<T>
where
    T: crate::traits::Tasks + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
