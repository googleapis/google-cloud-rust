...
impl SubmitBuildRequest {
    ...
    /// ```
    /// # use google_cloud_run_v2::model::SubmitBuildRequest;
    /// use google_cloud_run_v2::model::submit_build_request;
    /// use google_cloud_run_v2::model::StorageSource;
    /// let x = SubmitBuildRequest::new().set_source(Some(submit_build_request::Source::StorageSource(StorageSource::default().into())));
    /// ```
    pub fn set_source<
    ...
    /// let x = SubmitBuildRequest::new().set_build_type(Some(submit_build_request::BuildType::BuildpackBuild(BuildpacksBuild::default().into())));
    /// ```
...
impl Condition {
    ...
    /// let x0 = Condition::new().set_reasons(Some(condition::Reasons::Reason(CommonReason::Unknown)));
    /// let x1 = Condition::new().set_reasons(Some(condition::Reasons::Reason(CommonReason::RevisionFailed)));
    /// let x2 = Condition::new().set_reasons(Some(condition::Reasons::Reason(CommonReason::ProgressDeadlineExceeded)));
    /// ```
    pub fn set_reasons<
    ...
    /// assert!(x.reason().is_some());
    /// assert!(x.revision_reason().is_none());
    /// assert!(x.execution_reason().is_none());
    /// ```
    ...
    /// assert!(x.revision_reason().is_some());
    /// assert!(x.reason().is_none());
    /// assert!(x.execution_reason().is_none());
    /// ```
    ...
    /// assert!(x.execution_reason().is_some());
    /// assert!(x.reason().is_none());
    /// assert!(x.revision_reason().is_none());
    /// ```
...
impl Job {
    ...
    /// # use google_cloud_run_v2::model::Job;
    /// use google_cloud_run_v2::model::job;
    /// let x = Job::new().set_create_execution(Some(job::CreateExecution::StartExecutionToken("example".to_string())));
    /// ```
...
impl EnvVar {
    ...
    /// ```
    /// # use google_cloud_run_v2::model::EnvVar;
    /// use google_cloud_run_v2::model::env_var;
    /// let x = EnvVar::new().set_values(Some(env_var::Values::Value("example".to_string())));
    /// ```
...
impl Volume {
    ...
    /// let x = Volume::new().set_volume_type(Some(volume::VolumeType::Secret(SecretVolumeSource::default().into())));
    /// ```
...
impl Probe {
    ...
    /// let x = Probe::new().set_probe_type(Some(probe::ProbeType::HttpGet(HTTPGetAction::default().into())));
    /// ```
...
impl TaskTemplate {
    ...
    /// ```
    /// # use google_cloud_run_v2::model::TaskTemplate;
    /// use google_cloud_run_v2::model::task_template;
    /// let x = TaskTemplate::new().set_retries(Some(task_template::Retries::MaxRetries(42)));
    /// ```
    pub fn set_retries<
...
impl BinaryAuthorization {
    ...
    /// ```
    /// # use google_cloud_run_v2::model::BinaryAuthorization;
    /// use google_cloud_run_v2::model::binary_authorization;
    /// let x = BinaryAuthorization::new().set_binauthz_method(Some(binary_authorization::BinauthzMethod::UseDefault(true)));
    /// ```
