    ...
    async fn get_execution(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//run.googleapis.com/v2/{}", var_name,);
    ...
    async fn list_executions(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//run.googleapis.com/v2/{}/executions", var_parent,);
    ...
    async fn create_instance(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//run.googleapis.com/v2/{}/instances", var_parent,);
    ...
    async fn create_job(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//run.googleapis.com/v2/{}/jobs", var_parent,);
    ...
    async fn get_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//run.googleapis.com/v2/{}", var_resource,);
    ...
    async fn list_revisions(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//run.googleapis.com/v2/{}/revisions", var_parent,);
    ...
    async fn create_service(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//run.googleapis.com/v2/{}/services", var_parent,);
    ...
    async fn list_tasks(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//run.googleapis.com/v2/{}/tasks", var_parent,);
    ...
    async fn create_worker_pool(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//run.googleapis.com/v2/{}/workerPools", var_parent,);
