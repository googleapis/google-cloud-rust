    ...
    async fn submit_build(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/builds:submit";
    ...
    async fn wait_operation(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{name}:wait";
    ...
    async fn list_executions(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/executions";
    ...
    async fn create_job(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/jobs";
    ...
    async fn update_job(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{job.name}";

                let resource_name = format!("//run.googleapis.com/{}", var_job_name,);
    ...
    async fn list_revisions(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/revisions";
    ...
    async fn create_service(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/services";
    ...
    async fn update_service(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{service.name}";

                let resource_name = format!("//run.googleapis.com/{}", var_service_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn create_worker_pool(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/workerPools";
    ...
    async fn update_worker_pool(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{worker_pool.name}";

                let resource_name = format!("//run.googleapis.com/{}", var_worker_pool_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
