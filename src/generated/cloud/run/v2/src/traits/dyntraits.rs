...
/// All implementations of [crate::traits::Builds] also implement [Builds].
#[async_trait::async_trait]
impl<T: crate::traits::Builds> Builds for T {
...
/// All implementations of [crate::traits::Executions] also implement [Executions].
#[async_trait::async_trait]
impl<T: crate::traits::Executions> Executions for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn get_execution(
        &self,
        req: crate::model::GetExecutionRequest,
...
/// All implementations of [crate::traits::Jobs] also implement [Jobs].
#[async_trait::async_trait]
impl<T: crate::traits::Jobs> Jobs for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn create_job(
        &self,
        req: crate::model::CreateJobRequest,
...
/// All implementations of [crate::traits::Revisions] also implement [Revisions].
#[async_trait::async_trait]
impl<T: crate::traits::Revisions> Revisions for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn get_revision(
        &self,
        req: crate::model::GetRevisionRequest,
...
/// All implementations of [crate::traits::Services] also implement [Services].
#[async_trait::async_trait]
impl<T: crate::traits::Services> Services for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn create_service(
        &self,
        req: crate::model::CreateServiceRequest,
...
/// All implementations of [crate::traits::Tasks] also implement [Tasks].
#[async_trait::async_trait]
impl<T: crate::traits::Tasks> Tasks for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn get_task(
        &self,
        req: crate::model::GetTaskRequest,
