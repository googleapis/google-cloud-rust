        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//recaptchaenterprise.googleapis.com/v1/{}/assessments",
                    var_parent,
                );
    ...
    async fn annotate_assessment(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//recaptchaenterprise.googleapis.com/v1/{}", var_name,);
    ...
    async fn create_key(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//recaptchaenterprise.googleapis.com/v1/{}/keys",
                    var_parent,
                );
    ...
    async fn retrieve_legacy_secret_key(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//recaptchaenterprise.googleapis.com/v1/{}", var_key,);
    ...
    async fn list_ip_overrides(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//recaptchaenterprise.googleapis.com/v1/{}", var_parent,);
    ...
    async fn create_firewall_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//recaptchaenterprise.googleapis.com/v1/{}/firewallpolicies",
                    var_parent,
                );
    ...
    async fn list_related_account_groups(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//recaptchaenterprise.googleapis.com/v1/{}/relatedaccountgroups",
                    var_parent,
                );
    ...
    async fn list_related_account_group_memberships(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//recaptchaenterprise.googleapis.com/v1/{}/memberships",
                    var_parent,
                );
    ...
    async fn search_related_account_group_memberships(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//recaptchaenterprise.googleapis.com/v1/{}/relatedaccountgroupmemberships",
                    var_project,
                );
