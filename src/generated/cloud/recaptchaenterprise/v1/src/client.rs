...
/// [with_credentials()]: super::builder::recaptcha_enterprise_service::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `RecaptchaEnterpriseService` in
