...
/// Implements a [LanguageService](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct LanguageService<T>
where
    T: crate::traits::LanguageService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::LanguageService for LanguageService<T>
where
    T: crate::traits::LanguageService + std::fmt::Debug + Send + Sync,
{
