...
/// Implements a [LanguageService](super::stubs::LanguageService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct LanguageService<T>
where
    T: super::stubs::LanguageService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::LanguageService for LanguageService<T>
where
    T: super::stubs::LanguageService + std::fmt::Debug + Send + Sync,
{
