...
/// Implements a [LanguageService](crate::stubs::LanguageService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct LanguageService<T>
where
    T: crate::stubs::LanguageService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::LanguageService for LanguageService<T>
where
    T: crate::stubs::LanguageService + std::fmt::Debug + Send + Sync,
{
