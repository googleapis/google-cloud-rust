...
/// [with_credentials()]: super::builder::language_service::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `LanguageService` in
...
impl LanguageService {
    ...
    pub fn builder() -> super::builder::language_service::ClientBuilder {
        crate::new_client_builder(super::builder::language_service::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::LanguageService>> {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::LanguageService> {
    ...
    /// ```
    /// # use google_cloud_language_v2::client::LanguageService;
    /// use google_cloud_language_v2::Result;
    /// async fn sample(
    ...
    ///    client: &LanguageService
    /// ) -> Result<()> {
    ///     let response = client.analyze_entities()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &LanguageService
    /// ) -> Result<()> {
    ///     let response = client.classify_text()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &LanguageService
    /// ) -> Result<()> {
    ///     let response = client.moderate_text()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &LanguageService
    /// ) -> Result<()> {
    ///     let response = client.annotate_text()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
