...
/// Implements a [CloudMemcache](crate::stubs::CloudMemcache) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudMemcache<T>
where
    T: crate::stubs::CloudMemcache + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::CloudMemcache for CloudMemcache<T>
where
    T: crate::stubs::CloudMemcache + std::fmt::Debug + Send + Sync,
{
