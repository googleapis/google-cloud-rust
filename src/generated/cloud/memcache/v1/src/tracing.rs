...
/// Implements a [CloudMemcache](super::stubs::CloudMemcache) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudMemcache<T>
where
    T: super::stubs::CloudMemcache + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::CloudMemcache for CloudMemcache<T>
where
    T: super::stubs::CloudMemcache + std::fmt::Debug + Send + Sync,
{
