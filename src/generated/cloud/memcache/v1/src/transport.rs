    ...
    async fn list_instances(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//memcache.googleapis.com/v1/{}/instances", var_parent,);
    ...
    async fn get_instance(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//memcache.googleapis.com/v1/{}", var_name,);
    ...
    async fn reschedule_maintenance(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//memcache.googleapis.com/v1/{}", var_instance,);
