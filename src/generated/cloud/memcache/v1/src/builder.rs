...
/// Request and client builders for [CloudMemcache][crate::client::CloudMemcache].
pub mod cloud_memcache {
    ...
    impl CreateInstance {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Instance, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_memcache_v1::client::CloudMemcache::create_instance::until_done";
            }
    ...
    impl UpdateInstance {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Instance, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_memcache_v1::client::CloudMemcache::update_instance::until_done";
            }
    ...
    impl UpdateParameters {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `update_parameters`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::Instance, crate::model::OperationMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_memcache_v1::client::CloudMemcache::update_parameters::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateParameters {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteInstance {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_memcache_v1::client::CloudMemcache::delete_instance::until_done";
            }
    ...
    impl ApplyParameters {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `apply_parameters`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::Instance, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_memcache_v1::client::CloudMemcache::apply_parameters::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ApplyParameters {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl RescheduleMaintenance {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Instance, crate::model::OperationMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_memcache_v1::client::CloudMemcache::reschedule_maintenance::until_done";
            }
