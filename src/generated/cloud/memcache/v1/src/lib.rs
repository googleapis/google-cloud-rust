...
//! 
//!
//! This crate contains traits, types, and functions to interact with Cloud Memorystore for Memcached API
...
const DEFAULT_HOST: &str = "https://memcache.googleapis.com/";
