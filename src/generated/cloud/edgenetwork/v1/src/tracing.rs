...
/// Implements a [EdgeNetwork](crate::stubs::EdgeNetwork) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct EdgeNetwork<T>
where
    T: crate::stubs::EdgeNetwork + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::EdgeNetwork for EdgeNetwork<T>
where
    T: crate::stubs::EdgeNetwork + std::fmt::Debug + Send + Sync,
{
