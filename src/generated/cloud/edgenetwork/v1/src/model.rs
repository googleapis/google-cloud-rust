...
pub mod router {
    ...
    impl BgpPeer {
        ...
        /// ```
        /// # use google_cloud_edgenetwork_v1::model::router::BgpPeer;
        /// let x = BgpPeer::new().set_peer_asn(42u32);
        /// ```
        ...
        /// ```
        /// # use google_cloud_edgenetwork_v1::model::router::BgpPeer;
        /// let x = BgpPeer::new().set_local_asn(42u32);
        /// ```
    ...
    impl Bgp {
        ...
        /// ```
        /// # use google_cloud_edgenetwork_v1::model::router::Bgp;
        /// let x = Bgp::new().set_keepalive_interval_in_seconds(42u32);
        /// ```
