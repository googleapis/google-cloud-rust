...
impl EdgeNetwork {
    ...
    where T: super::stub::EdgeNetwork + 'static {
    ...
    async fn build_inner(conf: gaxi::options::ClientConfig) -> gax::client_builder::Result<std::sync::Arc<dyn super::stub::dynamic::EdgeNetwork>> {
    ...
    async fn build_transport(conf: gaxi::options::ClientConfig) -> gax::client_builder::Result<impl super::stub::EdgeNetwork> {
        super::transport::EdgeNetwork::new(conf).await
    }

    async fn build_with_tracing(conf: gaxi::options::ClientConfig) -> gax::client_builder::Result<impl super::stub::EdgeNetwork> {
        Self::build_transport(conf).await.map(super::tracing::EdgeNetwork::new)
    }
    ...
    pub fn list_interconnect_attachments(&self) -> super::builder::edge_network::ListInterconnectAttachments
    {
    ...
    /// }
    /// ```
    pub fn get_interconnect_attachment(&self) -> super::builder::edge_network::GetInterconnectAttachment
    {
    ...
    /// [user guide]: https://googleapis.github.io/google-cloud-rust/
    /// [working with long-running operations]: https://googleapis.github.io/google-cloud-rust/working_with_long_running_operations.html
    pub fn create_interconnect_attachment(&self) -> super::builder::edge_network::CreateInterconnectAttachment
    {
    ...
    /// [user guide]: https://googleapis.github.io/google-cloud-rust/
    /// [working with long-running operations]: https://googleapis.github.io/google-cloud-rust/working_with_long_running_operations.html
    pub fn delete_interconnect_attachment(&self) -> super::builder::edge_network::DeleteInterconnectAttachment
    {
