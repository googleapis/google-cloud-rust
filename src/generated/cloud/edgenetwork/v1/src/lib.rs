...
//! 
//!
//! This crate contains traits, types, and functions to interact with Distributed Cloud Edge Network API
...
const DEFAULT_HOST: &str = "https://edgenetwork.googleapis.com/";
