...
/// Implements a [CloudFilestoreManager](crate::stubs::CloudFilestoreManager) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudFilestoreManager<T>
where
    T: crate::stubs::CloudFilestoreManager + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::CloudFilestoreManager for CloudFilestoreManager<T>
where
    T: crate::stubs::CloudFilestoreManager + std::fmt::Debug + Send + Sync,
{
