...
/// [with_credentials()]: super::builder::cloud_filestore_manager::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `CloudFilestoreManager` in
...
impl CloudFilestoreManager {
    ...
    /// ) -> Result<()> {
    ///     let response = client.restore_instance()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &CloudFilestoreManager
    /// ) -> Result<()> {
    ///     let response = client.revert_instance()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
