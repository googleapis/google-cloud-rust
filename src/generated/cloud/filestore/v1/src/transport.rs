...
/// Implements [CloudFilestoreManager](crate::stubs::CloudFilestoreManager) using a [gax::http_client::ReqwestClient].
#[derive(Clone)]
...
impl crate::stubs::CloudFilestoreManager for CloudFilestoreManager {
