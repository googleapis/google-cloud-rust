...
/// Request and client builders for [AssuredWorkloadsService][crate::client::AssuredWorkloadsService].
pub mod assured_workloads_service {
    ...
    /// # async fn sample() -> google_cloud_assuredworkloads_v1::Result<()> {
    ...
    impl CreateWorkload {
        ...
        > {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_assuredworkloads_v1::client::AssuredWorkloadsService::create_workload::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateWorkload {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateWorkload {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for RestrictAllowedResources {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteWorkload {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
