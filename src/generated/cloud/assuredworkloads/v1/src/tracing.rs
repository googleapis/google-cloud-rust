...
/// Implements a [AssuredWorkloadsService](crate::stubs::AssuredWorkloadsService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AssuredWorkloadsService<T>
where
    T: crate::stubs::AssuredWorkloadsService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::AssuredWorkloadsService for AssuredWorkloadsService<T>
where
    T: crate::stubs::AssuredWorkloadsService + std::fmt::Debug + Send + Sync,
{
