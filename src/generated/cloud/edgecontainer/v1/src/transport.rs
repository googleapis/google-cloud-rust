...
impl super::stub::EdgeContainer for EdgeContainer {
    async fn list_clusters(
        ...
        let options = {
            ...
            if let Some(rn) = resource_name {
                let full_resource_name = format!("//edgecontainer.googleapis.com/{}", rn);
    ...
    async fn create_cluster(
        ...
        let options = {
            let resource_name = Option::<&String>::None
                .or(Some(&req.parent))
                                .or(req.cluster.as_ref().map(|s| &s.name))
                ;
            if let Some(rn) = resource_name {
                let full_resource_name = format!("//edgecontainer.googleapis.com/{}", rn);
                gax::options::internal::set_resource_name(options, full_resource_name)
    ...
    async fn update_cluster(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).and_then(|m| m.cluster.as_ref()).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/clusters/"), Segment::SingleWildcard])?,
            );
    ...
    async fn generate_access_token(
        ...
        .or_else(|| {
            let path = format!(
                ...
                try_match(Some(&req).map(|m| &m.cluster).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/clusters/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{cluster}:generateAccessToken";
    ...
    async fn generate_offline_credential(
        ...
        .or_else(|| {
            ...
            let path_template = "/v1/{cluster}:generateOfflineCredential";
    ...
    async fn list_node_pools(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}/nodePools",
                try_match(Some(&req).map(|m| &m.parent).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/clusters/"), Segment::SingleWildcard])?,
            );
    ...
    async fn create_node_pool(
        ...
        let options = {
            let resource_name = Option::<&String>::None
                .or(Some(&req.parent))
                                .or(req.node_pool.as_ref().map(|s| &s.name))
                ;
            if let Some(rn) = resource_name {
                let full_resource_name = format!("//edgecontainer.googleapis.com/{}", rn);
                gax::options::internal::set_resource_name(options, full_resource_name)
    ...
    async fn update_node_pool(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).and_then(|m| m.node_pool.as_ref()).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/clusters/"), Segment::SingleWildcard, Segment::Literal("/nodePools/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{node_pool.name}";
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                let builder = PathMismatchBuilder::default();
                let builder = builder.maybe_add(
                    Some(&req).and_then(|m| m.node_pool.as_ref()).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/clusters/"), Segment::SingleWildcard, Segment::Literal("/nodePools/"), Segment::SingleWildcard],
                    "node_pool.name",
                    "projects/*/locations/*/clusters/*/nodePools/*");
                paths.push(builder.build());
    ...
    async fn list_machines(
        ...
        .or_else(|| {
            ...
            let path_template = "/v1/{parent}/machines";
    ...
    async fn get_machine(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/machines/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{name}";
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                ...
                let builder = builder.maybe_add(
                    Some(&req).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/machines/"), Segment::SingleWildcard],
                    "name",
    ...
    async fn list_vpn_connections(
        ...
        .or_else(|| {
            ...
            let path_template = "/v1/{parent}/vpnConnections";
    ...
    async fn get_vpn_connection(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/vpnConnections/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{name}";
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                ...
                let builder = builder.maybe_add(
                    Some(&req).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/vpnConnections/"), Segment::SingleWildcard],
                    "name",
    ...
    async fn create_vpn_connection(
        ...
        let options = {
            let resource_name = Option::<&String>::None
                .or(Some(&req.parent))
                                .or(req.vpn_connection.as_ref().map(|s| &s.name))
                                .or(req.vpn_connection.as_ref().map(|s| &s.cluster))
                ;
            if let Some(rn) = resource_name {
                let full_resource_name = format!("//edgecontainer.googleapis.com/{}", rn);
                gax::options::internal::set_resource_name(options, full_resource_name)
