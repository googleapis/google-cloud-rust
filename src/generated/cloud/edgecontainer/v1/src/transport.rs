    ...
    async fn list_clusters(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//edgecontainer.googleapis.com/v1/{}/clusters", var_parent,);
    ...
    async fn get_cluster(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//edgecontainer.googleapis.com/v1/{}", var_name,);
    ...
    async fn update_cluster(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//edgecontainer.googleapis.com/v1/{}", var_cluster_name,);
    ...
    async fn generate_access_token(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//edgecontainer.googleapis.com/v1/{}", var_cluster,);
    ...
    async fn list_node_pools(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//edgecontainer.googleapis.com/v1/{}/nodePools", var_parent,);
    ...
    async fn update_node_pool(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//edgecontainer.googleapis.com/v1/{}", var_node_pool_name,);
    ...
    async fn list_machines(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//edgecontainer.googleapis.com/v1/{}/machines", var_parent,);
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//edgecontainer.googleapis.com/v1/{}/vpnConnections",
                    var_parent,
                );
    ...
    async fn get_server_config(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//edgecontainer.googleapis.com/v1/{}/serverConfig",
                    var_name,
                );
