    ...
    async fn upgrade_cluster(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:upgrade";
    ...
    async fn generate_access_token(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{cluster}:generateAccessToken";
    ...
    async fn generate_offline_credential(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{cluster}:generateOfflineCredential";
    ...
    async fn update_node_pool(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{node_pool.name}";
    ...
    async fn list_machines(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/machines";
    ...
    async fn list_vpn_connections(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/vpnConnections";
