...
/// Request and client builders for [EdgeContainer][crate::client::EdgeContainer].
pub mod edge_container {
    ...
    impl CreateCluster {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Cluster, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_edgecontainer_v1::client::EdgeContainer::create_cluster::until_done";
            }
    ...
    impl UpdateCluster {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Cluster, crate::model::OperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_edgecontainer_v1::client::EdgeContainer::update_cluster::until_done";
            }
    ...
    impl UpgradeCluster {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Cluster, crate::model::OperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_edgecontainer_v1::client::EdgeContainer::upgrade_cluster::until_done";
            }
    ...
    impl DeleteCluster {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_edgecontainer_v1::client::EdgeContainer::delete_cluster::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GenerateOfflineCredential {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ListNodePools {
        ...
        pub fn by_page(
            self,
        ) -> impl google_cloud_gax::paginator::Paginator<crate::model::ListNodePoolsResponse, crate::Error>
        {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
            let execute = move |token: String| {
        ...
        pub fn by_item(
            ...
            crate::model::ListNodePoolsResponse,
            crate::Error,
        > {
            use google_cloud_gax::paginator::Paginator;
            self.by_page().items()
    ...
    impl CreateNodePool {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `create_node_pool`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::NodePool, crate::model::OperationMetadata>
        {
            type Operation = google_cloud_lro::internal::Operation<
                crate::model::NodePool,
                crate::model::OperationMetadata,
            >;
            let polling_error_policy = self.0.stub.get_polling_error_policy(&self.0.options);
            let polling_backoff_policy = self.0.stub.get_polling_backoff_policy(&self.0.options);
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_edgecontainer_v1::client::EdgeContainer::create_node_pool::until_done";
            }
    ...
    impl UpdateNodePool {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `update_node_pool`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::NodePool, crate::model::OperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_edgecontainer_v1::client::EdgeContainer::update_node_pool::until_done";
            }
    ...
    impl DeleteNodePool {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `delete_node_pool`.
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            type Operation =
                google_cloud_lro::internal::Operation<wkt::Empty, crate::model::OperationMetadata>;
            let polling_error_policy = self.0.stub.get_polling_error_policy(&self.0.options);
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_edgecontainer_v1::client::EdgeContainer::delete_node_pool::until_done";
            }
    ...
    impl ListMachines {
        ...
        pub fn by_page(
            self,
        ) -> impl google_cloud_gax::paginator::Paginator<crate::model::ListMachinesResponse, crate::Error>
        {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
            let execute = move |token: String| {
        ...
        pub fn by_item(
            ...
            crate::model::ListMachinesResponse,
            crate::Error,
        > {
            use google_cloud_gax::paginator::Paginator;
            self.by_page().items()
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListMachines {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetMachine {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListVpnConnections {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetVpnConnection {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateVpnConnection {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `create_vpn_connection`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::VpnConnection, crate::model::OperationMetadata>
        {
            type Operation = google_cloud_lro::internal::Operation<
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_edgecontainer_v1::client::EdgeContainer::create_vpn_connection::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateVpnConnection {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteVpnConnection {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `delete_vpn_connection`.
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            type Operation =
                google_cloud_lro::internal::Operation<wkt::Empty, crate::model::OperationMetadata>;
            let polling_error_policy = self.0.stub.get_polling_error_policy(&self.0.options);
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_edgecontainer_v1::client::EdgeContainer::delete_vpn_connection::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteVpnConnection {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
