...
/// Implements a [EdgeContainer](super::stubs::EdgeContainer) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct EdgeContainer<T>
where
    T: super::stubs::EdgeContainer + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::EdgeContainer for EdgeContainer<T>
where
    T: super::stubs::EdgeContainer + std::fmt::Debug + Send + Sync,
{
