        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//policysimulator.googleapis.com/v1/{}/orgPolicyViolationsPreviews",
                    var_parent,
                );
    ...
    async fn get_org_policy_violations_preview(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//policysimulator.googleapis.com/v1/{}", var_name,);
    ...
    async fn list_org_policy_violations(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//policysimulator.googleapis.com/v1/{}/orgPolicyViolations",
                    var_parent,
                );
    ...
    async fn list_replay_results(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//policysimulator.googleapis.com/v1/{}/results", var_parent,);
