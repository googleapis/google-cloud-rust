...
/// Request and client builders for [OrgPolicyViolationsPreviewService][crate::client::OrgPolicyViolationsPreviewService].
pub mod org_policy_violations_preview_service {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListOrgPolicyViolationsPreviews {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetOrgPolicyViolationsPreview {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateOrgPolicyViolationsPreview {
        ...
        > {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_policysimulator_v1::client::OrgPolicyViolationsPreviewService::create_org_policy_violations_preview::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateOrgPolicyViolationsPreview {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListOrgPolicyViolations {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
...
/// Request and client builders for [Simulator][crate::client::Simulator].
pub mod simulator {
    use crate::Result;
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetReplay {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateReplay {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Replay, crate::model::ReplayOperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_policysimulator_v1::client::Simulator::create_replay::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateReplay {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ListReplayResults {
        ...
        pub fn by_page(
            ...
            crate::model::ListReplayResultsResponse,
            crate::Error,
        > {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListReplayResults {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
