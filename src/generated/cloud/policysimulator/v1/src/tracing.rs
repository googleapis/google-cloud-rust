...
/// Implements a [Simulator](super::stubs::Simulator) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Simulator<T>
where
    T: super::stubs::Simulator + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Simulator for Simulator<T>
where
    T: super::stubs::Simulator + std::fmt::Debug + Send + Sync,
{
