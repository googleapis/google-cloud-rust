...
/// Request and client builders for [LookupService][crate::client::LookupService].
pub mod lookup_service {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ResolveService {
...
/// Request and client builders for [RegistrationService][crate::client::RegistrationService].
pub mod registration_service {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateNamespace {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ListNamespaces {
        ...
        pub fn by_page(
            ...
            crate::model::ListNamespacesResponse,
            crate::Error,
        > {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListNamespaces {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetNamespace {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateNamespace {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteNamespace {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
