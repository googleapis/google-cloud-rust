...
impl super::stub::LookupService for LookupService {
    async fn resolve_service(
        ...
        let response: crate::model::ResolveServiceResponse =
...
impl super::stub::RegistrationService for RegistrationService {
    async fn create_namespace(
        ...
        let response: crate::model::Namespace = self
            .inner
    ...
    async fn list_namespaces(
        ...
        let response: crate::model::ListNamespacesResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn create_endpoint(
        ...
        let response: crate::model::Endpoint = self
            .inner
    ...
    async fn list_endpoints(
        ...
        let builder = builder.query(&[("filter", &req.filter)]);
        let builder = builder.query(&[("orderBy", &req.order_by)]);
        let response: crate::model::ListEndpointsResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
