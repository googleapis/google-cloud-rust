    ...
    async fn resolve_service(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:resolve";
...
impl super::stub::RegistrationService for RegistrationService {
    async fn create_namespace(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//servicedirectory.googleapis.com/{}", var_parent,);
                let builder = self.inner.builder(Method::POST, path);
    ...
    async fn update_namespace(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                let var_namespace_name = try_match(
                    Some(&req)
                ...
                let path = format!("/v1/{}", var_namespace_name,);

                let _path_template = "/v1/{namespace.name}";

                let resource_name =
                    format!("//servicedirectory.googleapis.com/{}", var_namespace_name,);
    ...
    async fn update_service(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//servicedirectory.googleapis.com/{}", var_service_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn create_endpoint(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/endpoints";
    ...
    async fn update_endpoint(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                let var_endpoint_name = try_match(
                    Some(&req)
                ...
                let path = format!("/v1/{}", var_endpoint_name,);

                let _path_template = "/v1/{endpoint.name}";

                let resource_name =
                    format!("//servicedirectory.googleapis.com/{}", var_endpoint_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
