...
/// Implements a [LookupService](crate::stubs::LookupService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct LookupService<T>
where
    T: crate::stubs::LookupService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::LookupService for LookupService<T>
where
    T: crate::stubs::LookupService + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [RegistrationService](crate::stubs::RegistrationService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct RegistrationService<T>
where
    T: crate::stubs::RegistrationService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::RegistrationService for RegistrationService<T>
where
    T: crate::stubs::RegistrationService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
