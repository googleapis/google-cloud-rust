...
/// Implements a [LookupService](super::stubs::LookupService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct LookupService<T>
where
    T: super::stubs::LookupService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::LookupService for LookupService<T>
where
    T: super::stubs::LookupService + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [RegistrationService](super::stubs::RegistrationService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct RegistrationService<T>
where
    T: super::stubs::RegistrationService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::RegistrationService for RegistrationService<T>
where
    T: super::stubs::RegistrationService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
