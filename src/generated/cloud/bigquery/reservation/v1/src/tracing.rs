...
/// Implements a [ReservationService](super::stubs::ReservationService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ReservationService<T>
where
    T: super::stubs::ReservationService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ReservationService for ReservationService<T>
where
    T: super::stubs::ReservationService + std::fmt::Debug + Send + Sync,
{
