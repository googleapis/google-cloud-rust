...
/// Implements a [ReservationService](crate::stubs::ReservationService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ReservationService<T>
where
    T: crate::stubs::ReservationService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ReservationService for ReservationService<T>
where
    T: crate::stubs::ReservationService + std::fmt::Debug + Send + Sync,
{
