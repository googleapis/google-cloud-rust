        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//bigqueryreservation.googleapis.com/v1/{}/reservations",
                    var_parent,
                );
    ...
    async fn get_reservation(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//bigqueryreservation.googleapis.com/v1/{}", var_name,);
    ...
    async fn create_capacity_commitment(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//bigqueryreservation.googleapis.com/v1/{}/capacityCommitments",
                    var_parent,
                );
    ...
    async fn create_assignment(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//bigqueryreservation.googleapis.com/v1/{}/assignments",
                    var_parent,
                );
    ...
    async fn search_assignments(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//bigqueryreservation.googleapis.com/v1/{}", var_parent,);
    ...
    async fn get_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//bigqueryreservation.googleapis.com/v1/{}", var_resource,);
    ...
    async fn create_reservation_group(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//bigqueryreservation.googleapis.com/v1/{}/reservationGroups",
                    var_parent,
                );
