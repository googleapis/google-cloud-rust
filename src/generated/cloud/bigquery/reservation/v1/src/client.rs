...
/// [with_credentials()]: super::builder::reservation_service::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `ReservationService` in
...
impl ReservationService {
    ...
    /// ) -> Result<()> {
    ///     let response = client.failover_reservation()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ReservationService
    /// ) -> Result<()> {
    ///     let response = client.split_capacity_commitment()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ReservationService
    /// ) -> Result<()> {
    ///     let response = client.merge_capacity_commitments()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ReservationService
    /// ) -> Result<()> {
    ///     let mut list = client.search_assignments()
    ///         /* set fields */
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &ReservationService
    /// ) -> Result<()> {
    ///     let mut list = client.search_all_assignments()
    ///         /* set fields */
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &ReservationService
    /// ) -> Result<()> {
    ///     let response = client.move_assignment()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
