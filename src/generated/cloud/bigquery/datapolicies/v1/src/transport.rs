        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//bigquerydatapolicy.googleapis.com/v1/{}/dataPolicies",
                    var_parent,
                );
    ...
    async fn delete_data_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//bigquerydatapolicy.googleapis.com/v1/{}", var_name,);
    ...
    async fn get_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//bigquerydatapolicy.googleapis.com/v1/{}", var_resource,);
