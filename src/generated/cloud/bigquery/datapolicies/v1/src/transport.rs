...
impl super::stub::DataPolicyService for DataPolicyService {
    async fn create_data_policy(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}/dataPolicies", var_parent,);
    ...
    async fn update_data_policy(
        ...
        let (builder, method, _path_template) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}", var_data_policy_name,);
    ...
    async fn test_iam_permissions(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.bigquery.datapolicies.v1.DataPolicyService/TestIamPermissions")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name)
            );
        }
