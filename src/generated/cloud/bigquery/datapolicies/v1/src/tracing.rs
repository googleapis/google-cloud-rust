...
/// Implements a [DataPolicyService](super::stubs::DataPolicyService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DataPolicyService<T>
where
    T: super::stubs::DataPolicyService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::DataPolicyService for DataPolicyService<T>
where
    T: super::stubs::DataPolicyService + std::fmt::Debug + Send + Sync,
{
