...
/// Implements a [DataPolicyService](crate::stubs::DataPolicyService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DataPolicyService<T>
where
    T: crate::stubs::DataPolicyService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::DataPolicyService for DataPolicyService<T>
where
    T: crate::stubs::DataPolicyService + std::fmt::Debug + Send + Sync,
{
