...
/// Request and client builders for [DataPolicyService][crate::client::DataPolicyService].
pub mod data_policy_service {
    ...
    /// # async fn sample() -> google_cloud_bigquery_datapolicies_v1::Result<()> {
    ///
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateDataPolicy {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateDataPolicy {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for RenameDataPolicy {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteDataPolicy {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetDataPolicy {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ListDataPolicies {
        ...
        pub fn by_page(
            ...
            crate::model::ListDataPoliciesResponse,
            crate::Error,
        > {
            use std::clone::Clone;
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListDataPolicies {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
