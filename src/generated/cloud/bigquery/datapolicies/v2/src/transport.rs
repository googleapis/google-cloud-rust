        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//bigquerydatapolicy.googleapis.com/v2/{}/dataPolicies",
                    var_parent,
                );
    ...
    async fn add_grantees(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//bigquerydatapolicy.googleapis.com/v2/{}", var_data_policy,);
    ...
    async fn delete_data_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//bigquerydatapolicy.googleapis.com/v2/{}", var_name,);
    ...
    async fn get_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//bigquerydatapolicy.googleapis.com/v2/{}", var_resource,);
