    ...
    async fn create_data_policy(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/dataPolicies";
    ...
    async fn add_grantees(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{data_policy}:addGrantees";
    ...
    async fn remove_grantees(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{data_policy}:removeGrantees";
    ...
    async fn update_data_policy(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{data_policy.name}";

                let resource_name = format!(
                    "//bigquerydatapolicy.googleapis.com/{}",
                    var_data_policy_name,
                );
