...
pub mod data_policy_service {
    ...
    impl AddGrantees {
        ...
        /// Sends the request.
        pub async fn send(self) -> Result<crate::model::DataPolicy> {
            (*self.0.stub).add_grantees(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }
    ...
    impl RemoveGrantees {
        ...
        /// Sends the request.
        pub async fn send(self) -> Result<crate::model::DataPolicy> {
            (*self.0.stub).remove_grantees(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }
