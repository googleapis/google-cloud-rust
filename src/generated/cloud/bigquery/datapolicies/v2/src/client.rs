...
/// [with_credentials()]: super::builder::data_policy_service::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `DataPolicyService` in
...
impl DataPolicyService {
    ...
    ///    client: &DataPolicyService
    /// ) -> Result<()> {
    ///     let response = client.add_grantees()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &DataPolicyService
    /// ) -> Result<()> {
    ///     let response = client.remove_grantees()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
