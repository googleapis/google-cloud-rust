        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//bigqueryconnection.googleapis.com/v1/{}/connections",
                    var_parent,
                );
    ...
    async fn get_connection(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//bigqueryconnection.googleapis.com/v1/{}", var_name,);
    ...
    async fn get_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//bigqueryconnection.googleapis.com/v1/{}", var_resource,);
