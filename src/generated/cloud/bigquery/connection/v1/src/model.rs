...
impl Connection {
    ...
    /// let x = Connection::new().set_properties(Some(connection::Properties::CloudSql(CloudSqlProperties::default().into())));
    /// ```
...
impl AwsProperties {
    ...
    /// ```
    /// # use google_cloud_bigquery_connection_v1::model::AwsProperties;
    /// use google_cloud_bigquery_connection_v1::model::aws_properties;
    /// use google_cloud_bigquery_connection_v1::model::AwsAccessRole;
    /// let x = AwsProperties::new().set_authentication_method(Some(aws_properties::AuthenticationMethod::AccessRole(AwsAccessRole::default().into())));
    /// ```
