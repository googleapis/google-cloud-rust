...
/// Implements a [ConnectionService](crate::stubs::ConnectionService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ConnectionService<T>
where
    T: crate::stubs::ConnectionService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ConnectionService for ConnectionService<T>
where
    T: crate::stubs::ConnectionService + std::fmt::Debug + Send + Sync,
{
