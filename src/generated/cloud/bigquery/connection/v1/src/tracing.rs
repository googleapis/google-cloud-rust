...
/// Implements a [ConnectionService](super::stubs::ConnectionService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ConnectionService<T>
where
    T: super::stubs::ConnectionService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ConnectionService for ConnectionService<T>
where
    T: super::stubs::ConnectionService + std::fmt::Debug + Send + Sync,
{
