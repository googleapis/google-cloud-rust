...
/// Implements a [DataTransferService](super::stubs::DataTransferService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DataTransferService<T>
where
    T: super::stubs::DataTransferService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::DataTransferService for DataTransferService<T>
where
    T: super::stubs::DataTransferService + std::fmt::Debug + Send + Sync,
{
