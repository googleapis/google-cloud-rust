    ...
    async fn create_transfer_config(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/transferConfigs";
    ...
    async fn update_transfer_config(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{transfer_config.name}";

                let resource_name = format!(
                    "//bigquerydatatransfer.googleapis.com/{}",
                    var_transfer_config_name,
                );
    ...
    async fn schedule_transfer_runs(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}:scheduleRuns";
    ...
    async fn start_manual_transfer_runs(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}:startManualRuns";
    ...
    async fn list_transfer_logs(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/transferLogs";
    ...
    async fn check_valid_creds(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:checkValidCreds";
    ...
    async fn enroll_data_sources(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:enrollDataSources";
    ...
    async fn unenroll_data_sources(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:unenrollDataSources";
