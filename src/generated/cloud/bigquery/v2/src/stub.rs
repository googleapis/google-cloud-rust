...
pub trait DatasetService: std::fmt::Debug + Send + Sync {
    ...
    > + Send {
        std::future::ready::<crate::Result<gax::response::Response<crate::model::DatasetList>>>(
...
pub trait JobService: std::fmt::Debug + Send + Sync {
    ...
    > + Send {
        std::future::ready::<crate::Result<gax::response::Response<crate::model::JobCancelResponse>>>(
            Err(Error::other("unimplemented")),
        )
    }
    ...
    > + Send {
        std::future::ready::<crate::Result<gax::response::Response<crate::model::JobList>>>(Err(
            Error::other("unimplemented"),
        ))
    }
    ...
    > + Send {
        std::future::ready::<crate::Result<gax::response::Response<crate::model::QueryResponse>>>(
            Err(Error::other("unimplemented")),
        )
    }
}
...
pub trait RoutineService: std::fmt::Debug + Send + Sync {
    ...
    > + Send {
        std::future::ready::<crate::Result<gax::response::Response<crate::model::Routine>>>(Err(
            Error::other("unimplemented"),
        ))
    }
...
pub trait RowAccessPolicyService: std::fmt::Debug + Send + Sync {
    ...
    > + Send {
        std::future::ready::<crate::Result<gax::response::Response<crate::model::RowAccessPolicy>>>(
            Err(Error::other("unimplemented")),
        )
    }
...
pub trait TableService: std::fmt::Debug + Send + Sync {
    ...
    > + Send {
        std::future::ready::<crate::Result<gax::response::Response<crate::model::TableList>>>(Err(
            Error::other("unimplemented"),
        ))
    }
}
