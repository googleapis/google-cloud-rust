...
pub mod dataset_service {
    ...
    {
        pub(crate) fn new(stub: Arc<dyn super::super::stubs::dynamic::DatasetService>) -> Self {
            Self {
                stub,
                request: R::default(),
...
pub mod job_service {
    ...
    where
        R: std::default::Default,
    {
        pub(crate) fn new(stub: Arc<dyn super::super::stubs::dynamic::JobService>) -> Self {
            Self {
                stub,
                request: R::default(),
                options: gax::options::RequestOptions::default(),
    ...
    /// The request builder for a JobService::cancel_job call.
    #[derive(Clone, Debug)]
    ...
    /// The request builder for a JobService::insert_job call.
    #[derive(Clone, Debug)]
    ...
    impl gax::options::RequestBuilder for InsertJob {
        fn request_options(&mut self) -> &mut gax::options::RequestOptions {
            &mut self.0.options
        }
    }
...
pub mod routine_service {
    ...
    where
        R: std::default::Default,
    {
        pub(crate) fn new(stub: Arc<dyn super::super::stubs::dynamic::RoutineService>) -> Self {
            Self {
                stub,
                request: R::default(),
                options: gax::options::RequestOptions::default(),
...
pub mod row_access_policy_service {
    ...
    impl ListRowAccessPolicies {
        ...
        pub async fn paginator(
            self,
        ) -> gax::paginator::Paginator<crate::model::ListRowAccessPoliciesResponse, gax::error::Error>
        {
            use std::clone::Clone;
...
pub mod table_service {
    ...
    where
        R: std::default::Default,
    {
        pub(crate) fn new(stub: Arc<dyn super::super::stubs::dynamic::TableService>) -> Self {
            Self {
                stub,
                request: R::default(),
                options: gax::options::RequestOptions::default(),
