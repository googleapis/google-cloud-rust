    ...
    async fn list_data_exchanges(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/dataExchanges";
    ...
    async fn list_org_data_exchanges(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{organization}/dataExchanges";

                let resource_name = format!("//analyticshub.googleapis.com/{}", var_organization,);
                let builder = self.inner.builder(Method::GET, path);
                let builder = builder.query(&[("pageSize", &req.page_size)]);
                let builder = builder.query(&[("pageToken", &req.page_token)]);
                let builder = Ok(builder);
    ...
    async fn update_data_exchange(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{data_exchange.name}";

                let resource_name =
                    format!("//analyticshub.googleapis.com/{}", var_data_exchange_name,);
    ...
    async fn list_listings(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/listings";
    ...
    async fn update_listing(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{listing.name}";

                let resource_name = format!("//analyticshub.googleapis.com/{}", var_listing_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn subscribe_listing(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:subscribe";
    ...
    async fn refresh_subscription(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:refresh";
    ...
    async fn list_subscriptions(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/subscriptions";
    ...
    async fn list_shared_resource_subscriptions(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{resource}:listSubscriptions";
    ...
    async fn create_query_template(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/queryTemplates";
    ...
    async fn update_query_template(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{query_template.name}";

                let resource_name =
                    format!("//analyticshub.googleapis.com/{}", var_query_template_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = req
                        .update_mask
    ...
    async fn submit_query_template(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:submit";
