...
/// Implements a [AnalyticsHubService](super::stubs::AnalyticsHubService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AnalyticsHubService<T>
where
    T: super::stubs::AnalyticsHubService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::AnalyticsHubService for AnalyticsHubService<T>
where
    T: super::stubs::AnalyticsHubService + std::fmt::Debug + Send + Sync,
{
