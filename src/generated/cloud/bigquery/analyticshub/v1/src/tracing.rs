...
/// Implements a [AnalyticsHubService](crate::stubs::AnalyticsHubService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AnalyticsHubService<T>
where
    T: crate::stubs::AnalyticsHubService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::AnalyticsHubService for AnalyticsHubService<T>
where
    T: crate::stubs::AnalyticsHubService + std::fmt::Debug + Send + Sync,
{
