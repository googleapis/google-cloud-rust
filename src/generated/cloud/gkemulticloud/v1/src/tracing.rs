...
/// Implements a [AttachedClusters](crate::stubs::AttachedClusters) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AttachedClusters<T>
where
    T: crate::stubs::AttachedClusters + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::AttachedClusters for AttachedClusters<T>
where
    T: crate::stubs::AttachedClusters + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [AwsClusters](crate::stubs::AwsClusters) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AwsClusters<T>
where
    T: crate::stubs::AwsClusters + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::AwsClusters for AwsClusters<T>
where
    T: crate::stubs::AwsClusters + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [AzureClusters](crate::stubs::AzureClusters) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AzureClusters<T>
where
    T: crate::stubs::AzureClusters + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::AzureClusters for AzureClusters<T>
where
    T: crate::stubs::AzureClusters + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
