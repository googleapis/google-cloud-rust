...
impl super::stub::AttachedClusters for AttachedClusters {
    ...
    ) -> Result<gax::response::Response<crate::model::GenerateAttachedClusterAgentTokenResponse>>
    {
        ...
        #[cfg(google_cloud_unstable_tracing)]
        let options = {
            let resource_name = Option::<&String>::None.or(Some(&req.attached_cluster));
            if let Some(rn) = resource_name {
                let full_resource_name = format!("//gkemulticloud.googleapis.com/{}", rn);
                gax::options::internal::set_resource_name(options, full_resource_name)
            } else {
...
impl super::stub::AwsClusters for AwsClusters {
    ...
    async fn generate_aws_cluster_agent_token(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        let options = {
            let resource_name = Option::<&String>::None.or(Some(&req.aws_cluster));
            if let Some(rn) = resource_name {
                let full_resource_name = format!("//gkemulticloud.googleapis.com/{}", rn);
                gax::options::internal::set_resource_name(options, full_resource_name)
            } else {
...
impl super::stub::AzureClusters for AzureClusters {
    ...
    async fn generate_azure_cluster_agent_token(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        let options = {
            let resource_name = Option::<&String>::None.or(Some(&req.azure_cluster));
            if let Some(rn) = resource_name {
                let full_resource_name = format!("//gkemulticloud.googleapis.com/{}", rn);
                gax::options::internal::set_resource_name(options, full_resource_name)
            } else {
