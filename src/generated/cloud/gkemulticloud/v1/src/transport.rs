    ...
    async fn create_attached_cluster(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/attachedClusters";
    ...
    async fn update_attached_cluster(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{attached_cluster.name}";

                let resource_name = format!(
                    "//gkemulticloud.googleapis.com/{}",
                    var_attached_cluster_name,
                );
    ...
    async fn import_attached_cluster(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/attachedClusters:import";
    ...
    async fn generate_attached_cluster_install_manifest(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}:generateAttachedClusterInstallManifest";
    ...
    async fn generate_attached_cluster_agent_token(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{attached_cluster}:generateAttachedClusterAgentToken";
    ...
    async fn create_aws_cluster(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/awsClusters";
    ...
    async fn update_aws_cluster(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{aws_cluster.name}";

                let resource_name =
                    format!("//gkemulticloud.googleapis.com/{}", var_aws_cluster_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = builder.query(&[("validateOnly", &req.validate_only)]);
                    let builder = req
    ...
    async fn generate_aws_cluster_agent_token(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{aws_cluster}:generateAwsClusterAgentToken";
    ...
    async fn generate_aws_access_token(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{aws_cluster}:generateAwsAccessToken";
    ...
    async fn create_aws_node_pool(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/awsNodePools";
    ...
    async fn update_aws_node_pool(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{aws_node_pool.name}";

                let resource_name =
                    format!("//gkemulticloud.googleapis.com/{}", var_aws_node_pool_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = builder.query(&[("validateOnly", &req.validate_only)]);
                    let builder = req
    ...
    async fn rollback_aws_node_pool_update(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:rollback";
    ...
    async fn get_aws_open_id_config(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{aws_cluster}/.well-known/openid-configuration";
    ...
    async fn get_aws_json_web_keys(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{aws_cluster}/jwks";
    ...
    async fn create_azure_client(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/azureClients";
    ...
    async fn create_azure_cluster(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/azureClusters";
    ...
    async fn update_azure_cluster(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{azure_cluster.name}";

                let resource_name =
                    format!("//gkemulticloud.googleapis.com/{}", var_azure_cluster_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = builder.query(&[("validateOnly", &req.validate_only)]);
                    let builder = req
    ...
    async fn generate_azure_cluster_agent_token(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{azure_cluster}:generateAzureClusterAgentToken";
    ...
    async fn generate_azure_access_token(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{azure_cluster}:generateAzureAccessToken";
    ...
    async fn create_azure_node_pool(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/azureNodePools";
    ...
    async fn update_azure_node_pool(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{azure_node_pool.name}";

                let resource_name = format!(
                    "//gkemulticloud.googleapis.com/{}",
                    var_azure_node_pool_name,
                );
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = builder.query(&[("validateOnly", &req.validate_only)]);
    ...
    async fn get_azure_open_id_config(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{azure_cluster}/.well-known/openid-configuration";
    ...
    async fn get_azure_json_web_keys(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{azure_cluster}/jwks";
