    ...
    async fn list_secrets(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/secrets";
    ...
    async fn add_secret_version(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}:addVersion";
    ...
    async fn update_secret(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{secret.name}";

                let resource_name = format!("//secretmanager.googleapis.com/{}", var_secret_name,);
    ...
    async fn access_secret_version(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:access";
