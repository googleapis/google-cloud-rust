...
/// [with_credentials()]: super::builder::secret_manager_service::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `SecretManagerService` in
