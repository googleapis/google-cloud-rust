...
/// [with_credentials()]: super::builder::oracle_database::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `OracleDatabase` in
...
impl OracleDatabase {
    ...
    pub fn builder() -> super::builder::oracle_database::ClientBuilder {
        crate::new_client_builder(super::builder::oracle_database::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::OracleDatabase>> {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::OracleDatabase> {
