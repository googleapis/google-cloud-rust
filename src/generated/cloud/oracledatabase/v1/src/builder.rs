...
/// Request and client builders for [OracleDatabase][crate::client::OracleDatabase].
pub mod oracle_database {
    ...
    /// The request builder for [OracleDatabase::configure_exascale_cloud_exadata_infrastructure][crate::client::OracleDatabase::configure_exascale_cloud_exadata_infrastructure] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_oracledatabase_v1::builder::oracle_database::ConfigureExascaleCloudExadataInfrastructure;
    /// # async fn sample() -> google_cloud_oracledatabase_v1::Result<()> {
    /// use google_cloud_lro::Poller;
    ///
    /// let builder = prepare_request_builder();
    ...
    /// # Ok(()) }
    ///
    /// fn prepare_request_builder() -> ConfigureExascaleCloudExadataInfrastructure {
    ///   # panic!();
    ///   // ... details omitted ...
    /// }
    /// ```
    #[derive(Clone, Debug)]
    pub struct ConfigureExascaleCloudExadataInfrastructure(
        RequestBuilder<crate::model::ConfigureExascaleCloudExadataInfrastructureRequest>,
    );

    impl ConfigureExascaleCloudExadataInfrastructure {
        pub(crate) fn new(
            stub: std::sync::Arc<dyn super::super::stub::dynamic::OracleDatabase>,
        ) -> Self {
            Self(RequestBuilder::new(stub))
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<
            V: Into<crate::model::ConfigureExascaleCloudExadataInfrastructureRequest>,
        >(
            mut self,
            v: V,
        ) -> Self {
        ...
        ///
        /// This starts, but does not poll, a longrunning operation. More information
        /// on [configure_exascale_cloud_exadata_infrastructure][crate::client::OracleDatabase::configure_exascale_cloud_exadata_infrastructure].
        pub async fn send(self) -> Result<google_cloud_longrunning::model::Operation> {
            (*self.0.stub)
                .configure_exascale_cloud_exadata_infrastructure(self.0.request, self.0.options)
                .await
                .map(crate::Response::into_body)
        }

        /// Creates a [Poller][google_cloud_lro::Poller] to work with `configure_exascale_cloud_exadata_infrastructure`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<
            crate::model::CloudExadataInfrastructure,
        ...
        ///
        /// This is a **required** field for requests.
        pub fn set_total_storage_size_gb<T: Into<i32>>(mut self, v: T) -> Self {
            self.0.request.total_storage_size_gb = v.into();
            self
        }
        ...
        pub fn set_total_vm_storage_size_gb<T: Into<i32>>(mut self, v: T) -> Self {
            self.0.request.total_vm_storage_size_gb = v.into();
            self
        }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ConfigureExascaleCloudExadataInfrastructure {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    /// The request builder for [OracleDatabase::refresh_autonomous_database][crate::client::OracleDatabase::refresh_autonomous_database] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_oracledatabase_v1::builder::oracle_database::RefreshAutonomousDatabase;
    /// # async fn sample() -> google_cloud_oracledatabase_v1::Result<()> {
    /// use google_cloud_lro::Poller;
    ///
    /// let builder = prepare_request_builder();
    ...
    /// # Ok(()) }
    ///
    /// fn prepare_request_builder() -> RefreshAutonomousDatabase {
    ///   # panic!();
    ///   // ... details omitted ...
    /// }
    /// ```
    #[derive(Clone, Debug)]
    pub struct RefreshAutonomousDatabase(
        RequestBuilder<crate::model::RefreshAutonomousDatabaseRequest>,
    );

    impl RefreshAutonomousDatabase {
        pub(crate) fn new(
            stub: std::sync::Arc<dyn super::super::stub::dynamic::OracleDatabase>,
        ) -> Self {
            Self(RequestBuilder::new(stub))
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::RefreshAutonomousDatabaseRequest>>(
            mut self,
            v: V,
        ) -> Self {
            self.0.request = v.into();
        ...
        ///
        /// This starts, but does not poll, a longrunning operation. More information
        /// on [refresh_autonomous_database][crate::client::OracleDatabase::refresh_autonomous_database].
        pub async fn send(self) -> Result<google_cloud_longrunning::model::Operation> {
            (*self.0.stub)
                .refresh_autonomous_database(self.0.request, self.0.options)
                .await
                .map(crate::Response::into_body)
        }

        /// Creates a [Poller][google_cloud_lro::Poller] to work with `refresh_autonomous_database`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<
            crate::model::AutonomousDatabase,
        ...
        > {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_oracledatabase_v1::client::OracleDatabase::refresh_autonomous_database::until_done";
            }
        ...
        where
            T: std::convert::Into<wkt::Timestamp>,
        {
            self.0.request.refresh_cutoff_time = std::option::Option::Some(v.into());
            self
        }
        ...
        where
            T: std::convert::Into<wkt::Timestamp>,
        {
            self.0.request.refresh_cutoff_time = v.map(|x| x.into());
            self
        }
    }

    #[doc(hidden)]
    impl crate::RequestBuilder for RefreshAutonomousDatabase {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [OracleDatabase::get_autonomous_database_refreshable_clones][crate::client::OracleDatabase::get_autonomous_database_refreshable_clones] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_oracledatabase_v1::builder::oracle_database::GetAutonomousDatabaseRefreshableClones;
    /// # async fn sample() -> google_cloud_oracledatabase_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    /// # Ok(()) }
    ///
    /// fn prepare_request_builder() -> GetAutonomousDatabaseRefreshableClones {
    ///   # panic!();
    ///   // ... details omitted ...
    /// }
    /// ```
    #[derive(Clone, Debug)]
    pub struct GetAutonomousDatabaseRefreshableClones(
        RequestBuilder<crate::model::GetAutonomousDatabaseRefreshableClonesRequest>,
    );

    impl GetAutonomousDatabaseRefreshableClones {
        pub(crate) fn new(
            stub: std::sync::Arc<dyn super::super::stub::dynamic::OracleDatabase>,
        ) -> Self {
            Self(RequestBuilder::new(stub))
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<
            V: Into<crate::model::GetAutonomousDatabaseRefreshableClonesRequest>,
        >(
            mut self,
            v: V,
        ) -> Self {
        ...
        /// Sends the request.
        pub async fn send(self) -> Result<crate::model::AutonomousDatabaseRefreshableClones> {
            (*self.0.stub)
                .get_autonomous_database_refreshable_clones(self.0.request, self.0.options)
                .await
                .map(crate::Response::into_body)
        }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetAutonomousDatabaseRefreshableClones {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
