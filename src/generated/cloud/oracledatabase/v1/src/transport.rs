        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//oracledatabase.googleapis.com/v1/{}/cloudExadataInfrastructures",
                    var_parent,
                );
    ...
    async fn get_cloud_exadata_infrastructure(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//oracledatabase.googleapis.com/v1/{}", var_name,);
    ...
    async fn list_cloud_vm_clusters(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//oracledatabase.googleapis.com/v1/{}/cloudVmClusters",
                    var_parent,
                );
    ...
    async fn list_entitlements(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//oracledatabase.googleapis.com/v1/{}/entitlements",
                    var_parent,
                );
    ...
    async fn list_db_servers(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//oracledatabase.googleapis.com/v1/{}/dbServers",
                    var_parent,
                );
    ...
    async fn list_db_nodes(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//oracledatabase.googleapis.com/v1/{}/dbNodes", var_parent,);
    ...
    async fn list_gi_versions(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//oracledatabase.googleapis.com/v1/{}/giVersions",
                    var_parent,
                );
    ...
    async fn list_minor_versions(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//oracledatabase.googleapis.com/v1/{}/minorVersions",
                    var_parent,
                );
    ...
    async fn list_db_system_shapes(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//oracledatabase.googleapis.com/v1/{}/dbSystemShapes",
                    var_parent,
                );
    ...
    async fn list_autonomous_databases(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//oracledatabase.googleapis.com/v1/{}/autonomousDatabases",
                    var_parent,
                );
    ...
    async fn list_autonomous_db_versions(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//oracledatabase.googleapis.com/v1/{}/autonomousDbVersions",
                    var_parent,
                );
    ...
    async fn list_autonomous_database_character_sets(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//oracledatabase.googleapis.com/v1/{}/autonomousDatabaseCharacterSets",
                    var_parent,
                );
    ...
    async fn list_autonomous_database_backups(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//oracledatabase.googleapis.com/v1/{}/autonomousDatabaseBackups",
                    var_parent,
                );
    ...
    async fn list_odb_networks(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//oracledatabase.googleapis.com/v1/{}/odbNetworks",
                    var_parent,
                );
    ...
    async fn list_odb_subnets(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//oracledatabase.googleapis.com/v1/{}/odbSubnets",
                    var_parent,
                );
    ...
    async fn list_exadb_vm_clusters(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//oracledatabase.googleapis.com/v1/{}/exadbVmClusters",
                    var_parent,
                );
    ...
    async fn list_exascale_db_storage_vaults(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//oracledatabase.googleapis.com/v1/{}/exascaleDbStorageVaults",
                    var_parent,
                );
    ...
    async fn list_db_system_initial_storage_sizes(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//oracledatabase.googleapis.com/v1/{}/dbSystemInitialStorageSizes",
                    var_parent,
                );
    ...
    async fn list_databases(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//oracledatabase.googleapis.com/v1/{}/databases",
                    var_parent,
                );
    ...
    async fn list_pluggable_databases(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//oracledatabase.googleapis.com/v1/{}/pluggableDatabases",
                    var_parent,
                );
    ...
    async fn list_db_systems(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//oracledatabase.googleapis.com/v1/{}/dbSystems",
                    var_parent,
                );
    ...
    async fn list_db_versions(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//oracledatabase.googleapis.com/v1/{}/dbVersions",
                    var_parent,
                );
    ...
    async fn list_database_character_sets(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//oracledatabase.googleapis.com/v1/{}/databaseCharacterSets",
                    var_parent,
                );
