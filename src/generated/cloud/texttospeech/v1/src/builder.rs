...
/// Request and client builders for [TextToSpeech][crate::client::TextToSpeech].
pub mod text_to_speech {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListVoices {
...
/// Request and client builders for [TextToSpeechLongAudioSynthesize][crate::client::TextToSpeechLongAudioSynthesize].
pub mod text_to_speech_long_audio_synthesize {
    ...
    impl SynthesizeLongAudio {
        ...
        > {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_texttospeech_v1::client::TextToSpeechLongAudioSynthesize::synthesize_long_audio::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for SynthesizeLongAudio {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
