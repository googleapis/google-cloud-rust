...
/// Implements a [TextToSpeech](crate::stubs::TextToSpeech) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct TextToSpeech<T>
where
    T: crate::stubs::TextToSpeech + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::TextToSpeech for TextToSpeech<T>
where
    T: crate::stubs::TextToSpeech + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [TextToSpeechLongAudioSynthesize](crate::stubs::TextToSpeechLongAudioSynthesize) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct TextToSpeechLongAudioSynthesize<T>
where
    T: crate::stubs::TextToSpeechLongAudioSynthesize + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::TextToSpeechLongAudioSynthesize for TextToSpeechLongAudioSynthesize<T>
where
    T: crate::stubs::TextToSpeechLongAudioSynthesize + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
