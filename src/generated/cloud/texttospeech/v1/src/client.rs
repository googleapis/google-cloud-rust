...
impl TextToSpeechLongAudioSynthesize {
    ...
    /// async fn wait(
    ///     mut poller: impl lro::Poller<model::SynthesizeLongAudioResponse, model::SynthesizeLongAudioMetadata>
    /// ) -> Result<model::SynthesizeLongAudioResponse> {
    ...
    /// field contains the final response, this will be a [crate::model::SynthesizeLongAudioResponse] (as
    /// an [Any]), or the error (as a `Status`).
    ///
    /// If the `done` field is `false`, the operation has not completed.  The
    /// operation may also include a [crate::model::SynthesizeLongAudioMetadata] value in the `metadata`
    ...
    ///
    /// [send()]: crate::builders::text_to_speech_long_audio_synthesize::SynthesizeLongAudio::send
    /// [poller()]: crate::builders::text_to_speech_long_audio_synthesize::SynthesizeLongAudio::poller
