...
/// [with_credentials()]: super::builder::text_to_speech::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `TextToSpeech` in
...
impl TextToSpeech {
    ...
    pub fn builder() -> super::builder::text_to_speech::ClientBuilder {
        crate::new_client_builder(super::builder::text_to_speech::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::TextToSpeech>> {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::TextToSpeech> {
    ...
    /// ```
    /// # use google_cloud_texttospeech_v1::client::TextToSpeech;
    /// use google_cloud_texttospeech_v1::Result;
    /// async fn sample(
    ///    client: &TextToSpeech
    /// ) -> Result<()> {
    ///     let response = client.list_voices()
    ...
    ///    client: &TextToSpeech
    /// ) -> Result<()> {
    ///     let response = client.synthesize_speech()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
...
/// [with_credentials()]: super::builder::text_to_speech_long_audio_synthesize::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `TextToSpeechLongAudioSynthesize` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
#[derive(Clone, Debug)]
...
impl TextToSpeechLongAudioSynthesize {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::TextToSpeechLongAudioSynthesize> {
