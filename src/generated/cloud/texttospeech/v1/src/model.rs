...
impl CustomPronunciationParams {
    ...
    /// ```
    /// # use google_cloud_texttospeech_v1::model::CustomPronunciationParams;
    /// let x = CustomPronunciationParams::new().set_or_clear_phrase("example");
    ...
    /// ```
    /// # use google_cloud_texttospeech_v1::model::CustomPronunciationParams;
    /// let x = CustomPronunciationParams::new().set_or_clear_pronunciation("example");
...
impl SynthesisInput {
    ...
    /// ```
    /// # use google_cloud_texttospeech_v1::model::SynthesisInput;
    /// let x = SynthesisInput::new().set_or_clear_prompt("example");
    ...
    /// ```
    /// # use google_cloud_texttospeech_v1::model::SynthesisInput;
    /// use google_cloud_texttospeech_v1::model::synthesis_input;
    /// let x = SynthesisInput::new().set_input_source(Some(synthesis_input::InputSource::Text("example".to_string())));
    /// ```
...
impl StreamingSynthesisInput {
    ...
    /// ```
    /// # use google_cloud_texttospeech_v1::model::StreamingSynthesisInput;
    /// let x = StreamingSynthesisInput::new().set_or_clear_prompt("example");
    ...
    /// ```
    /// # use google_cloud_texttospeech_v1::model::StreamingSynthesisInput;
    /// use google_cloud_texttospeech_v1::model::streaming_synthesis_input;
    /// let x = StreamingSynthesisInput::new().set_input_source(Some(streaming_synthesis_input::InputSource::Text("example".to_string())));
    /// ```
    pub fn set_input_source<
        T: std::convert::Into<
...
impl StreamingSynthesizeRequest {
    ...
    /// use google_cloud_texttospeech_v1::model::streaming_synthesize_request;
    /// use google_cloud_texttospeech_v1::model::StreamingSynthesizeConfig;
    /// let x = StreamingSynthesizeRequest::new().set_streaming_request(Some(streaming_synthesize_request::StreamingRequest::StreamingConfig(StreamingSynthesizeConfig::default().into())));
    /// ```
