...
/// Implements a [SqlBackupRunsService](crate::stubs::SqlBackupRunsService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SqlBackupRunsService<T>
where T: crate::stubs::SqlBackupRunsService + std::fmt::Debug + Send + Sync {
    inner: T,
}
...
impl<T> crate::stubs::SqlBackupRunsService for SqlBackupRunsService<T>
where T: crate::stubs::SqlBackupRunsService + std::fmt::Debug + Send + Sync {
...
/// Implements a [SqlConnectService](crate::stubs::SqlConnectService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SqlConnectService<T>
where T: crate::stubs::SqlConnectService + std::fmt::Debug + Send + Sync {
    inner: T,
}
...
impl<T> crate::stubs::SqlConnectService for SqlConnectService<T>
where T: crate::stubs::SqlConnectService + std::fmt::Debug + Send + Sync {
    #[tracing::instrument(ret)]
...
/// Implements a [SqlDatabasesService](crate::stubs::SqlDatabasesService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SqlDatabasesService<T>
where T: crate::stubs::SqlDatabasesService + std::fmt::Debug + Send + Sync {
    inner: T,
}
...
impl<T> crate::stubs::SqlDatabasesService for SqlDatabasesService<T>
where T: crate::stubs::SqlDatabasesService + std::fmt::Debug + Send + Sync {
    #[tracing::instrument(ret)]
    async fn delete(
        &self,
...
/// Implements a [SqlFlagsService](crate::stubs::SqlFlagsService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SqlFlagsService<T>
where T: crate::stubs::SqlFlagsService + std::fmt::Debug + Send + Sync {
    inner: T,
}
...
impl<T> crate::stubs::SqlFlagsService for SqlFlagsService<T>
where T: crate::stubs::SqlFlagsService + std::fmt::Debug + Send + Sync {
    #[tracing::instrument(ret)]
    async fn list(
        &self,
...
/// Implements a [SqlInstancesService](crate::stubs::SqlInstancesService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SqlInstancesService<T>
where T: crate::stubs::SqlInstancesService + std::fmt::Debug + Send + Sync {
    inner: T,
}
...
impl<T> crate::stubs::SqlInstancesService for SqlInstancesService<T>
where T: crate::stubs::SqlInstancesService + std::fmt::Debug + Send + Sync {
    #[tracing::instrument(ret)]
...
/// Implements a [SqlOperationsService](crate::stubs::SqlOperationsService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SqlOperationsService<T>
where T: crate::stubs::SqlOperationsService + std::fmt::Debug + Send + Sync {
    inner: T,
}
...
impl<T> crate::stubs::SqlOperationsService for SqlOperationsService<T>
where T: crate::stubs::SqlOperationsService + std::fmt::Debug + Send + Sync {
    #[tracing::instrument(ret)]
    async fn get(
        &self,
...
/// Implements a [SqlSslCertsService](crate::stubs::SqlSslCertsService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SqlSslCertsService<T>
where T: crate::stubs::SqlSslCertsService + std::fmt::Debug + Send + Sync {
    inner: T,
}
...
impl<T> crate::stubs::SqlSslCertsService for SqlSslCertsService<T>
where T: crate::stubs::SqlSslCertsService + std::fmt::Debug + Send + Sync {
    #[tracing::instrument(ret)]
    async fn delete(
        &self,
...
/// Implements a [SqlTiersService](crate::stubs::SqlTiersService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SqlTiersService<T>
where T: crate::stubs::SqlTiersService + std::fmt::Debug + Send + Sync {
    inner: T,
}
...
impl<T> crate::stubs::SqlTiersService for SqlTiersService<T>
where T: crate::stubs::SqlTiersService + std::fmt::Debug + Send + Sync {
    #[tracing::instrument(ret)]
    async fn list(
        &self,
...
/// Implements a [SqlUsersService](crate::stubs::SqlUsersService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SqlUsersService<T>
where T: crate::stubs::SqlUsersService + std::fmt::Debug + Send + Sync {
    inner: T,
}
...
impl<T> crate::stubs::SqlUsersService for SqlUsersService<T>
where T: crate::stubs::SqlUsersService + std::fmt::Debug + Send + Sync {
    #[tracing::instrument(ret)]
    async fn delete(
        &self,
