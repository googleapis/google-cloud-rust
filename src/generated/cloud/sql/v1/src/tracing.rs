...
/// Implements a [SqlBackupRunsService](super::stubs::SqlBackupRunsService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SqlBackupRunsService<T>
where T: super::stubs::SqlBackupRunsService + std::fmt::Debug + Send + Sync {
    inner: T,
}
...
impl<T> super::stubs::SqlBackupRunsService for SqlBackupRunsService<T>
where T: super::stubs::SqlBackupRunsService + std::fmt::Debug + Send + Sync {
...
/// Implements a [SqlConnectService](super::stubs::SqlConnectService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SqlConnectService<T>
where T: super::stubs::SqlConnectService + std::fmt::Debug + Send + Sync {
    inner: T,
}
...
impl<T> super::stubs::SqlConnectService for SqlConnectService<T>
where T: super::stubs::SqlConnectService + std::fmt::Debug + Send + Sync {
    #[tracing::instrument(ret)]
...
/// Implements a [SqlDatabasesService](super::stubs::SqlDatabasesService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SqlDatabasesService<T>
where T: super::stubs::SqlDatabasesService + std::fmt::Debug + Send + Sync {
    inner: T,
}
...
impl<T> super::stubs::SqlDatabasesService for SqlDatabasesService<T>
where T: super::stubs::SqlDatabasesService + std::fmt::Debug + Send + Sync {
    #[tracing::instrument(ret)]
    async fn delete(
        &self,
...
/// Implements a [SqlFlagsService](super::stubs::SqlFlagsService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SqlFlagsService<T>
where T: super::stubs::SqlFlagsService + std::fmt::Debug + Send + Sync {
    inner: T,
}
...
impl<T> super::stubs::SqlFlagsService for SqlFlagsService<T>
where T: super::stubs::SqlFlagsService + std::fmt::Debug + Send + Sync {
    #[tracing::instrument(ret)]
    async fn list(
        &self,
...
/// Implements a [SqlInstancesService](super::stubs::SqlInstancesService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SqlInstancesService<T>
where T: super::stubs::SqlInstancesService + std::fmt::Debug + Send + Sync {
    inner: T,
}
...
impl<T> super::stubs::SqlInstancesService for SqlInstancesService<T>
where T: super::stubs::SqlInstancesService + std::fmt::Debug + Send + Sync {
    #[tracing::instrument(ret)]
...
/// Implements a [SqlOperationsService](super::stubs::SqlOperationsService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SqlOperationsService<T>
where T: super::stubs::SqlOperationsService + std::fmt::Debug + Send + Sync {
    inner: T,
}
...
impl<T> super::stubs::SqlOperationsService for SqlOperationsService<T>
where T: super::stubs::SqlOperationsService + std::fmt::Debug + Send + Sync {
    #[tracing::instrument(ret)]
    async fn get(
        &self,
...
/// Implements a [SqlSslCertsService](super::stubs::SqlSslCertsService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SqlSslCertsService<T>
where T: super::stubs::SqlSslCertsService + std::fmt::Debug + Send + Sync {
    inner: T,
}
...
impl<T> super::stubs::SqlSslCertsService for SqlSslCertsService<T>
where T: super::stubs::SqlSslCertsService + std::fmt::Debug + Send + Sync {
    #[tracing::instrument(ret)]
    async fn delete(
        &self,
...
/// Implements a [SqlTiersService](super::stubs::SqlTiersService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SqlTiersService<T>
where T: super::stubs::SqlTiersService + std::fmt::Debug + Send + Sync {
    inner: T,
}
...
impl<T> super::stubs::SqlTiersService for SqlTiersService<T>
where T: super::stubs::SqlTiersService + std::fmt::Debug + Send + Sync {
    #[tracing::instrument(ret)]
    async fn list(
        &self,
...
/// Implements a [SqlUsersService](super::stubs::SqlUsersService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SqlUsersService<T>
where T: super::stubs::SqlUsersService + std::fmt::Debug + Send + Sync {
    inner: T,
}
...
impl<T> super::stubs::SqlUsersService for SqlUsersService<T>
where T: super::stubs::SqlUsersService + std::fmt::Debug + Send + Sync {
    #[tracing::instrument(ret)]
    async fn delete(
        &self,
