...
/// A dyn-compatible, crate-private version of `SqlBackupRunsService`.
...
/// All implementations of [crate::traits::SqlBackupRunsService] also implement [SqlBackupRunsService].
#[async_trait::async_trait]
impl<T: crate::traits::SqlBackupRunsService> SqlBackupRunsService for T {
...
/// A dyn-compatible, crate-private version of `SqlConnectService`.
#[async_trait::async_trait]
...
/// All implementations of [crate::traits::SqlConnectService] also implement [SqlConnectService].
#[async_trait::async_trait]
impl<T: crate::traits::SqlConnectService> SqlConnectService for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn get_connect_settings(
        &self,
        req: crate::model::GetConnectSettingsRequest,
...
/// A dyn-compatible, crate-private version of `SqlDatabasesService`.
#[async_trait::async_trait]
...
#[async_trait::async_trait]
impl<T: crate::traits::SqlDatabasesService> SqlDatabasesService for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn delete(
        &self,
        req: crate::model::SqlDatabasesDeleteRequest,
...
/// A dyn-compatible, crate-private version of `SqlFlagsService`.
#[async_trait::async_trait]
...
/// All implementations of [crate::traits::SqlFlagsService] also implement [SqlFlagsService].
#[async_trait::async_trait]
impl<T: crate::traits::SqlFlagsService> SqlFlagsService for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn list(
        &self,
        req: crate::model::SqlFlagsListRequest,
...
/// A dyn-compatible, crate-private version of `SqlInstancesService`.
#[async_trait::async_trait]
...
/// All implementations of [crate::traits::SqlInstancesService] also implement [SqlInstancesService].
#[async_trait::async_trait]
impl<T: crate::traits::SqlInstancesService> SqlInstancesService for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn add_server_ca(
        &self,
        req: crate::model::SqlInstancesAddServerCaRequest,
...
/// A dyn-compatible, crate-private version of `SqlOperationsService`.
#[async_trait::async_trait]
...
/// All implementations of [crate::traits::SqlOperationsService] also implement [SqlOperationsService].
#[async_trait::async_trait]
impl<T: crate::traits::SqlOperationsService> SqlOperationsService for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn get(
        &self,
        req: crate::model::SqlOperationsGetRequest,
...
/// A dyn-compatible, crate-private version of `SqlSslCertsService`.
#[async_trait::async_trait]
...
/// All implementations of [crate::traits::SqlSslCertsService] also implement [SqlSslCertsService].
#[async_trait::async_trait]
impl<T: crate::traits::SqlSslCertsService> SqlSslCertsService for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn delete(
        &self,
        req: crate::model::SqlSslCertsDeleteRequest,
...
/// A dyn-compatible, crate-private version of `SqlTiersService`.
#[async_trait::async_trait]
...
/// All implementations of [crate::traits::SqlTiersService] also implement [SqlTiersService].
#[async_trait::async_trait]
impl<T: crate::traits::SqlTiersService> SqlTiersService for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn list(
        &self,
        req: crate::model::SqlTiersListRequest,
...
/// A dyn-compatible, crate-private version of `SqlUsersService`.
#[async_trait::async_trait]
...
#[async_trait::async_trait]
impl<T: crate::traits::SqlUsersService> SqlUsersService for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn delete(
        &self,
        req: crate::model::SqlUsersDeleteRequest,
