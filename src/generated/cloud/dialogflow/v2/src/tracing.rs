...
/// Implements a [Agents](super::stubs::Agents) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Agents<T>
where
    T: super::stubs::Agents + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Agents for Agents<T>
where
    T: super::stubs::Agents + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [AnswerRecords](super::stubs::AnswerRecords) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AnswerRecords<T>
where
    T: super::stubs::AnswerRecords + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::AnswerRecords for AnswerRecords<T>
where
    T: super::stubs::AnswerRecords + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Contexts](super::stubs::Contexts) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Contexts<T>
where
    T: super::stubs::Contexts + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Contexts for Contexts<T>
where
    T: super::stubs::Contexts + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Conversations](super::stubs::Conversations) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Conversations<T>
where
    T: super::stubs::Conversations + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Conversations for Conversations<T>
where
    T: super::stubs::Conversations + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [ConversationDatasets](super::stubs::ConversationDatasets) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ConversationDatasets<T>
where
    T: super::stubs::ConversationDatasets + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ConversationDatasets for ConversationDatasets<T>
where
    T: super::stubs::ConversationDatasets + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [ConversationModels](super::stubs::ConversationModels) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ConversationModels<T>
where
    T: super::stubs::ConversationModels + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ConversationModels for ConversationModels<T>
where
    T: super::stubs::ConversationModels + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [ConversationProfiles](super::stubs::ConversationProfiles) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ConversationProfiles<T>
where
    T: super::stubs::ConversationProfiles + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ConversationProfiles for ConversationProfiles<T>
where
    T: super::stubs::ConversationProfiles + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Documents](super::stubs::Documents) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Documents<T>
where
    T: super::stubs::Documents + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Documents for Documents<T>
where
    T: super::stubs::Documents + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [EncryptionSpecService](super::stubs::EncryptionSpecService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct EncryptionSpecService<T>
where
    T: super::stubs::EncryptionSpecService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::EncryptionSpecService for EncryptionSpecService<T>
where
    T: super::stubs::EncryptionSpecService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [EntityTypes](super::stubs::EntityTypes) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct EntityTypes<T>
where
    T: super::stubs::EntityTypes + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::EntityTypes for EntityTypes<T>
where
    T: super::stubs::EntityTypes + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Environments](super::stubs::Environments) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Environments<T>
where
    T: super::stubs::Environments + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Environments for Environments<T>
where
    T: super::stubs::Environments + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Fulfillments](super::stubs::Fulfillments) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Fulfillments<T>
where
    T: super::stubs::Fulfillments + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Fulfillments for Fulfillments<T>
where
    T: super::stubs::Fulfillments + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Generators](super::stubs::Generators) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Generators<T>
where
    T: super::stubs::Generators + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Generators for Generators<T>
where
    T: super::stubs::Generators + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Intents](super::stubs::Intents) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Intents<T>
where
    T: super::stubs::Intents + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Intents for Intents<T>
where
    T: super::stubs::Intents + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [KnowledgeBases](super::stubs::KnowledgeBases) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct KnowledgeBases<T>
where
    T: super::stubs::KnowledgeBases + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::KnowledgeBases for KnowledgeBases<T>
where
    T: super::stubs::KnowledgeBases + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Participants](super::stubs::Participants) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Participants<T>
where
    T: super::stubs::Participants + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Participants for Participants<T>
where
    T: super::stubs::Participants + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Sessions](super::stubs::Sessions) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Sessions<T>
where
    T: super::stubs::Sessions + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Sessions for Sessions<T>
where
    T: super::stubs::Sessions + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [SessionEntityTypes](super::stubs::SessionEntityTypes) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SessionEntityTypes<T>
where
    T: super::stubs::SessionEntityTypes + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::SessionEntityTypes for SessionEntityTypes<T>
where
    T: super::stubs::SessionEntityTypes + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
