...
where T: super::stub::GeneratorEvaluations + std::fmt::Debug + Send + Sync {
    inner: T,
}
...
where T: super::stub::SipTrunks + std::fmt::Debug + Send + Sync {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct Tools<T>
where T: super::stub::Tools + std::fmt::Debug + Send + Sync {
    inner: T,
}
