...
/// Implements [AnswerRecords](crate::stubs::AnswerRecords) using a [gax::http_client::ReqwestClient].
#[derive(Clone)]
        ...
        let builder = self
            ...
            .builder(
                ...
                format!(
                    ...
                    req.answer_record
                        .as_ref()
                        .ok_or_else(|| gax::path_parameter::missing("answer_record"))?
                        .name
                ),
            )
            .query(&[("$alt", "json;enum-encoding=int")])
...
/// Implements [Contexts](crate::stubs::Contexts) using a [gax::http_client::ReqwestClient].
#[derive(Clone)]
pub struct Contexts {
    inner: gax::http_client::ReqwestClient,
}
...
/// Implements [Conversations](crate::stubs::Conversations) using a [gax::http_client::ReqwestClient].
#[derive(Clone)]
            ...
            .builder(
                ...
                format!(
                    ...
                    req.stateless_conversation
                        .as_ref()
                        .ok_or_else(|| gax::path_parameter::missing("stateless_conversation"))?
                        .parent
                ),
            )
            .query(&[("$alt", "json;enum-encoding=int")])
...
/// Implements [ConversationDatasets](crate::stubs::ConversationDatasets) using a [gax::http_client::ReqwestClient].
#[derive(Clone)]
...
/// Implements [ConversationModels](crate::stubs::ConversationModels) using a [gax::http_client::ReqwestClient].
#[derive(Clone)]
...
/// Implements [ConversationProfiles](crate::stubs::ConversationProfiles) using a [gax::http_client::ReqwestClient].
#[derive(Clone)]
            ...
            .builder(
                ...
                format!(
                    ...
                    req.conversation_profile
                        .as_ref()
                        .ok_or_else(|| gax::path_parameter::missing("conversation_profile"))?
                        .name
                ),
            )
            .query(&[("$alt", "json;enum-encoding=int")])
...
/// Implements [Documents](crate::stubs::Documents) using a [gax::http_client::ReqwestClient].
#[derive(Clone)]
...
/// Implements [EncryptionSpecService](crate::stubs::EncryptionSpecService) using a [gax::http_client::ReqwestClient].
#[derive(Clone)]
...
/// Implements [Fulfillments](crate::stubs::Fulfillments) using a [gax::http_client::ReqwestClient].
#[derive(Clone)]
        ...
        let builder = self
            ...
            .builder(
                ...
                format!(
                    ...
                    req.fulfillment
                        .as_ref()
                        .ok_or_else(|| gax::path_parameter::missing("fulfillment"))?
                        .name
                ),
            )
            .query(&[("$alt", "json;enum-encoding=int")])
...
/// Implements [KnowledgeBases](crate::stubs::KnowledgeBases) using a [gax::http_client::ReqwestClient].
#[derive(Clone)]
        ...
        let builder = self
            ...
            .builder(
                ...
                format!(
                    ...
                    req.knowledge_base
                        .as_ref()
                        .ok_or_else(|| gax::path_parameter::missing("knowledge_base"))?
                        .name
                ),
            )
            .query(&[("$alt", "json;enum-encoding=int")])
...
/// Implements [Participants](crate::stubs::Participants) using a [gax::http_client::ReqwestClient].
#[derive(Clone)]
        ...
        let builder = self
            ...
            .builder(
                ...
                format!(
                    ...
                    req.participant
                        .as_ref()
                        .ok_or_else(|| gax::path_parameter::missing("participant"))?
                        .name
                ),
            )
            .query(&[("$alt", "json;enum-encoding=int")])
