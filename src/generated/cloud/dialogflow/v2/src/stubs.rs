...
pub trait Agents: std::fmt::Debug + Send + Sync {
    ...
    /// Implements [crate::client::Agents::set_agent].
    fn set_agent(
        &self,
    ...
    /// Implements [crate::client::Agents::search_agents].
    fn search_agents(
        &self,
        _req: crate::model::SearchAgentsRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::SearchAgentsResponse>> + Send
    {
        std::future::ready::<crate::Result<crate::model::SearchAgentsResponse>>(Err(Error::other(
            "unimplemented",
        )))
    }

    /// Implements [crate::client::Agents::train_agent].
    fn train_agent(
        &self,
    ...
    /// Implements [crate::client::Agents::import_agent].
    fn import_agent(
        &self,
    ...
    /// Implements [crate::client::Agents::get_validation_result].
    fn get_validation_result(
        &self,
        _req: crate::model::GetValidationResultRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::ValidationResult>> + Send
    {
        std::future::ready::<crate::Result<crate::model::ValidationResult>>(Err(Error::other(
            "unimplemented",
        )))
    }
...
/// Defines the trait used to implement [crate::client::AnswerRecords].
///
/// Application developers may need to implement this trait to mock
...
pub trait AnswerRecords: std::fmt::Debug + Send + Sync {
    /// Implements [crate::client::AnswerRecords::list_answer_records].
    fn list_answer_records(
        &self,
        _req: crate::model::ListAnswerRecordsRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::ListAnswerRecordsResponse>> + Send
    {
        std::future::ready::<crate::Result<crate::model::ListAnswerRecordsResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }

    /// Implements [crate::client::AnswerRecords::update_answer_record].
    fn update_answer_record(
        &self,
        _req: crate::model::UpdateAnswerRecordRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::AnswerRecord>> + Send {
        std::future::ready::<crate::Result<crate::model::AnswerRecord>>(Err(Error::other(
            "unimplemented",
        )))
    }

    /// Implements [crate::client::AnswerRecords::list_locations].
    fn list_locations(
        &self,
        _req: location::model::ListLocationsRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::AnswerRecords::get_location].
    fn get_location(
        &self,
        _req: location::model::GetLocationRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::AnswerRecords::list_operations].
    fn list_operations(
        &self,
        _req: longrunning::model::ListOperationsRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::AnswerRecords::get_operation].
    fn get_operation(
        &self,
        _req: longrunning::model::GetOperationRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::AnswerRecords::cancel_operation].
    fn cancel_operation(
        &self,
        _req: longrunning::model::CancelOperationRequest,
        _options: gax::options::RequestOptions,
...
/// Defines the trait used to implement [crate::client::Contexts].
///
/// Application developers may need to implement this trait to mock
...
pub trait Contexts: std::fmt::Debug + Send + Sync {
    /// Implements [crate::client::Contexts::list_contexts].
    fn list_contexts(
        &self,
    ...
    /// Implements [crate::client::Contexts::get_context].
    fn get_context(
        &self,
    ...
    /// Implements [crate::client::Contexts::create_context].
    fn create_context(
        &self,
    ...
    /// Implements [crate::client::Contexts::update_context].
    fn update_context(
        &self,
    ...
    /// Implements [crate::client::Contexts::delete_context].
    fn delete_context(
        &self,
    ...
    /// Implements [crate::client::Contexts::delete_all_contexts].
    ...
    /// Implements [crate::client::Contexts::list_locations].
    fn list_locations(
        &self,
        _req: location::model::ListLocationsRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::Contexts::get_location].
    fn get_location(
        &self,
        _req: location::model::GetLocationRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::Contexts::list_operations].
    fn list_operations(
        &self,
        _req: longrunning::model::ListOperationsRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::Contexts::get_operation].
    fn get_operation(
        &self,
        _req: longrunning::model::GetOperationRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::Contexts::cancel_operation].
    fn cancel_operation(
        &self,
        _req: longrunning::model::CancelOperationRequest,
        _options: gax::options::RequestOptions,
...
/// Defines the trait used to implement [crate::client::Conversations].
///
/// Application developers may need to implement this trait to mock
...
pub trait Conversations: std::fmt::Debug + Send + Sync {
    /// Implements [crate::client::Conversations::create_conversation].
    ...
    /// Implements [crate::client::Conversations::list_conversations].
    ...
    /// Implements [crate::client::Conversations::get_conversation].
    fn get_conversation(
        &self,
    ...
    /// Implements [crate::client::Conversations::complete_conversation].
    ...
    fn list_messages(
        ...
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::ListMessagesResponse>> + Send
    {
        std::future::ready::<crate::Result<crate::model::ListMessagesResponse>>(Err(Error::other(
            "unimplemented",
        )))
    }

    /// Implements [crate::client::Conversations::suggest_conversation_summary].
    fn suggest_conversation_summary(
        &self,
        _req: crate::model::SuggestConversationSummaryRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<
        Output = crate::Result<crate::model::SuggestConversationSummaryResponse>,
    > + Send {
        std::future::ready::<crate::Result<crate::model::SuggestConversationSummaryResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }

    /// Implements [crate::client::Conversations::generate_stateless_summary].
    fn generate_stateless_summary(
        &self,
        _req: crate::model::GenerateStatelessSummaryRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<
        Output = crate::Result<crate::model::GenerateStatelessSummaryResponse>,
    > + Send {
        std::future::ready::<crate::Result<crate::model::GenerateStatelessSummaryResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }

    /// Implements [crate::client::Conversations::generate_stateless_suggestion].
    fn generate_stateless_suggestion(
        &self,
        _req: crate::model::GenerateStatelessSuggestionRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<
        Output = crate::Result<crate::model::GenerateStatelessSuggestionResponse>,
    > + Send {
        std::future::ready::<crate::Result<crate::model::GenerateStatelessSuggestionResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }

    /// Implements [crate::client::Conversations::search_knowledge].
    fn search_knowledge(
        &self,
    ...
    /// Implements [crate::client::Conversations::list_locations].
    fn list_locations(
        &self,
        _req: location::model::ListLocationsRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::Conversations::get_location].
    fn get_location(
        &self,
        _req: location::model::GetLocationRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::Conversations::list_operations].
    fn list_operations(
        &self,
        _req: longrunning::model::ListOperationsRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::Conversations::get_operation].
    fn get_operation(
        &self,
        _req: longrunning::model::GetOperationRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::Conversations::cancel_operation].
    fn cancel_operation(
        &self,
        _req: longrunning::model::CancelOperationRequest,
        _options: gax::options::RequestOptions,
...
/// Defines the trait used to implement [crate::client::ConversationDatasets].
///
/// Application developers may need to implement this trait to mock
...
pub trait ConversationDatasets: std::fmt::Debug + Send + Sync {
    /// Implements [crate::client::ConversationDatasets::create_conversation_dataset].
    ...
    /// Implements [crate::client::ConversationDatasets::get_conversation_dataset].
    fn get_conversation_dataset(
        &self,
        _req: crate::model::GetConversationDatasetRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::ConversationDataset>> + Send
    {
        std::future::ready::<crate::Result<crate::model::ConversationDataset>>(Err(Error::other(
            "unimplemented",
        )))
    }

    /// Implements [crate::client::ConversationDatasets::list_conversation_datasets].
    fn list_conversation_datasets(
        &self,
        _req: crate::model::ListConversationDatasetsRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<
        Output = crate::Result<crate::model::ListConversationDatasetsResponse>,
    > + Send {
        std::future::ready::<crate::Result<crate::model::ListConversationDatasetsResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }

    /// Implements [crate::client::ConversationDatasets::delete_conversation_dataset].
    ...
    /// Implements [crate::client::ConversationDatasets::import_conversation_data].
    ...
    /// Implements [crate::client::ConversationDatasets::list_locations].
    fn list_locations(
        &self,
        _req: location::model::ListLocationsRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::ConversationDatasets::get_location].
    fn get_location(
        &self,
        _req: location::model::GetLocationRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::ConversationDatasets::list_operations].
    fn list_operations(
        &self,
        _req: longrunning::model::ListOperationsRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::ConversationDatasets::get_operation].
    fn get_operation(
        &self,
        _req: longrunning::model::GetOperationRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::ConversationDatasets::cancel_operation].
    fn cancel_operation(
        &self,
        _req: longrunning::model::CancelOperationRequest,
        _options: gax::options::RequestOptions,
...
/// Defines the trait used to implement [crate::client::ConversationModels].
///
/// Application developers may need to implement this trait to mock
...
pub trait ConversationModels: std::fmt::Debug + Send + Sync {
    /// Implements [crate::client::ConversationModels::create_conversation_model].
    ...
    /// Implements [crate::client::ConversationModels::get_conversation_model].
    fn get_conversation_model(
        &self,
        _req: crate::model::GetConversationModelRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::ConversationModel>> + Send
    {
        std::future::ready::<crate::Result<crate::model::ConversationModel>>(Err(Error::other(
            "unimplemented",
        )))
    }

    /// Implements [crate::client::ConversationModels::list_conversation_models].
    fn list_conversation_models(
        &self,
        _req: crate::model::ListConversationModelsRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::ListConversationModelsResponse>>
           + Send {
        std::future::ready::<crate::Result<crate::model::ListConversationModelsResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }

    /// Implements [crate::client::ConversationModels::delete_conversation_model].
    ...
    /// Implements [crate::client::ConversationModels::deploy_conversation_model].
    ...
    /// Implements [crate::client::ConversationModels::undeploy_conversation_model].
    ...
    /// Implements [crate::client::ConversationModels::get_conversation_model_evaluation].
    fn get_conversation_model_evaluation(
        &self,
        _req: crate::model::GetConversationModelEvaluationRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::ConversationModelEvaluation>> + Send
    {
        std::future::ready::<crate::Result<crate::model::ConversationModelEvaluation>>(Err(
            Error::other("unimplemented"),
        ))
    }

    /// Implements [crate::client::ConversationModels::list_conversation_model_evaluations].
    fn list_conversation_model_evaluations(
        &self,
        _req: crate::model::ListConversationModelEvaluationsRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<
        Output = crate::Result<crate::model::ListConversationModelEvaluationsResponse>,
    > + Send {
        std::future::ready::<crate::Result<crate::model::ListConversationModelEvaluationsResponse>>(
            Err(Error::other("unimplemented")),
        )
    }

    /// Implements [crate::client::ConversationModels::create_conversation_model_evaluation].
    ...
    /// Implements [crate::client::ConversationModels::list_locations].
    fn list_locations(
        &self,
        _req: location::model::ListLocationsRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::ConversationModels::get_location].
    fn get_location(
        &self,
        _req: location::model::GetLocationRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::ConversationModels::list_operations].
    fn list_operations(
        &self,
        _req: longrunning::model::ListOperationsRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::ConversationModels::get_operation].
    fn get_operation(
        &self,
        _req: longrunning::model::GetOperationRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::ConversationModels::cancel_operation].
    fn cancel_operation(
        &self,
        _req: longrunning::model::CancelOperationRequest,
        _options: gax::options::RequestOptions,
...
/// Defines the trait used to implement [crate::client::ConversationProfiles].
///
/// Application developers may need to implement this trait to mock
...
pub trait ConversationProfiles: std::fmt::Debug + Send + Sync {
    /// Implements [crate::client::ConversationProfiles::list_conversation_profiles].
    fn list_conversation_profiles(
        &self,
        _req: crate::model::ListConversationProfilesRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<
        Output = crate::Result<crate::model::ListConversationProfilesResponse>,
    > + Send {
        std::future::ready::<crate::Result<crate::model::ListConversationProfilesResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }

    /// Implements [crate::client::ConversationProfiles::get_conversation_profile].
    fn get_conversation_profile(
        &self,
        _req: crate::model::GetConversationProfileRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::ConversationProfile>> + Send
    {
        std::future::ready::<crate::Result<crate::model::ConversationProfile>>(Err(Error::other(
            "unimplemented",
        )))
    }

    /// Implements [crate::client::ConversationProfiles::create_conversation_profile].
    ...
    /// Implements [crate::client::ConversationProfiles::update_conversation_profile].
    ...
    /// Implements [crate::client::ConversationProfiles::delete_conversation_profile].
    ...
    /// Implements [crate::client::ConversationProfiles::set_suggestion_feature_config].
    ...
    /// Implements [crate::client::ConversationProfiles::clear_suggestion_feature_config].
    ...
    /// Implements [crate::client::ConversationProfiles::list_locations].
    fn list_locations(
        &self,
        _req: location::model::ListLocationsRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::ConversationProfiles::get_location].
    fn get_location(
        &self,
        _req: location::model::GetLocationRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::ConversationProfiles::list_operations].
    fn list_operations(
        &self,
        _req: longrunning::model::ListOperationsRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::ConversationProfiles::get_operation].
    fn get_operation(
        &self,
        _req: longrunning::model::GetOperationRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::ConversationProfiles::cancel_operation].
    fn cancel_operation(
        &self,
        _req: longrunning::model::CancelOperationRequest,
        _options: gax::options::RequestOptions,
...
/// Defines the trait used to implement [crate::client::Documents].
///
/// Application developers may need to implement this trait to mock
...
pub trait Documents: std::fmt::Debug + Send + Sync {
    /// Implements [crate::client::Documents::list_documents].
    fn list_documents(
        &self,
    ...
    /// Implements [crate::client::Documents::get_document].
    fn get_document(
        &self,
    ...
    /// Implements [crate::client::Documents::create_document].
    fn create_document(
        &self,
    ...
    /// Implements [crate::client::Documents::import_documents].
    fn import_documents(
        &self,
    ...
    /// Implements [crate::client::Documents::delete_document].
    fn delete_document(
        &self,
    ...
    /// Implements [crate::client::Documents::update_document].
    fn update_document(
        &self,
    ...
    /// Implements [crate::client::Documents::reload_document].
    fn reload_document(
        &self,
    ...
    /// Implements [crate::client::Documents::export_document].
    fn export_document(
        &self,
    ...
    /// Implements [crate::client::Documents::list_locations].
    fn list_locations(
        &self,
        _req: location::model::ListLocationsRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::Documents::get_location].
    fn get_location(
        &self,
        _req: location::model::GetLocationRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::Documents::list_operations].
    fn list_operations(
        &self,
        _req: longrunning::model::ListOperationsRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::Documents::get_operation].
    fn get_operation(
        &self,
        _req: longrunning::model::GetOperationRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::Documents::cancel_operation].
    fn cancel_operation(
        &self,
        _req: longrunning::model::CancelOperationRequest,
        _options: gax::options::RequestOptions,
...
/// Defines the trait used to implement [crate::client::EncryptionSpecService].
///
/// Application developers may need to implement this trait to mock
...
pub trait EncryptionSpecService: std::fmt::Debug + Send + Sync {
    /// Implements [crate::client::EncryptionSpecService::get_encryption_spec].
    fn get_encryption_spec(
        &self,
        _req: crate::model::GetEncryptionSpecRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::EncryptionSpec>> + Send {
        std::future::ready::<crate::Result<crate::model::EncryptionSpec>>(Err(Error::other(
            "unimplemented",
        )))
    }

    /// Implements [crate::client::EncryptionSpecService::initialize_encryption_spec].
    ...
    /// Implements [crate::client::EncryptionSpecService::list_locations].
    fn list_locations(
        &self,
        _req: location::model::ListLocationsRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::EncryptionSpecService::get_location].
    fn get_location(
        &self,
        _req: location::model::GetLocationRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::EncryptionSpecService::list_operations].
    fn list_operations(
        &self,
        _req: longrunning::model::ListOperationsRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::EncryptionSpecService::get_operation].
    fn get_operation(
        &self,
        _req: longrunning::model::GetOperationRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::EncryptionSpecService::cancel_operation].
    fn cancel_operation(
        &self,
        _req: longrunning::model::CancelOperationRequest,
        _options: gax::options::RequestOptions,
...
pub trait EntityTypes: std::fmt::Debug + Send + Sync {
    ...
    /// Implements [crate::client::EntityTypes::batch_update_entity_types].
    ...
    /// Implements [crate::client::EntityTypes::batch_delete_entity_types].
    ...
    /// Implements [crate::client::EntityTypes::batch_create_entities].
    ...
    /// Implements [crate::client::EntityTypes::batch_update_entities].
    ...
    /// Implements [crate::client::EntityTypes::batch_delete_entities].
...
pub trait Environments: std::fmt::Debug + Send + Sync {
    ...
    /// Implements [crate::client::Environments::get_environment_history].
    fn get_environment_history(
        &self,
        _req: crate::model::GetEnvironmentHistoryRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::EnvironmentHistory>> + Send
    {
        std::future::ready::<crate::Result<crate::model::EnvironmentHistory>>(Err(Error::other(
            "unimplemented",
        )))
    }
...
/// Defines the trait used to implement [crate::client::Fulfillments].
///
/// Application developers may need to implement this trait to mock
...
pub trait Fulfillments: std::fmt::Debug + Send + Sync {
    /// Implements [crate::client::Fulfillments::get_fulfillment].
    fn get_fulfillment(
        &self,
        _req: crate::model::GetFulfillmentRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::Fulfillment>> + Send {
        std::future::ready::<crate::Result<crate::model::Fulfillment>>(Err(Error::other(
            "unimplemented",
        )))
    }

    /// Implements [crate::client::Fulfillments::update_fulfillment].
    ...
    /// Implements [crate::client::Fulfillments::list_locations].
    fn list_locations(
        &self,
        _req: location::model::ListLocationsRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::Fulfillments::get_location].
    fn get_location(
        &self,
        _req: location::model::GetLocationRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::Fulfillments::list_operations].
    fn list_operations(
        &self,
        _req: longrunning::model::ListOperationsRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::Fulfillments::get_operation].
    fn get_operation(
        &self,
        _req: longrunning::model::GetOperationRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::Fulfillments::cancel_operation].
    fn cancel_operation(
        &self,
        _req: longrunning::model::CancelOperationRequest,
        _options: gax::options::RequestOptions,
...
pub trait Intents: std::fmt::Debug + Send + Sync {
    ...
    /// Implements [crate::client::Intents::batch_update_intents].
    ...
    /// Implements [crate::client::Intents::batch_delete_intents].
...
/// Defines the trait used to implement [crate::client::KnowledgeBases].
///
/// Application developers may need to implement this trait to mock
...
pub trait KnowledgeBases: std::fmt::Debug + Send + Sync {
    /// Implements [crate::client::KnowledgeBases::list_knowledge_bases].
    fn list_knowledge_bases(
        &self,
        _req: crate::model::ListKnowledgeBasesRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::ListKnowledgeBasesResponse>> + Send
    {
        std::future::ready::<crate::Result<crate::model::ListKnowledgeBasesResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }

    /// Implements [crate::client::KnowledgeBases::get_knowledge_base].
    fn get_knowledge_base(
        &self,
        _req: crate::model::GetKnowledgeBaseRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::KnowledgeBase>> + Send {
        std::future::ready::<crate::Result<crate::model::KnowledgeBase>>(Err(Error::other(
            "unimplemented",
        )))
    }

    /// Implements [crate::client::KnowledgeBases::create_knowledge_base].
    ...
    /// Implements [crate::client::KnowledgeBases::delete_knowledge_base].
    ...
    /// Implements [crate::client::KnowledgeBases::update_knowledge_base].
    ...
    /// Implements [crate::client::KnowledgeBases::list_locations].
    fn list_locations(
        &self,
        _req: location::model::ListLocationsRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::KnowledgeBases::get_location].
    fn get_location(
        &self,
        _req: location::model::GetLocationRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::KnowledgeBases::list_operations].
    fn list_operations(
        &self,
        _req: longrunning::model::ListOperationsRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::KnowledgeBases::get_operation].
    fn get_operation(
        &self,
        _req: longrunning::model::GetOperationRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::KnowledgeBases::cancel_operation].
    fn cancel_operation(
        &self,
        _req: longrunning::model::CancelOperationRequest,
        _options: gax::options::RequestOptions,
...
/// Defines the trait used to implement [crate::client::Participants].
///
/// Application developers may need to implement this trait to mock
...
pub trait Participants: std::fmt::Debug + Send + Sync {
    /// Implements [crate::client::Participants::create_participant].
    fn create_participant(
        &self,
        _req: crate::model::CreateParticipantRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::Participant>> + Send {
        std::future::ready::<crate::Result<crate::model::Participant>>(Err(Error::other(
            "unimplemented",
        )))
    }

    /// Implements [crate::client::Participants::get_participant].
    fn get_participant(
        &self,
    ...
    /// Implements [crate::client::Participants::list_participants].
    fn list_participants(
        &self,
        _req: crate::model::ListParticipantsRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::ListParticipantsResponse>> + Send
    {
        std::future::ready::<crate::Result<crate::model::ListParticipantsResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }

    /// Implements [crate::client::Participants::update_participant].
    ...
    /// Implements [crate::client::Participants::analyze_content].
    fn analyze_content(
        &self,
        _req: crate::model::AnalyzeContentRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::AnalyzeContentResponse>> + Send
    {
        std::future::ready::<crate::Result<crate::model::AnalyzeContentResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }

    /// Implements [crate::client::Participants::suggest_articles].
    fn suggest_articles(
        &self,
        _req: crate::model::SuggestArticlesRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::SuggestArticlesResponse>> + Send
    {
        std::future::ready::<crate::Result<crate::model::SuggestArticlesResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }

    /// Implements [crate::client::Participants::suggest_faq_answers].
    fn suggest_faq_answers(
        &self,
        _req: crate::model::SuggestFaqAnswersRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::SuggestFaqAnswersResponse>> + Send
    {
        std::future::ready::<crate::Result<crate::model::SuggestFaqAnswersResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }

    /// Implements [crate::client::Participants::suggest_smart_replies].
    fn suggest_smart_replies(
        &self,
        _req: crate::model::SuggestSmartRepliesRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::SuggestSmartRepliesResponse>> + Send
    {
        std::future::ready::<crate::Result<crate::model::SuggestSmartRepliesResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }

    /// Implements [crate::client::Participants::suggest_knowledge_assist].
    fn suggest_knowledge_assist(
        &self,
        _req: crate::model::SuggestKnowledgeAssistRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<crate::model::SuggestKnowledgeAssistResponse>>
           + Send {
        std::future::ready::<crate::Result<crate::model::SuggestKnowledgeAssistResponse>>(Err(
            Error::other("unimplemented"),
        ))
    }

    /// Implements [crate::client::Participants::list_locations].
    fn list_locations(
        &self,
        _req: location::model::ListLocationsRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::Participants::get_location].
    fn get_location(
        &self,
        _req: location::model::GetLocationRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::Participants::list_operations].
    fn list_operations(
        &self,
        _req: longrunning::model::ListOperationsRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::Participants::get_operation].
    fn get_operation(
        &self,
        _req: longrunning::model::GetOperationRequest,
        _options: gax::options::RequestOptions,
    ...
    /// Implements [crate::client::Participants::cancel_operation].
    fn cancel_operation(
        &self,
        _req: longrunning::model::CancelOperationRequest,
        _options: gax::options::RequestOptions,
