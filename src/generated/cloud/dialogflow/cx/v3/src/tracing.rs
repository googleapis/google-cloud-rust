...
/// Implements a [Changelogs](super::stubs::Changelogs) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Changelogs<T>
where
    T: super::stubs::Changelogs + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Changelogs for Changelogs<T>
where
    T: super::stubs::Changelogs + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Deployments](super::stubs::Deployments) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Deployments<T>
where
    T: super::stubs::Deployments + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Deployments for Deployments<T>
where
    T: super::stubs::Deployments + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Experiments](super::stubs::Experiments) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Experiments<T>
where
    T: super::stubs::Experiments + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Experiments for Experiments<T>
where
    T: super::stubs::Experiments + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Flows](super::stubs::Flows) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Flows<T>
where
    T: super::stubs::Flows + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Flows for Flows<T>
where
    T: super::stubs::Flows + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Pages](super::stubs::Pages) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Pages<T>
where
    T: super::stubs::Pages + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Pages for Pages<T>
where
    T: super::stubs::Pages + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [SecuritySettingsService](super::stubs::SecuritySettingsService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SecuritySettingsService<T>
where
    T: super::stubs::SecuritySettingsService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::SecuritySettingsService for SecuritySettingsService<T>
where
    T: super::stubs::SecuritySettingsService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [TestCases](super::stubs::TestCases) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct TestCases<T>
where
    T: super::stubs::TestCases + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::TestCases for TestCases<T>
where
    T: super::stubs::TestCases + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [TransitionRouteGroups](super::stubs::TransitionRouteGroups) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct TransitionRouteGroups<T>
where
    T: super::stubs::TransitionRouteGroups + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::TransitionRouteGroups for TransitionRouteGroups<T>
where
    T: super::stubs::TransitionRouteGroups + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Webhooks](super::stubs::Webhooks) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Webhooks<T>
where
    T: super::stubs::Webhooks + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Webhooks for Webhooks<T>
where
    T: super::stubs::Webhooks + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
