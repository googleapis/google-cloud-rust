...
/// Implements a [CloudBilling](crate::stubs::CloudBilling) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudBilling<T>
where
    T: crate::stubs::CloudBilling + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::CloudBilling for CloudBilling<T>
where
    T: crate::stubs::CloudBilling + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [CloudCatalog](crate::stubs::CloudCatalog) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudCatalog<T>
where
    T: crate::stubs::CloudCatalog + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::CloudCatalog for CloudCatalog<T>
where
    T: crate::stubs::CloudCatalog + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
