...
/// Implements a [CloudBilling](super::stubs::CloudBilling) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudBilling<T>
where
    T: super::stubs::CloudBilling + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::CloudBilling for CloudBilling<T>
where
    T: super::stubs::CloudBilling + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [CloudCatalog](super::stubs::CloudCatalog) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudCatalog<T>
where
    T: super::stubs::CloudCatalog + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::CloudCatalog for CloudCatalog<T>
where
    T: super::stubs::CloudCatalog + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
