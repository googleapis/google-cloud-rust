...
impl serde::ser::Serialize for super::PricingInfo {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if !wkt::internal::is_default(&self.currency_conversion_rate) {
            ...
            state.serialize_entry("currencyConversionRate", &__With(&self.currency_conversion_rate))?;
        }
        if !self._unknown_fields.is_empty() {
            for (key, value) in self._unknown_fields.iter() {
                state.serialize_entry(key, &value)?;
...
impl serde::ser::Serialize for super::PricingExpression {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if !wkt::internal::is_default(&self.base_unit_conversion_factor) {
            ...
            state.serialize_entry("baseUnitConversionFactor", &__With(&self.base_unit_conversion_factor))?;
        }
        if !self._unknown_fields.is_empty() {
            for (key, value) in self._unknown_fields.iter() {
                state.serialize_entry(key, &value)?;
