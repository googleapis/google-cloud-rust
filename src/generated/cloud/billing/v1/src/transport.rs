    ...
    async fn list_billing_accounts(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/billingAccounts";
            ...
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/billingAccounts";
            ...
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/subAccounts";
    ...
    async fn list_project_billing_info(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}/projects";
    ...
    async fn get_project_billing_info(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}/billingInfo";
    ...
    async fn move_billing_account(
        ...
        let (builder, method, _path_template, resource_name) = None
            ...
            .or_else(|| {
                ...
                let _path_template = "/v1/{destination_parent}/{name}:move";

                let resource_name =
                    format!("//cloudbilling.googleapis.com/{}", var_destination_parent,);
                let builder = self.inner.builder(Method::GET, path);
                let builder = Ok(builder);
                Some(builder.map(|b| (b, Method::GET, _path_template, resource_name)))
            })
    ...
    async fn list_skus(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/skus";
