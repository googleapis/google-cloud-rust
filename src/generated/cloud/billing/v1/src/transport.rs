    ...
    async fn get_billing_account(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//cloudbilling.googleapis.com/v1/{}", var_name,);
    ...
    async fn list_project_billing_info(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//cloudbilling.googleapis.com/v1/{}/projects", var_name,);
    ...
    async fn get_project_billing_info(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//cloudbilling.googleapis.com/v1/{}/billingInfo", var_name,);
    ...
    async fn get_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//cloudbilling.googleapis.com/v1/{}", var_resource,);
        ...
        let (builder, method, resource_name) = None
            ...
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//cloudbilling.googleapis.com/v1/{}/{}",
    ...
    async fn list_skus(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//cloudbilling.googleapis.com/v1/{}/skus", var_parent,);
