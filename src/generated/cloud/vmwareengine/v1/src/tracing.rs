...
/// Implements a [VmwareEngine](super::stubs::VmwareEngine) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct VmwareEngine<T>
where
    T: super::stubs::VmwareEngine + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::VmwareEngine for VmwareEngine<T>
where
    T: super::stubs::VmwareEngine + std::fmt::Debug + Send + Sync,
{
