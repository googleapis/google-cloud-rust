...
/// Implements a [VmwareEngine](crate::stubs::VmwareEngine) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct VmwareEngine<T>
where
    T: crate::stubs::VmwareEngine + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::VmwareEngine for VmwareEngine<T>
where
    T: crate::stubs::VmwareEngine + std::fmt::Debug + Send + Sync,
{
