...
/// [with_credentials()]: super::builder::vmware_engine::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `VmwareEngine` in
...
impl VmwareEngine {
    ...
    /// ) -> Result<()> {
    ///     let mut list = client.list_private_clouds()
    ///         .set_parent(parent)
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &VmwareEngine, parent: &str
    /// ) -> Result<()> {
    ///     let response = client.create_private_cloud()
    ///         .set_parent(parent)
    ///         .set_private_cloud(
    ///             PrivateCloud::new()/* set fields */
    ///         )
    ...
    ///    client: &VmwareEngine
    /// ) -> Result<()> {
    ///     let mut list = client.fetch_network_policy_external_addresses()
    ///         /* set fields */
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &VmwareEngine, parent: &str
    /// ) -> Result<()> {
    ///     let mut list = client.list_node_types()
    ///         .set_parent(parent)
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &VmwareEngine
    /// ) -> Result<()> {
    ///     let response = client.show_nsx_credentials()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &VmwareEngine
    /// ) -> Result<()> {
    ///     let response = client.show_vcenter_credentials()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &VmwareEngine
    /// ) -> Result<()> {
    ///     let response = client.reset_nsx_credentials()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &VmwareEngine
    /// ) -> Result<()> {
    ///     let response = client.reset_vcenter_credentials()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &VmwareEngine, parent: &str
    /// ) -> Result<()> {
    ///     let response = client.create_network_peering()
    ///         .set_parent(parent)
    ///         .set_network_peering(
    ///             NetworkPeering::new()/* set fields */
    ///         )
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &VmwareEngine
    /// ) -> Result<()> {
    ///     let mut list = client.list_peering_routes()
    ///         /* set fields */
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &VmwareEngine
    /// ) -> Result<()> {
    ///     let response = client.repair_management_dns_zone_binding()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &VmwareEngine
    /// ) -> Result<()> {
    ///     let mut list = client.list_private_connection_peering_routes()
    ///         /* set fields */
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &VmwareEngine
    /// ) -> Result<()> {
    ///     let response = client.grant_dns_bind_permission()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &VmwareEngine
    /// ) -> Result<()> {
    ///     let response = client.revoke_dns_bind_permission()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
