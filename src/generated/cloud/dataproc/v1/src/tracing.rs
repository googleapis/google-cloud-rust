...
/// Implements a [AutoscalingPolicyService](crate::stubs::AutoscalingPolicyService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AutoscalingPolicyService<T>
where
    T: crate::stubs::AutoscalingPolicyService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::AutoscalingPolicyService for AutoscalingPolicyService<T>
where
    T: crate::stubs::AutoscalingPolicyService + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [BatchController](crate::stubs::BatchController) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct BatchController<T>
where
    T: crate::stubs::BatchController + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::BatchController for BatchController<T>
where
    T: crate::stubs::BatchController + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [ClusterController](crate::stubs::ClusterController) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ClusterController<T>
where
    T: crate::stubs::ClusterController + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ClusterController for ClusterController<T>
where
    T: crate::stubs::ClusterController + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [JobController](crate::stubs::JobController) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct JobController<T>
where
    T: crate::stubs::JobController + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::JobController for JobController<T>
where
    T: crate::stubs::JobController + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [NodeGroupController](crate::stubs::NodeGroupController) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct NodeGroupController<T>
where
    T: crate::stubs::NodeGroupController + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::NodeGroupController for NodeGroupController<T>
where
    T: crate::stubs::NodeGroupController + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [SessionTemplateController](crate::stubs::SessionTemplateController) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SessionTemplateController<T>
where
    T: crate::stubs::SessionTemplateController + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::SessionTemplateController for SessionTemplateController<T>
where
    T: crate::stubs::SessionTemplateController + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [SessionController](crate::stubs::SessionController) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SessionController<T>
where
    T: crate::stubs::SessionController + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::SessionController for SessionController<T>
where
    T: crate::stubs::SessionController + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [WorkflowTemplateService](crate::stubs::WorkflowTemplateService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct WorkflowTemplateService<T>
where
    T: crate::stubs::WorkflowTemplateService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::WorkflowTemplateService for WorkflowTemplateService<T>
where
    T: crate::stubs::WorkflowTemplateService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
