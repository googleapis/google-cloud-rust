...
/// [with_credentials()]: super::builder::lustre::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `Lustre` in
...
impl Lustre {
    ...
    /// async fn sample(
    ///    client: &Lustre, project_id: &str, location_id: &str
    /// ) -> Result<()> {
    ///     let mut list = client.list_instances()
    ///         .set_parent(format!("projects/{project_id}/locations/{location_id}"))
    ///         .by_item();
