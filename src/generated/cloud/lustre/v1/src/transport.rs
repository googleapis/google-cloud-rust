...
impl super::stub::Lustre for Lustre {
    async fn list_instances(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//lustre.googleapis.com/{}", var_parent,);
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.lustre.v1.Lustre/ListInstances")
    ...
    async fn get_instance(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.lustre.v1.Lustre/GetInstance")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn create_instance(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.lustre.v1.Lustre/CreateInstance")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn update_instance(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.lustre.v1.Lustre/UpdateInstance")
                    .set_url_template(_path_template),
            );
        }
        let options = google_cloud_gax::options::internal::set_default_idempotency(
    ...
    async fn delete_instance(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.lustre.v1.Lustre/DeleteInstance")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn reschedule_maintenance(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.lustre.v1.Lustre/RescheduleMaintenance")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn import_data(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}:importData", var_name,);
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.lustre.v1.Lustre/ImportData")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn export_data(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}:exportData", var_name,);
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.lustre.v1.Lustre/ExportData")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn create_mirror(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}/mirrors", var_parent,);
                let path_template = "/v1/{parent}/mirrors";

                let resource_name = format!("//lustre.googleapis.com/{}", var_parent,);
                let builder = self.inner.builder(Method::POST, path);
                let builder = builder.query(&[("mirrorId", &req.mirror_id)]);
                let builder = builder.query(&[("requestId", &req.request_id)]);
                let builder = Ok(builder);
                Some(builder.map(|b| (b, Method::POST, path_template, resource_name)))
            })
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.lustre.v1.Lustre/CreateMirror")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
        ...
        let body = gaxi::http::handle_empty(req.mirror, &method);
        self.inner.execute(builder, body, options).await
    }
    ...
    async fn update_mirror(
        ...
        let (builder, method, _path_template) = None
            .or_else(|| {
                let var_mirror_name = try_match(
                    Some(&req)
                        .and_then(|m| m.mirror.as_ref())
                        .map(|m| &m.name)
                        .map(|s| s.as_str()),
                    &[
                        Segment::Literal("projects/"),
                        ...
                        Segment::Literal("/instances/"),
                        Segment::SingleWildcard,
                        Segment::Literal("/mirrors/"),
                        Segment::SingleWildcard,
                    ],
                )?;
                let path = format!("/v1/{}", var_mirror_name,);
                let path_template = "/v1/{mirror.name}";
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.lustre.v1.Lustre/UpdateMirror")
                    .set_url_template(_path_template),
            );
        }
        let options = google_cloud_gax::options::internal::set_default_idempotency(
    ...
    async fn delete_mirror(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.lustre.v1.Lustre/DeleteMirror")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn get_mirror(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.lustre.v1.Lustre/GetMirror")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn list_mirrors(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.lustre.v1.Lustre/ListMirrors")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn create_directory_policy(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}/directoryPolicies", var_parent,);
                let path_template = "/v1/{parent}/directoryPolicies";

                let resource_name = format!("//lustre.googleapis.com/{}", var_parent,);
                let builder = self.inner.builder(Method::POST, path);
                let builder = builder.query(&[("directoryPolicyId", &req.directory_policy_id)]);
                let builder = Ok(builder);
                Some(builder.map(|b| (b, Method::POST, path_template, resource_name)))
            })
            .ok_or_else(|| {
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.lustre.v1.Lustre/CreateDirectoryPolicy")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
        ...
        let body = gaxi::http::handle_empty(req.directory_policy, &method);
        self.inner.execute(builder, body, options).await
    }
    ...
    async fn delete_directory_policy(
            ...
            .or_else(|| {
                let var_name = try_match(
                    ...
                    &[
                        ...
                        Segment::Literal("/instances/"),
                        Segment::SingleWildcard,
                        Segment::Literal("/directoryPolicies/"),
                        Segment::SingleWildcard,
                    ],
                )?;
                let path = format!("/v1/{}", var_name,);
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.lustre.v1.Lustre/DeleteDirectoryPolicy")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn get_directory_policy(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.lustre.v1.Lustre/GetDirectoryPolicy")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn list_directory_policies(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.cloud.lustre.v1.Lustre/ListDirectoryPolicies")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn set_iam_policy(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//lustre.googleapis.com/{}", var_resource,);
