    ...
    async fn update_instance(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//notebooks.googleapis.com/{}", var_instance_name,);
    ...
    async fn check_instance_upgradability(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{notebook_instance}:checkUpgradability";

                let resource_name =
                    format!("//notebooks.googleapis.com/{}", var_notebook_instance,);
                let builder = self.inner.builder(Method::GET, path);
                let builder = Ok(builder);
                Some(builder.map(|b| (b, Method::GET, _path_template, resource_name)))
            })
    ...
    async fn upgrade_instance(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{name}:upgrade";
    ...
    async fn rollback_instance(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{name}:rollback";
    ...
    async fn diagnose_instance(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{name}:diagnose";
