...
impl RollbackInstanceRequest {
    ...
    /// # let location_id = "location_id";
    /// # let instance_id = "instance_id";
    /// let x = RollbackInstanceRequest::new().set_name(format!("projects/{project_id}/locations/{location_id}/instances/{instance_id}"));
    /// ```
    pub fn set_name<T: std::convert::Into<std::string::String>>(mut self, v: T) -> Self {
        self.name = v.into();
        self
...
impl DiagnoseInstanceRequest {
    ...
    /// # let location_id = "location_id";
    /// # let instance_id = "instance_id";
    /// let x = DiagnoseInstanceRequest::new().set_name(format!("projects/{project_id}/locations/{location_id}/instances/{instance_id}"));
    /// ```
    pub fn set_name<T: std::convert::Into<std::string::String>>(mut self, v: T) -> Self {
        self.name = v.into();
        self
