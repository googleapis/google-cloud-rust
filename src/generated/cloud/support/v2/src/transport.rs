        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//cloudsupport.googleapis.com/v2/{}/attachments",
                    var_parent,
                );
    ...
    async fn get_case(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//cloudsupport.googleapis.com/v2/{}", var_name,);
    ...
    async fn list_cases(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//cloudsupport.googleapis.com/v2/{}/cases", var_parent,);
    ...
    async fn list_comments(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//cloudsupport.googleapis.com/v2/{}/comments", var_parent,);
