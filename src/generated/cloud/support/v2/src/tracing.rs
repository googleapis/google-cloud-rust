...
/// Implements a [CaseAttachmentService](super::stubs::CaseAttachmentService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CaseAttachmentService<T>
where
    T: super::stubs::CaseAttachmentService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::CaseAttachmentService for CaseAttachmentService<T>
where
    T: super::stubs::CaseAttachmentService + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [CaseService](super::stubs::CaseService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CaseService<T>
where
    T: super::stubs::CaseService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::CaseService for CaseService<T>
where
    T: super::stubs::CaseService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [CommentService](super::stubs::CommentService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CommentService<T>
where
    T: super::stubs::CommentService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::CommentService for CommentService<T>
where
    T: super::stubs::CommentService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
