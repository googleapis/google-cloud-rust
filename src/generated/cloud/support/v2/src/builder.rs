...
/// Request and client builders for [CaseAttachmentService][crate::client::CaseAttachmentService].
pub mod case_attachment_service {
    ...
    impl ListAttachments {
        ...
        pub fn by_page(
            ...
            crate::model::ListAttachmentsResponse,
            crate::Error,
        > {
            use std::clone::Clone;
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListAttachments {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [CaseAttachmentService::get_attachment][crate::client::CaseAttachmentService::get_attachment] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_support_v2::builder::case_attachment_service::GetAttachment;
    /// # async fn sample() -> google_cloud_support_v2::Result<()> {
    ///
    /// let builder = prepare_request_builder();
...
/// Request and client builders for [CaseService][crate::client::CaseService].
pub mod case_service {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetCase {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ListCases {
        ...
        pub fn by_page(
            self,
        ) -> impl google_cloud_gax::paginator::Paginator<crate::model::ListCasesResponse, crate::Error>
        {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
            let execute = move |token: String| {
        ...
        pub fn by_item(
            self,
        ) -> impl google_cloud_gax::paginator::ItemPaginator<crate::model::ListCasesResponse, crate::Error>
        {
            use google_cloud_gax::paginator::Paginator;
            self.by_page().items()
        }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListCases {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl SearchCases {
        ...
        pub fn by_page(
            self,
        ) -> impl google_cloud_gax::paginator::Paginator<crate::model::SearchCasesResponse, crate::Error>
        {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
            let execute = move |token: String| {
        ...
        pub fn by_item(
            ...
            crate::model::SearchCasesResponse,
            crate::Error,
        > {
            use google_cloud_gax::paginator::Paginator;
            self.by_page().items()
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for SearchCases {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateCase {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateCase {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for EscalateCase {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CloseCase {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for SearchCaseClassifications {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
...
/// Request and client builders for [CommentService][crate::client::CommentService].
pub mod comment_service {
    ...
    impl ListComments {
        ...
        pub fn by_page(
            self,
        ) -> impl google_cloud_gax::paginator::Paginator<crate::model::ListCommentsResponse, crate::Error>
        {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
            let execute = move |token: String| {
        ...
        pub fn by_item(
            ...
            crate::model::ListCommentsResponse,
            crate::Error,
        > {
            use google_cloud_gax::paginator::Paginator;
            self.by_page().items()
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListComments {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateComment {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [CommentService::get_comment][crate::client::CommentService::get_comment] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_support_v2::builder::comment_service::GetComment;
    /// # async fn sample() -> google_cloud_support_v2::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    /// # Ok(()) }
    ///
    /// fn prepare_request_builder() -> GetComment {
    ///   # panic!();
    ///   // ... details omitted ...
    /// }
    /// ```
    #[derive(Clone, Debug)]
    pub struct GetComment(RequestBuilder<crate::model::GetCommentRequest>);
    ...
    impl GetComment {
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::GetCommentRequest>>(mut self, v: V) -> Self {
            self.0.request = v.into();
            self
        }
        ...
        pub async fn send(self) -> Result<crate::model::Comment> {
            (*self.0.stub)
                .get_comment(self.0.request, self.0.options)
                .await
                .map(crate::Response::into_body)
        }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetComment {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
