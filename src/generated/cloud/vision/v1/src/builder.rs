...
/// Request and client builders for [ImageAnnotator][crate::client::ImageAnnotator].
pub mod image_annotator {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for BatchAnnotateImages {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for BatchAnnotateFiles {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl AsyncBatchAnnotateImages {
        ...
        > {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_vision_v1::client::ImageAnnotator::async_batch_annotate_images::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for AsyncBatchAnnotateImages {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl AsyncBatchAnnotateFiles {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_vision_v1::client::ImageAnnotator::async_batch_annotate_files::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for AsyncBatchAnnotateFiles {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
...
/// Request and client builders for [ProductSearch][crate::client::ProductSearch].
pub mod product_search {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateProductSet {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ListProductSets {
        ...
        pub fn by_page(
            ...
            crate::model::ListProductSetsResponse,
            crate::Error,
        > {
            use std::clone::Clone;
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListProductSets {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetProductSet {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateProductSet {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteProductSet {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateReferenceImage {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteReferenceImage {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListReferenceImages {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetReferenceImage {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for AddProductToProductSet {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for RemoveProductFromProductSet {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListProductsInProductSet {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ImportProductSets {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_vision_v1::client::ProductSearch::import_product_sets::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ImportProductSets {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl PurgeProducts {
        ...
        pub fn poller(
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_vision_v1::client::ProductSearch::purge_products::until_done";
            }
