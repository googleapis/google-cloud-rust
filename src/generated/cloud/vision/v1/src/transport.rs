    ...
    async fn create_product_set(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//vision.googleapis.com/v1/{}/productSets", var_parent,);
    ...
    async fn get_product_set(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//vision.googleapis.com/v1/{}", var_name,);
    ...
    async fn create_product(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//vision.googleapis.com/v1/{}/products", var_parent,);
    ...
    async fn create_reference_image(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//vision.googleapis.com/v1/{}/referenceImages", var_parent,);
    ...
    async fn list_products_in_product_set(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//vision.googleapis.com/v1/{}/products", var_name,);
