...
/// Implements a [ApiHub](super::stubs::ApiHub) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ApiHub<T>
where
    T: super::stubs::ApiHub + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ApiHub for ApiHub<T>
where
    T: super::stubs::ApiHub + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [ApiHubDependencies](super::stubs::ApiHubDependencies) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ApiHubDependencies<T>
where
    T: super::stubs::ApiHubDependencies + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ApiHubDependencies for ApiHubDependencies<T>
where
    T: super::stubs::ApiHubDependencies + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [HostProjectRegistrationService](super::stubs::HostProjectRegistrationService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct HostProjectRegistrationService<T>
where
    T: super::stubs::HostProjectRegistrationService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::HostProjectRegistrationService for HostProjectRegistrationService<T>
where
    T: super::stubs::HostProjectRegistrationService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [LintingService](super::stubs::LintingService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct LintingService<T>
where
    T: super::stubs::LintingService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::LintingService for LintingService<T>
where
    T: super::stubs::LintingService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [ApiHubPlugin](super::stubs::ApiHubPlugin) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ApiHubPlugin<T>
where
    T: super::stubs::ApiHubPlugin + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ApiHubPlugin for ApiHubPlugin<T>
where
    T: super::stubs::ApiHubPlugin + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Provisioning](super::stubs::Provisioning) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Provisioning<T>
where
    T: super::stubs::Provisioning + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Provisioning for Provisioning<T>
where
    T: super::stubs::Provisioning + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [RuntimeProjectAttachmentService](super::stubs::RuntimeProjectAttachmentService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct RuntimeProjectAttachmentService<T>
where
    T: super::stubs::RuntimeProjectAttachmentService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::RuntimeProjectAttachmentService for RuntimeProjectAttachmentService<T>
where
    T: super::stubs::RuntimeProjectAttachmentService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
