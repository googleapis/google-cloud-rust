...
pub mod alert_policy {
    ...
    pub mod condition {
        ...
        #[derive(Clone, Debug, Default, PartialEq, serde::Deserialize, serde::Serialize)]
        pub struct EvaluationMissingData(std::string::String);
        ...
        pub mod evaluation_missing_data {
            ...
            pub const EVALUATION_MISSING_DATA_UNSPECIFIED: &str =
                "EVALUATION_MISSING_DATA_UNSPECIFIED";

            /// If there is no data to evaluate the condition, then evaluate the
            /// condition as false.
            pub const EVALUATION_MISSING_DATA_INACTIVE: &str = "EVALUATION_MISSING_DATA_INACTIVE";

            /// If there is no data to evaluate the condition, then evaluate the
            /// condition as true.
            pub const EVALUATION_MISSING_DATA_ACTIVE: &str = "EVALUATION_MISSING_DATA_ACTIVE";

            /// Do not evaluate the condition to any value if there is no data.
            pub const EVALUATION_MISSING_DATA_NO_OP: &str = "EVALUATION_MISSING_DATA_NO_OP";
        }
    ...
    pub mod alert_strategy {
        ...
        #[derive(Clone, Debug, Default, PartialEq, serde::Deserialize, serde::Serialize)]
        pub struct NotificationPrompt(std::string::String);
        ...
        pub mod notification_prompt {
            ...
            pub const NOTIFICATION_PROMPT_UNSPECIFIED: &str = "NOTIFICATION_PROMPT_UNSPECIFIED";
    ...
    #[derive(Clone, Debug, Default, PartialEq, serde::Deserialize, serde::Serialize)]
    pub struct ConditionCombinerType(std::string::String);
    ...
    pub mod condition_combiner_type {
        ...
        pub const COMBINE_UNSPECIFIED: &str = "COMBINE_UNSPECIFIED";
        ...
        pub const AND_WITH_MATCHING_RESOURCE: &str = "AND_WITH_MATCHING_RESOURCE";
    }
...
pub mod list_time_series_request {
    ...
    #[derive(Clone, Debug, Default, PartialEq, serde::Deserialize, serde::Serialize)]
    pub struct TimeSeriesView(std::string::String);
...
pub struct NotificationChannel {
    ...
    /// field.
    ///
    /// [google.monitoring.v3.NotificationChannelDescriptor.type]: crate::model::NotificationChannelDescriptor::r#type
    #[serde(rename = "type")]
    #[serde(skip_serializing_if = "std::string::String::is_empty")]
    pub r#type: std::string::String,
...
pub mod notification_channel {
    ...
    /// [google.monitoring.v3.NotificationChannelService.UpdateNotificationChannel]: crate::client::NotificationChannelService::update_notification_channel
    #[derive(Clone, Debug, Default, PartialEq, serde::Deserialize, serde::Serialize)]
    pub struct VerificationStatus(std::string::String);
    ...
    pub mod verification_status {
        ...
        pub const VERIFICATION_STATUS_UNSPECIFIED: &str = "VERIFICATION_STATUS_UNSPECIFIED";
...
pub mod uptime_check_config {
    ...
    pub mod http_check {
        ...
        pub mod response_status_code {
            ...
            #[derive(Clone, Debug, Default, PartialEq, serde::Deserialize, serde::Serialize)]
            pub struct StatusClass(std::string::String);
            ...
            pub mod status_class {
                ...
                pub const STATUS_CLASS_UNSPECIFIED: &str = "STATUS_CLASS_UNSPECIFIED";

                /// The class of status codes between 100 and 199.
                pub const STATUS_CLASS_1XX: &str = "STATUS_CLASS_1XX";

                /// The class of status codes between 200 and 299.
                pub const STATUS_CLASS_2XX: &str = "STATUS_CLASS_2XX";

                /// The class of status codes between 300 and 399.
                pub const STATUS_CLASS_3XX: &str = "STATUS_CLASS_3XX";

                /// The class of status codes between 400 and 499.
                pub const STATUS_CLASS_4XX: &str = "STATUS_CLASS_4XX";

                /// The class of status codes between 500 and 599.
                pub const STATUS_CLASS_5XX: &str = "STATUS_CLASS_5XX";

                /// The class of all status codes.
                pub const STATUS_CLASS_ANY: &str = "STATUS_CLASS_ANY";
            }
        ...
        pub mod service_agent_authentication {
            ...
            /// Type of authentication.
            #[derive(Clone, Debug, Default, PartialEq, serde::Deserialize, serde::Serialize)]
            pub struct ServiceAgentAuthenticationType(std::string::String);
            ...
            pub mod service_agent_authentication_type {
                ...
                pub const SERVICE_AGENT_AUTHENTICATION_TYPE_UNSPECIFIED: &str =
                    "SERVICE_AGENT_AUTHENTICATION_TYPE_UNSPECIFIED";

                /// OIDC Authentication
                pub const OIDC_TOKEN: &str = "OIDC_TOKEN";
            }
        }

        /// The HTTP request method options.
        #[derive(Clone, Debug, Default, PartialEq, serde::Deserialize, serde::Serialize)]
        pub struct RequestMethod(std::string::String);
        ...
        #[derive(Clone, Debug, Default, PartialEq, serde::Deserialize, serde::Serialize)]
        pub struct ContentType(std::string::String);
    ...
    pub mod content_matcher {
        ...
        pub mod json_path_matcher {
            ...
            #[derive(Clone, Debug, Default, PartialEq, serde::Deserialize, serde::Serialize)]
            pub struct JsonPathMatcherOption(std::string::String);
            ...
            pub mod json_path_matcher_option {
                ...
                pub const JSON_PATH_MATCHER_OPTION_UNSPECIFIED: &str =
        ...
        #[derive(Clone, Debug, Default, PartialEq, serde::Deserialize, serde::Serialize)]
        pub struct ContentMatcherOption(std::string::String);
        ...
        pub mod content_matcher_option {
            ...
            pub const CONTENT_MATCHER_OPTION_UNSPECIFIED: &str =
            ...
            /// `CONTENT_MATCHER_OPTION_UNSPECIFIED`.
            pub const CONTAINS_STRING: &str = "CONTAINS_STRING";

            /// Selects negation of substring matching. The match succeeds if the
            /// output does _NOT_ contain the `content` string.
            pub const NOT_CONTAINS_STRING: &str = "NOT_CONTAINS_STRING";

            /// Selects regular-expression matching. The match succeeds if the output
            /// matches the regular expression specified in the `content` string.
            /// Regex matching is only supported for HTTP/HTTPS checks.
            pub const MATCHES_REGEX: &str = "MATCHES_REGEX";

            /// Selects negation of regular-expression matching. The match succeeds if
            /// the output does _NOT_ match the regular expression specified in the
            /// `content` string. Regex matching is only supported for HTTP/HTTPS
            /// checks.
            pub const NOT_MATCHES_REGEX: &str = "NOT_MATCHES_REGEX";
    ...
    #[derive(Clone, Debug, Default, PartialEq, serde::Deserialize, serde::Serialize)]
    pub struct CheckerType(std::string::String);
    ...
    pub mod checker_type {
        ...
        pub const CHECKER_TYPE_UNSPECIFIED: &str = "CHECKER_TYPE_UNSPECIFIED";
        ...
        pub const STATIC_IP_CHECKERS: &str = "STATIC_IP_CHECKERS";
        ...
        pub const VPC_CHECKERS: &str = "VPC_CHECKERS";
    }
...
/// `right`.
#[derive(Clone, Debug, Default, PartialEq, serde::Deserialize, serde::Serialize)]
pub struct ComparisonType(std::string::String);
...
pub mod comparison_type {
    ...
    pub const COMPARISON_UNSPECIFIED: &str = "COMPARISON_UNSPECIFIED";

    /// True if the left argument is greater than the right argument.
    pub const COMPARISON_GT: &str = "COMPARISON_GT";

    /// True if the left argument is greater than or equal to the right argument.
    pub const COMPARISON_GE: &str = "COMPARISON_GE";

    /// True if the left argument is less than the right argument.
    pub const COMPARISON_LT: &str = "COMPARISON_LT";

    /// True if the left argument is less than or equal to the right argument.
    pub const COMPARISON_LE: &str = "COMPARISON_LE";

    /// True if the left argument is equal to the right argument.
    pub const COMPARISON_EQ: &str = "COMPARISON_EQ";

    /// True if the left argument is not equal to the right argument.
    pub const COMPARISON_NE: &str = "COMPARISON_NE";
}
...
/// details.
#[derive(Clone, Debug, Default, PartialEq, serde::Deserialize, serde::Serialize)]
pub struct ServiceTier(std::string::String);
...
pub mod service_tier {
    ...
    pub const SERVICE_TIER_UNSPECIFIED: &str = "SERVICE_TIER_UNSPECIFIED";
    ...
    pub const SERVICE_TIER_BASIC: &str = "SERVICE_TIER_BASIC";
    ...
    /// documentation](https://cloud.google.com/monitoring/workspaces/tiers).
    pub const SERVICE_TIER_PREMIUM: &str = "SERVICE_TIER_PREMIUM";
}

/// The regions from which an Uptime check can be run.
#[derive(Clone, Debug, Default, PartialEq, serde::Deserialize, serde::Serialize)]
pub struct UptimeCheckRegion(std::string::String);
...
pub mod uptime_check_region {
    ...
    pub const REGION_UNSPECIFIED: &str = "REGION_UNSPECIFIED";
...
#[derive(Clone, Debug, Default, PartialEq, serde::Deserialize, serde::Serialize)]
pub struct GroupResourceType(std::string::String);
...
pub mod group_resource_type {
    ...
    pub const RESOURCE_TYPE_UNSPECIFIED: &str = "RESOURCE_TYPE_UNSPECIFIED";
    ...
    pub const AWS_ELB_LOAD_BALANCER: &str = "AWS_ELB_LOAD_BALANCER";
}
