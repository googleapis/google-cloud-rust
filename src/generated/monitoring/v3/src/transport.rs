    ...
    async fn list_alert_policies(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//monitoring.googleapis.com/v3/{}/alertPolicies", var_name,);
    ...
    async fn get_alert_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//monitoring.googleapis.com/v3/{}", var_name,);
    ...
    async fn list_groups(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//monitoring.googleapis.com/v3/{}/groups", var_name,);
    ...
    async fn list_group_members(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//monitoring.googleapis.com/v3/{}/members", var_name,);
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//monitoring.googleapis.com/v3/{}/monitoredResourceDescriptors",
                    var_name,
                );
    ...
    async fn list_metric_descriptors(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//monitoring.googleapis.com/v3/{}/metricDescriptors",
                    var_name,
                );
    ...
    async fn list_time_series(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//monitoring.googleapis.com/v3/{}/timeSeries", var_name,);
    ...
    async fn list_notification_channel_descriptors(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//monitoring.googleapis.com/v3/{}/notificationChannelDescriptors",
                    var_name,
                );
    ...
    async fn list_notification_channels(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//monitoring.googleapis.com/v3/{}/notificationChannels",
                    var_name,
                );
    ...
    async fn create_service(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//monitoring.googleapis.com/v3/{}/services", var_parent,);
    ...
    async fn create_service_level_objective(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//monitoring.googleapis.com/v3/{}/serviceLevelObjectives",
                    var_parent,
                );
    ...
    async fn create_snooze(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//monitoring.googleapis.com/v3/{}/snoozes", var_parent,);
    ...
    async fn list_uptime_check_configs(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//monitoring.googleapis.com/v3/{}/uptimeCheckConfigs",
                    var_parent,
                );
