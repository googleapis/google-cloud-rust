...
/// [with_credentials()]: super::builder::alert_policy_service::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `AlertPolicyService` in
...
impl AlertPolicyService {
    ...
    pub fn builder() -> super::builder::alert_policy_service::ClientBuilder {
        crate::new_client_builder(super::builder::alert_policy_service::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::AlertPolicyService>>
    {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::AlertPolicyService> {
    ...
    /// async fn sample(
    ///    client: &AlertPolicyService, project_id: &str
    /// ) -> Result<()> {
    ///     let mut list = client.list_alert_policies()
    ///         .set_name(format!("projects/{project_id}"))
    ///         .by_item();
    ...
    /// use google_cloud_monitoring_v3::Result;
    /// async fn sample(
    ///    client: &AlertPolicyService, project_id: &str, alert_policy_id: &str
    /// ) -> Result<()> {
    ///     let response = client.get_alert_policy()
    ///         .set_name(format!("projects/{project_id}/alertPolicies/{alert_policy_id}"))
    ///         .send().await?;
    ...
    ///         .set_alert_policy(
    ///             AlertPolicy::new().set_name(format!("projects/{project_id}/alertPolicies/{alert_policy_id}"))/* set fields */
    ///         )
...
/// [with_credentials()]: super::builder::group_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `GroupService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
#[derive(Clone, Debug)]
...
impl GroupService {
    ...
    pub fn builder() -> super::builder::group_service::ClientBuilder {
        crate::new_client_builder(super::builder::group_service::client::Factory)
    }
    ...
    async fn build_inner(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::GroupService>> {
        if gaxi::options::tracing_enabled(&conf) {
            return Ok(std::sync::Arc::new(Self::build_with_tracing(conf).await?));
        }
        Ok(std::sync::Arc::new(Self::build_transport(conf).await?))
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::GroupService> {
    ...
    /// use google_cloud_monitoring_v3::Result;
    /// async fn sample(
    ///    client: &GroupService, project_id: &str
    /// ) -> Result<()> {
    ///     let mut list = client.list_groups()
    ///         .set_name(format!("projects/{project_id}"))
    ///         .by_item();
    ...
    /// use google_cloud_monitoring_v3::Result;
    /// async fn sample(
    ///    client: &GroupService, project_id: &str, group_id: &str
    /// ) -> Result<()> {
    ///     let response = client.get_group()
    ///         .set_name(format!("projects/{project_id}/groups/{group_id}"))
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    /// }
    ...
    ///         .set_group(
    ///             Group::new().set_name(format!("projects/{project_id}/groups/{group_id}"))/* set fields */
    ///         )
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
...
/// [with_credentials()]: super::builder::metric_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `MetricService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
#[derive(Clone, Debug)]
...
impl MetricService {
    ...
    pub fn builder() -> super::builder::metric_service::ClientBuilder {
        crate::new_client_builder(super::builder::metric_service::client::Factory)
    }
    ...
    async fn build_inner(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::MetricService>> {
        if gaxi::options::tracing_enabled(&conf) {
            return Ok(std::sync::Arc::new(Self::build_with_tracing(conf).await?));
        }
        Ok(std::sync::Arc::new(Self::build_transport(conf).await?))
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::MetricService> {
...
/// [with_credentials()]: super::builder::notification_channel_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `NotificationChannelService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
#[derive(Clone, Debug)]
...
impl NotificationChannelService {
    ...
    pub fn builder() -> super::builder::notification_channel_service::ClientBuilder {
        crate::new_client_builder(super::builder::notification_channel_service::client::Factory)
    }
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::NotificationChannelService> {
    ...
    /// use google_cloud_monitoring_v3::Result;
    /// async fn sample(
    ///    client: &NotificationChannelService, project_id: &str
    /// ) -> Result<()> {
    ///     let mut list = client.list_notification_channel_descriptors()
    ///         .set_name(format!("projects/{project_id}"))
    ///         .by_item();
    ...
    /// use google_cloud_monitoring_v3::Result;
    /// async fn sample(
    ///    client: &NotificationChannelService, project_id: &str, channel_descriptor_id: &str
    /// ) -> Result<()> {
    ///     let response = client.get_notification_channel_descriptor()
    ///         .set_name(format!("projects/{project_id}/notificationChannelDescriptors/{channel_descriptor_id}"))
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    /// }
    ...
    /// use google_cloud_monitoring_v3::Result;
    /// async fn sample(
    ///    client: &NotificationChannelService, project_id: &str, notification_channel_id: &str
    /// ) -> Result<()> {
    ///     let response = client.get_notification_channel()
    ///         .set_name(format!("projects/{project_id}/notificationChannels/{notification_channel_id}"))
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    /// }
    ...
    ///         .set_notification_channel(
    ///             NotificationChannel::new().set_name(format!("projects/{project_id}/notificationChannels/{notification_channel_id}"))/* set fields */
    ///         )
    ///         .set_update_mask(FieldMask::default().set_paths(["updated.field.path1", "updated.field.path2"]))
    ///         .send().await?;
    ///     println!("response {:?}", response);
...
/// [with_credentials()]: super::builder::query_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `QueryService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
#[derive(Clone, Debug)]
...
impl QueryService {
    ...
    pub fn builder() -> super::builder::query_service::ClientBuilder {
        crate::new_client_builder(super::builder::query_service::client::Factory)
    }
    ...
    async fn build_inner(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::QueryService>> {
        if gaxi::options::tracing_enabled(&conf) {
            return Ok(std::sync::Arc::new(Self::build_with_tracing(conf).await?));
        }
        Ok(std::sync::Arc::new(Self::build_transport(conf).await?))
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::QueryService> {
...
/// [with_credentials()]: super::builder::service_monitoring_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `ServiceMonitoringService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
#[derive(Clone, Debug)]
...
impl ServiceMonitoringService {
    ...
    pub fn builder() -> super::builder::service_monitoring_service::ClientBuilder {
        crate::new_client_builder(super::builder::service_monitoring_service::client::Factory)
    }
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::ServiceMonitoringService> {
    ...
    /// use google_cloud_monitoring_v3::Result;
    /// async fn sample(
    ///    client: &ServiceMonitoringService, project_id: &str
    /// ) -> Result<()> {
    ...
    /// use google_cloud_monitoring_v3::Result;
    /// async fn sample(
    ///    client: &ServiceMonitoringService, project_id: &str, service_id: &str
    /// ) -> Result<()> {
    ///     let response = client.get_service()
    ///         .set_name(format!("projects/{project_id}/services/{service_id}"))
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    /// }
    ...
    ///         .set_service(
    ///             Service::new().set_name(format!("projects/{project_id}/services/{service_id}"))/* set fields */
    ///         )
    ///         .set_update_mask(FieldMask::default().set_paths(["updated.field.path1", "updated.field.path2"]))
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ...
    ///         .set_parent(format!("projects/{project_id}/services/{service_id}"))
    ...
    /// use google_cloud_monitoring_v3::Result;
    /// async fn sample(
    ///    client: &ServiceMonitoringService, project_id: &str, service_id: &str, service_level_objective_id: &str
    /// ) -> Result<()> {
    ///     let response = client.get_service_level_objective()
    ///         .set_name(format!("projects/{project_id}/services/{service_id}/serviceLevelObjectives/{service_level_objective_id}"))
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    /// }
    ...
    ///         .set_service_level_objective(
    ///             ServiceLevelObjective::new().set_name(format!("projects/{project_id}/services/{service_id}/serviceLevelObjectives/{service_level_objective_id}"))/* set fields */
    ///         )
    ///         .set_update_mask(FieldMask::default().set_paths(["updated.field.path1", "updated.field.path2"]))
    ///         .send().await?;
    ///     println!("response {:?}", response);
...
/// [with_credentials()]: super::builder::snooze_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `SnoozeService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
#[derive(Clone, Debug)]
...
impl SnoozeService {
    ...
    pub fn builder() -> super::builder::snooze_service::ClientBuilder {
        crate::new_client_builder(super::builder::snooze_service::client::Factory)
    }
    ...
    async fn build_inner(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::SnoozeService>> {
        if gaxi::options::tracing_enabled(&conf) {
            return Ok(std::sync::Arc::new(Self::build_with_tracing(conf).await?));
        }
        Ok(std::sync::Arc::new(Self::build_transport(conf).await?))
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::SnoozeService> {
    ...
    /// use google_cloud_monitoring_v3::Result;
    /// async fn sample(
    ///    client: &SnoozeService, project_id: &str
    /// ) -> Result<()> {
    ...
    /// use google_cloud_monitoring_v3::Result;
    /// async fn sample(
    ///    client: &SnoozeService, project_id: &str, snooze_id: &str
    /// ) -> Result<()> {
    ///     let response = client.get_snooze()
    ///         .set_name(format!("projects/{project_id}/snoozes/{snooze_id}"))
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    /// }
    ...
    ///         .set_snooze(
    ///             Snooze::new().set_name(format!("projects/{project_id}/snoozes/{snooze_id}"))/* set fields */
    ///         )
    ///         .set_update_mask(FieldMask::default().set_paths(["updated.field.path1", "updated.field.path2"]))
    ///         .send().await?;
    ///     println!("response {:?}", response);
...
/// [with_credentials()]: super::builder::uptime_check_service::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `UptimeCheckService` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
#[derive(Clone, Debug)]
...
impl UptimeCheckService {
    ...
    pub fn builder() -> super::builder::uptime_check_service::ClientBuilder {
        crate::new_client_builder(super::builder::uptime_check_service::client::Factory)
    }
    ...
    async fn build_inner(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::UptimeCheckService>>
    {
        if gaxi::options::tracing_enabled(&conf) {
            return Ok(std::sync::Arc::new(Self::build_with_tracing(conf).await?));
        }
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::UptimeCheckService> {
    ...
    /// use google_cloud_monitoring_v3::Result;
    /// async fn sample(
    ///    client: &UptimeCheckService, project_id: &str
    /// ) -> Result<()> {
    ///     let mut list = client.list_uptime_check_configs()
    ///         .set_parent(format!("projects/{project_id}"))
    ///         .by_item();
    ...
    /// use google_cloud_monitoring_v3::Result;
    /// async fn sample(
    ///    client: &UptimeCheckService, project_id: &str, uptime_check_config_id: &str
    /// ) -> Result<()> {
    ///     let response = client.get_uptime_check_config()
    ///         .set_name(format!("projects/{project_id}/uptimeCheckConfigs/{uptime_check_config_id}"))
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    /// }
    ...
    ///         .set_uptime_check_config(
    ///             UptimeCheckConfig::new().set_name(format!("projects/{project_id}/uptimeCheckConfigs/{uptime_check_config_id}"))/* set fields */
    ///         )
    ///         .set_update_mask(FieldMask::default().set_paths(["updated.field.path1", "updated.field.path2"]))
    ///         .send().await?;
    ///     println!("response {:?}", response);
