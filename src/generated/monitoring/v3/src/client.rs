...
/// An implementation of [crate::traits::AlertPolicyService] to make requests with.
///
/// `AlertPolicyService` has various configuration parameters, but the defaults
...
pub struct AlertPolicyService {
    inner: Arc<dyn crate::traits::dyntraits::AlertPolicyService>,
}
...
impl AlertPolicyService {
    ...
    where
        T: crate::traits::AlertPolicyService + 'static,
    {
        Self {
            inner: Arc::new(stub),
        }
    ...
    ) -> Result<Arc<dyn crate::traits::dyntraits::AlertPolicyService>> {
    ...
    async fn build_transport(
        conf: gax::options::ClientConfig,
    ) -> Result<impl crate::traits::AlertPolicyService> {
...
/// An implementation of [crate::traits::GroupService] to make requests with.
///
/// `GroupService` has various configuration parameters, but the defaults
/// are set to work with most applications.
///
...
pub struct GroupService {
    inner: Arc<dyn crate::traits::dyntraits::GroupService>,
}
...
impl GroupService {
    ...
    pub fn from_stub<T>(stub: T) -> Self
    where
        T: crate::traits::GroupService + 'static,
    {
        Self {
            inner: Arc::new(stub),
        }
    ...
    async fn build_inner(
        conf: gax::options::ClientConfig,
    ) -> Result<Arc<dyn crate::traits::dyntraits::GroupService>> {
        if conf.tracing_enabled() {
            return Ok(Arc::new(Self::build_with_tracing(conf).await?));
        }
        Ok(Arc::new(Self::build_transport(conf).await?))
    ...
    async fn build_transport(
        conf: gax::options::ClientConfig,
    ) -> Result<impl crate::traits::GroupService> {
...
/// An implementation of [crate::traits::MetricService] to make requests with.
///
/// `MetricService` has various configuration parameters, but the defaults
/// are set to work with most applications.
///
...
pub struct MetricService {
    inner: Arc<dyn crate::traits::dyntraits::MetricService>,
}
...
impl MetricService {
    ...
    pub fn from_stub<T>(stub: T) -> Self
    where
        T: crate::traits::MetricService + 'static,
    {
        Self {
            inner: Arc::new(stub),
        }
    ...
    async fn build_inner(
        conf: gax::options::ClientConfig,
    ) -> Result<Arc<dyn crate::traits::dyntraits::MetricService>> {
        if conf.tracing_enabled() {
            return Ok(Arc::new(Self::build_with_tracing(conf).await?));
        }
        Ok(Arc::new(Self::build_transport(conf).await?))
    ...
    async fn build_transport(
        conf: gax::options::ClientConfig,
    ) -> Result<impl crate::traits::MetricService> {
...
/// An implementation of [crate::traits::NotificationChannelService] to make requests with.
///
/// `NotificationChannelService` has various configuration parameters, but the defaults
/// are set to work with most applications.
///
...
pub struct NotificationChannelService {
    inner: Arc<dyn crate::traits::dyntraits::NotificationChannelService>,
}
...
impl NotificationChannelService {
    ...
    pub fn from_stub<T>(stub: T) -> Self
    where
        T: crate::traits::NotificationChannelService + 'static,
    {
        Self {
            inner: Arc::new(stub),
        }
    ...
    async fn build_inner(
        conf: gax::options::ClientConfig,
    ) -> Result<Arc<dyn crate::traits::dyntraits::NotificationChannelService>> {
        if conf.tracing_enabled() {
            return Ok(Arc::new(Self::build_with_tracing(conf).await?));
        }
        Ok(Arc::new(Self::build_transport(conf).await?))
    ...
    async fn build_transport(
        conf: gax::options::ClientConfig,
    ) -> Result<impl crate::traits::NotificationChannelService> {
...
/// An implementation of [crate::traits::QueryService] to make requests with.
///
/// `QueryService` has various configuration parameters, but the defaults
/// are set to work with most applications.
///
...
pub struct QueryService {
    inner: Arc<dyn crate::traits::dyntraits::QueryService>,
}
...
impl QueryService {
    ...
    pub fn from_stub<T>(stub: T) -> Self
    where
        T: crate::traits::QueryService + 'static,
    {
        Self {
            inner: Arc::new(stub),
        }
    ...
    async fn build_inner(
        conf: gax::options::ClientConfig,
    ) -> Result<Arc<dyn crate::traits::dyntraits::QueryService>> {
        if conf.tracing_enabled() {
            return Ok(Arc::new(Self::build_with_tracing(conf).await?));
        }
        Ok(Arc::new(Self::build_transport(conf).await?))
    ...
    async fn build_transport(
        conf: gax::options::ClientConfig,
    ) -> Result<impl crate::traits::QueryService> {
...
/// An implementation of [crate::traits::ServiceMonitoringService] to make requests with.
///
/// `ServiceMonitoringService` has various configuration parameters, but the defaults
/// are set to work with most applications.
///
...
pub struct ServiceMonitoringService {
    inner: Arc<dyn crate::traits::dyntraits::ServiceMonitoringService>,
}
...
impl ServiceMonitoringService {
    ...
    pub fn from_stub<T>(stub: T) -> Self
    where
        T: crate::traits::ServiceMonitoringService + 'static,
    {
        Self {
            inner: Arc::new(stub),
        }
    ...
    async fn build_inner(
        conf: gax::options::ClientConfig,
    ) -> Result<Arc<dyn crate::traits::dyntraits::ServiceMonitoringService>> {
        if conf.tracing_enabled() {
            return Ok(Arc::new(Self::build_with_tracing(conf).await?));
        }
        Ok(Arc::new(Self::build_transport(conf).await?))
    ...
    async fn build_transport(
        conf: gax::options::ClientConfig,
    ) -> Result<impl crate::traits::ServiceMonitoringService> {
...
/// An implementation of [crate::traits::SnoozeService] to make requests with.
///
/// `SnoozeService` has various configuration parameters, but the defaults
/// are set to work with most applications.
///
...
pub struct SnoozeService {
    inner: Arc<dyn crate::traits::dyntraits::SnoozeService>,
}
...
impl SnoozeService {
    ...
    pub fn from_stub<T>(stub: T) -> Self
    where
        T: crate::traits::SnoozeService + 'static,
    {
        Self {
            inner: Arc::new(stub),
        }
    ...
    async fn build_inner(
        conf: gax::options::ClientConfig,
    ) -> Result<Arc<dyn crate::traits::dyntraits::SnoozeService>> {
        if conf.tracing_enabled() {
            return Ok(Arc::new(Self::build_with_tracing(conf).await?));
        }
        Ok(Arc::new(Self::build_transport(conf).await?))
    ...
    async fn build_transport(
        conf: gax::options::ClientConfig,
    ) -> Result<impl crate::traits::SnoozeService> {
...
/// An implementation of [crate::traits::UptimeCheckService] to make requests with.
///
/// `UptimeCheckService` has various configuration parameters, but the defaults
/// are set to work with most applications.
///
...
pub struct UptimeCheckService {
    inner: Arc<dyn crate::traits::dyntraits::UptimeCheckService>,
}
...
impl UptimeCheckService {
    ...
    pub fn from_stub<T>(stub: T) -> Self
    where
        T: crate::traits::UptimeCheckService + 'static,
    {
        Self {
            inner: Arc::new(stub),
        }
    ...
    async fn build_inner(
        conf: gax::options::ClientConfig,
    ) -> Result<Arc<dyn crate::traits::dyntraits::UptimeCheckService>> {
        if conf.tracing_enabled() {
            return Ok(Arc::new(Self::build_with_tracing(conf).await?));
        }
        Ok(Arc::new(Self::build_transport(conf).await?))
    ...
    async fn build_transport(
        conf: gax::options::ClientConfig,
    ) -> Result<impl crate::traits::UptimeCheckService> {
