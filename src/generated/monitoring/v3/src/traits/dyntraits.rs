...
/// A dyn-compatible, crate-private version of `AlertPolicyService`.
...
/// All implementations of [crate::traits::AlertPolicyService] also implement [AlertPolicyService].
#[async_trait::async_trait]
impl<T: crate::traits::AlertPolicyService> AlertPolicyService for T {
...
/// A dyn-compatible, crate-private version of `GroupService`.
#[async_trait::async_trait]
...
/// All implementations of [crate::traits::GroupService] also implement [GroupService].
#[async_trait::async_trait]
impl<T: crate::traits::GroupService> GroupService for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn list_groups(
        &self,
        req: crate::model::ListGroupsRequest,
...
/// A dyn-compatible, crate-private version of `MetricService`.
#[async_trait::async_trait]
...
/// All implementations of [crate::traits::MetricService] also implement [MetricService].
#[async_trait::async_trait]
impl<T: crate::traits::MetricService> MetricService for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn list_monitored_resource_descriptors(
        &self,
        req: crate::model::ListMonitoredResourceDescriptorsRequest,
...
/// A dyn-compatible, crate-private version of `NotificationChannelService`.
#[async_trait::async_trait]
...
/// All implementations of [crate::traits::NotificationChannelService] also implement [NotificationChannelService].
#[async_trait::async_trait]
impl<T: crate::traits::NotificationChannelService> NotificationChannelService for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn list_notification_channel_descriptors(
        &self,
        req: crate::model::ListNotificationChannelDescriptorsRequest,
...
/// A dyn-compatible, crate-private version of `QueryService`.
#[async_trait::async_trait]
...
/// All implementations of [crate::traits::QueryService] also implement [QueryService].
#[async_trait::async_trait]
impl<T: crate::traits::QueryService> QueryService for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn query_time_series(
        &self,
        req: crate::model::QueryTimeSeriesRequest,
...
/// A dyn-compatible, crate-private version of `ServiceMonitoringService`.
#[async_trait::async_trait]
...
/// All implementations of [crate::traits::ServiceMonitoringService] also implement [ServiceMonitoringService].
#[async_trait::async_trait]
impl<T: crate::traits::ServiceMonitoringService> ServiceMonitoringService for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn create_service(
        &self,
        req: crate::model::CreateServiceRequest,
...
/// A dyn-compatible, crate-private version of `SnoozeService`.
#[async_trait::async_trait]
...
/// All implementations of [crate::traits::SnoozeService] also implement [SnoozeService].
#[async_trait::async_trait]
impl<T: crate::traits::SnoozeService> SnoozeService for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn create_snooze(
        &self,
        req: crate::model::CreateSnoozeRequest,
...
/// A dyn-compatible, crate-private version of `UptimeCheckService`.
#[async_trait::async_trait]
...
/// All implementations of [crate::traits::UptimeCheckService] also implement [UptimeCheckService].
#[async_trait::async_trait]
impl<T: crate::traits::UptimeCheckService> UptimeCheckService for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn list_uptime_check_configs(
        &self,
        req: crate::model::ListUptimeCheckConfigsRequest,
