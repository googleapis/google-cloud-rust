...
/// Implements a [AlertPolicyService](super::stubs::AlertPolicyService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AlertPolicyService<T>
where
    T: super::stubs::AlertPolicyService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::AlertPolicyService for AlertPolicyService<T>
where
    T: super::stubs::AlertPolicyService + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [GroupService](super::stubs::GroupService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct GroupService<T>
where
    T: super::stubs::GroupService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::GroupService for GroupService<T>
where
    T: super::stubs::GroupService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [MetricService](super::stubs::MetricService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct MetricService<T>
where
    T: super::stubs::MetricService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::MetricService for MetricService<T>
where
    T: super::stubs::MetricService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [NotificationChannelService](super::stubs::NotificationChannelService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct NotificationChannelService<T>
where
    T: super::stubs::NotificationChannelService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::NotificationChannelService for NotificationChannelService<T>
where
    T: super::stubs::NotificationChannelService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [QueryService](super::stubs::QueryService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct QueryService<T>
where
    T: super::stubs::QueryService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::QueryService for QueryService<T>
where
    T: super::stubs::QueryService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [ServiceMonitoringService](super::stubs::ServiceMonitoringService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ServiceMonitoringService<T>
where
    T: super::stubs::ServiceMonitoringService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ServiceMonitoringService for ServiceMonitoringService<T>
where
    T: super::stubs::ServiceMonitoringService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [SnoozeService](super::stubs::SnoozeService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SnoozeService<T>
where
    T: super::stubs::SnoozeService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::SnoozeService for SnoozeService<T>
where
    T: super::stubs::SnoozeService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [UptimeCheckService](super::stubs::UptimeCheckService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct UptimeCheckService<T>
where
    T: super::stubs::UptimeCheckService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::UptimeCheckService for UptimeCheckService<T>
where
    T: super::stubs::UptimeCheckService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
