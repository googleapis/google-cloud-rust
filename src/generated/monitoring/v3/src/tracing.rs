...
/// Implements a [AlertPolicyService](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AlertPolicyService<T>
where
    T: crate::traits::AlertPolicyService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::AlertPolicyService for AlertPolicyService<T>
where
    T: crate::traits::AlertPolicyService + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [GroupService](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct GroupService<T>
where
    T: crate::traits::GroupService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::GroupService for GroupService<T>
where
    T: crate::traits::GroupService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [MetricService](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct MetricService<T>
where
    T: crate::traits::MetricService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::MetricService for MetricService<T>
where
    T: crate::traits::MetricService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [NotificationChannelService](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct NotificationChannelService<T>
where
    T: crate::traits::NotificationChannelService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::NotificationChannelService for NotificationChannelService<T>
where
    T: crate::traits::NotificationChannelService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [QueryService](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct QueryService<T>
where
    T: crate::traits::QueryService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::QueryService for QueryService<T>
where
    T: crate::traits::QueryService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [ServiceMonitoringService](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ServiceMonitoringService<T>
where
    T: crate::traits::ServiceMonitoringService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::ServiceMonitoringService for ServiceMonitoringService<T>
where
    T: crate::traits::ServiceMonitoringService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [SnoozeService](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SnoozeService<T>
where
    T: crate::traits::SnoozeService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::SnoozeService for SnoozeService<T>
where
    T: crate::traits::SnoozeService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [UptimeCheckService](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct UptimeCheckService<T>
where
    T: crate::traits::UptimeCheckService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::UptimeCheckService for UptimeCheckService<T>
where
    T: crate::traits::UptimeCheckService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
