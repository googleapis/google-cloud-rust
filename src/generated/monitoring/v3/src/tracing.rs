...
/// Implements a [AlertPolicyService](crate::stubs::AlertPolicyService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AlertPolicyService<T>
where
    T: crate::stubs::AlertPolicyService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::AlertPolicyService for AlertPolicyService<T>
where
    T: crate::stubs::AlertPolicyService + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [GroupService](crate::stubs::GroupService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct GroupService<T>
where
    T: crate::stubs::GroupService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::GroupService for GroupService<T>
where
    T: crate::stubs::GroupService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [MetricService](crate::stubs::MetricService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct MetricService<T>
where
    T: crate::stubs::MetricService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::MetricService for MetricService<T>
where
    T: crate::stubs::MetricService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [NotificationChannelService](crate::stubs::NotificationChannelService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct NotificationChannelService<T>
where
    T: crate::stubs::NotificationChannelService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::NotificationChannelService for NotificationChannelService<T>
where
    T: crate::stubs::NotificationChannelService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [QueryService](crate::stubs::QueryService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct QueryService<T>
where
    T: crate::stubs::QueryService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::QueryService for QueryService<T>
where
    T: crate::stubs::QueryService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [ServiceMonitoringService](crate::stubs::ServiceMonitoringService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ServiceMonitoringService<T>
where
    T: crate::stubs::ServiceMonitoringService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ServiceMonitoringService for ServiceMonitoringService<T>
where
    T: crate::stubs::ServiceMonitoringService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [SnoozeService](crate::stubs::SnoozeService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct SnoozeService<T>
where
    T: crate::stubs::SnoozeService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::SnoozeService for SnoozeService<T>
where
    T: crate::stubs::SnoozeService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [UptimeCheckService](crate::stubs::UptimeCheckService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct UptimeCheckService<T>
where
    T: crate::stubs::UptimeCheckService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::UptimeCheckService for UptimeCheckService<T>
where
    T: crate::stubs::UptimeCheckService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
