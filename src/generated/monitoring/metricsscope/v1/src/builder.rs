...
/// Request and client builders for [MetricsScopes][crate::client::MetricsScopes].
pub mod metrics_scopes {
    ...
    impl CreateMonitoredProject {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::MonitoredProject, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_monitoring_metricsscope_v1::client::MetricsScopes::create_monitored_project::until_done";
            }
    ...
    impl DeleteMonitoredProject {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_monitoring_metricsscope_v1::client::MetricsScopes::delete_monitored_project::until_done";
            }
