...
/// Implements a [MetricsScopes](crate::stubs::MetricsScopes) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct MetricsScopes<T>
where
    T: crate::stubs::MetricsScopes + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::MetricsScopes for MetricsScopes<T>
where
    T: crate::stubs::MetricsScopes + std::fmt::Debug + Send + Sync,
{
