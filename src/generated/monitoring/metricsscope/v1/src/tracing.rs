...
/// Implements a [MetricsScopes](super::stubs::MetricsScopes) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct MetricsScopes<T>
where
    T: super::stubs::MetricsScopes + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::MetricsScopes for MetricsScopes<T>
where
    T: super::stubs::MetricsScopes + std::fmt::Debug + Send + Sync,
{
