...
impl super::stub::DashboardsService for DashboardsService {
    async fn create_dashboard(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}/dashboards", var_parent,);
    ...
    async fn get_dashboard(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.monitoring.dashboard.v1.DashboardsService/GetDashboard")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn update_dashboard(
        ...
        let (builder, method, _path_template) = None
            .or_else(|| {
                let var_dashboard_name = try_match(
                    Some(&req)
                ...
                let path = format!("/v1/{}", var_dashboard_name,);
