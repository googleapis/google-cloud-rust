...
/// Implements a [DashboardsService](super::stubs::DashboardsService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DashboardsService<T>
where
    T: super::stubs::DashboardsService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::DashboardsService for DashboardsService<T>
where
    T: super::stubs::DashboardsService + std::fmt::Debug + Send + Sync,
{
