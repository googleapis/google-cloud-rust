...
/// Implements a [DashboardsService](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DashboardsService<T>
where
    T: crate::traits::DashboardsService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::DashboardsService for DashboardsService<T>
where
    T: crate::traits::DashboardsService + std::fmt::Debug + Send + Sync,
{
