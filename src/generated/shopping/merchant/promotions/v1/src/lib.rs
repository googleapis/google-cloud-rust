...
//!
//! This crate contains traits, types, and functions to interact with Shopping Merchant Promotions API
...
//! # Available Clients
//!
//! * [PromotionsService](client/struct.PromotionsService.html)
//!
//! # Features
//!
