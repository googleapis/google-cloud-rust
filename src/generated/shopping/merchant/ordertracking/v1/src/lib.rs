...
//!
//! This crate contains traits, types, and functions to interact with Shopping Merchant Order Tracking API
...
//! # Available Clients
//!
//! * [OrderTrackingSignalsService](client/struct.OrderTrackingSignalsService.html)
//!
//! # Features
//!
