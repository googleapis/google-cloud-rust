    ...
    async fn delete_log(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{log_name}";
    ...
    async fn write_log_entries(
        ...
        let (builder, method, _path_template) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/entries:write";
    ...
    async fn list_log_entries(
        ...
        let (builder, method, _path_template) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/entries:list";
    ...
    async fn list_monitored_resource_descriptors(
        ...
        let (builder, method, _path_template) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/monitoredResourceDescriptors";
    ...
    async fn list_logs(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/logs";
    ...
    async fn list_buckets(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/buckets";
    ...
    async fn create_bucket_async(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/buckets:createAsync";
    ...
    async fn update_bucket_async(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{name}:updateAsync";
    ...
    async fn list_views(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/views";
    ...
    async fn list_sinks(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/sinks";
    ...
    async fn get_sink(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{sink_name}";
    ...
    async fn create_link(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/links";
    ...
    async fn list_exclusions(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/exclusions";
    ...
    async fn get_cmek_settings(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{name}/cmekSettings";
    ...
    async fn get_settings(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{name}/settings";
    ...
    async fn copy_log_entries(
        ...
        let (builder, method, _path_template) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/entries:copy";
    ...
    async fn list_log_metrics(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/metrics";
    ...
    async fn get_log_metric(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{metric_name}";
