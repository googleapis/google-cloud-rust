    ...
    async fn delete_log(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//logging.googleapis.com/v2/{}", var_log_name,);
    ...
    async fn list_logs(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//logging.googleapis.com/v2/{}/logs", var_parent,);
    ...
    async fn list_buckets(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//logging.googleapis.com/v2/{}/buckets", var_parent,);
    ...
    async fn get_bucket(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//logging.googleapis.com/v2/{}", var_name,);
    ...
    async fn list_sinks(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//logging.googleapis.com/v2/{}/sinks", var_parent,);
    ...
    async fn get_sink(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//logging.googleapis.com/v2/{}", var_sink_name,);
    ...
    async fn create_link(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//logging.googleapis.com/v2/{}/links", var_parent,);
    ...
    async fn list_exclusions(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//logging.googleapis.com/v2/{}/exclusions", var_parent,);
    ...
    async fn get_cmek_settings(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//logging.googleapis.com/v2/{}/cmekSettings", var_name,);
    ...
    async fn get_settings(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//logging.googleapis.com/v2/{}/settings", var_name,);
    ...
    async fn list_log_metrics(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//logging.googleapis.com/v2/{}/metrics", var_parent,);
    ...
    async fn get_log_metric(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//logging.googleapis.com/v2/{}", var_metric_name,);
