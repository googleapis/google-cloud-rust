...
/// Implements a [LoggingServiceV2](super::stubs::LoggingServiceV2) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct LoggingServiceV2<T>
where
    T: super::stubs::LoggingServiceV2 + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::LoggingServiceV2 for LoggingServiceV2<T>
where
    T: super::stubs::LoggingServiceV2 + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [ConfigServiceV2](super::stubs::ConfigServiceV2) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ConfigServiceV2<T>
where
    T: super::stubs::ConfigServiceV2 + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ConfigServiceV2 for ConfigServiceV2<T>
where
    T: super::stubs::ConfigServiceV2 + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [MetricsServiceV2](super::stubs::MetricsServiceV2) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct MetricsServiceV2<T>
where
    T: super::stubs::MetricsServiceV2 + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::MetricsServiceV2 for MetricsServiceV2<T>
where
    T: super::stubs::MetricsServiceV2 + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
