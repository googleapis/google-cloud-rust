...
/// Request and client builders for [LoggingServiceV2][crate::client::LoggingServiceV2].
...
/// Request and client builders for [ConfigServiceV2][crate::client::ConfigServiceV2].
pub mod config_service_v_2 {
    ...
    impl CreateBucketAsync {
        ...
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::LogBucket, crate::model::BucketMetadata>
        {
            type Operation = google_cloud_lro::internal::Operation<
                crate::model::LogBucket,
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_logging_v2::client::ConfigServiceV2::create_bucket_async::until_done";
            }
    ...
    impl UpdateBucketAsync {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::LogBucket, crate::model::BucketMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_logging_v2::client::ConfigServiceV2::update_bucket_async::until_done";
            }
    ...
    impl CreateLink {
        ...
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::Link, crate::model::LinkMetadata> {
            type Operation = google_cloud_lro::internal::Operation<
                crate::model::Link,
                crate::model::LinkMetadata,
            >;
            let polling_error_policy = self.0.stub.get_polling_error_policy(&self.0.options);
            let polling_backoff_policy = self.0.stub.get_polling_backoff_policy(&self.0.options);
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_logging_v2::client::ConfigServiceV2::create_link::until_done";
            }
    ...
    impl DeleteLink {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::LinkMetadata> {
            type Operation =
                google_cloud_lro::internal::Operation<wkt::Empty, crate::model::LinkMetadata>;
            let polling_error_policy = self.0.stub.get_polling_error_policy(&self.0.options);
            let polling_backoff_policy = self.0.stub.get_polling_backoff_policy(&self.0.options);
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_logging_v2::client::ConfigServiceV2::delete_link::until_done";
            }
    ...
    impl CopyLogEntries {
        ...
        > {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_logging_v2::client::ConfigServiceV2::copy_log_entries::until_done";
            }
...
/// Request and client builders for [MetricsServiceV2][crate::client::MetricsServiceV2].
