...
//! Google Cloud Client Libraries for Rust - Street View Publish API
//!
//! This crate contains traits, types, and functions to interact with Street View Publish API
...
//! # Available Clients
//!
//! * [StreetViewPublishService](client/struct.StreetViewPublishService.html)
//!
//! # Features
//!
...
const DEFAULT_HOST: &str = "https://streetviewpublish.googleapis.com/";
