...
impl crate::traits::SecretManagerService for SecretManagerService {
    ...
    async fn list_locations(
        ...
        let builder = self
            ...
            .get(format!(
                ...
                self.inner.endpoint, req.project,
            ))
            .query(&[("alt", "json")]);
        let builder =
    ...
    async fn get_location(
        ...
        let builder = self
            ...
            .get(format!(
                "{}/v1/projects/{}/locations/{}",
                self.inner.endpoint, req.project, req.location,
            ))
            .query(&[("alt", "json")]);
        let access_token = self.fetch_token().await?;
        Self::execute(access_token, builder, None::<NoBody>).await
    ...
    async fn add_secret_version(
        ...
        let builder = self
            ...
            .post(format!(
                ...
                self.inner.endpoint, req.project, req.secret,
            ))
            .query(&[("alt", "json")]);
        let access_token = self.fetch_token().await?;
    ...
    async fn add_secret_version_by_project_and_location_and_secret(
        ...
        let builder = self
            ...
            .post(format!(
                ...
                self.inner.endpoint, req.project, req.location, req.secret,
            ))
            .query(&[("alt", "json")]);
        let access_token = self.fetch_token().await?;
        Self::execute(access_token, builder, Some(req)).await
    ...
    async fn get_secret_version(
        ...
        let builder = self
            ...
            .get(format!(
                "{}/v1/projects/{}/secrets/{}/versions/{}",
                self.inner.endpoint, req.project, req.secret, req.version,
            ))
            .query(&[("alt", "json")]);
        let access_token = self.fetch_token().await?;
        Self::execute(access_token, builder, None::<NoBody>).await
    ...
    async fn get_secret_version_by_project_and_location_and_secret_and_version(
        ...
        let builder = self
            ...
            .get(format!(
                "{}/v1/projects/{}/locations/{}/secrets/{}/versions/{}",
                self.inner.endpoint, req.project, req.location, req.secret, req.version,
            ))
            .query(&[("alt", "json")]);
        let access_token = self.fetch_token().await?;
        Self::execute(access_token, builder, None::<NoBody>).await
