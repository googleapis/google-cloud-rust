...
impl crate::traits::SecretManagerService for SecretManagerService {
    async fn list_locations(
        ...
        let options = options.set_idempotent_default(reqwest::Method::GET.is_idempotent());
        let builder = self
            .inner
            .builder(
                reqwest::Method::GET,
    ...
    async fn create_secret(
        ...
        let options = options.set_idempotent_default(reqwest::Method::POST.is_idempotent());
        let builder = self
            .inner
            .builder(
                reqwest::Method::POST,
    ...
    async fn delete_secret(
        ...
        let options = options.set_idempotent_default(reqwest::Method::DELETE.is_idempotent());
        let builder = self
            .inner
            .builder(
    ...
    async fn update_secret(
        ...
        let options = options.set_idempotent_default(reqwest::Method::PATCH.is_idempotent());
        let builder = self
            .inner
            .builder(
