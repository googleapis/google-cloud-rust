    ...
    async fn enable_service(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//serviceusage.googleapis.com/{}", var_name,);
    ...
    async fn list_services(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//serviceusage.googleapis.com/{}", var_parent,);
                let builder = self.inner.builder(Method::GET, path);
    ...
    async fn batch_enable_services(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/services:batchEnable";
    ...
    async fn batch_get_services(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/services:batchGet";
