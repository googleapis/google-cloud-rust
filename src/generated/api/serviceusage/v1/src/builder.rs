...
/// Request and client builders for [ServiceUsage][crate::client::ServiceUsage].
pub mod service_usage {
    ...
    impl EnableService {
        ...
        > {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_api_serviceusage_v1::client::ServiceUsage::enable_service::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for EnableService {
    ...
    impl DisableService {
        ...
        > {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_api_serviceusage_v1::client::ServiceUsage::disable_service::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DisableService {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl BatchEnableServices {
        ...
        > {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_api_serviceusage_v1::client::ServiceUsage::batch_enable_services::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for BatchEnableServices {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for BatchGetServices {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
