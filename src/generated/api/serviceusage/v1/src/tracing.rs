...
/// Implements a [ServiceUsage](super::stubs::ServiceUsage) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ServiceUsage<T>
where
    T: super::stubs::ServiceUsage + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ServiceUsage for ServiceUsage<T>
where
    T: super::stubs::ServiceUsage + std::fmt::Debug + Send + Sync,
{
