...
/// Implements a [QuotaController](super::stubs::QuotaController) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct QuotaController<T>
where
    T: super::stubs::QuotaController + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::QuotaController for QuotaController<T>
where
    T: super::stubs::QuotaController + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [ServiceController](super::stubs::ServiceController) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ServiceController<T>
where
    T: super::stubs::ServiceController + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ServiceController for ServiceController<T>
where
    T: super::stubs::ServiceController + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
