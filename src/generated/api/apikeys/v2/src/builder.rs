...
/// Request and client builders for [ApiKeys][crate::client::ApiKeys].
pub mod api_keys {
    use crate::Result;
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetKeyString {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UndeleteKey {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for LookupKey {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
