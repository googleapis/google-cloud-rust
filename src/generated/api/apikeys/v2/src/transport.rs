    ...
    async fn create_key(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//apikeys.googleapis.com/v2/{}/keys", var_parent,);
    ...
    async fn get_key(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//apikeys.googleapis.com/v2/{}", var_name,);
    ...
    async fn get_key_string(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//apikeys.googleapis.com/v2/{}/keyString", var_name,);
