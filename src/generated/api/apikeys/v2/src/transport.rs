    ...
    async fn create_key(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/keys";
    ...
    async fn get_key_string(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{name}/keyString";
    ...
    async fn update_key(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{key.name}";

                let resource_name = format!("//apikeys.googleapis.com/{}", var_key_name,);
    ...
    async fn lookup_key(
        ...
        let (builder, method, _path_template) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/keys:lookupKey";
