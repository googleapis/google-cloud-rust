...
/// Implements a [ApiKeys](super::stubs::ApiKeys) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ApiKeys<T>
where
    T: super::stubs::ApiKeys + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ApiKeys for ApiKeys<T>
where
    T: super::stubs::ApiKeys + std::fmt::Debug + Send + Sync,
{
