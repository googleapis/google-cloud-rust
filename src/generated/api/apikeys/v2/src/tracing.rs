...
/// Implements a [ApiKeys](crate::stubs::ApiKeys) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ApiKeys<T>
where
    T: crate::stubs::ApiKeys + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ApiKeys for ApiKeys<T>
where
    T: crate::stubs::ApiKeys + std::fmt::Debug + Send + Sync,
{
