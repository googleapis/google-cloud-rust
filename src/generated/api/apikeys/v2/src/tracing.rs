    ...
    async fn create_key(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::ApiKeys",
                "create_key",
                Some("google.api.apikeys.v2.ApiKeys/CreateKey")
            );
            self.inner
    ...
    async fn list_keys(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::ApiKeys",
                "list_keys",
                Some("google.api.apikeys.v2.ApiKeys/ListKeys")
            );
            self.inner
    ...
    async fn get_key(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::ApiKeys",
                "get_key",
                Some("google.api.apikeys.v2.ApiKeys/GetKey")
            );
            self.inner
                .get_key(req, options)
                .instrument_client(self.duration.clone(), start, span)
    ...
    async fn get_key_string(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::ApiKeys",
                "get_key_string",
                Some("google.api.apikeys.v2.ApiKeys/GetKeyString")
            );
            self.inner
    ...
    async fn update_key(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::ApiKeys",
                "update_key",
                Some("google.api.apikeys.v2.ApiKeys/UpdateKey")
            );
            self.inner
    ...
    async fn delete_key(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::ApiKeys",
                "delete_key",
                Some("google.api.apikeys.v2.ApiKeys/DeleteKey")
            );
            self.inner
    ...
    async fn undelete_key(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::ApiKeys",
                "undelete_key",
                Some("google.api.apikeys.v2.ApiKeys/UndeleteKey")
            );
            self.inner
    ...
    async fn lookup_key(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::ApiKeys",
                "lookup_key",
                Some("google.api.apikeys.v2.ApiKeys/LookupKey")
            );
            self.inner
