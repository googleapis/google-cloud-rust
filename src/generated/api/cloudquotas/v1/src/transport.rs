    ...
    async fn list_quota_infos(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/quotaInfos";
    ...
    async fn list_quota_preferences(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/quotaPreferences";
    ...
    async fn update_quota_preference(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{quota_preference.name}";

                let resource_name =
                    format!("//cloudquotas.googleapis.com/{}", var_quota_preference_name,);
