...
/// [with_credentials()]: super::builder::service_manager::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `ServiceManager` in
...
impl ServiceManager {
    ...
    pub fn builder() -> super::builder::service_manager::ClientBuilder {
        crate::new_client_builder(super::builder::service_manager::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::ServiceManager>> {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::ServiceManager> {
