...
/// Implements a [ServiceManager](crate::stubs::ServiceManager) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ServiceManager<T>
where
    T: crate::stubs::ServiceManager + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ServiceManager for ServiceManager<T>
where
    T: crate::stubs::ServiceManager + std::fmt::Debug + Send + Sync,
{
