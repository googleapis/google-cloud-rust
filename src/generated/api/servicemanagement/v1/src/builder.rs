...
/// Request and client builders for [ServiceManager][crate::client::ServiceManager].
pub mod service_manager {
    ...
    impl CreateService {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::ManagedService, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_api_servicemanagement_v1::client::ServiceManager::create_service::until_done";
            }
    ...
    impl DeleteService {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_api_servicemanagement_v1::client::ServiceManager::delete_service::until_done";
            }
    ...
    impl UndeleteService {
        ...
        > {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_api_servicemanagement_v1::client::ServiceManager::undelete_service::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UndeleteService {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListServiceConfigs {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetServiceConfig {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateServiceConfig {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl SubmitConfigSource {
        ...
        > {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_api_servicemanagement_v1::client::ServiceManager::submit_config_source::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for SubmitConfigSource {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListServiceRollouts {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetServiceRollout {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateServiceRollout {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Rollout, crate::model::OperationMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_api_servicemanagement_v1::client::ServiceManager::create_service_rollout::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateServiceRollout {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GenerateConfigReport {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
