...
impl HealthCheck {
    ...
    /// ```
    /// # use google_cloud_appengine_v1::model::HealthCheck;
    /// let x = HealthCheck::new().set_healthy_threshold(42u32);
    /// ```
    ...
    /// ```
    /// # use google_cloud_appengine_v1::model::HealthCheck;
    /// let x = HealthCheck::new().set_unhealthy_threshold(42u32);
    /// ```
    ...
    /// ```
    /// # use google_cloud_appengine_v1::model::HealthCheck;
    /// let x = HealthCheck::new().set_restart_threshold(42u32);
    /// ```
...
impl ReadinessCheck {
    ...
    /// ```
    /// # use google_cloud_appengine_v1::model::ReadinessCheck;
    /// let x = ReadinessCheck::new().set_failure_threshold(42u32);
    /// ```
    ...
    /// ```
    /// # use google_cloud_appengine_v1::model::ReadinessCheck;
    /// let x = ReadinessCheck::new().set_success_threshold(42u32);
    /// ```
...
impl LivenessCheck {
    ...
    /// ```
    /// # use google_cloud_appengine_v1::model::LivenessCheck;
    /// let x = LivenessCheck::new().set_failure_threshold(42u32);
    /// ```
    pub fn set_failure_threshold<T: std::convert::Into<u32>>(mut self, v: T) -> Self {
        self.failure_threshold = v.into();
        self
    ...
    /// ```
    /// # use google_cloud_appengine_v1::model::LivenessCheck;
    /// let x = LivenessCheck::new().set_success_threshold(42u32);
    /// ```
    pub fn set_success_threshold<T: std::convert::Into<u32>>(mut self, v: T) -> Self {
        self.success_threshold = v.into();
        self
