...
impl Applications {
    ...
    /// ```
    /// # use gax::Result;
    /// # use google_cloud_appengine_v1::model;
    /// async fn wait(
    ///     mut poller: impl lro::Poller<model::Application, model::OperationMetadataV1>
    ...
    /// field contains the final response, this will be a [crate::model::Application] (as
    ...
    ///
    /// [send()]: crate::builders::applications::CreateApplication::send
    /// [poller()]: crate::builders::applications::CreateApplication::poller
    ...
    /// the error status in the [result] field.
    ///
    /// [send()]: crate::builders::applications::UpdateApplication::send
    /// [poller()]: crate::builders::applications::UpdateApplication::poller
    /// [until_done()]: lro::Poller::until_done
    /// [PollingPolicy]: gax::polling_policy::PollingPolicy
    /// [PollingBackoffPolicy]: gax::polling_backoff_policy::PollingBackoffPolicy
    /// [get_operation]: Self::get_operation
    ...
    /// the error status in the [result] field.
    ///
    /// [send()]: crate::builders::applications::RepairApplication::send
    /// [poller()]: crate::builders::applications::RepairApplication::poller
    /// [until_done()]: lro::Poller::until_done
    /// [PollingPolicy]: gax::polling_policy::PollingPolicy
    /// [PollingBackoffPolicy]: gax::polling_backoff_policy::PollingBackoffPolicy
    /// [get_operation]: Self::get_operation
...
impl Services {
    ...
    /// # use google_cloud_appengine_v1::model;
    /// async fn wait(
    ///     mut poller: impl lro::Poller<model::Service, model::OperationMetadataV1>
...
impl Versions {
    ...
    /// # use google_cloud_appengine_v1::model;
    /// async fn wait(
    ///     mut poller: impl lro::Poller<model::Version, model::CreateVersionMetadataV1>
    ...
    ///
    /// If the `done` field is `true`, the operation has completed. The `result`
    /// field contains the final response, this will be a [crate::model::Version] (as
    /// an [Any]), or the error (as a `Status`).
    ///
    /// If the `done` field is `false`, the operation has not completed.  The
    /// operation may also include a [crate::model::CreateVersionMetadataV1] value in the `metadata`
    /// field. This value would also be encoded as an [Any]. The metadata may
    /// include information about how much progress the LRO has made.
    ///
    /// To find out if the operation has completed, use the [get_operation]
    ...
    /// the error status in the [result] field.
    ///
    /// [send()]: crate::builders::versions::CreateVersion::send
    /// [poller()]: crate::builders::versions::CreateVersion::poller
    /// [until_done()]: lro::Poller::until_done
    /// [PollingPolicy]: gax::polling_policy::PollingPolicy
    /// [PollingBackoffPolicy]: gax::polling_backoff_policy::PollingBackoffPolicy
    /// [get_operation]: Self::get_operation
    ...
    /// # use google_cloud_appengine_v1::model;
    /// async fn wait(
    ///     mut poller: impl lro::Poller<model::Version, model::OperationMetadataV1>
    /// ) -> Result<model::Version> {
    ///     poller.until_done().await
    /// }
    /// ```
    ...
    /// the error status in the [result] field.
    ///
    /// [send()]: crate::builders::versions::UpdateVersion::send
    /// [poller()]: crate::builders::versions::UpdateVersion::poller
    /// [until_done()]: lro::Poller::until_done
    /// [PollingPolicy]: gax::polling_policy::PollingPolicy
    /// [PollingBackoffPolicy]: gax::polling_backoff_policy::PollingBackoffPolicy
    /// [get_operation]: Self::get_operation
    ...
    /// the error status in the [result] field.
    ///
    /// [send()]: crate::builders::versions::DeleteVersion::send
    /// [poller()]: crate::builders::versions::DeleteVersion::poller
    /// [until_done()]: lro::Poller::until_done
    /// [PollingPolicy]: gax::polling_policy::PollingPolicy
    /// [PollingBackoffPolicy]: gax::polling_backoff_policy::PollingBackoffPolicy
    /// [get_operation]: Self::get_operation
...
impl Instances {
    ...
    /// the error status in the [result] field.
    ///
    /// [send()]: crate::builders::instances::DeleteInstance::send
    /// [poller()]: crate::builders::instances::DeleteInstance::poller
    /// [until_done()]: lro::Poller::until_done
    /// [PollingPolicy]: gax::polling_policy::PollingPolicy
    /// [PollingBackoffPolicy]: gax::polling_backoff_policy::PollingBackoffPolicy
    /// [get_operation]: Self::get_operation
    ...
    /// # use google_cloud_appengine_v1::model;
    /// async fn wait(
    ///     mut poller: impl lro::Poller<model::Instance, model::OperationMetadataV1>
    ...
    /// the error status in the [result] field.
    ///
    /// [send()]: crate::builders::instances::DebugInstance::send
    /// [poller()]: crate::builders::instances::DebugInstance::poller
    /// [until_done()]: lro::Poller::until_done
    /// [PollingPolicy]: gax::polling_policy::PollingPolicy
    /// [PollingBackoffPolicy]: gax::polling_backoff_policy::PollingBackoffPolicy
    /// [get_operation]: Self::get_operation
...
impl DomainMappings {
    ...
    /// # use google_cloud_appengine_v1::model;
    /// async fn wait(
    ///     mut poller: impl lro::Poller<model::DomainMapping, model::OperationMetadataV1>
    /// ) -> Result<model::DomainMapping> {
    ///     poller.until_done().await
    /// }
    /// ```
    ///
    ...
    ///
    /// If the `done` field is `true`, the operation has completed. The `result`
    /// field contains the final response, this will be a [crate::model::DomainMapping] (as
    /// an [Any]), or the error (as a `Status`).
    ///
    /// If the `done` field is `false`, the operation has not completed.  The
    /// operation may also include a [crate::model::OperationMetadataV1] value in the `metadata`
    ...
    /// the error status in the [result] field.
    ///
    /// [send()]: crate::builders::domain_mappings::CreateDomainMapping::send
    /// [poller()]: crate::builders::domain_mappings::CreateDomainMapping::poller
    /// [until_done()]: lro::Poller::until_done
    /// [PollingPolicy]: gax::polling_policy::PollingPolicy
    /// [PollingBackoffPolicy]: gax::polling_backoff_policy::PollingBackoffPolicy
    /// [get_operation]: Self::get_operation
    ...
    /// the error status in the [result] field.
    ///
    /// [send()]: crate::builders::domain_mappings::UpdateDomainMapping::send
    /// [poller()]: crate::builders::domain_mappings::UpdateDomainMapping::poller
    /// [until_done()]: lro::Poller::until_done
    /// [PollingPolicy]: gax::polling_policy::PollingPolicy
    /// [PollingBackoffPolicy]: gax::polling_backoff_policy::PollingBackoffPolicy
    /// [get_operation]: Self::get_operation
    ...
    /// the error status in the [result] field.
    ///
    /// [send()]: crate::builders::domain_mappings::DeleteDomainMapping::send
    /// [poller()]: crate::builders::domain_mappings::DeleteDomainMapping::poller
    /// [until_done()]: lro::Poller::until_done
    /// [PollingPolicy]: gax::polling_policy::PollingPolicy
    /// [PollingBackoffPolicy]: gax::polling_backoff_policy::PollingBackoffPolicy
    /// [get_operation]: Self::get_operation
