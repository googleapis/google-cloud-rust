...
/// Request and client builders for [Applications][crate::client::Applications].
pub mod applications {
    ...
    impl CreateApplication {
        ...
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::Application, crate::model::OperationMetadataV1>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_appengine_v1::client::Applications::create_application::until_done";
            }
    ...
    impl UpdateApplication {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Application, crate::model::OperationMetadataV1>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_appengine_v1::client::Applications::update_application::until_done";
            }
    ...
    impl RepairApplication {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `repair_application`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::Application, crate::model::OperationMetadataV1>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_appengine_v1::client::Applications::repair_application::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for RepairApplication {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
...
/// Request and client builders for [Services][crate::client::Services].
pub mod services {
    use crate::Result;
    ...
    impl UpdateService {
        ...
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::Service, crate::model::OperationMetadataV1>
        {
            type Operation = google_cloud_lro::internal::Operation<
                crate::model::Service,
                crate::model::OperationMetadataV1,
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_appengine_v1::client::Services::update_service::until_done";
            }
    ...
    impl DeleteService {
        ...
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadataV1> {
            type Operation = google_cloud_lro::internal::Operation<
                wkt::Empty,
                crate::model::OperationMetadataV1,
            >;
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_appengine_v1::client::Services::delete_service::until_done";
            }
...
pub mod versions {
    ...
    impl CreateVersion {
        ...
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::Version, crate::model::CreateVersionMetadataV1>
        {
            type Operation = google_cloud_lro::internal::Operation<
                crate::model::Version,
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_appengine_v1::client::Versions::create_version::until_done";
            }
    ...
    impl UpdateVersion {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `update_version`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::Version, crate::model::OperationMetadataV1>
        {
            type Operation = google_cloud_lro::internal::Operation<
                crate::model::Version,
                crate::model::OperationMetadataV1,
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_appengine_v1::client::Versions::update_version::until_done";
            }
    ...
    impl DeleteVersion {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `delete_version`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadataV1> {
            type Operation = google_cloud_lro::internal::Operation<
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_appengine_v1::client::Versions::delete_version::until_done";
            }
...
/// Request and client builders for [Instances][crate::client::Instances].
pub mod instances {
    use crate::Result;
    ...
    impl DeleteInstance {
        ...
        pub fn poller(
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_appengine_v1::client::Instances::delete_instance::until_done";
            }
    ...
    impl DebugInstance {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `debug_instance`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::Instance, crate::model::OperationMetadataV1>
        {
            type Operation = google_cloud_lro::internal::Operation<
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_appengine_v1::client::Instances::debug_instance::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DebugInstance {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
...
/// Request and client builders for [Firewall][crate::client::Firewall].
pub mod firewall {
    use crate::Result;
    ...
    impl ListIngressRules {
        ...
        pub fn by_page(
            ...
            crate::model::ListIngressRulesResponse,
            crate::Error,
        > {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListIngressRules {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for BatchUpdateIngressRules {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateIngressRule {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetIngressRule {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateIngressRule {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteIngressRule {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
...
/// Request and client builders for [AuthorizedDomains][crate::client::AuthorizedDomains].
pub mod authorized_domains {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListAuthorizedDomains {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
...
/// Request and client builders for [AuthorizedCertificates][crate::client::AuthorizedCertificates].
pub mod authorized_certificates {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListAuthorizedCertificates {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetAuthorizedCertificate {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateAuthorizedCertificate {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateAuthorizedCertificate {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteAuthorizedCertificate {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
...
/// Request and client builders for [DomainMappings][crate::client::DomainMappings].
pub mod domain_mappings {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListDomainMappings {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetDomainMapping {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateDomainMapping {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `create_domain_mapping`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::DomainMapping, crate::model::OperationMetadataV1>
        {
            type Operation = google_cloud_lro::internal::Operation<
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_appengine_v1::client::DomainMappings::create_domain_mapping::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateDomainMapping {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UpdateDomainMapping {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `update_domain_mapping`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::DomainMapping, crate::model::OperationMetadataV1>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_appengine_v1::client::DomainMappings::update_domain_mapping::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateDomainMapping {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteDomainMapping {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `delete_domain_mapping`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadataV1> {
            type Operation = google_cloud_lro::internal::Operation<
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_appengine_v1::client::DomainMappings::delete_domain_mapping::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteDomainMapping {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
