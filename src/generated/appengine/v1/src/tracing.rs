...
/// Implements a [Applications](crate::stubs::Applications) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Applications<T>
where
    T: crate::stubs::Applications + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::Applications for Applications<T>
where
    T: crate::stubs::Applications + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [Services](crate::stubs::Services) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Services<T>
where
    T: crate::stubs::Services + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::Services for Services<T>
where
    T: crate::stubs::Services + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Instances](crate::stubs::Instances) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Instances<T>
where
    T: crate::stubs::Instances + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::Instances for Instances<T>
where
    T: crate::stubs::Instances + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [Firewall](crate::stubs::Firewall) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Firewall<T>
where
    T: crate::stubs::Firewall + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::Firewall for Firewall<T>
where
    T: crate::stubs::Firewall + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [AuthorizedDomains](crate::stubs::AuthorizedDomains) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AuthorizedDomains<T>
where
    T: crate::stubs::AuthorizedDomains + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::AuthorizedDomains for AuthorizedDomains<T>
where
    T: crate::stubs::AuthorizedDomains + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [AuthorizedCertificates](crate::stubs::AuthorizedCertificates) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AuthorizedCertificates<T>
where
    T: crate::stubs::AuthorizedCertificates + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::AuthorizedCertificates for AuthorizedCertificates<T>
where
    T: crate::stubs::AuthorizedCertificates + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
...
/// Implements a [DomainMappings](crate::stubs::DomainMappings) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DomainMappings<T>
where
    T: crate::stubs::DomainMappings + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::DomainMappings for DomainMappings<T>
where
    T: crate::stubs::DomainMappings + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
