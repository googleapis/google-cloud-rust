...
//! 
//!
//! This crate contains traits, types, and functions to interact with Access Context Manager API
...
const DEFAULT_HOST: &str = "https://accesscontextmanager.googleapis.com/";
