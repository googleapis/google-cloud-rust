...
/// [with_credentials()]: super::builder::access_context_manager::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `AccessContextManager` in
