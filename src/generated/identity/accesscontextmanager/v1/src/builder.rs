...
/// Request and client builders for [AccessContextManager][crate::client::AccessContextManager].
pub mod access_context_manager {
    ...
    impl CreateAccessPolicy {
        ...
        > {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_identity_accesscontextmanager_v1::client::AccessContextManager::create_access_policy::until_done";
            }
    ...
    impl UpdateAccessPolicy {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_identity_accesscontextmanager_v1::client::AccessContextManager::update_access_policy::until_done";
            }
    ...
    impl DeleteAccessPolicy {
        ...
        ) -> impl google_cloud_lro::Poller<(), crate::model::AccessContextManagerOperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_identity_accesscontextmanager_v1::client::AccessContextManager::delete_access_policy::until_done";
            }
    ...
    impl ListAccessLevels {
        ...
        pub fn by_page(
            ...
            crate::model::ListAccessLevelsResponse,
            crate::Error,
        > {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListAccessLevels {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetAccessLevel {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateAccessLevel {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_identity_accesscontextmanager_v1::client::AccessContextManager::create_access_level::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateAccessLevel {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UpdateAccessLevel {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_identity_accesscontextmanager_v1::client::AccessContextManager::update_access_level::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateAccessLevel {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteAccessLevel {
        ...
        ) -> impl google_cloud_lro::Poller<(), crate::model::AccessContextManagerOperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_identity_accesscontextmanager_v1::client::AccessContextManager::delete_access_level::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteAccessLevel {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ReplaceAccessLevels {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_identity_accesscontextmanager_v1::client::AccessContextManager::replace_access_levels::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ReplaceAccessLevels {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListServicePerimeters {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetServicePerimeter {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateServicePerimeter {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_identity_accesscontextmanager_v1::client::AccessContextManager::create_service_perimeter::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateServicePerimeter {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UpdateServicePerimeter {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_identity_accesscontextmanager_v1::client::AccessContextManager::update_service_perimeter::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateServicePerimeter {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteServicePerimeter {
        ...
        ) -> impl google_cloud_lro::Poller<(), crate::model::AccessContextManagerOperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_identity_accesscontextmanager_v1::client::AccessContextManager::delete_service_perimeter::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteServicePerimeter {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ReplaceServicePerimeters {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_identity_accesscontextmanager_v1::client::AccessContextManager::replace_service_perimeters::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ReplaceServicePerimeters {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CommitServicePerimeters {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_identity_accesscontextmanager_v1::client::AccessContextManager::commit_service_perimeters::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CommitServicePerimeters {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListGcpUserAccessBindings {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetGcpUserAccessBinding {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateGcpUserAccessBinding {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_identity_accesscontextmanager_v1::client::AccessContextManager::create_gcp_user_access_binding::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateGcpUserAccessBinding {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UpdateGcpUserAccessBinding {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_identity_accesscontextmanager_v1::client::AccessContextManager::update_gcp_user_access_binding::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateGcpUserAccessBinding {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteGcpUserAccessBinding {
        ...
        ) -> impl google_cloud_lro::Poller<(), crate::model::GcpUserAccessBindingOperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_identity_accesscontextmanager_v1::client::AccessContextManager::delete_gcp_user_access_binding::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteGcpUserAccessBinding {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
