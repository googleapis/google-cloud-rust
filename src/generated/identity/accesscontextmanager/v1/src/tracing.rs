...
/// Implements a [AccessContextManager](super::stubs::AccessContextManager) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AccessContextManager<T>
where
    T: super::stubs::AccessContextManager + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::AccessContextManager for AccessContextManager<T>
where
    T: super::stubs::AccessContextManager + std::fmt::Debug + Send + Sync,
{
