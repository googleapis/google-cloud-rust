...
/// Implements a [AccessContextManager](crate::stubs::AccessContextManager) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AccessContextManager<T>
where
    T: crate::stubs::AccessContextManager + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::AccessContextManager for AccessContextManager<T>
where
    T: crate::stubs::AccessContextManager + std::fmt::Debug + Send + Sync,
{
