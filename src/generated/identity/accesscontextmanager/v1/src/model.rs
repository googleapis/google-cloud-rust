...
impl AccessLevel {
    ...
    /// let x = AccessLevel::new().set_level(Some(
    ///     google_cloud_identity_accesscontextmanager_v1::model::access_level::Level::Basic(BasicLevel::default().into())));
    /// ```
...
pub mod service_perimeter_config {
    ...
    impl MethodSelector {
        ...
        /// use google_cloud_identity_accesscontextmanager_v1::model::service_perimeter_config::method_selector::Kind;
        /// let x = MethodSelector::new().set_kind(Some(Kind::Method("example".to_string())));
        /// ```
    ...
    impl IngressSource {
        ...
        /// use google_cloud_identity_accesscontextmanager_v1::model::service_perimeter_config::ingress_source::Source;
        /// let x = IngressSource::new().set_source(Some(Source::AccessLevel("example".to_string())));
        /// ```
