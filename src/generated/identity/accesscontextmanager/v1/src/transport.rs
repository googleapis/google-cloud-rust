...
impl super::stub::AccessContextManager for AccessContextManager {
    async fn list_access_policies(
        ...
        let response: crate::model::ListAccessPoliciesResponse = self
            .inner
    ...
    async fn get_access_policy(
        ...
        let response: crate::model::AccessPolicy = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn list_access_levels(
        ...
        let response: crate::model::ListAccessLevelsResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn get_access_level(
        ...
        let builder = builder.query(&[("accessLevelFormat", &req.access_level_format.value())]);
        let response: crate::model::AccessLevel = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn list_service_perimeters(
        ...
        let builder = builder.query(&[("pageSize", &req.page_size)]);
        let builder = builder.query(&[("pageToken", &req.page_token)]);
        let response: crate::model::ListServicePerimetersResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn get_service_perimeter(
        ...
        let response: crate::model::ServicePerimeter = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn list_gcp_user_access_bindings(
        ...
        let builder = builder.query(&[("pageSize", &req.page_size)]);
        let builder = builder.query(&[("pageToken", &req.page_token)]);
        let response: crate::model::ListGcpUserAccessBindingsResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn get_gcp_user_access_binding(
        ...
        let response: crate::model::GcpUserAccessBinding = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
