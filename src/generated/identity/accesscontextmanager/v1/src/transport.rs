    ...
    async fn get_access_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//accesscontextmanager.googleapis.com/v1/{}", var_name,);
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//accesscontextmanager.googleapis.com/v1/{}/accessLevels",
                    var_parent,
                );
    ...
    async fn list_service_perimeters(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//accesscontextmanager.googleapis.com/v1/{}/servicePerimeters",
                    var_parent,
                );
    ...
    async fn list_gcp_user_access_bindings(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//accesscontextmanager.googleapis.com/v1/{}/gcpUserAccessBindings",
                    var_parent,
                );
    ...
    async fn set_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//accesscontextmanager.googleapis.com/v1/{}", var_resource,);
