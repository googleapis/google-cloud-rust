    ...
    async fn list_instance_configs(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/instanceConfigs";
    ...
    async fn update_instance_config(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{instance_config.name}";

                let resource_name =
                    format!("//spanner.googleapis.com/{}", var_instance_config_name,);
    ...
    async fn list_instance_config_operations(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/instanceConfigOperations";
    ...
    async fn list_instance_partitions(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/instancePartitions";
    ...
    async fn update_instance(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//spanner.googleapis.com/{}", var_instance_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = Ok(builder);
                Some(builder.map(|b| (b, Method::PATCH, _path_template, resource_name)))
            })
    ...
    async fn update_instance_partition(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{instance_partition.name}";

                let resource_name =
                    format!("//spanner.googleapis.com/{}", var_instance_partition_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = Ok(builder);
                Some(builder.map(|b| (b, Method::PATCH, _path_template, resource_name)))
            })
    ...
    async fn list_instance_partition_operations(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/instancePartitionOperations";
