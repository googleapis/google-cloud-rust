    ...
    async fn list_instance_configs(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//spanner.googleapis.com/v1/{}/instanceConfigs", var_parent,);
    ...
    async fn get_instance_config(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//spanner.googleapis.com/v1/{}", var_name,);
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//spanner.googleapis.com/v1/{}/instanceConfigOperations",
                    var_parent,
                );
    ...
    async fn list_instances(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//spanner.googleapis.com/v1/{}/instances", var_parent,);
    ...
    async fn list_instance_partitions(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//spanner.googleapis.com/v1/{}/instancePartitions",
                    var_parent,
                );
    ...
    async fn set_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//spanner.googleapis.com/v1/{}", var_resource,);
    ...
    async fn list_instance_partition_operations(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//spanner.googleapis.com/v1/{}/instancePartitionOperations",
                    var_parent,
                );
