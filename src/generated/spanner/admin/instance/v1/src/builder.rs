...
/// Request and client builders for [InstanceAdmin][crate::client::InstanceAdmin].
pub mod instance_admin {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListInstanceConfigs {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetInstanceConfig {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateInstanceConfig {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `create_instance_config`.
        pub fn poller(
            self,
        ...
        > {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_spanner_admin_instance_v1::client::InstanceAdmin::create_instance_config::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateInstanceConfig {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UpdateInstanceConfig {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `update_instance_config`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<
            crate::model::InstanceConfig,
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_spanner_admin_instance_v1::client::InstanceAdmin::update_instance_config::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateInstanceConfig {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteInstanceConfig {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListInstanceConfigOperations {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListInstancePartitions {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateInstance {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Instance, crate::model::CreateInstanceMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_spanner_admin_instance_v1::client::InstanceAdmin::create_instance::until_done";
            }
    ...
    impl UpdateInstance {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Instance, crate::model::UpdateInstanceMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_spanner_admin_instance_v1::client::InstanceAdmin::update_instance::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetInstancePartition {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateInstancePartition {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `create_instance_partition`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_spanner_admin_instance_v1::client::InstanceAdmin::create_instance_partition::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateInstancePartition {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteInstancePartition {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UpdateInstancePartition {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `update_instance_partition`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<
            crate::model::InstancePartition,
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_spanner_admin_instance_v1::client::InstanceAdmin::update_instance_partition::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateInstancePartition {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListInstancePartitionOperations {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl MoveInstance {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `move_instance`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_spanner_admin_instance_v1::client::InstanceAdmin::move_instance::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for MoveInstance {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
