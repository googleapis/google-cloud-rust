...
/// Implements a [InstanceAdmin](crate::stubs::InstanceAdmin) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct InstanceAdmin<T>
where
    T: crate::stubs::InstanceAdmin + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::InstanceAdmin for InstanceAdmin<T>
where
    T: crate::stubs::InstanceAdmin + std::fmt::Debug + Send + Sync,
{
