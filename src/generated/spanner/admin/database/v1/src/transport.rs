    ...
    async fn list_databases(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//spanner.googleapis.com/v1/{}/databases", var_parent,);
    ...
    async fn update_database_ddl(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//spanner.googleapis.com/v1/{}/ddl", var_database,);
    ...
    async fn drop_database(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//spanner.googleapis.com/v1/{}", var_database,);
    ...
    async fn create_backup(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//spanner.googleapis.com/v1/{}/backups", var_parent,);
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//spanner.googleapis.com/v1/{}/databaseOperations",
                    var_parent,
                );
    ...
    async fn list_backup_operations(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//spanner.googleapis.com/v1/{}/backupOperations",
                    var_parent,
                );
    ...
    async fn list_database_roles(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//spanner.googleapis.com/v1/{}/databaseRoles", var_parent,);
    ...
    async fn create_backup_schedule(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//spanner.googleapis.com/v1/{}/backupSchedules", var_parent,);
