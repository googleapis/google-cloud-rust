...
impl BackupScheduleSpec {
    ...
    /// let x = BackupScheduleSpec::new().set_schedule_spec(Some(
    ///     google_cloud_spanner_admin_database_v1::model::backup_schedule_spec::ScheduleSpec::CronSpec(CrontabSpec::default().into())));
    /// ```
...
impl BackupSchedule {
    ...
    ///     google_cloud_spanner_admin_database_v1::model::backup_schedule::BackupTypeSpec::FullBackupSpec(FullBackupSpec::default().into())));
    /// ```
...
impl RestoreInfo {
    ...
    ///     google_cloud_spanner_admin_database_v1::model::restore_info::SourceInfo::BackupInfo(BackupInfo::default().into())));
    /// ```
...
impl RestoreDatabaseRequest {
    ...
    /// ```ignore,no_run
    /// # use google_cloud_spanner_admin_database_v1::model::RestoreDatabaseRequest;
    /// use google_cloud_spanner_admin_database_v1::model::restore_database_request::Source;
    /// let x = RestoreDatabaseRequest::new().set_source(Some(Source::Backup("example".to_string())));
    /// ```
...
impl RestoreDatabaseMetadata {
    ...
    ///     google_cloud_spanner_admin_database_v1::model::restore_database_metadata::SourceInfo::BackupInfo(BackupInfo::default().into())));
    /// ```
