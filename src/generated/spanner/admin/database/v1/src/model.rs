...
pub struct InternalUpdateGraphOperationRequest {
    ...
    /// Internal field, do not use directly.
    pub vm_identity_token: std::string::String,
...
impl InternalUpdateGraphOperationRequest {
    pub fn new() -> Self {
        std::default::Default::default()
    }

    /// Sets the value of [database][crate::model::InternalUpdateGraphOperationRequest::database].
    pub fn set_database<T: std::convert::Into<std::string::String>>(mut self, v: T) -> Self {
        self.database = v.into();
        self
    }

    /// Sets the value of [operation_id][crate::model::InternalUpdateGraphOperationRequest::operation_id].
    pub fn set_operation_id<T: std::convert::Into<std::string::String>>(mut self, v: T) -> Self {
        self.operation_id = v.into();
        self
    }

    /// Sets the value of [vm_identity_token][crate::model::InternalUpdateGraphOperationRequest::vm_identity_token].
    pub fn set_vm_identity_token<T: std::convert::Into<std::string::String>>(
        mut self,
        v: T,
    ) -> Self {
        self.vm_identity_token = v.into();
        self
    }

    /// Sets the value of [progress][crate::model::InternalUpdateGraphOperationRequest::progress].
    pub fn set_progress<T: std::convert::Into<f64>>(mut self, v: T) -> Self {
        self.progress = v.into();
        self
    }

    /// Sets the value of [status][crate::model::InternalUpdateGraphOperationRequest::status].
    ...
    /// Sets or clears the value of [status][crate::model::InternalUpdateGraphOperationRequest::status].
...
impl wkt::message::Message for InternalUpdateGraphOperationRequest {
    fn typename() -> &'static str {
        "type.googleapis.com/google.spanner.admin.database.v1.InternalUpdateGraphOperationRequest"
    }
}

#[doc(hidden)]
impl<'de> serde::de::Deserialize<'de> for InternalUpdateGraphOperationRequest {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Deserialize<'de> for __FieldTag {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for Visitor {
                    type Value = __FieldTag;
                    fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                        formatter.write_str("a field name for InternalUpdateGraphOperationRequest")
                    }
                    fn visit_str<E>(self, value: &str) -> std::result::Result<Self::Value, E>
                    where
                        E: serde::de::Error,
                    {
                        ...
                        match value {
                            ...
                            "operationId" => Ok(__FieldTag::__operation_id),
                            "operation_id" => Ok(__FieldTag::__operation_id),
                            "vmIdentityToken" => Ok(__FieldTag::__vm_identity_token),
                            "vm_identity_token" => Ok(__FieldTag::__vm_identity_token),
                            "progress" => Ok(__FieldTag::__progress),
        ...
        struct Visitor;
        impl<'de> serde::de::Visitor<'de> for Visitor {
            type Value = InternalUpdateGraphOperationRequest;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("struct InternalUpdateGraphOperationRequest")
            }
            fn visit_map<A>(self, mut map: A) -> std::result::Result<Self::Value, A::Error>
            where
                A: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(tag) = map.next_key::<__FieldTag>()? {
                    ...
                    match tag {
                        ...
                        __FieldTag::__vm_identity_token => {
                            if !fields.insert(__FieldTag::__vm_identity_token) {
                                return std::result::Result::Err(A::Error::duplicate_field(
                                    "multiple values for vm_identity_token",
                                ));
                            }
                            result.vm_identity_token = map
                                .next_value::<std::option::Option<std::string::String>>()?
                                .unwrap_or_default();
                        }
                        __FieldTag::__progress => {
...
#[doc(hidden)]
impl serde::ser::Serialize for InternalUpdateGraphOperationRequest {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if !self.vm_identity_token.is_empty() {
            state.serialize_entry("vmIdentityToken", &self.vm_identity_token)?;
        }
...
impl std::fmt::Debug for InternalUpdateGraphOperationRequest {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut debug_struct = f.debug_struct("InternalUpdateGraphOperationRequest");
        debug_struct.field("database", &self.database);
        debug_struct.field("operation_id", &self.operation_id);
        debug_struct.field("vm_identity_token", &self.vm_identity_token);
        debug_struct.field("progress", &self.progress);
...
impl InternalUpdateGraphOperationResponse {
    pub fn new() -> Self {
        std::default::Default::default()
    }
}

impl wkt::message::Message for InternalUpdateGraphOperationResponse {
    fn typename() -> &'static str {
        "type.googleapis.com/google.spanner.admin.database.v1.InternalUpdateGraphOperationResponse"
    }
}

#[doc(hidden)]
impl<'de> serde::de::Deserialize<'de> for InternalUpdateGraphOperationResponse {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Deserialize<'de> for __FieldTag {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for Visitor {
                    type Value = __FieldTag;
                    fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                        formatter.write_str("a field name for InternalUpdateGraphOperationResponse")
                    }
                    fn visit_str<E>(self, value: &str) -> std::result::Result<Self::Value, E>
                    where
                        E: serde::de::Error,
        ...
        struct Visitor;
        impl<'de> serde::de::Visitor<'de> for Visitor {
            type Value = InternalUpdateGraphOperationResponse;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("struct InternalUpdateGraphOperationResponse")
            }
            fn visit_map<A>(self, mut map: A) -> std::result::Result<Self::Value, A::Error>
            where
                A: serde::de::MapAccess<'de>,
...
#[doc(hidden)]
impl serde::ser::Serialize for InternalUpdateGraphOperationResponse {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl std::fmt::Debug for InternalUpdateGraphOperationResponse {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut debug_struct = f.debug_struct("InternalUpdateGraphOperationResponse");
        if !self._unknown_fields.is_empty() {
            debug_struct.field("_unknown_fields", &self._unknown_fields);
        }
        debug_struct.finish()
