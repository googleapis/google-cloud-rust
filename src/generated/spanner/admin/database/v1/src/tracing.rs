...
/// Implements a [DatabaseAdmin](super::stubs::DatabaseAdmin) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DatabaseAdmin<T>
where
    T: super::stubs::DatabaseAdmin + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::DatabaseAdmin for DatabaseAdmin<T>
where
    T: super::stubs::DatabaseAdmin + std::fmt::Debug + Send + Sync,
{
