...
/// Implements a [DatabaseAdmin](crate::stubs::DatabaseAdmin) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DatabaseAdmin<T>
where
    T: crate::stubs::DatabaseAdmin + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::DatabaseAdmin for DatabaseAdmin<T>
where
    T: crate::stubs::DatabaseAdmin + std::fmt::Debug + Send + Sync,
{
