...
/// Request and client builders for [DatabaseAdmin][crate::client::DatabaseAdmin].
pub mod database_admin {
    ...
    impl CreateDatabase {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Database, crate::model::CreateDatabaseMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_spanner_admin_database_v1::client::DatabaseAdmin::create_database::until_done";
            }
    ...
    impl UpdateDatabase {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Database, crate::model::UpdateDatabaseMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_spanner_admin_database_v1::client::DatabaseAdmin::update_database::until_done";
            }
    ...
    impl UpdateDatabaseDdl {
        ...
        pub fn poller(
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_spanner_admin_database_v1::client::DatabaseAdmin::update_database_ddl::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateDatabaseDdl {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DropDatabase {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetDatabaseDdl {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl CreateBackup {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Backup, crate::model::CreateBackupMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_spanner_admin_database_v1::client::DatabaseAdmin::create_backup::until_done";
            }
    ...
    impl CopyBackup {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Backup, crate::model::CopyBackupMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_spanner_admin_database_v1::client::DatabaseAdmin::copy_backup::until_done";
            }
    ...
    impl RestoreDatabase {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Database, crate::model::RestoreDatabaseMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_spanner_admin_database_v1::client::DatabaseAdmin::restore_database::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListDatabaseOperations {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListBackupOperations {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListDatabaseRoles {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for AddSplitPoints {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
