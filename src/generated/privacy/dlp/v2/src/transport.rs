    ...
    async fn inspect_content(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/content:inspect";
    ...
    async fn redact_image(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/image:redact";
    ...
    async fn deidentify_content(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/content:deidentify";
    ...
    async fn reidentify_content(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/content:reidentify";
    ...
    async fn list_info_types(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/infoTypes";
            ...
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/infoTypes";
    ...
    async fn create_inspect_template(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/inspectTemplates";
    ...
    async fn create_deidentify_template(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/deidentifyTemplates";
    ...
    async fn create_job_trigger(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/jobTriggers";
    ...
    async fn hybrid_inspect_job_trigger(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{name}:hybridInspect";
    ...
    async fn activate_job_trigger(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{name}:activate";
    ...
    async fn create_discovery_config(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/discoveryConfigs";
    ...
    async fn create_dlp_job(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/dlpJobs";
    ...
    async fn create_stored_info_type(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/storedInfoTypes";
    ...
    async fn list_project_data_profiles(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/projectDataProfiles";
    ...
    async fn list_table_data_profiles(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/tableDataProfiles";
    ...
    async fn list_column_data_profiles(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/columnDataProfiles";
    ...
    async fn list_file_store_data_profiles(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/fileStoreDataProfiles";
    ...
    async fn finish_dlp_job(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{name}:finish";
    ...
    async fn search_connections(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/connections:search";
