...
impl ComplianceData {
    ...
    pub fn maybe_f_child<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<crate::model::ComplianceDataChild>,
    {
    ...
    pub fn maybe_p_string<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<std::string::String>,
    {
    ...
    pub fn maybe_p_bool<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<bool>,
    {
    ...
    pub fn maybe_p_kingdom<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<crate::model::compliance_data::LifeKingdom>,
    {
    ...
    pub fn maybe_p_child<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<crate::model::ComplianceDataChild>,
    {
...
impl ComplianceDataChild {
    ...
    pub fn maybe_p_float<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<f32>,
    {
...
impl EchoErrorDetailsResponse {
    ...
    pub fn maybe_single_detail<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<crate::model::echo_error_details_response::SingleDetail>,
    {
    ...
    pub fn maybe_multiple_details<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<crate::model::echo_error_details_response::MultipleDetails>,
    {
...
impl ExpandRequest {
    ...
    pub fn maybe_stream_wait_time<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<wkt::Duration>,
    {
...
impl User {
    ...
    pub fn maybe_age<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<i32>,
    {
    ...
    pub fn maybe_height_feet<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<f64>,
    {
    ...
    pub fn maybe_nickname<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<std::string::String>,
    {
    ...
    pub fn maybe_enable_notifications<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<bool>,
    {
...
impl SearchBlurbsMetadata {
    ...
    pub fn maybe_retry_info<T>(mut self, v: std::option::Option<T>) -> Self
    where
        T: std::convert::Into<rpc::model::RetryInfo>,
    {
...
pub mod streaming_sequence_report {
    ...
    impl Attempt {
        ...
        pub fn maybe_attempt_delay<T>(mut self, v: std::option::Option<T>) -> Self
        where
            T: std::convert::Into<wkt::Duration>,
        {
