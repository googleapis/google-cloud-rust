...
/// Implements [DeveloperKnowledge](super::stub::DeveloperKnowledge) using a [gaxi::http::ReqwestClient].
#[derive(Clone)]
pub struct DeveloperKnowledge {
    inner: gaxi::http::ReqwestClient,
}

impl std::fmt::Debug for DeveloperKnowledge {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::result::Result<(), std::fmt::Error> {
        f.debug_struct("DeveloperKnowledge")
...
impl super::stub::DeveloperKnowledge for DeveloperKnowledge {
    async fn search_document_chunks(
        ...
        let (builder, method, _path_template) = None
            .or_else(|| {
                let path = "/v1/documents:searchDocumentChunks".to_string();
                let path_template = "/v1/documents:searchDocumentChunks";
    ...
    async fn get_document(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//developerknowledge.googleapis.com/{}", var_name,);
                let builder = self.inner.builder(Method::GET, path);
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.developers.knowledge.v1.DeveloperKnowledge/GetDocument")
                    .set_url_template(_path_template)
    ...
    async fn batch_get_documents(
        ...
        let (builder, method, _path_template) = None
            .or_else(|| {
                let path = "/v1/documents:batchGet".to_string();
                let path_template = "/v1/documents:batchGet";
    ...
    async fn answer_query(
        ...
        let (builder, method, _path_template) = None
            .or_else(|| {
                let path = "/v1:answerQuery".to_string();
                let path_template = "/v1:answerQuery";
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.developers.knowledge.v1.DeveloperKnowledge/AnswerQuery")
                    .set_url_template(_path_template),
            );
        }
        let options = google_cloud_gax::options::internal::set_default_idempotency(
