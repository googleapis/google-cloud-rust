...
/// Implements a [Policies](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Policies<T>
where
    T: crate::traits::Policies + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::Policies for Policies<T>
where
    T: crate::traits::Policies + std::fmt::Debug + Send + Sync,
{
