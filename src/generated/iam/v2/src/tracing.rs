...
/// Implements a [Policies](super::stubs::Policies) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Policies<T>
where
    T: super::stubs::Policies + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Policies for Policies<T>
where
    T: super::stubs::Policies + std::fmt::Debug + Send + Sync,
{
