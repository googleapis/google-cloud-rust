...
/// Implements a [Policies](crate::stubs::Policies) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Policies<T>
where
    T: crate::stubs::Policies + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::Policies for Policies<T>
where
    T: crate::stubs::Policies + std::fmt::Debug + Send + Sync,
{
