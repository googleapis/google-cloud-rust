...
pub mod policies {
    ...
    impl CreatePolicy {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Policy, crate::model::PolicyOperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_iam_v2::client::Policies::create_policy::until_done";
            }
    ...
    impl UpdatePolicy {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Policy, crate::model::PolicyOperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_iam_v2::client::Policies::update_policy::until_done";
            }
    ...
    impl DeletePolicy {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Policy, crate::model::PolicyOperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_iam_v2::client::Policies::delete_policy::until_done";
            }
