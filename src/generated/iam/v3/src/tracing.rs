...
/// Implements a [PolicyBindings](super::stubs::PolicyBindings) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct PolicyBindings<T>
where
    T: super::stubs::PolicyBindings + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::PolicyBindings for PolicyBindings<T>
where
    T: super::stubs::PolicyBindings + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [PrincipalAccessBoundaryPolicies](super::stubs::PrincipalAccessBoundaryPolicies) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct PrincipalAccessBoundaryPolicies<T>
where
    T: super::stubs::PrincipalAccessBoundaryPolicies + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::PrincipalAccessBoundaryPolicies for PrincipalAccessBoundaryPolicies<T>
where
    T: super::stubs::PrincipalAccessBoundaryPolicies + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
