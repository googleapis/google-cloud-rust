...
/// Implements a [AccessPolicies](super::stub::AccessPolicies) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct AccessPolicies<T>
where
    T: super::stub::AccessPolicies + std::fmt::Debug + Send + Sync,
{
    inner: T,
    duration: gaxi::observability::DurationMetric,
}

impl<T> AccessPolicies<T>
where
    T: super::stub::AccessPolicies + std::fmt::Debug + Send + Sync,
{
...
impl<T> super::stub::AccessPolicies for AccessPolicies<T>
where
    T: super::stub::AccessPolicies + std::fmt::Debug + Send + Sync,
{
    ...
    async fn create_access_policy(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            ...
            method: "client::AccessPolicies::create_access_policy",
    ...
    async fn get_access_policy(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::AccessPolicies::get_access_policy",
    ...
    async fn update_access_policy(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::AccessPolicies::update_access_policy",
    ...
    async fn delete_access_policy(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::AccessPolicies::delete_access_policy",
    ...
    async fn list_access_policies(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::AccessPolicies::list_access_policies",
    ...
    async fn search_access_policy_bindings(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::AccessPolicies::search_access_policy_bindings",
            self.inner.search_access_policy_bindings(req, options));
        pending.await
    }
    ...
    async fn get_operation(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::AccessPolicies::get_operation",
