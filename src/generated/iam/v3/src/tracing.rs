...
/// Implements a [PolicyBindings](crate::stubs::PolicyBindings) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct PolicyBindings<T>
where
    T: crate::stubs::PolicyBindings + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::PolicyBindings for PolicyBindings<T>
where
    T: crate::stubs::PolicyBindings + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [PrincipalAccessBoundaryPolicies](crate::stubs::PrincipalAccessBoundaryPolicies) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct PrincipalAccessBoundaryPolicies<T>
where
    T: crate::stubs::PrincipalAccessBoundaryPolicies + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::PrincipalAccessBoundaryPolicies for PrincipalAccessBoundaryPolicies<T>
where
    T: crate::stubs::PrincipalAccessBoundaryPolicies + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
