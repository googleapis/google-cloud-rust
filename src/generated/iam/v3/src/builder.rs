...
/// Request and client builders for [AccessPolicies][crate::client::AccessPolicies].
pub mod access_policies {
    use crate::Result;

    /// A builder for [AccessPolicies][crate::client::AccessPolicies].
    ///
    /// ```
    /// # async fn sample() -> google_cloud_gax::client_builder::Result<()> {
    /// # use google_cloud_iam_v3::*;
    /// # use builder::access_policies::ClientBuilder;
    /// # use client::AccessPolicies;
    /// let builder : ClientBuilder = AccessPolicies::builder();
    /// let client = builder
    ...
    pub(crate) mod client {
        use super::super::super::client::AccessPolicies;
        pub struct Factory;
        impl crate::ClientFactory for Factory {
            type Client = AccessPolicies;
    ...
    /// Common implementation for [crate::client::AccessPolicies] request builders.
    #[derive(Clone, Debug)]
    pub(crate) struct RequestBuilder<R: std::default::Default> {
        stub: std::sync::Arc<dyn super::super::stub::dynamic::AccessPolicies>,
        request: R,
    ...
    /// The request builder for [AccessPolicies::create_access_policy][crate::client::AccessPolicies::create_access_policy] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_iam_v3::builder::access_policies::CreateAccessPolicy;
    ...
    /// ```
    #[derive(Clone, Debug)]
    pub struct CreateAccessPolicy(RequestBuilder<crate::model::CreateAccessPolicyRequest>);
    ...
    impl CreateAccessPolicy {
        ...
        pub fn with_request<V: Into<crate::model::CreateAccessPolicyRequest>>(
            mut self,
            v: V,
        ) -> Self {
        ...
        /// on [create_access_policy][crate::client::AccessPolicies::create_access_policy].
        ...
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<crate::model::AccessPolicy, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_iam_v3::client::AccessPolicies::create_access_policy::until_done";
            }
        ...
        ///
        /// This is a **required** field for requests.
        pub fn set_access_policy_id<T: Into<std::string::String>>(mut self, v: T) -> Self {
            self.0.request.access_policy_id = v.into();
            self
        }
        ...
        {
            self.0.request.access_policy = std::option::Option::Some(v.into());
            self
        }
        ...
        where
            T: std::convert::Into<crate::model::AccessPolicy>,
        {
            self.0.request.access_policy = v.map(|x| x.into());
            self
        }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateAccessPolicy {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [AccessPolicies::get_access_policy][crate::client::AccessPolicies::get_access_policy] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_iam_v3::builder::access_policies::GetAccessPolicy;
    /// # async fn sample() -> google_cloud_iam_v3::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetAccessPolicy {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [AccessPolicies::update_access_policy][crate::client::AccessPolicies::update_access_policy] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_iam_v3::builder::access_policies::UpdateAccessPolicy;
    /// # async fn sample() -> google_cloud_iam_v3::Result<()> {
    /// use google_cloud_lro::Poller;
    ///
    /// let builder = prepare_request_builder();
    ...
    impl UpdateAccessPolicy {
        ...
        ///
        /// This starts, but does not poll, a longrunning operation. More information
        /// on [update_access_policy][crate::client::AccessPolicies::update_access_policy].
        pub async fn send(self) -> Result<google_cloud_longrunning::model::Operation> {
            (*self.0.stub)
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::AccessPolicy, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_iam_v3::client::AccessPolicies::update_access_policy::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateAccessPolicy {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [AccessPolicies::delete_access_policy][crate::client::AccessPolicies::delete_access_policy] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_iam_v3::builder::access_policies::DeleteAccessPolicy;
    /// # async fn sample() -> google_cloud_iam_v3::Result<()> {
    /// use google_cloud_lro::Poller;
    ///
    /// let builder = prepare_request_builder();
    ...
    impl DeleteAccessPolicy {
        ...
        ///
        /// This starts, but does not poll, a longrunning operation. More information
        /// on [delete_access_policy][crate::client::AccessPolicies::delete_access_policy].
        pub async fn send(self) -> Result<google_cloud_longrunning::model::Operation> {
            (*self.0.stub)
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name =
                    "google_cloud_iam_v3::client::AccessPolicies::delete_access_policy::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteAccessPolicy {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [AccessPolicies::list_access_policies][crate::client::AccessPolicies::list_access_policies] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_iam_v3::builder::access_policies::ListAccessPolicies;
    /// # async fn sample() -> google_cloud_iam_v3::Result<()> {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListAccessPolicies {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [AccessPolicies::search_access_policy_bindings][crate::client::AccessPolicies::search_access_policy_bindings] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_iam_v3::builder::access_policies::SearchAccessPolicyBindings;
    /// # async fn sample() -> google_cloud_iam_v3::Result<()> {
    /// use google_cloud_gax::paginator::ItemPaginator;
    ///
    /// let builder = prepare_request_builder();
    ...
    /// # Ok(()) }
    ///
    /// fn prepare_request_builder() -> SearchAccessPolicyBindings {
    ///   # panic!();
    ///   // ... details omitted ...
    /// }
    /// ```
    #[derive(Clone, Debug)]
    pub struct SearchAccessPolicyBindings(
        RequestBuilder<crate::model::SearchAccessPolicyBindingsRequest>,
    );

    impl SearchAccessPolicyBindings {
        pub(crate) fn new(
            stub: std::sync::Arc<dyn super::super::stub::dynamic::AccessPolicies>,
        ) -> Self {
            Self(RequestBuilder::new(stub))
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::SearchAccessPolicyBindingsRequest>>(
            mut self,
            v: V,
        ) -> Self {
            self.0.request = v.into();
        ...
        /// Sends the request.
        pub async fn send(self) -> Result<crate::model::SearchAccessPolicyBindingsResponse> {
            (*self.0.stub)
                .search_access_policy_bindings(self.0.request, self.0.options)
                .await
                .map(crate::Response::into_body)
        }
        ...
        pub fn by_page(
            ...
            crate::model::SearchAccessPolicyBindingsResponse,
            crate::Error,
        > {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for SearchAccessPolicyBindings {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [AccessPolicies::get_operation][crate::client::AccessPolicies::get_operation] calls.
    ///
    /// # Example
    /// ```
    /// # use google_cloud_iam_v3::builder::access_policies::GetOperation;
    /// # async fn sample() -> google_cloud_iam_v3::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
...
/// Request and client builders for [PolicyBindings][crate::client::PolicyBindings].
pub mod policy_bindings {
    ...
    impl CreatePolicyBinding {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::PolicyBinding, crate::model::OperationMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_iam_v3::client::PolicyBindings::create_policy_binding::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreatePolicyBinding {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetPolicyBinding {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UpdatePolicyBinding {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::PolicyBinding, crate::model::OperationMetadata>
        {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_iam_v3::client::PolicyBindings::update_policy_binding::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdatePolicyBinding {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeletePolicyBinding {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_iam_v3::client::PolicyBindings::delete_policy_binding::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeletePolicyBinding {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListPolicyBindings {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for SearchTargetPolicyBindings {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
...
/// Request and client builders for [PrincipalAccessBoundaryPolicies][crate::client::PrincipalAccessBoundaryPolicies].
pub mod principal_access_boundary_policies {
    ...
    impl CreatePrincipalAccessBoundaryPolicy {
        ...
        > {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_iam_v3::client::PrincipalAccessBoundaryPolicies::create_principal_access_boundary_policy::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreatePrincipalAccessBoundaryPolicy {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetPrincipalAccessBoundaryPolicy {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl UpdatePrincipalAccessBoundaryPolicy {
        ...
        > {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_iam_v3::client::PrincipalAccessBoundaryPolicies::update_principal_access_boundary_policy::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdatePrincipalAccessBoundaryPolicy {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeletePrincipalAccessBoundaryPolicy {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_iam_v3::client::PrincipalAccessBoundaryPolicies::delete_principal_access_boundary_policy::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeletePrincipalAccessBoundaryPolicy {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListPrincipalAccessBoundaryPolicies {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for SearchPrincipalAccessBoundaryPolicyBindings {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
