    ...
    async fn create_policy_binding(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//iam.googleapis.com/v3/{}/policyBindings", var_parent,);
    ...
    async fn get_policy_binding(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//iam.googleapis.com/v3/{}", var_name,);
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//iam.googleapis.com/v3/{}/principalAccessBoundaryPolicies",
                    var_parent,
                );
