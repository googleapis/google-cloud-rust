    ...
    async fn create_policy_binding(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v3/{parent}/policyBindings";
    ...
    async fn update_policy_binding(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v3/{policy_binding.name}";

                let resource_name = format!("//iam.googleapis.com/{}", var_policy_binding_name,);
    ...
    async fn search_target_policy_bindings(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v3/{parent}/policyBindings:searchTargetPolicyBindings";
    ...
    async fn create_principal_access_boundary_policy(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v3/{parent}/principalAccessBoundaryPolicies";
    ...
    async fn update_principal_access_boundary_policy(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v3/{principal_access_boundary_policy.name}";

                let resource_name = format!(
                    "//iam.googleapis.com/{}",
                    var_principal_access_boundary_policy_name,
                );
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = (|| {
                    let builder = builder.query(&[("validateOnly", &req.validate_only)]);
    ...
    ) -> Result<crate::Response<crate::model::SearchPrincipalAccessBoundaryPolicyBindingsResponse>>
    {
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v3/{name}:searchPolicyBindings";
