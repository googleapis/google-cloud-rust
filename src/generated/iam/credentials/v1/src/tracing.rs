...
/// Implements a [IAMCredentials](super::stubs::IAMCredentials) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct IAMCredentials<T>
where
    T: super::stubs::IAMCredentials + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::IAMCredentials for IAMCredentials<T>
where
    T: super::stubs::IAMCredentials + std::fmt::Debug + Send + Sync,
{
