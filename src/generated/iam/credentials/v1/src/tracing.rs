...
/// Implements a [IAMCredentials](crate::stubs::IAMCredentials) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct IAMCredentials<T>
where
    T: crate::stubs::IAMCredentials + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::IAMCredentials for IAMCredentials<T>
where
    T: crate::stubs::IAMCredentials + std::fmt::Debug + Send + Sync,
{
