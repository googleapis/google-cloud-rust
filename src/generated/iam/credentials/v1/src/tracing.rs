...
/// Implements a [IAMCredentials](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct IAMCredentials<T>
where
    T: crate::traits::IAMCredentials + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::IAMCredentials for IAMCredentials<T>
where
    T: crate::traits::IAMCredentials + std::fmt::Debug + Send + Sync,
{
