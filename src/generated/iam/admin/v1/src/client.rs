...
/// [with_credentials()]: super::builder::iam::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `Iam` in
...
impl Iam {
    ...
    ///    client: &Iam
    /// ) -> Result<()> {
    ///     let mut list = client.list_service_accounts()
    ///         /* set fields */
    ///         .by_item();
    ...
    ///    client: &Iam
    /// ) -> Result<()> {
    ///     let response = client.create_service_account()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &Iam
    /// ) -> Result<()> {
    ///     let response = client.update_service_account()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &Iam
    /// ) -> Result<()> {
    ///     let response = client.patch_service_account()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &Iam
    /// ) -> Result<()> {
    ///     let response = client.undelete_service_account()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &Iam
    /// ) -> Result<()> {
    ///     let response = client.list_service_account_keys()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///         .set_name(format!("projects/{}/serviceAccounts/{}/keys/{}", project_id, service_account_id, key_id))
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    /// }
    ...
    ///    client: &Iam
    /// ) -> Result<()> {
    ///     let response = client.create_service_account_key()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &Iam
    /// ) -> Result<()> {
    ///     let response = client.upload_service_account_key()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &Iam
    /// ) -> Result<()> {
    ///     let mut list = client.query_grantable_roles()
    ///         /* set fields */
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &Iam
    /// ) -> Result<()> {
    ///     let mut list = client.list_roles()
    ///         /* set fields */
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &Iam
    /// ) -> Result<()> {
    ///     let response = client.update_role()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &Iam
    /// ) -> Result<()> {
    ///     let mut list = client.query_testable_permissions()
    ///         /* set fields */
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &Iam
    /// ) -> Result<()> {
    ///     let response = client.query_auditable_services()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &Iam
    /// ) -> Result<()> {
    ///     let response = client.lint_policy()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
