...
impl Iam {
    ...
    async fn build_transport(conf: gax::options::ClientConfig) -> Result<impl super::stub::Iam> {
        super::transport::Iam::new(conf).await
    }

    async fn build_with_tracing(conf: gax::options::ClientConfig) -> Result<impl super::stub::Iam> {
