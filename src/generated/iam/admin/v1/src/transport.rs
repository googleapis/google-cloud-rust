    ...
    async fn list_service_accounts(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//iam.googleapis.com/v1/{}/serviceAccounts", var_name,);
    ...
    async fn get_service_account(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//iam.googleapis.com/v1/{}", var_name,);
    ...
    async fn list_service_account_keys(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//iam.googleapis.com/v1/{}/keys", var_name,);
    ...
    async fn get_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//iam.googleapis.com/v1/{}", var_resource,);
    ...
    async fn list_roles(
        ...
        let (builder, method, resource_name) = None
            ...
            .or_else(|| {
                ...
                let resource_name = format!("//iam.googleapis.com/v1/{}/roles", var_parent,);
