...
pub mod iam {
    ...
    pub struct RequestBuilder<R: std::default::Default> {
        stub: Arc<dyn crate::traits::dyntraits::Iam>,
        request: R,
    ...
    {
        pub(crate) fn new(stub: Arc<dyn crate::traits::dyntraits::Iam>) -> Self {
            Self {
                stub,
                request: R::default(),
    ...
    impl ListServiceAccountKeys {
        ...
        pub fn set_key_types<
            T: Into<std::vec::Vec<crate::model::list_service_account_keys_request::KeyType>>,
        >(
            mut self,
            v: T,
        ) -> Self {
            self.0.request.key_types = v.into();
            self
        }
    }
