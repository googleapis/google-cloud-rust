...
/// Implements a [BigtableInstanceAdmin](crate::stubs::) decorator for logging and tracing.
#[derive(Clone, Debug)]
...
/// Implements a [BigtableTableAdmin](crate::stubs::) decorator for logging and tracing.
#[derive(Clone, Debug)]
