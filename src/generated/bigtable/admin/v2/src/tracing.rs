...
/// Implements a [BigtableInstanceAdmin](crate::stubs::BigtableInstanceAdmin) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct BigtableInstanceAdmin<T>
where
    T: crate::stubs::BigtableInstanceAdmin + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::BigtableInstanceAdmin for BigtableInstanceAdmin<T>
where
    T: crate::stubs::BigtableInstanceAdmin + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [BigtableTableAdmin](crate::stubs::BigtableTableAdmin) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct BigtableTableAdmin<T>
where
    T: crate::stubs::BigtableTableAdmin + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::BigtableTableAdmin for BigtableTableAdmin<T>
where
    T: crate::stubs::BigtableTableAdmin + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
