...
/// Implements a [BigtableInstanceAdmin](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct BigtableInstanceAdmin<T>
where
    T: crate::traits::BigtableInstanceAdmin + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::BigtableInstanceAdmin for BigtableInstanceAdmin<T>
where
    T: crate::traits::BigtableInstanceAdmin + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [BigtableTableAdmin](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct BigtableTableAdmin<T>
where
    T: crate::traits::BigtableTableAdmin + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::BigtableTableAdmin for BigtableTableAdmin<T>
where
    T: crate::traits::BigtableTableAdmin + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
