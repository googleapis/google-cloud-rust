...
/// All implementations of [crate::traits::BigtableInstanceAdmin] also implement [BigtableInstanceAdmin].
#[async_trait::async_trait]
impl<T: crate::traits::BigtableInstanceAdmin> BigtableInstanceAdmin for T {
...
/// All implementations of [crate::traits::BigtableTableAdmin] also implement [BigtableTableAdmin].
#[async_trait::async_trait]
impl<T: crate::traits::BigtableTableAdmin> BigtableTableAdmin for T {
    /// Forwards the call to the implementation provided by `T`.
    async fn create_table(
        &self,
        req: crate::model::CreateTableRequest,
