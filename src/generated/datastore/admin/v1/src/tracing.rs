...
/// Implements a [DatastoreAdmin](crate::stubs::DatastoreAdmin) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct DatastoreAdmin<T>
where
    T: crate::stubs::DatastoreAdmin + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::DatastoreAdmin for DatastoreAdmin<T>
where
    T: crate::stubs::DatastoreAdmin + std::fmt::Debug + Send + Sync,
{
