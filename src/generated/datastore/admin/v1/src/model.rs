...
impl MigrationProgressEvent {
    ...
    /// ```
    /// # use google_cloud_datastore_admin_v1::model::MigrationProgressEvent;
    /// use google_cloud_datastore_admin_v1::model::migration_progress_event;
    /// use google_cloud_datastore_admin_v1::model::migration_progress_event::PrepareStepDetails;
    /// let x = MigrationProgressEvent::new().set_step_details(Some(migration_progress_event::StepDetails::PrepareStepDetails(PrepareStepDetails::default().into())));
    /// ```
