...
/// Request and client builders for [DatastoreAdmin][crate::client::DatastoreAdmin].
pub mod datastore_admin {
    ...
    impl ExportEntities {
        ...
        > {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_datastore_admin_v1::client::DatastoreAdmin::export_entities::until_done";
            }
    ...
    impl ImportEntities {
        ...
        pub fn poller(
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_datastore_admin_v1::client::DatastoreAdmin::import_entities::until_done";
            }
    ...
    impl CreateIndex {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Index, crate::model::IndexOperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_datastore_admin_v1::client::DatastoreAdmin::create_index::until_done";
            }
    ...
    impl DeleteIndex {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Index, crate::model::IndexOperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_datastore_admin_v1::client::DatastoreAdmin::delete_index::until_done";
            }
