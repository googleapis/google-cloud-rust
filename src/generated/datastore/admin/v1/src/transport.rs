    ...
    async fn export_entities(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/projects/{project_id}:export";

                let resource_name =
                    format!("//datastore.googleapis.com/projects/{}", var_project_id,);
    ...
    async fn import_entities(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/projects/{project_id}:import";
    ...
    async fn create_index(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/projects/{project_id}/indexes";
    ...
    async fn delete_index(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/projects/{project_id}/indexes/{index_id}";

                let resource_name = format!(
                    "//datastore.googleapis.com/projects/{}/indexes/{}",
                    var_project_id, var_index_id,
                );
    ...
    async fn list_operations(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//datastore.googleapis.com/{}", var_name,);
                let builder = self.inner.builder(Method::GET, path);
                let builder = builder.query(&[("filter", &req.filter)]);
                let builder = builder.query(&[("pageSize", &req.page_size)]);
                let builder = builder.query(&[("pageToken", &req.page_token)]);
