...
/// Implements a [FirestoreAdmin](super::stubs::FirestoreAdmin) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct FirestoreAdmin<T>
where
    T: super::stubs::FirestoreAdmin + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::FirestoreAdmin for FirestoreAdmin<T>
where
    T: super::stubs::FirestoreAdmin + std::fmt::Debug + Send + Sync,
{
