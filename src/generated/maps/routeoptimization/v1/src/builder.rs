...
/// Request and client builders for [RouteOptimization][crate::client::RouteOptimization].
pub mod route_optimization {
    use crate::Result;

    /// A builder for [RouteOptimization][crate::client::RouteOptimization].
    ///
    /// ```
    /// # async fn sample() -> google_cloud_gax::client_builder::Result<()> {
    /// # use google_maps_routeoptimization_v1::*;
    /// # use builder::route_optimization::ClientBuilder;
    /// # use client::RouteOptimization;
    /// let builder : ClientBuilder = RouteOptimization::builder();
    /// let client = builder
    ///     .with_endpoint("https://routeoptimization.googleapis.com")
    ///     .build().await?;
    /// # Ok(()) }
    /// ```
    ...
    pub(crate) mod client {
        use super::super::super::client::RouteOptimization;
        pub struct Factory;
        impl crate::ClientFactory for Factory {
            type Client = RouteOptimization;
    ...
    /// Common implementation for [crate::client::RouteOptimization] request builders.
    #[derive(Clone, Debug)]
    pub(crate) struct RequestBuilder<R: std::default::Default> {
        stub: std::sync::Arc<dyn super::super::stub::dynamic::RouteOptimization>,
        request: R,
    ...
    /// The request builder for [RouteOptimization::optimize_tours][crate::client::RouteOptimization::optimize_tours] calls.
    ///
    /// # Example
    /// ```
    /// # use google_maps_routeoptimization_v1::builder::route_optimization::OptimizeTours;
    /// # async fn sample() -> google_maps_routeoptimization_v1::Result<()> {
    ///
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for OptimizeTours {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [RouteOptimization::batch_optimize_tours][crate::client::RouteOptimization::batch_optimize_tours] calls.
    ///
    /// # Example
    /// ```
    /// # use google_maps_routeoptimization_v1::builder::route_optimization::BatchOptimizeTours;
    /// # async fn sample() -> google_maps_routeoptimization_v1::Result<()> {
    ...
    impl BatchOptimizeTours {
        ...
        /// on [batch_optimize_tours][crate::client::RouteOptimization::batch_optimize_tours].
        ...
        pub fn poller(
            ...
            crate::model::BatchOptimizeToursMetadata,
        > {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_maps_routeoptimization_v1::client::RouteOptimization::batch_optimize_tours::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for BatchOptimizeTours {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [RouteOptimization::optimize_tours_long_running][crate::client::RouteOptimization::optimize_tours_long_running] calls.
    ///
    /// # Example
    /// ```
    /// # use google_maps_routeoptimization_v1::builder::route_optimization::OptimizeToursLongRunning;
    /// # async fn sample() -> google_maps_routeoptimization_v1::Result<()> {
    /// use google_cloud_lro::Poller;
    ///
    /// let builder = prepare_request_builder();
    ...
    /// ```
    #[derive(Clone, Debug)]
    pub struct OptimizeToursLongRunning(RequestBuilder<crate::model::OptimizeToursRequest>);
    ...
    impl OptimizeToursLongRunning {
        ...
        ///
        /// This starts, but does not poll, a longrunning operation. More information
        /// on [optimize_tours_long_running][crate::client::RouteOptimization::optimize_tours_long_running].
        pub async fn send(self) -> Result<google_cloud_longrunning::model::Operation> {
            (*self.0.stub)
                .optimize_tours_long_running(self.0.request, self.0.options)
                .await
                .map(crate::Response::into_body)
        }

        /// Creates a [Poller][google_cloud_lro::Poller] to work with `optimize_tours_long_running`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<
            crate::model::OptimizeToursResponse,
            crate::model::OptimizeToursLongRunningMetadata,
        > {
            type Operation = google_cloud_lro::internal::Operation<
                crate::model::OptimizeToursResponse,
                crate::model::OptimizeToursLongRunningMetadata,
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_maps_routeoptimization_v1::client::RouteOptimization::optimize_tours_long_running::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for OptimizeToursLongRunning {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [RouteOptimization::optimize_tours_uri][crate::client::RouteOptimization::optimize_tours_uri] calls.
    ///
    /// # Example
    /// ```
    /// # use google_maps_routeoptimization_v1::builder::route_optimization::OptimizeToursUri;
    /// # async fn sample() -> google_maps_routeoptimization_v1::Result<()> {
    /// use google_cloud_lro::Poller;
    ///
    /// let builder = prepare_request_builder();
    ...
    /// # Ok(()) }
    ///
    /// fn prepare_request_builder() -> OptimizeToursUri {
    ///   # panic!();
    ///   // ... details omitted ...
    /// }
    /// ```
    #[derive(Clone, Debug)]
    pub struct OptimizeToursUri(RequestBuilder<crate::model::OptimizeToursUriRequest>);

    impl OptimizeToursUri {
        pub(crate) fn new(
            stub: std::sync::Arc<dyn super::super::stub::dynamic::RouteOptimization>,
        ) -> Self {
            Self(RequestBuilder::new(stub))
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::OptimizeToursUriRequest>>(
            mut self,
            v: V,
        ) -> Self {
            self.0.request = v.into();
        ...
        ///
        /// This starts, but does not poll, a longrunning operation. More information
        /// on [optimize_tours_uri][crate::client::RouteOptimization::optimize_tours_uri].
        pub async fn send(self) -> Result<google_cloud_longrunning::model::Operation> {
            (*self.0.stub)
                .optimize_tours_uri(self.0.request, self.0.options)
                .await
                .map(crate::Response::into_body)
        }

        /// Creates a [Poller][google_cloud_lro::Poller] to work with `optimize_tours_uri`.
        pub fn poller(
            self,
        ) -> impl google_cloud_lro::Poller<
            crate::model::OptimizeToursUriResponse,
            crate::model::OptimizeToursUriMetadata,
        > {
            type Operation = google_cloud_lro::internal::Operation<
                crate::model::OptimizeToursUriResponse,
                crate::model::OptimizeToursUriMetadata,
            ...
            let mut poller_options = self.0.stub.get_poller_options(&self.0.options);
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_maps_routeoptimization_v1::client::RouteOptimization::optimize_tours_uri::until_done";
            }
        ...
        where
            T: std::convert::Into<crate::model::Uri>,
        {
            self.0.request.output = std::option::Option::Some(v.into());
            self
        }
        ...
        where
            T: std::convert::Into<crate::model::Uri>,
        {
            self.0.request.output = v.map(|x| x.into());
            self
        }
    }

    #[doc(hidden)]
    impl crate::RequestBuilder for OptimizeToursUri {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }

    /// The request builder for [RouteOptimization::get_operation][crate::client::RouteOptimization::get_operation] calls.
    ///
    /// # Example
    /// ```
    /// # use google_maps_routeoptimization_v1::builder::route_optimization::GetOperation;
    /// # async fn sample() -> google_maps_routeoptimization_v1::Result<()> {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
