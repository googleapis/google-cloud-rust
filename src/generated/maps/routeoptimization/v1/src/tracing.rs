...
/// Implements a [RouteOptimization](super::stub::RouteOptimization) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct RouteOptimization<T>
where
    T: super::stub::RouteOptimization + std::fmt::Debug + Send + Sync,
{
    inner: T,
    duration: gaxi::observability::DurationMetric,
}

impl<T> RouteOptimization<T>
where
    T: super::stub::RouteOptimization + std::fmt::Debug + Send + Sync,
{
...
impl<T> super::stub::RouteOptimization for RouteOptimization<T>
where
    T: super::stub::RouteOptimization + std::fmt::Debug + Send + Sync,
{
    ...
    async fn optimize_tours(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            ...
            method: "client::RouteOptimization::optimize_tours",
    ...
    async fn batch_optimize_tours(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::RouteOptimization::batch_optimize_tours",
            self.inner.batch_optimize_tours(req, options));
        pending.await
    }

    #[tracing::instrument(level = tracing::Level::DEBUG, ret)]
    async fn optimize_tours_long_running(
        &self,
        req: crate::model::OptimizeToursRequest,
        options: crate::RequestOptions,
    ) -> Result<crate::Response<google_cloud_longrunning::model::Operation>> {
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::RouteOptimization::optimize_tours_long_running",
            self.inner.optimize_tours_long_running(req, options));
        pending.await
    }

    #[tracing::instrument(level = tracing::Level::DEBUG, ret)]
    async fn optimize_tours_uri(
        &self,
        req: crate::model::OptimizeToursUriRequest,
        options: crate::RequestOptions,
    ) -> Result<crate::Response<google_cloud_longrunning::model::Operation>> {
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::RouteOptimization::optimize_tours_uri",
            self.inner.optimize_tours_uri(req, options));
        pending.await
    }
    ...
    async fn get_operation(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            metric: self.duration.clone(),
            info: *info::INSTRUMENTATION_CLIENT_INFO,
            method: "client::RouteOptimization::get_operation",
...
pub(crate) mod info {
    ...
    > = std::sync::LazyLock::new(|| {
        ...
        info.service_name = "routeoptimization";
        info.client_version = VERSION;
        info.client_artifact = NAME;
        info.default_host = "routeoptimization";
        info
    });
}
