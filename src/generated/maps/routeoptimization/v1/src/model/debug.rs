...
impl std::fmt::Debug for super::Uri {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut debug_struct = f.debug_struct("Uri");
...
impl std::fmt::Debug for super::OptimizeToursUriRequest {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut debug_struct = f.debug_struct("OptimizeToursUriRequest");
...
impl std::fmt::Debug for super::OptimizeToursUriResponse {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut debug_struct = f.debug_struct("OptimizeToursUriResponse");
        debug_struct.field("output", &self.output);
        if !self._unknown_fields.is_empty() {
            debug_struct.field("_unknown_fields", &self._unknown_fields);
        }
...
impl std::fmt::Debug for super::OptimizeToursUriMetadata {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut debug_struct = f.debug_struct("OptimizeToursUriMetadata");
        if !self._unknown_fields.is_empty() {
            debug_struct.field("_unknown_fields", &self._unknown_fields);
        }
        debug_struct.finish()
...
impl std::fmt::Debug for super::BatchOptimizeToursMetadata {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut debug_struct = f.debug_struct("BatchOptimizeToursMetadata");
        if !self._unknown_fields.is_empty() {
            debug_struct.field("_unknown_fields", &self._unknown_fields);
        }
        debug_struct.finish()
...
impl std::fmt::Debug for super::OptimizeToursLongRunningMetadata {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut debug_struct = f.debug_struct("OptimizeToursLongRunningMetadata");
        if !self._unknown_fields.is_empty() {
            debug_struct.field("_unknown_fields", &self._unknown_fields);
        }
        debug_struct.finish()
...
impl std::fmt::Debug for super::OptimizeToursResponse {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        debug_struct.field("processed_request", &self.processed_request);
...
impl std::fmt::Debug for super::shipment_model::Objective {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut debug_struct = f.debug_struct("Objective");
...
impl std::fmt::Debug for super::shipment::VisitRequest {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        debug_struct.field("label", &self.label);
        debug_struct.field("avoid_u_turns", &self.avoid_u_turns);
        if !self._unknown_fields.is_empty() {
            debug_struct.field("_unknown_fields", &self._unknown_fields);
        }
        debug_struct.finish()
...
impl std::fmt::Debug for super::vehicle::load_limit::LoadCost {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut debug_struct = f.debug_struct("LoadCost");
        debug_struct.field("load_threshold", &self.load_threshold);
        debug_struct.field(
            "cost_per_unit_below_threshold",
            &self.cost_per_unit_below_threshold,
        );
        debug_struct.field(
            "cost_per_unit_above_threshold",
            &self.cost_per_unit_above_threshold,
        );
        if !self._unknown_fields.is_empty() {
            debug_struct.field("_unknown_fields", &self._unknown_fields);
        }
...
impl std::fmt::Debug for super::ShipmentRoute {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        debug_struct.field("metrics", &self.metrics);
        debug_struct.field("vehicle_fullness", &self.vehicle_fullness);
...
impl std::fmt::Debug for super::shipment_route::Visit {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        debug_struct.field(
            ...
            &self.injected_solution_location_token,
        );
        if !self._unknown_fields.is_empty() {
            debug_struct.field("_unknown_fields", &self._unknown_fields);
        }
...
impl std::fmt::Debug for super::SkippedShipment {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        debug_struct.field(
            ...
            &self.estimated_incompatible_vehicle_ratio,
        );
...
impl std::fmt::Debug for super::skipped_shipment::Reason {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        debug_struct.field("example_vehicle_indices", &self.example_vehicle_indices);
        debug_struct.field(
...
impl std::fmt::Debug for super::AggregatedMetrics {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        debug_struct.field(
            ...
            &self.performed_mandatory_shipment_count,
        );
        debug_struct.field(
            "performed_shipment_penalty_cost_sum",
            &self.performed_shipment_penalty_cost_sum,
        );
        debug_struct.field("travel_duration", &self.travel_duration);
        debug_struct.field("wait_duration", &self.wait_duration);
        debug_struct.field("delay_duration", &self.delay_duration);
...
impl std::fmt::Debug for super::VehicleFullness {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut debug_struct = f.debug_struct("VehicleFullness");
        debug_struct.field("max_fullness", &self.max_fullness);
        debug_struct.field("distance", &self.distance);
        debug_struct.field("travel_duration", &self.travel_duration);
        debug_struct.field("active_duration", &self.active_duration);
        debug_struct.field("max_load", &self.max_load);
        debug_struct.field("active_span", &self.active_span);
        if !self._unknown_fields.is_empty() {
            debug_struct.field("_unknown_fields", &self._unknown_fields);
        }
        debug_struct.finish()
