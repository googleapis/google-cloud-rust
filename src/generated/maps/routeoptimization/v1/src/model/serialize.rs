...
#[doc(hidden)]
impl serde::ser::Serialize for super::Uri {
...
#[doc(hidden)]
impl serde::ser::Serialize for super::OptimizeToursUriRequest {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
#[doc(hidden)]
impl serde::ser::Serialize for super::OptimizeToursUriResponse {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
#[doc(hidden)]
impl serde::ser::Serialize for super::OptimizeToursUriMetadata {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
#[doc(hidden)]
impl serde::ser::Serialize for super::BatchOptimizeToursMetadata {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
#[doc(hidden)]
impl serde::ser::Serialize for super::OptimizeToursLongRunningMetadata {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for super::OptimizeToursResponse {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.processed_request.is_some() {
            state.serialize_entry("processedRequest", &self.processed_request)?;
        }
...
#[doc(hidden)]
impl serde::ser::Serialize for super::shipment_model::Objective {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl serde::ser::Serialize for super::shipment::VisitRequest {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.avoid_u_turns.is_some() {
            state.serialize_entry("avoidUTurns", &self.avoid_u_turns)?;
        }
        if !self._unknown_fields.is_empty() {
            for (key, value) in self._unknown_fields.iter() {
                state.serialize_entry(key, &value)?;
...
impl serde::ser::Serialize for super::vehicle::LoadLimit {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.cost_per_kilometer.is_some() {
            state.serialize_entry("costPerKilometer", &self.cost_per_kilometer)?;
        }
        if self.cost_per_traveled_hour.is_some() {
            state.serialize_entry("costPerTraveledHour", &self.cost_per_traveled_hour)?;
        }
        if !self._unknown_fields.is_empty() {
            for (key, value) in self._unknown_fields.iter() {
                state.serialize_entry(key, &value)?;
...
#[doc(hidden)]
impl serde::ser::Serialize for super::vehicle::load_limit::LoadCost {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        use std::option::Option::Some;
        let mut state = serializer.serialize_map(std::option::Option::None)?;
        if self.load_threshold.is_some() {
            struct __With<'a>(&'a std::option::Option<i64>);
            impl<'a> serde::ser::Serialize for __With<'a> {
                fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
                where
            ...
            state.serialize_entry("loadThreshold", &__With(&self.load_threshold))?;
        }
        if self.cost_per_unit_below_threshold.is_some() {
            struct __With<'a>(&'a std::option::Option<f64>);
            impl<'a> serde::ser::Serialize for __With<'a> {
                fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
                where
            ...
            state.serialize_entry(
                ...
                &__With(&self.cost_per_unit_below_threshold),
            )?;
        }
        if self.cost_per_unit_above_threshold.is_some() {
            struct __With<'a>(&'a std::option::Option<f64>);
            impl<'a> serde::ser::Serialize for __With<'a> {
                fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
                where
            ...
            state.serialize_entry(
                ...
                &__With(&self.cost_per_unit_above_threshold),
            )?;
        }
        if !self._unknown_fields.is_empty() {
            for (key, value) in self._unknown_fields.iter() {
...
impl serde::ser::Serialize for super::ShipmentRoute {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.vehicle_fullness.is_some() {
            state.serialize_entry("vehicleFullness", &self.vehicle_fullness)?;
        }
...
impl serde::ser::Serialize for super::shipment_route::Visit {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.injected_solution_location_token.is_some() {
            struct __With<'a>(&'a std::option::Option<i32>);
            impl<'a> serde::ser::Serialize for __With<'a> {
                fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
                where
            ...
            state.serialize_entry(
                ...
                &__With(&self.injected_solution_location_token),
            )?;
        }
        if !self._unknown_fields.is_empty() {
            for (key, value) in self._unknown_fields.iter() {
...
impl serde::ser::Serialize for super::SkippedShipment {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.estimated_incompatible_vehicle_ratio.is_some() {
            struct __With<'a>(&'a std::option::Option<f64>);
            impl<'a> serde::ser::Serialize for __With<'a> {
                fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
                where
            ...
            state.serialize_entry(
                ...
                &__With(&self.estimated_incompatible_vehicle_ratio),
            )?;
        }
...
impl serde::ser::Serialize for super::skipped_shipment::Reason {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if !self.example_vehicle_indices.is_empty() {
            struct __With<'a>(&'a std::vec::Vec<i32>);
            impl<'a> serde::ser::Serialize for __With<'a> {
                fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
                where
            ...
            state.serialize_entry(
                ...
                &__With(&self.example_vehicle_indices),
            )?;
        }
...
impl serde::ser::Serialize for super::AggregatedMetrics {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if self.performed_mandatory_shipment_count.is_some() {
            struct __With<'a>(&'a std::option::Option<i32>);
            impl<'a> serde::ser::Serialize for __With<'a> {
                fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
                where
            ...
            state.serialize_entry(
                ...
                &__With(&self.performed_mandatory_shipment_count),
            )?;
        }
        if self.performed_shipment_penalty_cost_sum.is_some() {
            struct __With<'a>(&'a std::option::Option<f64>);
            impl<'a> serde::ser::Serialize for __With<'a> {
                fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
                where
            ...
            state.serialize_entry(
                ...
                &__With(&self.performed_shipment_penalty_cost_sum),
            )?;
        }
        if self.travel_duration.is_some() {
            state.serialize_entry("travelDuration", &self.travel_duration)?;
...
#[doc(hidden)]
impl serde::ser::Serialize for super::VehicleFullness {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if self.max_fullness.is_some() {
            ...
            state.serialize_entry("maxFullness", &__With(&self.max_fullness))?;
        }
        ...
        if self.travel_duration.is_some() {
            ...
            state.serialize_entry("travelDuration", &__With(&self.travel_duration))?;
        }
        if self.active_duration.is_some() {
            ...
            state.serialize_entry("activeDuration", &__With(&self.active_duration))?;
        }
        if self.max_load.is_some() {
            struct __With<'a>(&'a std::option::Option<f64>);
            impl<'a> serde::ser::Serialize for __With<'a> {
        ...
        if self.active_span.is_some() {
            ...
            state.serialize_entry("activeSpan", &__With(&self.active_span))?;
        }
        if !self._unknown_fields.is_empty() {
            for (key, value) in self._unknown_fields.iter() {
                state.serialize_entry(key, &value)?;
