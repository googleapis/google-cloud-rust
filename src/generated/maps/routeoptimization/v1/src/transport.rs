...
/// Implements [RouteOptimization](super::stub::RouteOptimization) using a [gaxi::http::ReqwestClient].
#[derive(Clone)]
pub struct RouteOptimization {
    inner: gaxi::http::ReqwestClient,
}

impl std::fmt::Debug for RouteOptimization {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::result::Result<(), std::fmt::Error> {
        f.debug_struct("RouteOptimization")
...
impl super::stub::RouteOptimization for RouteOptimization {
    ...
    async fn optimize_tours_long_running(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.maps.routeoptimization.v1.RouteOptimization/OptimizeToursLongRunning")
                    .set_url_template(_path_template)
            );
        }
        let options = google_cloud_gax::options::internal::set_default_idempotency(
