...
//! Google Cloud Client Libraries for Rust - Navigation Connect API
//!
//! This crate contains traits, types, and functions to interact with Navigation Connect API
...
//! # Available Clients
//!
//! * [NavConnectService](client/struct.NavConnectService.html)
//!
//! # Features
//!
...
const DEFAULT_HOST: &str = "https://navigationconnect.googleapis.com/";
