...
//! Google Cloud Client Libraries for Rust - Aerial View API
//!
//! This crate contains traits, types, and functions to interact with Aerial View API
...
//! # Available Clients
//!
//! * [AerialView](client/struct.AerialView.html)
//!
//! # Features
//!
...
const DEFAULT_HOST: &str = "https://aerialview.googleapis.com/";
