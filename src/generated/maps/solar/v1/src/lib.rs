...
//!
//! This crate contains traits, types, and functions to interact with Solar API
...
//! # Available Clients
//!
//! * [Solar](client/struct.Solar.html)
//!
//! # Features
//!
...
const DEFAULT_HOST: &str = "https://solar.googleapis.com/";
