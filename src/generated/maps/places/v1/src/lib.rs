...
//!
//! This crate contains traits, types, and functions to interact with Places API (New)
...
//! # Available Clients
//!
//! * [Places](client/struct.Places.html)
//!
//! # Features
//!
...
const DEFAULT_HOST: &str = "https://places.googleapis.com/";
