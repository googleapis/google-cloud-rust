...
pub trait Routes: std::fmt::Debug + Send + Sync {
    /// Implements [super::client::Routes::compute_routes].
    fn compute_routes(
        &self,
        _req: crate::model::ComputeRoutesRequest,
        _options: crate::RequestOptions,
    ) -> impl std::future::Future<
        Output = crate::Result<crate::Response<crate::model::ComputeRoutesResponse>>,
    > + Send {
