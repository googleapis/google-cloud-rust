# Google Cloud Client Libraries for Rust - Roads API
...
Fetch Google roads using a viewport, road ID, or latitude/longitude
coordinates.
...
- Read the [crate's documentation](https://docs.rs/google-maps-roads-v1op/1.0.0)
