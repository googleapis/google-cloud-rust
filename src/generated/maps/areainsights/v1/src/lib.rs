...
//! Google Cloud Client Libraries for Rust - Places Aggregate API
//!
//! This crate contains traits, types, and functions to interact with Places Aggregate API
...
//! # Available Clients
//!
//! * [AreaInsights](client/struct.AreaInsights.html)
//!
//! # Features
//!
...
const DEFAULT_HOST: &str = "https://areainsights.googleapis.com/";
