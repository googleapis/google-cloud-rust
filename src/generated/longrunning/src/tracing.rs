...
/// Implements a [Operations](crate::stubs::Operations) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Operations<T>
where
    T: crate::stubs::Operations + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::Operations for Operations<T>
where
    T: crate::stubs::Operations + std::fmt::Debug + Send + Sync,
{
