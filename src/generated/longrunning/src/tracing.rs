...
/// Implements a [Operations](super::stubs::Operations) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Operations<T>
where
    T: super::stubs::Operations + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Operations for Operations<T>
where
    T: super::stubs::Operations + std::fmt::Debug + Send + Sync,
{
