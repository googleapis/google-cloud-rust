...
/// Implements a [ProfilerService](super::stubs::ProfilerService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ProfilerService<T>
where
    T: super::stubs::ProfilerService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ProfilerService for ProfilerService<T>
where
    T: super::stubs::ProfilerService + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [ExportService](super::stubs::ExportService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ExportService<T>
where
    T: super::stubs::ExportService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ExportService for ExportService<T>
where
    T: super::stubs::ExportService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
