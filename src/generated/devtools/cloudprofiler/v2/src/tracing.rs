...
/// Implements a [ProfilerService](crate::stubs::ProfilerService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ProfilerService<T>
where
    T: crate::stubs::ProfilerService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ProfilerService for ProfilerService<T>
where
    T: crate::stubs::ProfilerService + std::fmt::Debug + Send + Sync,
{
...
/// Implements a [ExportService](crate::stubs::ExportService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ExportService<T>
where
    T: crate::stubs::ExportService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ExportService for ExportService<T>
where
    T: crate::stubs::ExportService + std::fmt::Debug + Send + Sync,
{
    #[tracing::instrument(ret)]
