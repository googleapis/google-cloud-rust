    ...
    async fn create_profile(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v2/{}/profiles", var_parent,);

                let _path_template = "/v2/{parent}/profiles";
    ...
    async fn create_offline_profile(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v2/{}/profiles:createOffline", var_parent,);

                let _path_template = "/v2/{parent}/profiles:createOffline";
    ...
    async fn update_profile(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v2/{}", var_profile_name,);

                let _path_template = "/v2/{profile.name}";

                let resource_name = format!("//cloudprofiler.googleapis.com/{}", var_profile_name,);
