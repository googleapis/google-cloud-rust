...
/// Request and client builders for [ProfilerService][crate::client::ProfilerService].
pub mod profiler_service {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateProfile {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateOfflineProfile {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
...
/// Request and client builders for [ExportService][crate::client::ExportService].
pub mod export_service {
    ...
    impl ListProfiles {
        ...
        pub fn by_page(
            self,
        ) -> impl google_cloud_gax::paginator::Paginator<crate::model::ListProfilesResponse, crate::Error>
        {
            use std::clone::Clone;
        ...
        pub fn by_item(
            ...
            crate::model::ListProfilesResponse,
            crate::Error,
        > {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListProfiles {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
