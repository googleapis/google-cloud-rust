...
pub mod span {
    ...
    impl TimeEvent {
        ...
        /// ```
        /// # use google_cloud_trace_v2::model::span::TimeEvent;
        /// use google_cloud_trace_v2::model::span::time_event;
        /// use google_cloud_trace_v2::model::span::time_event::Annotation;
        /// let x = TimeEvent::new().set_value(Some(span::time_event::Value::Annotation(Annotation::default().into())));
        /// ```
        pub fn set_value<
...
impl AttributeValue {
    ...
    /// ```
    /// # use google_cloud_trace_v2::model::AttributeValue;
    /// use google_cloud_trace_v2::model::attribute_value;
    /// let x = AttributeValue::new().set_value(Some(attribute_value::Value::IntValue(42)));
    /// ```
    pub fn set_value<
