...
/// A dyn-compatible, crate-private version of `TraceService`.
...
/// All implementations of [crate::traits::TraceService] also implement [TraceService].
#[async_trait::async_trait]
impl<T: crate::traits::TraceService> TraceService for T {
