...
/// Implements a [TraceService](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct TraceService<T>
where
    T: crate::traits::TraceService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::TraceService for TraceService<T>
where
    T: crate::traits::TraceService + std::fmt::Debug + Send + Sync,
{
