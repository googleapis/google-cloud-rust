...
/// Implements a [TraceService](super::stubs::TraceService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct TraceService<T>
where
    T: super::stubs::TraceService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::TraceService for TraceService<T>
where
    T: super::stubs::TraceService + std::fmt::Debug + Send + Sync,
{
