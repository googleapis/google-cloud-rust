...
/// Implements a [TraceService](crate::stubs::TraceService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct TraceService<T>
where
    T: crate::stubs::TraceService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::TraceService for TraceService<T>
where
    T: crate::stubs::TraceService + std::fmt::Debug + Send + Sync,
{
