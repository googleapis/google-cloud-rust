...
/// Implements a [ContainerAnalysis](crate::stubs::ContainerAnalysis) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ContainerAnalysis<T>
where
    T: crate::stubs::ContainerAnalysis + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ContainerAnalysis for ContainerAnalysis<T>
where
    T: crate::stubs::ContainerAnalysis + std::fmt::Debug + Send + Sync,
{
