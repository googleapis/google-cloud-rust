...
/// Implements a [ContainerAnalysis](super::stubs::ContainerAnalysis) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ContainerAnalysis<T>
where
    T: super::stubs::ContainerAnalysis + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ContainerAnalysis for ContainerAnalysis<T>
where
    T: super::stubs::ContainerAnalysis + std::fmt::Debug + Send + Sync,
{
