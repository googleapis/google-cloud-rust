...
/// Request and client builders for [ContainerAnalysis][crate::client::ContainerAnalysis].
pub mod container_analysis {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetVulnerabilityOccurrencesSummary {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ExportSBOM {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
