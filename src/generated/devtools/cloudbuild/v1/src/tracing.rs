...
/// Implements a [CloudBuild](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudBuild<T>
where
    T: crate::traits::CloudBuild + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::CloudBuild for CloudBuild<T>
where
    T: crate::traits::CloudBuild + std::fmt::Debug + Send + Sync,
{
