...
/// Implements a [CloudBuild](crate::stubs::CloudBuild) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudBuild<T>
where
    T: crate::stubs::CloudBuild + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::CloudBuild for CloudBuild<T>
where
    T: crate::stubs::CloudBuild + std::fmt::Debug + Send + Sync,
{
