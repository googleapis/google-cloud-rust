...
/// Implements a [CloudBuild](super::stubs::CloudBuild) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct CloudBuild<T>
where
    T: super::stubs::CloudBuild + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::CloudBuild for CloudBuild<T>
where
    T: super::stubs::CloudBuild + std::fmt::Debug + Send + Sync,
{
