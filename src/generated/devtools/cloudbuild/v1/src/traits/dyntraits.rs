...
/// A dyn-compatible, crate-private version of `CloudBuild`.
...
/// All implementations of [crate::traits::CloudBuild] also implement [CloudBuild].
#[async_trait::async_trait]
impl<T: crate::traits::CloudBuild> CloudBuild for T {
