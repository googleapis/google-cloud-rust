...
impl RepoSource {
    ...
    /// ```
    /// # use google_cloud_build_v1::model::RepoSource;
    /// use google_cloud_build_v1::model::repo_source;
...
impl Source {
    ...
    /// use google_cloud_build_v1::model::source;
    /// use google_cloud_build_v1::model::StorageSource;
    /// let x = Source::new().set_source(Some(source::Source::StorageSource(StorageSource::default().into())));
    /// ```
...
impl Dependency {
    ...
    /// # use google_cloud_build_v1::model::Dependency;
    /// use google_cloud_build_v1::model::dependency;
    /// let x = Dependency::new().set_dep(Some(dependency::Dep::Empty(true)));
    /// ```
...
pub mod dependency {
    ...
    impl GitSourceRepository {
        ...
        /// ```
        /// # use google_cloud_build_v1::model::dependency::GitSourceRepository;
        /// use google_cloud_build_v1::model::dependency::git_source_repository;
        /// let x = GitSourceRepository::new().set_repotype(Some(dependency::git_source_repository::Repotype::Url("example".to_string())));
        /// ```
        pub fn set_repotype<
            T: std::convert::Into<
                    std::option::Option<crate::model::dependency::git_source_repository::Repotype>,
...
impl GitRepoSource {
    ...
    /// ```
    /// # use google_cloud_build_v1::model::GitRepoSource;
    /// use google_cloud_build_v1::model::git_repo_source;
    /// let x = GitRepoSource::new().set_source(Some(git_repo_source::Source::Repository("example".to_string())));
    /// ```
    pub fn set_source<
    ...
    /// # use google_cloud_build_v1::model::GitRepoSource;
    /// use google_cloud_build_v1::model::git_repo_source;
    /// let x = GitRepoSource::new().set_enterprise_config(Some(git_repo_source::EnterpriseConfig::GithubEnterpriseConfig("example".to_string())));
    /// ```
...
impl GitFileSource {
    ...
    /// ```
    /// # use google_cloud_build_v1::model::GitFileSource;
    /// use google_cloud_build_v1::model::git_file_source;
    /// let x = GitFileSource::new().set_source(Some(git_file_source::Source::Repository("example".to_string())));
    /// ```
    pub fn set_source<
    ...
    /// # use google_cloud_build_v1::model::GitFileSource;
    /// use google_cloud_build_v1::model::git_file_source;
    /// let x = GitFileSource::new().set_enterprise_config(Some(git_file_source::EnterpriseConfig::GithubEnterpriseConfig("example".to_string())));
    /// ```
    pub fn set_enterprise_config<
...
impl BuildTrigger {
    ...
    /// ```
    /// # use google_cloud_build_v1::model::BuildTrigger;
    /// use google_cloud_build_v1::model::build_trigger;
    /// let x = BuildTrigger::new().set_build_template(Some(build_trigger::BuildTemplate::Autodetect(true)));
    /// ```
...
impl RepositoryEventConfig {
    ...
    /// ```
    /// # use google_cloud_build_v1::model::RepositoryEventConfig;
    /// use google_cloud_build_v1::model::repository_event_config;
    /// use google_cloud_build_v1::model::PullRequestFilter;
    /// let x = RepositoryEventConfig::new().set_filter(Some(repository_event_config::Filter::PullRequest(PullRequestFilter::default().into())));
    /// ```
    pub fn set_filter<
...
impl GitHubEventsConfig {
    ...
    /// ```
    /// # use google_cloud_build_v1::model::GitHubEventsConfig;
    /// use google_cloud_build_v1::model::git_hub_events_config;
    /// use google_cloud_build_v1::model::PullRequestFilter;
    /// let x = GitHubEventsConfig::new().set_event(Some(git_hub_events_config::Event::PullRequest(PullRequestFilter::default().into())));
    /// ```
    pub fn set_event<
...
impl WebhookConfig {
    ...
    /// ```
    /// # use google_cloud_build_v1::model::WebhookConfig;
    /// use google_cloud_build_v1::model::webhook_config;
    /// let x = WebhookConfig::new().set_auth_method(Some(webhook_config::AuthMethod::Secret("example".to_string())));
    /// ```
...
impl PullRequestFilter {
    ...
    /// ```
    /// # use google_cloud_build_v1::model::PullRequestFilter;
    /// use google_cloud_build_v1::model::pull_request_filter;
    /// let x = PullRequestFilter::new().set_git_ref(Some(pull_request_filter::GitRef::Branch("example".to_string())));
    /// ```
    pub fn set_git_ref<
...
impl PushFilter {
    ...
    /// ```
    /// # use google_cloud_build_v1::model::PushFilter;
    /// use google_cloud_build_v1::model::push_filter;
    /// let x = PushFilter::new().set_git_ref(Some(push_filter::GitRef::Branch("example".to_string())));
    /// ```
    pub fn set_git_ref<
...
impl WorkerPool {
    ...
    /// ```
    /// # use google_cloud_build_v1::model::WorkerPool;
    /// use google_cloud_build_v1::model::worker_pool;
    /// use google_cloud_build_v1::model::PrivatePoolV1Config;
    /// let x = WorkerPool::new().set_config(Some(worker_pool::Config::PrivatePoolV1Config(PrivatePoolV1Config::default().into())));
    /// ```
    pub fn set_config<
