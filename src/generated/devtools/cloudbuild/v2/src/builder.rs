...
/// Request and client builders for [RepositoryManager][crate::client::RepositoryManager].
pub mod repository_manager {
    ...
    impl CreateConnection {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Connection, crate::model::OperationMetadata>
        {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_build_v2::client::RepositoryManager::create_connection::until_done";
            }
    ...
    impl UpdateConnection {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Connection, crate::model::OperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_build_v2::client::RepositoryManager::update_connection::until_done";
            }
    ...
    impl DeleteConnection {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_build_v2::client::RepositoryManager::delete_connection::until_done";
            }
    ...
    impl CreateRepository {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Repository, crate::model::OperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_build_v2::client::RepositoryManager::create_repository::until_done";
            }
    ...
    impl BatchCreateRepositories {
        ...
        /// Creates a [Poller][google_cloud_lro::Poller] to work with `batch_create_repositories`.
        pub fn poller(
            self,
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_build_v2::client::RepositoryManager::batch_create_repositories::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for BatchCreateRepositories {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl DeleteRepository {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_build_v2::client::RepositoryManager::delete_repository::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for FetchLinkableRepositories {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
