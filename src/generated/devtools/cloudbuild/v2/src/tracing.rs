...
/// Implements a [RepositoryManager](super::stubs::RepositoryManager) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct RepositoryManager<T>
where
    T: super::stubs::RepositoryManager + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::RepositoryManager for RepositoryManager<T>
where
    T: super::stubs::RepositoryManager + std::fmt::Debug + Send + Sync,
{
