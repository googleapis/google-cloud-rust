...
/// Implements a [RepositoryManager](crate::traits::) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct RepositoryManager<T>
where
    T: crate::traits::RepositoryManager + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::traits::RepositoryManager for RepositoryManager<T>
where
    T: crate::traits::RepositoryManager + std::fmt::Debug + Send + Sync,
{
