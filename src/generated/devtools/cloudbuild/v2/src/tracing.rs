...
/// Implements a [RepositoryManager](crate::stubs::RepositoryManager) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct RepositoryManager<T>
where
    T: crate::stubs::RepositoryManager + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::RepositoryManager for RepositoryManager<T>
where
    T: crate::stubs::RepositoryManager + std::fmt::Debug + Send + Sync,
{
