    ...
    async fn create_connection(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//cloudbuild.googleapis.com/v2/{}/connections", var_parent,);
    ...
    async fn get_connection(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//cloudbuild.googleapis.com/v2/{}", var_name,);
    ...
    async fn create_repository(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//cloudbuild.googleapis.com/v2/{}/repositories", var_parent,);
    ...
    async fn fetch_read_write_token(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//cloudbuild.googleapis.com/v2/{}", var_repository,);
    ...
    async fn fetch_linkable_repositories(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//cloudbuild.googleapis.com/v2/{}", var_connection,);
    ...
    async fn set_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//cloudbuild.googleapis.com/v2/{}", var_resource,);
