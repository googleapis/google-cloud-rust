...
impl super::stub::RepositoryManager for RepositoryManager {
    ...
    async fn get_connection(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.devtools.cloudbuild.v2.RepositoryManager/GetConnection")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn get_repository(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.devtools.cloudbuild.v2.RepositoryManager/GetRepository")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn fetch_git_refs(
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.devtools.cloudbuild.v2.RepositoryManager/FetchGitRefs")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
