    ...
    async fn create_connection(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v2/{parent}/connections";
    ...
    async fn update_connection(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v2/{}", var_connection_name,);

                let _path_template = "/v2/{connection.name}";

                let resource_name = format!("//cloudbuild.googleapis.com/{}", var_connection_name,);
    ...
    async fn create_repository(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v2/{}/repositories", var_parent,);

                let _path_template = "/v2/{parent}/repositories";
    ...
    async fn batch_create_repositories(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v2/{}/repositories:batchCreate", var_parent,);

                let _path_template = "/v2/{parent}/repositories:batchCreate";
    ...
    async fn fetch_read_write_token(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v2/{}:accessReadWriteToken", var_repository,);

                let _path_template = "/v2/{repository}:accessReadWriteToken";
    ...
    async fn fetch_read_token(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v2/{}:accessReadToken", var_repository,);

                let _path_template = "/v2/{repository}:accessReadToken";
    ...
    async fn fetch_linkable_repositories(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v2/{}:fetchLinkableRepositories", var_connection,);

                let _path_template = "/v2/{connection}:fetchLinkableRepositories";

                let resource_name = format!("//cloudbuild.googleapis.com/{}", var_connection,);
                let builder = self.inner.builder(Method::GET, path);
                let builder = builder.query(&[("pageSize", &req.page_size)]);
                let builder = builder.query(&[("pageToken", &req.page_token)]);
                let builder = Ok(builder);
    ...
    async fn fetch_git_refs(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v2/{}:fetchGitRefs", var_repository,);

                let _path_template = "/v2/{repository}:fetchGitRefs";
