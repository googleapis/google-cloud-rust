    ...
    async fn get_docker_image(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//artifactregistry.googleapis.com/v1/{}", var_name,);
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//artifactregistry.googleapis.com/v1/{}/mavenArtifacts",
                    var_parent,
                );
    ...
    async fn list_npm_packages(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//artifactregistry.googleapis.com/v1/{}/npmPackages",
                    var_parent,
                );
    ...
    async fn list_python_packages(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//artifactregistry.googleapis.com/v1/{}/pythonPackages",
                    var_parent,
                );
    ...
    async fn list_repositories(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//artifactregistry.googleapis.com/v1/{}/repositories",
                    var_parent,
                );
    ...
    async fn list_packages(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//artifactregistry.googleapis.com/v1/{}/packages",
                    var_parent,
                );
    ...
    async fn batch_delete_versions(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//artifactregistry.googleapis.com/v1/{}/versions",
                    var_parent,
                );
    ...
    async fn list_files(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//artifactregistry.googleapis.com/v1/{}/files", var_parent,);
    ...
    async fn create_rule(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//artifactregistry.googleapis.com/v1/{}/rules", var_parent,);
    ...
    async fn set_iam_policy(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//artifactregistry.googleapis.com/v1/{}", var_resource,);
    ...
    async fn list_attachments(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!(
                    "//artifactregistry.googleapis.com/v1/{}/attachments",
                    var_parent,
                );
    ...
    async fn export_artifact(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//artifactregistry.googleapis.com/v1/{}", var_repository,);
