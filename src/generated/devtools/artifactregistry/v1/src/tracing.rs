...
/// Implements a [ArtifactRegistry](super::stubs::ArtifactRegistry) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ArtifactRegistry<T>
where
    T: super::stubs::ArtifactRegistry + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::ArtifactRegistry for ArtifactRegistry<T>
where
    T: super::stubs::ArtifactRegistry + std::fmt::Debug + Send + Sync,
{
