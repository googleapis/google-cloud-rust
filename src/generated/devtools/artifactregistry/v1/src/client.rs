...
/// [with_credentials()]: super::builder::artifact_registry::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `ArtifactRegistry` in
...
impl ArtifactRegistry {
    ...
    /// ) -> Result<()> {
    ///     let response = client.import_apt_artifacts()
    ///         /* set fields */
    ...
    ///    client: &ArtifactRegistry
    /// ) -> Result<()> {
    ///     let response = client.import_yum_artifacts()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ArtifactRegistry
    /// ) -> Result<()> {
    ///     let response = client.export_artifact()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
