    ...
    async fn get_google_service_account(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                Some("google.storagetransfer.v1.StorageTransferService/GetGoogleServiceAccount")
            );
            self.inner
    ...
    async fn create_transfer_job(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::StorageTransferService",
                "create_transfer_job",
                Some("google.storagetransfer.v1.StorageTransferService/CreateTransferJob")
            );
            self.inner
    ...
    async fn update_transfer_job(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::StorageTransferService",
                "update_transfer_job",
                Some("google.storagetransfer.v1.StorageTransferService/UpdateTransferJob")
            );
            self.inner
    ...
    async fn get_transfer_job(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::StorageTransferService",
                "get_transfer_job",
                Some("google.storagetransfer.v1.StorageTransferService/GetTransferJob")
            );
            self.inner
    ...
    async fn list_transfer_jobs(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::StorageTransferService",
                "list_transfer_jobs",
                Some("google.storagetransfer.v1.StorageTransferService/ListTransferJobs")
            );
            self.inner
    ...
    async fn pause_transfer_operation(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                Some("google.storagetransfer.v1.StorageTransferService/PauseTransferOperation")
            );
            self.inner
    ...
    async fn resume_transfer_operation(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                Some("google.storagetransfer.v1.StorageTransferService/ResumeTransferOperation")
            );
            self.inner
    ...
    async fn run_transfer_job(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::StorageTransferService",
                "run_transfer_job",
                Some("google.storagetransfer.v1.StorageTransferService/RunTransferJob")
            );
            self.inner
    ...
    async fn delete_transfer_job(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::StorageTransferService",
                "delete_transfer_job",
                Some("google.storagetransfer.v1.StorageTransferService/DeleteTransferJob")
            );
            self.inner
    ...
    async fn create_agent_pool(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::StorageTransferService",
                "create_agent_pool",
                Some("google.storagetransfer.v1.StorageTransferService/CreateAgentPool")
            );
            self.inner
    ...
    async fn update_agent_pool(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::StorageTransferService",
                "update_agent_pool",
                Some("google.storagetransfer.v1.StorageTransferService/UpdateAgentPool")
            );
            self.inner
    ...
    async fn get_agent_pool(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::StorageTransferService",
                "get_agent_pool",
                Some("google.storagetransfer.v1.StorageTransferService/GetAgentPool")
            );
            self.inner
    ...
    async fn list_agent_pools(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::StorageTransferService",
                "list_agent_pools",
                Some("google.storagetransfer.v1.StorageTransferService/ListAgentPools")
            );
            self.inner
    ...
    async fn delete_agent_pool(
        ...
        #[cfg(google_cloud_unstable_tracing)]
        {
            ...
            let (start, span) = gaxi::client_request_signals!(
                ...
                "client::StorageTransferService",
                "delete_agent_pool",
                Some("google.storagetransfer.v1.StorageTransferService/DeleteAgentPool")
            );
            self.inner
