...
/// Implements a [StorageTransferService](crate::stubs::StorageTransferService) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct StorageTransferService<T>
where
    T: crate::stubs::StorageTransferService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::StorageTransferService for StorageTransferService<T>
where
    T: crate::stubs::StorageTransferService + std::fmt::Debug + Send + Sync,
{
