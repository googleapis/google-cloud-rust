...
/// Request and client builders for [StorageTransferService][crate::client::StorageTransferService].
pub mod storage_transfer_service {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetGoogleServiceAccount {
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateTransferJob {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateTransferJob {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetTransferJob {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ListTransferJobs {
        ...
        pub fn by_page(
            ...
            crate::model::ListTransferJobsResponse,
            crate::Error,
        > {
            use std::clone::Clone;
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListTransferJobs {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for PauseTransferOperation {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ResumeTransferOperation {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl RunTransferJob {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::TransferOperation> {
            ...
            if let Some(ref mut details) = poller_options.tracing {
                details.method_name = "google_cloud_storagetransfer_v1::client::StorageTransferService::run_transfer_job::until_done";
            }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for RunTransferJob {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteTransferJob {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for CreateAgentPool {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for UpdateAgentPool {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for GetAgentPool {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    impl ListAgentPools {
        ...
        pub fn by_page(
            ...
            crate::model::ListAgentPoolsResponse,
            crate::Error,
        > {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for ListAgentPools {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    #[doc(hidden)]
    impl crate::RequestBuilder for DeleteAgentPool {
        fn request_options(&mut self) -> &mut crate::RequestOptions {
            &mut self.0.options
        }
    }
