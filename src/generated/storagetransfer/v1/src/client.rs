...
impl StorageTransferService {
    ...
    /// operation may also include a [crate::model::TransferOperation] value in the `metadata`
    ...
    ///
    /// [send()]: crate::builders::storage_transfer_service::RunTransferJob::send
    /// [poller()]: crate::builders::storage_transfer_service::RunTransferJob::poller
