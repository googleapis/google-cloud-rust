...
/// Implements a [Grafeas](crate::stubs::Grafeas) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Grafeas<T>
where
    T: crate::stubs::Grafeas + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::Grafeas for Grafeas<T>
where
    T: crate::stubs::Grafeas + std::fmt::Debug + Send + Sync,
{
