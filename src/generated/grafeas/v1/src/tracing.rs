...
/// Implements a [Grafeas](super::stubs::Grafeas) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Grafeas<T>
where
    T: super::stubs::Grafeas + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> super::stubs::Grafeas for Grafeas<T>
where
    T: super::stubs::Grafeas + std::fmt::Debug + Send + Sync,
{
