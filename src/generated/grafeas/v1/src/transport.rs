    ...
    async fn get_occurrence(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//containeranalysis.googleapis.com/v1/{}", var_name,);
    ...
    async fn get_occurrence_note(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//containeranalysis.googleapis.com/v1/{}/notes", var_name,);
    ...
    async fn list_notes(
        ...
        let (builder, method, resource_name) = None
            .or_else(|| {
                ...
                let resource_name =
                    format!("//containeranalysis.googleapis.com/v1/{}/notes", var_parent,);
