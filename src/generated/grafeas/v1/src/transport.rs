...
impl super::stub::Grafeas for Grafeas {
    async fn get_occurrence(
        ...
        let response: crate::model::Occurrence = self
            .inner
    ...
    async fn list_occurrences(
        ...
        let response: crate::model::ListOccurrencesResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn batch_create_occurrences(
        ...
        let response: crate::model::BatchCreateOccurrencesResponse =
    ...
    async fn get_occurrence_note(
        ...
        let response: crate::model::Note = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn list_notes(
        ...
        let builder = builder.query(&[("pageSize", &req.page_size)]);
        let builder = builder.query(&[("pageToken", &req.page_token)]);
        let response: crate::model::ListNotesResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
    ...
    async fn batch_create_notes(
        ...
        let response: crate::model::BatchCreateNotesResponse =
            self.inner.execute(builder, Some(req), options).await?;
        Ok(gax::response::Response::from(response))
    }
    ...
    async fn list_note_occurrences(
        ...
        let builder = builder.query(&[("pageSize", &req.page_size)]);
        let builder = builder.query(&[("pageToken", &req.page_token)]);
        let response: crate::model::ListNoteOccurrencesResponse = self
            .inner
            .execute(builder, None::<gaxi::http::NoBody>, options)
            .await?;
        Ok(gax::response::Response::from(response))
