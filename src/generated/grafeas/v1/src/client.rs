...
/// [with_credentials()]: super::builder::grafeas::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `Grafeas` in
...
impl Grafeas {
    ...
    ///    client: &Grafeas, parent: &str
    /// ) -> Result<()> {
    ///     let response = client.create_occurrence()
    ///         .set_parent(parent)
    ///         .set_occurrence(
    ///             Occurrence::new()/* set fields */
    ///         )
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &Grafeas
    /// ) -> Result<()> {
    ///     let response = client.batch_create_occurrences()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &Grafeas
    /// ) -> Result<()> {
    ///     let response = client.get_occurrence_note()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &Grafeas, parent: &str
    /// ) -> Result<()> {
    ///     let mut list = client.list_notes()
    ///         .set_parent(parent)
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &Grafeas
    /// ) -> Result<()> {
    ///     let response = client.batch_create_notes()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &Grafeas
    /// ) -> Result<()> {
    ///     let mut list = client.list_note_occurrences()
    ///         /* set fields */
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
