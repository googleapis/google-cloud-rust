...
impl ComplianceNote {
    ...
    /// ```
    /// # use google_cloud_grafeas_v1::model::ComplianceNote;
    /// use google_cloud_grafeas_v1::model::compliance_note;
    /// use google_cloud_grafeas_v1::model::compliance_note::CisBenchmark;
    /// let x = ComplianceNote::new().set_compliance_type(Some(compliance_note::ComplianceType::CisBenchmark(CisBenchmark::default().into())));
    /// ```
    ...
    /// # use google_cloud_grafeas_v1::model::ComplianceNote;
    /// use google_cloud_grafeas_v1::model::compliance_note;
    /// let x = ComplianceNote::new().set_potential_impact(Some(compliance_note::PotentialImpact::Impact("example".to_string())));
    /// ```
...
impl DSSEAttestationOccurrence {
    ...
    /// ```
    /// # use google_cloud_grafeas_v1::model::DSSEAttestationOccurrence;
    /// use google_cloud_grafeas_v1::model::dsse_attestation_occurrence;
    /// use google_cloud_grafeas_v1::model::InTotoStatement;
    /// let x = DSSEAttestationOccurrence::new().set_decoded_payload(Some(dsse_attestation_occurrence::DecodedPayload::Statement(InTotoStatement::default().into())));
    /// ```
...
impl Occurrence {
    ...
    /// let x = Occurrence::new().set_details(Some(occurrence::Details::Vulnerability(VulnerabilityOccurrence::default().into())));
    /// ```
    pub fn set_details<
...
impl Note {
    ...
    /// let x = Note::new().set_type(Some(note::Type::Vulnerability(VulnerabilityNote::default().into())));
    /// ```
...
impl InTotoStatement {
    ...
    /// ```
    /// # use google_cloud_grafeas_v1::model::InTotoStatement;
    /// use google_cloud_grafeas_v1::model::in_toto_statement;
    /// use google_cloud_grafeas_v1::model::InTotoProvenance;
    /// let x = InTotoStatement::new().set_predicate(Some(in_toto_statement::Predicate::Provenance(InTotoProvenance::default().into())));
    /// ```
...
impl SourceContext {
    ...
    /// ```
    /// # use google_cloud_grafeas_v1::model::SourceContext;
    /// use google_cloud_grafeas_v1::model::source_context;
    /// use google_cloud_grafeas_v1::model::CloudRepoSourceContext;
    /// let x = SourceContext::new().set_context(Some(source_context::Context::CloudRepo(CloudRepoSourceContext::default().into())));
    /// ```
    pub fn set_context<
...
impl CloudRepoSourceContext {
    ...
    /// ```
    /// # use google_cloud_grafeas_v1::model::CloudRepoSourceContext;
    /// use google_cloud_grafeas_v1::model::cloud_repo_source_context;
    /// let x = CloudRepoSourceContext::new().set_revision(Some(cloud_repo_source_context::Revision::RevisionId("example".to_string())));
    /// ```
    pub fn set_revision<
...
impl GerritSourceContext {
    ...
    /// ```
    /// # use google_cloud_grafeas_v1::model::GerritSourceContext;
    /// use google_cloud_grafeas_v1::model::gerrit_source_context;
    /// let x = GerritSourceContext::new().set_revision(Some(gerrit_source_context::Revision::RevisionId("example".to_string())));
    /// ```
    pub fn set_revision<
...
impl RepoId {
    ...
    /// ```
    /// # use google_cloud_grafeas_v1::model::RepoId;
    /// use google_cloud_grafeas_v1::model::repo_id;
    /// let x = RepoId::new().set_id(Some(repo_id::Id::Uid("example".to_string())));
    /// ```
...
impl SecretLocation {
    ...
    /// ```
    /// # use google_cloud_grafeas_v1::model::SecretLocation;
    /// use google_cloud_grafeas_v1::model::secret_location;
    /// use google_cloud_grafeas_v1::model::FileLocation;
    /// let x = SecretLocation::new().set_location(Some(secret_location::Location::FileLocation(FileLocation::default().into())));
    /// ```
    pub fn set_location<
...
pub mod vulnerability_assessment_note {
    ...
    impl Product {
        ...
        /// # use google_cloud_grafeas_v1::model::vulnerability_assessment_note::Product;
        /// use google_cloud_grafeas_v1::model::vulnerability_assessment_note::product;
        /// let x = Product::new().set_identifier(Some(vulnerability_assessment_note::product::Identifier::GenericUri("example".to_string())));
        /// ```
