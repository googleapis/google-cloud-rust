...
impl UniversalActionExtensionPoint {
    ...
    /// ```
    /// # use google_cloud_apps_script_type::model::UniversalActionExtensionPoint;
    /// use google_cloud_apps_script_type::model::universal_action_extension_point;
    /// let x = UniversalActionExtensionPoint::new().set_action_type(Some(universal_action_extension_point::ActionType::OpenLink("example".to_string())));
    /// ```
