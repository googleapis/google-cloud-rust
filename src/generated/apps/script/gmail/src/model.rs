...
impl UniversalAction {
    ...
    /// ```
    /// # use google_cloud_apps_script_type_gmail::model::UniversalAction;
    /// use google_cloud_apps_script_type_gmail::model::universal_action;
    /// let x = UniversalAction::new().set_action_type(Some(universal_action::ActionType::OpenLink("example".to_string())));
    /// ```
...
impl ContextualTrigger {
    ...
    /// ```
    /// # use google_cloud_apps_script_type_gmail::model::ContextualTrigger;
    /// use google_cloud_apps_script_type_gmail::model::contextual_trigger;
    /// use google_cloud_apps_script_type_gmail::model::UnconditionalTrigger;
    /// let x = ContextualTrigger::new().set_trigger(Some(contextual_trigger::Trigger::Unconditional(UnconditionalTrigger::default().into())));
    /// ```
    pub fn set_trigger<
