...
//!
//! This crate contains traits, types, and functions to interact with Google Workspace Events API
...
//! # Available Clients
//!
//! * [SubscriptionsService](client/struct.SubscriptionsService.html)
//!
//! # Features
//!
...
const DEFAULT_HOST: &str = "https://workspaceevents.googleapis.com/";
