...
/// Implements a [ClusterManager](crate::stubs::ClusterManager) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct ClusterManager<T>
where
    T: crate::stubs::ClusterManager + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::stubs::ClusterManager for ClusterManager<T>
where
    T: crate::stubs::ClusterManager + std::fmt::Debug + Send + Sync,
{
