...
/// [with_credentials()]: super::builder::cluster_manager::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `ClusterManager` in
...
impl ClusterManager {
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let response = client.set_node_pool_autoscaling()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let response = client.set_logging_service()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let response = client.set_monitoring_service()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let response = client.set_addons_config()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let response = client.set_locations()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let response = client.update_master()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let response = client.set_master_auth()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let response = client.delete_cluster()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let response = client.get_json_web_keys()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let response = client.list_node_pools()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let response = client.delete_node_pool()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let response = client.rollback_node_pool_upgrade()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let response = client.set_node_pool_management()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let response = client.set_legacy_abac()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let response = client.start_ip_rotation()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let response = client.complete_ip_rotation()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let response = client.set_node_pool_size()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let response = client.set_network_policy()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let response = client.set_maintenance_policy()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let mut list = client.list_usable_subnetworks()
    ///         /* set fields */
    ///         .by_item();
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let response = client.check_autopilot_compatibility()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let response = client.fetch_cluster_upgrade_info()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &ClusterManager
    /// ) -> Result<()> {
    ///     let response = client.fetch_node_pool_upgrade_info()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
