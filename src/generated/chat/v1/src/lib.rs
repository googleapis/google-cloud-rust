...
//!
//! This crate contains traits, types, and functions to interact with Google Chat API
...
//! # Available Clients
//!
//! * [ChatService](client/struct.ChatService.html)
//!
//! # Features
//!
...
const DEFAULT_HOST: &str = "https://chat.googleapis.com/";
