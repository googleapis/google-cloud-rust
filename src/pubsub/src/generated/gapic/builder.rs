...
pub mod publisher {
    ...
    /// The request builder for [Publisher::set_iam_policy][crate::client::Publisher::set_iam_policy] calls.
    ///
    /// # Example
    /// ```no_run
    /// # use google_cloud_pubsub_v1::builder;
    /// use builder::publisher::SetIamPolicy;
    /// # tokio_test::block_on(async {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    ...
    /// The request builder for [Publisher::get_iam_policy][crate::client::Publisher::get_iam_policy] calls.
    ///
    /// # Example
    /// ```no_run
    /// # use google_cloud_pubsub_v1::builder;
    /// use builder::publisher::GetIamPolicy;
    /// # tokio_test::block_on(async {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    ...
    /// The request builder for [Publisher::test_iam_permissions][crate::client::Publisher::test_iam_permissions] calls.
    ///
    /// # Example
    /// ```no_run
    /// # use google_cloud_pubsub_v1::builder;
    /// use builder::publisher::TestIamPermissions;
    /// # tokio_test::block_on(async {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
...
pub mod subscriber {
    ...
    /// The request builder for [Subscriber::pull][crate::client::Subscriber::pull] calls.
    ///
    /// # Example
    /// ```no_run
    /// # use google_cloud_pubsub_v1::builder;
    /// use builder::subscriber::Pull;
    /// # tokio_test::block_on(async {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    /// # gax::Result::<()>::Ok(()) });
    ///
    /// fn prepare_request_builder() -> Pull {
    ///   # panic!();
    ///   // ... details omitted ...
    /// }
    /// ```
    #[derive(Clone, Debug)]
    pub struct Pull(RequestBuilder<crate::model::PullRequest>);
    ...
    impl Pull {
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::PullRequest>>(mut self, v: V) -> Self {
            self.0.request = v.into();
            self
        }
        ...
        /// Sends the request.
        pub async fn send(self) -> Result<crate::model::PullResponse> {
            (*self.0.stub).pull(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }
        ...
        #[deprecated]
        pub fn set_return_immediately<T: Into<bool>>(mut self, v: T) -> Self {
            self.0.request.return_immediately = v.into();
            self
        }
        ...
        ///
        /// This is a **required** field for requests.
        pub fn set_max_messages<T: Into<i32>>(mut self, v: T) -> Self {
            self.0.request.max_messages = v.into();
            self
        }
    }

    #[doc(hidden)]
    impl gax::options::internal::RequestBuilder for Pull {
        fn request_options(&mut self) -> &mut gax::options::RequestOptions {
            &mut self.0.options
        }
    }
    ...
    /// The request builder for [Subscriber::set_iam_policy][crate::client::Subscriber::set_iam_policy] calls.
    ///
    /// # Example
    /// ```no_run
    /// # use google_cloud_pubsub_v1::builder;
    /// use builder::subscriber::SetIamPolicy;
    /// # tokio_test::block_on(async {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    ...
    /// The request builder for [Subscriber::get_iam_policy][crate::client::Subscriber::get_iam_policy] calls.
    ///
    /// # Example
    /// ```no_run
    /// # use google_cloud_pubsub_v1::builder;
    /// use builder::subscriber::GetIamPolicy;
    /// # tokio_test::block_on(async {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
    ...
    /// The request builder for [Subscriber::test_iam_permissions][crate::client::Subscriber::test_iam_permissions] calls.
    ///
    /// # Example
    /// ```no_run
    /// # use google_cloud_pubsub_v1::builder;
    /// use builder::subscriber::TestIamPermissions;
    /// # tokio_test::block_on(async {
    ///
    /// let builder = prepare_request_builder();
    /// let response = builder.send().await?;
