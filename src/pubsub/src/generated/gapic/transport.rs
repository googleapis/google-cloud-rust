    ...
    async fn update_topic(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{topic.name}";

                let resource_name = format!("//pubsub.googleapis.com/{}", var_topic_name,);
    ...
    async fn list_topics(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{project}/topics";
    ...
    async fn list_topic_subscriptions(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{topic}/subscriptions";
    ...
    async fn list_topic_snapshots(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{topic}/snapshots";
    ...
    async fn detach_subscription(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{subscription}:detach";
    ...
    async fn get_subscription(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{subscription}";
    ...
    async fn update_subscription(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{subscription.name}";

                let resource_name = format!("//pubsub.googleapis.com/{}", var_subscription_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = Ok(builder);
                Some(builder.map(|b| (b, Method::PATCH, _path_template, resource_name)))
            })
    ...
    async fn list_subscriptions(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{project}/subscriptions";
    ...
    async fn modify_push_config(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{subscription}:modifyPushConfig";
    ...
    async fn get_snapshot(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{snapshot}";
    ...
    async fn list_snapshots(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{project}/snapshots";
    ...
    async fn update_snapshot(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let resource_name = format!("//pubsub.googleapis.com/{}", var_snapshot_name,);
                let builder = self.inner.builder(Method::PATCH, path);
                let builder = Ok(builder);
                Some(builder.map(|b| (b, Method::PATCH, _path_template, resource_name)))
            })
    ...
    async fn seek(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{subscription}:seek";
    ...
    async fn create_schema(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/schemas";
    ...
    async fn delete_schema_revision(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{name}:deleteRevision";
    ...
    async fn validate_schema(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/schemas:validate";
    ...
    async fn validate_message(
        ...
        let (builder, method, _path_template, resource_name) = None
            .or_else(|| {
                ...
                let _path_template = "/v1/{parent}/schemas:validateMessage";
