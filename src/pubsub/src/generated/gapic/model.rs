...
pub struct IngestionFailureEvent {
    ...
    pub failure: std::option::Option<crate::model::ingestion_failure_event::Failure>,
...
impl IngestionFailureEvent {
    ...
    /// Sets the value of [topic][crate::model::IngestionFailureEvent::topic].
    pub fn set_topic<T: std::convert::Into<std::string::String>>(mut self, v: T) -> Self {
        self.topic = v.into();
        self
    }

    /// Sets the value of [error_message][crate::model::IngestionFailureEvent::error_message].
    pub fn set_error_message<T: std::convert::Into<std::string::String>>(mut self, v: T) -> Self {
        self.error_message = v.into();
        self
    }

    /// Sets the value of [failure][crate::model::IngestionFailureEvent::failure].
    ///
    /// Note that all the setters affecting `failure` are mutually
    /// exclusive.
    pub fn set_failure<T: std::convert::Into<std::option::Option<crate::model::ingestion_failure_event::Failure>>>(mut self, v: T) -> Self
    {
        self.failure = v.into();
        self
    }

    /// The value of [failure][crate::model::IngestionFailureEvent::failure]
    /// if it holds a `CloudStorageFailure`, `None` if the field is not set or
    /// holds a different branch.
    pub fn cloud_storage_failure(&self) -> std::option::Option<&std::boxed::Box<crate::model::ingestion_failure_event::CloudStorageFailure>> {
        #[allow(unreachable_patterns)]
        self.failure.as_ref().and_then(|v| match v {
            crate::model::ingestion_failure_event::Failure::CloudStorageFailure(v) => std::option::Option::Some(v),
            _ => std::option::Option::None,
        })
    }

    /// Sets the value of [failure][crate::model::IngestionFailureEvent::failure]
    /// to hold a `CloudStorageFailure`.
    ///
    /// Note that all the setters affecting `failure` are
    /// mutually exclusive.
    pub fn set_cloud_storage_failure<T: std::convert::Into<std::boxed::Box<crate::model::ingestion_failure_event::CloudStorageFailure>>>(mut self, v: T) -> Self {
        self.failure = std::option::Option::Some(
            crate::model::ingestion_failure_event::Failure::CloudStorageFailure(
                v.into()
            )
        );
        self
    ...
    /// The value of [failure][crate::model::IngestionFailureEvent::failure]
    /// if it holds a `AwsMskFailure`, `None` if the field is not set or
    /// holds a different branch.
    pub fn aws_msk_failure(&self) -> std::option::Option<&std::boxed::Box<crate::model::ingestion_failure_event::AwsMskFailureReason>> {
        #[allow(unreachable_patterns)]
        self.failure.as_ref().and_then(|v| match v {
            crate::model::ingestion_failure_event::Failure::AwsMskFailure(v) => std::option::Option::Some(v),
            _ => std::option::Option::None,
        })
    }

    /// Sets the value of [failure][crate::model::IngestionFailureEvent::failure]
    /// to hold a `AwsMskFailure`.
    ///
    /// Note that all the setters affecting `failure` are
    /// mutually exclusive.
    pub fn set_aws_msk_failure<T: std::convert::Into<std::boxed::Box<crate::model::ingestion_failure_event::AwsMskFailureReason>>>(mut self, v: T) -> Self {
        self.failure = std::option::Option::Some(
            crate::model::ingestion_failure_event::Failure::AwsMskFailure(
                v.into()
            )
        );
        self
    ...
    /// The value of [failure][crate::model::IngestionFailureEvent::failure]
    /// if it holds a `AzureEventHubsFailure`, `None` if the field is not set or
    /// holds a different branch.
    pub fn azure_event_hubs_failure(&self) -> std::option::Option<&std::boxed::Box<crate::model::ingestion_failure_event::AzureEventHubsFailureReason>> {
        #[allow(unreachable_patterns)]
        self.failure.as_ref().and_then(|v| match v {
            crate::model::ingestion_failure_event::Failure::AzureEventHubsFailure(v) => std::option::Option::Some(v),
            _ => std::option::Option::None,
        })
    }

    /// Sets the value of [failure][crate::model::IngestionFailureEvent::failure]
    /// to hold a `AzureEventHubsFailure`.
    ///
    /// Note that all the setters affecting `failure` are
    /// mutually exclusive.
    pub fn set_azure_event_hubs_failure<T: std::convert::Into<std::boxed::Box<crate::model::ingestion_failure_event::AzureEventHubsFailureReason>>>(mut self, v: T) -> Self {
        self.failure = std::option::Option::Some(
            crate::model::ingestion_failure_event::Failure::AzureEventHubsFailure(
                v.into()
            )
        );
        self
    ...
    /// The value of [failure][crate::model::IngestionFailureEvent::failure]
    /// if it holds a `ConfluentCloudFailure`, `None` if the field is not set or
    /// holds a different branch.
    pub fn confluent_cloud_failure(&self) -> std::option::Option<&std::boxed::Box<crate::model::ingestion_failure_event::ConfluentCloudFailureReason>> {
        #[allow(unreachable_patterns)]
        self.failure.as_ref().and_then(|v| match v {
            crate::model::ingestion_failure_event::Failure::ConfluentCloudFailure(v) => std::option::Option::Some(v),
            _ => std::option::Option::None,
        })
    }

    /// Sets the value of [failure][crate::model::IngestionFailureEvent::failure]
    /// to hold a `ConfluentCloudFailure`.
    ///
    /// Note that all the setters affecting `failure` are
    /// mutually exclusive.
    pub fn set_confluent_cloud_failure<T: std::convert::Into<std::boxed::Box<crate::model::ingestion_failure_event::ConfluentCloudFailureReason>>>(mut self, v: T) -> Self {
        self.failure = std::option::Option::Some(
            crate::model::ingestion_failure_event::Failure::ConfluentCloudFailure(
                v.into()
            )
        );
        self
    ...
    /// The value of [failure][crate::model::IngestionFailureEvent::failure]
    /// if it holds a `AwsKinesisFailure`, `None` if the field is not set or
    /// holds a different branch.
    pub fn aws_kinesis_failure(&self) -> std::option::Option<&std::boxed::Box<crate::model::ingestion_failure_event::AwsKinesisFailureReason>> {
        #[allow(unreachable_patterns)]
        self.failure.as_ref().and_then(|v| match v {
            crate::model::ingestion_failure_event::Failure::AwsKinesisFailure(v) => std::option::Option::Some(v),
            _ => std::option::Option::None,
        })
    }

    /// Sets the value of [failure][crate::model::IngestionFailureEvent::failure]
    /// to hold a `AwsKinesisFailure`.
    ///
    /// Note that all the setters affecting `failure` are
    /// mutually exclusive.
    pub fn set_aws_kinesis_failure<T: std::convert::Into<std::boxed::Box<crate::model::ingestion_failure_event::AwsKinesisFailureReason>>>(mut self, v: T) -> Self {
        self.failure = std::option::Option::Some(
            crate::model::ingestion_failure_event::Failure::AwsKinesisFailure(
                v.into()
            )
        );
        self
...
impl wkt::message::Message for IngestionFailureEvent {
    fn typename() -> &'static str {
...
#[doc(hidden)]
impl<'de> serde::de::Deserialize<'de> for IngestionFailureEvent {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        enum __FieldTag {
            __topic,
            __error_message,
            __cloud_storage_failure,
            __aws_msk_failure,
            __azure_event_hubs_failure,
            __confluent_cloud_failure,
            __aws_kinesis_failure,
            Unknown(std::string::String),
        }
        impl<'de> serde::de::Deserialize<'de> for __FieldTag {
            fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for Visitor {
                    type Value = __FieldTag;
                    fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                        formatter.write_str("a field name for IngestionFailureEvent")
                    }
                    fn visit_str<E>(self, value: &str) -> std::result::Result<Self::Value, E>
                    where
                        E: serde::de::Error,
                    {
                        ...
                        match value {
                            ...
                            "cloudStorageFailure" => Ok(__FieldTag::__cloud_storage_failure),
                            "cloud_storage_failure" => Ok(__FieldTag::__cloud_storage_failure),
                            "awsMskFailure" => Ok(__FieldTag::__aws_msk_failure),
                            "aws_msk_failure" => Ok(__FieldTag::__aws_msk_failure),
                            "azureEventHubsFailure" => Ok(__FieldTag::__azure_event_hubs_failure),
                            "azure_event_hubs_failure" => Ok(__FieldTag::__azure_event_hubs_failure),
                            "confluentCloudFailure" => Ok(__FieldTag::__confluent_cloud_failure),
                            "confluent_cloud_failure" => Ok(__FieldTag::__confluent_cloud_failure),
                            "awsKinesisFailure" => Ok(__FieldTag::__aws_kinesis_failure),
                            "aws_kinesis_failure" => Ok(__FieldTag::__aws_kinesis_failure),
                            _ => Ok(__FieldTag::Unknown(value.to_string())),
                        }
                    }
                }
        ...
        struct Visitor;
        impl<'de> serde::de::Visitor<'de> for Visitor {
            type Value = IngestionFailureEvent;
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("struct IngestionFailureEvent")
            }
            fn visit_map<A>(self, mut map: A) -> std::result::Result<Self::Value, A::Error>
            where
                A: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(tag) = map.next_key::<__FieldTag>()? {
                    ...
                    match tag {
                        ...
                        __FieldTag::__cloud_storage_failure => {
                            if !fields.insert(__FieldTag::__cloud_storage_failure) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for cloud_storage_failure"));
                            }
                            if result.failure.is_some() {
                                return std::result::Result::Err(A::Error::duplicate_field(
                                    "multiple values for `failure`, a oneof with full ID .google.pubsub.v1.IngestionFailureEvent.cloud_storage_failure, latest field was cloudStorageFailure",
                                ));
                            }
                            result.failure = std::option::Option::Some(
                                crate::model::ingestion_failure_event::Failure::CloudStorageFailure(
                                    map.next_value::<std::option::Option<std::boxed::Box<crate::model::ingestion_failure_event::CloudStorageFailure>>>()?.unwrap_or_default()
                                ),
                            );
                        },
                        __FieldTag::__aws_msk_failure => {
                            if !fields.insert(__FieldTag::__aws_msk_failure) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for aws_msk_failure"));
                            }
                            if result.failure.is_some() {
                                return std::result::Result::Err(A::Error::duplicate_field(
                                    "multiple values for `failure`, a oneof with full ID .google.pubsub.v1.IngestionFailureEvent.aws_msk_failure, latest field was awsMskFailure",
                                ));
                            }
                            result.failure = std::option::Option::Some(
                                crate::model::ingestion_failure_event::Failure::AwsMskFailure(
                                    map.next_value::<std::option::Option<std::boxed::Box<crate::model::ingestion_failure_event::AwsMskFailureReason>>>()?.unwrap_or_default()
                                ),
                            );
                        },
                        __FieldTag::__azure_event_hubs_failure => {
                            if !fields.insert(__FieldTag::__azure_event_hubs_failure) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for azure_event_hubs_failure"));
                            }
                            if result.failure.is_some() {
                                return std::result::Result::Err(A::Error::duplicate_field(
                                    "multiple values for `failure`, a oneof with full ID .google.pubsub.v1.IngestionFailureEvent.azure_event_hubs_failure, latest field was azureEventHubsFailure",
                                ));
                            }
                            result.failure = std::option::Option::Some(
                                crate::model::ingestion_failure_event::Failure::AzureEventHubsFailure(
                                    map.next_value::<std::option::Option<std::boxed::Box<crate::model::ingestion_failure_event::AzureEventHubsFailureReason>>>()?.unwrap_or_default()
                                ),
                            );
                        },
                        __FieldTag::__confluent_cloud_failure => {
                            if !fields.insert(__FieldTag::__confluent_cloud_failure) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for confluent_cloud_failure"));
                            }
                            if result.failure.is_some() {
                                return std::result::Result::Err(A::Error::duplicate_field(
                                    "multiple values for `failure`, a oneof with full ID .google.pubsub.v1.IngestionFailureEvent.confluent_cloud_failure, latest field was confluentCloudFailure",
                                ));
                            }
                            result.failure = std::option::Option::Some(
                                crate::model::ingestion_failure_event::Failure::ConfluentCloudFailure(
                                    map.next_value::<std::option::Option<std::boxed::Box<crate::model::ingestion_failure_event::ConfluentCloudFailureReason>>>()?.unwrap_or_default()
                                ),
                            );
                        },
                        __FieldTag::__aws_kinesis_failure => {
                            if !fields.insert(__FieldTag::__aws_kinesis_failure) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for aws_kinesis_failure"));
                            }
                            if result.failure.is_some() {
                                return std::result::Result::Err(A::Error::duplicate_field(
                                    "multiple values for `failure`, a oneof with full ID .google.pubsub.v1.IngestionFailureEvent.aws_kinesis_failure, latest field was awsKinesisFailure",
                                ));
                            }
                            result.failure = std::option::Option::Some(
                                crate::model::ingestion_failure_event::Failure::AwsKinesisFailure(
                                    map.next_value::<std::option::Option<std::boxed::Box<crate::model::ingestion_failure_event::AwsKinesisFailureReason>>>()?.unwrap_or_default()
                                ),
                            );
                        },
                        __FieldTag::Unknown(key) => {
...
#[doc(hidden)]
impl serde::ser::Serialize for IngestionFailureEvent {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
        ...
        if let Some(value) = self.cloud_storage_failure() {
            state.serialize_entry("cloudStorageFailure", value)?;
        }
        if let Some(value) = self.aws_msk_failure() {
            state.serialize_entry("awsMskFailure", value)?;
        }
        if let Some(value) = self.azure_event_hubs_failure() {
            state.serialize_entry("azureEventHubsFailure", value)?;
        }
        if let Some(value) = self.confluent_cloud_failure() {
            state.serialize_entry("confluentCloudFailure", value)?;
        }
        if let Some(value) = self.aws_kinesis_failure() {
            state.serialize_entry("awsKinesisFailure", value)?;
        }
        if !self._unknown_fields.is_empty() {
            for (key, value) in self._unknown_fields.iter() {
                state.serialize_entry(key, &value)?;
...
impl std::fmt::Debug for IngestionFailureEvent {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut debug_struct = f.debug_struct("IngestionFailureEvent");
        debug_struct.field("topic", &self.topic);
...
/// Defines additional types related to [IngestionFailureEvent].
pub mod ingestion_failure_event {
    ...
    impl wkt::message::Message for ApiViolationReason {
        fn typename() -> &'static str {
    ...
    #[doc(hidden)]
    impl<'de> serde::de::Deserialize<'de> for ApiViolationReason {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: serde::Deserializer<'de>,
        {
            ...
            impl<'de> serde::de::Deserialize<'de> for __FieldTag {
                    ...
                    D: serde::Deserializer<'de>,
                {
                    ...
                    impl<'de> serde::de::Visitor<'de> for Visitor {
                        type Value = __FieldTag;
                        fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                            formatter.write_str("a field name for ApiViolationReason")
                        }
                        fn visit_str<E>(self, value: &str) -> std::result::Result<Self::Value, E>
                        where
                            E: serde::de::Error,
            ...
            struct Visitor;
            impl<'de> serde::de::Visitor<'de> for Visitor {
                type Value = ApiViolationReason;
                fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                    formatter.write_str("struct ApiViolationReason")
                }
                fn visit_map<A>(self, mut map: A) -> std::result::Result<Self::Value, A::Error>
                where
                    A: serde::de::MapAccess<'de>,
    ...
    #[doc(hidden)]
    impl serde::ser::Serialize for ApiViolationReason {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: serde::ser::Serializer,
        {
    ...
    impl std::fmt::Debug for ApiViolationReason {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            let mut debug_struct = f.debug_struct("ApiViolationReason");
            if !self._unknown_fields.is_empty() {
                debug_struct.field("_unknown_fields", &self._unknown_fields);
            }
            debug_struct.finish()
    ...
    impl wkt::message::Message for AvroFailureReason {
        fn typename() -> &'static str {
    ...
    #[doc(hidden)]
    impl<'de> serde::de::Deserialize<'de> for AvroFailureReason {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: serde::Deserializer<'de>,
        {
            ...
            impl<'de> serde::de::Deserialize<'de> for __FieldTag {
                    ...
                    D: serde::Deserializer<'de>,
                {
                    ...
                    impl<'de> serde::de::Visitor<'de> for Visitor {
                        type Value = __FieldTag;
                        fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                            formatter.write_str("a field name for AvroFailureReason")
                        }
                        fn visit_str<E>(self, value: &str) -> std::result::Result<Self::Value, E>
                        where
                            E: serde::de::Error,
            ...
            struct Visitor;
            impl<'de> serde::de::Visitor<'de> for Visitor {
                type Value = AvroFailureReason;
                fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                    formatter.write_str("struct AvroFailureReason")
                }
                fn visit_map<A>(self, mut map: A) -> std::result::Result<Self::Value, A::Error>
                where
                    A: serde::de::MapAccess<'de>,
    ...
    #[doc(hidden)]
    impl serde::ser::Serialize for AvroFailureReason {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: serde::ser::Serializer,
        {
    ...
    impl std::fmt::Debug for AvroFailureReason {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            let mut debug_struct = f.debug_struct("AvroFailureReason");
            if !self._unknown_fields.is_empty() {
                debug_struct.field("_unknown_fields", &self._unknown_fields);
            }
            debug_struct.finish()
    ...
    impl SchemaViolationReason {
        pub fn new() -> Self {
            std::default::Default::default()
        }
    }

    impl wkt::message::Message for SchemaViolationReason {
        fn typename() -> &'static str {
    ...
    #[doc(hidden)]
    impl<'de> serde::de::Deserialize<'de> for SchemaViolationReason {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: serde::Deserializer<'de>,
        {
            ...
            impl<'de> serde::de::Deserialize<'de> for __FieldTag {
                    ...
                    D: serde::Deserializer<'de>,
                {
                    ...
                    impl<'de> serde::de::Visitor<'de> for Visitor {
                        type Value = __FieldTag;
                        fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                            formatter.write_str("a field name for SchemaViolationReason")
                        }
                        fn visit_str<E>(self, value: &str) -> std::result::Result<Self::Value, E>
                        where
                            E: serde::de::Error,
            ...
            struct Visitor;
            impl<'de> serde::de::Visitor<'de> for Visitor {
                type Value = SchemaViolationReason;
                fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                    formatter.write_str("struct SchemaViolationReason")
                }
                fn visit_map<A>(self, mut map: A) -> std::result::Result<Self::Value, A::Error>
                where
                    A: serde::de::MapAccess<'de>,
    ...
    #[doc(hidden)]
    impl serde::ser::Serialize for SchemaViolationReason {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: serde::ser::Serializer,
        {
    ...
    impl std::fmt::Debug for SchemaViolationReason {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            let mut debug_struct = f.debug_struct("SchemaViolationReason");
            if !self._unknown_fields.is_empty() {
                debug_struct.field("_unknown_fields", &self._unknown_fields);
            }
            debug_struct.finish()
    ...
    impl MessageTransformationFailureReason {
        pub fn new() -> Self {
            std::default::Default::default()
        }
    }

    impl wkt::message::Message for MessageTransformationFailureReason {
        fn typename() -> &'static str {
    ...
    #[doc(hidden)]
    impl<'de> serde::de::Deserialize<'de> for MessageTransformationFailureReason {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: serde::Deserializer<'de>,
        {
            ...
            impl<'de> serde::de::Deserialize<'de> for __FieldTag {
                    ...
                    D: serde::Deserializer<'de>,
                {
                    ...
                    impl<'de> serde::de::Visitor<'de> for Visitor {
                        type Value = __FieldTag;
                        fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                            formatter.write_str("a field name for MessageTransformationFailureReason")
                        }
                        fn visit_str<E>(self, value: &str) -> std::result::Result<Self::Value, E>
                        where
                            E: serde::de::Error,
            ...
            struct Visitor;
            impl<'de> serde::de::Visitor<'de> for Visitor {
                type Value = MessageTransformationFailureReason;
                fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                    formatter.write_str("struct MessageTransformationFailureReason")
                }
                fn visit_map<A>(self, mut map: A) -> std::result::Result<Self::Value, A::Error>
                where
                    A: serde::de::MapAccess<'de>,
    ...
    #[doc(hidden)]
    impl serde::ser::Serialize for MessageTransformationFailureReason {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: serde::ser::Serializer,
        {
    ...
    impl std::fmt::Debug for MessageTransformationFailureReason {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            let mut debug_struct = f.debug_struct("MessageTransformationFailureReason");
            if !self._unknown_fields.is_empty() {
                debug_struct.field("_unknown_fields", &self._unknown_fields);
            }
            debug_struct.finish()
    ...
    pub struct CloudStorageFailure {
        ...
        pub reason: std::option::Option<crate::model::ingestion_failure_event::cloud_storage_failure::Reason>,
    ...
    impl CloudStorageFailure {
        ...
        /// Sets the value of [bucket][crate::model::ingestion_failure_event::CloudStorageFailure::bucket].
        pub fn set_bucket<T: std::convert::Into<std::string::String>>(mut self, v: T) -> Self {
            self.bucket = v.into();
            self
        }

        /// Sets the value of [object_name][crate::model::ingestion_failure_event::CloudStorageFailure::object_name].
        pub fn set_object_name<T: std::convert::Into<std::string::String>>(mut self, v: T) -> Self {
            self.object_name = v.into();
            self
        }

        /// Sets the value of [object_generation][crate::model::ingestion_failure_event::CloudStorageFailure::object_generation].
        pub fn set_object_generation<T: std::convert::Into<i64>>(mut self, v: T) -> Self {
            self.object_generation = v.into();
            self
        }

        /// Sets the value of [reason][crate::model::ingestion_failure_event::CloudStorageFailure::reason].
        ///
        /// Note that all the setters affecting `reason` are mutually
        /// exclusive.
        pub fn set_reason<T: std::convert::Into<std::option::Option<crate::model::ingestion_failure_event::cloud_storage_failure::Reason>>>(mut self, v: T) -> Self
        {
            self.reason = v.into();
            self
        }

        /// The value of [reason][crate::model::ingestion_failure_event::CloudStorageFailure::reason]
        /// if it holds a `AvroFailureReason`, `None` if the field is not set or
        /// holds a different branch.
        pub fn avro_failure_reason(&self) -> std::option::Option<&std::boxed::Box<crate::model::ingestion_failure_event::AvroFailureReason>> {
            #[allow(unreachable_patterns)]
            self.reason.as_ref().and_then(|v| match v {
                crate::model::ingestion_failure_event::cloud_storage_failure::Reason::AvroFailureReason(v) => std::option::Option::Some(v),
                _ => std::option::Option::None,
            })
        }

        /// Sets the value of [reason][crate::model::ingestion_failure_event::CloudStorageFailure::reason]
        /// to hold a `AvroFailureReason`.
        ///
        /// Note that all the setters affecting `reason` are
        /// mutually exclusive.
        pub fn set_avro_failure_reason<T: std::convert::Into<std::boxed::Box<crate::model::ingestion_failure_event::AvroFailureReason>>>(mut self, v: T) -> Self {
            self.reason = std::option::Option::Some(
                crate::model::ingestion_failure_event::cloud_storage_failure::Reason::AvroFailureReason(
                    v.into()
                )
            );
            self
        ...
        /// The value of [reason][crate::model::ingestion_failure_event::CloudStorageFailure::reason]
        /// if it holds a `ApiViolationReason`, `None` if the field is not set or
        /// holds a different branch.
        pub fn api_violation_reason(&self) -> std::option::Option<&std::boxed::Box<crate::model::ingestion_failure_event::ApiViolationReason>> {
            #[allow(unreachable_patterns)]
            self.reason.as_ref().and_then(|v| match v {
                crate::model::ingestion_failure_event::cloud_storage_failure::Reason::ApiViolationReason(v) => std::option::Option::Some(v),
                _ => std::option::Option::None,
            })
        }

        /// Sets the value of [reason][crate::model::ingestion_failure_event::CloudStorageFailure::reason]
        /// to hold a `ApiViolationReason`.
        ///
        /// Note that all the setters affecting `reason` are
        /// mutually exclusive.
        pub fn set_api_violation_reason<T: std::convert::Into<std::boxed::Box<crate::model::ingestion_failure_event::ApiViolationReason>>>(mut self, v: T) -> Self {
            self.reason = std::option::Option::Some(
                crate::model::ingestion_failure_event::cloud_storage_failure::Reason::ApiViolationReason(
                    v.into()
                )
            );
            self
        ...
        /// The value of [reason][crate::model::ingestion_failure_event::CloudStorageFailure::reason]
        /// if it holds a `SchemaViolationReason`, `None` if the field is not set or
        /// holds a different branch.
        pub fn schema_violation_reason(&self) -> std::option::Option<&std::boxed::Box<crate::model::ingestion_failure_event::SchemaViolationReason>> {
            #[allow(unreachable_patterns)]
            self.reason.as_ref().and_then(|v| match v {
                crate::model::ingestion_failure_event::cloud_storage_failure::Reason::SchemaViolationReason(v) => std::option::Option::Some(v),
                _ => std::option::Option::None,
            })
        }

        /// Sets the value of [reason][crate::model::ingestion_failure_event::CloudStorageFailure::reason]
        /// to hold a `SchemaViolationReason`.
        ///
        /// Note that all the setters affecting `reason` are
        /// mutually exclusive.
        pub fn set_schema_violation_reason<T: std::convert::Into<std::boxed::Box<crate::model::ingestion_failure_event::SchemaViolationReason>>>(mut self, v: T) -> Self {
            self.reason = std::option::Option::Some(
                crate::model::ingestion_failure_event::cloud_storage_failure::Reason::SchemaViolationReason(
                    v.into()
                )
            );
            self
        ...
        /// The value of [reason][crate::model::ingestion_failure_event::CloudStorageFailure::reason]
        /// if it holds a `MessageTransformationFailureReason`, `None` if the field is not set or
        /// holds a different branch.
        pub fn message_transformation_failure_reason(&self) -> std::option::Option<&std::boxed::Box<crate::model::ingestion_failure_event::MessageTransformationFailureReason>> {
            #[allow(unreachable_patterns)]
            self.reason.as_ref().and_then(|v| match v {
                crate::model::ingestion_failure_event::cloud_storage_failure::Reason::MessageTransformationFailureReason(v) => std::option::Option::Some(v),
                _ => std::option::Option::None,
            })
        }

        /// Sets the value of [reason][crate::model::ingestion_failure_event::CloudStorageFailure::reason]
        /// to hold a `MessageTransformationFailureReason`.
        ///
        /// Note that all the setters affecting `reason` are
        /// mutually exclusive.
        pub fn set_message_transformation_failure_reason<T: std::convert::Into<std::boxed::Box<crate::model::ingestion_failure_event::MessageTransformationFailureReason>>>(mut self, v: T) -> Self {
            self.reason = std::option::Option::Some(
                crate::model::ingestion_failure_event::cloud_storage_failure::Reason::MessageTransformationFailureReason(
                    v.into()
                )
            );
            self
    ...
    impl wkt::message::Message for CloudStorageFailure {
        fn typename() -> &'static str {
    ...
    #[doc(hidden)]
    impl<'de> serde::de::Deserialize<'de> for CloudStorageFailure {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: serde::Deserializer<'de>,
        {
            ...
            enum __FieldTag {
                ...
                __object_name,
                __object_generation,
                __avro_failure_reason,
                __api_violation_reason,
                __schema_violation_reason,
                __message_transformation_failure_reason,
                Unknown(std::string::String),
            }
            impl<'de> serde::de::Deserialize<'de> for __FieldTag {
                fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
                    ...
                    D: serde::Deserializer<'de>,
                {
                    ...
                    impl<'de> serde::de::Visitor<'de> for Visitor {
                        type Value = __FieldTag;
                        fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                            formatter.write_str("a field name for CloudStorageFailure")
                        }
                        fn visit_str<E>(self, value: &str) -> std::result::Result<Self::Value, E>
                        where
                            E: serde::de::Error,
                        {
                            ...
                            match value {
                                ...
                                "objectGeneration" => Ok(__FieldTag::__object_generation),
                                "object_generation" => Ok(__FieldTag::__object_generation),
                                "avroFailureReason" => Ok(__FieldTag::__avro_failure_reason),
                                "avro_failure_reason" => Ok(__FieldTag::__avro_failure_reason),
                                "apiViolationReason" => Ok(__FieldTag::__api_violation_reason),
                                "api_violation_reason" => Ok(__FieldTag::__api_violation_reason),
                                "schemaViolationReason" => Ok(__FieldTag::__schema_violation_reason),
                                "schema_violation_reason" => Ok(__FieldTag::__schema_violation_reason),
                                "messageTransformationFailureReason" => Ok(__FieldTag::__message_transformation_failure_reason),
                                "message_transformation_failure_reason" => Ok(__FieldTag::__message_transformation_failure_reason),
                                _ => Ok(__FieldTag::Unknown(value.to_string())),
                            }
                        }
                    }
            ...
            struct Visitor;
            impl<'de> serde::de::Visitor<'de> for Visitor {
                type Value = CloudStorageFailure;
                fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                    formatter.write_str("struct CloudStorageFailure")
                }
                fn visit_map<A>(self, mut map: A) -> std::result::Result<Self::Value, A::Error>
                where
                    A: serde::de::MapAccess<'de>,
                {
                    ...
                    while let Some(tag) = map.next_key::<__FieldTag>()? {
                        ...
                        match tag {
                            ...
                            __FieldTag::__object_generation => {
                                if !fields.insert(__FieldTag::__object_generation) {
                                    return std::result::Result::Err(A::Error::duplicate_field("multiple values for object_generation"));
                                }
                                ...
                                result.object_generation = map.next_value::< __With >()?.0.unwrap_or_default();
                            },
                            __FieldTag::__avro_failure_reason => {
                                if !fields.insert(__FieldTag::__avro_failure_reason) {
                                    return std::result::Result::Err(A::Error::duplicate_field("multiple values for avro_failure_reason"));
                                }
                                if result.reason.is_some() {
                                    return std::result::Result::Err(A::Error::duplicate_field(
                                        "multiple values for `reason`, a oneof with full ID .google.pubsub.v1.IngestionFailureEvent.CloudStorageFailure.avro_failure_reason, latest field was avroFailureReason",
                                    ));
                                }
                                result.reason = std::option::Option::Some(
                                    crate::model::ingestion_failure_event::cloud_storage_failure::Reason::AvroFailureReason(
                                        map.next_value::<std::option::Option<std::boxed::Box<crate::model::ingestion_failure_event::AvroFailureReason>>>()?.unwrap_or_default()
                                    ),
                                );
                            },
                            __FieldTag::__api_violation_reason => {
                                if !fields.insert(__FieldTag::__api_violation_reason) {
                                    return std::result::Result::Err(A::Error::duplicate_field("multiple values for api_violation_reason"));
                                }
                                if result.reason.is_some() {
                                    return std::result::Result::Err(A::Error::duplicate_field(
                                        "multiple values for `reason`, a oneof with full ID .google.pubsub.v1.IngestionFailureEvent.CloudStorageFailure.api_violation_reason, latest field was apiViolationReason",
                                    ));
                                }
                                result.reason = std::option::Option::Some(
                                    crate::model::ingestion_failure_event::cloud_storage_failure::Reason::ApiViolationReason(
                                        map.next_value::<std::option::Option<std::boxed::Box<crate::model::ingestion_failure_event::ApiViolationReason>>>()?.unwrap_or_default()
                                    ),
                                );
                            },
                            __FieldTag::__schema_violation_reason => {
                                if !fields.insert(__FieldTag::__schema_violation_reason) {
                                    return std::result::Result::Err(A::Error::duplicate_field("multiple values for schema_violation_reason"));
                                }
                                if result.reason.is_some() {
                                    return std::result::Result::Err(A::Error::duplicate_field(
                                        "multiple values for `reason`, a oneof with full ID .google.pubsub.v1.IngestionFailureEvent.CloudStorageFailure.schema_violation_reason, latest field was schemaViolationReason",
                                    ));
                                }
                                result.reason = std::option::Option::Some(
                                    crate::model::ingestion_failure_event::cloud_storage_failure::Reason::SchemaViolationReason(
                                        map.next_value::<std::option::Option<std::boxed::Box<crate::model::ingestion_failure_event::SchemaViolationReason>>>()?.unwrap_or_default()
                                    ),
                                );
                            },
                            __FieldTag::__message_transformation_failure_reason => {
                                if !fields.insert(__FieldTag::__message_transformation_failure_reason) {
                                    return std::result::Result::Err(A::Error::duplicate_field("multiple values for message_transformation_failure_reason"));
                                }
                                if result.reason.is_some() {
                                    return std::result::Result::Err(A::Error::duplicate_field(
                                        "multiple values for `reason`, a oneof with full ID .google.pubsub.v1.IngestionFailureEvent.CloudStorageFailure.message_transformation_failure_reason, latest field was messageTransformationFailureReason",
                                    ));
                                }
                                result.reason = std::option::Option::Some(
                                    crate::model::ingestion_failure_event::cloud_storage_failure::Reason::MessageTransformationFailureReason(
                                        map.next_value::<std::option::Option<std::boxed::Box<crate::model::ingestion_failure_event::MessageTransformationFailureReason>>>()?.unwrap_or_default()
                                    ),
                                );
                            },
                            __FieldTag::Unknown(key) => {
    ...
    #[doc(hidden)]
    impl serde::ser::Serialize for CloudStorageFailure {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: serde::ser::Serializer,
        {
            ...
            if !wkt::internal::is_default(&self.object_generation) {
                ...
                state.serialize_entry("objectGeneration", &__With(&self.object_generation))?;
            }
            if let Some(value) = self.avro_failure_reason() {
                state.serialize_entry("avroFailureReason", value)?;
            }
            if let Some(value) = self.api_violation_reason() {
                state.serialize_entry("apiViolationReason", value)?;
            }
            if let Some(value) = self.schema_violation_reason() {
                state.serialize_entry("schemaViolationReason", value)?;
            }
            if let Some(value) = self.message_transformation_failure_reason() {
                state.serialize_entry("messageTransformationFailureReason", value)?;
            }
            if !self._unknown_fields.is_empty() {
                for (key, value) in self._unknown_fields.iter() {
                    state.serialize_entry(key, &value)?;
    ...
    impl std::fmt::Debug for CloudStorageFailure {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            let mut debug_struct = f.debug_struct("CloudStorageFailure");
            debug_struct.field("bucket", &self.bucket);
            debug_struct.field("object_name", &self.object_name);
            debug_struct.field("object_generation", &self.object_generation);
    ...
    /// Defines additional types related to [CloudStorageFailure].
    pub mod cloud_storage_failure {
        ...
        pub enum Reason {
            ...
            AvroFailureReason(std::boxed::Box<crate::model::ingestion_failure_event::AvroFailureReason>),
            /// Optional. The Pub/Sub API limits prevented the desired message from
            /// being published.
            ApiViolationReason(std::boxed::Box<crate::model::ingestion_failure_event::ApiViolationReason>),
            /// Optional. The Pub/Sub message failed schema validation.
            SchemaViolationReason(std::boxed::Box<crate::model::ingestion_failure_event::SchemaViolationReason>),
            /// Optional. Failure encountered when applying a message transformation to
            /// the Pub/Sub message.
            MessageTransformationFailureReason(std::boxed::Box<crate::model::ingestion_failure_event::MessageTransformationFailureReason>),
        }
    }
    ...
    pub struct AwsMskFailureReason {
        ...
        pub kafka_topic: std::string::String,
        ...
        pub reason: std::option::Option<crate::model::ingestion_failure_event::aws_msk_failure_reason::Reason>,

        _unknown_fields: serde_json::Map<std::string::String, serde_json::Value>,
    }

    impl AwsMskFailureReason {
        pub fn new() -> Self {
            std::default::Default::default()
        }

        /// Sets the value of [cluster_arn][crate::model::ingestion_failure_event::AwsMskFailureReason::cluster_arn].
        pub fn set_cluster_arn<T: std::convert::Into<std::string::String>>(mut self, v: T) -> Self {
            self.cluster_arn = v.into();
            self
        }

        /// Sets the value of [kafka_topic][crate::model::ingestion_failure_event::AwsMskFailureReason::kafka_topic].
        pub fn set_kafka_topic<T: std::convert::Into<std::string::String>>(mut self, v: T) -> Self {
            self.kafka_topic = v.into();
            self
        }

        /// Sets the value of [partition_id][crate::model::ingestion_failure_event::AwsMskFailureReason::partition_id].
        pub fn set_partition_id<T: std::convert::Into<i64>>(mut self, v: T) -> Self {
            self.partition_id = v.into();
            self
        }

        /// Sets the value of [offset][crate::model::ingestion_failure_event::AwsMskFailureReason::offset].
        pub fn set_offset<T: std::convert::Into<i64>>(mut self, v: T) -> Self {
            self.offset = v.into();
            self
        }

        /// Sets the value of [reason][crate::model::ingestion_failure_event::AwsMskFailureReason::reason].
        ///
        /// Note that all the setters affecting `reason` are mutually
        /// exclusive.
        pub fn set_reason<T: std::convert::Into<std::option::Option<crate::model::ingestion_failure_event::aws_msk_failure_reason::Reason>>>(mut self, v: T) -> Self
        {
            self.reason = v.into();
            self
        }

        /// The value of [reason][crate::model::ingestion_failure_event::AwsMskFailureReason::reason]
        /// if it holds a `ApiViolationReason`, `None` if the field is not set or
        /// holds a different branch.
        pub fn api_violation_reason(&self) -> std::option::Option<&std::boxed::Box<crate::model::ingestion_failure_event::ApiViolationReason>> {
            #[allow(unreachable_patterns)]
            self.reason.as_ref().and_then(|v| match v {
                crate::model::ingestion_failure_event::aws_msk_failure_reason::Reason::ApiViolationReason(v) => std::option::Option::Some(v),
                _ => std::option::Option::None,
            })
        }
        ...
        pub fn set_api_violation_reason<T: std::convert::Into<std::boxed::Box<crate::model::ingestion_failure_event::ApiViolationReason>>>(mut self, v: T) -> Self {
            self.reason = std::option::Option::Some(
                crate::model::ingestion_failure_event::aws_msk_failure_reason::Reason::ApiViolationReason(
                    v.into()
                )
            );
            self
        ...
        pub fn schema_violation_reason(&self) -> std::option::Option<&std::boxed::Box<crate::model::ingestion_failure_event::SchemaViolationReason>> {
            #[allow(unreachable_patterns)]
            self.reason.as_ref().and_then(|v| match v {
                crate::model::ingestion_failure_event::aws_msk_failure_reason::Reason::SchemaViolationReason(v) => std::option::Option::Some(v),
                _ => std::option::Option::None,
            })
        }
        ...
        pub fn set_schema_violation_reason<T: std::convert::Into<std::boxed::Box<crate::model::ingestion_failure_event::SchemaViolationReason>>>(mut self, v: T) -> Self {
            self.reason = std::option::Option::Some(
                crate::model::ingestion_failure_event::aws_msk_failure_reason::Reason::SchemaViolationReason(
                    v.into()
                )
            );
            self
        ...
        pub fn message_transformation_failure_reason(&self) -> std::option::Option<&std::boxed::Box<crate::model::ingestion_failure_event::MessageTransformationFailureReason>> {
            #[allow(unreachable_patterns)]
            self.reason.as_ref().and_then(|v| match v {
                crate::model::ingestion_failure_event::aws_msk_failure_reason::Reason::MessageTransformationFailureReason(v) => std::option::Option::Some(v),
                _ => std::option::Option::None,
            })
        }
        ...
        pub fn set_message_transformation_failure_reason<T: std::convert::Into<std::boxed::Box<crate::model::ingestion_failure_event::MessageTransformationFailureReason>>>(mut self, v: T) -> Self {
            self.reason = std::option::Option::Some(
                crate::model::ingestion_failure_event::aws_msk_failure_reason::Reason::MessageTransformationFailureReason(
                    v.into()
                )
            );
            self
    ...
    impl wkt::message::Message for AwsMskFailureReason {
        fn typename() -> &'static str {
    ...
    #[doc(hidden)]
    impl<'de> serde::de::Deserialize<'de> for AwsMskFailureReason {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: serde::Deserializer<'de>,
        {
            ...
            impl<'de> serde::de::Deserialize<'de> for __FieldTag {
                    ...
                    D: serde::Deserializer<'de>,
                {
                    ...
                    impl<'de> serde::de::Visitor<'de> for Visitor {
                        type Value = __FieldTag;
                        fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                            formatter.write_str("a field name for AwsMskFailureReason")
                        }
                        fn visit_str<E>(self, value: &str) -> std::result::Result<Self::Value, E>
                        where
                            E: serde::de::Error,
                        {
                            ...
                            match value {
                                "clusterArn" => Ok(__FieldTag::__cluster_arn),
                                "cluster_arn" => Ok(__FieldTag::__cluster_arn),
                                "kafkaTopic" => Ok(__FieldTag::__kafka_topic),
                                "kafka_topic" => Ok(__FieldTag::__kafka_topic),
            ...
            struct Visitor;
            impl<'de> serde::de::Visitor<'de> for Visitor {
                type Value = AwsMskFailureReason;
                fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                    formatter.write_str("struct AwsMskFailureReason")
                }
                fn visit_map<A>(self, mut map: A) -> std::result::Result<Self::Value, A::Error>
                where
                    A: serde::de::MapAccess<'de>,
                {
                    ...
                    while let Some(tag) = map.next_key::<__FieldTag>()? {
                        ...
                        match tag {
                            ...
                            __FieldTag::__kafka_topic => {
                                if !fields.insert(__FieldTag::__kafka_topic) {
                                    return std::result::Result::Err(A::Error::duplicate_field("multiple values for kafka_topic"));
                                }
                                result.kafka_topic = map.next_value::<std::option::Option<std::string::String>>()?.unwrap_or_default();
                            },
                            __FieldTag::__partition_id => {
                                if !fields.insert(__FieldTag::__partition_id) {
                                    return std::result::Result::Err(A::Error::duplicate_field("multiple values for partition_id"));
                                }
                                struct __With( std::option::Option<i64> );
                                impl<'de> serde::de::Deserialize<'de> for __With {
                                    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
                                ...
                                result.partition_id = map.next_value::< __With >()?.0.unwrap_or_default();
                            },
                            __FieldTag::__offset => {
                            ...
                            __FieldTag::__api_violation_reason => {
                                ...
                                if result.reason.is_some() {
                                    return std::result::Result::Err(A::Error::duplicate_field(
                                        "multiple values for `reason`, a oneof with full ID .google.pubsub.v1.IngestionFailureEvent.AwsMskFailureReason.api_violation_reason, latest field was apiViolationReason",
                                    ));
                                }
                                result.reason = std::option::Option::Some(
                                    crate::model::ingestion_failure_event::aws_msk_failure_reason::Reason::ApiViolationReason(
                            ...
                            __FieldTag::__schema_violation_reason => {
                                ...
                                if result.reason.is_some() {
                                    return std::result::Result::Err(A::Error::duplicate_field(
                                        "multiple values for `reason`, a oneof with full ID .google.pubsub.v1.IngestionFailureEvent.AwsMskFailureReason.schema_violation_reason, latest field was schemaViolationReason",
                                    ));
                                }
                                result.reason = std::option::Option::Some(
                                    crate::model::ingestion_failure_event::aws_msk_failure_reason::Reason::SchemaViolationReason(
                            ...
                            __FieldTag::__message_transformation_failure_reason => {
                                ...
                                if result.reason.is_some() {
                                    return std::result::Result::Err(A::Error::duplicate_field(
                                        "multiple values for `reason`, a oneof with full ID .google.pubsub.v1.IngestionFailureEvent.AwsMskFailureReason.message_transformation_failure_reason, latest field was messageTransformationFailureReason",
                                    ));
                                }
                                result.reason = std::option::Option::Some(
                                    crate::model::ingestion_failure_event::aws_msk_failure_reason::Reason::MessageTransformationFailureReason(
    ...
    #[doc(hidden)]
    impl serde::ser::Serialize for AwsMskFailureReason {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: serde::ser::Serializer,
        {
            ...
            if !self.kafka_topic.is_empty() {
                state.serialize_entry("kafkaTopic", &self.kafka_topic)?;
            }
            if !wkt::internal::is_default(&self.partition_id) {
                struct __With<'a>(&'a i64);
                impl<'a> serde::ser::Serialize for __With<'a> {
                    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
                    where
                ...
                state.serialize_entry("partitionId", &__With(&self.partition_id))?;
            }
    ...
    impl std::fmt::Debug for AwsMskFailureReason {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            let mut debug_struct = f.debug_struct("AwsMskFailureReason");
            debug_struct.field("cluster_arn", &self.cluster_arn);
            debug_struct.field("kafka_topic", &self.kafka_topic);
    ...
    /// Defines additional types related to [AwsMskFailureReason].
    ...
    pub struct AzureEventHubsFailureReason {
        ...
        /// Reason why ingestion failed for the specified message.
        pub reason: std::option::Option<crate::model::ingestion_failure_event::azure_event_hubs_failure_reason::Reason>,

        _unknown_fields: serde_json::Map<std::string::String, serde_json::Value>,
    }

    impl AzureEventHubsFailureReason {
        pub fn new() -> Self {
            std::default::Default::default()
        }

        /// Sets the value of [namespace][crate::model::ingestion_failure_event::AzureEventHubsFailureReason::namespace].
        pub fn set_namespace<T: std::convert::Into<std::string::String>>(mut self, v: T) -> Self {
            self.namespace = v.into();
            self
        }

        /// Sets the value of [event_hub][crate::model::ingestion_failure_event::AzureEventHubsFailureReason::event_hub].
        pub fn set_event_hub<T: std::convert::Into<std::string::String>>(mut self, v: T) -> Self {
            self.event_hub = v.into();
            self
        }

        /// Sets the value of [partition_id][crate::model::ingestion_failure_event::AzureEventHubsFailureReason::partition_id].
        pub fn set_partition_id<T: std::convert::Into<i64>>(mut self, v: T) -> Self {
            self.partition_id = v.into();
            self
        }

        /// Sets the value of [offset][crate::model::ingestion_failure_event::AzureEventHubsFailureReason::offset].
        pub fn set_offset<T: std::convert::Into<i64>>(mut self, v: T) -> Self {
            self.offset = v.into();
            self
        }

        /// Sets the value of [reason][crate::model::ingestion_failure_event::AzureEventHubsFailureReason::reason].
        ///
        /// Note that all the setters affecting `reason` are mutually
        /// exclusive.
        pub fn set_reason<T: std::convert::Into<std::option::Option<crate::model::ingestion_failure_event::azure_event_hubs_failure_reason::Reason>>>(mut self, v: T) -> Self
        {
            self.reason = v.into();
            self
        }

        /// The value of [reason][crate::model::ingestion_failure_event::AzureEventHubsFailureReason::reason]
        /// if it holds a `ApiViolationReason`, `None` if the field is not set or
        /// holds a different branch.
        pub fn api_violation_reason(&self) -> std::option::Option<&std::boxed::Box<crate::model::ingestion_failure_event::ApiViolationReason>> {
            #[allow(unreachable_patterns)]
            self.reason.as_ref().and_then(|v| match v {
                crate::model::ingestion_failure_event::azure_event_hubs_failure_reason::Reason::ApiViolationReason(v) => std::option::Option::Some(v),
                _ => std::option::Option::None,
            })
        }
        ...
        pub fn set_api_violation_reason<T: std::convert::Into<std::boxed::Box<crate::model::ingestion_failure_event::ApiViolationReason>>>(mut self, v: T) -> Self {
            self.reason = std::option::Option::Some(
                crate::model::ingestion_failure_event::azure_event_hubs_failure_reason::Reason::ApiViolationReason(
                    v.into()
                )
            );
            self
        ...
        pub fn schema_violation_reason(&self) -> std::option::Option<&std::boxed::Box<crate::model::ingestion_failure_event::SchemaViolationReason>> {
            #[allow(unreachable_patterns)]
            self.reason.as_ref().and_then(|v| match v {
                crate::model::ingestion_failure_event::azure_event_hubs_failure_reason::Reason::SchemaViolationReason(v) => std::option::Option::Some(v),
                _ => std::option::Option::None,
            })
        }
        ...
        pub fn set_schema_violation_reason<T: std::convert::Into<std::boxed::Box<crate::model::ingestion_failure_event::SchemaViolationReason>>>(mut self, v: T) -> Self {
            self.reason = std::option::Option::Some(
                crate::model::ingestion_failure_event::azure_event_hubs_failure_reason::Reason::SchemaViolationReason(
                    v.into()
                )
            );
            self
        ...
        pub fn message_transformation_failure_reason(&self) -> std::option::Option<&std::boxed::Box<crate::model::ingestion_failure_event::MessageTransformationFailureReason>> {
            #[allow(unreachable_patterns)]
            self.reason.as_ref().and_then(|v| match v {
                crate::model::ingestion_failure_event::azure_event_hubs_failure_reason::Reason::MessageTransformationFailureReason(v) => std::option::Option::Some(v),
                _ => std::option::Option::None,
            })
        }
        ...
        pub fn set_message_transformation_failure_reason<T: std::convert::Into<std::boxed::Box<crate::model::ingestion_failure_event::MessageTransformationFailureReason>>>(mut self, v: T) -> Self {
            self.reason = std::option::Option::Some(
                crate::model::ingestion_failure_event::azure_event_hubs_failure_reason::Reason::MessageTransformationFailureReason(
                    v.into()
                )
            );
            self
    ...
    impl wkt::message::Message for AzureEventHubsFailureReason {
        fn typename() -> &'static str {
    ...
    #[doc(hidden)]
    impl<'de> serde::de::Deserialize<'de> for AzureEventHubsFailureReason {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: serde::Deserializer<'de>,
        {
            ...
            impl<'de> serde::de::Deserialize<'de> for __FieldTag {
                    ...
                    D: serde::Deserializer<'de>,
                {
                    ...
                    impl<'de> serde::de::Visitor<'de> for Visitor {
                        type Value = __FieldTag;
                        fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                            formatter.write_str("a field name for AzureEventHubsFailureReason")
                        }
                        fn visit_str<E>(self, value: &str) -> std::result::Result<Self::Value, E>
                        where
                            E: serde::de::Error,
            ...
            struct Visitor;
            impl<'de> serde::de::Visitor<'de> for Visitor {
                type Value = AzureEventHubsFailureReason;
                fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                    formatter.write_str("struct AzureEventHubsFailureReason")
                }
                fn visit_map<A>(self, mut map: A) -> std::result::Result<Self::Value, A::Error>
                where
                    A: serde::de::MapAccess<'de>,
                    ...
                    while let Some(tag) = map.next_key::<__FieldTag>()? {
                        ...
                        match tag {
                            ...
                            __FieldTag::__api_violation_reason => {
                                ...
                                if result.reason.is_some() {
                                    return std::result::Result::Err(A::Error::duplicate_field(
                                        "multiple values for `reason`, a oneof with full ID .google.pubsub.v1.IngestionFailureEvent.AzureEventHubsFailureReason.api_violation_reason, latest field was apiViolationReason",
                                    ));
                                }
                                result.reason = std::option::Option::Some(
                                    crate::model::ingestion_failure_event::azure_event_hubs_failure_reason::Reason::ApiViolationReason(
                            ...
                            __FieldTag::__schema_violation_reason => {
                                ...
                                if result.reason.is_some() {
                                    return std::result::Result::Err(A::Error::duplicate_field(
                                        "multiple values for `reason`, a oneof with full ID .google.pubsub.v1.IngestionFailureEvent.AzureEventHubsFailureReason.schema_violation_reason, latest field was schemaViolationReason",
                                    ));
                                }
                                result.reason = std::option::Option::Some(
                                    crate::model::ingestion_failure_event::azure_event_hubs_failure_reason::Reason::SchemaViolationReason(
                            ...
                            __FieldTag::__message_transformation_failure_reason => {
                                ...
                                if result.reason.is_some() {
                                    return std::result::Result::Err(A::Error::duplicate_field(
                                        "multiple values for `reason`, a oneof with full ID .google.pubsub.v1.IngestionFailureEvent.AzureEventHubsFailureReason.message_transformation_failure_reason, latest field was messageTransformationFailureReason",
                                    ));
                                }
                                result.reason = std::option::Option::Some(
                                    crate::model::ingestion_failure_event::azure_event_hubs_failure_reason::Reason::MessageTransformationFailureReason(
    ...
    #[doc(hidden)]
    impl serde::ser::Serialize for AzureEventHubsFailureReason {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: serde::ser::Serializer,
        {
    ...
    impl std::fmt::Debug for AzureEventHubsFailureReason {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            let mut debug_struct = f.debug_struct("AzureEventHubsFailureReason");
            debug_struct.field("namespace", &self.namespace);
            debug_struct.field("event_hub", &self.event_hub);
            debug_struct.field("partition_id", &self.partition_id);
            debug_struct.field("offset", &self.offset);
    ...
    /// Defines additional types related to [AzureEventHubsFailureReason].
    ...
    pub struct ConfluentCloudFailureReason {
        ...
        /// Reason why ingestion failed for the specified message.
        pub reason: std::option::Option<crate::model::ingestion_failure_event::confluent_cloud_failure_reason::Reason>,

        _unknown_fields: serde_json::Map<std::string::String, serde_json::Value>,
    }

    impl ConfluentCloudFailureReason {
        pub fn new() -> Self {
            std::default::Default::default()
        }

        /// Sets the value of [cluster_id][crate::model::ingestion_failure_event::ConfluentCloudFailureReason::cluster_id].
        pub fn set_cluster_id<T: std::convert::Into<std::string::String>>(mut self, v: T) -> Self {
            self.cluster_id = v.into();
            self
        }

        /// Sets the value of [kafka_topic][crate::model::ingestion_failure_event::ConfluentCloudFailureReason::kafka_topic].
        pub fn set_kafka_topic<T: std::convert::Into<std::string::String>>(mut self, v: T) -> Self {
            self.kafka_topic = v.into();
            self
        }

        /// Sets the value of [partition_id][crate::model::ingestion_failure_event::ConfluentCloudFailureReason::partition_id].
        pub fn set_partition_id<T: std::convert::Into<i64>>(mut self, v: T) -> Self {
            self.partition_id = v.into();
            self
        }

        /// Sets the value of [offset][crate::model::ingestion_failure_event::ConfluentCloudFailureReason::offset].
        pub fn set_offset<T: std::convert::Into<i64>>(mut self, v: T) -> Self {
            self.offset = v.into();
            self
        }

        /// Sets the value of [reason][crate::model::ingestion_failure_event::ConfluentCloudFailureReason::reason].
        ///
        /// Note that all the setters affecting `reason` are mutually
        /// exclusive.
        pub fn set_reason<T: std::convert::Into<std::option::Option<crate::model::ingestion_failure_event::confluent_cloud_failure_reason::Reason>>>(mut self, v: T) -> Self
        {
            self.reason = v.into();
            self
        }

        /// The value of [reason][crate::model::ingestion_failure_event::ConfluentCloudFailureReason::reason]
        /// if it holds a `ApiViolationReason`, `None` if the field is not set or
        /// holds a different branch.
        pub fn api_violation_reason(&self) -> std::option::Option<&std::boxed::Box<crate::model::ingestion_failure_event::ApiViolationReason>> {
            #[allow(unreachable_patterns)]
            self.reason.as_ref().and_then(|v| match v {
                crate::model::ingestion_failure_event::confluent_cloud_failure_reason::Reason::ApiViolationReason(v) => std::option::Option::Some(v),
                _ => std::option::Option::None,
            })
        }
        ...
        pub fn set_api_violation_reason<T: std::convert::Into<std::boxed::Box<crate::model::ingestion_failure_event::ApiViolationReason>>>(mut self, v: T) -> Self {
            self.reason = std::option::Option::Some(
                crate::model::ingestion_failure_event::confluent_cloud_failure_reason::Reason::ApiViolationReason(
                    v.into()
                )
            );
            self
        ...
        pub fn schema_violation_reason(&self) -> std::option::Option<&std::boxed::Box<crate::model::ingestion_failure_event::SchemaViolationReason>> {
            #[allow(unreachable_patterns)]
            self.reason.as_ref().and_then(|v| match v {
                crate::model::ingestion_failure_event::confluent_cloud_failure_reason::Reason::SchemaViolationReason(v) => std::option::Option::Some(v),
                _ => std::option::Option::None,
            })
        }
        ...
        pub fn set_schema_violation_reason<T: std::convert::Into<std::boxed::Box<crate::model::ingestion_failure_event::SchemaViolationReason>>>(mut self, v: T) -> Self {
            self.reason = std::option::Option::Some(
                crate::model::ingestion_failure_event::confluent_cloud_failure_reason::Reason::SchemaViolationReason(
                    v.into()
                )
            );
            self
        ...
        pub fn message_transformation_failure_reason(&self) -> std::option::Option<&std::boxed::Box<crate::model::ingestion_failure_event::MessageTransformationFailureReason>> {
            #[allow(unreachable_patterns)]
            self.reason.as_ref().and_then(|v| match v {
                crate::model::ingestion_failure_event::confluent_cloud_failure_reason::Reason::MessageTransformationFailureReason(v) => std::option::Option::Some(v),
                _ => std::option::Option::None,
            })
        }
        ...
        pub fn set_message_transformation_failure_reason<T: std::convert::Into<std::boxed::Box<crate::model::ingestion_failure_event::MessageTransformationFailureReason>>>(mut self, v: T) -> Self {
            self.reason = std::option::Option::Some(
                crate::model::ingestion_failure_event::confluent_cloud_failure_reason::Reason::MessageTransformationFailureReason(
                    v.into()
                )
            );
            self
    ...
    impl wkt::message::Message for ConfluentCloudFailureReason {
        fn typename() -> &'static str {
    ...
    #[doc(hidden)]
    impl<'de> serde::de::Deserialize<'de> for ConfluentCloudFailureReason {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: serde::Deserializer<'de>,
        {
            ...
            impl<'de> serde::de::Deserialize<'de> for __FieldTag {
                    ...
                    D: serde::Deserializer<'de>,
                {
                    ...
                    impl<'de> serde::de::Visitor<'de> for Visitor {
                        type Value = __FieldTag;
                        fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                            formatter.write_str("a field name for ConfluentCloudFailureReason")
                        }
                        fn visit_str<E>(self, value: &str) -> std::result::Result<Self::Value, E>
                        where
                            E: serde::de::Error,
            ...
            struct Visitor;
            impl<'de> serde::de::Visitor<'de> for Visitor {
                type Value = ConfluentCloudFailureReason;
                fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                    formatter.write_str("struct ConfluentCloudFailureReason")
                }
                fn visit_map<A>(self, mut map: A) -> std::result::Result<Self::Value, A::Error>
                where
                    A: serde::de::MapAccess<'de>,
                    ...
                    while let Some(tag) = map.next_key::<__FieldTag>()? {
                        ...
                        match tag {
                            ...
                            __FieldTag::__api_violation_reason => {
                                ...
                                if result.reason.is_some() {
                                    return std::result::Result::Err(A::Error::duplicate_field(
                                        "multiple values for `reason`, a oneof with full ID .google.pubsub.v1.IngestionFailureEvent.ConfluentCloudFailureReason.api_violation_reason, latest field was apiViolationReason",
                                    ));
                                }
                                result.reason = std::option::Option::Some(
                                    crate::model::ingestion_failure_event::confluent_cloud_failure_reason::Reason::ApiViolationReason(
                            ...
                            __FieldTag::__schema_violation_reason => {
                                ...
                                if result.reason.is_some() {
                                    return std::result::Result::Err(A::Error::duplicate_field(
                                        "multiple values for `reason`, a oneof with full ID .google.pubsub.v1.IngestionFailureEvent.ConfluentCloudFailureReason.schema_violation_reason, latest field was schemaViolationReason",
                                    ));
                                }
                                result.reason = std::option::Option::Some(
                                    crate::model::ingestion_failure_event::confluent_cloud_failure_reason::Reason::SchemaViolationReason(
                            ...
                            __FieldTag::__message_transformation_failure_reason => {
                                ...
                                if result.reason.is_some() {
                                    return std::result::Result::Err(A::Error::duplicate_field(
                                        "multiple values for `reason`, a oneof with full ID .google.pubsub.v1.IngestionFailureEvent.ConfluentCloudFailureReason.message_transformation_failure_reason, latest field was messageTransformationFailureReason",
                                    ));
                                }
                                result.reason = std::option::Option::Some(
                                    crate::model::ingestion_failure_event::confluent_cloud_failure_reason::Reason::MessageTransformationFailureReason(
    ...
    #[doc(hidden)]
    impl serde::ser::Serialize for ConfluentCloudFailureReason {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: serde::ser::Serializer,
        {
    ...
    impl std::fmt::Debug for ConfluentCloudFailureReason {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            let mut debug_struct = f.debug_struct("ConfluentCloudFailureReason");
            debug_struct.field("cluster_id", &self.cluster_id);
            debug_struct.field("kafka_topic", &self.kafka_topic);
            debug_struct.field("partition_id", &self.partition_id);
            debug_struct.field("offset", &self.offset);
    ...
    /// Defines additional types related to [ConfluentCloudFailureReason].
    ...
    pub struct AwsKinesisFailureReason {
        ...
        /// Reason why ingestion failed for the specified message.
        pub reason: std::option::Option<crate::model::ingestion_failure_event::aws_kinesis_failure_reason::Reason>,

        _unknown_fields: serde_json::Map<std::string::String, serde_json::Value>,
    }

    impl AwsKinesisFailureReason {
        pub fn new() -> Self {
            std::default::Default::default()
        }

        /// Sets the value of [stream_arn][crate::model::ingestion_failure_event::AwsKinesisFailureReason::stream_arn].
        pub fn set_stream_arn<T: std::convert::Into<std::string::String>>(mut self, v: T) -> Self {
            self.stream_arn = v.into();
            self
        }

        /// Sets the value of [partition_key][crate::model::ingestion_failure_event::AwsKinesisFailureReason::partition_key].
        pub fn set_partition_key<T: std::convert::Into<std::string::String>>(mut self, v: T) -> Self {
            self.partition_key = v.into();
            self
        }

        /// Sets the value of [sequence_number][crate::model::ingestion_failure_event::AwsKinesisFailureReason::sequence_number].
        pub fn set_sequence_number<T: std::convert::Into<std::string::String>>(mut self, v: T) -> Self {
            self.sequence_number = v.into();
            self
        }

        /// Sets the value of [reason][crate::model::ingestion_failure_event::AwsKinesisFailureReason::reason].
        ///
        /// Note that all the setters affecting `reason` are mutually
        /// exclusive.
        pub fn set_reason<T: std::convert::Into<std::option::Option<crate::model::ingestion_failure_event::aws_kinesis_failure_reason::Reason>>>(mut self, v: T) -> Self
        {
            self.reason = v.into();
            self
        }

        /// The value of [reason][crate::model::ingestion_failure_event::AwsKinesisFailureReason::reason]
        /// if it holds a `SchemaViolationReason`, `None` if the field is not set or
        /// holds a different branch.
        pub fn schema_violation_reason(&self) -> std::option::Option<&std::boxed::Box<crate::model::ingestion_failure_event::SchemaViolationReason>> {
            #[allow(unreachable_patterns)]
            self.reason.as_ref().and_then(|v| match v {
                crate::model::ingestion_failure_event::aws_kinesis_failure_reason::Reason::SchemaViolationReason(v) => std::option::Option::Some(v),
                _ => std::option::Option::None,
            })
        }
        ...
        pub fn set_schema_violation_reason<T: std::convert::Into<std::boxed::Box<crate::model::ingestion_failure_event::SchemaViolationReason>>>(mut self, v: T) -> Self {
            self.reason = std::option::Option::Some(
                crate::model::ingestion_failure_event::aws_kinesis_failure_reason::Reason::SchemaViolationReason(
                    v.into()
                )
            );
            self
        ...
        pub fn message_transformation_failure_reason(&self) -> std::option::Option<&std::boxed::Box<crate::model::ingestion_failure_event::MessageTransformationFailureReason>> {
            #[allow(unreachable_patterns)]
            self.reason.as_ref().and_then(|v| match v {
                crate::model::ingestion_failure_event::aws_kinesis_failure_reason::Reason::MessageTransformationFailureReason(v) => std::option::Option::Some(v),
                _ => std::option::Option::None,
            })
        }
        ...
        pub fn set_message_transformation_failure_reason<T: std::convert::Into<std::boxed::Box<crate::model::ingestion_failure_event::MessageTransformationFailureReason>>>(mut self, v: T) -> Self {
            self.reason = std::option::Option::Some(
                crate::model::ingestion_failure_event::aws_kinesis_failure_reason::Reason::MessageTransformationFailureReason(
                    v.into()
                )
            );
            self
    ...
    impl wkt::message::Message for AwsKinesisFailureReason {
        fn typename() -> &'static str {
    ...
    #[doc(hidden)]
    impl<'de> serde::de::Deserialize<'de> for AwsKinesisFailureReason {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: serde::Deserializer<'de>,
        {
            ...
            impl<'de> serde::de::Deserialize<'de> for __FieldTag {
                    ...
                    D: serde::Deserializer<'de>,
                {
                    ...
                    impl<'de> serde::de::Visitor<'de> for Visitor {
                        type Value = __FieldTag;
                        fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                            formatter.write_str("a field name for AwsKinesisFailureReason")
                        }
                        fn visit_str<E>(self, value: &str) -> std::result::Result<Self::Value, E>
                        where
                            E: serde::de::Error,
            ...
            struct Visitor;
            impl<'de> serde::de::Visitor<'de> for Visitor {
                type Value = AwsKinesisFailureReason;
                fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                    formatter.write_str("struct AwsKinesisFailureReason")
                }
                fn visit_map<A>(self, mut map: A) -> std::result::Result<Self::Value, A::Error>
                where
                    A: serde::de::MapAccess<'de>,
                    ...
                    while let Some(tag) = map.next_key::<__FieldTag>()? {
                        ...
                        match tag {
                            ...
                            __FieldTag::__partition_key => {
                                ...
                                result.partition_key = map.next_value::<std::option::Option<std::string::String>>()?.unwrap_or_default();
                            },
                            __FieldTag::__sequence_number => {
                                ...
                                result.sequence_number = map.next_value::<std::option::Option<std::string::String>>()?.unwrap_or_default();
                            },
                            __FieldTag::__schema_violation_reason => {
                                if !fields.insert(__FieldTag::__schema_violation_reason) {
                                    return std::result::Result::Err(A::Error::duplicate_field("multiple values for schema_violation_reason"));
                                ...
                                if result.reason.is_some() {
                                    return std::result::Result::Err(A::Error::duplicate_field(
                                        "multiple values for `reason`, a oneof with full ID .google.pubsub.v1.IngestionFailureEvent.AwsKinesisFailureReason.schema_violation_reason, latest field was schemaViolationReason",
                                    ));
                                }
                                result.reason = std::option::Option::Some(
                                    crate::model::ingestion_failure_event::aws_kinesis_failure_reason::Reason::SchemaViolationReason(
                            ...
                            __FieldTag::__message_transformation_failure_reason => {
                                ...
                                if result.reason.is_some() {
                                    return std::result::Result::Err(A::Error::duplicate_field(
                                        "multiple values for `reason`, a oneof with full ID .google.pubsub.v1.IngestionFailureEvent.AwsKinesisFailureReason.message_transformation_failure_reason, latest field was messageTransformationFailureReason",
                                    ));
                                }
                                result.reason = std::option::Option::Some(
                                    crate::model::ingestion_failure_event::aws_kinesis_failure_reason::Reason::MessageTransformationFailureReason(
    ...
    #[doc(hidden)]
    impl serde::ser::Serialize for AwsKinesisFailureReason {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: serde::ser::Serializer,
        {
            ...
            if !self.sequence_number.is_empty() {
                state.serialize_entry("sequenceNumber", &self.sequence_number)?;
            }
            if let Some(value) = self.schema_violation_reason() {
                state.serialize_entry("schemaViolationReason", value)?;
            }
    ...
    impl std::fmt::Debug for AwsKinesisFailureReason {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            let mut debug_struct = f.debug_struct("AwsKinesisFailureReason");
            debug_struct.field("stream_arn", &self.stream_arn);
    ...
    /// Defines additional types related to [AwsKinesisFailureReason].
    ...
    pub enum Failure {
        ...
        CloudStorageFailure(std::boxed::Box<crate::model::ingestion_failure_event::CloudStorageFailure>),
        /// Optional. Failure when ingesting from Amazon MSK.
        AwsMskFailure(std::boxed::Box<crate::model::ingestion_failure_event::AwsMskFailureReason>),
        /// Optional. Failure when ingesting from Azure Event Hubs.
        AzureEventHubsFailure(std::boxed::Box<crate::model::ingestion_failure_event::AzureEventHubsFailureReason>),
        /// Optional. Failure when ingesting from Confluent Cloud.
        ConfluentCloudFailure(std::boxed::Box<crate::model::ingestion_failure_event::ConfluentCloudFailureReason>),
        /// Optional. Failure when ingesting from AWS Kinesis.
        AwsKinesisFailure(std::boxed::Box<crate::model::ingestion_failure_event::AwsKinesisFailureReason>),
    }
}
...
#[doc(hidden)]
impl<'de> serde::de::Deserialize<'de> for ReceivedMessage {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                    ...
                    match tag {
                        __FieldTag::__ack_id => {
                            if !fields.insert(__FieldTag::__ack_id) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for ack_id"));
                            }
                            result.ack_id = map.next_value::<std::option::Option<std::string::String>>()?.unwrap_or_default();
                        },
                        __FieldTag::__message => {
                            if !fields.insert(__FieldTag::__message) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for message"));
                            }
                            result.message = map.next_value::<std::option::Option<crate::model::PubsubMessage>>()?
                                ;
                        },
                        __FieldTag::__delivery_attempt => {
                            if !fields.insert(__FieldTag::__delivery_attempt) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for delivery_attempt"));
                            }
                            struct __With( std::option::Option<i32> );
                            impl<'de> serde::de::Deserialize<'de> for __With {
                                fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
                            ...
                            result.delivery_attempt = map.next_value::< __With >()?.0.unwrap_or_default();
                        },
                        __FieldTag::Unknown(key) => {
                            let value = map.next_value::<serde_json::Value>()?;
                            result._unknown_fields.insert(key, value);
...
#[doc(hidden)]
impl serde::ser::Serialize for ReceivedMessage {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl PullRequest {
    ...
    /// Sets the value of [subscription][crate::model::PullRequest::subscription].
    pub fn set_subscription<T: std::convert::Into<std::string::String>>(mut self, v: T) -> Self {
        self.subscription = v.into();
        self
    }

    /// Sets the value of [return_immediately][crate::model::PullRequest::return_immediately].
    #[deprecated]
    pub fn set_return_immediately<T: std::convert::Into<bool>>(mut self, v: T) -> Self {
        self.return_immediately = v.into();
        self
    }

    /// Sets the value of [max_messages][crate::model::PullRequest::max_messages].
    pub fn set_max_messages<T: std::convert::Into<i32>>(mut self, v: T) -> Self {
        self.max_messages = v.into();
        self
    }
}
...
impl wkt::message::Message for PullRequest {
    fn typename() -> &'static str {
        "type.googleapis.com/google.pubsub.v1.PullRequest"
    }
}
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for Visitor {
                        ...
                        E: serde::de::Error,
                    {
                        ...
                        match value {
                            "subscription" => Ok(__FieldTag::__subscription),
                            "returnImmediately" => Ok(__FieldTag::__return_immediately),
                            "return_immediately" => Ok(__FieldTag::__return_immediately),
                            "maxMessages" => Ok(__FieldTag::__max_messages),
                            "max_messages" => Ok(__FieldTag::__max_messages),
                            _ => Ok(__FieldTag::Unknown(value.to_string())),
                        }
                ...
                A: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(tag) = map.next_key::<__FieldTag>()? {
                    ...
                    match tag {
                        ...
                        __FieldTag::__return_immediately => {
                            if !fields.insert(__FieldTag::__return_immediately) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for return_immediately"));
                            }
                            result.return_immediately = map.next_value::<std::option::Option<bool>>()?.unwrap_or_default();
                        },
                        __FieldTag::__max_messages => {
                            if !fields.insert(__FieldTag::__max_messages) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for max_messages"));
...
impl serde::ser::Serialize for PullRequest {
        ...
        S: serde::ser::Serializer,
    {
        ...
        if !wkt::internal::is_default(&self.return_immediately) {
            state.serialize_entry("returnImmediately", &self.return_immediately)?;
        }
        if !wkt::internal::is_default(&self.max_messages) {
            struct __With<'a>(&'a i32);
            impl<'a> serde::ser::Serialize for __With<'a> {
...
impl std::fmt::Debug for PullRequest {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        debug_struct.field("subscription", &self.subscription);
        debug_struct.field("return_immediately", &self.return_immediately);
        debug_struct.field("max_messages", &self.max_messages);
        if !self._unknown_fields.is_empty() {
            debug_struct.field("_unknown_fields", &self._unknown_fields);
        }
...
impl PullResponse {
    ...
    /// Sets the value of [received_messages][crate::model::PullResponse::received_messages].
...
impl wkt::message::Message for PullResponse {
    fn typename() -> &'static str {
        "type.googleapis.com/google.pubsub.v1.PullResponse"
    }
}

#[doc(hidden)]
impl<'de> serde::de::Deserialize<'de> for PullResponse {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Deserialize<'de> for __FieldTag {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for Visitor {
                    type Value = __FieldTag;
                    fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                        formatter.write_str("a field name for PullResponse")
                    }
                    fn visit_str<E>(self, value: &str) -> std::result::Result<Self::Value, E>
                    where
                        E: serde::de::Error,
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                formatter.write_str("struct PullResponse")
            }
            fn visit_map<A>(self, mut map: A) -> std::result::Result<Self::Value, A::Error>
            where
                A: serde::de::MapAccess<'de>,
                    ...
                    match tag {
                        __FieldTag::__received_messages => {
                            if !fields.insert(__FieldTag::__received_messages) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for received_messages"));
                            }
                            result.received_messages = map.next_value::<std::option::Option<std::vec::Vec<crate::model::ReceivedMessage>>>()?.unwrap_or_default();
                        },
                        __FieldTag::Unknown(key) => {
                            let value = map.next_value::<serde_json::Value>()?;
                            result._unknown_fields.insert(key, value);
...
#[doc(hidden)]
impl serde::ser::Serialize for PullResponse {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
impl std::fmt::Debug for PullResponse {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut debug_struct = f.debug_struct("PullResponse");
...
#[doc(hidden)]
impl<'de> serde::de::Deserialize<'de> for ModifyAckDeadlineRequest {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                    ...
                    match tag {
                        ...
                        __FieldTag::__ack_ids => {
                            if !fields.insert(__FieldTag::__ack_ids) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for ack_ids"));
                            }
...
#[doc(hidden)]
impl serde::ser::Serialize for ModifyAckDeadlineRequest {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
#[doc(hidden)]
impl<'de> serde::de::Deserialize<'de> for AcknowledgeRequest {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
#[doc(hidden)]
impl serde::ser::Serialize for AcknowledgeRequest {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
#[doc(hidden)]
impl<'de> serde::de::Deserialize<'de> for StreamingPullRequest {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for Visitor {
                        ...
                        E: serde::de::Error,
                    {
                        ...
                        match value {
                            ...
                            "streamAckDeadlineSeconds" => Ok(__FieldTag::__stream_ack_deadline_seconds),
                            "stream_ack_deadline_seconds" => Ok(__FieldTag::__stream_ack_deadline_seconds),
                            "clientId" => Ok(__FieldTag::__client_id),
                            "client_id" => Ok(__FieldTag::__client_id),
                            "maxOutstandingMessages" => Ok(__FieldTag::__max_outstanding_messages),
                            "max_outstanding_messages" => Ok(__FieldTag::__max_outstanding_messages),
                    ...
                    match tag {
                        ...
                        __FieldTag::__modify_deadline_seconds => {
                            if !fields.insert(__FieldTag::__modify_deadline_seconds) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for modify_deadline_seconds"));
                            }
                            ...
                            result.modify_deadline_seconds = map.next_value::< __With >()?.0.unwrap_or_default();
                        },
                        __FieldTag::__modify_deadline_ack_ids => {
                            if !fields.insert(__FieldTag::__modify_deadline_ack_ids) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for modify_deadline_ack_ids"));
                            }
                        ...
                        __FieldTag::__stream_ack_deadline_seconds => {
                            if !fields.insert(__FieldTag::__stream_ack_deadline_seconds) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for stream_ack_deadline_seconds"));
                            }
                            struct __With( std::option::Option<i32> );
                            impl<'de> serde::de::Deserialize<'de> for __With {
                                fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
                            ...
                            result.stream_ack_deadline_seconds = map.next_value::< __With >()?.0.unwrap_or_default();
                        },
                        __FieldTag::__client_id => {
                            if !fields.insert(__FieldTag::__client_id) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for client_id"));
                        ...
                        __FieldTag::__max_outstanding_messages => {
                            if !fields.insert(__FieldTag::__max_outstanding_messages) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for max_outstanding_messages"));
                            }
                            struct __With( std::option::Option<i64> );
                            impl<'de> serde::de::Deserialize<'de> for __With {
                                fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
                            ...
                            result.max_outstanding_messages = map.next_value::< __With >()?.0.unwrap_or_default();
                        },
                        __FieldTag::__max_outstanding_bytes => {
                            if !fields.insert(__FieldTag::__max_outstanding_bytes) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for max_outstanding_bytes"));
                            }
                            struct __With( std::option::Option<i64> );
                            impl<'de> serde::de::Deserialize<'de> for __With {
                                fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
                            ...
                            result.max_outstanding_bytes = map.next_value::< __With >()?.0.unwrap_or_default();
                        },
                        __FieldTag::Unknown(key) => {
                            let value = map.next_value::<serde_json::Value>()?;
                            result._unknown_fields.insert(key, value);
...
#[doc(hidden)]
impl serde::ser::Serialize for StreamingPullRequest {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
#[doc(hidden)]
impl<'de> serde::de::Deserialize<'de> for StreamingPullResponse {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for Visitor {
                        ...
                        E: serde::de::Error,
                    {
                        ...
                        match value {
                            ...
                            "acknowledge_confirmation" => Ok(__FieldTag::__acknowledge_confirmation),
                            "modifyAckDeadlineConfirmation" => Ok(__FieldTag::__modify_ack_deadline_confirmation),
                            "modify_ack_deadline_confirmation" => Ok(__FieldTag::__modify_ack_deadline_confirmation),
                    ...
                    match tag {
                        ...
                        __FieldTag::__acknowledge_confirmation => {
                            if !fields.insert(__FieldTag::__acknowledge_confirmation) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for acknowledge_confirmation"));
                            }
                            result.acknowledge_confirmation = map.next_value::<std::option::Option<crate::model::streaming_pull_response::AcknowledgeConfirmation>>()?
                                ;
                        },
                        __FieldTag::__modify_ack_deadline_confirmation => {
                            if !fields.insert(__FieldTag::__modify_ack_deadline_confirmation) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for modify_ack_deadline_confirmation"));
                            }
                        ...
                        __FieldTag::__subscription_properties => {
                            if !fields.insert(__FieldTag::__subscription_properties) {
                                return std::result::Result::Err(A::Error::duplicate_field("multiple values for subscription_properties"));
                            }
                            result.subscription_properties = map.next_value::<std::option::Option<crate::model::streaming_pull_response::SubscriptionProperties>>()?
                                ;
                        },
                        __FieldTag::Unknown(key) => {
                            let value = map.next_value::<serde_json::Value>()?;
...
#[doc(hidden)]
impl serde::ser::Serialize for StreamingPullResponse {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::ser::Serializer,
    {
...
pub mod streaming_pull_response {
    ...
    #[doc(hidden)]
    impl<'de> serde::de::Deserialize<'de> for AcknowledgeConfirmation {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: serde::Deserializer<'de>,
        {
                    ...
                    impl<'de> serde::de::Visitor<'de> for Visitor {
                            ...
                            E: serde::de::Error,
                        {
                            ...
                            match value {
                                ...
                                "temporary_failed_ack_ids" => Ok(__FieldTag::__temporary_failed_ack_ids),
                                _ => Ok(__FieldTag::Unknown(value.to_string())),
                            }
                        }
                    }
            ...
            struct Visitor;
            impl<'de> serde::de::Visitor<'de> for Visitor {
                type Value = AcknowledgeConfirmation;
                fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
                        ...
                        match tag {
                            ...
                            __FieldTag::__invalid_ack_ids => {
                                if !fields.insert(__FieldTag::__invalid_ack_ids) {
                                    return std::result::Result::Err(A::Error::duplicate_field("multiple values for invalid_ack_ids"));
                                }
                            ...
                            __FieldTag::__unordered_ack_ids => {
                                if !fields.insert(__FieldTag::__unordered_ack_ids) {
                                    return std::result::Result::Err(A::Error::duplicate_field("multiple values for unordered_ack_ids"));
                                }
                            ...
                            __FieldTag::__temporary_failed_ack_ids => {
                                if !fields.insert(__FieldTag::__temporary_failed_ack_ids) {
                                    return std::result::Result::Err(A::Error::duplicate_field("multiple values for temporary_failed_ack_ids"));
                                }
    ...
    #[doc(hidden)]
    impl serde::ser::Serialize for AcknowledgeConfirmation {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: serde::ser::Serializer,
        {
    ...
    impl std::fmt::Debug for AcknowledgeConfirmation {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
    ...
    #[doc(hidden)]
    impl<'de> serde::de::Deserialize<'de> for ModifyAckDeadlineConfirmation {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: serde::Deserializer<'de>,
        {
            ...
            struct Visitor;
            impl<'de> serde::de::Visitor<'de> for Visitor {
                type Value = ModifyAckDeadlineConfirmation;
                fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
    ...
    #[doc(hidden)]
    impl serde::ser::Serialize for ModifyAckDeadlineConfirmation {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: serde::ser::Serializer,
        {
    ...
    impl std::fmt::Debug for ModifyAckDeadlineConfirmation {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
    ...
    #[doc(hidden)]
    impl<'de> serde::de::Deserialize<'de> for SubscriptionProperties {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: serde::Deserializer<'de>,
        {
                    ...
                    D: serde::Deserializer<'de>,
                {
                    ...
                    impl<'de> serde::de::Visitor<'de> for Visitor {
                            ...
                            E: serde::de::Error,
                        {
                            ...
                            use std::string::ToString;
                            match value {
                                "exactlyOnceDeliveryEnabled" => Ok(__FieldTag::__exactly_once_delivery_enabled),
                                "exactly_once_delivery_enabled" => Ok(__FieldTag::__exactly_once_delivery_enabled),
                                "messageOrderingEnabled" => Ok(__FieldTag::__message_ordering_enabled),
                                "message_ordering_enabled" => Ok(__FieldTag::__message_ordering_enabled),
                                _ => Ok(__FieldTag::Unknown(value.to_string())),
                            }
                        }
                    }
                        ...
                        match tag {
                            __FieldTag::__exactly_once_delivery_enabled => {
                                if !fields.insert(__FieldTag::__exactly_once_delivery_enabled) {
                                    return std::result::Result::Err(A::Error::duplicate_field("multiple values for exactly_once_delivery_enabled"));
                                }
                                result.exactly_once_delivery_enabled = map.next_value::<std::option::Option<bool>>()?.unwrap_or_default();
                            },
                            __FieldTag::__message_ordering_enabled => {
                                if !fields.insert(__FieldTag::__message_ordering_enabled) {
                                    return std::result::Result::Err(A::Error::duplicate_field("multiple values for message_ordering_enabled"));
                                }
                                result.message_ordering_enabled = map.next_value::<std::option::Option<bool>>()?.unwrap_or_default();
                            },
                            __FieldTag::Unknown(key) => {
                                let value = map.next_value::<serde_json::Value>()?;
                                result._unknown_fields.insert(key, value);
    ...
    #[doc(hidden)]
    impl serde::ser::Serialize for SubscriptionProperties {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: serde::ser::Serializer,
        {
    ...
    impl std::fmt::Debug for SubscriptionProperties {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
