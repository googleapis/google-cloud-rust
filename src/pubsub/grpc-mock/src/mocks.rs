...
pub trait Subscriber {
    ...
    async fn create_subscription(
        &self,
        request: tonic::Request<google::pubsub::v1::Subscription>,
    ) -> tonic::Result<tonic::Response<google::pubsub::v1::Subscription>>;
    async fn get_subscription(
        &self,
        request: tonic::Request<google::pubsub::v1::GetSubscriptionRequest>,
    ) -> tonic::Result<tonic::Response<google::pubsub::v1::Subscription>>;
    async fn update_subscription(
        &self,
        request: tonic::Request<google::pubsub::v1::UpdateSubscriptionRequest>,
    ) -> tonic::Result<tonic::Response<google::pubsub::v1::Subscription>>;
    async fn list_subscriptions(
        &self,
        request: tonic::Request<google::pubsub::v1::ListSubscriptionsRequest>,
    ) -> tonic::Result<tonic::Response<google::pubsub::v1::ListSubscriptionsResponse>>;
    async fn delete_subscription(
        &self,
        request: tonic::Request<google::pubsub::v1::DeleteSubscriptionRequest>,
    ) -> tonic::Result<tonic::Response<()>>;
    async fn modify_ack_deadline(
        &self,
        request: tonic::Request<google::pubsub::v1::ModifyAckDeadlineRequest>,
    ) -> tonic::Result<tonic::Response<()>>;
    async fn acknowledge(
        &self,
        request: tonic::Request<google::pubsub::v1::AcknowledgeRequest>,
    ) -> tonic::Result<tonic::Response<()>>;
    async fn pull(
        &self,
        request: tonic::Request<google::pubsub::v1::PullRequest>,
    ) -> tonic::Result<tonic::Response<google::pubsub::v1::PullResponse>>;
    async fn streaming_pull(
        &self,
        request: tonic::Request<
            mpsc::Receiver<tonic::Result<google::pubsub::v1::StreamingPullRequest>>,
        >,
    ) -> tonic::Result<
        tonic::Response<mpsc::Receiver<tonic::Result<google::pubsub::v1::StreamingPullResponse>>>,
    >;
    async fn modify_push_config(
        &self,
        request: tonic::Request<google::pubsub::v1::ModifyPushConfigRequest>,
    ) -> tonic::Result<tonic::Response<()>>;
    async fn get_snapshot(
        &self,
        request: tonic::Request<google::pubsub::v1::GetSnapshotRequest>,
    ) -> tonic::Result<tonic::Response<google::pubsub::v1::Snapshot>>;
    async fn list_snapshots(
        &self,
        request: tonic::Request<google::pubsub::v1::ListSnapshotsRequest>,
    ) -> tonic::Result<tonic::Response<google::pubsub::v1::ListSnapshotsResponse>>;
    async fn create_snapshot(
        &self,
        request: tonic::Request<google::pubsub::v1::CreateSnapshotRequest>,
    ) -> tonic::Result<tonic::Response<google::pubsub::v1::Snapshot>>;
    async fn update_snapshot(
        &self,
        request: tonic::Request<google::pubsub::v1::UpdateSnapshotRequest>,
    ) -> tonic::Result<tonic::Response<google::pubsub::v1::Snapshot>>;
    async fn delete_snapshot(
        &self,
        request: tonic::Request<google::pubsub::v1::DeleteSnapshotRequest>,
    ) -> tonic::Result<tonic::Response<()>>;
    async fn seek(
        &self,
        request: tonic::Request<google::pubsub::v1::SeekRequest>,
    ) -> tonic::Result<tonic::Response<google::pubsub::v1::SeekResponse>>;
}

#[async_trait]
impl google::pubsub::v1::subscriber_server::Subscriber for MockSubscriber {
    async fn create_subscription(
        &self,
        request: tonic::Request<google::pubsub::v1::Subscription>,
    ) -> tonic::Result<tonic::Response<google::pubsub::v1::Subscription>> {
    ...
    type StreamingPullStream =
        ReceiverStream<tonic::Result<google::pubsub::v1::StreamingPullResponse>>;
    async fn streaming_pull(
        &self,
        request: tonic::Request<tonic::Streaming<google::pubsub::v1::StreamingPullRequest>>,
