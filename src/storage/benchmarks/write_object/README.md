...
* **Option B (`Option_B_Unbuffered_2Pass`)**:
  ...
  * **Pass 1:** Scans the local file to compute SIMD CRC32C checksum.
  * **Pass 2:** Streams data via a single continuous PUT request with server-side validation header (`x-goog-hash`).
