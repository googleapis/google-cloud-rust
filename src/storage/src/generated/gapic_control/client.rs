...
impl StorageControl {
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::StorageControl>> {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::StorageControl> {
    ...
    /// ) -> Result<()> {
    ///     let response = client.rename_folder()
    ///         /* set fields */
    ...
    ///    client: &StorageControl
    /// ) -> Result<()> {
    ///     client.delete_folder_recursive()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     Ok(())
    /// }
    ...
    pub fn delete_folder_recursive(
        &self,
    ) -> super::builder::storage_control::DeleteFolderRecursive {
        super::builder::storage_control::DeleteFolderRecursive::new(self.inner.clone())
    }
    ...
    ///    client: &StorageControl
    /// ) -> Result<()> {
    ///     let response = client.create_managed_folder()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &StorageControl
    /// ) -> Result<()> {
    ///     let response = client.create_anywhere_cache()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &StorageControl
    /// ) -> Result<()> {
    ///     let response = client.update_anywhere_cache()
    ///         /* set fields */
    ///         .poller().until_done().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &StorageControl
    /// ) -> Result<()> {
    ///     let response = client.disable_anywhere_cache()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &StorageControl
    /// ) -> Result<()> {
    ///     let response = client.pause_anywhere_cache()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &StorageControl
    /// ) -> Result<()> {
    ///     let response = client.resume_anywhere_cache()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &StorageControl
    /// ) -> Result<()> {
    ///     let response = client.get_project_intelligence_config()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &StorageControl
    /// ) -> Result<()> {
    ///     let response = client.update_project_intelligence_config()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &StorageControl
    /// ) -> Result<()> {
    ///     let response = client.get_folder_intelligence_config()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &StorageControl
    /// ) -> Result<()> {
    ///     let response = client.update_folder_intelligence_config()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &StorageControl
    /// ) -> Result<()> {
    ///     let response = client.get_organization_intelligence_config()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &StorageControl
    /// ) -> Result<()> {
    ///     let response = client.update_organization_intelligence_config()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &StorageControl
    /// ) -> Result<()> {
    ///     let response = client.view_object_full_context()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    pub fn view_object_full_context(
        &self,
    ) -> super::builder::storage_control::ViewObjectFullContext {
        super::builder::storage_control::ViewObjectFullContext::new(self.inner.clone())
    }
