...
impl StorageControl {
    ...
    /// [user guide]: https://googleapis.github.io/google-cloud-rust/
    /// [working with long-running operations]: https://googleapis.github.io/google-cloud-rust/working_with_long_running_operations.html
    pub fn disable_rapid_cache(&self) -> crate::builder::storage_control::DisableRapidCache {
        self.control.disable_rapid_cache()
    }
        ...
        T: crate::stub::StorageControl + 'static,
    {
        ...
        Self {
            storage: crate::generated::gapic::client::StorageControl::from_stub::<std::sync::Arc<T>>(
                stub.clone(),
            ),
