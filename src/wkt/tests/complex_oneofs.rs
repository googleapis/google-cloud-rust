...
mod tests {
    ...
    #[test_case(MessageWithComplexOneOf::new().set_float_value(0.0_f32), json!({"floatValue": 0.0}))]
    #[test_case(MessageWithComplexOneOf::new().set_float_value(1.5_f32), json!({"floatValue": 1.5}))]
    #[test_case(MessageWithComplexOneOf::new().set_float_value(2.5_f32), json!({"floatValue": 2.5}))]
    #[test_case(MessageWithComplexOneOf::new().set_float_value(3.0_f32), json!({"floatValue": 3.0}))]
    ...
    #[test_case(MessageWithComplexOneOf::new().set_string_value(""), json!({"stringValue": ""}))]
    #[test_case(MessageWithComplexOneOf::new().set_float_value(0.0_f32), json!({"floatValue": 0}))]
    #[test_case(MessageWithComplexOneOf::new().set_float_value(1.5_f32), json!({"floatValue": "1.5"}))]
    #[test_case(MessageWithComplexOneOf::new().set_float_value(2.5_f32), json!({"floatValue": 2.5}))]
    #[test_case(MessageWithComplexOneOf::new().set_float_value(3.0_f32), json!({"floatValue": 3}))]
    ...
    #[test_case(MessageWithComplexOneOf::new().set_float_value(1.5_f32), json!({"float_value": 1.5}))]
