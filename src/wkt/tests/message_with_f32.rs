...
mod tests {
    ...
    #[test_case(MessageWithF32::new().set_singular(0.0_f32), json!({}))]
    #[test_case(MessageWithF32::new().set_singular(1.5_f32), json!({"singular": 1.5}))]
    ...
    #[test_case(MessageWithF32::new().set_optional(0.0_f32), json!({"optional": 0.0}))]
    #[test_case(MessageWithF32::new().set_or_clear_optional(None::<f32>), json!({}))]
    #[test_case(MessageWithF32::new().set_optional(1.5_f32), json!({"optional": 1.5}))]
    ...
    #[test_case(MessageWithF32::new().set_repeated([0.0_f32, 1.5_f32, 2.5_f32]), json!({"repeated": [0.0, 1.5, 2.5]}))]
    ...
    #[test_case(MessageWithF32::new(), json!({}))]
    #[test_case(MessageWithF32::new().set_singular(0.0_f32), json!({"singular": null}))]
    #[test_case(MessageWithF32::new().set_singular(0.0_f32), json!({}))]
    #[test_case(MessageWithF32::new().set_singular(1.5_f32), json!({"singular": 1.5}))]
    #[test_case(MessageWithF32::new().set_optional(0.0_f32), json!({"optional": 0.0}))]
    #[test_case(MessageWithF32::new().set_or_clear_optional(None::<f32>), json!({}))]
    ...
    #[test_case(MessageWithF32::new().set_repeated([0_f32;0]), json!({}))]
    #[test_case(MessageWithF32::new().set_repeated([0.0_f32, 1.5_f32, 2.5_f32]), json!({"repeated": [0.0, 1.5, 2.5]}))]
    #[test_case(MessageWithF32::new().set_repeated([0.0_f32, 1.5_f32, 2.5_f32]), json!({"repeated": [0, 1.5, "2.5"]}))]
    #[test_case(MessageWithF32::new().set_map([("", 0_f32);0]), json!({}))]
    #[test_case(MessageWithF32::new().set_map([("a", 0_f32), ("b", 1_f32)]), json!({"map": {"a": 0.0, "b": 1.0}}))]
