...
mod test {
    ...
    pub struct MessageWithU32 {
        ...
        #[serde_as(as = "google_cloud_wkt::internal::U32")]
        pub singular: u32,

        #[serde(skip_serializing_if = "std::option::Option::is_none")]
        #[serde_as(as = "Option<google_cloud_wkt::internal::U32>")]
        pub optional: Option<u32>,

        #[serde(skip_serializing_if = "Vec::is_empty")]
        #[serde_as(as = "Vec<google_cloud_wkt::internal::U32>")]
        pub repeated: Vec<u32>,

        #[serde(skip_serializing_if = "HashMap::is_empty")]
        #[serde_as(as = "HashMap<_, google_cloud_wkt::internal::U32>")]
        pub map_value: HashMap<String, u32>,

        #[serde(skip_serializing_if = "HashMap::is_empty")]
        #[serde_as(as = "HashMap<google_cloud_wkt::internal::U32, _>")]
        pub map_key: HashMap<u32, String>,

        #[serde(skip_serializing_if = "HashMap::is_empty")]
        #[serde_as(
            as = "HashMap<google_cloud_wkt::internal::U32, google_cloud_wkt::internal::U32>"
        )]
        pub map_key_value: HashMap<u32, u32>,
    }
