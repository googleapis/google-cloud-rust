...
impl wkt::prost::Convert<ErrorInfo> for rpc::model::ErrorInfo {
...
impl wkt::prost::Convert<rpc::model::ErrorInfo> for ErrorInfo {
...
impl wkt::prost::Convert<RetryInfo> for rpc::model::RetryInfo {
...
impl wkt::prost::Convert<rpc::model::RetryInfo> for RetryInfo {
...
impl wkt::prost::Convert<DebugInfo> for rpc::model::DebugInfo {
...
impl wkt::prost::Convert<rpc::model::DebugInfo> for DebugInfo {
...
impl wkt::prost::Convert<quota_failure::Violation> for rpc::model::quota_failure::Violation {
...
impl wkt::prost::Convert<rpc::model::quota_failure::Violation> for quota_failure::Violation {
...
impl wkt::prost::Convert<QuotaFailure> for rpc::model::QuotaFailure {
...
impl wkt::prost::Convert<rpc::model::QuotaFailure> for QuotaFailure {
...
impl wkt::prost::Convert<precondition_failure::Violation> for rpc::model::precondition_failure::Violation {
...
impl wkt::prost::Convert<rpc::model::precondition_failure::Violation> for precondition_failure::Violation {
...
impl wkt::prost::Convert<PreconditionFailure> for rpc::model::PreconditionFailure {
...
impl wkt::prost::Convert<rpc::model::PreconditionFailure> for PreconditionFailure {
...
impl wkt::prost::Convert<bad_request::FieldViolation> for rpc::model::bad_request::FieldViolation {
...
impl wkt::prost::Convert<rpc::model::bad_request::FieldViolation> for bad_request::FieldViolation {
...
impl wkt::prost::Convert<BadRequest> for rpc::model::BadRequest {
...
impl wkt::prost::Convert<rpc::model::BadRequest> for BadRequest {
...
impl wkt::prost::Convert<RequestInfo> for rpc::model::RequestInfo {
...
impl wkt::prost::Convert<rpc::model::RequestInfo> for RequestInfo {
...
impl wkt::prost::Convert<ResourceInfo> for rpc::model::ResourceInfo {
...
impl wkt::prost::Convert<rpc::model::ResourceInfo> for ResourceInfo {
...
impl wkt::prost::Convert<help::Link> for rpc::model::help::Link {
...
impl wkt::prost::Convert<rpc::model::help::Link> for help::Link {
...
impl wkt::prost::Convert<Help> for rpc::model::Help {
    fn cnv(self) -> Help {
        Help {
...
impl wkt::prost::Convert<rpc::model::Help> for Help {
...
impl wkt::prost::Convert<LocalizedMessage> for rpc::model::LocalizedMessage {
...
impl wkt::prost::Convert<rpc::model::LocalizedMessage> for LocalizedMessage {
...
impl wkt::prost::Convert<HttpRequest> for rpc::model::HttpRequest {
...
impl wkt::prost::Convert<rpc::model::HttpRequest> for HttpRequest {
...
impl wkt::prost::Convert<HttpResponse> for rpc::model::HttpResponse {
...
impl wkt::prost::Convert<rpc::model::HttpResponse> for HttpResponse {
...
impl wkt::prost::Convert<HttpHeader> for rpc::model::HttpHeader {
...
impl wkt::prost::Convert<rpc::model::HttpHeader> for HttpHeader {
