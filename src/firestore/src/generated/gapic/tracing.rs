    ...
    T: super::stub::Firestore + std::fmt::Debug + Send + Sync,
{
    ...
    {
        self.inner.batch_get_documents(req, options).await
    }
    ...
    async fn run_query(
        ...
        self.inner.run_query(req, options).await
    }
    ...
    > {
        self.inner.run_aggregation_query(req, options).await
    }
