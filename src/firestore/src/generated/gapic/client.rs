...
/// [with_credentials()]: super::builder::firestore::ClientBuilder::with_credentials
...
/// create one and reuse it. You do not need to wrap `Firestore` in
...
impl Firestore {
    ...
    pub fn builder() -> super::builder::firestore::ClientBuilder {
        crate::new_client_builder(super::builder::firestore::client::Factory)
    }
    ...
    ) -> crate::ClientBuilderResult<std::sync::Arc<dyn super::stub::dynamic::Firestore>> {
    ...
    async fn build_transport(
        conf: gaxi::options::ClientConfig,
    ) -> crate::ClientBuilderResult<impl super::stub::Firestore> {
    ...
    ///    client: &Firestore
    /// ) -> Result<()> {
    ///     let mut list = client.partition_query()
    ///         /* set fields */
    ///         .by_item();
    ///     while let Some(item) = list.next().await.transpose()? {
    ///         println!("{:?}", item);
    ...
    ///    client: &Firestore
    /// ) -> Result<()> {
    ///     let response = client.list_collection_ids()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
    ...
    ///    client: &Firestore
    /// ) -> Result<()> {
    ///     let response = client.batch_write()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
