...
always include these details when formatting errors using `std::fmt::Display`.
Some applications may want to examine these details and change their behavior
